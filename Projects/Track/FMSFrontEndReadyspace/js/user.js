...
$(document).ready(function () {
    ...
    $('#submit-user').on('click', function () {
        ...
        var url = 'https://track-asia.com/tracksgwebapi/api/login';
        ...
        $.ajax({
            url: "https://track-asia.com/tracksgwebapi/api/login",
            type: "POST",
            ...
            success: function (userlogin) {
                ...
                if (userlogin.ErrorMessage == null && userlogin.LoginRetry == "Active") {
                    ...
                    $.ajax({
                        url: "https://track-asia.com/tracksgwebapi/api/eventinfo",
                        type: "POST",
