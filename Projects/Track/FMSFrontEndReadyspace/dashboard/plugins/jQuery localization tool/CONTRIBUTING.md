...
### PhantomJS
While Grunt can run the included unit tests via [PhantomJS](https://phantomjs.org/), this shouldn't be considered a substitute for the real thing. Please be sure to test the `test/*.html` unit test file(s) in _actual_ browsers.
