 ...
 * https://www.schillmania.com/projects/soundmanager2/license.txt
 *
 * Flash 8 / ActionScript 2 version
 *
 * Compiling AS to Flash 8 SWF using MTASC (free compiler - https://www.mtasc.org/):
 ...
 * https://livedocs.macromedia.com/flash/8/
 * Previously-live URL:
 * https://livedocs.macromedia.com/flash/8/main/wwhelp/wwhimpl/common/html/wwhelp.htm?context=LiveDocs_Parts&file=00002668.html
 *
...
class SoundManager2 {
  ...
  function SoundManager2() {
     ...
     *  download from https://livedocs.macromedia.com/flash/8/
     *  Related AS3 documentation: https://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/system/Security.html#allowDomain%28%29
     */
      ...
      try {
        if (isFirstCall) {
          ...
          if (!didSandboxMessage && sandboxType != 'remote' && sandboxType != 'localTrusted') {
            ...
            flashDebug('<br><b>Fatal: Security sandbox error: Got "' + sandboxType + '", expected "remote" or "localTrusted".<br>Additional security permissions need to be granted.<br>See <a href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager04.html">flash security settings panel</a> for non-HTTP, eg. file:// use.</b><br>https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager04.html<br><br>You may also be able to right-click this movie and choose from the menu: <br>"Global Settings" -> "Advanced" tab -> "Trusted Location Settings"<br>');
          }
    ...
    var onID3 = function() {
      ...
      // May be related to thumbnails for album art included in MP3 file by iTunes. See https://mabblog.com/blog/?p=33
      var id3Data = [];
      var id3Props = [];
