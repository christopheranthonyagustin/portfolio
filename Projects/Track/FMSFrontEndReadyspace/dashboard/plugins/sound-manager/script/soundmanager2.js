  ...
  html5_events = {
    ...
    */
    ...
    error: html5_event(function() {
       ...
       * Reference: https://www.whatwg.org/specs/web-apps/current-work/multipage/the-video-element.html#error-codes
       */
...
featureCheck = function() {
  ...
  createMovie = function(smID, smURL) {
    ...
    if (isIE) {
      ...
      movieHTML = [
        '<object id="' + smID + '" data="' + smURL + '" type="' + oEmbed.type + '" title="' + oEmbed.title +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">',
        param('movie', smURL),
