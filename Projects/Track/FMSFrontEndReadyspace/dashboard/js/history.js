...
var i = 0;
    ...
    function setLines(map, lines) {
        ...
        webapi = "https://track-asia.com/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
 ...
 */
    function playAnimate() {
        ...
        url = "https://track-asia.com/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    * Pausing...
    ...
    function setZones(map, zones, callback) {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            url = 'https://track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller + '&CompanyID=' + getLocalstorageValueCompany;

        } else if (getSessionstorageValueRoleID == 2) {

            url = 'https://track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller;
