...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://track-asia.com/tracksgwebapi/api/resellerinfo';

    } else {

        WebAPI = 'https://track-asia.com/tracksgwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
