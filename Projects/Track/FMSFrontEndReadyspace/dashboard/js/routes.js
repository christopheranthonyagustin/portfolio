...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://track-asia.com/tracksgwebapi/api/companyinfo?&ResellerID=" + "1", function (data) {
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
        ...
        geocoder.geocode({
            ...
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                if (origin.length == 6 && isNaN(origin) == false) {
                    ...
                    //Reverse Geocode
                    var getAPI = "https://track-asia.com/tracksgwebapi/api/reversegeocode?PosY=" + lat + "&PosX=" + lng;
                    console.log(getAPI);
...
function searchDriver(id) {
    ...
    var apiDriver = 'https://track-asia.com/tracksgwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'https://track-asia.com/tracksgwebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'https://track-asia.com/tracksgwebapi/api/searchjob?JobNumber=' + getJobNumber;
...
function reloadJobsCreated() {
    ...
    //https://track-asia.com/tracksgwebapi/api/routeinfo?CompanyID=14
    var WebAPIJobs;
    if (getSessionstorageValueRoleID == 1) {

        WebAPIJobs = 'https://track-asia.com/tracksgwebapi/api/routeinfo?CompanyID=' + getSessionstorageValueCompanyID + '&DriverID=' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
...
function searchRouteFilter() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIJobs = 'https://track-asia.com/tracksgwebapi/api/routeinfo?CompanyID=' + getSessionstorageValueCompanyID + '&DriverID=' + driver + '&Flag=' + flag + '&StartDate=' + dateFrom + '&EndDate=' + dateTo;
    }
    else if (getSessionstorageValueRoleID == 2) {
...
function viewWaypoints(route_id) {
    ...
    var WebAPI = 'https://track-asia.com/tracksgwebapi/api/routelocationinfo?CompanyID=' + getSessionstorageValueCompanyID + '&RouteID=' + route_id;
...
function deletePlan(route_id) {
    ...
    bootbox.confirm("<div style='color:black'>Are you sure you want to delete ?</div>", function (result) {
        ...
        if (result) {
            ...
            var WebAPI = 'https://track-asia.com/tracksgwebapi/api/routeinfo/' + route_id;
