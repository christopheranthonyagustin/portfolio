...
//OnLoad User Role
$.getJSON("https://track-asia.com/tracksgwebapi/api/roleinfo?RoleID=" + getSessionstorageValueRoleID, function (data) {
    $.each(data, function (index, item) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + '' + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://track-asia.com/tracksgwebapi/api/userinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&RoleID=' + getSessionstorageValueRoleID;
        ...
        $('#users-editable').bootstrapTable({
            ...
            onCheck: function (row) {
                ...
                if (getSessionstorageValueRoleID == 1) {
                    ...
                    $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo", function (data) {
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://track-asia.com/tracksgwebapi/api/userinfo?ResellerID=' + '4' + '&CompanyID=' + '2' + '&RoleID=' + getSessionstorageValueRoleID;

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://track-asia.com/tracksgwebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
$.getJSON("https://track-asia.com/tracksgwebapi/api/languageinfo", function (data) {
    $.each(data, function (index, item) {
...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
