...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + '&ResellerID=' + '1' + '&CompanyID=' + '1', function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    var getZone = 'https://track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    var getZoneByID = 'https://track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    ...
    var getZoneByID = 'https://track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
