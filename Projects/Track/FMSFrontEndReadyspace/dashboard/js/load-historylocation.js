...
$(document).ready(function () {
    ...
    function setLines(map, lines) {
        ...
        var url = "https://track-asia.com/tracksgwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
        ...
        if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
            ...
            var WebApi = "https://track-asia.com/tracksgwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
