...
//Load Events
$.getJSON("https://track-asia.com/tracksgwebapi/api/statusinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + '&ResellerID=' + "4" + '&CompanyID=' + "2", function (data) {
        $.each(data, function (index, item) {
    ...
    $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets').append(
    ...
    $('.SelectReport').on('change', function () {
        ...
        function GenerateEN() {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var WebApi = "https://track-asia.com/tracksgwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + getSpeed + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var WebApiEvent = "https://track-asia.com/tracksgwebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var WebApiMessages = "https://track-asia.com/tracksgwebapi/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var jobApi = 'https://track-asia.com/tracksgwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
                var WebApiUtilization = "https://track-asia.com/tracksgwebapi/api/utilizationinfo?Asset=" + getAsset + "&StartTime=" + timestamp + "&EndTime=" + rxtime;
                var WebAPIIdling = "https://track-asia.com/tracksgwebapi/api/idlinginfo?Asset=" + getAsset + "&IdleStart=" + timestamp + "&IdleEnd=" + rxtime;
                    ...
                    if (strEvent == 12 | strEvent == 13) {
                        ...
                        $(document).ready(function () {
                            ...
                            $('#' + Report).bootstrapTable(
                                {
                                    idField: 'EventID',
                                    url: 'https://track-asia.com/tracksgwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID,
                                    columns: [{
                                        field: 'EventID',
                                        title: 'id',
                                        class: 'hidden-xs hidden-sm hidden-md hidden-lg hidden-desktop'
...
if (getSessionstorageValueRoleID == 1) {
    ...
    MobileWebAPIReseller = 'https://track-asia.com/tracksgwebapi/api/resellerinfo';
    ...
    MobileWebAPIReseller = 'https://track-asia.com/tracksgwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
$(function () {
    ...
    $('.SelectVechsFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            $.getJSON("https://track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "https://track-asia.com/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "https://track-asia.com/tracksgwebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "https://track-asia.com/tracksgwebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'https://track-asia.com/tracksgwebapi/api/jobinfo?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'https://track-asia.com/tracksgwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: 'Timestamp',
