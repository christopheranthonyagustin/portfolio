...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function() {
	...
	$('#devices-editable').bootstrapTable({
		idField: 'id',
		url: 'https://app.track-asia.com/tracksgwebapi/api/deviceinfo?ResellerID=' + '4' + '&CompanyID=' + '2',
		columns: [{
		    field: 'state',
		    title: 'ID',
		    checkbox: 'true'
