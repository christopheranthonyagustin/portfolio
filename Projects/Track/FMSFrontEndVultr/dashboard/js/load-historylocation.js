	...
	var startDate = moment(getLocalstorageValueDateFrom, dateFormat);
	var endDate = moment(getLocalstorageValueDateTo, dateFormat);
...
$(document).ready(function () {
    ...
    function setLines(map, lines) {
        ...
        var url = "https://app.track-asia.com/tracksgwebapi/api/posinfo?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&CompanyID=" + getLocalstorageValueCompany;
        ...
        $.getJSON(url, function (lines) {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                var marker1 = new google.maps.Marker({
                    position: new google.maps.LatLng(lines[0].PosY, lines[0].PosX),
                    map: map,
                ...
                var marker2 = new google.maps.Marker({
                    position: new google.maps.LatLng(lines[(lines.length - 1)].PosY, lines[(lines.length - 1)].PosX),
                    map: map,
    ...
    if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
        ...
        if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
            ...
            var WebApi = "https://app.track-asia.com/tracksgwebapi/api/posinfo?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&CompanyID=" + getLocalstorageValueCompany;
                        ...
                        onClickRow: function (row, $element) {
                            ...
                            //Table Vehicle List
                                        ...
                                        var contentString = '<div id="content">' +
                                              '<div id="siteNotice">' +
                                              '</div>' +
                                              '<h5 id="firstHeading" class="firstHeading text-primary">' + assetName + '</h5>' +
                                              '<div id="bodyContent">' +
                                              '<p><b data-l11n="th">ที่อยู่: </b><b data-l11n>Address: </b>' + address +
                                              '<br /><b data-l11n="th">สถานะ: </b><b data-l11n>Status: </b>' + engine +
                                              '<br /><b data-l11n="th">ความเร็ว: </b><b data-l11n>Speed: </b>' + speed + '</p>' +
...
$(document).ready(function () {
    ...
    document.getElementById("softwareEN").innerHTML = version;
		...
		alert('View Location not allowed');
		   window.location.href = 'history.html';
	}
