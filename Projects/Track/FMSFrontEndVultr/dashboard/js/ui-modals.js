...
$(document).ready(function () {
	...
	$('#bv-wz-form').keypress(function (event) {
        if (event.which == '13') {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/tracksgwebapi/api/messageinfo",
                        type: "POST",
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/tracksgwebapi/api/assetinfo",
                        type: "POST",
                    ...
                    var updateAsset = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo?id=' + assets.AssetID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (zones.ZoneID == 'undefined' || zones.ZoneID == null || zones.ZoneID == 0 || zones.ZoneID != GetZoneID) {
                        ...
                        var updateZone = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?id=' + zones.ZoneID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you want to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo/' + row.ZoneID;
    ...
    $('#submit-companyEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/tracksgwebapi/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo?id=' + company.CompanyID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo/' + row.CompanyID;
        ...
        if (getUserCompany != "0" || getUserCompany == "") {
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'https://app.track-asia.com/tracksgwebapi/api/userinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (getAlertType != null) {
						...
						$('#userNotificationsType option').each(function () {
                            let isSelected = false;

                            for (i = 0; i < getAlertType.length; i++) {
                                if ($(this).val() == getAlertType[i]) {
                    ...
                    if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/tracksgwebapi/api/userinfo",
                            type: "POST",
                        ...
                        var updateUser = 'https://app.track-asia.com/tracksgwebapi/api/userinfo?id=' + user.UserID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/userinfo/' + row.UserID;
    ...
    $('#submit-deviceEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/tracksgwebapi/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/tracksgwebapi/api/deviceinfo",
                        type: "POST",
                    ...
                    var updateDevice = 'https://app.track-asia.com/tracksgwebapi/api/deviceinfo?id=' + device.DeviceID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/deviceinfo/' + row.DeviceID;
    ...
    $('#submit-resellerEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'https://app.track-asia.com/tracksgwebapi/api/resellerinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/tracksgwebapi/api/resellerinfo",
                        type: "POST",
                    ...
                    var updateReseller = 'https://app.track-asia.com/tracksgwebapi/api/resellerinfo?id=' + reseller.ResellerID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/resellerinfo/' + row.ResellerID;
        ...
        if (getDriver != "")
        {
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                ...
                if (result) {
                    ...
                    var url = 'https://app.track-asia.com/tracksgwebapi/api/driverinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    var driver = {
                        ...
                        LoginName: $('#driverLoginNameEN').val(),
                    ...
                    if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/tracksgwebapi/api/driverinfo",
                            type: "POST",
                        ...
                        var updateDriver = 'https://app.track-asia.com/tracksgwebapi/api/driverinfo?id=' + driver.DriverID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'https://app.track-asia.com/tracksgwebapi/api/userinfo?id=' + profile.UserID;
        ...
        else
        {
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                ...
                if (result) {
                    ...
                    var url = 'https://app.track-asia.com/tracksgwebapi/api/jobinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/tracksgwebapi/api/jobinfo",
                            type: "POST",
                        ...
                        var updateJob = 'https://app.track-asia.com/tracksgwebapi/api/jobinfo?id=' + job.JobID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/jobinfo/' + row.JobID;
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                ...
                if (result) {
                    ...
                    if (route.RouteID == 'undefined' || route.RouteID == null || route.RouteID == 0) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/tracksgwebapi/api/routeinfo",
                            type: "POST",
                            ...
                            success: function (res) {
                                ...
                                table.find('tr').each(function (i) {
                                    ...
                                    $.ajax({
                                        url: "https://app.track-asia.com/tracksgwebapi/api/routelocationinfo",
                                        type: "POST",
