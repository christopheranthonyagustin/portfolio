...
if (getSessionstorageValueRoleID == 1) {
    ...
    company = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/companyinfo?&ResellerID=" + "4", function (data) {
    ...
    company = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/companyinfo?ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
    ...
    company = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/companyinfo?CompanyID=" + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIDriver = 'https://app.track-asia.com/tracksgwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID;
}
else if (getSessionstorageValueRoleID >= 3) {
...
//On Load Category
var category = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/categoryinfo", function (data) {
    $.each(data, function (index, item) {
...
//populate the Drop Down List
//On Load Make
var make = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/makeinfo", function (data) {
    $.each(data, function (index, item) {
...
var selectedDevice = "";
var device = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/deviceinfo", function (data) {
    $.each(data, function (index, item) {
...
var transmission = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/transmissioninfo", function (data) {
    $.each(data, function (index, item) {
...
var fueltype = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/fueltypeinfo", function (data) {
    $.each(data, function (index, item) {
...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                WebAPIDriver = 'https://app.track-asia.com/tracksgwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }
            ...
            if (getSessionstorageValueRoleID == 1) {
                getZone = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                ...
                getZone = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
                ...
                getZone = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
         ...
         WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        
        } else {

         WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        }
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '4' + '&CompanyID=' + '2';

    }
    else if (getSessionstorageValueRoleID == 2)
    {

        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
    ...
    if (getSessionstorageValueRoleID > 3) {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you want to delete ?</div>", function (result) {
            ...
            if (result) {
                ...
                var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/assetinfo/' + asset_id;
...
function viewservices(asset_id) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://app.track-asia.com/tracksgwebapi/api/serviceinfo?CompanyID=" + getSessionstorageValueCompanyID + "&AssetID=" + asset_id,
        async: false,
        data: {
            get_param: 'value'
        },
        ...
        success: function (data) {
            ...
            $("<div id='viewServicesForms'>").dialog({
                ...
                open: function () {
                    ...
                    var WebAPIService = 'https://app.track-asia.com/tracksgwebapi/api/servicetypeinfo/';
...
function deleteservices(value) {
    ...
    bootbox.confirm("<div style='color:black'>Are you sure you wish to delete?</div>", function (result) {
        if (result) {
            ...
            var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/servicinginfo/' + value.ServiceID;
                ...
                if (moment(validDate).isValid() && moment(validDateRxTime).isValid()) {
                    ...
                    bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                        if (result) {
                            ...
                            $.ajax({
                                url: "https://app.track-asia.com/tracksgwebapi/api/servicinginfo?id=" + value.ServiceID,
                                type: "PUT",
                                data: JSON.stringify(service),
                                crossDomain: true,
                                contentType: 'application/json; charset=utf-8',
...
function viewcontracts(asset_id) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://app.track-asia.com/tracksgwebapi/api/contractinfo?CompanyID=" + getSessionstorageValueCompanyID + "&AssetID=" + asset_id,
        async: false,
        data: {
            get_param: 'value'
        },
        ...
        success: function (data) {
            ...
            $("<div id='viewContractForms'>").dialog({
                ...
                open: function () {
                    ...
                    var WebAPIContract = 'https://app.track-asia.com/tracksgwebapi/api/contracttypeinfo/';
                    ...
                    var WebAPINotifInterval = "https://app.track-asia.com/tracksgwebapi/api/notificationintervalinfo?Description=Days";
                    ...
                    $('#contract_unit').on('change', function () {
                        ...
                        if (selectedUnit) {
                            ...
                            var notif_interval = $.getJSON("https://app.track-asia.com/tracksgwebapi/api/notificationintervalinfo?Description=" + selectedUnit, function (data) {
                                $.each(data, function (index, item) {
                            ...
                            if ($('#contract_name').val() && $('#contract_price').val()) {
                                ...
                                bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                                    if (result) {
                                        ...
                                        $.ajax({
                                            url: "https://app.track-asia.com/tracksgwebapi/api/contractinfo",
                                            type: "POST",
                                            ...
                                            success: function (res) {
                                                ...
                                                for (var i = 0; i < results.length; i++) {
                                                    ...
                                                    $.ajax({
                                                        url: "https://app.track-asia.com/tracksgwebapi/api/contractalertinfo",
                                                        type: "POST",
                                                        async: false,
                ...
                if (moment(validDateStart).isValid() && moment(validDateEnd).isValid()) {
                    ...
                    bootbox.confirm("<div style='color:red'>Warning!!! This action might affect the existing Contracts. <div style='color:black'>Are you sure you wish to submit?</div></div>", function (result) {
                        if (result) {
                            ...
                            $.ajax({
                                url: "https://app.track-asia.com/tracksgwebapi/api/contractinfo?id=" + value.ContractID,
                                type: "PUT",
                                data: JSON.stringify(contract),
                                crossDomain: true,
                                contentType: 'application/json; charset=utf-8',
                                ...
                                success: function (res) {
                                    ...
                                    $.ajax({
                                        url: "https://app.track-asia.com/tracksgwebapi/api/contractalertinfoex/" + value.ContractID,
                                        type: "Delete",
                                        async: false,
...
function deletecontract(value) {
    ...
    bootbox.confirm("<div style='color:black'>Are you sure you wish to delete?</div>", function (result) {
        if (result) {
            ...
            var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/contractinfo/' + value.ContractID;
...
function viewcontractalert(value) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://app.track-asia.com/tracksgwebapi/api/contractalertinfo?ContractID=" + value.ContractID + "&CompanyID=" + getSessionstorageValueCompanyID,
        async: false,
        data: {
            get_param: 'value'
        },
...
function editcontractalert(value) {
    ...
    $("<div id='editContractAlertForms'>").dialog({
        ...
        open: function () {
            ...
            //Populate Flag Value
            var WebAPISystem = "https://app.track-asia.com/tracksgwebapi/api/flaginfo";
            var filter = $.getJSON(WebAPISystem, function (data) {
                $.each(data, function (index, item) {
                    ...
                    if ($('#edit_contract_status').val() == 2) {
                        ...
                        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                            if (result) {
                                ...
                                $.ajax({
                                    url: "https://app.track-asia.com/tracksgwebapi/api/contractalertinfo?id=" + value.ContractAlertID,
                                    type: "PUT",
                                    data: JSON.stringify(contract_alert),
                                    crossDomain: true,
                                    contentType: 'application/json; charset=utf-8',
                ...
                if (isEmpty($('#cancelRemarks').val()) == false) {
                    ...
                    bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                        if (result) {
                            ...
                            var updateContract = 'https://app.track-asia.com/tracksgwebapi/api/contractalertinfo?id=' + value.ContractAlertID;
...
function deletecontractalert(value) {
    ...
    bootbox.confirm("<div style='color:black'>Are you sure you wish to delete?</div>", function (result) {
        if (result) {
            ...
            var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/contractalertinfo/' + value.ContractAlertID;
...
if (getSessionstorageValueRoleID == 1)
    {
        getZone = 'https://app.track-asia.com/tracksgwebapi/api/zonefilterinfo?ResellerID=' + '4' + '&CompanyID=' + '2';
        ...
        getZone = 'https://app.track-asia.com/tracksgwebapi/api/zonefilterinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
