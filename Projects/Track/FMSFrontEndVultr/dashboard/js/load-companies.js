...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo?ResellerID=' + selectedReseller;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo?ResellerID=' + '4';
    }
    else if (getSessionstorageValueRoleID == 2)
    {
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/companyinfo?CompanyID=' + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID;
