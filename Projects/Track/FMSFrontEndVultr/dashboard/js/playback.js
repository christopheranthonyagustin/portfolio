...
(function ($) {
    ...
    app = {
        ...
        createMap: function (element, options) {
            ...
            var marker1 = new google.maps.Marker({
                position: new google.maps.LatLng(this.route[0].PosY, this.route[0].PosX),
                map: app.map,
            ...
            var marker2 = new google.maps.Marker({
                position: new google.maps.LatLng(this.route[(app.route.length - 1)].PosY, this.route[(app.route.length - 1)].PosX),
                map: app.map,
    ...
    $(function () {
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            ...
            // route API
            var api = 'https://app.track-asia.com/tracksgwebapi/api/posinfo?Asset=' + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
	 ...
	 alert('Playback not allowed for more than 4 hours.');
     window.location.href = 'history.html';
}