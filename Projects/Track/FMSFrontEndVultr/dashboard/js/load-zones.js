...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        ...
        $('#zones-editable').bootstrapTable({
            ...
            onLoadSuccess: function (data) {
                ...
                var getSessionstorageValueZoneID = sessionStorage.getItem('setSessionstorageValueZoneID');

                if (getSessionstorageValueZoneID == 'undefined' || getSessionstorageValueZoneID == null || getSessionstorageValueZoneID == 0) {
                    console.log('add');
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + '4' + '&CompanyID=' + '2';

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
//$.getJSON("https://track-asia.com/fmswebapi/api/zonetypeinfo", function (data) {
//    $.each(data, function (index, item) {
//        $('#zoneTypeID').append(
//             $('<option></option>').val(item.ZoneTypeID).html(item.ZoneTypeID)
//         );
//    });
//    $(".selectpicker").selectpicker('refresh');
//});
...
function clearZoneForms() {

    $('#zoneID').val('');
    $('#zoneNameEN').val('');
    $('#Perimeter').val('');
    $('#zoneColor').val('');
    $('#zones-editable').bootstrapTable('refresh');
}
