...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/resellerinfo';

    } else {

        WebAPI = 'https://app.track-asia.com/tracksgwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
