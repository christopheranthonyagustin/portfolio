...
//Load Events
$.getJSON("https://app.track-asia.com/tracksgwebapi/api/statusinfo", function (data) {
    $.each(data, function (index, item) {

        if (item.StatusID == 12 || item.StatusID == 13 || item.StatusID == 17 || item.StatusID == 18) {
            $('#load-events').append(
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + '&ResellerID=' + "4" + '&CompanyID=' + "2", function (data) {
        $.each(data, function (index, item) {
    ...
    $.getJSON("https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets').append(
			 ...
			 if (index == 0) localStorage.setItem("setLocalstorageValueAsset", item.Name);
...
function roundToTwo(num) {
    ...
    //return +(Math.round(num + "e+2") + "e-2") / 1000 + ' km';
	var strVal = num / 10;
    ...
    $('.SelectReport').on('change', function () {
        ...
        function GenerateEN() {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var WebApi = "https://app.track-asia.com/tracksgwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + getSpeed + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var WebApiEvent = "https://app.track-asia.com/tracksgwebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var WebApiMessages = "https://app.track-asia.com/tracksgwebapi/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                var jobApi = 'https://app.track-asia.com/tracksgwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
                var WebApiUtilization = "https://app.track-asia.com/tracksgwebapi/api/utilizationinfo?Asset=" + getAsset + "&StartTime=" + timestamp + "&EndTime=" + rxtime;
                var WebAPIIdling = "https://app.track-asia.com/tracksgwebapi/api/idlinginfo?Asset=" + getAsset + "&IdleStart=" + timestamp + "&IdleEnd=" + rxtime;
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                    fileName: '[Positions_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'PosID',
                                url: WebApi,
                                columns: [{
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                    fileName: '[Speed_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'PosID',
                                url: WebApi,
                                columns: [{
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                    fileName: '[Mileage_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'UtilID',
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                    fileName: '[Utilization_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'UtilID',
                                url: WebApiUtilization,
                                columns: [{
                            ...
                            $('#' + Report).bootstrapTable(
                                {
                                    exportDataType: 'all',
                                    exportOptions: {
                                        fileName: '[UserLogInOut_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                    },
                                    idField: 'EventID',
                                    url: 'https://app.track-asia.com/tracksgwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID,
                                    columns: [{
                                        field: 'EventID',
                                        title: 'id',
                                        class: 'hidden-xs hidden-sm hidden-md hidden-lg hidden-desktop'
                            ...
                            $('#' + Report).bootstrapTable(
                                {
                                    exportDataType: 'all',
                                    exportOptions: {
                                        fileName: '[ZoneEnterExit_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                    },
                                    idField: 'EventID',
                                    url: WebApiEvent,
                                    columns: [{
                            ...
                            $('#' + Report).bootstrapTable(
                                {
                                    exportDataType: 'all',
                                    exportOptions: {
                                        fileName: '[SpeedLimit_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                    },
                                    idField: 'EventID',
                                    url: WebApiEvent,
                                    columns: [{
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                        fileName: '[Messages_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'MessageID',
                                url: WebApiMessages,
                                columns: [{
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                        fileName: '[Jobs_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'id',
                                url: jobApi,
                                columns: [{
                        ...
                        $('#' + Report).bootstrapTable(
                            {
                                exportDataType: 'all',
                                exportOptions: {
                                        fileName: '[Idling_Report] ' + moment.utc().add(8, 'hours').format('D-MMM-YYYY')
                                },
                                idField: 'AssetID',
                                url: WebAPIIdling,
                                columns: [{
...
$.getJSON("https://app.track-asia.com/tracksgwebapi/api/reportinfo", function (data) {
    $.each(data, function (index, item) {
		
        if (item.ReportID == 1 || item.ReportID == 2 ||  item.ReportID == 3 ||  item.ReportID == 4 ||  item.ReportID == 5 ||  item.ReportID == 6) $('#load-report').append($('<option></option>').val(item.Name).html(item.Name));
...
if (getSessionstorageValueRoleID == 1) {
	...
	localStorage.setItem("setLocalstorageValueReseller", sessionStorage.getItem('setSessionstorageValueDefaultReseller'));
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://app.track-asia.com/tracksgwebapi/api/companyinfo?CompanyID=" + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
        ...
        $.each(data, function (index, item) {
            ...
            $('#load-company').append($('<option data-icon="fa fa-building-o fa-lg"></option>').val(item.CompanyID).html(item.Name));
			if (index == 0) localStorage.setItem("setLocalstorageValueCompany", item.CompanyID);
...
$(function () {
    ...
    $('.SelectVechsFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            $.getJSON("https://app.track-asia.com/tracksgwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
...
$('#generatemobile').on('click', function () {
    ...
    localStorage.setItem("setLocalstorageValueDateTo", dateto);
	  var dateFormat = "D-MMM-YYYY, hh:mm:ss A";
	var convertTmestamp = moment(datefrom, dateFormat);
    ...
    var webapiMobile = "https://app.track-asia.com/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    var WebApiEvent = "https://app.track-asia.com/tracksgwebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    var WebApiMessages = "https://app.track-asia.com/tracksgwebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    var jobApi = 'https://app.track-asia.com/tracksgwebapi/api/jobinfo?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
	console.log(webapiMobile)
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'https://app.track-asia.com/tracksgwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: 'Timestamp',
