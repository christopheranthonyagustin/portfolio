...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    qunit: {
      ...
      all: {
          options: {
              urls: ['1.6.4', '1.7.0', '1.8.0', '1.9.0', '1.11.0', '2.0.0', '2.1.1'].map(function(version) {
                  return 'https://localhost:<%= connect.server.options.port %>/test/localizationTool.html?jquery=' + version;
              })
          }
      }
    },
