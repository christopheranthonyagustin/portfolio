package {
	...
	public class FlashMediaElement extends MovieClip {
		...
		public function FlashMediaElement() {
			...
			//_autoplay = true;
			//_mediaUrl  = "https://mediafiles.dts.edu/chapel/mp4/20100609.mp4";
			//_controlsEnabled = true;
			//_mediaUrl  = "../media/Parades-PastLives.mp3";
			//_mediaUrl  = "../media/echo-hereweare.mp4";

			//_mediaUrl = "https://video.ted.com/talks/podcast/AlGore_2006_480.mp4";
			//_mediaUrl = "rtmp://stream2.france24.yacast.net/france24_live/en/f24_liveen";

			//_mediaUrl = "https://www.youtube.com/watch?feature=player_embedded&v=yyWWXSwtPP0"; // hosea
			//_mediaUrl = "https://www.youtube.com/watch?feature=player_embedded&v=m5VDDJlsD6I"; // railer with notes
			...
			if (_isVideo) {
				if (_mediaUrl.search(/(https?|file)\:\/\/.*?\.m3u8(\?.*)?/i) !== -1) {
					...
					Security.allowDomain("https://www.dailymotion.com");
