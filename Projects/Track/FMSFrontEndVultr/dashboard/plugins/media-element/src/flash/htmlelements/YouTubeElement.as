package htmlelements {
	...
	public class YouTubeElement extends Sprite implements IMediaElement	{
		...
		//https://code.google.com/p/gdata-samples/source/browse/trunk/ytplayer/actionscript3/com/google/youtube/examples/AS3Player.as
		...
		private function getYouTubeId(url:String):String {
			// https://www.youtube.com/watch?feature=player_embedded&v=yyWWXSwtPP0
			// https://www.youtube.com/v/VIDEO_ID?version=3
			// https://youtu.be/Djd6tPrxc08
			...
			if (url.indexOf("?") > 0) {
				// assuming: https://www.youtube.com/watch?feature=player_embedded&v=yyWWXSwtPP0
				youTubeId = getYouTubeIdFromParam(url);
				
				// if it's https://www.youtube.com/v/VIDEO_ID?version=3
				if (youTubeId == "") {
		...
		public function load():void {
			...
			if (_playerIsLoaded) {
				...
				if (!_isChromless && _youTubeId != "") {
					_playerLoader.load(new URLRequest("https://www.youtube.com/v/" + _youTubeId + "?version=3&controls=0&rel=0&showinfo=0&iv_load_policy=1"));
				}
				*/
			}
		}
