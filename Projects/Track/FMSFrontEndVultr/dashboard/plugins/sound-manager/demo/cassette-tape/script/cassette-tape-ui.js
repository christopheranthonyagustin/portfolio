...
var CanvasImage = function(canvas, image) {
   ...
   * original: https://www.flother.com/blog/2010/image-blur-html5-canvas/
   *
...
function init() {
  ...
  if (soundManager.ok()) {
    ...
    s = soundManager.createSound({
      id: 'tapeSound',
      url: 'https://freshly-ground.com/data/audio/sm2/Chill With Schill (Summer 2012 Session Excerpt).mp3',
      multiShot: false,
