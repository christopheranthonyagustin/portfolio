  ...
  public class SoundManager2_SMSound_AS3 extends Sound {
    ...
    public function SoundManager2_SMSound_AS3(oSoundManager: SoundManager2_AS3, sIDArg: String = null, sURLArg: String = null, usePeakData: Boolean = false, useWaveformData: Boolean = false, useEQData: Boolean = false, useNetstreamArg: Boolean = false, netStreamBufferTime: Number = 1, serverUrl: String = null, duration: Number = 0, autoPlay: Boolean = false, useEvents: Boolean = false, autoLoad: Boolean = false, checkPolicyFile: Boolean = false) {
      ...
      if (this.useNetstream) {
        ...
        // @see onBWDone
        // @see https://www.adobe.com/devnet/flashmediaserver/articles/dynamic_stream_switching_04.html
        // @see https://www.johncblandii.com/index.php/2007/12/fms-a-quick-fix-for-missing-onbwdone-onfcsubscribe-etc.html
        this.nc.client = this;
    ...
    public function rtmpResponder(result:Object):void {
      ...
      // https://help.adobe.com/en_US/FlashMediaServer/3.5_Deving/WS5b3ccc516d4fbf351e63e3d11a0773d117-7ffe.html
      ...
      switch (event.info.code) {
        ...
        case "NetConnection.Connect.Success":
          try {
            ...
            // bufferTime reference: https://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/net/NetStream.html#bufferTime
...
writeDebug('waiting for next call...');
    ...
    public function getWaveformData() : void {
      // https://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/media/SoundMixer.html#computeSpectrum()
    ...
    public function loadSound(sURL: String) : void {
      if (this.useNetstream) {
        ...
        try {
          ...
          this.soundLoaderContext = new SoundLoaderContext(1000, this.checkPolicyFile); // check for policy (crossdomain.xml) file on remote domains - https://livedocs.adobe.com/flash/9.0/ActionScriptLangRefV3/flash/media/SoundLoaderContext.html
    ...
    public function doNetStatus(e: NetStatusEvent) : void {
      ...
      // @see https://www.actionscript.org/forums/archive/index.php3/t-159194.html
