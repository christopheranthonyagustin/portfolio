...
$(document).ready(function () {
    ...
    //Pageload
        ...
        var getUsername = localStorage.getItem("SetUsername");
		var getPassword = localStorage.getItem("SetPassword");

    //Populate 

        if (localStorage.getItem("SetUsername") == "" || localStorage.getItem("SetUsername") == "undefined" || localStorage.getItem("SetUsername") == undefined || localStorage.getItem("SetPassword") == "" || localStorage.getItem("SetPassword") == undefined || localStorage.getItem("SetPassword") == "undefined") {
			$('#username').val('');
			$('#password').val('');
		} else if (localStorage.getItem("SetUsername") !== null && localStorage.getItem("SetPassword") !== null) {
    ...
    $('#submit-user').on('click', function () {
        ...
        var url = 'https://app.track-asia.com/tracksgwebapi/api/login';
        ...
        $.ajax({
            url: "https://app.track-asia.com/tracksgwebapi/api/login",
            type: "POST",
            ...
            success: function (userlogin) {
                ...
                if (userlogin.ErrorMessage == null && userlogin.LoginRetry == "Active") {

                    //For DEMO Website
                    //if (userlogin.CompanyID == 3)
                    //{
                ...
                else if (userlogin.LoginRetry == "Locked") {
