...
namespace FMSWebApi
{
    public class Consts
    {
        ...
        public const string ERR_CUSTOMERERROR = "Driver Error";
        public const string ERR_REGIONERROR = "Region Error";
        public const string ERR_SUPPLIERERROR = "Supplier Error";
