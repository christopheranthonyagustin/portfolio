...
namespace FMSWebApi.Controllers
{
    ...
    public class CategoryInfoController : ApiController
    {
        ...
        {
            CategoryInfo currCategory = repository.Get(id);
        ...
        public CategoryInfo PostCategory(CategoryInfo currCategory)
        {
            currCategory = repository.Add(currCategory);
            return currCategory;
        }

        public void PutCategory(int id, CategoryInfo currCategory)
        {
            currCategory.CategoryID = id;
