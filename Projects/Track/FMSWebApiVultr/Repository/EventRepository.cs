...
namespace FMSWebApi.Repository
{
    public class EventRepository : IEventRepository
    {
        ...
        public EventInfo SaveLoginEvent(EventInfo currEvent)
        {
            ...
            try
            {
                using (MySqlConnection conn = new MySqlConnection(mConnStr))
                {
                    ...
                    if (strClientIP != "") currEvent.Remarks += String.Format(" (Personnel Name: {0} Device: {1})", currEvent.Driver, currAsset.Name);
                    ...
                    using (MySqlCommand cmd = new MySqlCommand())
                    {
                        ...
                        cmd.Parameters.AddWithValue("@PosID", currAsset.LastPos);
        ...
        public EventInfo SaveLogoutEvent(EventInfo currEvent)
        {
            ...
            {
                Logger.LogEvent(ex.Message + "-SaveLogoutEvent", System.Diagnostics.EventLogEntryType.Error);
            }
                        ...
                        {                                                                                          
                            try
                            {
                                                ...
                                                foreach (string strNotify in arrNotify)
                                                {
                                                   ...
                                                   // Logger.LogEvent("check event notification" + arrTemp.Count(), System.Diagnostics.EventLogEntryType.Error);
                                                    ...
                                                    if ((arrTemp[0] == udtEvent.StatusID.ToString()) && (arrTemp.Length > 1) && (arrTemp[1].Length > 1))
                                                    {
                                                        ...
                                                        //Logger.LogEvent("get contact info email: " + strEmail, System.Diagnostics.EventLogEntryType.Warning);
                                                        //Logger.LogEvent("get contact info phone: " + strPhone, System.Diagnostics.EventLogEntryType.Warning);
                                ...
                                foreach (string strPhone in arrSms)
                                {
                                    ...
                                    messageRepo.AddMessage(udtMessage);
                                ...
                                {
                                    //Logger.LogEvent("Email: " + strEmail, System.Diagnostics.EventLogEntryType.Warning);
                                    // send notification
