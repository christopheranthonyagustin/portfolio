...
namespace FMSWebApi
{
    public static class Logger
    {
        ...
        public static void LogEvent(string projName, string strMsg, EventLogEntryType logType)
        {
            ...
            {
                LogEvent(string.Format("ProjName: {0} Msg: {1} instanceName: {2} Exception: {3}", projName, strMsg, instanceName, ex.Message), System.Diagnostics.EventLogEntryType.Error);
            }
        }
        ...
        public static string LogError(string strError, string strSql)
        {
            ...
            {
                // log event
                string strLog = String.Format("AcecomWeb: {0}\r\n\"{1}\"", strError, strSql);
                LogEvent(strLog, 2);
            }
            catch { }
            return strError;
