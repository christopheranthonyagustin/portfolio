...
namespace FMSMsg
{
    ...
    partial class Service1 : ServiceBase
    {
        ...
        public void RunService()
        {
            ...
            {
                // initialize settings
                FmsWcfClient svcTrack = new FmsWcfClient();//Made service to close immediately
                ...
                if (Settings.Default.IsSMS) SendSMS("+6598637670", msg);
                if (Settings.Default.IsSMS) SendSMS("+6584901968", msg);
        ...
        private void TestEmail()
        {
            try
            {
                ...
                eMail.To.Add(new MailAddress("anthony_agustin@acecom.com.sg"));

                // set email content
                eMail.Subject = "TRACK-Email Test";
                eMail.Body = "Test For TRACK Email Alert";
