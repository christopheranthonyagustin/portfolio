            ...
            try
            {
                ...
                if (bConnected)
                {
                    ...
                    if (iLen > 0)
                    {
                        ...
                        //    //string utf8_String = "A,L\n\r";
                        //    string utf8_String = String.Format("A,L" + CR);
                        //    byte[] bytes = Encoding.Default.GetBytes(utf8_String);
                        //    var myString = Encoding.UTF8.GetString(bytes);

                        //    Send(utf8_String, sockInfo.Socket, false);
                        //    //string strAck = String.Format(utf8_String);
                        //    //sockInfo.Socket.Send(strAck.ToByteArray());

                        //   // sockInfo.Socket.Send(Encoding.ASCII.GetBytes(myString));
                        //   // Broadcast(myString);
                        //    //strTemp = strTemp.Replace("L", "\r");


                        //    Logger.LogToEvent("MobileEye Server Reply: " + strTemp, System.Diagnostics.EventLogEntryType.Warning);//testing
                        //}
                        ...
                        //{
                        //    Send("$L#", sockInfo.Socket, false);
                        //}

                        ////AVL301
                        //else if (strTemp.StartsWith("$H"))
                        //{
                        //    Send("$H#", sockInfo.Socket, false);
                        //}
                        ...
                        //    strTemp = String.Format("~{0}\r", strHex);
                        //    Logger.LogToEvent("AVL301 to strHex: " + strTemp, System.Diagnostics.EventLogEntryType.Warning);//testing
