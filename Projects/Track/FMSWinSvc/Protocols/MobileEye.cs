        ...
        public FMSWebApi.Models.PosInfo ParseData(string rawData)
        {
            ...
            try
            {
                ...
                */
                ...
                Logger.LogToEvent("MobileEye RawData: " + rawData, System.Diagnostics.EventLogEntryType.Warning);
                ...
                if (rawData.Contains(Consts.MobileEye_HEAD))
                {
                    ...
                    //get IMEI/Device ID
                    deviceID = arrData[1].Substring(0, 6);
                    newdata = rawData.Substring(Consts.MobileEye_HEAD.Length + deviceID.Length);
    

                    Logger.LogToEvent("MobileEye DeviceID: " + deviceID, System.Diagnostics.EventLogEntryType.Warning);
