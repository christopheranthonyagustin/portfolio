...
namespace FMSWebApi.Repository
{
    ...
    {
        private string mConnStr = "server=103.237.168.119;uid=root;pwd=@c3c0M;database=tracksg;default command timeout=360;";
        private string mConnStrSMS = "server=103.237.168.119;uid=root;pwd=@c3c0M;database=ads;default command timeout=360;";
        ...
        public string SendMessage(MessageInfo udtMessage)
        {
            ...
            try
            {
                using (MySqlConnection conn = new MySqlConnection(mConnStrSMS))
                {
