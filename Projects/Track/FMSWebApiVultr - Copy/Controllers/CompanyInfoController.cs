...
namespace FMSWebApi.Controllers
{
    ...
    public class CompanyInfoController : ApiController
    {
        ...
        [Route("api/fileupload/uploadfilecompany")]
        [HttpPost]
        public void UploadFileCompany()
        {
            try
            {
                if (HttpContext.Current.Request.Files.AllKeys.Any())
                {
                    ...
                    var httpPostedFile = HttpContext.Current.Request.Files["UploadedImageCompany"];
                    ...
                    if (httpPostedFile != null)
                    {
                        ...
                        var fileSavePath = Path.Combine(HttpContext.Current.Server.MapPath("~/images/companies"), httpPostedFile.FileName);
            ...
            {
                Logger.LogEvent(ex.Message + "-(Get File Company)", System.Diagnostics.EventLogEntryType.Error);
            }
        }
    }
}
