$(document).ready(function () {
    ...
    $('#load-versionEN').on('click', function () {
        ...
        bootbox.dialog({
            title: "About TRACK",
            message: '<div class="media"><div class="media-left"><img class="media-object" src="img/logo.png" alt="Version" style="width:150px;"></div><div class="media-body"><h4 class="text-thin"><strong>TRACK</strong> - Fleet Management System</h4>version&nbsp;' + version + '</div></div><br />' + '<div><textarea id="load-ver" name="load-ver" rows="7" cols="73" class="text-dark text-thin"></textarea></div>',
            callback: function (result) {
                //Callback function here
            },
            animateIn: 'zoomInDown',
