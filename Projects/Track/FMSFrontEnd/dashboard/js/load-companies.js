...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://track.asiacom.co.th/tracksgwebapi/api/companyinfo?ResellerID=' + selectedReseller;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        WebAPI = 'http://103.237.168.119/tracksgwebapi/api/companyinfo?ResellerID=' + '4';
    }
    else if (getSessionstorageValueRoleID == 2)
    {
        WebAPI = 'http://track.asiacom.co.th/tracksgwebapi/api/companyinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
        WebAPI = 'http://track.asiacom.co.th/tracksgwebapi/api/companyinfo?CompanyID=' + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID;
...
//Total Companies
var url = 'http://103.237.168.119/tracksgwebapi/api/companyinfo';
