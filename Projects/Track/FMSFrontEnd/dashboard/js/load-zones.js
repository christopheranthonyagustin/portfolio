...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://103.237.168.119/tracksgwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://103.237.168.119/tracksgwebapi/api/zoneinfo?ResellerID=' + '4' + '&CompanyID=' + '2';

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://103.237.168.119/tracksgwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
//$.getJSON("http://103.237.168.119/fmswebapi/api/zonetypeinfo", function (data) {
//    $.each(data, function (index, item) {
//        $('#zoneTypeID').append(
