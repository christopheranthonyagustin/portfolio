...
var i = 0;
    ...
    function setLines(map, lines) {
        ...
        webapi = "http://103.237.168.119/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
 ...
 */
    function playAnimate() {
        ...
        url = "http://103.237.168.119/tracksgwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    * Pausing...
    ...
    function setZones(map, zones, callback) {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            url = 'http://103.237.168.119/tracksgwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller + '&CompanyID=' + getLocalstorageValueCompany;

        } else if (getSessionstorageValueRoleID == 2) {

            url = 'http://103.237.168.119/tracksgwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller;
