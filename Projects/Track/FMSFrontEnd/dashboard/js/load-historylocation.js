...
$(document).ready(function () {
    ...
    function setLines(map, lines) {
        ...
        var url = "http://103.237.168.119/tracksgwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
        ...
        if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
            ...
            var WebApi = "http://103.237.168.119/tracksgwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
