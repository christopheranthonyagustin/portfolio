...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://103.237.168.119/tracksgwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://103.237.168.119/tracksgwebapi/api/driverinfo?ResellerID=' + '4' + '&CompanyID=' + '2';
    } else if (getSessionstorageValueRoleID == 2) {

        WebAPI = 'http://103.237.168.119/tracksgwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID >= 3) {
