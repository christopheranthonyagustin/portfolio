...
namespace FMSWebApi.Repository
{
    ...
    {
        private string mConnStr = "server=localhost;uid=root;pwd=@c3c0M;database=tracksg;";
        private string mConnStrSMS = "server=localhost;uid=root;pwd=@c3c0M;database=ads;";
