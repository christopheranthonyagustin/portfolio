...
namespace FMSWebApi.Repository
{
    public class RoleRepository : IRoleRepository
    {
        ...
        private string mConnStr = "server=localhost;uid=root;pwd=@c3c0M;database=tracksg;max pool size=500;Connection Timeout=9999;";
        ...
        public IEnumerable<RoleInfo> GetByRoleID(RoleInfo param)
        {
            ...
            //Logger.LogEvent("GetQuery Role Repository: " + query, System.Diagnostics.EventLogEntryType.Information);//TESTING
