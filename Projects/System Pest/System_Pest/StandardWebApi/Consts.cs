...
namespace FMSWebApi
{
    public class Consts
    {
        public const string PROJECT_NAME = "SP";
		public const int MIN_SPEED = 5;
        public const string DBConnStr = "server=localhost;uid=root;pwd=@c3c0M;database=sp;";
        ...
        public const string ERR_CUSTOMERERROR = "Customer Error";
    }
}