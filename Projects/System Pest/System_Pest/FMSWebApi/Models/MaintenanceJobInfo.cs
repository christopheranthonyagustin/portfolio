...
namespace FMSWebApi.Models
{
    public class MaintenanceJobInfo
    {
        ...
        public string MainTechSignatures { get; set; }
        public string MainTechFillSignatures { get; set; }
        public string MainClientSignatures { get; set; }
        public string MainClientFillSignatures { get; set; }
        public string MainForms { get; set; }
        public string MainFormsFill { get; set; }
        ...
        public string PestTreatment { get; set; }
