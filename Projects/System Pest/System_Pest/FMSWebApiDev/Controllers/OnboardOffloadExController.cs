...
namespace FMSWebApi.Controllers
{
    ...
    public class OnboardOffloadExController : ApiController
    {
        private static readonly IAssetRepository repository = new AssetRepository();

               public string Get()
        {
            return "Onboard/Offload Ex";
        }

        public OnboardOffloadInfo Post([FromBody]OnboardOffloadInfo item)
        {
            ...
            item = repository.OnboardOffloadEx(item);
            return item;
        }
