...
function timeTableDisplayFormatter(value) {
    //Format UTC
    var timestamp = moment(value).add('hours', 8).format('hh:mm A');
    return timestamp;
}
                                                        ...
                                                        if (getGroup == jobs[k].Groups) {
                                                            ...
                                                            if (timeTableDateFormatter(jobs[k].Timestamp) == timestamp) {
                                                                if (timeTableFormatter(jobs[k].Timestamp) > '0359' && timeTableFormatter(jobs[k].Timestamp) < '0800') {
                                                                    ...
                                                                    jobInformation += "Company : " + formtypeFormatter(jobs[k].AssetCompanyID) +
                                                                        ...
                                                                        "Remarks : " + remarks +
                                                                        "<br style='mso-data-placement:same-cell;' />" +
                                                                        "Technician : " + "<span id=driverTable onclick=changeMainDriver(" + jobs[k].MaintenanceJobID + ") style='color: cornflowerblue;'>" + driverFormatter(jobs[k].DriverName) + "</span>" +
                                                                        "<br style='mso-data-placement:same-cell;' />" +
                                            ...
                                            if (getGroup == jobs[k].Groups) {
                                                if (timeTableDateFormatter(jobs[k].Timestamp) == timestamp) {
                                                    if (timeTableFormatter(jobs[k].Timestamp) > '0359' && timeTableFormatter(jobs[k].Timestamp) < '0800') {
                                                        ...
                                                        var finalRemarks = jobs[k].Remarks.split('~');
                                                        var remarks = finalRemarks[0];
                                                        jobInformation += "Time : " + timeTableDisplayFormatter(jobs[k].Timestamp) +
                                                            "<br style='mso-data-placement:same-cell;' />" +
                                                ...
                                                if (timeTableDateFormatter(jobs[k].Timestamp) == timestamp) {
                                                    if (timeTableFormatter(jobs[k].Timestamp) > '0359' && timeTableFormatter(jobs[k].Timestamp) < '0800') {
                                                        ...
                                                        if (jobs[k].GeneralLocation == data[j].GeneralLocation) {
                                                            ...
                                                            jobInformation += "Company : " + formtypeFormatter(jobs[k].FormType) +
                                                                "<br style='mso-data-placement:same-cell;' />" +
                                                                "Time : " + timeTableDisplayFormatter(jobs[k].Timestamp) +
                                                                "<br style='mso-data-placement:same-cell;' />" +
                                                                "Customer Company : " + jobs[k].Company +
