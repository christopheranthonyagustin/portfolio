...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID;
            ...
            if (getSessionstorageValueRoleID == 1) {
                getZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                ...
                getZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
                ...
                getZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            ...
            if (getSessionstorageValueRoleID == 1 || getSessionstorageValueRoleID == 2) {
                ...
                $.getJSON("https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=" + getReseller + "&CompanyID=" + selectedCompany, function (data) {
                    $.each(data, function (index, item) {
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
         ...
         WebAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        
        } else {

         WebAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        ...
        $('#vehicles-editable').bootstrapTable({
            ...
            onUncheck: function (row) {
                ...
                $('#assetDevice').find('[value="' + row.Tag + '"]').remove();
                $('.selectpicker').selectpicker('refresh');
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    }
    else if (getSessionstorageValueRoleID == 2)
    {

        WebAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
        ...
        onCheck: function (row) {
            ...
            if (getCheckbox == 1)
            {
                ...
                if (row.Key > 0) {
                    ...
                    var assetDevice = $("#assetDevice").append('<option value="' + row.Tag + '" selected="selected">' + row.Key + '</option>');
                }
                else {
...
{
    $('#main-wz-vehicle').bootstrapWizard('first');
}
...
function clearInputField(){
    ...
    $('#assetMileage').val("");
    $('#assetMileageEN').val("");
    $('#assetDistanceAlert').val("");
    $('#assetDistanceAlertEN').val("");
    $('#assetDateAlert').val("");
    $('#assetDateAlertEN').val("");
    $('#assetIdlingLimit').val("");
    $('#assetIdlingLimitEN').val("");
    $('#assetSpeedLimit').val("");
...
var getZone = "";
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        getZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    {
        $.getJSON("https://app.track-asia.com/spwebapi/api/deviceinfo", function (data) {
            $.each(data, function (index, item) {
                var AssignedTags = item.AssetID;
    ...
    else if (getSessionstorageValueTrackVersion == "vn" || getSessionstorageValueTrackVersion == "th" || getSessionstorageValueTrackVersion == "id")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            $.getJSON("https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=" + "1" + "&CompanyID=" + "1", function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
            ...
            $.getJSON("https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID, function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
