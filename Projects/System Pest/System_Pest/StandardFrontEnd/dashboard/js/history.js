...
var i = 0;
    ...
    function setLines(map, lines) {
        ...
        webapi = "https://app.track-asia.com/spwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
 ...
 */
    function playAnimate() {
        ...
        url = "https://app.track-asia.com/spwebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    * Pausing...
    ...
    function setZones(map, zones, callback) {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller + '&CompanyID=' + getLocalstorageValueCompany;

        } else if (getSessionstorageValueRoleID == 2) {

            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller;
