...
var getSessionstorageValueCompanyName = sessionStorage.getItem('setSessionstorageValueCompany');
...
else if (getSessionstorageValueRoleID == 2)
{
    ...
    $('#load-company').append($('<option selected="selected"></option>').val(getSessionstorageValueCompanyID).html(getSessionstorageValueCompanyName));
    //$(".selectpicker").selectpicker('refresh');
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        {
            var WebAPI = 'https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        }
        else if (getSessionstorageValueTrackVersion == "sg")
        {
            var WebAPI = 'https://app.track-asia.com/spwebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        }
        ...
        $('#devices-editable').bootstrapTable({
            ...
            onCheck: function (row) {
                $("#toggle-aside").hide();
                if (getSessionstorageValueUserID < 4)
                {
                    $("#toggle-aside2").show();
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueTrackVersion == "vn" || getSessionstorageValueTrackVersion == "th" || getSessionstorageValueTrackVersion == "id")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            DeviceAPI = "https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=" + "1" + "&CompanyID=" + "1";
        }
        else if (getSessionstorageValueRoleID == 2)
        {
            DeviceAPI = "https://app.track-asia.com/spwebapi/api/devicetaginfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
    }
    else if (getSessionstorageValueTrackVersion == "sg")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            DeviceAPI = "https://app.track-asia.com/spwebapi/api/deviceinfo?ResellerID=" + "1" + "&CompanyID=" + "1";
        }
        else if (getSessionstorageValueRoleID == 2) {
            DeviceAPI = "https://app.track-asia.com/spwebapi/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
        else if (getSessionstorageValueRoleID == 3) {
            DeviceAPI = "https://app.track-asia.com/spwebapi/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
