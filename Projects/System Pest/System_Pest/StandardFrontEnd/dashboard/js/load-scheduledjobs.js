...
if (getSessionstorageValueCompanyID == 1) {
    groupApi = 'https://app.track-asia.com/spwebapi/api/groupinfo';
} else if (getSessionstorageValueCompanyID == 2) {
    groupApi = 'https://app.track-asia.com/spwebapi/api/groupmyinfo';
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
function GenerateAreaTable() {
    ...
    if (getSessionstorageValueCompanyID == 1) {
        ...
        acAPI = 'https://app.track-asia.com/spwebapi/api/acinfo?Groups=' + $('#load-groups').val();

    } else if (getSessionstorageValueCompanyID == 2) {

        acAPI = 'https://app.track-asia.com/spwebapi/api/acmyinfo?Groups=' + $('#load-groups').val();
    ...
    var WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&FormType=' + getSessionstorageValueCompanyID + '&Groups=' + getGroup;

    var WebAPIMainJobs = 'https://app.track-asia.com/spwebapi/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&Groups=' + getGroup;
...
function changeDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfo/' + jobid;
...
function changeMainDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo/' + jobid;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    //var WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
                    var WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
                    //console.log(WebAPIJobs);
                    $.ajax({
                        async: false,
                        type: 'GET',
                            ...
                            if (jobs.length <= 0) {
                                ...
                                for (var q = 0; q < 8; q++) {
                                    if (q == 0) {
                                        ...
                                        if (jobs.length <= 0) {
                                            var WebAPIMainJobs = 'https://app.track-asia.com/spwebapi/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
                                            ...
                                            for (var k = 0; k < jobs.length; k++) {
                                                ...
                                                if (k + 1 == jobs.length) {
                                                    // if(hasJob){
                                                    //     markup += "<td style='font-size: 10px;padding: 5px;white-space: nowrap;'>" + jobInformation + "</td>"
                                                    //     //console.log("Job : True at " + jobInformation);
                                                    // }else{
                                                    //     markup += "<td style='font-size: 10px;padding: 10px;'></td>"
                                                    //     //console.log("Job : False");
                                                    // }
                                                        ...
                                                        success: function (jobs) {
                                                            ...
                                                            if (jobs.length <= 0) {
                                                                ...
                                                                for (var k = 0; k < jobs.length; k++) {
                                                                    ...
                                                                    var convertTimestamp = moment(getTimestamp, dateFormat);
                                                                    var checkTimestamp = moment(convertTimestamp).format(dateFormat);
                                                                    //if (jobs[k].MaintenanceJobID == 85261) alert("Maintenance ID:" + jobs[k].MaintenanceJobID + "Timestamp: " + timeTableFormatter(jobs[k].Timestamp));
                                                                    //if (jobs[k].MaintenanceJobID == 85261) alert("Maintenance ID:" + jobs[k].MaintenanceJobID + " Timestamp: " + timeTableDateFormatter(jobs[k].Timestamp) + " Check Timestamp: " + checkTimestamp);

                                                                    if (timeTableFormatter(jobs[k].Timestamp) > '0759' && timeTableFormatter(jobs[k].Timestamp) < '1000' && checkTimestamp == timeTableDateFormatter(jobs[k].Timestamp) == true) {
                                        ...
                                        if (jobs.length <= 0) {
                                            ...
                                            for (var k = 0; k < jobs.length; k++) {
                                                ...
                                                var checkTimestamp = moment(convertTimestamp).format(dateFormat);
                                                //#2
                                                if (timeTableFormatter(jobs[k].Timestamp) > '1959' == true && checkTimestamp > timeTableDateFormatter(jobs[k].Timestamp) == false) {
                                                    for (var p = 0; p < jobs[k].Pest.length; p++) {
                                                        pestIncluded += jobs[k].Pest[p].PestDesc + " "
                                                    }
                                                    var finalRemarks = jobs[k].Remarks.split('~');
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'https://app.track-asia.com/royal/'; //Login URL
...
function reloadCalendar() {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var rxtime = moment(convertRxtime).subtract('hours', 8).format(dateFormat);
    var jobApi = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
