...
//Load Events
$.getJSON("https://app.track-asia.com/spwebapi/api/statusinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    {
        $('#load-assets').append($('<option value="" selected=""></option>').val('').html("Tất Cả"));
    }
    else if (getSessionstorageValueLanguage == "id")
    {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + '&ResellerID=' + "1" + '&CompanyID=' + "1", function (data) {
        $.each(data, function (index, item) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets').append(
...
$.getJSON("https://app.track-asia.com/spwebapi/api/inventoryinfo?CompanyID=" + getSessionstorageValueCompanyID, function (data) {
    $.each(data, function (index, item) {
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + "1", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo", function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
...
$.getJSON("https://app.track-asia.com/spwebapi/api/categoryinfo", function (data) {
    $.each(data, function (index, item) {
...
function clientsignatureFormatter(value, row) {
    var labelColor;
    var text;
    if (row.ClientSignaturesFill == "Uniform") {
        text = value;

        return '<center><div style="color:black;"><a href="' + text + '" class="btn-link" data-toggle="lightbox" data-title="' + 'Supervisor Signature' + '"><img src="' + text + '" class="img-responsive" alt="' + text + '" height="30" width="30"></a></div></center>';

    } else if (row.ClientSignaturesFill != "Uniform") {
        labelColor = "dark";
        if (getSessionstorageValueLanguage == "en") {
            text = "No Signature Photo";
        }
...
function techsignatureFormatter(value, row) {
    var labelColor;
    var text;

    if (row.TechSignaturesFill == "Uniform") {
        text = value;
		

        return '<center><div style="color:black;"><a href="' + text + '" class="btn-link" data-toggle="lightbox" data-title="' + 'Supervisor Signature' + '"><img src="' + text + '" class="img-responsive" alt="' + text + '" height="30" width="30"></a></div></center>';

    } else if (row.TechSignaturesFill != "Uniform") {
        labelColor = "dark";
        if (getSessionstorageValueLanguage == "en") {
            text = "No Signature Photo";
        }
...
function formsFormatter(value, row) {
    var labelColor;
    var text;
	var returnHtml;
    if (row.FormsFill == "Uniform") {
        text = value;
		returnHtml = '<center><div style="color:black;"><a href="' + value + '" class="btn-link" data-title="' + row.JobNumber + '"><i class="fa fa-file-pdf-o fa-lg" style="color:white;"></i></a></div></center>';
		//alert(returnHtml)
		return returnHtml
		} else if (row.FormsFill != "Uniform") {
        labelColor = "white";
        if (getSessionstorageValueLanguage == "en") {
            text = "No PDF";
        }
    ...
    function Generate() {
        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var WebApiBarlight = "";
                var jobApi = "";
                var WebApiMessages = "https://app.track-asia.com/spwebapi/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                
                var inventoryAPI = 'https://app.track-asia.com/spwebapi/api/inventoryhistoryinfo?CompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Reference=' + getReference;
                ...
                if (getAsset == "")
                {
                    ...
                    WebApiCVR = "https://app.track-asia.com/spwebapi/api/cvrinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMeterPerSeconds;
                    WebApi = "https://app.track-asia.com/spwebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMeterPerSeconds;
                    WebApiBarlight = "https://app.track-asia.com/spwebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Barlight=1";
                    jobApi = 'https://app.track-asia.com/spwebapi/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    WebApiCVR = "https://app.track-asia.com/spwebapi/api/cvrinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApi = "https://app.track-asia.com/spwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApiBarlight = "https://app.track-asia.com/spwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&Barlight=1" + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    jobApi = 'https://app.track-asia.com/spwebapi/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;            
                }
                ...
                if (getLocalstorageValueRetrieveReport == "reports-positions") {
                    ...
                    if (strEvent == 1 | strEvent == 2) {
                        WebApiEvent = "https://app.track-asia.com/spwebapi/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                    ...
                    else if (strEvent == 12 | strEvent == 13) {
                        WebApiEvent = "https://app.track-asia.com/spwebapi/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                        ...
                        WebApiEvent = "https://app.track-asia.com/spwebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                        ...
                        $('#' + getLocalstorageValueRetrieveReport).bootstrapTable(
                            {
                                ...
                                // }, 
								{
                                    ...
                                    field: 'ClientSignatures',
                                    title: 'Client Signature',
                                    formatter: 'clientsignatureFormatter'
                                }, {
                                    field: 'TechSignatures',
                                    title: 'Technician Signature',
                                    formatter: 'techsignatureFormatter'
                                }, {
                                    field: 'Forms',
                                    title: 'Forms',
                                    formatter: 'formsFormatter'
                                }],
...
$.getJSON("https://app.track-asia.com/spwebapi/api/reportinfo", function (data) {
    $.each(data, function (index, item) {

        if (item.Name != "Type" && item.Name != "Mileage" && item.Name != "Messages" && item.Name != "Comprehensive Report" && item.Name != "Barlight" && item.Name != "Paramedic" && item.Name != "Payment" && item.Name != "Trip")
            if (getSessionstorageValueLanguage == "en")
            {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAgent = 'https://app.track-asia.com/spwebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

} else if (getSessionstorageValueRoleID == 2) {
    WebAPIAgent = 'https://app.track-asia.com/spwebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
    ...
    else if (getSessionstorageValueLanguage == "th")
    {
        ...
        $('#agent').append($('<option value="" selected="selected"></option>').val('').html("Tất Cả"));
    }
    else if (getSessionstorageValueLanguage == "id") {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    MobileWebAPIReseller = 'https://app.track-asia.com/spwebapi/api/resellerinfo';
    ...
    MobileWebAPIReseller = 'https://app.track-asia.com/spwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "https://app.track-asia.com/spwebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "https://app.track-asia.com/spwebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "https://app.track-asia.com/spwebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'https://app.track-asia.com/spwebapi/api/jobhistory?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'https://app.track-asia.com/spwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: titleTimestamp,
...
if (getSessionstorageValueLanguage == "en") {
    ...
    $(".allReport").text("Tất Cả");
    $(".jobStatusAll").text("Tất Cả");
    $(".driverAll").text("Tất Cả");
