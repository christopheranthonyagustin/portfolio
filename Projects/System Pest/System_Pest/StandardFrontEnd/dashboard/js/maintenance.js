...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "https://app.track-asia.com/spwebapi/api/pestinfo";
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    } else if (getSessionstorageValueRoleID == 2) {
        WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(function () {
    ...
    //Populate phone user
    var WebAPITreatment = "https://app.track-asia.com/spwebapi/api/treatmentinfo";
        ...
        if ($("#jobOtherPest").val() != '') {
            if($("#jobOtherTreatment").val() != ''){
                ...
                $.niftyNoty({
                    ...
                    message: "Item cannot be added. Description must not be empty!",
                    container: 'floating',
                    timer: 3000
                });
            }
            ...
            $.niftyNoty({
                type: 'danger',
                icon: 'fa fa-exclamation-triangle',
                message: 'Item cannot be added. Item must not be empty!',
                container: 'floating',
                timer: 3000
            });
        }
...
function reloadJobsCreated() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/maintenanceinfo?CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID == 2) {
...
function searchJobFilter() {
    ...
    WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/maintenancefilterinfo?CompanyID=' + getSessionstorageValueCompanyID + '&CusCompany=' + companyName + '&PIC=' + personInCharge + '&Postal=' + postalCode + '&Address=' + address;
...
function viewjob(job_id) {
    ...
    var WebAPI = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo?MaintenanceID=' + job_id;
    $.ajax({
        type: 'GET',
        url: WebAPI,
        async: false,
                                ...
                                for (j = 0; j < value.length; j++) {
                                    ...
                                    if (j + 1 == value.length) {
                                        markup += "<tr>" +
                                            ...
                                            "</td>" +
                                            "<td style='padding: 5px;'>" +
                                            editactionFormatter(data[k].MaintenanceJobID) + " " + deleteactionFormatter(data[k].MaintenanceID, data[k].MaintenanceJobID) + 
                                            "</td>" +
                                            "</tr>"
                                    }
                                }
    ...
    if (getSessionstorageValueRoleID > 3) {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
            if (result) {
                ...
                var WebAPI = 'https://app.track-asia.com/spwebapi/api/maintenanceinfo/' + job_id;
                ...
                if($('#update_reference_no').val() == ''){
                    ...
                    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to update all reference no?" + "</div>", function (result) {
                        if (result) {
                            ...
                            var updateReferenceNo = 'https://app.track-asia.com/spwebapi/api/maintenancejobreference?id=' + maintenance_id;
                            $.ajax({
...
function enableEmailNotification(maintenance_id) {
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to enable all email notification?" + "</div>", function (result) {
        if (result) {
            ...
            var updateMaintenanceJob = 'https://app.track-asia.com/spwebapi/api/maintenancejobalert?id=' + maintenance_id;
            $.ajax({
...
function addmaintenancejob(maintenance_id, maintenance_job_id) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://app.track-asia.com/spwebapi/api/maintenancejobinfo/" + maintenance_job_id,
        async: false,
        data: {
            get_param: 'value'
        },
        ...
        success: function (value) {
            ...
            $("<div id='addForms'>").dialog({
                ...
                open: function () {
                    ...
                    markup +=
                        "<div class='col-sm-4 hidden-xs hidden-sm hidden-md hidden-lg'><div class='form-group'>" +
                        "<label class='control-label'>Items</label>" +
                        "<select class='selectpicker' data-live-search='true' data-dropup-auto='false' data-width='100%' data-style='btn-asiacomDropdown' id='newpests' name='newpests' data-table='searchable' class='hidden-xs hidden-sm hidden-md hidden-lg'></select>" +
                        "</div></div>" +
                        "<div class='col-sm-4 hidden-xs hidden-sm hidden-md hidden-lg'><div class='form-group '>" +
                        "<label class='control-label'>Description</label>" +
                        "<select class='selectpicker' class='hidden-xs hidden-sm hidden-md hidden-lg' data-live-search='true' data-dropup-auto='false' multiple data-width='100%' data-style='btn-asiacomDropdown' id='newTreatments' name='newTreatments' data-table='searchable'></select>" +
                        "</div></div>" +
                       
                        "<div class='col-sm-4'><div class='form-group'>" +
						"<label class='control-label'>Items</label>" +
                        "<input id='newotherpests' type='text' placeholder='Item' class='form-control'>" +
                        "</div></div>" +
                        "<div class='col-sm-4'><div class='form-group'>" +
						"<label class='control-label'>Description</label>" +
                        "<input id='newotherTreatments' type='text' placeholder='Description' class='form-control'>" +
                        "</div></div>" +
						 "<div class='col-sm-4' style='margin-top: 26px;'><div class='form-group'>" +
                        "<button id='addItemPest' class='btn btn-info' type='submit' style='margin-right:15px;'>Add Item</button>" +
                        "<button id='deleteItemPest' class='btn btn-danger' disabled=''>Delete Item</button>" +
                        "<button id='clearItemPest' class='btn btn-danger' type='submit' style='margin-left:15px;'>Clear Item</button>" +
                        "</div></div>" +
                        "<div class='col-sm-4'><div class='form-group'>" +
                    ...
                    $('#newpestsTreatment').bootstrapTable({
                        ...
                        columns: [{
                            ...
                            field: 'PestDesc', //change from PestDesc to ItemDesc
                            title: 'Items' // change from Pests to Items
                        }, {
                            field: 'TreatmentDesc', //change from TreateDesc to JobDesc
                            title: 'Description', //change from Treatements to Description
                        }, {
                            field: 'Index',
                            title: 'Index',
                    ...
                    $.getJSON('https://app.track-asia.com/spwebapi/api/emailflaginfo', function (data) {
                                        ...
                                        if (result) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (json) {
                                                    ...
                                                    var addMaintenanceJob = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo';
...
function editmaintenancejob(id) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://app.track-asia.com/spwebapi/api/maintenancejobinfo/" + id,
        async: false,
        data: {
            get_param: 'value'
        },
                ...
                open: function () {
                    ...
                    if (value.Flag == 0 && getSessionstorageValueRoleID > 4) {
                        ...
                        var markup = "<div style='border-style: none; margin: 0px; padding: 0px 3px; overflow: auto;' class=''>" +
                            ...
                            "<th style='color: blue;'>Cancel Remarks</th>" +
                            "<th style='color: blue;'>Reference No.</th>" +
                            "<th style='color: blue;'>Items and Description</th>" + //change from Pests & Treatments
                                        ...
                                        if (result) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (json) {
                                                    ...
                                                    var updateMaintenanceJob = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo?id=' + maintenancejob.MaintenanceJobID;
                                                    var maintenanceFinalID = value.MaintenanceID;
                                                    $.ajax({
                                                        url: updateMaintenanceJob,
                                                        type: "PUT",
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to delete the maintenance job?" + "</div>", function (result) {
        if (result) {
            ...
            var event = {
                ...
                RxTime: moment().format(),
                StatusID: 2,
                Remarks: "Maintenance ID: " + maintenance_id + " : " + maintenance_job_id + " has been deleted.",
                AlertLevel: 0,
                AlertLevelEx: 0,
                Flag: 1,
                AckUserID: getSessionstorageValueRoleID,
            ...
            var jobs = JSON.stringify({ 'MaintenanceJobID': maintenance_job_id });
                var WebAPI = 'https://app.track-asia.com/spwebapi/api/removemaintenancejobinfo?id=' + maintenance_job_id;
        ...
        open: function () {
            ...
            if (value.Flag == 0 && getSessionstorageValueRoleID > 4) {
                ...
                var markup =
                    "<div class='col-sm-4 hidden-xs hidden-sm hidden-md hidden-lg'><div class='form-group'>" +
                    "<label class='control-label'>Items</label>" +
                    "<div class='hidden-xs hidden-sm hidden-md hidden-lg'><select class='selectpicker' data-live-search='true' data-dropup-auto='false' data-width='100%' data-style='btn-asiacomDropdown' id='newpests' name='newpests' data-table='searchable'></select></div>" +
                    "</div></div>" +
                    "<div class='col-sm-4 hidden-xs hidden-sm hidden-md hidden-lg'><div class='form-group'>" +
                    "<label class='control-label'>Description</label>" +
                    "<div class='hidden-xs hidden-sm hidden-md hidden-lg'><select class='selectpicker' data-live-search='true' data-dropup-auto='false' multiple data-width='100%' data-style='btn-asiacomDropdown' id='newTreatments' name='newTreatments' data-table='searchable'></select></div>" +
                    "</div></div>" +
            ...
            'Submit': function () {
                ...
                bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to update pest?" + "</div>", function (result) {
                    if (result) {
                        ...
                        var deletePestTreatment = 'https://app.track-asia.com/spwebapi/api/deletemainpesttreatment';
    ...
    $("<div id='noPestForms'>").dialog({
        ...
        open: function () {
            ...
            var markup = "<div class='col-sm-4'><div class='form-group'>" +
                "<label class='control-label'>Items</label>" +
                "<select class='selectpicker' class='hidden-xs hidden-sm hidden-md hidden-lg' data-live-search='true' data-dropup-auto='false' data-width='100%' data-style='btn-asiacomDropdown' id='newpests' name='newpests' data-table='searchable'></select>" +
                "</div></div>" +
                "<div class='col-sm-4'><div class='form-group'>" +
                "<label class='control-label'>Description</label>" +
                "<select class='selectpicker' class='hidden-xs hidden-sm hidden-md hidden-lg' data-live-search='true' data-dropup-auto='false' multiple data-width='100%' data-style='btn-asiacomDropdown' id='newTreatments' name='newTreatments' data-table='searchable'></select>" +
            ...
            'Update Maintenance': function () {
                ...
                bootbox.confirm("<div style='color:black'>" + "WARNING: Maintenance Jobs will recalculate once you update the job. Proceed?" + "</div>", function (result) {
                    if (result) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/spwebapi/api/maintenanceinfo?id=" + maintenance.MaintenanceID,
                            type: "PUT",
                            async: false,
                            data: JSON.stringify(maintenance),
                            crossDomain: true,
                            ...
                            success: function (maintenance) {
                                ...
                                $.ajax({
                                    url: "https://app.track-asia.com/spwebapi/api/maintenancejobinfoex/" + $('#maintenanceID').val(),
                                    type: "GET",
                                    crossDomain: true,
                                    contentType: 'application/json; charset=utf-8',
                                    xhrFields: {
                                    ...
                                    success: function (res) {
                                        ...
                                        if (res.MaintenanceID > 0) {
                                            ...
                                            $.ajax({
                                                url: 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo/' + $('#maintenanceID').val(),
                                                type: "Delete",
                                                async: false,
...
function loadMaintenance(job_id) {
    ...
    $.ajax({
        ...
        success: function (value) {
            ...
            var WebAPI = 'https://app.track-asia.com/spwebapi/api/maintenanceinfo/' + value[0].MaintenanceID;
            $.ajax({
                type: 'GET',
                url: WebAPI,
                async: false,
...
$(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfoex?ResellerID=' + '1' + '&CompanyID=' + '1';
    } else if (getSessionstorageValueRoleID == 2) {
        WebAPIDriver = 'https://app.track-asia.com/spwebapi/api/driverinfoex?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function BindTable(jsondata) { /*Function used to convert the JSON array to Html Table*/
    ...
    for (var i = 0; i < jsondata.length; ++i) {
        ...
        if (data.MAINTENANCE_INTERVAL == "Daily" ||
            ...
            data.MAINTENANCE_INTERVAL == "Fortnightly" ||
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == "undefined" | getSessionstorageValueUser == "") {
        ...
        window.location.href = 'https://app.track-asia.com/systempest/'; //Login URL
...
$(function () {
    ...
    $('#companyName').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'https://app.track-asia.com/spwebapi/api/autocompletecompany?CompanyID=' + getSessionstorageValueCompanyID,
                type: 'GET',
                cache: false,
                data: {
    ...
    $('#jobDestination').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'https://app.track-asia.com/spwebapi/api/autocompleteaddress?CompanyID=' + getSessionstorageValueCompanyID,
                type: 'GET',
                cache: false,
                data: {
