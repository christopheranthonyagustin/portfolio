...
// based on (hr) translation by Bojan Markovic
...
(function (factory) {
    ...
    var months = 'leden_únor_brezen_duben_kveten_cerven_cervenec_srpen_zárí_ríjen_listopad_prosinec'.split('_'),
    ...
    function translate(number, withoutSuffix, key, isFuture) {
        ...
        case 'MM': // 9 months / in 9 months / 9 months ago
            if (withoutSuffix || isFuture) {
                return result + (plural(number) ? 'mesíce' : 'mesícu');
            } else {
...
(function (factory) {
    ...
    return moment.defineLocale('cv', {
        months : '?a????_???a?_???_???_???_çe????_??a_ç????_??a?_???_???_??????'.split('_'),
        monthsShort : '?a?_???_???_???_???_çe?_??a_ç??_??_???_???_???'.split('_'),
        weekdays : '???????????_????????_?????????_?????_?eç????????_???????_?a??????'.split('_'),
        weekdaysShort : '???_???_???_??_?eç_???_?a?'.split('_'),
        weekdaysMin : '??_??_??_??_?ç_??_??'.split('_'),
        longDateFormat : {
            LT : 'HH:mm',
            LTS : 'LT:ss',
            L : 'DD-MM-YYYY',
            LL : 'YYYY [ç????] MMMM [??a?e?] D[-?e?e]',
            LLL : 'YYYY [ç????] MMMM [??a?e?] D[-?e?e], LT',
            LLLL : 'dddd, YYYY [ç????] MMMM [??a?e?] D[-?e?e], LT'
        },
        calendar : {
            sameDay: '[????] LT [???????]',
            nextDay: '[????] LT [???????]',
        ...
        relativeTime : {
            future : function (output) {
                var affix = /?????$/i.exec(output) ? '???' : /ç??$/i.exec(output) ? '???' : '???';
                return output + affix;
            },
            past : '%s ??????',
            s : '?e?-?? ç??????',
...
// moment.js locale configuration
// locale : hrvatski (hr)
// author : Bojan Markovic : https://github.com/bmarkovic
...
(function (factory) {
    ...
    return moment.defineLocale('hr', {
        months : 'sjecanj_veljaca_ožujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split('_'),
...
(function (factory) {
    ...
    weekDays = 'sekmadienis_pirmadienis_antradienis_treciadienis_ketvirtadienis_penktadienis_šeštadienis'.split('_');
    ...
    function relativeWeekDay(moment, format) {
        ...
        return nominative ? weekDay : weekDay.substring(0, weekDay.length - 2) + 'i';
    }

    return moment.defineLocale('lt', {
        months : 'sausio_vasario_kovo_balandžio_gegužes_birželio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruodžio'.split('_'),
...
(function (factory) {
    ...
    var units = {
        'mm': 'minuti_minutes_minute_minutes',
        'hh': 'stundu_stundas_stunda_stundas',
        'dd': 'dienu_dienas_diena_dienas',
        'MM': 'menesi_menešus_menesis_meneši',
...
(function (factory) {
    ...
    function translate(number, withoutSuffix, key) {
        ...
        case 'MM':
            return result + (plural(number) ? 'miesiace' : 'miesiecy');
        case 'yy':
    ...
    return moment.defineLocale('pl', {
        ...
        weekdaysMin : 'N_Pn_Wt_Sr_Cz_Pt_So'.split('_'),
        longDateFormat : {
            LT : 'HH:mm',
            LTS : 'LT:ss',
            L : 'DD.MM.YYYY',
...
// author : Milan Janackovic<milanjanackovic@gmail.com> : https://github.com/milan-j
...
(function (factory) {
    ...
    return moment.defineLocale('sr', {
        ...
        weekdays: ['nedelja', 'ponedeljak', 'utorak', 'sreda', 'cetvrtak', 'petak', 'subota'],
        weekdaysShort: ['ned.', 'pon.', 'uto.', 'sre.', 'cet.', 'pet.', 'sub.'],
...
//           Burak Yigit Kaya: https://github.com/BYK
...
(function (factory) {
    ...
    return moment.defineLocale('vi', {
        ...
        longDateFormat : {
            ...
            L : 'DD/MM/YYYY',
            LL : 'D MMMM [nam] YYYY',
            LLL : 'D MMMM [nam] YYYY LT',
            LLLL : 'dddd, D MMMM [nam] YYYY LT',
            l : 'DD/M/YYYY',
            ll : 'D MMM YYYY',
            lll : 'D MMM YYYY LT',
            llll : 'ddd, D MMM YYYY LT'
