...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://app.track-asia.com/spwebapi/api/inventoryinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
       ...
       WebAPI = 'https://app.track-asia.com/spwebapi/api/inventoryinfo?CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        WebAPI = 'https://app.track-asia.com/spwebapi/api/inventoryinfo?CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID >= 3) {
...
{
    $('#main-wz-driver').bootstrapWizard('first');
}
...
var url = 'https://app.track-asia.com/spwebapi/api/inventoryinfo';
//Total Vehicles
...
function nameFormatter(value, row) {
    ...
    if (row.ImageFill == "Uniform") {
        ...
        return '<center><div style="color:black;"><a href="' + text + '" class="btn-link" data-toggle="lightbox" data-title="' + row.Name + '" data-footer="' + "<strong> </strong>" + "\n" + "<strong> </strong>" + '"><img src="' + text + '" class="img-responsive" alt="' + text + '" height="30" width="30"></a></div></center>';
