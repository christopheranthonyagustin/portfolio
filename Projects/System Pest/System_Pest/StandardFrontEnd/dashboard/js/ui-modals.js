    ...
    $('#submit-vehicle').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/assetinfo';
                ...
                $.ajax({
                    url: "https://app.track-asia.com/spwebapi/api/messageinfo",
                    type: "POST",
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/assetinfo",
                        type: "POST",
                    ...
                    var updateAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?id=' + assets.AssetID;
    ...
    $('#submit-vehicleEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var apiAsset = 'https://app.track-asia.com/spwebapi/api/duplicateasset?Name=' + assets.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจว่า คุณต้องการลบ ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo/' + row.AssetID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'https://app.track-asia.com/spwebapi/api/zoneinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (zones.ZoneID == 'undefined' || zones.ZoneID == null || zones.ZoneID == 0 || zones.ZoneID != GetZoneID) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/spwebapi/api/zoneinfo",
                            type: "POST",
                        ...
                        var updateZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?id=' + zones.ZoneID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiZone = 'https://app.track-asia.com/spwebapi/api/duplicatezone?Name=' + zones.Name;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ โซน ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/zoneinfo/' + row.ZoneID;
    ...
    $('#submit-company').on('click', function () {
        ...
        bootbox.confirm("ค<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'https://app.track-asia.com/spwebapi/api/companyinfo?id=' + company.CompanyID;
    ...
    $('#submit-companyEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var apiCompany = 'https://app.track-asia.com/spwebapi/api/duplicatecompany?Name=' + company.Name;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/companyinfo/' + row.CompanyID;
    ...
    $('#submit-user').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการส่ง?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/userinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/userinfo",
                        type: "POST",
                    ...
                    var updateUser = 'https://app.track-asia.com/spwebapi/api/userinfo?id=' + user.UserID;
        ...
        if (getUserCompany != "0" || getUserCompany == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiUser = 'https://app.track-asia.com/spwebapi/api/duplicateuser?User=' + user.User;
                                ...
                                $.ajax({
                                    ...
                                    success: function (user) {
                                        ...
                                        var ajaxRequest = $.ajax({
                                            type: "POST",
                                            url: "https://app.track-asia.com/spwebapi/api/fileupload/uploadfileuser",
                                            contentType: false,
                                            processData: false,
                                            data: data,
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/userinfo/' + row.UserID;
    ...
    $('#submit-device').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/deviceinfo",
                        type: "POST",
                    ...
                    var updateDevice = 'https://app.track-asia.com/spwebapi/api/deviceinfo?id=' + device.DeviceID;
    ...
    $('#submit-deviceEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var GetDeviceID = $('#deviceID').val();
                var DeviceAPI = "https://app.track-asia.com/spwebapi/api/deviceinfo"
                var apiDevice = 'https://app.track-asia.com/spwebapi/api/duplicatedevice?Name=' + device.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/deviceinfo/' + row.DeviceID;
    ...
    $('#submit-reseller').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/resellerinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/resellerinfo",
                        type: "POST",
                    ...
                    var updateReseller = 'https://app.track-asia.com/spwebapi/api/resellerinfo?id=' + reseller.ResellerID;
        ...
        if (getReseller == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                ...
                if (result) {
                    ...
                    var GetResellerID = $('#resellerID').val();
                    var apiReseller = 'https://app.track-asia.com/spwebapi/api/duplicatereseller?Name=' + reseller.Name;
                    if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/resellerinfo/' + row.ResellerID;
    ...
    $('#submit-driver').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://app.track-asia.com/spwebapi/api/driverinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "https://app.track-asia.com/spwebapi/api/fileupload/uploadfile",
                    contentType: false,
                    processData: false,
                    data: data,
                    success: function (data) {
                ...
                if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                    ...
                    $.ajax({
                        url: "https://app.track-asia.com/spwebapi/api/driverinfo",
                        type: "POST",
                    ...
                    var updateDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?id=' + driver.DriverID;
    ...
    $('#submit-driverEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var apiDriver = 'https://app.track-asia.com/spwebapi/api/duplicatedriver?Name=' + driver.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://app.track-asia.com/spwebapi/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'https://app.track-asia.com/spwebapi/api/userinfo?id=' + profile.UserID;
                    ...
                    if (row.Flag == 1 || row.Flag == 2) {
                        bootbox.confirm("<div style='color:black'>Are you sure you wish to edit a job?</div>", function (result) {
                            ...
                            if (result) {
                                ...
                                var url = 'https://app.track-asia.com/spwebapi/api/jobinfo';
                                var xhr = createCORSRequest('GET', url);
                                xhr.send();
                                if (!xhr) {
                                    throw new Error('CORS not supported');
                                ...
                                if (row.JobStatus == "In Progress" || row.JobStatus == "Job Edited") {
                                    ...
                                    var updateJob = 'https://app.track-asia.com/spwebapi/api/jobinfo?id=' + jobEdit.JobID;
                                    ...
                                    //Get Asset
                                    $.ajax({
                                        url: "https://app.track-asia.com/spwebapi/api/checkdriver",
                                        type: "POST",
                                        data: JSON.stringify(driver),
                                        crossDomain: true,
                                        contentType: 'application/json; charset=utf-8',
                                ...
                                $.ajax({
                                    ...
                                    success: function (driver) {
                                        ...
                                        if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                            ...
                                            var apiJobNumber = 'https://app.track-asia.com/spwebapi/api/searchjob?JobNumber=' + job.JobNumber;
                                            ...
                                            $.getJSON(apiJobNumber, function (data) {
                                                ...
                                                if (data.length == 1) {
                                                    ...
                                                    //Add Scheduled Job
                                                    $.ajax({
                                                        url: "https://app.track-asia.com/spwebapi/api/jobinfo",
                                                        type: "POST",
                                            ...
                                            var updateJob = 'https://app.track-asia.com/spwebapi/api/jobinfo?id=' + job.JobID;
            ...
            if (row.Flag == 0 || row.Flag == 1 || row.Flag == 2) {
                bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
                    if (result) {
                        ...
                        var WebAPI = 'https://app.track-asia.com/spwebapi/api/jobinfo/' + row.JobID;
                            ...
                            if (result) {
                                ...
                                if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                    ...
                                    $.niftyNoty({
                                        type: 'danger',
                                        icon: 'fa fa-exclamation-triangle',
                                        message: 'Item(s) is not Assigned.',
                                        container: 'floating',
                                        timer: 3000
                                    });
                                } else {
                                    ...
                                    var getAssetCompanyID = sessionStorage.getItem('setSessionstorageValueCompanyID');

                                    var checkAssetID = 'https://app.track-asia.com/spwebapi/api/driverinfo/' + getJobTechnician;
                                    $.ajax({
                                        url: checkAssetID,
                                        type: 'GET',
                                        async: false,
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (job) {
                                                        ...
                                                        var event = {
                                                            ...
                                                            RxTime: moment().format(),
                                                            StatusID: 1,
                                                            Remarks: "Job ID: " + job.JobID + " added successfully",
                                                            AlertLevel: 0,
                                                            AlertLevelEx: 0,
                                                            Flag: 1,
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "https://app.track-asia.com/spwebapi/api/pesttreatmentinfo",
                                                                type: "POST",
                                                                ...
                                                                permissions: ["https://app.track-asia.com"],
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (job) {
                                                ...
                                                var event = {
                                                    ...
                                                    RxTime: moment().format(),
                                                    StatusID: 1,
                                                    Remarks: "Job ID: " + getJobID + " edited successfully",
                                                    AlertLevel: 0,
                                                    AlertLevelEx: 0,
                                                    Flag: 1,
                                                    AckUserID: getSessionstorageValueRoleID,
                                                ...
                                                var deletePestTreatment = 'https://app.track-asia.com/spwebapi/api/deletepesttreatment';
...
$('#submit-itemEN').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var apiAsset = 'https://app.track-asia.com/spwebapi/api/duplicateinventory?Name=' + getItemName + "&CompanyID=" + getSessionstorageValueCompanyID;
            ...
            if (getInventoryID == 'undefined' || getInventoryID == null || getInventoryID == 0 || getInventoryID != getInventoryID || getInventoryID == "") {
                ...
                $.getJSON(apiAsset, function (data) {
                    ...
                    if (data.length == 1) {
                        ...
                        $.ajax({
                            url: "https://app.track-asia.com/spwebapi/api/inventoryinfo",
                            type: "POST",
                            ...
                            success: function (inventory) {
                                ...
                                if (files.length > 0) {
                                    ...
                                    var ajaxRequest = $.ajax({
                                        type: "POST",
                                        url: "https://app.track-asia.com/spwebapi/api/fileupload/uploadfileinventory",
                                        contentType: false,
                                        processData: false,
                                        data: data,
                                        success: function (data) {
                                ...
                                $.ajax({
                                    url: "https://app.track-asia.com/spwebapi/api/inventoryhistoryinfo",
                                    type: "POST",
                ...
                var updateInventory = 'https://app.track-asia.com/spwebapi/api/inventoryinfo?id=' + getInventoryID;
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var WebAPI = 'https://app.track-asia.com/spwebapi/api/inventoryinfo/' + row.InventoryID;
...
$('#submit-change-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfo/' + getJobID;
...
$('#submit-change-main-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo/' + getJobID;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Flag == 0) {
                ...
                var updateJob = 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo?id=' + job.MaintenanceJobID;
                $.ajax({
                    url: updateJob,
                    type: "PUT",
                    data: JSON.stringify(job),
...
$('#submit-newmaintenance').on('click', function () {
    ...
    if ($('#jobPIC').val() == "" || $('#jobDestination').val() == "" ||
        ...
        $("#contract_start_html").val() == "" || $("#contract_end_html").val() == "") {
            ...
            if ($("#jobPIC").val().length == 0) msg = 'Job Pic must not be empty';
            ...
            if ($("#driver").val() == 0) msg = 'You must select a phone user';
			...
			// if ($('#pestsTreatment').bootstrapTable('getData').length == 0) msg = 'Item & Description is not Assigned.';			
                    ...
                    if ($('#jobMaintenanceID').val() == "") {
                        ...
                        if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                            ...
                            $.niftyNoty({
                                type: 'danger',
                                icon: 'fa fa-exclamation-triangle',
                                message: 'Item & Description is not assigned.',
                                container: 'floating',
                                timer: 3000
                            });
                        } else {
                            ...
                            $.ajax({
                                url: "https://app.track-asia.com/spwebapi/api/maintenanceinfo",
                                type: "POST",
                                ...
                                success: function (maintenance) {
                                    ...
                                    var event = {
                                        ...
                                        RxTime: moment().format(),
                                        StatusID: 2,
                                        Remarks: "Maintenance ID: " + maintenance.MaintenanceID + " added successfully",
                                        AlertLevel: 0,
                                        AlertLevelEx: 0,
                                        Flag: 1,
                                        AckUserID: getSessionstorageValueRoleID,
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (json) {
                                                ...
                                                var maintenancejob = {
                                                    ...
                                                    CancelRemarks: "",
                                                    isSent: isSent,
                                                    ReferenceNo: $('#jobReferenceNo').val(),
                                                    AssetID: getJobAssetID,
                                                    DriverID: getJobTechnician,
                                                    Technician: getTechnician
                                                ...
                                                $.ajax({
                                                    url: "https://app.track-asia.com/spwebapi/api/maintenancejobinfo",
                                                    type: "POST",
                                                    async: false,
                                                    ...
                                                    success: function (maintenancejob) {
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "https://app.track-asia.com/spwebapi/api/mainpesttreatmentinfo",
                                                                type: "POST",
                                                                async: false,
                                                                data: JSON.stringify(pests),
                                                                crossDomain: true,
                        ...
                        if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                            if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                ...
                                $.ajax({
                                    url: "https://app.track-asia.com/spwebapi/api/maintenanceinfo?id=" + $('#jobMaintenanceID').val(),
                                    type: "PUT",
                                    data: JSON.stringify(maintenance),
                                    async: false,
                                    crossDomain: true,
                                    ...
                                    success: function (maintenance) {
                                        ...
                                        var event = {
                                            ...
                                            RxTime: moment().format(),
                                            StatusID: 2,
                                            Remarks: "Maintenance ID: " + $('#jobMaintenanceID').val() + " updated successfully",
                                            AlertLevel: 0,
                                            AlertLevelEx: 0,
                                            Flag: 1,
                                            AckUserID: getSessionstorageValueRoleID,
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (event) {
                                                ...
                                                if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                                                    ...
                                                    $.ajax({
                                                        url: "https://app.track-asia.com/spwebapi/api/maintenancejobinfoex/" + $('#jobMaintenanceID').val(),
                                                        type: "GET",
                                                        crossDomain: true,
                                                        contentType: 'application/json; charset=utf-8',
                                                        xhrFields: {
                                                        ...
                                                        success: function (res) {
                                                            ...
                                                            if (res.MaintenanceID > 0) {
                                                                ...
                                                                $.ajax({
                                                                    url: 'https://app.track-asia.com/spwebapi/api/maintenancejobinfo/' + $('#jobMaintenanceID').val(),
                                                                    type: "Delete",
                                                                    async: false,
...
$('#submit-maintenance').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'https://app.track-asia.com/spwebapi/api/maintenanceinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            $.each(data, function (index, value) {
                ...
                $.ajax({
                    ...
                    success: function (maintenance) {
                        ...
                        var apiDriver = 'https://app.track-asia.com/spwebapi/api/duplicatedriver?Name=' + value.DRIVER;
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var WebAPI = 'https://app.track-asia.com/spwebapi/api/maintenanceinfo/' + row.MaintenanceID;
...
$('#submit-duplicatejob').on('click', function () {
    ...
    var url = 'https://app.track-asia.com/spwebapi/api/jobinfo/' + job_id;
