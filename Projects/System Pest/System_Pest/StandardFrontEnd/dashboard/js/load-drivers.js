...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
       ...
       WebAPI = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        WebAPI = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID >= 3) {
        ...
        $('#drivers-editable').bootstrapTable({
            ...
            onCheck: function (row) {
                ...
                var driverRemarks = $('#driverRemarks').val(row.Remarks);
                var driverRemarksEN = $('#driverRemarksEN').val(row.Remarks);
                var driverTechnicianEN = $('#technicianEN').val(row.Technician);
...
// format for Vehicle Column.
// =================================================================
function technicianFormatter(value, row) {
    var text = ''
    var temp = new Array();
    temp = value.split(",");
