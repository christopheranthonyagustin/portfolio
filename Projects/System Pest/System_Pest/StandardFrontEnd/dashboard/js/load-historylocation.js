...
if (getLocalstorageValueAsset == "") {
    ...
    $(document).ready(function () {
        ...
        function setLines(map, lines) {
            ...
            var url = "https://app.track-asia.com/spwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        ...
        if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
            ...
            if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
                ...
                var WebApi = "https://app.track-asia.com/spwebapi/api/posinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
