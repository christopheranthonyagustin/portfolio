...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIReseller = 'https://app.track-asia.com/spwebapi/api/resellerinfo';
    ...
    WebAPIReseller = 'https://app.track-asia.com/spwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + "4", function (data) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
    ...
    $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?CompanyID=" + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
...
$(function () {
    ...
    $('.SelectResellerFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            $.getJSON("https://app.track-asia.com/spwebapi/api/resellerinfo", function (data) {
                $.each(data, function (index, item) {
            ...
            $.getJSON("https://app.track-asia.com/spwebapi/api/resellerinfo?ResellerID=" + selectedReseller, function (data) {
                $.each(data, function (index, item) {
        ...
        $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + selectedReseller, function (data) {
...
$(function () {
    ...
    $('.MobileSelectResellerFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            $.getJSON("https://app.track-asia.com/spwebapi/api/resellerinfo?ResellerID=" + selectedMobileReseller, function (data) {
                $.each(data, function (index, item) {
        ...
        $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + selectedMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany > 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                $.getJSON("https://app.track-asia.com/spwebapi/api/companyinfo?&ResellerID=" + getReseller, function (data) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                var getZoneAPI = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                var getZoneAPI = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + "&CompanyID=" + selectedCompany;
            }

            else if (getSessionstorageValueRoleID >= 3) {
                var getZoneAPI = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
            ...
            if (getSessionstorageValueRoleID == 1) {
                if (sessionStorage.getItem('setSessionstorageValueDefaultReseller') > 0 && sessionStorage.getItem('setSessionstorageValueDefaultCompany') > 0) {
                    reloadWebAPIAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + sessionStorage.getItem('setSessionstorageValueDefaultReseller') + '&CompanyID=' + sessionStorage.getItem('setSessionstorageValueDefaultCompany');
                } else {
                    reloadWebAPIAsset = '';
                }
                ...
                reloadWebAPIAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        if (selectedMobileCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany, function (data) {
                ...
                $.getJSON("https://app.track-asia.com/spwebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany, function (data) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedMobileCompany;
                } else {
                    WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
            ...
            $.getJSON("https://app.track-asia.com/spwebapi/api/zoneinfo?CompanyID=" + selectedMobileCompany, function (data) {
    ...
    $('.MobileSelectVechsFilter').on('change', function () {
        ...
        if (selectedMobileAsset != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                } else {
                    WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&Assets=' + selectedMobileAsset;
            }
            ...
            $.getJSON("https://app.track-asia.com/spwebapi/api/zoneinfo?CompanyID=" + getCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        if (sessionStorage.getItem('setSessionstorageValueDefaultReseller') > 0 && sessionStorage.getItem('setSessionstorageValueDefaultCompany') > 0) {
            url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + sessionStorage.getItem('setSessionstorageValueDefaultReseller') + '&CompanyID=' + sessionStorage.getItem('setSessionstorageValueDefaultCompany');
        } else {
            url = '';
        }
        ...
        url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setMarkersFilter(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedReseller != "") {
            url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
        } else {
            url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;
...
function setMarkersFilterMobile(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
    ...
    for (var i = 0, length = data.length; i < length; i++) {
        ...
        if (data[i]) {
            ...
            if (data[i].LastPos == null || data[i].LastPos.Engine == null || data[i].LastPos.PosID == 0 || data[i].LastPos === "") {
				...
				var getLastPosID = data[i].LastPos.PosID;
                ...
                var assetContent = "<div id='assetInfo' class='form-group' style='padding:0px !important;'>" +
                    ...
                    "<tbody>" +
                    "<tr>" + "<td>" +
                    "<span data-l11n id='latestAddress' class='text-bold'>Address:&nbsp;</span>" + address +
                    "<br />" +
                    ...
                    "<br />" +
                    "<br />" +
					"<button  onclick='getMarkersID(" + getLastPosID  + ")' style='color:#458FD2;width:100%; padding:5px'>" + "Update Address" + '</button>' +
                    "</td>" + "</tr>"
                "</tbody>" + "</table>" +
                    "</div>"; //infobox
...
function getMarkersID(id) {
	
	$.ajax({
		url: 'https://app.track-asia.com/spwebapi/api/posinfo?id=' + id,
		type: 'GET',
		success: function (data) {
			//console.log(data)
			var posX = data.PosX.toFixed(6);
			var posY = data.PosY.toFixed(6);
			
			//Reverse Geocode
			var getAPI = "https://app.track-asia.com/dmswebapi/api/reversegeocode?PosY=" + posY + "&PosX=" + posX;
			//console.log(getAPI);
			...
			$.getJSON(getAPI, function (data) {
				...
				$.each(data, function (index, item) {
					...
					var updatePosition = 'https://app.track-asia.com/spwebapi/api/updateposinfo?id=' + id;
					$.ajax({
						url: updatePosition,
						type: "PUT",
			...
			// var form = new FormData();
				...
				// $.ajax(settings).done(function (response) {
					...
					// var onemap_api = 'https://developers.onemap.sg/privateapi/commonsvc/revgeocode?location=' + posY + ',' + posX + '&token=' + obj.access_token;
					...
					// $.ajax({
						...
						// success: function (data) {
							...
							// }else{
								// var newpos_x = parseFloat(posX).toFixed(3);
								// var newpos_y = parseFloat(posY).toFixed(3);

								// var onemap_api = 'https://developers.onemap.sg/privateapi/commonsvc/revgeocode?location=' + newpos_y + ',' + newpos_x + '&token=' + obj.access_token;
								// console.log(onemap_api)
								// $.ajax({
									// url: onemap_api,
									// type: 'GET',
							...
							// //alert(data.GeocodeInfo[0].BLOCK + ',' + data.GeocodeInfo[0].ROAD + ',' + data.GeocodeInfo[0].BUILDINGNAME)
					// }});				
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '4' + '&CompanyID=' + '2';
    ...
    WebAPIAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setZonesFilter(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedReseller != "") {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
        } else {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;

    } else if (getSessionstorageValueRoleID >= 3) {

        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setZonesFilterMobile(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
...
function setZonesFilterMobileAsset(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        } else {
            url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany;
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + '4' + '&CompanyID=' + '2';
