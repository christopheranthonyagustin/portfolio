...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
...
function GenerateEN() {
        ...
        var jobApi = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
