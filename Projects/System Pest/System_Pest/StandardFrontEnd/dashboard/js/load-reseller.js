...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://app.track-asia.com/spwebapi/api/resellerinfo';

    } else {

        WebAPI = 'https://app.track-asia.com/spwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
...
if (getSessionstorageValueLanguage == "en") {
    ...
    $("#resellerEmail").text("Dịa Chỉ Email");
