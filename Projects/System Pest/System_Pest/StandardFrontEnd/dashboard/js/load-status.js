...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == "undefined" | getSessionstorageValueUser == "") {
       ...
       window.location.href = 'https://track-asia.com/jds/'; //Login URL
...
if (getSessionstorageValueRoleID == 1) {
    var getZone = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    var getZoneByID = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    ...
    var getZoneByID = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
