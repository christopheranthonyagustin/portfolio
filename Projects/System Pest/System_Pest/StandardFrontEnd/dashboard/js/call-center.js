...
$(function () {
    ...
    $button.click(function (e) {
        ...
        // }
        // else if ($("#jobPests").val() == 0 || $("#jobOtherPest").val() == '') {
...
// $(document).ready(function () {
//     $('#jobTechnician').change(function () {
//         var getTechnician = $(this).find(':selected').attr('data-technician')
//        $('#jobPartners').val(getTechnician);
...
$(function () {
    ...
    $('#jobTechnician').append($('<option selected="selected"></option>').val(0).html("No Phone User Selected"));
    ...
    if(getSessionstorageValueCompanyID == 1){
        $('#jobFormType').append($('<option></option>').val(1).html("System Pest Singapore"));
        $('#jobFormType').append($('<option></option>').val(3).html("Asia White Ant"));
        $('#jobFormType').val(1);
        $('.selectpicker').selectpicker('refresh');
    }else if(getSessionstorageValueCompanyID == 2){
        $('#jobFormType').append($('<option></option>').val(2).html("System Pest Malaysia"));
        $('#jobFormType').val(1);
        $('.selectpicker').selectpicker('refresh');
...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "https://app.track-asia.com/spwebapi/api/treatmentinfo";
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
	...
	if (flag == 0 && getSessionstorageValueRoleID > 3){
	    ...
	    bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to edit this job?' + "</div>", function (result) {
	        if (result) {
	            ...
	            var WebAPI = 'https://app.track-asia.com/spwebapi/api/jobinfo/' + job_id;
	            ...
	            $.ajax({
	                ...
	                success: function (res) {
						if(res.Flag == 0){
							alert('Alert : Job has been Completed.')
						}else{
							...
							$('#getAssets').val(res.Asset);
							$("#jobFormType").val(res.FormType);
...
function calculateDistances(pt, closest, numberOfResults) {
    ...
    $.ajax({
        url: 'https://app.track-asia.com/spwebapi/api/distancematrix?Origin=' + originPT[1] + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
...
function calculateLocationIQDistances(pt, closest, numberOfResults) {
    var finalClosest = "";
    var regExp = /\(([^)]+)\)/;
    for (var i = 0; i < closest.length; i++) {
        var closestPosition = regExp.exec(closest[i].getPosition());
    ...
    console.log('URL : ' + 'https://app.track-asia.com/spwebapi/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest);

    $.ajax({
        url: 'https://app.track-asia.com/spwebapi/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
        success: function (json) {
...
function searchDriver(id) {
    ...
    var apiDriver = 'https://app.track-asia.com/spwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'https://app.track-asia.com/spwebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'https://app.track-asia.com/spwebapi/api/searchjob?JobNumber=' + getJobNumber;
    //alert(apiJobNumber);
...
function clearJobForms() {
	...
	$('#jobTime').val(moment().format('DD-MMM-YYYY, HH:mm'));
...
function formFormatter(value, fill, referenceno) {
    ...
    if (fill == "Uniform") {
        text = value;
        return '<center><div style="color:black;"><a href="' + text + '" class="btn-link" data-title="' + referenceno + '"><i class="fa fa-file-pdf-o fa-lg" style="color:white;"></i></a></div></center>';
...
function reloadJobsCreated()
    {
        ...
        var WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfoex?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID;
;
        // if (getSessionstorageValueRoleID == 1) {

        //     WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        // }
        // else if (getSessionstorageValueRoleID == 2) {
        ...
        //     WebAPIJobs = 'https://app.track-asia.com/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Agent=' + getSessionstorageValueUser;
        // }
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    outputDiv.innerHTML += "<table id='jobsCreated' border='1'>"
                                        ...
                                        + "<th style='padding: 5px;' class='hidden-xs hidden-sm hidden-md hidden-lg'>" + 'Company' + "</th>"
                                        + "<th style='padding: 5px;' class='hidden-xs hidden-sm hidden-md hidden-lg'>" + 'Form' + "</th>"
                                        ...
                                        + "<th style='padding: 5px;'>" + 'Client Signature' + "</th>"
                                        + "<th style='padding: 5px;'>" + 'Technician Signature' + "</th>"
                                        + "<th style='padding: 5px;'>" + 'Service Form' + "</th>"
                    ...
                    for (k = 0; k < res.length; k++) {
                        ...
                        if (res[k] != undefined || res[k]) {
                            ...
                            outputDiv.innerHTML += "<table id='jobsCreated' border='1'>"
                                        ...
                                        + formtypeFormatter(res[k].AssetCompanyID)
                                        + "</td>"
                                        + "<td style='padding: 5px;' class='hidden-xs hidden-sm hidden-md hidden-lg'>"
                                        + formtypeFormatter(res[k].FormType)
                                        + "</td>"
                                        + "<td style='padding: 5px;'>"
                                        ...
                                        + "</td>"
                                        + "<td style='padding: 5px;'>"
                                        + signFormatter(res[k].ClientSignatures, res[k].ClientSignaturesFill, res[k].ReferenceNo)
                                        + "</td>"
                                        + "<td style='padding: 5px;'>"
                                        + signFormatter(res[k].TechSignatures, res[k].TechSignaturesFill, res[k].ReferenceNo)
                                        + "</td>"
                                        + "<td style='padding: 5px;'>"
                                        + formFormatter(res[k].Forms, res[k].FormsFill, res[k].ReferenceNo)
                                        + "</td>"
                                        + "<td style='padding: 5px;'>"
                                        ...
                                        + "&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href='javascript:google.maps.event.trigger(duplicatejob(" + res[k].JobID + "," + res[k].Flag + "),\"click\");' style='color:#458FD2;'>" + "Duplicate" + '</a></strong>'
                                        + "</td>"
                                        + "</tr>"
                                        + "</tbody>";
                                        + "</table>";
...
function duplicatejob(id, flag) {


    $('#dateFromForm').val(moment().format('DD-MMM-YYYY, HH:mm'));
    $('#dateToForm').val(moment().format('DD-MMM-YYYY, HH:mm'));
    $('#duplicatejobid').val(id);
    $('#DuplicateJobForm').modal("show");
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'https://app.track-asia.com/spwebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
...
function showArrayCircle(event) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIAsset = 'https://app.track-asia.com/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    $(function () {
        ...
        $('#companyName').autocomplete({
            ...
            select: function (event, ui) {
                ...
                $("#jobReferenceNo").val(ui.item.reference);
