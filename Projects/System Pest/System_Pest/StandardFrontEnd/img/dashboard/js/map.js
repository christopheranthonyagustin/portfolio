...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://117.120.7.119/spwebapi/api/companyinfo?&ResellerID=" + "4", function (data) {
        ...
        if (selectedCompany > 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                if (sessionStorage.getItem('setSessionstorageValueDefaultReseller') > 0 && sessionStorage.getItem('setSessionstorageValueDefaultCompany') > 0) {
                    reloadWebAPIAsset = 'http://117.120.7.119/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + sessionStorage.getItem('setSessionstorageValueDefaultReseller') + '&CompanyID=' + sessionStorage.getItem('setSessionstorageValueDefaultCompany');
                } else {
                    reloadWebAPIAsset = '';
                }
                ...
                reloadWebAPIAsset = 'http://117.120.7.119/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'http://117.120.7.119/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '4' + '&CompanyID=' + '2';
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'http://117.120.7.119/spwebapi/api/zoneinfo?ResellerID=' + '4' + '&CompanyID=' + '2';
