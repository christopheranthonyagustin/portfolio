...
if (getSessionstorageValueCompanyID == 1) {
    groupApi = 'http://117.120.7.119/spwebapi/api/groupinfo';
}
else if (getSessionstorageValueCompanyID == 2) {
    groupApi = 'http://117.120.7.119/spwebapi/api/groupmyinfo';
}
...
function GenerateAreaTable(){
    ...
    if (getSessionstorageValueCompanyID == 1) {
        ...
        acAPI = 'http://117.120.7.119/spwebapi/api/acinfo?Groups=' + $('#load-groups').val();
    
    }
	else if (getSessionstorageValueCompanyID == 2) {

        acAPI = 'http://117.120.7.119/spwebapi/api/acmyinfo?Groups=' + $('#load-groups').val();
	...
	var WebAPIJobs = 'http://117.120.7.119/spwebapi/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&FormType=' + getSessionstorageValueCompanyID;

    var WebAPIMainJobs = 'http://117.120.7.119/spwebapi/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
...
function changeDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'http://117.120.7.119/spwebapi/api/jobinfo/' + jobid;
...
function changeMainDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo/' + jobid;
    ...
    if (getSessionstorageValueCompanyID == 2) {
                        ...
                        if(jobs.length <= 0){
                            ...
                            for(var q = 0; q < 8; q++){
                                if (q == 0) {
                                    ...
                                    if(jobs.length <= 0){
                                        var WebAPIMainJobs = 'http://117.120.7.119/spwebapi/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp  + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
        ...
        success: function (data) { 
            ...
            for(var i = 0; i < data.length; i ++){
                ...
                var WebAPIJobs = 'http://117.120.7.119/spwebapi/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
