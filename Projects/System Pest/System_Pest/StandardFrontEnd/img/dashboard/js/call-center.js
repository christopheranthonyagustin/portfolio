...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "http://117.120.7.119/spwebapi/api/treatmentinfo";
	...
	if (flag == 0 && getSessionstorageValueRoleID > 3){
	    ...
	    bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to edit this job?' + "</div>", function (result) {
	        if (result) {
	            ...
	            var WebAPI = 'http://117.120.7.119/spwebapi/api/jobinfo/' + job_id;
...
function calculateDistances(pt, closest, numberOfResults) {
    ...
    $.ajax({
        url: 'http://117.120.7.119/spwebapi/api/distancematrix?Origin=' + originPT[1] + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
...
function reloadJobsCreated()
    {
        ...
        var WebAPIJobs = 'http://117.120.7.119/spwebapi/api/jobinfoex?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID;
;
        // if (getSessionstorageValueRoleID == 1) {
