                        ...
                        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                            ...
                            if (result) {
                                ...
                                if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                    ...
                                    var checkAssetID = 'http://117.120.7.119/spwebapi/api/driverinfo/' + getJobTechnician;
                                    $.ajax({
                                        url: checkAssetID,
                                        type: 'GET',
                                        async: false,
                                                    ...
                                                    success: function (job) {
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                permissions: ["http://117.120.7.119"],
...
$('#submit-itemEN').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var apiAsset = 'http://117.120.7.119/spwebapi/api/duplicateinventory?Name=' + getItemName + "&CompanyID=" + getSessionstorageValueCompanyID;
            ...
            if (getInventoryID == 'undefined' || getInventoryID == null || getInventoryID == 0 || getInventoryID != getInventoryID || getInventoryID == "") {
                ...
                $.getJSON(apiAsset, function (data) {
                    ...
                    if (data.length == 1) {
                        ...
                        $.ajax({
                            url: "http://117.120.7.119/spwebapi/api/inventoryinfo",
                            type: "POST",
                            ...
                            success: function (inventory) {
                                ...
                                var ajaxRequest = $.ajax({
                                    type: "POST",
                                    url: "http://117.120.7.119/spwebapi/api/fileupload/uploadfileinventory",
                                    contentType: false,
                                    processData: false,
                                    data: data,
                                    success: function (data) {
                                ...
                                $.ajax({
                                    url: "http://117.120.7.119/spwebapi/api/inventoryhistoryinfo",
                                    type: "POST",
                ...
                var updateInventory = 'http://117.120.7.119/spwebapi/api/inventoryinfo?id=' + getInventoryID;
...
$('#submit-change-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'http://117.120.7.119/spwebapi/api/jobinfo/' + getJobID;
...
$('#submit-change-main-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo/' + getJobID;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Flag == 0) {
                ...
                var updateJob = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo?id=' + job.MaintenanceJobID;
                $.ajax({
                    url: updateJob,
                    type: "PUT",
                    data: JSON.stringify(job),
                ...
                if (result) {
                    ...
                    if ($('#jobMaintenanceID').val() == "") {
                        ...
                        if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                            ...
                            $.ajax({
                                url: "http://117.120.7.119/spwebapi/api/maintenanceinfo",
                                type: "POST",
                                    ...
                                    for (var i = 0; i < results.length; i++) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (json) {
                                                ...
                                                $.ajax({
                                                    url: "http://117.120.7.119/spwebapi/api/maintenancejobinfo",
                                                    type: "POST",
                                                    async: false,
                                                    ...
                                                    success: function (maintenancejob) {
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "http://117.120.7.119/spwebapi/api/mainpesttreatmentinfo",
                                                                type: "POST",
                                                                async: false,
                                                                data: JSON.stringify(pests),
                                                                crossDomain: true,
                        ...
                        if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                            if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                ...
                                $.ajax({
                                    url: "http://117.120.7.119/spwebapi/api/maintenanceinfo?id=" + $('#jobMaintenanceID').val(),
                                    type: "PUT",
                                    data: JSON.stringify(maintenance),
                                    async: false,
                                    crossDomain: true,
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (event) {
                                                ...
                                                if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                                                    ...
                                                    $.ajax({
                                                        url: "http://117.120.7.119/spwebapi/api/maintenancejobinfoex/" + $('#jobMaintenanceID').val(),
                                                        type: "GET",
                                                        crossDomain: true,
                                                        contentType: 'application/json; charset=utf-8',
                                                        xhrFields: {
                                                        ...
                                                        success: function (res) {
                                                            ...
                                                            if (res.MaintenanceID > 0) {
                                                                ...
                                                                $.ajax({
                                                                    url: 'http://117.120.7.119/spwebapi/api/maintenancejobinfo/' + $('#jobMaintenanceID').val(),
                                                                    type: "Delete",
                                                                    async: false,
...
$('#submit-maintenance').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'http://117.120.7.119/spwebapi/api/maintenanceinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            $.each(data, function (index, value) {
                ...
                $.ajax({
                    ...
                    success: function (maintenance) {
                        ...
                        var apiDriver = 'http://117.120.7.119/spwebapi/api/duplicatedriver?Name=' + value.DRIVER;
