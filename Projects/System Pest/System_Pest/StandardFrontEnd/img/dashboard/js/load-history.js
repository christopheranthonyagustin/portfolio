        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                if (getAsset == "")
                {
                    ...
                    jobApi = 'http://117.120.7.119/spwebapi/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    jobApi = 'http://117.120.7.119/spwebapi/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;            
                }
...
$('#generatemobile').on('click', function () {
    ...
    var jobApi = 'http://117.120.7.119/spwebapi/api/jobhistory?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
