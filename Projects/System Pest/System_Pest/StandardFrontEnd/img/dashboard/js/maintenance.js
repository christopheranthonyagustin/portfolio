...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "http://117.120.7.119/spwebapi/api/pestinfo";
...
$(function () {
    ...
    //Populate phone user
    var WebAPITreatment = "http://117.120.7.119/spwebapi/api/treatmentinfo";
...
function reloadJobsCreated() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIJobs = 'http://117.120.7.119/spwebapi/api/maintenanceinfo?CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID == 2) {
...
function searchJobFilter() {
    ...
    WebAPIJobs = 'http://117.120.7.119/spwebapi/api/maintenancefilterinfo?CompanyID=' + getSessionstorageValueCompanyID + '&CusCompany=' + companyName + '&PIC=' + personInCharge + '&Postal=' + postalCode + '&Address=' + address;
...
function disableEmailNotification(maintenance_id) {
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to disable all email notification?" + "</div>", function (result) {
        if (result) {
            ...
            $('#LoadingForm').modal('show');
            var WebAPI = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo?MaintenanceID=' + maintenance_id;
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].Flag > 0) {
                            ...
                            var updateMaintenanceJob = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo?id=' + data[i].MaintenanceJobID;
...
function addmaintenancejob(maintenance_id, maintenance_job_id) {
    ...
    $.ajax({
        type: 'GET',
        url: "http://117.120.7.119/spwebapi/api/maintenancejobinfo/" + maintenance_job_id,
        async: false,
        data: {
            get_param: 'value'
        },
        ...
        success: function (value) {
            ...
            $("<div id='addForms'>").dialog({
                ...
                open: function () {
                    ...
                    $.getJSON('http://117.120.7.119/spwebapi/api/emailflaginfo', function (data) {
                                        ...
                                        if (result) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (json) {
                                                    ...
                                                    var addMaintenanceJob = 'http://117.120.7.119/spwebapi/api/maintenancejobinfo';
...
function editmaintenancejob(id) {
    ...
    $.ajax({
        type: 'GET',
        url: "http://117.120.7.119/spwebapi/api/maintenancejobinfo/" + id,
        async: false,
        data: {
            get_param: 'value'
        },
            ...
            'Submit': function () {
                ...
                bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to update pest?" + "</div>", function (result) {
                    if (result) {
                        ...
                        var deletePestTreatment = 'http://117.120.7.119/spwebapi/api/deletemainpesttreatment';
            ...
            'Update Maintenance': function () {
                ...
                bootbox.confirm("<div style='color:black'>" + "WARNING: Maintenance Jobs will recalculate once you update the job. Proceed?" + "</div>", function (result) {
                    if (result) {
                        ...
                        $.ajax({
                            url: "http://117.120.7.119/spwebapi/api/maintenanceinfo?id=" + maintenance.MaintenanceID,
                            type: "PUT",
                            async: false,
                            data: JSON.stringify(maintenance),
                            crossDomain: true,
                            ...
                            success: function (maintenance) {
                                ...
                                $.ajax({
                                    url: "http://117.120.7.119/spwebapi/api/maintenancejobinfoex/" + $('#maintenanceID').val(),
                                    type: "GET",
                                    crossDomain: true,
                                    contentType: 'application/json; charset=utf-8',
                                    xhrFields: {
                                    ...
                                    success: function (res) {
                                        ...
                                        if (res.MaintenanceID > 0) {
                                            ...
                                            $.ajax({
                                                url: 'http://117.120.7.119/spwebapi/api/maintenancejobinfo/' + $('#maintenanceID').val(),
                                                type: "Delete",
                                                async: false,
...
function loadMaintenance(job_id) {
    ...
    $.ajax({
        ...
        success: function (value) {
            ...
            var WebAPI = 'http://117.120.7.119/spwebapi/api/maintenanceinfo/' + value[0].MaintenanceID;
            $.ajax({
                type: 'GET',
                url: WebAPI,
                async: false,
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == "undefined" | getSessionstorageValueUser == "") {
        ...
        window.location.href = 'http://117.120.7.119/systempest/'; //Login URL
...
$(function () {
    ...
    $('#companyName').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'http://117.120.7.119/spwebapi/api/autocompletecompany?CompanyID=' + getSessionstorageValueCompanyID,
                type: 'GET',
                cache: false,
                data: {
    ...
    $('#jobDestination').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'http://117.120.7.119/spwebapi/api/autocompleteaddress?CompanyID=' + getSessionstorageValueCompanyID,
                type: 'GET',
                cache: false,
                data: {
