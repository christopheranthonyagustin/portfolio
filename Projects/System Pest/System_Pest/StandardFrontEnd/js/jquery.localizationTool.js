...
(function($) {
    ...
    var methods = {
        ...
        '_selectLanguage': function (languageCode) {
            ...
            if (getLang == "en")
            {
                $('#logForm').bootstrapValidator('destroy');
                ...
                $('#logForm').bootstrapValidator({
                    ...
                    fields: {
                        username: {
                            ...
                            validators: {
                                notEmpty: {
                                    message: 'Tên người dùng là cần thiết và không thể để trống'
                                },
                                stringLength: {
                                    min: 4,
                                    max: 30,
                                    message: 'Tên người dùng phải có nhiều hơn 4 và dài hơn 30 ký tự'
                                },
                                regexp: {
                                    regexp: /^[a-zA-Z0-9_\.]+$/,
                                    message: 'Tên người dùng chỉ có thể bao gồm chữ cái, số , dấu chấm và gạch dướ'
                                },
                                different: {
                                    field: 'password',
                                    message: 'Tên người dùng và mật khẩu không thể được giống như nhau'
                                }
                            }
                        },
                        password: {
                            ...
                            validators: {
                                notEmpty: {
                                    message: 'Các mật khẩu là cần thiết và không thể để trống'
                                },
                                different: {
                                    field: 'username',
                                    message: 'Mật khẩu không thể giống như tên người dùng'
                                }
                            }
                        },
                    }
                ...
                $('#logForm').bootstrapValidator({
                    ...
                    fields: {
                        username: {
                            ...
                            validators: {
                                notEmpty: {
                                    message: 'Username diperluan and tidak boleh dikosong'
                                },
                                stringLength: {
                                    min: 4,
                                    max: 30,
                                    message: 'username harus lebih dari 4 dan panjang kurang dari 30 karakter'
                                },
                                regexp: {
                                    regexp: /^[a-zA-Z0-9_\.]+$/,
                                    message: 'username hanya bisa terdiri dari alfabet, angka, titik dan garis bawah'
                                },
                                different: {
                                    field: 'password',
                                    message: 'Username dan password tidak bisa sama dengan satu sama lain'
                                }
                            }
                        },
                        password: {
                            ...
                            validators: {
                                notEmpty: {
                                    message: 'Password diperluan and tidak boleh dikosong'
                                },
                                different: {
                                    field: 'username',
                                    message: 'password tidak bisa sama dengan nama pengguna'
                                }
                            }
                        },
                    }
            ...
            sessionStorage.setItem("setSessionstorageValueLanguage", getLang);
        ...
        'init' : function(options) {
            ...
            var settings = $.extend({
                ...
                'languages' : {
                     ...
                     * - list of country codes: https://www.gnu.org/software/gettext/manual/html_node/Country-Codes.html
                     * - list of language codes: https://www.gnu.org/software/gettext/manual/html_node/Usual-Language-Codes.html#Usual-Language-Codes
                     */
                },
                /*
