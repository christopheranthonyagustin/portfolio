...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://webapi.systempest.com/api/inventoryinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
       ...
       WebAPI = 'https://webapi.systempest.com/api/inventoryinfo?CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        WebAPI = 'https://webapi.systempest.com/api/inventoryinfo?CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID >= 3) {
