    ...
    $(function () {
        ...
        $('#companyName').autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: 'https://webapi.systempest.com/api/autocompletecompany?CompanyID=' + getSessionstorageValueCompanyID,
                    type: 'GET',
                    cache: false,
                    data: {
        ...
        $('#jobDestination').autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: 'https://webapi.systempest.com/api/autocompleteaddress?CompanyID=' + getSessionstorageValueCompanyID,
                    type: 'GET',
                    cache: false,
                    data: {
