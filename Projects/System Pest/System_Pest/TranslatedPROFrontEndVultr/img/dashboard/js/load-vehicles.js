...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                WebAPIDriver = 'https://webapi.systempest.com/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                WebAPIDriver = 'https://webapi.systempest.com/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID;
            ...
            if (getSessionstorageValueRoleID == 1) {
                getZone = 'https://webapi.systempest.com/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                ...
                getZone = 'https://webapi.systempest.com/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
                ...
                getZone = 'https://webapi.systempest.com/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            ...
            if (getSessionstorageValueRoleID == 1 || getSessionstorageValueRoleID == 2) {
                ...
                $.getJSON("https://webapi.systempest.com/api/devicetaginfo?ResellerID=" + getReseller + "&CompanyID=" + selectedCompany, function (data) {
                    $.each(data, function (index, item) {
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
         ...
         WebAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        
        } else {

         WebAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    }
    else if (getSessionstorageValueRoleID == 2)
    {

        WebAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
...
var getZone = "";
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        getZone = 'https://webapi.systempest.com/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    {
        $.getJSON("https://webapi.systempest.com/api/deviceinfo", function (data) {
            $.each(data, function (index, item) {
                var AssignedTags = item.AssetID;
    ...
    else if (getSessionstorageValueTrackVersion == "vn" || getSessionstorageValueTrackVersion == "th" || getSessionstorageValueTrackVersion == "id")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            $.getJSON("https://webapi.systempest.com/api/devicetaginfo?ResellerID=" + "1" + "&CompanyID=" + "1", function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
            ...
            $.getJSON("https://webapi.systempest.com/api/devicetaginfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID, function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
