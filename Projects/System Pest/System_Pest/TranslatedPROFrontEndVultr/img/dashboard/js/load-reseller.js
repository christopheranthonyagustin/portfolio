...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://webapi.systempest.com/api/resellerinfo';

    } else {

        WebAPI = 'https://webapi.systempest.com/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
