...
function searchJobFilter() {
    ...
    WebAPIJobs = 'https://webapi.systempest.com/api/maintenancefilterinfo?CompanyID=' + getSessionstorageValueCompanyID + '&CusCompany=' + companyName + '&PIC=' + personInCharge + '&Postal=' + postalCode + '&Address=' + address;
...
function disableEmailNotification(maintenance_id) {
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to disable all email notification?" + "</div>", function (result) {
        if (result) {
            ...
            $('#LoadingForm').modal('show');
            var WebAPI = 'https://webapi.systempest.com/api/maintenancejobinfo?MaintenanceID=' + maintenance_id;
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].Flag > 0) {
                            ...
                            var updateMaintenanceJob = 'https://webapi.systempest.com/api/maintenancejobinfo?id=' + data[i].MaintenanceJobID;
