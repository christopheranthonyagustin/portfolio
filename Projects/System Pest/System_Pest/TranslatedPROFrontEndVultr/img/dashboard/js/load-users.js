...
//OnLoad User Role
$.getJSON("https://webapi.systempest.com/api/roleinfo?RoleID=" + getSessionstorageValueRoleID, function (data) {
    $.each(data, function (index, item) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'https://webapi.systempest.com/api/assetinfo?UserID=' + '' + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://webapi.systempest.com/api/userinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&RoleID=' + getSessionstorageValueRoleID;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://webapi.systempest.com/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://webapi.systempest.com/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
$.getJSON("https://webapi.systempest.com/api/languageinfo", function (data) {
    $.each(data, function (index, item) {
