...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "https://webapi.systempest.com/api/treatmentinfo";
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('https://webapi.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'https://webapi.systempest.com/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
	...
	if (flag == 0 && getSessionstorageValueRoleID > 3){
	    ...
	    bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to edit this job?' + "</div>", function (result) {
	        if (result) {
	            ...
	            var WebAPI = 'https://webapi.systempest.com/api/jobinfo/' + job_id;
    ...
    if (data.Flag == 0 && getSessionstorageValueRoleID > 3) {
        ...
        bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to delete this job?' + "</div>", function (result) {
            if (result) {
                ...
                var WebAPI = 'https://webapi.systempest.com/api/jobinfo/' + data.JobID;
                console.log(WebAPI)
                $.ajax({
                    url: WebAPI,
                    type: "DELETE",
...
function calculateDistances(pt, closest, numberOfResults) {
    ...
    $.ajax({
        url: 'https://webapi.systempest.com/api/distancematrix?Origin=' + originPT[1] + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
...
function calculateLocationIQDistances(pt, closest, numberOfResults) {
    ...
    console.log('URL : ' + 'https://webapi.systempest.com/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest);

    $.ajax({
        url: 'https://webapi.systempest.com/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
        success: function (json) {
...
function searchDriver(id) {
    ...
    var apiDriver = 'https://webapi.systempest.com/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'https://webapi.systempest.com/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'https://webapi.systempest.com/api/searchjob?JobNumber=' + getJobNumber;
    //alert(apiJobNumber);
...
function reloadJobsCreated()
    {
        ...
        var WebAPIJobs = 'https://webapi.systempest.com/api/jobinfoex?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID;
;
        // if (getSessionstorageValueRoleID == 1) {

        //     WebAPIJobs = 'https://webapi.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        // }
        // else if (getSessionstorageValueRoleID == 2) {
        ...
        //     WebAPIJobs = 'https://webapi.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Agent=' + getSessionstorageValueUser;
        // }
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'https://webapi.systempest.com/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
...
function showArrayCircle(event) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIAsset = 'https://webapi.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';
