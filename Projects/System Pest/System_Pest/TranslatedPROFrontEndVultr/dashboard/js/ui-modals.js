...
function datetimeFunction(value) {
...
$(document).ready(function () {
    ...
    $('#submit-vehicle').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                $.ajax({
                    url: "https://webapi.systempest.com/api/messageinfo",
                    type: "POST",
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/assetinfo",
                        type: "POST",
                    ...
                    var updateAsset = 'https://webapi.systempest.com/api/assetinfo?id=' + assets.AssetID;
    ...
    $('#submit-vehicleEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var apiAsset = 'https://webapi.systempest.com/api/duplicateasset?Name=' + assets.Name;
                                ...
                                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                    ...
                                    if (row.Name == item.Name) {
                                        ...
                                        $.niftyNoty({
                                            type: 'danger',
                                            icon: 'fa fa-exclamation-triangle',
                                            message: 'Phone Name had been used!',
                                            container: 'floating',
                                            timer: 3000
                                        });
                                    }
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจว่า คุณต้องการลบ ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://webapi.systempest.com/api/assetinfo/' + row.AssetID;
    ...
    $('#submit-zones').on('click', function () {
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            $.niftyNoty({
                type: 'danger',
                icon: 'fa fa-exclamation-triangle',
                message: 'กรุณากรอกข้อมูล ที่ว่างเปล่า',
                container: 'floating',
                timer: 3000
            });
            ...
            bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'https://webapi.systempest.com/api/zoneinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (zones.ZoneID == 'undefined' || zones.ZoneID == null || zones.ZoneID == 0 || zones.ZoneID != GetZoneID) {
                        ...
                        $.ajax({
                            url: "https://webapi.systempest.com/api/zoneinfo",
                            type: "POST",
                        ...
                        var updateZone = 'https://webapi.systempest.com/api/zoneinfo?id=' + zones.ZoneID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiZone = 'https://webapi.systempest.com/api/duplicatezone?Name=' + zones.Name;
                                    ...
                                    var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                        ...
                                        if (row.Name == item.Name) {
                                            ...
                                            $.niftyNoty({
                                                type: 'danger',
                                                icon: 'fa fa-exclamation-triangle',
                                                message: 'Zone Name had been used!',
                                                container: 'floating',
                                                timer: 3000
                                            });
                                        }
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ โซน ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var zones = JSON.stringify({
                        'ZoneId': row.ZoneID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/zoneinfo/' + row.ZoneID;
    ...
    $('#submit-pestEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/pestinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var GetPestID = $('#pestID').val();

                var apiPest = 'https://webapi.systempest.com/api/duplicatepest?PestDesc=' + pests.PestDesc;

                if (pests.PestID == 'undefined' || pests.PestID == null || pests.PestID == 0 || pests.PestID != GetPestID) {

                    //Check Duplicate Pest
                    $.getJSON(apiPest, function (data) {
                        ...
                        if (data.length == 1) {
                            ...
                            $.ajax({
                                url: "https://webapi.systempest.com/api/pestinfo",
                                type: "POST",
                                ...
                                success: function (pests) {
                                    ...
                                    clearInputField();
                                    returnToTab1();
                                    $('#pests-editable').bootstrapTable('refresh');
                    ...
                    function updatePests() {
                        var updatePest = 'https://webapi.systempest.com/api/pestinfo?id=' + pests.PestID;
    ...
    //Confirm Delete Row Pests
    $('#pest-confirm-deleteEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var pests = JSON.stringify({
                        'PestID': row.PestID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/pestinfo/' + row.PestID;
    ...
    //Submit Treatments
    $('#submit-treatmentEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/treatmentinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var treatments = {
                    ...
                    TreatmentDesc: $('#treatmentEN').val(),
                };

                var GetTreatmentID = $('#treatmentID').val();

                var apiTreatment = 'https://webapi.systempest.com/api/duplicatetreatment?TreatmentDesc=' + treatments.TreatmentDesc;

                if (treatments.TreatmentID == 'undefined' || treatments.TreatmentID == null || treatments.TreatmentID == 0 || treatments.TreatmentID != GetTreatmentID) {

                    //Check Duplicate Treatment
                    $.getJSON(apiTreatment, function (data) {
                        ...
                        if (data.length == 1) {
                            ...
                            $.niftyNoty({
                                type: 'danger',
                                icon: 'fa fa-exclamation-triangle',
                                message: 'Treatment had been used!',
                                container: 'floating',
                                timer: 3000
                            });
                            ...
                            $.ajax({
                                url: "https://webapi.systempest.com/api/treatmentinfo",
                                type: "POST",
                                ...
                                success: function (treatments) {
                                    ...
                                    clearInputField();
                                    returnToTab1();
                                    $('#treatments-editable').bootstrapTable('refresh');
                        ...
                        if (data.length == 1) {
                            $.each(data, function (index, item) {
                                ...
                                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                    ...
                                    if (row.TreatmentDesc == item.TreatmentDesc) {
                                        updateTreatments();
                                    } else {
                    ...
                    function updateTreatments() {
                        var updateTreatment = 'https://webapi.systempest.com/api/treatmentinfo?id=' + treatments.TreatmentID;
    ...
    //Confirm Delete Row Treatments
    $('#treatment-confirm-deleteEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var treatments = JSON.stringify({
                        'TreatmentID': row.TreatmentID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/treatmentinfo/' + row.TreatmentID;
    ...
    //Submit Preventions
    $('#submit-preventionEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/recommendationsinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var preventions = {
                    RecommendationsID: $('#preventionID').val(),
                    Recommendation: $('#preventionEN').val(),
                };

                var GetPreventionID = $('#preventionID').val();

                var apiPrevention = 'https://webapi.systempest.com/api/duplicaterecommendation?Recommendation=' + preventions.Recommendation;

                if (preventions.RecommendationsID == 'undefined' || preventions.RecommendationsID == null || preventions.RecommendationsID == 0 || preventions.RecommendationsID != GetPreventionID) {

                    //Check Duplicate PreventionID
                    $.getJSON(apiPrevention, function (data) {
                        ...
                        if (data.length == 1) {
                            ...
                            $.niftyNoty({
                                type: 'danger',
                                icon: 'fa fa-exclamation-triangle',
                                message: 'Prevention Tip had been used!',
                                container: 'floating',
                                timer: 3000
                            });
                            ...
                            $.ajax({
                                url: "https://webapi.systempest.com/api/recommendationsinfo",
                                type: "POST",
                                data: JSON.stringify(preventions),
                                crossDomain: true,
                                contentType: 'application/json; charset=utf-8',
                                xhrFields: {
                                    // The 'xhrFields' property sets additional fields on the XMLHttpRequest.
                                ...
                                permissions: ["http://*.asiacom.co.th"],
                                success: function (preventions) {
                                    console.log(preventions)
                                    $("#toggle-aside").show();
                                    $("toggle-aside2").hide();
                                    clearInputField();
                                    returnToTab1();
                                    $('#preventions-editable').bootstrapTable('refresh');
                    ...
                    function updatePreventions() {
                        var updatePrevention = 'https://webapi.systempest.com/api/recommendationsinfo?id=' + preventions.RecommendationsID;

                        $.ajax({
                            url: updatePrevention,
                            type: "PUT",
                            data: JSON.stringify(preventions),
                            crossDomain: true,
                            contentType: 'application/json; charset=utf-8',
    ...
    //Confirm Delete Row Preventions
    $('#prevention-confirm-deleteEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var preventions = JSON.stringify({
                        'RecommendationsID': row.RecommendationsID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/recommendationsinfo/' + row.RecommendationsID;
    ...
    $('#submit-company').on('click', function () {
        ...
        bootbox.confirm("ค<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'https://webapi.systempest.com/api/companyinfo?id=' + company.CompanyID;
    ...
    $('#submit-companyEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var apiCompany = 'https://webapi.systempest.com/api/duplicatecompany?Name=' + company.Name;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://webapi.systempest.com/api/companyinfo/' + row.CompanyID;
    ...
    $('#submit-user').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการส่ง?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/userinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                try {
                    if (GetUserID == null | GetUserID == "" | GetUserID == "undefined") {
                        ...
                        var hash = CryptoJS.SHA3(getPassword, {
                            outputLength: 256
                ...
                if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/userinfo",
                        type: "POST",
                    ...
                    var updateUser = 'https://webapi.systempest.com/api/userinfo?id=' + user.UserID;
        ...
        if (getUserCompany != "0" || getUserCompany == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiUser = 'https://webapi.systempest.com/api/duplicateuser?User=' + user.User;
                            ...
                            if (data.length == 1) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (user) {
                                        ...
                                        if (files.length > 0) {
                                            data.append("UploadedImage", files[0], user.UserID + ".png");
                                        }

                                        // Make Ajax request with the contentType = false, and procesDate = false
                                        var ajaxRequest = $.ajax({
                                            type: "POST",
                                            url: "https://webapi.systempest.com/api/fileupload/uploadfileuser",
                                            contentType: false,
                                            processData: false,
                                            data: data,
            ...
            $.niftyNoty({
                type: 'danger',
                icon: 'fa fa-exclamation-triangle',
                message: 'You Must Select Company',
                container: 'floating',
                timer: 3000
            });
        }
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://webapi.systempest.com/api/userinfo/' + row.UserID;
    ...
    $('#submit-device').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/deviceinfo",
                        type: "POST",
                    ...
                    var updateDevice = 'https://webapi.systempest.com/api/deviceinfo?id=' + device.DeviceID;
    ...
    $('#submit-deviceEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var GetDeviceID = $('#deviceID').val();
                var DeviceAPI = "https://webapi.systempest.com/api/deviceinfo"
                var apiDevice = 'https://webapi.systempest.com/api/duplicatedevice?Name=' + device.Name;
                                ...
                                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                    ...
                                    if (row.Name == item.Name) {
                                        ...
                                        $.niftyNoty({
                                            type: 'danger',
                                            icon: 'fa fa-exclamation-triangle',
                                            message: 'Device Name had been used!',
                                            container: 'floating',
                                            timer: 3000
                                        });
                                    }
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://webapi.systempest.com/api/deviceinfo/' + row.DeviceID;
    ...
    $('#submit-reseller').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/resellerinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/resellerinfo",
                        type: "POST",
                    ...
                    var updateReseller = 'https://webapi.systempest.com/api/resellerinfo?id=' + reseller.ResellerID;
        ...
        if (getReseller == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                ...
                if (result) {
                    ...
                    var GetResellerID = $('#resellerID').val();
                    var apiReseller = 'https://webapi.systempest.com/api/duplicatereseller?Name=' + reseller.Name;
                    if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                                    ...
                                    var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                        ...
                                        if (row.Name == item.Name) {
                                            ...
                                            $.niftyNoty({
                                                type: 'danger',
                                                icon: 'fa fa-exclamation-triangle',
                                                message: 'Reseller Name had been used!',
                                                container: 'floating',
                                                timer: 3000
                                            });
                                        }
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var reseller = JSON.stringify({
                        'ResellerID': row.ResellerID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/resellerinfo/' + row.ResellerID;
    ...
    $('#submit-driver').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://webapi.systempest.com/api/driverinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "https://webapi.systempest.com/api/fileupload/uploadfile",
                    contentType: false,
                    processData: false,
                    data: data,
                    success: function (data) {
                ...
                if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                    ...
                    $.ajax({
                        url: "https://webapi.systempest.com/api/driverinfo",
                        type: "POST",
                    ...
                    var updateDriver = 'https://webapi.systempest.com/api/driverinfo?id=' + driver.DriverID;
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var driver = {
                    ...
                    Technician: $('#technicianEN').val()
                };

                var apiDriver = 'https://webapi.systempest.com/api/duplicatedriver?Name=' + driver.Name;
                        ...
                        if (data.length == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function (driver) {
                                    ...
                                    // Add the uploaded image content to the form data collection
                                    if (files.length > 0) {
                                        data.append("UploadedImage", files[0], driver.DriverID + ".png");
                                    }
                                ...
                                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                                    ...
                                    if (row.Name == item.Name) {
                                        ...
                                        $.niftyNoty({
                                            type: 'danger',
                                            icon: 'fa fa-exclamation-triangle',
                                            message: 'Phone User had been used!',
                                            container: 'floating',
                                            timer: 3000
                                        });
                                    }
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var driver = JSON.stringify({
                        'DriverID': row.DriverID
                    });
                    var WebAPI = 'https://webapi.systempest.com/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'https://webapi.systempest.com/api/userinfo?id=' + profile.UserID;
                    ...
                    if (row.Flag == 1 || row.Flag == 2) {
                        bootbox.confirm("<div style='color:black'>Are you sure you wish to edit a job?</div>", function (result) {
                            ...
                            if (result) {
                                ...
                                var url = 'https://webapi.systempest.com/api/jobinfo';
                                var xhr = createCORSRequest('GET', url);
                                xhr.send();
                                if (!xhr) {
                                    throw new Error('CORS not supported');
                                ...
                                if (row.JobStatus == "In Progress" || row.JobStatus == "Job Edited") {
                                    ...
                                    var updateJob = 'https://webapi.systempest.com/api/jobinfo?id=' + jobEdit.JobID;
                                    ...
                                    //Get Asset
                                    $.ajax({
                                        url: "https://webapi.systempest.com/api/checkdriver",
                                        type: "POST",
                                        data: JSON.stringify(driver),
                                        crossDomain: true,
                                        contentType: 'application/json; charset=utf-8',
                    ...
                    if (getAddress == "") {
                        if (getSessionstorageValueLanguage == "en") {
                            ...
                            $.niftyNoty({
                                type: 'danger',
                                icon: 'fa fa-exclamation-triangle',
                                message: 'ที่อยู่ต้องไม่ว่างเปล่า',
                                container: 'floating',
                                timer: 3000
                            });
                        }
                                ...
                                $.ajax({
                                    ...
                                    success: function (driver) {
                                        ...
                                        if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                            ...
                                            var apiJobNumber = 'https://webapi.systempest.com/api/searchjob?JobNumber=' + job.JobNumber;
                                            ...
                                            $.getJSON(apiJobNumber, function (data) {
                                                ...
                                                if (data.length == 1) {
                                                    ...
                                                    //Add Scheduled Job
                                                    $.ajax({
                                                        url: "https://webapi.systempest.com/api/jobinfo",
                                                        type: "POST",
                                            ...
                                            var updateJob = 'https://webapi.systempest.com/api/jobinfo?id=' + job.JobID;
            ...
            if (row.Flag == 0 || row.Flag == 1 || row.Flag == 2) {
                bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
                    if (result) {
                        ...
                        var WebAPI = 'https://webapi.systempest.com/api/jobinfo/' + row.JobID;
    ...
    $('#submit-call').on('click', function () {
        ...
        var timestamp = moment(convertTimestamp).format(dateFormat);
        // Get today's date
        var todaysDate1 = moment().format('DD-MMM-YYYY');
		var todaysDate2 = moment();
		
        if (validateTimestamp == true) {

            if (todaysDate2 < convertTimestamp || timestamp == todaysDate1) {
              
			        if ($('#jobPIC').val() == "" || $('#jobDestination').val() == "" ||
                    $('#jobPostal').val() == "" || $('#companyName').val() == "" ||
                    $('#jobContactNumber').val() == "" || $('#jobTime').val() == "" ||
                    $('#jobReferenceNo').val() == "") {
                    ...
                    if ($('#jobPostal').val().length == 6 && getSessionstorageValueCompanyID == 1 || $('#jobPostal').val().length == 6 && getSessionstorageValueCompanyID == 3 ||
                        $('#jobPostal').val().length == 5 && getSessionstorageValueCompanyID == 2) {

                        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {

                            if (result) {

                                if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                
                                    $.niftyNoty({
                                        type: 'danger',
                                        icon: 'fa fa-exclamation-triangle',
                                        message: 'Pest & Treatment is not Assigned.',
                                        container: 'floating',
                                        timer: 3000
                                    });
                                } else {
                                    ...
                                    var convertTimestamp = moment(getTimestamp, dateFormat);
                                    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
                                    var schedule_timestamp = moment(convertTimestamp).format(dateFormat);
                                    ...
                                    var getFormType = $("#jobFormType").val();
                                    var getJobAssetID;
                                    var getTechnician = $('#jobTechnician').find(':selected').attr('data-technician');
                                    var getAssetCompanyID = $('#jobFormType').val();

                                    var checkAssetID = 'https://webapi.systempest.com/api/driverinfo/' + getJobTechnician;
                                    $.ajax({
                                        url: checkAssetID,
                                        type: 'GET',
                                        async: false,
                                    ...
                                    var job = {
                                        ...
                                        AssetCompanyID: getAssetCompanyID,
                                        AssetResellerID: sessionStorage.getItem('setSessionstorageValueUserResellerID'),
                                    ...
                                    if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                            ...
                                            if (data.length == 1) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (job) {
                                                        ...
                                                        var remarks = "Job ID: " + job.JobID + "<br>" +
                                                        "Job Number: " + job.JobNumber + "<br>" +
                                                        "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                                                        "Assigned to Driver ID: " + job.DriverID + "<br>" +
                                                        "Schedule Date: " + schedule_timestamp + "<br>" +
                                                        ...
                                                        var event = {
                                                            ...
                                                            CompanyID: $('#jobFormType').val()
                                                        };

                                                        $.ajax({
                                                            url: "https://webapi.systempest.com/api/eventinfo",
                                                            type: "POST",
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "https://webapi.systempest.com/api/pesttreatmentinfo",
                                                                type: "POST",
                                                                data: JSON.stringify(pests),
                                                                crossDomain: true,
                                                                contentType: 'application/json; charset=utf-8',
                                                                ...
                                                                permissions: ["https://portal.systempest.com"],
                                                                success: function (pests) {
                                                                    console.log(pests);
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (res) {
                                                ...
                                                var deletePestTreatment = 'https://webapi.systempest.com/api/deletepesttreatment';
...
$('#submit-itemEN').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'https://webapi.systempest.com/api/inventoryinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            var apiAsset = 'https://webapi.systempest.com/api/duplicateinventory?Name=' + getItemName + "&CompanyID=" + getSessionstorageValueCompanyID;
            ...
            if (getInventoryID == 'undefined' || getInventoryID == null || getInventoryID == 0 || getInventoryID != getInventoryID || getInventoryID == "") {
                ...
                $.getJSON(apiAsset, function (data) {
                    ...
                    if (data.length == 1) {
                        ...
                        $.niftyNoty({
                            type: 'danger',
                            icon: 'fa fa-exclamation-triangle',
                            message: 'Item already Existed in Inventory',
                            container: 'floating',
                            timer: 3000
                        });
                        clearInputFields();
                        ...
                        $.ajax({
                            url: "https://webapi.systempest.com/api/inventoryinfo",
                            type: "POST",
                            ...
                            success: function (inventory) {
                                ...
                                // Add the uploaded image content to the form data collection
                                if (files.length > 0) {
                                    data.append("UploadedImage", files[0], inventory.InventoryID + ".png");
                                }

                                // Make Ajax request with the contentType = false, and procesDate = false
                                var ajaxRequest = $.ajax({
                                    type: "POST",
                                    url: "https://webapi.systempest.com/api/fileupload/uploadfileinventory",
                                    contentType: false,
                                    processData: false,
                                    data: data,
                                    success: function (data) {
                                ...
                                $.ajax({
                                    url: "https://webapi.systempest.com/api/inventoryhistoryinfo",
                                    type: "POST",
                                    ...
                                    success: function (inventoryHistory) {
                                        ...
                                        $("#itemImage").hide();
                                        $('#inventory-editable').bootstrapTable('refresh');
                                        //window.location.reload(true);
                ...
                var updateInventory = 'https://webapi.systempest.com/api/inventoryinfo?id=' + getInventoryID;
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var inventory = JSON.stringify({
                    'InventoryID': row.InventoryID
                });
                var WebAPI = 'https://webapi.systempest.com/api/inventoryinfo/' + row.InventoryID;
...
$('#submit-change-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://webapi.systempest.com/api/jobinfo/' + getJobID;
...
$('#submit-change-main-driver').on('click', function () {
    ...
    var getJobID = $('#tableMainJobID').val();
    var getJobTechnician = $('#jobMainTechnician').val();
    var getTechnician = $('#jobMainTechnician').find(':selected').attr('data-technician');
    var dateFormat = "D-MMM-YYYY, hh:mm:ss A";
    var getTimestamp = $("#jobMainDate").val();
    var convertTimestamp = moment(getTimestamp, dateFormat);
    var validateTimestamp = moment(getTimestamp, dateFormat).isValid();
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://webapi.systempest.com/api/maintenancejobinfo/' + getJobID;
    ...
    if (getTimestamp.length > 0) {
        ...
        if (validateTimestamp == true){
                ...
                success: function (data) {
                    ...
                    if (data.Flag == 0) {
                        ...
                        $('#TableFormMainDriver').modal("hide");
                        ...
                        var updateJob = 'https://webapi.systempest.com/api/maintenancejobinfo?id=' + job.MaintenanceJobID;
                        $.ajax({
                            url: updateJob,
                            type: "PUT",
                            data: JSON.stringify(job),
        ...
        alert('Scheduled Time must not be empty!');
    }
...
$('#submit-newmaintenance').on('click', function () {
    ...
    if ($('#jobPIC').val() == "" || $('#jobDestination').val() == "" ||
        $('#jobPostal').val() == "" || $('#jobReferenceNo').val() == "" ||
        $("#contract_start_html").val() == "" || $("#contract_end_html").val() == "") {
		
		  if ($("#jobPIC").val().length == 0) msg = 'Person in charge must not be empty';
          if ($("#jobDestination").val().length == 0) msg = 'Job destination must not be empty!';
          if ($("#jobPostal").val().length == 0) msg = 'Postal must not be empty';
          if ($("#jobReferenceNo").val().length == 0) msg = 'Reference No. must not be empty';
          if ($("#contract_start_html").val().length == 0) msg = 'Contract Start must not be empty';
          if ($("#contract_end_html").val().length == 0) msg = 'Contract End must not be empty';     
        ...
        if (moment($("#contract_start_html").val()).isBefore($("#contract_end_html").val())) {
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                ...
                if (result) {
                    ...
                    var startDate = moment($('#contract_start_html').val());
                    var endDate = moment($('#contract_end_html').val());
                    var results = enumerateDaysBetweenDates(startDate, endDate, $('#maintenance_interval_html').val());
                    var contract_start = moment.utc($('#contract_start_html').val()).format('DD-MMM, YYYY HH:mm');
                    var contract_end = moment.utc($('#contract_end_html').val()).format('DD-MMM, YYYY HH:mm');

                    if ($('#jobMaintenanceID').val() == "") {
                        var maintenance = {
                            MaintenanceID: "",
                            CompanyID: sessionStorage.getItem('setSessionstorageValueCompanyID'),
                            ...
                            UserID: sessionStorage.getItem('setSessionstorageValueUserID'),
                            Address: $('#jobDestination').val(),
                            Postal: $("#jobPostal").val(),
                            Unit: $("#jobUnit").val().trim(),
                            CusCompany: $("#companyName").val().trim(),
                            PIC: $("#jobPIC").val().trim(),
                            Phone: $("#jobContactNumber").val(),
                            Email: $("#customerEmail").val(),
                            Site: $("#jobSite").val().trim(),
                            ContractStart: moment.utc($('#contract_start_html').val()).subtract(8, 'hours').format('DD-MMM, YYYY HH:mm'),
                            ContractEnd: moment.utc($('#contract_end_html').val()).subtract(8, 'hours').format('DD-MMM, YYYY HH:mm'),
                            MaintenanceInterval: $("#maintenance_interval_html").val(),
                            NotificationInterval: $("#notification_interval_html").val(),
                            Remarks: $("#jobRemarks").val().trim()
                        };
                        if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                            ...
                            $.ajax({
                                url: "https://webapi.systempest.com/api/maintenanceinfo",
                                type: "POST",
                                ...
                                success: function (maintenance) {
                                    ...
                                    var remarks = "Maintenance ID: " + maintenance.MaintenanceID + "<br>" +
                                    "Address: " + maintenance.Address + "<br>" +
                                    "Company: " + maintenance.CusCompany + "<br>" +
                                    "Person In Charge: " + maintenance.PIC + "<br>" +
                                    "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                                    "Contract Start: " + contract_start + "<br>" +
                                    "Contract End: " + contract_end + "<br>" +
                                    "Maintenance Interval: " + maintenance.MaintenanceInterval + "<br>" +
                                    "Status: Maintenance Created Successfully";
                                    ...
                                    for (var i = 0; i < results.length; i++) {
                                        ...
                                        var notifInterval = getIntervalDates(results[i], $('#notification_interval_html').val());
                                        var getJobAssetID;
                                        var getTechnician = $('#jobTechnician').find(':selected').attr('data-technician');
                                        var getJobTechnician = $("#jobTechnician").val();
                                        var checkAssetID = 'https://webapi.systempest.com/api/driverinfo/' + getJobTechnician;
                                        $.ajax({
                                            ...
                                            success: function (json) {
                                                ...
                                                var maintenancejob = {
                                                    ...
                                                    CancelRemarks: "",
                                                    isSent: isSent,
                                                    ReferenceNo: $('#jobReferenceNo').val().trim(),
                                                    AssetID: getJobAssetID,
                                                    DriverID: getJobTechnician,
                                                    Technician: getTechnician
                                                ...
                                                $.ajax({
                                                    url: "https://webapi.systempest.com/api/maintenancejobinfo",
                                                    type: "POST",
                                                    async: false,
                                                    ...
                                                    success: function (maintenancejob) {
                                                        ...
                                                        var remarks = "Maintenance Job ID: " + maintenancejob.MaintenanceJobID  + "<br>" +
                                                        "Maintenance ID: " + maintenancejob.MaintenanceID + "<br>" +
                                                        "Reference No: " + maintenancejob.ReferenceNo + "<br>" +
                                                        "Technician: " + maintenancejob.Technician + "<br>" +
                                                        "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                                                        "Alert Date: " + datetimeFunction(maintenancejob.AlertDate) + "<br>" +
                                                        "Scheduled Date: " + datetimeFunction(maintenancejob.Timestamp) + "<br>" +                                                        
                                                        "Status: Maintenance Job Created Successfully";
                                                      ...
                                                      $.ajax({
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "https://webapi.systempest.com/api/mainpesttreatmentinfo",
                                                                type: "POST",
                                                                async: false,
                                                                data: JSON.stringify(pests),
                                                                crossDomain: true,
                        ...
                        var maintenance = {
                            MaintenanceID: $('#jobMaintenanceID').val(),
                            CompanyID: sessionStorage.getItem('setSessionstorageValueCompanyID'),
                            Timestamp: moment.utc().format(datetimeFormat),
                            RxTime: moment.utc().format(datetimeFormat),
                            UserID: sessionStorage.getItem('setSessionstorageValueUserID'),
                        ...
                        if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                            if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                ...
                                //Recalculate
                                $.ajax({
                                    url: "https://webapi.systempest.com/api/maintenanceinfo?id=" + $('#jobMaintenanceID').val(),
                                    type: "PUT",
                                    data: JSON.stringify(maintenance),
                                    async: false,
                                    crossDomain: true,
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (event) {
                                                ...
                                                if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                                                    ...
                                                    $.ajax({
                                                        url: "https://webapi.systempest.com/api/maintenancejobinfoex/" + $('#jobMaintenanceID').val(),
                                                        type: "GET",
                                                        crossDomain: true,
                                                        contentType: 'application/json; charset=utf-8',
                                                        xhrFields: {
                                                        ...
                                                        success: function (res) {
                                                            ...
                                                            if (res.MaintenanceID > 0) {
                                                                ...
                                                                $.ajax({
                                                                    url: 'https://webapi.systempest.com/api/maintenancejobinfo/' + $('#jobMaintenanceID').val(),
                                                                    type: "Delete",
                                                                    async: false,
                                                                    ...
                                                                    success: function (deletemaintenance) {
                                                                        ...
                                                                        var remarks = "Maintenance ID: " + res.MaintenanceID  + "<br>" +
                                                                        "Address: " + res.Address + "<br>" +
                                                                        "Company: " + res.CusCompany + "<br>" +
                                                                        "Person In Charge: " + res.PIC + "<br>" +
                                                                        "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                                                                        "Status: All Maintenance Job Cleared Successfully";
                                                                      ...
                                                                      $.ajax({
                                                                        ...
                                                                        for (var i = 0; i < results.length; i++) {
                                                                            ...
                                                                            var maintenancejob = {
                                                                                ...
                                                                                isSent: isSent,
                                                                                ReferenceNo: $('#jobReferenceNo').val().trim(),
                                                                                DriverID: $('#jobTechnician').val(),
                                                                                AssetID: 0,
                                                                                Technician: $('#jobTechnician').find(':selected').attr('data-technician')
                                                                            };
                                                ...
                                                } else if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "false") {
                                                    clearJobForms();
                                                    reloadJobsCreated();
                                                    setTimeout(function () {
														$('#LoadingForm').modal('hide');
            ...
            $.niftyNoty({
                type: 'danger',
                icon: 'fa fa-exclamation-triangle',
                message: 'Invalid Contract Start and Contract End Date',
                container: 'floating',
                timer: 3000
            });
...
$('#submit-maintenance').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'https://webapi.systempest.com/api/maintenanceinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            $.each(data, function (index, value) {
                ...
                //moment.utc(value.CONTRACT_START).subtract(8, 'hours').format('DD-MMM, YYYY HH:mm'),
                ...
                var maintenance = {
                    ...
                    Email: value.EMAIL,
                    Site: value.SITE,
                    ContractStart: moment.utc(value.CONTRACT_START).subtract(8, 'hours').format('DD-MMM, YYYY HH:mm'),
                    ContractEnd: moment.utc(value.CONTRACT_END).subtract(8, 'hours').format('DD-MMM, YYYY HH:mm'),
                ...
                $.ajax({
                    ...
                    success: function (maintenance) {
                        ...
                        var apiDriver = 'https://webapi.systempest.com/api/duplicatedriver?Name=' + value.DRIVER;
                                        ...
                                        if (res[k] != undefined || res[k]) {
                                            ...
                                            for (var i = 0; i < results.length; i++) {
                                                ...
                                                var maintenancejob = {
                                                    ...
                                                    DriverID: res[k].DriverID,
                                                    AssetID: res[k].AssetID,
                                                    Technician: res[k].Technician
                                                };
                                                ...
                                                $.ajax({
                                                    ...
                                                    permissions: ["https://portal.systempest.com"],
                                                    success: function (maintenancejob) {
                                                        console.log("Maintennce Job : " + maintenancejob);

                                                        //Do action
                                                        var pestData = $tablePest.bootstrapTable('getData');

                                                        var table = $("#exceltablePest tbody");

                                                        table.find('tr').each(function (i) {
                                                            var $tds = $(this).find('td'),
                                                                pestDesc = $tds.eq(0).text(),
                                                                treatmentDesc = $tds.eq(1).text()
                                                        });

                                                        $.each(pestData, function (index, value) {

                                                            var pests = {
                                                                MaintenanceJobID: maintenancejob.MaintenanceJobID,
                                                                ItemNo: index + 1,
                                                                PestDesc: value.PESTS,
                                                                TreatmentDesc: value.TREATMENTS,
                                                            }
                                                ...
                                                if (i + 1 == results.length) {
                                                    $('#exceltablePest').bootstrapTable('removeAll');
                                                    $('#exceltablePest').hide();
                                                }
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (maintenancejob) {
                                                ...
                                                $.each(pestData, function (index, value) {
                                                    ...
                                                    var parsePest = value.PESTS.split(',');
                                                    for (var j = 0; j < parsePest.length; j++) {

                                                        var pests = {
                                                            MaintenanceJobID: maintenancejob.MaintenanceJobID,
                                                            ItemNo: j + 1,
                                                            PestDesc: parsePest[j],
                                                            TreatmentDesc: value.TREATMENTS,
                                                        }
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var WebAPI = 'https://webapi.systempest.com/api/maintenanceinfo/' + row.MaintenanceID;
...
$('#submit-duplicatejob').on('click', function () {
    if (getSessionstorageValueLanguage == "en") {
        bootbox.setDefaults({
            /**
             * @optional String
    ...
    var job_id = $('#duplicatejobid').val();
    var url = 'https://webapi.systempest.com/api/jobinfo/' + job_id;
    ...
    $.ajax({
        ...
        success: function (value) {
            ...
            //Time formatter
            var dateFormat = "D-MMM-YYYY, hh:mm:ss A";
            var getTimestamp = $("#dateFromForm").val();
            var convertTimestamp = moment(getTimestamp, dateFormat);
            ...
            if (getSessionstorageValueTrackVersion == "sg") {
                ...
                var timestamp = moment(convertTimestamp).subtract('hours', 7).format(dateFormat);
            }

            var getRxtime = $("#dateToForm").val();
            ...
            if (getSessionstorageValueTrackVersion == "sg") {
                ...
                var rxtime = moment(convertRxtime).subtract('hours', 7).format(dateFormat);
            }
            ...
            var job = {
                ...
                Timestamp: timestamp,
                RxTime: moment().format(),
                AssetCompany: value.AssetCompany,
                AssetCompanyID: value.AssetCompanyID,
                AssetResellerID: value.AssetResellerID,
            ...
            for (var i = 0; i < Pest.length; i++) {
                ...
                itemRows.push({
                    PestTreatmentID: 0,
                    JobID: Pest[i].JobID,
                    PestDesc: Pest[i].PestDesc,
                    TreatmentDesc: Pest[i].TreatmentDesc,
                    ItemNo: Pest[i].ItemNo
                });
                ...
                if (i + 1 == Pest.length) {
                    ...
                    $.ajax({
                        ...
                        success: function (job) {
                            ...
                            "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                            "Assigned to Driver ID: " + job.DriverID + "<br>" +
                            "Schedule Date: " + datetimeFunction(job.Timestamp) + "<br>" +
                            "Status: Job Duplicated Successfully";
                            ...
                            for (var j = 0; j < itemRows.length; j++) {
                                ...
                                var items = {
                                    PestTreatmentID: itemRows[j].PestTreatmentID,
                                    JobID: job.JobID,
                                    PestDesc: itemRows[j].PestDesc,
                                    TreatmentDesc: itemRows[j].TreatmentDesc,
                                    ItemNo: itemRows[j].ItemNo
                                }
                                ...
                                $.ajax({
                                    ...
                                    permissions: ["https://track-asia.com"],
                                    success: function (cusPrice) {

                                        $('#DuplicateJobForm').modal('hide');
