$(document).ready(function () {
    ...
    $("#PestsExportExcelEN").click(function () {
        $('#pests-editable').tableExport({
            type: 'excel',
            escape: 'false',
            htmlContent: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Pests" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
        });
    });


    $("#PestsExportPDFEN").click(function () {
        $('#pests-editable').tableExport({
            type: 'pdf',
            escape: 'false',
            pdfFontSize: 8,
    ...
    $("#PestsExportWordEN").click(function () {
        $('#pests-editable').tableExport({
            type: 'doc',
            escape: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Pests" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
    ...
    $("#TreatmentsExportExcelEN").click(function () {
        $('#treatments-editable').tableExport({
            type: 'excel',
            escape: 'false',
            htmlContent: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Treatments" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
        });
    });


    $("#TreatmentsExportPDFEN").click(function () {
        $('#treatments-editable').tableExport({
            type: 'pdf',
            escape: 'false',
            pdfFontSize: 8,
    ...
    $("#TreatmentsExportWordEN").click(function () {
        $('#treatments-editable').tableExport({
            type: 'doc',
            escape: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Treatments" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
    ...
    $("#PreventionsExportExcelEN").click(function () {
        $('#preventions-editable').tableExport({
            type: 'excel',
            escape: 'false',
            htmlContent: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Preventions" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
        });
    });


    $("#PreventionsExportPDFEN").click(function () {
        $('#preventions-editable').tableExport({
            type: 'pdf',
            escape: 'false',
            pdfFontSize: 8,
    ...
    $("#PreventionsExportWordEN").click(function () {
        $('#preventions-editable').tableExport({
            type: 'doc',
            escape: 'false',
            fileName: "[" + getSessionstorageValueCompany + "] Preventions" + " " + moment.utc().add('hours', 8).format('D-MMM-YYYY')
