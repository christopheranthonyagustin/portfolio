...
function getMarkersID(id) {
	...
	$.ajax({
		url: 'https://webapi.systempest.com/api/posinfo?id=' + id,
		type: 'GET',
		success: function (data) {
			...
			//Reverse Geocode
            var getAPI = "https://webapi.systempest.com/api/reversegeocode?PosY=" + posY + "&PosX=" + posX;
			//console.log(getAPI);
			...
			$.getJSON(getAPI, function (data) {
				...
				$.each(data, function (index, item) {
					...
					var updatePosition = 'https://webapi.systempest.com/api/updateposinfo?id=' + id;
					$.ajax({
						url: updatePosition,
						type: "PUT",
