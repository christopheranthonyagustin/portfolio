...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        {
            var WebAPI = 'https://api.systempest.com/api/devicetaginfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        }
        else if (getSessionstorageValueTrackVersion == "sg")
        {
            var WebAPI = 'https://api.systempest.com/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        }
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueTrackVersion == "vn" || getSessionstorageValueTrackVersion == "th" || getSessionstorageValueTrackVersion == "id")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            DeviceAPI = "https://api.systempest.com/api/devicetaginfo?ResellerID=" + "1" + "&CompanyID=" + "1";
        }
        else if (getSessionstorageValueRoleID == 2)
        {
            DeviceAPI = "https://api.systempest.com/api/devicetaginfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
    }
    else if (getSessionstorageValueTrackVersion == "sg")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            DeviceAPI = "https://api.systempest.com/api/deviceinfo?ResellerID=" + "1" + "&CompanyID=" + "1";
        }
        else if (getSessionstorageValueRoleID == 2) {
            DeviceAPI = "https://api.systempest.com/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
        else if (getSessionstorageValueRoleID == 3) {
            DeviceAPI = "https://api.systempest.com/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
        }
