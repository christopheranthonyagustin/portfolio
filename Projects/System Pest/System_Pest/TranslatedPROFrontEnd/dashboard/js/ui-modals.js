    ...
    $('#submit-vehicle').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/assetinfo';
                ...
                $.ajax({
                    url: "https://api.systempest.com/api/messageinfo",
                    type: "POST",
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/assetinfo",
                        type: "POST",
                    ...
                    var updateAsset = 'https://api.systempest.com/api/assetinfo?id=' + assets.AssetID;
    ...
    $('#submit-vehicleEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var apiAsset = 'https://api.systempest.com/api/duplicateasset?Name=' + assets.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจว่า คุณต้องการลบ ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/assetinfo/' + row.AssetID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'https://api.systempest.com/api/zoneinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (zones.ZoneID == 'undefined' || zones.ZoneID == null || zones.ZoneID == 0 || zones.ZoneID != GetZoneID) {
                        ...
                        $.ajax({
                            url: "https://api.systempest.com/api/zoneinfo",
                            type: "POST",
                        ...
                        var updateZone = 'https://api.systempest.com/api/zoneinfo?id=' + zones.ZoneID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiZone = 'https://api.systempest.com/api/duplicatezone?Name=' + zones.Name;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ โซน ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/zoneinfo/' + row.ZoneID;
    ...
    $('#submit-company').on('click', function () {
        ...
        bootbox.confirm("ค<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'https://api.systempest.com/api/companyinfo?id=' + company.CompanyID;
    ...
    $('#submit-companyEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var apiCompany = 'https://api.systempest.com/api/duplicatecompany?Name=' + company.Name;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/companyinfo/' + row.CompanyID;
    ...
    $('#submit-user').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการส่ง?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/userinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/userinfo",
                        type: "POST",
                    ...
                    var updateUser = 'https://api.systempest.com/api/userinfo?id=' + user.UserID;
        ...
        if (getUserCompany != "0" || getUserCompany == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                if (result) {
                    ...
                    var apiUser = 'https://api.systempest.com/api/duplicateuser?User=' + user.User;
                                ...
                                $.ajax({
                                    ...
                                    success: function (user) {
                                        ...
                                        var ajaxRequest = $.ajax({
                                            type: "POST",
                                            url: "https://api.systempest.com/api/fileupload/uploadfileuser",
                                            contentType: false,
                                            processData: false,
                                            data: data,
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/userinfo/' + row.UserID;
    ...
    $('#submit-device').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/deviceinfo",
                        type: "POST",
                    ...
                    var updateDevice = 'https://api.systempest.com/api/deviceinfo?id=' + device.DeviceID;
    ...
    $('#submit-deviceEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            if (result) {
                ...
                var GetDeviceID = $('#deviceID').val();
                var DeviceAPI = "https://api.systempest.com/api/deviceinfo"
                var apiDevice = 'https://api.systempest.com/api/duplicatedevice?Name=' + device.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/deviceinfo/' + row.DeviceID;
    ...
    $('#submit-reseller').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/resellerinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/resellerinfo",
                        type: "POST",
                    ...
                    var updateReseller = 'https://api.systempest.com/api/resellerinfo?id=' + reseller.ResellerID;
        ...
        if (getReseller == "") {
            ...
            bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
                ...
                if (result) {
                    ...
                    var GetResellerID = $('#resellerID').val();
                    var apiReseller = 'https://api.systempest.com/api/duplicatereseller?Name=' + reseller.Name;
                    if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/resellerinfo/' + row.ResellerID;
    ...
    $('#submit-driver').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'https://api.systempest.com/api/driverinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "https://api.systempest.com/api/fileupload/uploadfile",
                    contentType: false,
                    processData: false,
                    data: data,
                    success: function (data) {
                ...
                if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                    ...
                    $.ajax({
                        url: "https://api.systempest.com/api/driverinfo",
                        type: "POST",
                    ...
                    var updateDriver = 'https://api.systempest.com/api/driverinfo?id=' + driver.DriverID;
    ...
    $('#submit-driverEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
            ...
            if (result) {
                ...
                var apiDriver = 'https://api.systempest.com/api/duplicatedriver?Name=' + driver.Name;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'https://api.systempest.com/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'https://api.systempest.com/api/userinfo?id=' + profile.UserID;
                    ...
                    if (row.Flag == 1 || row.Flag == 2) {
                        bootbox.confirm("<div style='color:black'>Are you sure you wish to edit a job?</div>", function (result) {
                            ...
                            if (result) {
                                ...
                                var url = 'https://api.systempest.com/api/jobinfo';
                                var xhr = createCORSRequest('GET', url);
                                xhr.send();
                                if (!xhr) {
                                    throw new Error('CORS not supported');
                                ...
                                if (row.JobStatus == "In Progress" || row.JobStatus == "Job Edited") {
                                    ...
                                    var updateJob = 'https://api.systempest.com/api/jobinfo?id=' + jobEdit.JobID;
                                    ...
                                    //Get Asset
                                    $.ajax({
                                        url: "https://api.systempest.com/api/checkdriver",
                                        type: "POST",
                                        data: JSON.stringify(driver),
                                        crossDomain: true,
                                        contentType: 'application/json; charset=utf-8',
                                ...
                                $.ajax({
                                    ...
                                    success: function (driver) {
                                        ...
                                        if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                            ...
                                            var apiJobNumber = 'https://api.systempest.com/api/searchjob?JobNumber=' + job.JobNumber;
                                            ...
                                            $.getJSON(apiJobNumber, function (data) {
                                                ...
                                                if (data.length == 1) {
                                                    ...
                                                    //Add Scheduled Job
                                                    $.ajax({
                                                        url: "https://api.systempest.com/api/jobinfo",
                                                        type: "POST",
                                            ...
                                            var updateJob = 'https://api.systempest.com/api/jobinfo?id=' + job.JobID;
            ...
            if (row.Flag == 0 || row.Flag == 1 || row.Flag == 2) {
                bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
                    if (result) {
                        ...
                        var WebAPI = 'https://api.systempest.com/api/jobinfo/' + row.JobID;
                                    ...
                                    if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (job) {
                                                        ...
                                                        table.find('tr').each(function (i) {
                                                            ...
                                                            $.ajax({
                                                                url: "https://api.systempest.com/api/pesttreatmentinfo",
                                                                type: "POST",
                                                                ...
                                                                permissions: ["https://app.systempest.com"],
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (res) {
                                                ...
                                                var deletePestTreatment = 'https://api.systempest.com/api/deletepesttreatment';
...
$('#submit-itemEN').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'https://api.systempest.com/api/inventoryinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            var apiAsset = 'https://api.systempest.com/api/duplicateinventory?Name=' + getItemName + "&CompanyID=" + getSessionstorageValueCompanyID;
            ...
            if (getInventoryID == 'undefined' || getInventoryID == null || getInventoryID == 0 || getInventoryID != getInventoryID || getInventoryID == "") {
                ...
                $.getJSON(apiAsset, function (data) {
                    ...
                    if (data.length == 1) {
                        ...
                        $.ajax({
                            url: "https://api.systempest.com/api/inventoryinfo",
                            type: "POST",
                            ...
                            success: function (inventory) {
                                ...
                                var ajaxRequest = $.ajax({
                                    type: "POST",
                                    url: "https://api.systempest.com/api/fileupload/uploadfileinventory",
                                    contentType: false,
                                    processData: false,
                                    data: data,
                                    success: function (data) {
                                ...
                                $.ajax({
                                    url: "https://api.systempest.com/api/inventoryhistoryinfo",
                                    type: "POST",
                ...
                var updateInventory = 'https://api.systempest.com/api/inventoryinfo?id=' + getInventoryID;
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var WebAPI = 'https://api.systempest.com/api/inventoryinfo/' + row.InventoryID;
...
$('#submit-change-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://api.systempest.com/api/jobinfo/' + getJobID;
...
$('#submit-change-main-driver').on('click', function () {
    ...
    var timestamp = moment(convertTimestamp).subtract('hours', 8).format(dateFormat);
    var WebAPIJob = '';
    WebAPIJobs = 'https://api.systempest.com/api/maintenancejobinfo/' + getJobID;
        ...
        if (validateTimestamp == true){
                ...
                success: function (data) {
                    ...
                    if (data.Flag == 0) {
                        ...
                        var updateJob = 'https://api.systempest.com/api/maintenancejobinfo?id=' + job.MaintenanceJobID;
                        $.ajax({
                            url: updateJob,
                            type: "PUT",
                            data: JSON.stringify(job),
                ...
                if (result) {
                    ...
                    if ($('#jobMaintenanceID').val() == "") {
                        ...
                        if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                            ...
                            $.ajax({
                                url: "https://api.systempest.com/api/maintenanceinfo",
                                type: "POST",
                        ...
                        if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                            if ($('#pestsTreatment').bootstrapTable('getData').length == 0) {
                                ...
                                //Recalculate
                                $.ajax({
                                    url: "https://api.systempest.com/api/maintenanceinfo?id=" + $('#jobMaintenanceID').val(),
                                    type: "PUT",
                                    data: JSON.stringify(maintenance),
                                    async: false,
                                    crossDomain: true,
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (event) {
                                                ...
                                                if (sessionStorage.getItem('setSessionstorageValueRegenerateMaintenance') == "true") {
                                                    ...
                                                    $.ajax({
                                                        url: "https://api.systempest.com/api/maintenancejobinfoex/" + $('#jobMaintenanceID').val(),
                                                        type: "GET",
                                                        crossDomain: true,
                                                        contentType: 'application/json; charset=utf-8',
                                                        xhrFields: {
                                                        ...
                                                        success: function (res) {
                                                            ...
                                                            if (res.MaintenanceID > 0) {
                                                                ...
                                                                $.ajax({
                                                                    url: 'https://api.systempest.com/api/maintenancejobinfo/' + $('#jobMaintenanceID').val(),
                                                                    type: "Delete",
                                                                    async: false,
...
$('#submit-maintenance').on('click', function () {
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSure + "</div>", function (result) {
        ...
        if (result) {
            ...
            var url = 'https://api.systempest.com/api/maintenanceinfo';
            var xhr = createCORSRequest('GET', url);
            xhr.send();
            if (!xhr) {
                throw new Error('CORS not supported');
            ...
            $.each(data, function (index, value) {
                ...
                $.ajax({
                    ...
                    success: function (maintenance) {
                        ...
                        var apiDriver = 'https://api.systempest.com/api/duplicatedriver?Name=' + value.DRIVER;
    ...
    bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
        if (result) {
            ...
            var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                ...
                var WebAPI = 'https://api.systempest.com/api/maintenanceinfo/' + row.MaintenanceID;
...
$('#submit-duplicatejob').on('click', function () {
    ...
    var url = 'https://api.systempest.com/api/jobinfo/' + job_id;
