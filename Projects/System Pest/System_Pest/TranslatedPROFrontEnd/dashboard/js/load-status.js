...
if (getSessionstorageValueRoleID == 1) {
    var getZone = 'https://api.systempest.com/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    var getZoneByID = 'https://api.systempest.com/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    ...
    var getZoneByID = 'https://api.systempest.com/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
