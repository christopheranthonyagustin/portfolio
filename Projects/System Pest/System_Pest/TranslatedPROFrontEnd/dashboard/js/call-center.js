...
$(function () {
    ...
    //Populate phone user
    var WebAPIPest = "https://api.systempest.com/api/treatmentinfo";
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('https://api.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'https://api.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'https://api.systempest.com/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
	...
	if (flag == 0 && getSessionstorageValueRoleID > 3){
	    ...
	    bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to edit this job?' + "</div>", function (result) {
	        if (result) {
	            ...
	            var WebAPI = 'https://api.systempest.com/api/jobinfo/' + job_id;
...
function deletejob(data) {
    ...
    if (data.Flag == 0 && getSessionstorageValueRoleID > 3) {
        ...
        bootbox.confirm("<div style='color:black'>" + 'Are you sure you want to delete this job?' + "</div>", function (result) {
            if (result) {
                ...
                var jobs = JSON.stringify({ 'JobID': data.JobID });
                var WebAPI = 'https://api.systempest.com/api/jobinfo/' + data.JobID;
                console.log(WebAPI)
                $.ajax({
                    url: WebAPI,
                    type: "DELETE",
                    ...
                    success: function (res) {
                        console.log(res);
                        var remarks = "Job ID: " + data.JobID + "<br>" +
                        "Job Number: " + data.JobNumber + "<br>" +
                        "User: " + sessionStorage.getItem('setSessionstorageValueUser') + "<br>" +
                        "Assigned to Driver ID: " + data.DriverID + "<br>" +
                        "Schedule Date: " + datetimeFunction(data.Timestamp) + "<br>" +
                        ...
                        var event = {
                            ...
                            AlertLevelEx: 0,
                            Flag: 1,
                            AckUserID: sessionStorage.getItem('setSessionstorageValueRoleID'),
...
function calculateDistances(pt, closest, numberOfResults) {
    ...
    $.ajax({
        url: 'https://api.systempest.com/api/distancematrix?Origin=' + originPT[1] + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
...
function calculateLocationIQDistances(pt, closest, numberOfResults) {
    ...
    console.log('URL : ' + 'https://api.systempest.com/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest);

    $.ajax({
        url: 'https://api.systempest.com/api/distancematrix?Origin=' + originPT + '&Destination=' + finalClosest,
        type: 'GET',
        cache: false,
        dataType: 'json',
        success: function (json) {
...
function searchDriver(id) {
    ...
    var apiDriver = 'https://api.systempest.com/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'https://api.systempest.com/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'https://api.systempest.com/api/searchjob?JobNumber=' + getJobNumber;
    //alert(apiJobNumber);
...
function reloadJobsCreated()
    {
        ...
        var WebAPIJobs = 'https://api.systempest.com/api/jobinfoex?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID;
;
        // if (getSessionstorageValueRoleID == 1) {

        //     WebAPIJobs = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        // }
        // else if (getSessionstorageValueRoleID == 2) {
        ...
        //     WebAPIJobs = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Agent=' + getSessionstorageValueUser;
        // }
                    ...
                    for (k = 0; k < res.length; k++) {
                        ...
                        if (res[k] != undefined || res[k]) {
                            ...
                            outputDiv.innerHTML += "<table id='jobsCreated' border='1'>"
                                        ...
                                        //"<a href='javascript:viewsubtitle(" + JSON.stringify(row) + ",\"" + $('#system_pcr').val() + "\",\"" + $('#system_sitename').val() + "\")' style='color:#86C6FF;'>" 
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'https://api.systempest.com/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
...
function showArrayCircle(event) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIAsset = 'https://api.systempest.com/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';
