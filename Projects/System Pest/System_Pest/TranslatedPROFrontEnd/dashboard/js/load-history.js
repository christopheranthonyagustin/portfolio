...
//Load Events
$.getJSON("https://api.systempest.com/api/statusinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://api.systempest.com/api/assetinfo?UserID=" + '&ResellerID=' + "1" + '&CompanyID=' + "1", function (data) {
        $.each(data, function (index, item) {
    ...
    $.getJSON("https://api.systempest.com/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets').append(
...
$.getJSON("https://api.systempest.com/api/inventoryinfo?CompanyID=" + getSessionstorageValueCompanyID, function (data) {
    $.each(data, function (index, item) {
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
            $.getJSON("https://api.systempest.com/api/companyinfo?&ResellerID=" + "1", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://api.systempest.com/api/assetinfo", function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
    ...
    $.getJSON("https://api.systempest.com/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
...
$.getJSON("https://api.systempest.com/api/categoryinfo", function (data) {
    $.each(data, function (index, item) {
    ...
    function Generate() {
        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var WebApiBarlight = "";
                var jobApi = "";
                var WebApiMessages = "https://api.systempest.com/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                
                var inventoryAPI = 'https://api.systempest.com/api/inventoryhistoryinfo?CompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Reference=' + getReference;
                ...
                if (getAsset == "")
                {
                    ...
                    WebApiCVR = "https://api.systempest.com/api/cvrinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMeterPerSeconds;
                    WebApi = "https://api.systempest.com/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMeterPerSeconds;
                    WebApiBarlight = "https://api.systempest.com/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Barlight=1";
                    jobApi = 'https://api.systempest.com/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    WebApiCVR = "https://api.systempest.com/api/cvrinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApi = "https://api.systempest.com/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApiBarlight = "https://api.systempest.com/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMeterPerSeconds + "&Barlight=1" + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    jobApi = 'https://api.systempest.com/api/jobhistory?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;            
                }
                ...
                if (getLocalstorageValueRetrieveReport == "reports-positions") {
                    ...
                    if (strEvent == 1 | strEvent == 2) {
                        WebApiEvent = "https://api.systempest.com/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                        ...
                        WebApiEvent = "https://api.systempest.com/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
...
$.getJSON("https://api.systempest.com/api/reportinfo", function (data) {
    $.each(data, function (index, item) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAgent = 'https://api.systempest.com/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

} else if (getSessionstorageValueRoleID == 2) {
    WebAPIAgent = 'https://api.systempest.com/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://api.systempest.com/api/companyinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    MobileWebAPIReseller = 'https://api.systempest.com/api/resellerinfo';
    ...
    MobileWebAPIReseller = 'https://api.systempest.com/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "https://api.systempest.com/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "https://api.systempest.com/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "https://api.systempest.com/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'https://api.systempest.com/api/jobhistory?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'https://api.systempest.com/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: titleTimestamp,
