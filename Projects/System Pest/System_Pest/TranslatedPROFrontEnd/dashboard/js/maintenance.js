...
function searchJobFilter() {
    ...
    WebAPIJobs = 'https://api.systempest.com/api/maintenancefilterinfo?CompanyID=' + getSessionstorageValueCompanyID + '&CusCompany=' + companyName + '&PIC=' + personInCharge + '&Postal=' + postalCode + '&Address=' + address + '&Phone=' + phone + '&ContractStart=' + timestamp + '&ContractEnd=' + rxtime;
            ...
            $("<div id='viewForms'>").dialog({
                ...
                open: function () {
                    ...
                    function pdfactionFormatter(maintenance_id, value) {
                        return "<div>" + "<span>" + "<a href='javascript:previewpdf(" + maintenance_id + ',' + value + ")' style='color:#458FD2;'>" + "Resend Report" + "</a>" + "</span>" + "</div>";
                        //return "<button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-target='#MaintenanceJobForm'>Launch demo modal</button>";
    ...
    if (getSessionstorageValueRoleID > 3) {
        ...
        bootbox.confirm("<div style='color:black'>" + titleAreYouSureDelete + "</div>", function (result) {
            if (result) {
                ...
                var WebAPI = 'https://api.systempest.com/api/maintenanceinfo/' + data.MaintenanceID;
                ...
                if($('#update_reference_no').val() == ''){
                    ...
                    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to update all reference no?" + "</div>", function (result) {
                        if (result) {
                            ...
                            var updateReferenceNo = 'https://api.systempest.com/api/maintenancejobreference?id=' + maintenance_id;
                            $.ajax({
...
function enableEmailNotification(maintenance_id) {
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to enable all email notification?" + "</div>", function (result) {
        if (result) {
            ...
            var updateMaintenanceJob = 'https://api.systempest.com/api/maintenancejobalert?id=' + maintenance_id;
            $.ajax({
...
console.log("https://api.systempest.com/api/maintenancejobinfo/" + maintenance_job_id)
    $.ajax({
        type: 'GET',
    ...
    bootbox.confirm("<div style='color:black'>" + "Are you sure you wish to delete the maintenance job?" + "</div>", function (result) {
        if (result) {
            ...
            var jobs = JSON.stringify({ 'MaintenanceJobID': maintenance_job_id });
                var WebAPI = 'https://api.systempest.com/api/removemaintenancejobinfo?id=' + maintenance_job_id;
                                        ...
                                        if (result) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (json) {
                                                    ...
                                                    var emailMaintenanceJob = 'https://api.systempest.com/api/emailmaintenancejob';
                                                    var maintenanceFinalID = value.MaintenanceID;
                                                    $.ajax({
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == "undefined" | getSessionstorageValueUser == "") {
        ...
        window.location.href = 'https://app.systempest.com/'; //Login URL
...
$(function () {
    ...
    $('#companyName').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'https://api.systempest.com/api/autocompletecompany?CompanyID=' + getSessionstorageValueCompanyID + '&CusCompany=' + $("#companyName").val(),
                type: 'GET',
                cache: false,
                data: {
    ...
    $('#jobDestination').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'https://api.systempest.com/api/autocompleteaddress?CompanyID=' + getSessionstorageValueCompanyID + '&Address=' + $("#jobDestination").val(),
                type: 'GET',
                cache: false,
                data: {
