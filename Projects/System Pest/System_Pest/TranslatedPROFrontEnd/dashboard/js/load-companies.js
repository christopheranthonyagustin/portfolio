...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://api.systempest.com/api/companyinfo?ResellerID=' + selectedReseller;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        WebAPI = 'https://api.systempest.com/api/companyinfo?ResellerID=' + '1';
    }
    else if (getSessionstorageValueRoleID == 2)
    {
        WebAPI = 'https://api.systempest.com/api/companyinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
        WebAPI = 'https://api.systempest.com/api/companyinfo?CompanyID=' + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID;
