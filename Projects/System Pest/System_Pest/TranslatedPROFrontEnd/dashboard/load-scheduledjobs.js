...
function GenerateAreaTable() {
    ...
    var WebAPIJobs = 'https://api.systempest.com/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&FormType=' + getSessionstorageValueCompanyID + '&Groups=' + getGroup;

    var WebAPIMainJobs = 'https://api.systempest.com/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&Groups=' + getGroup;
