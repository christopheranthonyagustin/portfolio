...
if (getSessionstorageValueCompanyID == 1) {
    groupApi = 'https://api.systempest.com/api/groupinfo';
}
else if (getSessionstorageValueCompanyID == 2) {
    groupApi = 'https://api.systempest.com/api/groupmyinfo';
}
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://api.systempest.com/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://api.systempest.com/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("https://api.systempest.com/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://api.systempest.com/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        jobApi = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID == 2) {
        jobApi = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID >= 3) {
        jobApi = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
...
function GenerateEN() {
    ...
    if($('#load-category').val() == 1){
        ...
        var jobApi = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany+ '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
...
function GenerateAreaTable(){
    ...
    if (getSessionstorageValueCompanyID == 1) {
        ...
        acAPI = 'https://api.systempest.com/api/acinfo?Groups=' + $('#load-groups').val();
    
    }
	else if (getSessionstorageValueCompanyID == 2) {

        acAPI = 'https://api.systempest.com/api/acmyinfo?Groups=' + $('#load-groups').val();
	...
	var markup = "<div style='border-style: none; margin: 0px; padding: 0px 3px; overflow: auto class=''>"
					+ "<table id='areaTable' class='table table-bordered' cellspacing='0'>"
					+ "<thead>"
					+ "<tr>"
	...
	var WebAPIJobs = 'https://api.systempest.com/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&FormType=' + getSessionstorageValueCompanyID;

    var WebAPIMainJobs = 'https://api.systempest.com/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        ...
        $.ajax({
            ...
            success: function (data) { 
                ...
                for(var i = 0; i < data.length; i++){
                    markup += "<th style='color: gray; background-color: white; font-size: 14px;padding-left: 10px;padding: 10px; width: 100%;'>" + data[i].Groups + "</th>"
                                                        ...
                                                        if(timeTableDateFormatter(jobs[k].Timestamp) == timestamp){
                                                            if(timeTableFormatter(jobs[k].Timestamp) > '0359' && timeTableFormatter(jobs[k].Timestamp) < '0800')
                                                            {
                                                                ...
                                                                jobInformation += "Time : " + timeTableDisplayFormatter(jobs[k].Timestamp) 
                                                                                ...
                                                                                + "<br>"
                                                                                +"<br>"+ "Status : " + statusFormatter(jobs[k].FlagValue )
                                                                                + "<br>"
                    ...
                    if(i + 1 == data.length){
                        ...
                        for(var j = 0; j < data.length; j++){
                            ...
                            success: function (jobs) {
                                var jobInformation = '';
                                if(jobs.length <= 0){
                                    //arkup += "<td style='color: gray; background-color: white; font-size: 10px'></td>"
                                    $.ajax({
                                        type: 'GET',
                                        async: false,
                                        url: WebAPIMainJobs,
...
function changeDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'https://api.systempest.com/api/jobinfo/' + jobid;
...
function changeMainDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'https://api.systempest.com/api/maintenancejobinfo/' + jobid;
...
function GenerateTechnicianTable(){
	...
	var markup = "<div style='border-style: none; margin: 0px; padding: 0px 3px; overflow: auto;'>"
                    ...
                    + "<th style='color: gray; background-color: white; font-size: 14px; padding-left: 10px;padding: 10px; white-space: nowrap'>4 am - 8 am</th>"
                    ...
                    + "<th style='color: gray; background-color: white; font-size: 14px; padding-left: 10px;padding: 10px; white-space: nowrap'>8 pm - 4 am</th>"
                    + "</tr>"
                    + "</thead>"
                    + "<tbody>"
    var WebAPIDriver = "";
    ...
    if (getSessionstorageValueCompanyID == 2) {
        ...
        success: function (data) { 
            ...
            for(var i = 0; i < data.length; i ++){
                ...
                var WebAPIJobs = 'https://api.systempest.com/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
                        ...
                        if(jobs.length <= 0){
                            ...
                            for(var q = 0; q < 8; q++){
                                if (q == 0) {
                                    ...
                                    if(jobs.length <= 0){
                                        var WebAPIMainJobs = 'https://api.systempest.com/api/maintenancejobdateinfo?AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp  + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
        ...
        success: function (data) { 
            ...
            for(var i = 0; i < data.length; i ++){
                ...
                var WebAPIJobs = 'https://api.systempest.com/api/joboverview?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
