...
http://github.com/ashleydw/lightbox

License: http://github.com/ashleydw/lightbox/blob/master/LICENSE
###
"use strict";
...
EkkoLightbox.prototype = {
	...
	isExternal : (url) ->
		...
		return true if typeof match[2] == "string" && match[2].length > 0 && match[2].replace(new RegExp(":("+{"http:":80,"http:":443}[location.protocol]+")?$"), "") != location.host
		false
