...
namespace FMSWebApi.Controllers
{
    ...
    public class MaintenanceFilterInfoController : ApiController
    {
        ...
        {           
            if((param.CompanyID > 0 && !string.IsNullOrEmpty(param.CusCompany) || !string.IsNullOrEmpty(param.PIC) || !string.IsNullOrEmpty(param.Postal) || !string.IsNullOrEmpty(param.Address) || !string.IsNullOrEmpty(param.Phone) || (param.ContractStart != DateTime.MinValue && param.ContractEnd != DateTime.MinValue)))
            {
                //Logger.LogEvent("Enter API - " + string.Format("Start: {0} End {1}", param.ContractStart, param.ContractEnd), System.Diagnostics.EventLogEntryType.Warning);
