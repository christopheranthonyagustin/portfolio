    ...
    public class EventRepository : IEventRepository
    {
        ...
        public IEnumerable<EventInfo> GetAll()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM view_events";
                cmd.Connection = conn;
                                    ...
                                    case "Zone Exit":
                                    {
                                        try 
                                        {
                                            ...
                                            if (udtEvent.Event == "Zone Enter")
                                            {
                                                ...
                                                if (currJobs.JobID != 0 && currJobs.FlagValue == "In Progress" && currJobs.Flag == 3)
                                                {
                                                ...
                                                else if (currJobs.JobID != 0 && currJobs.FlagValue == "In Progress" && currJobs.Flag == 3)
                                                {
                                                    stopWatch.Start();
                                                    System.Threading.Thread.Sleep(TimeSpan.FromMinutes(30));
                                                    //System.Threading.Thread.Sleep(TimeSpan.FromSeconds(5));
