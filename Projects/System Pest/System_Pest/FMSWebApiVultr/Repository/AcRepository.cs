    ...
    public class AcRepository : IAcRepository
    {
        ...
        public IEnumerable<AcInfo> GetAll()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM area_covered group by general_location order by postal_district asc";
                cmd.Connection = conn;
        ...
        public IEnumerable<AcInfo> GetAllEx()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM area_covered group by groups_ac order by postal_district asc";
                cmd.Connection = conn;
                cmd.CommandType = CommandType.Text;
                MySqlDataReader reader = cmd.ExecuteReader();
