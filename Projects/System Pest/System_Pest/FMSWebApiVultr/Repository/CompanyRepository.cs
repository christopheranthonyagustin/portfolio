...
namespace FMSWebApi.Repository
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        private string mConnStr = "server=127.0.0.1;uid=root;pwd=@c3c0M;database=sp;max pool size=500;SSL Mode=None;default command timeout=360;";
        ...
        public IEnumerable<CompanyInfo> GetAll()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM view_companies WHERE company_id != 0";
                cmd.Connection = conn;
