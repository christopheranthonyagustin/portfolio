...
namespace FMSWebApi.Repository
{
    ...
    {
        private string mConnStr = "server=127.0.0.1;uid=root;pwd=@c3c0M;database=sp;Charset=utf8;max pool size=500;SSL Mode=None;default command timeout=999999;";
        ...
        public IEnumerable<MaintenanceInfo> GetAll()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM view_maintenance";
                cmd.Connection = conn;
