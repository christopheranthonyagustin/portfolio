    ...
    public class AcMyRepository : IAcMyRepository
    {
        ...
        public IEnumerable<AcMyInfo> GetAll()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM area_covered group by groups_ac order by groups_ac asc";
                cmd.Connection = conn;
        ...
        public IEnumerable<AcMyInfo> GetAllEx()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM area_covered_my group by groups_ac order by groups_ac asc";
                cmd.Connection = conn;
                cmd.CommandType = CommandType.Text;
                MySqlDataReader reader = cmd.ExecuteReader();
