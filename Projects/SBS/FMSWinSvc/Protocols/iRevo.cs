    ...
    public class iRevo
    {
        ...
        public FMSWebApi.Models.PosInfo ParseData(string rawData)
        {
             ...
             */
                ...
                //Logger.LogToEvent("iRevo RawData: " + rawData, System.Diagnostics.EventLogEntryType.Information);
                ...
                if (rawData.Contains(Consts.iRevo_HEAD))
                {
                    ...
                    //realData = rawData.Substring(rawData.IndexOf(Consts.iRevo_DATA));     
                        ...
                        //Logger.LogToEvent("DeviceID: " + deviceID, System.Diagnostics.EventLogEntryType.Error);
                        ...
                        if (arrData[5] == "A")
                        {
                            ...
                            //Logger.LogToEvent("RxTime: " + newPos.RxTime, System.Diagnostics.EventLogEntryType.Error);
                            newPos.FixID = (arrData[5] == "A" ? 2 : 4);
                            newPos.Satellites = 0;
                            newPos.Timestamp = BuildTimestamp(arrData[0], arrData[1]);
                            //Logger.LogToEvent("Timestamp: " + newPos.Timestamp, System.Diagnostics.EventLogEntryType.Error);
                            //newPos.PosY = BuildLatLong(arrData[2], arrData[2]);//parse latitude
                            newPos.PosY = Convert.ToDouble(arrData[2]);
                            //Logger.LogToEvent("Latitude: " + newPos.PosY, System.Diagnostics.EventLogEntryType.Error);
                            //newPos.PosX = BuildLatLong(arrData[3], arrData[3]);//parse longitude
                            newPos.PosX = Convert.ToDouble(arrData[3]);
                            //Logger.LogToEvent("Longtitude: " + newPos.PosX, System.Diagnostics.EventLogEntryType.Error);
                            newPos.Speed = BuildSpeed(arrData[4]); //parse speed
                            //Logger.LogToEvent("Speed: " + newPos.Speed, System.Diagnostics.EventLogEntryType.Error);
                            ...
                            //Logger.LogToEvent("Ignition: " + newPos.Ignition, System.Diagnostics.EventLogEntryType.Error);
                        }
