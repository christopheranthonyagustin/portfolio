...
namespace FMSWinSvc
{
    public partial class Service1 : ServiceBase
    {
        ...
        public async Task SavePosRunAsync(string rawData)
        {
            ...
            StringBuilder sCommand = new StringBuilder("INSERT INTO positions (asset_id, tag_id, timestamp, rx_time, fix, " +
                                    ...
                                    await conn.OpenAsync();
                                        ...
                                        using (MySqlCommand cmd = new MySqlCommand())
                                        {
                                            ...
                                            for (int i = 0; i <= 50000; i++)
                                            {
                                                ...
                                                cmd.Parameters.AddWithValue("@TagID", deviceID);
                                                ...
                                                //Logger.LogToEvent("Event Saved: ", System.Diagnostics.EventLogEntryType.Warning);
                                                cmd.ExecuteNonQuery();
                                            }
