            ...
            try
            {
                ...
                if (bConnected)
                {
                    ...
                    if (iLen > 0)
                    {
                        ...
                        //Mobile Eye
                        if (strTemp.StartsWith("I") && strTemp.Contains("\r") && strTemp.EndsWith("\r"))
                        {
                            //Send Ack
                            ...
                            if (strTempArr.Length > 1)
                            {
                                ...
                                string StringAL = String.Format("A,L" + CR);
                                Send(StringAL, sockInfo.Socket);
                        ...
                        //else if (strTemp.StartsWith("L") && strTemp.Contains("\r") && strTemp.EndsWith("\r"))
                        //{
                        //    //Send Ack
                        //    const char CR = (char)13;  //Cr
