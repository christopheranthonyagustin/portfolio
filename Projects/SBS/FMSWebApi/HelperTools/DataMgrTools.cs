...
namespace FMSWebApi
{
    ...
    {
        private static string mProjName = "FMS-SBS";
        ...
        public static OverallPerformanceInfo BuildOverallPerformance(MySqlDataReader dbRdr)
        {
            ...
            try
            {
                OverallPerformance.DrvID = dbRdr.ToInt32("DrvNo");
                OverallPerformance.LDW = dbRdr.ToInt32("LDW");
                OverallPerformance.HW = dbRdr.ToInt32("HW");
                OverallPerformance.FCW = dbRdr.ToInt32("FCW");
                OverallPerformance.PCW = dbRdr.ToInt32("PCW");
                OverallPerformance.TotalLDW = dbRdr.ToInt32("TOTAL_LDW");
                OverallPerformance.TotalEvents = dbRdr.ToInt32("TOTAL_EVENTS");
            }
            catch (Exception ex)
            {
                // log error
        ...
        public static BcPerformanceInfo BuildBcPerformance(MySqlDataReader dbRdr)
        {
            ...
            try
            {
                BcPerformance.LDW = dbRdr.ToInt32("LDW");
                BcPerformance.HW = dbRdr.ToInt32("HW");
                BcPerformance.FCW = dbRdr.ToInt32("FCW");
                BcPerformance.PCW = dbRdr.ToInt32("PCW");
                BcPerformance.TotalLDW = dbRdr.ToInt32("TOTAL_LDW");
                BcPerformance.TotalEvents = dbRdr.ToInt32("TOTAL_EVENTS");
            }
            catch (Exception ex)
            {
                // log error
        ...
        public static DailyPerformanceInfo BuildDailyPerformance(MySqlDataReader dbRdr)
        {
            DailyPerformanceInfo DailyPerformance = new DailyPerformanceInfo();
            try
            {
                DailyPerformance.Date = dbRdr.ToDateTime("Date");
                DailyPerformance.LDW = dbRdr.ToInt32("LDW");
                DailyPerformance.HW = dbRdr.ToInt32("HW");
                DailyPerformance.FCW = dbRdr.ToInt32("FCW");
                DailyPerformance.PCW = dbRdr.ToInt32("PCW");
                DailyPerformance.TotalLDW = dbRdr.ToInt32("TOTAL_LDW");
                DailyPerformance.TotalEvents = dbRdr.ToInt32("TOTAL_EVENTS");
            }
            catch (Exception ex)
            {
                // log error
                Logger.LogEvent("DailyPerformanceInfo", ex.Message, System.Diagnostics.EventLogEntryType.Error);
