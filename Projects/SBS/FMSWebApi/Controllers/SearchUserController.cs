...
namespace FMSWebApi.Controllers
{
    ...
    {
        private static readonly ISearchUserRepository repository = new SearchUserRepository();

       // public IEnumerable<SearchUser> GetAllAssets()
        //{
       //     return repository.GetAll();
       // }

        public SearchUser GetAsset(int userID)
        {
            SearchUser currUser = repository.Get(userID);
            if (currUser == null)
            {
       ...
       // public IEnumerable<SearchUser> GetUserByName(string username)
        //{
      ...
      //  }
		 ...
		 public IEnumerable<SearchUser> GetByCompany([FromUri]SearchUser param)
        {
        ...
        public SearchUser PostAsset([FromBody]SearchUser currUser)
        {
        ...
        public bool PutUser(int id, [FromBody]SearchUser currUser)
        {
        ...
        public void DeleteProduct(int id)
        {
            ...
            SearchUser currUser = repository.Get(id);
            if (currUser == null)
            {
                throw new HttpResponseException(HttpStatusCode.NotFound);
            }
