...
namespace FMSWebApi.Repository
{
    ...
    {
        IEnumerable<DailyPerformanceInfo> GetAll();
        DailyPerformanceInfo Get(int posID);
        IEnumerable<DailyPerformanceInfo> GetDailyPerformance(DailyPerformanceInfo value);
    }
