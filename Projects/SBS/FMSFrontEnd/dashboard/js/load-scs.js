...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'http://track.asiacom.co.th/sbswebapi/api/scsinfo';
    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://track.asiacom.co.th/sbswebapi/api/scsinfo';
        //WebAPI = 'http://103.237.168.119/sbswebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
