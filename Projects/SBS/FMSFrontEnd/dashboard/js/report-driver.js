...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        var WebApi = 'http://103.237.168.119/sbswebapi/api/posinfo/?Asset=' + getAsset + '&Speed=&CompanyID=1&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
...
$(function () {
    ...
    $.getJSON("http://track.asiacom.co.th/sbswebapi/api/driverinfo", function (data) {
