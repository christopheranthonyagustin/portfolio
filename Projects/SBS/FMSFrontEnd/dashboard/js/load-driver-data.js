...
$(document).ready(function () {
 ...
 var getAsset = $("#eventlog").val(); //the value of the selected option   
    ...
    if (changeCheckbox.checked) {
        ...
        WebApi = "http://103.237.168.119/sbswebapi/api/posinfoex?Asset=" + getAsset + "&Speed=&CompanyID=1&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    }
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var table = $("#tripData").DataTable({
                    ...
                    "columns": [
                        ...
                        { data: "RxTime", title: "End Time" },
                        { data: "Hours", title: "No. of hrs" },
                        { data: "FCW", title: "FCW" },
                        { data: "PCW", title: "PCW" },
                        { data: "HMW", title: "HMW" },
                        { data: "LDW", title: "LDW" },
                    ...
                    },
                    {
                        ...
                        // this case `data: 0`.
                        "render": function (data, type, row) {
                            return startTimeFormatter(data);
                        },
                        "targets": 4
                    },
                    {
