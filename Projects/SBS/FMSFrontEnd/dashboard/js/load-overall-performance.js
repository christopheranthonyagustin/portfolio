...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        {
            //http://103.237.168.119/sbswebapi/api/overallperformanceinfo?DepotID=1&InterchangeID=1&DrvNo=15192&SvcNo=166&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            WebApi = "http://103.237.168.119/sbswebapi/api/overallperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=" + getDriver + "&SvcNo=" + getSessionstorageValueOPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
            WebApiErr = "http://103.237.168.119/sbswebapi/api/overallperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=&SvcNo=" + getSessionstorageValueOPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        }
...
$(function () {
    ...
    $('.SelectInterchangeFilter').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://103.237.168.119/sbswebapi/api/scsarchiveinfo?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
