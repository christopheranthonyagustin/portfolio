...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        {
            //http://103.237.168.119/sbswebapi/api/dailyperformanceinfo?DepotID=1&InterchangeID=1&DrvNo=15192&SvcNo=166&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            WebApi = "http://103.237.168.119/sbswebapi/api/dailyperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=" + getDriver + "&SvcNo=" + getSessionstorageValueDPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        }
...
$(function () {
    ...
    $('.SelectSvcFilter').on('change', function () {
        ...
        if (arrSelected == "" || arrSelected == null) {
            ...
            $('#driver').empty();
            //http://103.237.168.119/sbswebapi/api/scsarchiveinfo?Depot=1,2&Interchange=1,2&Interchange=1&OP_DATE_START=01-Sep-2016&OP_DATE_END=05-Sep-2016 
            var WebAPISvc = "http://103.237.168.119/sbswebapi/api/scsarchiveinfo?Depot=" + getDepot + "&Interchange=" + getInterchange + "&SVC_NO=" + arrSelected + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime;
