...
namespace FMSWebApi.Controllers
{
    ...
    public class OaPerfParamsInfoController : ApiController
    {
        private static readonly IOaPerfParamsRepository repository = new OaPerfParamsInfoRepository();

        public IEnumerable<OaPerfParamsInfo> GetOverallPerformance([FromUri]OaPerfParamsInfo param)
        {
        ...
        public OaPerfParamsInfo GetOaPerfParams(int id)
        {
            OaPerfParamsInfo currOAPerfParams = repository.Get(id);
        ...
        public OaPerfParamsInfo PostAsset([FromBody]OaPerfParamsInfo currOAPerfParams)
        {
