...
$(document).ready(function () {
    ...
    //Check Filter 
    //http://66.96.208.81/sbswebapi/api/bcrankinginfo?DepotID=1&InterchangeID=1&Criteria=LDW&Performance=ASC&LIMIT=5&Timestamp=31-Aug-2016,%2004:00:00%20AM%20&RxTime=1-Sep-2016,%2016:00:00%20PM
    ...
    function Generate() {
        ...
        {
            //http://66.96.208.81/sbswebapi/api/bcrankinginfo?DepotID=1&InterchangeID=1&SvcNo=166&Criteria=FCW&Performance=DESC&LIMIT=15&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            WebApi = "http://66.96.208.81/sbswebapi/api/bcrankinginfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&SvcNo=" + getSessionstorageValueBCRankSvc + "&Criteria=" + getCriteria + "&Performance=" + getPerformance + "&LIMIT=" + getBC + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        }
