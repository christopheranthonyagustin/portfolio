...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        {
            //http://66.96.208.81/sbswebapi/api/bcperformanceinfo?DepotID=1&InterchangeID=1&DrvNo=15989&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            //WebApi = "http://66.96.208.81/sbswebapi/api/bcperformanceinfo?DepotID1=" + parseObjDepot + "&DepotID2=" + parseObjDepot2 + "&DrvNo1=" + getDriver + "&DrvNo2=" + getDriver2 + "&Timestamp1=" + timestamp + "&RxTime1=" + rxtime + "&Timestamp2=" + timestamp2 + "&RxTime2=" + rxtime2 + "&Criteria=" + getCriteria;
            //WebApi2 = "http://66.96.208.81/sbswebapi/api/bcperformanceinfo?DepotID=" + parseObjDepot2 + "&DrvNo=" + getDriver2 + "&Timestamp=" + timestamp2 + "&RxTime=" + rxtime2 + "&Criteria=" + getCriteria;
            WebApi = "http://66.96.208.81/sbswebapi/api/bcperformanceinfo?DrvNo1=" + getDriver + "&DrvNo2=" + getDriver2 + "&Timestamp1=" + timestamp + "&RxTime1=" + rxtime + "&Timestamp2=" + timestamp2 + "&RxTime2=" + rxtime2 + "&Criteria=" + getCriteria;
        }
...
$(function () {
    ...
    $('.SelectSvcFilter').on('change', function () {
        ...
        else
        {
            ...
            $('#driver').empty();
            //http://66.96.208.81/sbswebapi/api/scsarchiveinfo?Depot=1,2&Interchange=1,2&Interchange=1&OP_DATE_START=01-Sep-2016&OP_DATE_END=05-Sep-2016 
            var WebAPISvc = "http://66.96.208.81/sbswebapi/api/scsarchiveinfo?Depot=" + getDepot + "&Interchange=" + getInterchange + "&SVC_NO=" + getSvc + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime;
    ...
    $('.SelectSvcFilter2').on('change', function () {
        ...
        if (arrSelected == "" || arrSelected == null) {
            ...
            $('#driver2').empty();
            //http://66.96.208.81/sbswebapi/api/scsarchiveinfo?Depot=1,2&Interchange=1,2&Interchange=1&OP_DATE_START=01-Sep-2016&OP_DATE_END=05-Sep-2016 
            var WebAPISvc = "http://66.96.208.81/sbswebapi/api/scsarchiveinfo?Depot=" + getDepot + "&Interchange=" + getInterchange + "&SVC_NO=" + SvcNo2 + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime;
