...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        {
            //http://66.96.208.81/sbswebapi/api/dailyperformanceinfo?DepotID=1&InterchangeID=1&DrvNo=15192&SvcNo=166&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            WebApi = "http://66.96.208.81/sbswebapi/api/dailyperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=" + getDriver + "&SvcNo=" + getSessionstorageValueDPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        }
