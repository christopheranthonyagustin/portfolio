...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        {
            //http://66.96.208.81/sbswebapi/api/overallperformanceinfo?DepotID=1&InterchangeID=1&DrvNo=15192&SvcNo=166&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            //WebApi = "http://66.96.208.81/sbswebapi/api/overallperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=" + getDriver + "&SvcNo=" + getSessionstorageValueOPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
            //WebApiErr = "http://66.96.208.81/sbswebapi/api/overallperformanceinfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&DrvNo=&SvcNo=" + getSessionstorageValueOPSvc + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
            WebApi = "http://66.96.208.81/sbswebapi/api/overallperformanceinfo?SessionID=" + sessionStorage.getItem('setSessionstorageValueUserID');
        }
        ...
        if (typeof (getDriver) !== "undefined" && getDriver !== null) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                if (getTimestamp < getRxTime) {
                    ...
                    var apiSearchSessionID = 'http://66.96.208.81/sbswebapi/api/oaperfparamsinfo?SessionID=' + sessionStorage.getItem('setSessionstorageValueUserID');
                    ...
                    $.getJSON(apiSearchSessionID, function (data) {
                        if (data.length > 0)
                        {
                            ...
                            var WebAPIOAPerf = 'http://66.96.208.81/sbswebapi/api/oaperfparamsinfo/' + sessionStorage.getItem('setSessionstorageValueUserID');;
                            ...
                            $.ajax({
                                ...
                                permissions: ["http://http://66.96.208.81"],
                                success: function (sessionid) {
                                    ...
                                    for (i = 1; i < 16; i++) {
                                        ...
                                        $.ajax({
                                            url: "http://66.96.208.81/sbswebapi/api/oaperfparamsinfo",
                                            type: "POST",
                            ...
                            var sessionid = JSON.stringify({ 'SessionID': sessionStorage.getItem('setSessionstorageValueUserID') });
                            var WebAPIDrv = 'http://66.96.208.81/sbswebapi/api/oaperfdrvinfo/' + sessionStorage.getItem('setSessionstorageValueUserID');;
                                        ...
                                        if (getDriver != null || getDriver == "") {
                                            if (getDriver.length > 0) {
                                                ...
                                                for (k = 0; k < getDriver.length; k++) {
                                                    ...
                                                    $.ajax({
                                                        url: "http://66.96.208.81/sbswebapi/api/oaperfdrvinfo",
                                                        type: "POST",
