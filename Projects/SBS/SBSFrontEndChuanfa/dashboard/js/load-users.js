...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://66.96.208.81/sbswebapi/api/userinfo';

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://66.96.208.81/sbswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
$.getJSON("http://66.96.208.81/sbswebapi/api/roleinfo?RoleID=" + getSessionstorageValueRoleID, function (data) {
    $.each(data, function (index, item) {
...
$.getJSON("http://66.96.208.81/sbswebapi/api/languageinfo", function (data) {
    $.each(data, function (index, item) {
...
$.getJSON("http://66.96.208.81/sbswebapi/api/statusinfo", function (data) {
    $.each(data, function (index, item) {
...
$.getJSON("http://66.96.208.81/sbswebapi/api/reportinfo", function (data) {
    $.each(data, function (index, item) {
