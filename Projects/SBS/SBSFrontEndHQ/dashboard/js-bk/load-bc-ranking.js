...
$(document).ready(function () {
    ...
    //Check Filter 
    //http://172.16.10.110/sbswebapi/api/bcrankinginfo?DepotID=1&InterchangeID=1&Criteria=LDW&Performance=ASC&LIMIT=5&Timestamp=31-Aug-2016,%2004:00:00%20AM%20&RxTime=1-Sep-2016,%2016:00:00%20PM
    ...
    function Generate() {
        ...
        var getSessionstorageValueBCRankSvc = sessionStorage.getItem('setSessionstorageValueBCRankSvcArr');
        ...
        {
            //http://172.16.10.110/sbswebapi/api/bcrankinginfo?DepotID=1&InterchangeID=1&SvcNo=166&Criteria=FCW&Performance=DESC&LIMIT=15&Timestamp=31-Aug-2016,%2004:00:00%20PM&RxTime=1-Sep-2016,%2004:00:00%20PM
            WebApi = "http://172.16.10.110/sbswebapi/api/bcrankinginfo?DepotID=" + parseObjDepot + "&InterchangeID=" + parseObjInterchange + "&SvcNo=" + getSessionstorageValueBCRankSvc + "&Criteria=" + getCriteria + "&Performance=" + getPerformance + "&LIMIT=" + getBC + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        }
...
$(function () {
    ...
    $('.SelectSvcFilter').on('change', function () {
        ...
        sessionStorage.setItem('setSessionstorageValueBCRankSvcArr', arrSelected);
    ...
    var selectedPerf = "";
    $('.SelectPerformanceFilter').on('change', function () {

        selectedPerf = $(this).find("option:selected");
        var arrSelected = [];
        selectedPerf.each(function () {

            if ($(this).val() == "DESC") {
                $('#bc').empty();
                $('#bc').append($('<option></option>').val(5).html("Worst 5 BC's"));
                $('#bc').append($('<option></option>').val(10).html("Worst 10 BC's"));
                $('#bc').append($('<option></option>').val(15).html("Worst 15 BC's"));
                $('#bc').append($('<option></option>').val(20).html("Worst 20 BC's"));
                $('#bc').append($('<option></option>').val("").html("ALL"));
                $('.selectpicker').selectpicker('refresh');
            }
            else if ($(this).val() == "ASC") {
                $('#bc').empty();
                $('#bc').append($('<option></option>').val(5).html("Best 5 BC's"));
                $('#bc').append($('<option></option>').val(10).html("Best 10 BC's"));
                $('#bc').append($('<option></option>').val(15).html("Best 15 BC's"));
                $('#bc').append($('<option></option>').val(20).html("Best 20 BC's"));
                $('#bc').append($('<option></option>').val("").html("ALL"));
                $('.selectpicker').selectpicker('refresh');
            }
