...
$(document).ready(function () {
    ...
    else if (getSessionstorageValueRoleID == 2)
    {
        ...
        WebAPI = 'http://172.16.10.110/sbswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    }
...
$.getJSON("http://172.16.10.110/sbswebapi/api/deviceinfo", function (data) {
    $.each(data, function (index, item) {
...
$.getJSON("http://172.16.10.110/sbswebapi/api/categoryinfo", function (data) {
    $.each(data, function (index, item) {
