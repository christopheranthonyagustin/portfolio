    ...
    $('#submit-vehicleEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://172.16.10.110/sbswebapi/api/assetinfo';
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "http://172.16.10.110/sbswebapi/api/messageinfo",
                        type: "POST",
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    var apiSearchAsset = 'http://172.16.10.110/sbswebapi/api/searchasset?Name=' + assets.Name;
                    ...
                    $.getJSON(apiSearchAsset, function (data) {
                        ...
                        if (data.length == 1)
                        {
                            ...
                            $.ajax({
                                url: "http://172.16.10.110/sbswebapi/api/assetinfo",
                                type: "POST",
                    ...
                    var updateAsset = 'http://172.16.10.110/sbswebapi/api/assetinfo?id=' + assets.AssetID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you want to delete ?</div>", function (result) {
            ...
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/assetinfo/' + row.AssetID;
    ...
    $('#submit-company').on('click', function () {
        ...
        bootbox.confirm("ค<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://172.16.10.110/sbswebapi/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "http://172.16.10.110/sbswebapi/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'http://172.16.10.110/sbswebapi/api/companyinfo?id=' + company.CompanyID;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/companyinfo/' + row.CompanyID;
        ...
        if (getUserCompany != "0" || getUserCompany == "") {
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'http://172.16.10.110/sbswebapi/api/userinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    var ajaxRequest = $.ajax({
                        type: "POST",
                        url: "http://172.16.10.110/sbswebapi/api/fileupload/uploadfileuser",
                        contentType: false,
                        processData: false,
                        data: data,
                    ...
                    if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                        ...
                        var apiSearchUser = 'http://172.16.10.110/sbswebapi/api/searchuser?User=' + user.User;
                        ...
                        $.getJSON(apiSearchUser, function (data) {
                            ...
                            if (data.length == 1) {
                                ...
                                $.ajax({
                                    url: "http://172.16.10.110/sbswebapi/api/userinfo",
                                    type: "POST",
                        ...
                        var updateUser = 'http://172.16.10.110/sbswebapi/api/userinfo?id=' + user.UserID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/userinfo/' + row.UserID;
    ...
    $('#submit-deviceEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://172.16.10.110/sbswebapi/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    var apiSearchDevice = 'http://172.16.10.110/sbswebapi/api/searchdevice?Name=' + device.Name;
                    ...
                    var updateDevice = 'http://172.16.10.110/sbswebapi/api/deviceinfo?id=' + device.DeviceID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/deviceinfo/' + row.DeviceID;
    ...
    $('#submit-driverEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            ...
            if (result) {
                ...
                var url = 'http://172.16.10.110/sbswebapi/api/driverinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "http://172.16.10.110/sbswebapi/api/fileupload/uploadfile",
                    contentType: false,
                    processData: false,
                    data: data,
                    success: function (data) {
                ...
                if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                    ...
                    var apiSearchDriver = 'http://172.16.10.110/sbswebapi/api/searchdriver?Name=' + driver.Name;
                    ...
                    $.getJSON(apiSearchDriver, function (data) {
                        ...
                        if (data.length == 1) {
                            ...
                            $.ajax({
                                url: "http://172.16.10.110/sbswebapi/api/driverinfo",
                                type: "POST",
                    ...
                    var updateDriver = 'http://172.16.10.110/sbswebapi/api/driverinfo?id=' + driver.DriverID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'http://172.16.10.110/sbswebapi/api/userinfo?id=' + profile.UserID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            ...
            if (result) {
               window.location.reload(true);
                ...
                var url = 'http://172.16.10.110/sbswebapi/api/jobinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                    ...
                    $.ajax({
                        url: "http://172.16.10.110/sbswebapi/api/jobinfo",
                        type: "POST",
                    ...
                    var updateJob = 'http://172.16.10.110/sbswebapi/api/jobinfo?id=' + job.JobID;
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://172.16.10.110/sbswebapi/api/jobinfo/' + row.JobID;
