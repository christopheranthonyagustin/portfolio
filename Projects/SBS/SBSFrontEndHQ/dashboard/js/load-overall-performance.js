...
$(function () {
    ...
    $('.SelectInterchangeFilter1').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc1').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));                  
    ...
    $('.SelectInterchangeFilter2').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc2').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));                    
    ...
    $('.SelectInterchangeFilter3').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc3').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));                  
    ...
    $('.SelectInterchangeFilter4').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc4').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));                  
    ...
    $('.SelectInterchangeFilter5').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc5').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));                  
    ...
    $('.SelectInterchangeFilter6').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc6').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter7').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
				$('#svc7').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter8').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc8').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter9').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc9').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter10').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc10').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter11').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc11').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter12').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
					$('#svc12').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter13').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
				  $('#svc13').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter14').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
                ...
                $.each(data, function (index, item) {
				  $('#svc14').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
    ...
    $('.SelectInterchangeFilter15').on('change', function () {
        ...
        if (arrSelectedInterchange == "" || arrSelectedInterchange == null) {
            ...
            $.getJSON("http://172.16.10.110/sbswebapi/api/scsarchiveinfoex?Depot=" + parseObjDepot + "&Interchange=" + arrSelectedInterchange + "&OP_DATE_START=" + timestamp + "&OP_DATE_END=" + rxtime, function (data) {
				$.each(data, function (index, item) {
				  $('#svc15').append($('<option></option>').val(item.SVC_NO).html(item.SVC_NO).addClass("label-success"));
