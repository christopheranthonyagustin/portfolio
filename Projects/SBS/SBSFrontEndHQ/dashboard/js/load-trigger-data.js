...
$(document).ready(function () {
    ...
    function Generate() {
        ...
        if (changeCheckbox.checked)
        {
            ...
            // WebApi = "http://172.16.10.110/sbswebapi/api/posinfo?Asset=" + getAsset + "&CompanyID=1&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&SvcNo=" + quoteSeparatedSVC;
            WebApi = "http://172.16.10.110/sbswebapi/api/triggerdata";
        }
        else
        {
            //WebApi = "http://172.16.10.110/sbswebapi/api/posinfoex?Asset=" + getAsset + "&CompanyID=1&Timestamp=" + timestamp + "&RxTime=" + rxtime;    
            // WebApi = "http://172.16.10.110/sbswebapi/api/triggerdatainfo?Drv=" + getDriver + "&Speed=&CompanyID=1&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&SvcNo=" + quoteSeparatedSVC;
            WebApi = "http://172.16.10.110/sbswebapi/api/triggerdata";
        }
        //alert(WebApi);
		console.log(WebApi);
        if (typeof (getDriver) !== "undefined" && getDriver !== null) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                if (getTimestamp < getRxTime) {
                    ...
                    $.ajax({
                        url: "http://172.16.10.110/sbswebapi/api/triggerdatainfo",
                        type: "POST",
...
function valueFormatter(value, row) {
    ...
    if (row.Event == 83 && value == 00) {
        ...
        text = "Head way distance > 2 seconds";
