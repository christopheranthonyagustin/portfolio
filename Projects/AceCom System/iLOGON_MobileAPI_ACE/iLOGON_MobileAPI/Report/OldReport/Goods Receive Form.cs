...
namespace KEYfields.Web.Reports.OldReport {
    using System;
    ...
    public class Goods_Receive_Form : ReportClass {
        
        public Goods_Receive_Form() {
        }
        
        public override string ResourceName {
            get {
                return "Goods Receive Form.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.OldReport.Goods Receive Form.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedGoods_Receive_Form : Component, ICachedReport {
        
        public CachedGoods_Receive_Form() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Goods_Receive_Form rpt = new Goods_Receive_Form();
            rpt.Site = this.Site;
            return rpt;
        }
