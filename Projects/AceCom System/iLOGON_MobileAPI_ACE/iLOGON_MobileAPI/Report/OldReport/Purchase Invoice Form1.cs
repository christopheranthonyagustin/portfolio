...
namespace iOneDistribution.Web.Reports.OldReport {
    ...
    public class Purchase_Invoice_Form : ReportClass {
        
        public Purchase_Invoice_Form() {
        }
        
        public override string ResourceName {
            get {
                return "Purchase Invoice Form.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "iOneDistribution.Web.Reports.OldReport.Purchase Invoice Form.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPurchase_Invoice_Form : Component, ICachedReport {
        
        public CachedPurchase_Invoice_Form() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Purchase_Invoice_Form rpt = new Purchase_Invoice_Form();
            rpt.Site = this.Site;
            return rpt;
        }
