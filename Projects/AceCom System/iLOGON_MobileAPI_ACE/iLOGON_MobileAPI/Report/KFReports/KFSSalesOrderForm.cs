...
namespace KEYfields.Web.Reports.KFReports {
    ...
    public class KFSSalesOrderForm : ReportClass {
        
        public KFSSalesOrderForm() {
        }
        
        public override string ResourceName {
            get {
                return "KFSSalesOrderForm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.KFReports.KFSSalesOrderForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKFSSalesOrderForm : Component, ICachedReport {
        
        public CachedKFSSalesOrderForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KFSSalesOrderForm rpt = new KFSSalesOrderForm();
            rpt.Site = this.Site;
            return rpt;
        }
