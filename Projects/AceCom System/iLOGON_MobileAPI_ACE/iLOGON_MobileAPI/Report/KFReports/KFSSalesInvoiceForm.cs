...
namespace KEYfields.Web.Reports.KFReports {
    ...
    public class KFSSalesInvoiceForm : ReportClass {
        
        public KFSSalesInvoiceForm() {
        }
        
        public override string ResourceName {
            get {
                return "KFSSalesInvoiceForm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.KFReports.KFSSalesInvoiceForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKFSSalesInvoiceForm : Component, ICachedReport {
        
        public CachedKFSSalesInvoiceForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KFSSalesInvoiceForm rpt = new KFSSalesInvoiceForm();
            rpt.Site = this.Site;
            return rpt;
        }
