...
namespace KEYfields.Web.Reports.KFReports {
    ...
    public class KTSSalesQuotationForm : ReportClass {
        
        public KTSSalesQuotationForm() {
        }
        
        public override string ResourceName {
            get {
                return "KTSSalesQuotationForm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.KFReports.KTSSalesQuotationForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKTSSalesQuotationForm : Component, ICachedReport {
        
        public CachedKTSSalesQuotationForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KTSSalesQuotationForm rpt = new KTSSalesQuotationForm();
            rpt.Site = this.Site;
            return rpt;
        }
