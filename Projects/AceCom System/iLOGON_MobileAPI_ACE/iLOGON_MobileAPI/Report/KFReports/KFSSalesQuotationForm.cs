...
namespace KEYfields.Web.Reports.KFReports {
    ...
    public class KFSSalesQuotationForm : ReportClass {
        
        public KFSSalesQuotationForm() {
        }
        
        public override string ResourceName {
            get {
                return "KFSSalesQuotationForm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.KFReports.KFSSalesQuotationForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKFSSalesQuotationForm : Component, ICachedReport {
        
        public CachedKFSSalesQuotationForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KFSSalesQuotationForm rpt = new KFSSalesQuotationForm();
            rpt.Site = this.Site;
            return rpt;
        }
