...
namespace KEYfields.Web.Reports.KFReports {
    ...
    public class KTSSalesOrderForm : ReportClass {
        
        public KTSSalesOrderForm() {
        }
        
        public override string ResourceName {
            get {
                return "KTSSalesOrderForm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KEYfields.Web.Reports.KFReports.KTSSalesOrderForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKTSSalesOrderForm : Component, ICachedReport {
        
        public CachedKTSSalesOrderForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KTSSalesOrderForm rpt = new KTSSalesOrderForm();
            rpt.Site = this.Site;
            return rpt;
        }
