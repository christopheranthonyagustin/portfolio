...
// #############################################################################
// emulation of the PHP version of kfSubMenu's construct_phrase() sprintf wrapper
...
function set_cp_title()
{
	if (typeof(parent.document) != "undefined" && typeof(parent.document) != "unknown" && typeof(parent.document.title) == "string")
	{
		...
		{
			parent.document.title = "kfSubMenu";
		}
	}
}
...
// #############################################################################
// ################## kfSubMenu Collapse HTML Functions ########################
// #############################################################################
...
function kfmenu_register(controlid, nowrite, datefield)
{
	if (kfmenu_usepopups)
	{
		kfmenu_doregister(controlid, nowrite, datefield);
	}
}
...
// #############################################################################
// ############## Main kfSubMenu Javascript Initialization #####################
// #############################################################################

function kfSubMenu_init()
{
	if (is_webtv)
	{
		return true;
	...
	if (kfmenu_usepopups && kfmenu_registered.length > 0)
	{
		for (i in kfmenu_registered)
		{
			kfmenu_init(kfmenu_registered[i]);
		}
