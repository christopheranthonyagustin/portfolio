...
if(typeof(offX) == "undefined")
	offX = 0 // x distance from the mouse.
if(typeof(offY) == "undefined")
	offY = -50 // y distance from the mouse.
...
if(typeof(formatType) == "undefined")
	...
	//yearFormat+formatSplitter+monthFormat+formatSplitter+"dd"; 
...
function createCalendarElements()
{
	...
	calCloseBtn = cel('div');
	calCloseBtn.id = "calCloseBtn";
	calCloseBtna = cel('a');
	calCloseBtna.href = "javascript: closeCalendar()";
	calCloseBtna.innerHTML = "close";
	appendc(calCloseBtn, calCloseBtna);
	appendc(document.getElementById(el), calCloseBtn);
}
