<%@ Page Language="c#" CodeBehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.MassSSInvoice.Menu" %>
        ...
        <tr>
            <td class="NewModuleTitle" align="left">
              <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                        ...
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Mass Invoice</asp:Label>
                      </div>
            </td>
            <td>
