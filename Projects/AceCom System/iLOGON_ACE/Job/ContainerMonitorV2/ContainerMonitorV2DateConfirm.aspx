<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerMonitorV2DateConfirm.aspx.cs" Inherits="iWMS.Web.Job.ContainerMonitorV2.ContainerMonitorV2DateConfirm" %>
...
<head id="Head1" runat="server">
    <title>ConfirmDate @ ContainerMonitorV2</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="ScanOutPanel" runat="server">
            ...
            <br />
            <br />
            <asp:Button ID="ConfirmBtn" runat="server" CssClass="white" Font-Bold="true" Text="Confirm" OnClick="ConfirmBtn_Click" UseSubmitBehavior="false" />
        </asp:Panel>
    </form>
</body>
</html>
