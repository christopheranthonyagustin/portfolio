<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TprBillOfLadingMenu.aspx.cs" Inherits="iWMS.Web.Job.TprBillOfLading.TprBillOfLadingMenu" %>
...
<html>
<head runat="server">
    <title>TprBillOfLadingMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Transport Bill Of Lading</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
