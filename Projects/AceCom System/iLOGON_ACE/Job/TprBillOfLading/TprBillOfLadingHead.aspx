<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TprBillOfLadingHead.aspx.cs" Inherits="iWMS.Web.Job.TprBillOfLading.TprBillOfLadingHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TprBillOfLadingHead</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <br />
         ...
         &nbsp;&nbsp;
          <asp:Button ID="ImportManifestBtn" CssClass="white" runat="server" OnClick="ImportManifestBtn_Click" Text="ImportManifest"
                        OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" Width="100"/>
        <br />
        <br />
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                        ...
                        <Columns>
                           ...
                           <telerik:GridBoundColumn DataField="ctnrno" UniqueName="ctnrno" SortExpression="ctnrno"
                            ...
                            <telerik:GridBoundColumn DataField="status" UniqueName="status" SortExpression="status" Display="false">
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn DataField="StatusColourCode" UniqueName="StatusColourCode" SortExpression="StatusColourCode" Display="false">
                            </telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
