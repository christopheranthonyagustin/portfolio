<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TprBillOfLadingDetail.aspx.cs" Inherits="iWMS.Web.Job.TprBillOfLading.TprBillOfLadingDetail" %>
...
<html>
<head runat="server">
    <title>TprBillOfLadingDetail</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <asp:Button ID="ImportOrderBtn" runat="server" CssClass="white" Text="ImportOrder"
                    OnClick="ImportOrderBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" visible="false"/>
                &nbsp;
