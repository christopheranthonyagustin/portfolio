<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterManpower.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterManpower" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ServiceRegisterManpower</title>
...
<body>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" HierarchyLoadMode="Client">
        <DetailTables>
                    <telerik:GridTableView DataKeyNames="id" Name="ChildGrid" Width="100%" SkinID="Telerik">
                        ...
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-ForeColor="Black">
                    <HeaderTemplate>
                        S/N 
                    </HeaderTemplate>
                    <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
               ...
               <telerik:GridBoundColumn HeaderText="Activity" DataField="peratvtcodedescr" AllowFiltering="true"
                    ColumnGroupName="peratvtcodedescr" SortExpression="peratvtcodedescr" UniqueName="peratvtcodedescr" Reorderable="true">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderText="Qty" DataField="qty" AllowFiltering="true"
                    ColumnGroupName="qty" SortExpression="qty" UniqueName="qty" Reorderable="true" DataFormatString="{0:N0}" >
                </telerik:GridBoundColumn>
