<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterUpload.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterUpload" %>
...
<head id="Head1" runat="server">
    <title>ServiceRegisterUpload</title>
...
<body>
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        ...
        <tr> 
            <td> 
                &nbsp;<telerik:RadLabel ID="excelLbl" runat="server" Text ="File Location"></telerik:RadLabel> 
                <br />                          
        ...
        <tr>
            <td>
            <br />
                <telerik:RadLabel ID="lblnote" Text="Note : Only Microsoft Excel files can be Uploaded."
                    runat="server"></telerik:RadLabel><br />
                <br />
                <telerik:RadButton ID="excelSend" Text=" INITIATE UPLOAD " runat="server" OnClick="excelSend_Click" Skin ="WebBlue"
                    OnClientClicking="SAVEClicking" />                
                <br />
            </td>
        </tr>
        <tr>
