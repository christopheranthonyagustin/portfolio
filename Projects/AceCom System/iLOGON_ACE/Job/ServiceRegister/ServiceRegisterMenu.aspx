<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterMenu.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >

<html>
<head id="Head1" runat="server">
    <title>ServiceRegisterMenu</title>
    ...
    <table width="100%">
        <tr valign="bottom">
            ...
            <td class="NewModuleTitle" align="right" valign="bottom">
                <asp:Label ID="MenuLbl" runat="server">Service Register</asp:Label>
            </td>
        </tr>
        <tr>
