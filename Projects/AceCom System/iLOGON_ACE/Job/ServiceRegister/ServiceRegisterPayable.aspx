<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterPayable.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterPayable" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ServiceRegisterPayable</title>
                ...
                <telerik:GridTemplateColumn UniqueName="icon" AllowFiltering="false">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton runat="server" Visible="True" ID="Edit" ImageUrl="..\..\image\pencil.gif"
                            AlternateText="Edit" CommandName="Edit" BackColor="Transparent" BorderWidth="0">
                        </asp:ImageButton>
                    </ItemTemplate>
                    <EditItemTemplate>
