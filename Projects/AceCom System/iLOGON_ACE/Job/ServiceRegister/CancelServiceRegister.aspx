<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelServiceRegister.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.CancelServiceRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CancelServiceRegister</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Job Register Cancellation/Void</asp:Label>
            </td>
        </tr>
    </table>
