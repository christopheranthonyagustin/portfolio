<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterTripDetList.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterTripDetList" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >

<html>
<head runat="server">
    <title>ServiceRegisterTripDetList</title>
</head>
        ...
        <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="frexpdate" HeaderText="FrExp Date" SortExpression="frexpdate"
                        DataFormatString="{0:dd/MMM/yyyy HH:MM}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="fractdate" HeaderText="FrAct Date" SortExpression="fractdate"
                        DataFormatString="{0:dd/MMM/yyyy HH:MM}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="toexpdate" HeaderText="ToExp Date" SortExpression="toexpdate"
                        DataFormatString="{0:dd/MMM/yyyy HH:MM}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="toactdate" HeaderText="ToAct Date" SortExpression="toactdate"
                        DataFormatString="{0:dd/MMM/yyyy HH:MM}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
