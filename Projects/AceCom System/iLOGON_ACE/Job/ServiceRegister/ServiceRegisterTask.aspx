<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterTask.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterTask" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ServiceRegisterTask</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="pagetitle">
                    ...
                    <telerik:RadButton Style="z-index: 0" ID="GenerateBtn" runat="server" CssClass="detailbutton"
                        Skin="WebBlue" Text="Generate" OnClick="GenerateDetailBtn_Click">
                    </telerik:RadButton>
                    <asp:ImageButton ID="DelImgBtn" runat="server" ImageUrl="../../Image/delete.png"
                        OnClick="DeleteAllBtn_Click" Visible="true" BackColor="Transparent" BorderWidth="0"
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" OnNeedDataSource="ResultDG_NeedDataSource"
            AllowPaging="True" GridLines="None" AllowSorting="True" Skin="Office2007" OnItemDataBound="ResultDG_ItemDataBound"
                    ...
                    <telerik:GridTemplateColumn UniqueName="Date" HeaderText="Date">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblStartDate" runat="server" Text="StartDate" Width="150px" Style="text-align: center"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblEndDate" runat="server" Text="EndDate" Width="150px" Style="text-align: center"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="startreason">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblStartReason" runat="server" Text="StartReason"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblEndReason" runat="server" Text="EndReason"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="startremark">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="txtStartRemarks" runat="server" Text="StartRemarks" DataField="startstatusremarks"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="txtEndRemarks" runat="server" Text="EndRemarks" DataField="endstatusremarks"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
