<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRegisterCharge.aspx.cs" Inherits="iWMS.Web.Job.ServiceRegister.ServiceRegisterCharge" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ServiceRegisterCharge</title>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="VehNo" HeaderStyle-HorizontalAlign="Center"
                        AllowFiltering="false">
                        <ItemTemplate>
                             <telerik:RadComboBox ID="VehNoDDL" runat="server" DataSource='<%# VehNoDS%>' DataTextField="Descr" AutoPostBack="true" OnSelectedIndexChanged="ResultDG_VehNoCBSelectedChanged"
