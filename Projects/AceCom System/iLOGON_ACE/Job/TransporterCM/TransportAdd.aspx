<%@ Page Language="c#" CodeBehind="TransportAdd.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.TransporterCM.TransportAdd" %>
        ...
        <tbody>
            <tr>
                <td style="height: 20px">
                    ...
                    <input id="tab2" class="TabTitle" value="Party" onclick='clickRow(2, "table1");'
                        style='cursor: pointer' runat="server">
                </td>
            </tr>
            <tr>
