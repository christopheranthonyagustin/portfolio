<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripSchedWBDetl.aspx.cs"
    Inherits="iWMS.Web.Job.TripPlanning.TripSchedWBDetl" %>
...
<head id="Head1" runat="server">
    <title>Trip Scheduling Pop-Up (TSPU)</title>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CheckCtnrNoDigit() {
            var ctnrno = document.getElementById("EqpNoTxt").value;
                            ...
                            <tr>
                                ...
                                <td style="width: 180px;">
                                    <telerik:RadTextBox runat="server" ID="EqpNoTxt" Width="120px" Skin="Office2007"
                                        AutoPostBack="True" OnTextChanged="EqpNoTxt_TextChanged" ClientEvents-OnValueChanged="CheckCtnrNoDigit">
                                    </telerik:RadTextBox>
                                </td>
                                <td style="width: 100px;" align="right">
