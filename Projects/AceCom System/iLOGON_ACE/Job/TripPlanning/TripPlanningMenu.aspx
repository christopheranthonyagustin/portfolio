...
<%@ Page Language="c#" CodeBehind="TripPlanningMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.TripPlanning.TripPlanningMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 60%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        width: 316px;">
                        <asp:Label ID="MenuLbl" runat="server">TripPlanningV1</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
