<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningTimeBlockMenu.aspx.cs"
    Inherits="iWMS.Web.Job.TripPlanning.TripPlanningTimeBlockMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>TripTimeBlock</title>
