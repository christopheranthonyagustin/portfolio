<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MassTripDetour.aspx.cs"
    Inherits="iWMS.Web.Job.TripPlanning.MassTripDetour" %>
        ...
        <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
            ...
            <tr>
                <td>
                    ...
                    <br />
                    &nbsp;&nbsp;<asp:Button ID="ChangeBtn" runat="server" CssClass="white" OnClick="ChangeBtn_Click" Text="Detour" Visible="true"/>
                </td>
            </tr>
        </table>
