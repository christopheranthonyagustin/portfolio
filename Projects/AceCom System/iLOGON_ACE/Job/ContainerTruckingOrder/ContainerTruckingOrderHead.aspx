<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerTruckingOrderHead.aspx.cs" Inherits="iWMS.Web.Job.ContainerTruckingOrder.ContainerTruckingOrderHead" %>
...
<html>
<head runat="server">
    <title>ContainerTruckingOrderHead</title>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="JBId" Name="MainGrid" AllowFilteringByColumn="false">
                        ...
                        <Columns>
                            ...
                            <%-- Added by UMI tix #11809 pt.41 on 28 July 2020 --%>
                            <telerik:GridBoundColumn DataField="POLPlantCityCode" UniqueName="POLPlantCityCode" SortExpression="POLPlantCityCode" HeaderText="FrCity">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PODPlantCityCode" UniqueName="PODPlantCityCode" SortExpression="PODPlantCityCode" HeaderText="ToCity">
                            </telerik:GridBoundColumn>
                            <%-- Added by UMI tix #11809 pt.42 on 28 July 2020 --%>
                            <telerik:GridBoundColumn DataField="POLDescr" UniqueName="POLDescr" SortExpression="POLDescr" HeaderText="POL">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PODDescr" UniqueName="PODDescr" SortExpression="PODDescr" HeaderText="POD">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="tpttype" UniqueName="TransportType" SortExpression="TransportType" HeaderText="TransportType">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="XMLBillSizeType" UniqueName="billsizetype" SortExpression="BillSizeTypeDescr" HeaderText="BillSizeType">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ET" UniqueName="ET" SortExpression="ET" HeaderText="C-T">
                            </telerik:GridBoundColumn>
                            <%-- Added by EDHO tix #11809 pt.17 on 5 July 2019 --%>
                            ...
                            <%-- Added by EDHO ticket #11809 pt.18 --%>
