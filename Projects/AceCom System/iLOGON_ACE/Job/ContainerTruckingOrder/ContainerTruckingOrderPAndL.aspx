<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerTruckingOrderPAndL.aspx.cs" Inherits="iWMS.Web.Job.ContainerTruckingOrder.ContainerTruckingOrderPnL" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ContainerTruckingOrderP&L</title>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="JobNo" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false"
                        HeaderStyle-CssClass="commandHeader" HeaderStyle-BackColor="#05538C">
                        <HeaderTemplate>
