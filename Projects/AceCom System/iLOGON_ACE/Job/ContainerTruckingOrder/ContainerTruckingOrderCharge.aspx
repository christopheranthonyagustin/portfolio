<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerTruckingOrderCharge.aspx.cs" Inherits="iWMS.Web.Job.ContainerTruckingOrder.ContainerTruckingOrderCharge" %>
...
<head runat="server">
    <title>ContainerTruckingOrderCharge</title>
        ...
        <tr>
            <td align="left">
               ...
               <%-- <telerik:RadButton ID="GenerateBtn" runat="server" CssClass="detailButton" Text="Generate"
                ...
                &nbsp;
                <asp:Button ID="SplitBtn" CssClass="white" runat="server"
                    OnClick="SplitBtn_Click" Text="Split" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                &nbsp;
                <asp:Button ID="AddPartyBtn" CssClass="white" runat="server"
                    OnClick="AddPartyBtn_Click" Text="Add Party" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                &nbsp; &nbsp;
            </td>
            <td align="right">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="chargeaccode" runat="server" ReadOnly="true" Width="200"  Value='<%# DataBinder.Eval(Container.DataItem, "chargeAcCode") %>' acid='<%# DataBinder.Eval(Container.DataItem, "billacid") %>'></asp:TextBox> 
                        </ItemTemplate> 
                    </telerik:GridTemplateColumn>
