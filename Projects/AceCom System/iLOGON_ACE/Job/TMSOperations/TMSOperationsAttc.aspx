<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSOperationsAttc.aspx.cs" Inherits="iWMS.Web.Job.TMSOperations.TMSOperationsAttc" %>
...
<html>
<head runat="server">
    <title>Attc @ TMS Operations</title>
                        ...
                        <table border="0" cellspacing="2" cellpadding="2" width="100%">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    &nbsp;&nbsp;
                                <asp:Button ID="UploadBtn" runat="server" OnClick="UploadBtn_Click" UseSubmitBehavior="false"
                                    Text="Upload" CssClass="white" OnClientClick="disableBtn(this.id)"
                                    SingleClick="true" SingleClickText="Uploading..."></asp:Button>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
