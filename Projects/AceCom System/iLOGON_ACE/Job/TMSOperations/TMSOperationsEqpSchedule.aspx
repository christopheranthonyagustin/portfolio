<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSOperationsEqpSchedule.aspx.cs" Inherits="iWMS.Web.Job.TMSOperations.TMSOperationsEqpSchedule" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Equipment Schedule</title>
        ...
        <asp:UpdatePanel ID="GridUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro"
                    ...
                    ItemStyle-Wrap="true" Width="130%" Height="90%">
