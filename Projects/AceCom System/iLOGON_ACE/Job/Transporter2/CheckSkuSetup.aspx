<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckSkuSetup.aspx.cs" Inherits="iWMS.Web.Job.Transporter2.CheckSkuSetup" %>
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            ...
            <tr>
                <td width="80%">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CtnrCheckBox" runat="server" />
                    &nbsp;<asp:Label ID="Label1" runat="server">Include ContainerNo</asp:Label>
                </td>
            </tr>
            <tr id="tableGI" runat="server" visible="false">
                <td width="80%">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="IndividualGICheckBox" runat="server" />
                    &nbsp;<asp:Label ID="Label2" runat="server">Pop to individual GI</asp:Label>
                </td>
            </tr>
            <tr>
                 <td width="80%">
