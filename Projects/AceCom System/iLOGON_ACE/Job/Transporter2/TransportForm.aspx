...
<%@ Page Language="c#" CodeBehind="TransportForm.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Transporter2.TransportForm" %>
    ...
    <table id="table1" border="0" cellspacing="3" cellpadding="3" width="100%" runat="server">
        <tr>
            <td>
                ...
                <input id="tab10" style="width: 70px; cursor: pointer" class="TabTitle" onclick='clickRow(10, "table1");'
        ...
        <tr style="display: none">
            <td style="border-top: #c0c0c0 1px solid" colspan="2">
                <asp:Button Style="z-index: 0" ID="UpdateExImBtn" runat="server" CssClass="detailButton"
                    Visible="False" Text="Update" OnClick="UpdateBtn_Click"></asp:Button>&nbsp;<asp:Label
                        ID="Id2Lbl" runat="server" CssClass="pagetitle"></asp:Label><br>
