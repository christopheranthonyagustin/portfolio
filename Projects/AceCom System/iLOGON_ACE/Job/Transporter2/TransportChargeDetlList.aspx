<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportChargeDetlList.aspx.cs" Inherits="iWMS.Web.Job.Transporter2.TransportChargeDetlList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
            ...
            <Tabs>
                <telerik:RadTab Text="ChargeSearch Results" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
