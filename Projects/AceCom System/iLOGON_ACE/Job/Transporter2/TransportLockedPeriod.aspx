<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportLockedPeriod.aspx.cs" Inherits="iWMS.Web.Job.Transporter2.TransportLockedPeriod" %>
...
<head runat="server">
    <title>JobCloseLockedPeriod</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            OnUpdateCommand="ResultDG_UpdateCommand" OnEditCommand="ResultDG_EditCommand">
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" EditMode="InPlace" TableLayout="Fixed" Width="100%">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn Reorderable="true" UniqueName="prefix" HeaderText="JobCloseLockedPeriod"
