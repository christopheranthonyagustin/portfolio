<%@ Page Language="c#" CodeBehind="TransportEquipmentSearch.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Transporter2.TransportEquipmentSearch" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0"
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="SearchBtn">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
            ...
            <Tabs>
                <telerik:RadTab Text="EquipmentSearch" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
