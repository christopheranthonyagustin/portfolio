...
<%@ Page Language="c#" CodeBehind="TransportHead.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Transporter2.TransportHead" %>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                ...
                <div id="div2" style="height: 92%">
                        ...
                        <table style="width: 100%; height: 30px">
                            <tr>
                                <td class="style1">
                                    ...
                                    &nbsp;
                    <asp:Button ID="ReopenCSBtn" class="white" runat="server" OnClick="ReopenCSBtn_Click" Text="ReopenCS" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="false" />
                                    &nbsp;
                    <asp:Button ID="VoidBtn" class="white" runat="server" OnClick="VoidBtn_Click" Text="Void" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                                    &nbsp;
                    <asp:Button ID="CopyBtn" class="white" runat="server" OnClick="CopyBtn_Click" Text="Copy" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;
                    <asp:Button ID="NonBillablebtn" class="white" runat="server" OnClick="NonBillablebtn_Click" Text="NonBill" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;
                    <asp:Button ID="CloseBtn" CssClass="white" runat="server" OnClick="Closebtn_Click" Text="Close" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;
                    <asp:Button ID="ChargeSheetBtn" class="blue" runat="server" OnClick="ChargesSheetBtn_Click" Text="Charge" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;
                    <asp:Button ID="PreviewBtn" class="blue" runat="server" OnClick="ChargePreviewBtn_Click" Text="Preview" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp; 
                    <asp:Button ID="MergeBtn" class="white" runat="server" OnClick="MergeBtn_Click"
                    ...
                    <asp:Button ID="CancelBtn" class="white" runat="server" OnClick="CancelBtn_Click"
                        Text="Cancel" CausesValidation="False" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                    &nbsp;
                    <asp:Button ID="CompAdvBtn" CssClass="green" runat="server" OnClick="CompAdvBtn_Click"
                        Text="CompAdv" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;
                    <asp:Button ID="ReleasetoOpsBtn" CssClass="LongLabelWhite" runat="server" OnClick="ReleasetoOpsBtn_Click"
                        Text="Release to Ops" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Visible="true" />
                                    &nbsp;&nbsp;&nbsp; 
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid">
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="checkboxicon" AllowFiltering="false">
                                        <HeaderTemplate>
                                    ...
                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="editicon" AllowFiltering="false">
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                    ...
                                    <%-- <telerik:GridTemplateColumn Reorderable="false" UniqueName="submenuicon" AllowFiltering="false">
                                <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="submenuprinticon" AllowFiltering="false">
                                <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                <ItemTemplate>
                                ...
                                <ItemStyle Wrap="false" />
                                    ...
                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IsCfmLbl" runat="server" />
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridBoundColumn Display="False" DataField="noofctnr" HeaderText="noofctnr">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn Display="False" DataField="nooftrip" HeaderText="nooftrip">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ET" SortExpression="ET" HeaderText="E-T" AllowFiltering="false"
                                        ItemStyle-Width="100px">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn Display="False" DataField="noofperh" HeaderText="noofperh">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn Display="False" DataField="noofperd" HeaderText="noofperd">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="TeamDescr" SortExpression="TeamDescr" ItemStyle-Wrap="false"
                                        HeaderText="Team">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ZoneCode" SortExpression="ZoneCode" ItemStyle-Wrap="false"
                                        HeaderText="Zone">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="OperatorStatusDescr" SortExpression="OperatorStatusDescr" ItemStyle-Wrap="false"
                                        HeaderText="OperatorStatus">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="isnonbillable" Display="False" HeaderText="isnonbillable">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="cargoPackTypeUSR02" Display="False" HeaderText="cargoPackTypeUSR02">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="statuscolor" Display="False" HeaderText="statuscolor">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
