<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportReopen.aspx.cs"
    Inherits="iWMS.Web.Job.Transporter2.TransportReopen" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TransportReopen</title>
...
<body onload="javascript:window.focus();" bottommargin="0" leftmargin="0" topmargin="0"
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="ReOpenBtn" runat="server" CssClass="detailButton" OnClick="ReOpenBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false"
