<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSManPowerPlanningForm.aspx.cs" Inherits="iWMS.Web.Job.TMSManPowerPlanning.TMSManPowerPlanningForm" %>
...
<head runat="server">
    <title>TMS Manpower Planning Update</title>
            ...
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <br />
                            <iWMS:iForm ID="formCtl_JBHEAD" runat="server"></iWMS:iForm><br />
                ...
                <table>
                    <tr style="width:500px;">
                        <td style="width:150px;text-align:center;"><asp:Label ID="PersonnelAvailableLbl" runat="server" Text="Available" Font-Bold="true"></asp:Label></td>
                        <td style="width:290px;text-align:center;"><asp:Label ID="PersonnelSelectedLbl" runat="server" Text="Selected" Font-Bold="true"></asp:Label></td>
                    </tr>
                </table>
                <br />
                <telerik:RadListBox runat="server" ID="PersonnelList" Height="250px" Width="200px"
                ...
                <telerik:RadListBox runat="server" ID="SelectedPersonnelList" Height="250px" Width="200px" CausesValidation="false"
