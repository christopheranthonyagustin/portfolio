<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSSHead.aspx.cs" Inherits="iWMS.Web.Job.FieldServiceSupport.FSSHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Search Result @ FSS</title>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="JBId">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="ChkIcon" AllowFiltering="false" HeaderStyle-Width="20px" ItemStyle-Width="20px">
                                <HeaderTemplate>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="EditIcon" AllowFiltering="false" HeaderStyle-Width="20px" ItemStyle-Width="20px">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="EditImgBtn"
                            ...
                            <telerik:GridBoundColumn DataField="JobNo" UniqueName="Number" SortExpression="Number" HeaderText="JobNo">
                            </telerik:GridBoundColumn>
