<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="WorkOrderRegisterCharge.aspx.cs"
    Inherits="iWMS.Web.Job.WorkOrderRegister.WorkOrderRegisterCharge" %>
...
<head runat="server">
    <title>WorkOrderRegisterCharge</title>
                            ...
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ChargeId" HeaderStyle-HorizontalAlign="Center" UniqueName="ChargeId" Display="false"
                                            AllowFiltering="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="ChargeIdTxt" runat="server" 
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "ChargeId") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
