<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkOrderRegisterTaskDetl.aspx.cs" Inherits="iWMS.Web.Job.WorkOrderRegister.WorkOrderRegisterTask" %>
...
<html>
<head runat="server">
    <title>WorkOrderRegisterTaskDetl</title>
                    ...
                    <telerik:GridTemplateColumn UniqueName="Date" HeaderText="Date">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblStartDate" runat="server" Text="StartDate" Width="250px" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblEndDate" runat="server" Text="EndDate" Width="250px" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="startreason">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblStartReason" runat="server" Text="StartReason" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblEndReason" runat="server" Text="EndReason" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="startremark">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="txtStartRemarks" runat="server" Text="StartRemarks" DataField="startstatusremarks" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="txtEndRemarks" runat="server" Text="EndRemarks" DataField="endstatusremarks" Style="text-align: center" CssClass="RGridHeader_CUSTOM" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
