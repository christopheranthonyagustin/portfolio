<%@ Page Language="c#" CodeBehind="UploadJbTPRMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Upload.UploadJbTPRMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="VehicleLbl" runat="server">Upload Jb TPR</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
