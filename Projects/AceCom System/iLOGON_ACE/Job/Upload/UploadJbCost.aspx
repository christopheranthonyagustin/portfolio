<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadJbCost.aspx.cs" Inherits="iWMS.Web.Job.Upload.UploadJbCost" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td width="20%">
                <asp:Label ID="headerLbl1" runat="server" CssClass="pagetitle">Upload Vendor Invoice :</asp:Label><br>
                <br>
            </td>
            <td width="40%">
            </td>
