<%@ Page Language="c#" CodeBehind="UploadJbCostMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Upload.UploadJbCostMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>SkuUploadMenu</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="VehicleLbl" runat="server">Upload JBCost</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
