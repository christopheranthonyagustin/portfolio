<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportOrderMenu.aspx.cs" Inherits="iWMS.Web.Job.ImportOrderRegister.ImportOrderRegisterMenu" %>
...
<html>
<head runat="server">
    <title>ImportOrderRegisterMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Import Order Register</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
