<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportOrderBoxDelivery.aspx.cs" Inherits="iWMS.Web.Job.ImportOrderRegister.ImportOrderBoxDelivery" %>
...
<html>
<head runat="server">
    <title>ImportOrderBoxDelivery</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <br />
                &nbsp;<asp:Button ID="SearchBtn" runat="server" CssClass="white" OnClick="SearchBtn_Click"
                    Text="Search" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                &nbsp;<asp:Button ID="AssignVehicleBtn" runat="server" CssClass="white" OnClick="AssignVehicleBtn_Click"
                    Text="AssignVehicle" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Width="100px" />
                <br />
                <br />
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    AllowPaging="true" Skin="Office2007" OnNeedDataSource="ResultDG_NeedDataSource" Height="1000px">
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="MobileNo" UniqueName="MobileNo" SortExpression="MobileNo"
                                HeaderText="Mobile Number">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="BookingNumber" UniqueName="BookingNumber" SortExpression="BookingNumber"
                            ...
                            <telerik:GridBoundColumn DataField="vessel" UniqueName="vessel" SortExpression="vessel"
                              ...
                              <telerik:GridBoundColumn DataField="BoxNo" UniqueName="BoxNo" SortExpression="BoxNo"
                                HeaderText="TrackingNo">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="BoxSize" UniqueName="BoxSize" SortExpression="BoxSize"
                                HeaderText="BoxSize">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="jbid" UniqueName="jbid" HeaderText="jbid" Display="false">
                            </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="StatusColourCode" Display="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ReferenceNumber" UniqueName="ReferenceNumber" Display="false"
