<%@ Page Language="c#" CodeBehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.PostDrToArBatch.Menu" %>
            ...
            <td class="ModuleTitle" align="left">
                <%--<div class="rounded-box1" style="background-color: #660000; width: 30%">
                    ...
                    <%--<div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="ReportNameLbl" runat="server" style="color:Black; font-size:medium; font-weight: bold">Batch Posting of Invoice to AR@Rx1A</asp:Label>
