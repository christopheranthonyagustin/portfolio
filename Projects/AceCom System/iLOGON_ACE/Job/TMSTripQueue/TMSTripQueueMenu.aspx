<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSTripQueueMenu.aspx.cs" Inherits="iWMS.Web.Job.TMSTripQueue.TMSTripQueueMenu" %>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="Lbl1" runat="server">TMS Trip Queue&nbsp;</asp:Label>
                </td>
            </tr>
        </table>
    </form>
