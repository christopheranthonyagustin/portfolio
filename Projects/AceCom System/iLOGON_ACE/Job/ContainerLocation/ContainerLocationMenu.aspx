<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerLocationMenu.aspx.cs" Inherits="iWMS.Web.Job.ContainerLocation.ContainerLocationMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ContainerLocation</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <asp:Label ID="Label1" Style="color: Black; font-size: medium; font-weight: bold" runat="server">Container Location&nbsp;&nbsp;</asp:Label>
                </td>
