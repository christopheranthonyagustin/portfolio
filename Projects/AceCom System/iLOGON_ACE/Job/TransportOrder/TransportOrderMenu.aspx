<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportOrderMenu.aspx.cs" Inherits="iWMS.Web.Job.TransportOrder.TransportOrderMenu" %>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right" valign="bottom">
                    <asp:Label ID="MenuLbl" runat="server">Transport Order</asp:Label>
                </td>
            </tr>
            <tr>
