...
<%@ Page Language="c#" CodeBehind="InvoiceSearch.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.TransportOrder.InvoiceSearch" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
        ...
        <Tabs>
            <telerik:RadTab Text="Invoice" Value="0" readonly="readonly" runat="server">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    <br />
    <form id="Form1" method="post" runat="server" defaultbutton="Searchbtn">
        ...
        <%--&nbsp--%>
        <%--<telerik:RadButton Style="z-index: 0" ID="SearchBtn" runat="server" Skin="WebBlue" CssClass="formbtn"
        Text="Search" OnClick="SearchBtn_Click"></telerik:RadButton>--%>
        <%--<br>
        <br />--%>
        <br />
        <iWMS:iForm ID="formCtl" runat="server"></iWMS:iForm>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-left:3px; padding-top:10px">
            <tr>
