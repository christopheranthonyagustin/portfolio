<%@ Page Language="c#" CodeBehind="FreightImportCtnrItemDetl.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.FreightImport.FreightImportCtnrItemDetl" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>FreightImportCtnrItemDetl</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td align="left"><br />
                    <%--<telerik:RadButton ID="AddDetailBtn" runat="server" Text="NewLine" Visible="False" CssClass="detailButton"
                    OnClick="AddDetailBtn_Click" Skin="WebBlue" ></telerik:RadButton>--%>
        ...
        <div style="height: 92%" id="div-datagrid">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                AllowFilteringByColumn="true" OnItemDataBound="ResultDG_ItemDataBound" OnNeedDataSource="ResultDG_NeedDataSource" OnEditCommand="ResultDG_EditCommand">
