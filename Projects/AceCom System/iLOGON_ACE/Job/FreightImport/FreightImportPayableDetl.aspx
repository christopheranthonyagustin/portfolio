<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightImportPayableDetl.aspx.cs"
    Inherits="iWMS.Web.Job.FreightImport.FreightImportPayableDetl" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>FreightImportPayableDetl</title>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="cbdlcamt" SortExpression="cbdlcamt" HeaderText="LcAmt"
                        DataFormatString="{0:N}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
