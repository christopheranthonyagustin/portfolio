<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightImportCharge.aspx.cs"
    Inherits="iWMS.Web.Job.FreightImport.FreightImportCharge" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>FreightImportCharge</title>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td align="left">
                <asp:Button ID="SaveBtn" runat="server" CssClass="white" UseSubmitBehavior="false"  OnClientClick="disableBtn(this.id,true)" Text="Save" OnClick="SaveBtn_Click">
                </asp:Button>
                &nbsp;
