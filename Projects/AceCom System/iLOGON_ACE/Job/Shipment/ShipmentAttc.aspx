<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipmentAttc.aspx.cs" Inherits="iWMS.Web.Job.Shipment.ShipmentAttc" %>
                        ...
                        <table border="0" cellspacing="2" cellpadding="2" width="100%" style="margin-left: 9px">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    &nbsp;&nbsp;
                                <asp:Button ID="ImageSubmit" runat="server" OnClick="ImageSubmit_ServerClick" CssClass="white" Text="Upload" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
