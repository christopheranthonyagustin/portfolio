<%@ Page Language="c#" CodeBehind="ShipmentCtnrDetl.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Shipment.ShipmentCtnrDetl" %>
...
<html>
<head runat="server">
    <title>DeclarationCtnrDetl</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" onload="if (document.getElementById('CtnrNoTxt')!= null) document.getElementById('CtnrNoTxt').focus();">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="pagetitle">
                &nbsp;
                <asp:Button ID="AddDetailBtn" runat="server" CssClass="white" Visible="false" Text="New" style="margin-top: 5px;"
                            ...
                            <tr>
                                <td><br />
                                    ...
                                    <asp:RequiredFieldValidator Style="z-index: 0" ID="CtnrNoReq" runat="server" Width="155px"
                                        ControlToValidate="CtnrNoTxt" ErrorMessage="*"></asp:RequiredFieldValidator><br />
                                ...
                                <td><br />
                                    ...
                                    <asp:RequiredFieldValidator Style="z-index: 0" ID="WeightReq" runat="server" Width="155px"
                                        ControlToValidate="WeightTxt" ErrorMessage="*"></asp:RequiredFieldValidator>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ctnrwt" SortExpression="ctnrwt" HeaderText="Weight"
                        DataFormatString="{0:#0##}" ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ctnrsealno" SortExpression="ctnrsealno" HeaderText="Seal No."
                        ItemStyle-Wrap="false">
                    </telerik:GridBoundColumn>
