<%@ Page Language="c#" CodeBehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.ReOpenDRInvoice.Menu" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <%--Ticket #2171: GKE : Enhancement to Re-Open Invoice module (DRHEAD & INVHEAD), pt 12 change by xm 16/05/2016 --%>
                <td class="NewModuleTitle" align="right">
                    ...
                    <asp:Label ID="ReportNameLbl" runat="server">Reopen Invoice</asp:Label>
                </td>
            </tr>
        </table>
    </form>
