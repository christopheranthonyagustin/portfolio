<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTripRegisterV3Map.aspx.cs" Inherits="iWMS.Web.Job.JobTripRegisterV3.JobTripRegisterV3Map" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">            
            function initMap() {
                ...
                var assetLocationGmap = new google.maps.Map(
                    (document.getElementById("AssetLocationGmap")),
                    {
                        ...
                        <%double centerlat = (double)Session["centerlat"];
                          double centerLng = (double)Session["centerlng"];%>
            ...
            {%>
                markers.push([<%=coordinates[i][0]%>, <%=coordinates[i][1]%>, '<%=info[i][0]%>']);
		    ...
		    <%}%>
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var info1 = markers[i][2];
                    if(info1 == "Start")
                    {
                        var image = "../../Image/start.png";
                    }
                    else if(info1 == "END"){
                        var image = "../../Image/end.png";
                    }
                    else{
                        var image = "../../Image/tracking.png";
                    }
...
<body style="margin: 0px;">
    <form id="form1" runat="server" method="post">
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <asp:Timer ID="RefreshTimer" runat="server" OnTick="RefreshTimer_Tick" Enabled="false"></asp:Timer>
                                ...
                                <td>
                                    <iWMS:iForm ID="formCtl_Refresh" runat="server"></iWMS:iForm>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <table>
            <tr>
                <td>
                    <asp:UpdatePanel runat="server" ID="UpdatePanel" Mode="Conditional">
                        <ContentTemplate>
        ...
        <div runat="server" class="assetLocationMapContent" id="AssetLocationGmap">
            <script type="text/javascript">
                var key = '<%=Session["Key"]%>';
                <%string checkdata = (string)Session["Norecord"];%>
                function loadScript() {
