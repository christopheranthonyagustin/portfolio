<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DDPV2BillableItems.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanningV2.DDPV2BillableItems" %>
                    ...
                    <tr>
                        <td align="left">
                            <asp:Button ID="SaveBtn" CssClass="white" runat="server" OnClick="SaveBtn_Click" CausesValidation="false"
                                Text="Save" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                            &nbsp;
