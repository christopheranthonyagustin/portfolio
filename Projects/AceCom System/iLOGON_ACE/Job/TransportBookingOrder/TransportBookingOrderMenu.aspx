<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportBookingOrderMenu.aspx.cs" Inherits="iWMS.Web.Job.TransportBookingOrder.TransportBookingOrderMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TransportBookingOrder</title>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right" valign="bottom">
                    <asp:Label ID="MenuLbl" runat="server">Transport Booking Order</asp:Label>
                </td>
            </tr>
            <tr>
