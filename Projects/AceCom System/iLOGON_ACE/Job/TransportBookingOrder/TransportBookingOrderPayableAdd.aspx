<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportBookingOrderPayableAdd.aspx.cs" Inherits="iWMS.Web.Job.TransportBookingOrder.TransportBookingOrderPayableAdd" %>
...
<head id="Head1" runat="server">
    <title>Transport Booking Order Payable Add</title>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function CheckCtnrNoDigit(e) {
                var CtnrNoTxt = $find('<%= ContainerNoTxt.ClientID %>');
                var ctnrno = CtnrNoTxt.get_value();
                if (ctnrno != "") {
                ...
                <td>
                    ...
                    <asp:UpdatePanel ID="OuterUpdatePanel" runat="server">
                        <ContentTemplate>
                            ...
                            <br />
                            <telerik:RadTextBox ID="ContainerNoTxt" runat="server" Width="150" Skin="WebBlue" ClientEvents-OnValueChanged="CheckCtnrNoDigit">
                            </telerik:RadTextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Bank" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" AllowFiltering="false">
                                            <ItemTemplate>
                                                <telerik:RadDropDownList ID="BankDDL" runat="server" Width="140px" Skin="WebBlue"
