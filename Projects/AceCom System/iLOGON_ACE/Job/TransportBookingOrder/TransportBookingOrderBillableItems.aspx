<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportBookingOrderBillableItems.aspx.cs" Inherits="iWMS.Web.Job.TransportBookingOrder.TransportBookingOrderBillableItems" %>
...
<head runat="server">
    <title>TransportBookingOrderBillableItems</title>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        ...
                        <asp:Button ID="InvoiceBtn" runat="server" CssClass="LongLabelBlue" ToolTip="Invoice" UseSubmitBehavior="false" CausesValidation="false"
                            OnClick="InvoiceBtn_Click" Text="Invoice Format 2" OnClientClick="disableBtn(this.id)" />
