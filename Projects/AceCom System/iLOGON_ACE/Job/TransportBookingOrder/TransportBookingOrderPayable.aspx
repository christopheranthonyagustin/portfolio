<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportBookingOrderPayable.aspx.cs" Inherits="iWMS.Web.Job.TransportBookingOrder.TransportBookingOrderPayable" %>
...
<html>
<head runat="server">
    <title>TransportBookingOrderPayable</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="cbdid" PageSize="150" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
