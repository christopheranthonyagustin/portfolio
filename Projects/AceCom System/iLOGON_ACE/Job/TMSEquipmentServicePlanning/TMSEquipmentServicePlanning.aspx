<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSEquipmentServicePlanning.aspx.cs" Inherits="iWMS.Web.Job.TMSEquipmentServicePlanning.TMSEquipmentServicePlanning" %>
...
<head runat="server">
    <title>TMS Equipment Service Planning</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Text="Equipment Rental" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
                                    ...
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding: 0 12px;">
                                            <tr>
                                                <td>
                                                    <div style="display: inline-block">
                                                     ...
                                                     &nbsp;&nbsp;
                                                    <div style="display: inline-block">
                                                          <asp:Label ID="StatusLbl" runat="server" Text="Status" /><br />
                                                        <telerik:RadComboBox ID="StatusCombo" runat="server" Skin="WebBlue" Filter="Contains" Width="150px">
                                                    </telerik:RadComboBox>
                                                        </div>
                                                    &nbsp;&nbsp;
                                            <div style="display: inline-block; text-align: left">
                                                ...
                                                &nbsp;
                                                 <asp:Button ID="AssignBtn" runat="server" Text="Assign" CausesValidation="false" ToolTip="Assign" CssClass="white" OnClick="AssignBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                                &nbsp;
