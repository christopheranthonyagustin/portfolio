<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightJobOrderReject.aspx.cs" Inherits="iWMS.Web.Job.FreightJobRegister.FreightJobOrderReject" %>
...
<head id="Head1" runat="server">
    <title>Freight Request Order Reject</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Freight Request Order Reject Reason</asp:Label>
            </td>
        </tr>
    </table>
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                        <telerik:RadTextBox RenderMode="Lightweight" ID="rejectRemarks" BackColor="Yellow"
            ...
            <tr>
                ...
                <td width="60%" align="left">
                    ...
                    <telerik:RadButton ID="PostBtn" runat="server" Text="Post" 
