<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightJobForm.aspx.cs" Inherits="iWMS.Web.Job.FreightJobRegister.FreightJobForm" %>
...
<head id="Head1" runat="server">
    <title>FreightJobRegisterForm</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" onload='displayRow("table1");'>
    ...
    <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" RenderMode="Lightweight"
        ...
        <Tabs>
            ...
            <telerik:RadTab Text="Freight" Value="5" runat="server">
            </telerik:RadTab>
