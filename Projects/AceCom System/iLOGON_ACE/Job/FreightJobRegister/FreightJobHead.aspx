<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightJobHead.aspx.cs" Inherits="iWMS.Web.Job.FreightJobRegister.FreightJobHead" %>
...
<head id="Head1" runat="server">
    <title>FreightJobRegisterHead</title>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="CancelBtn" class="white" runat="server" OnClick="cancelImgBtn_Clicked" Text="Cancel" 
                           OnClientClick="return confirm('Confirm to cancel Freight Job? All freight movements for this order will be removed upon confirmation.')" />&nbsp;
                </td>
                ...
                <td align="left">
                 ...
                 <%--Inbound Button--%>
                <td align="left">
                    <asp:Button ID="InboundBtn" CssClass="green" runat="server" OnClick="InboundBtn_Click" Visible="true"  
                    Text="Inbound" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>&nbsp;
                </td>

                 <%--Outbound Button--%>
                <td align="left">
                    <asp:Button ID="OutboundBtn" CssClass="green" runat="server" OnClick="OutboundBtn_Click" Visible="true"  
                    Text="Outbound" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>&nbsp;
                </td>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:ImageButton runat="server" Visible="True" ID="TankOrderEdit" ImageUrl="../../image/pencil.gif"
                                BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit Freight Job Register"
                    ...
                    <telerik:GridBoundColumn DataField="LDCommodityDescr" SortExpression="LDCommodityDescr"
                        HeaderText="Commodity">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="totalqty" SortExpression="totalqty" HeaderText="UnitsBooked"
                        DataFormatString="{0:N0}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="noofctnr" SortExpression="noofctnr" HeaderText="TotalUnits"
                        DataFormatString="{0:N0}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="OSUnits" SortExpression="OSUnits" HeaderText="O/sUnits"
                        DataFormatString="{0:N0}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="entid" SortExpression="entid" HeaderText="Entity"
                        Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="quid" SortExpression="quid" Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="qucode" SortExpression="qucode" HeaderText="CostingSheetNo">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="jobdescr" SortExpression="jobdescr" HeaderText="TankRequirements">
                    </telerik:GridBoundColumn>
