<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightJobLoadingInstruction.aspx.cs" Inherits="iWMS.Web.Job.FreightJobRegister.FreightJobLoadingInstruction" %>
...
<html>
<head runat="server">
    <title>FreightJobLoadingInstruction</title>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="NewLOIBtn" runat="server" Text="NewLOI"  CssClass="white" 
                        OnClick="NewLOIBtn_Click"  ToolTip="Create New Loading Instruction">
                    </asp:Button>

                    <asp:Button ID="JSBtn" runat="server" Text="JobSheet"  CssClass="blue"
                    OnClick="JSBtn_Click"  ToolTip="Print Job Sheet">
                    </asp:Button>

                    <asp:Button ID="BookingConfirmation" runat="server" Text="Booking" CssClass="blue"
                        OnClick="BookingConfirmationBtn_Click" ToolTip="Print Booking Confirmation">
                    </asp:Button>
   
                    <asp:Button ID="LOIBtn" runat="server" Text="LOI" Visible="true"
                        CssClass="blue" OnClick="LOIBtn_Click" ToolTip="Print Loading Instruction">
                    </asp:Button>
                        
                    <asp:Button ID="ROBtn" runat="server" Text="ReleaseOrd" Visible="true"
                        CssClass="blue" OnClick="ROBtn_Click"  ToolTip="Print Release Order">
                    </asp:Button>
                        
                    <asp:Button ID="SYBtn" runat="server" Text="SurveyOrd" Visible="true"
                        CssClass="blue" OnClick="SYBtn_Click"  ToolTip="Print Survey Order">
                    </asp:Button>
                        
                    <asp:Button ID="SOBtn" runat="server" Text="StoringOrd" Visible="true"
                        CssClass="blue" OnClick="SOBtn_Click"  ToolTip="Print Storing Order">
                    </asp:Button>
                        
                    <asp:Button ID="PrintBtn" runat="server" Text="Print" Visible="true"
                        CssClass="blue" OnClick="PrintBtn_Click" >
                    </asp:Button>
                </td>
