<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightJobJBBL.aspx.cs" Inherits="iWMS.Web.Job.FreightJobRegister.FreightJobJBBL" %>
...
<body>
    ...
    <table cellspacing="2" cellpadding="2" width="100%" border="0">
        <tr>
            <td>
                <telerik:RadButton ID="SaveBtn" runat="server" OnClick="SaveBtn_OnClick" Text="Save"
