<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyTransportPlanningQuickSurf.aspx.cs" Inherits="iWMS.Web.Job.DailyTransportPlanning.DailyTransportPlanningQuickSurf" %>
...
<html>
<head runat="server">
    <title>Quick Surf @ DailyTransportPlanning</title>
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="TripId" PageSize="50">
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false"
                        HeaderStyle-Width="40px" ItemStyle-Width="40px" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left">
                        <HeaderTemplate>
