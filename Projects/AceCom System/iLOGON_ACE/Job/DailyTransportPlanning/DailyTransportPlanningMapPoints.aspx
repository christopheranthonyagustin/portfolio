<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyTransportPlanningMapPoints.aspx.cs" Inherits="iWMS.Web.Job.DailyTransportPlanning.DailyTransportPlanningMapPoints" %>
        ...
        <script type="text/javascript">            
		    ...
		    <%}%>
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var image = "DailyTransportPlanningMapPointsMakeThumbNail.aspx?file=" + markers[i][2];
