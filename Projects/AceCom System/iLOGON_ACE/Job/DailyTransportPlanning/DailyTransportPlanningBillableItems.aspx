<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyTransportPlanningBillableItems.aspx.cs" Inherits="iWMS.Web.Job.DailyTransportPlanning.DailyTransportPlanningBillableItems" %>
...
<head runat="server">
    <title>DailyTransportPlanningBillableItems</title>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        ...
                        <asp:Button ID="NextItemBtn" CssClass="white" runat="server" OnClick="NextItemBtn_Click" Visible="True" Text="Next" CausesValidation="false" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                            &nbsp;&nbsp;
                        <asp:Button ID="LastRecordBtn" CssClass="white" runat="server" OnClick="LastRecordBtn_Click" Visible="True" Text="Last Record" CausesValidation="false" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                        <td align="right">
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="QtyTxt" runat="server" Width="60" OnTextChanged="ResultDG_OnQuantityTextChanged"
