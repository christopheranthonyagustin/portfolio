...
<%@ Page Language="c#" CodeBehind="TransportForm.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Transport.TransportForm" %>
        ...
        <tr>
            ...
            <td width="25%" align="right">
                ...
                <asp:Button Style="z-index: 0" ID="PopulateReceiptBtn" runat="server" CssClass="detailButton"
                    Text="Pop. To Receipt" Width="110px" CausesValidation="False" OnClick="PopulateReceiptBtn_Click"
            ...
            <td style="border-top: #c0c0c0 1px solid" colspan="2">
                <asp:Button Style="z-index: 0" ID="UpdateFormBtn" runat="server" CssClass="detailButton"
                    Visible="False" Text="Update" OnClick="UpdateBtn_Click"></asp:Button>&nbsp;<asp:Label
                        ID="IdLbl" runat="server" CssClass="pagetitle"></asp:Label>
                <br />
                <br>
