<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyTranshipmentPlanningSchedule.aspx.cs" Inherits="iWMS.Web.Job.DailyTranshipmentPlanning.DailyTranshipmentPlanningSchedule" %>
...
<html>
<head runat="server">
    <title>DailyTranshipmentPlanningSchedule</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="ScheduleTab" Text="Shift Schedule" Value="0" runat="server">
                </telerik:RadTab>
                ...
                <telerik:RadTab Id="UpdateTab" Text="Update" Value="150" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="BerthingScheduleTab" Text="Berthing Schedule" Value="200" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="SummaryTab" Text="Summary" Value="250" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="100%" ID="RadQueuePage" />
            <telerik:RadPageView runat="server" Height="100%" ID="RadUploadPage" />
            <telerik:RadPageView runat="server" Height="100%" ID="RadUpdatePage" />
            <telerik:RadPageView runat="server" Height="100%" ID="RadBerthingSchedulePage" />
            <telerik:RadPageView runat="server" Height="100%" ID="RadSummaryPage" />
