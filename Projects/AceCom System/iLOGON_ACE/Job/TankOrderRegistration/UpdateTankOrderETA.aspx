<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateTankOrderETA.aspx.cs" Inherits="iWMS.Web.Job.TankOrderRegistration.UpdateTankOrderETA" %>
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Tank Order Register Update ETA</asp:Label>
            </td>
        </tr>
    </table>
