<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankOrderEquipment.aspx.cs"
    Inherits="iWMS.Web.Job.TankOrderRegistration.TankOrderEquipment" %>
...
<head id="Head1" runat="server">
    <title>TankOrderEquipment</title>
                        ...
                        <table border="0" cellspacing="1" cellpadding="1" width="100%">
                            <tr>
                                ...
                                <telerik:RadButton ID="ClosePanelBtn" runat="server" OnClick="ClosePanelBtn_Click"
                                    ...
                                    &nbsp;
                                <telerik:RadButton ID="TankSearchBtn" runat="server" OnClick="TankSearchBtn_Click" Text="TankSearch"
                                    Skin="WebBlue">
                                </telerik:RadButton>
                                    &nbsp;&nbsp;
