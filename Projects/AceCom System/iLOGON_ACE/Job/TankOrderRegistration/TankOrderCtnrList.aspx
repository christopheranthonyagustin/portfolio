<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankOrderCtnrList.aspx.cs" Inherits="iWMS.Web.Job.TankOrderRegistration.TankOrderCtnrList" %>
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
            <Columns>
               ...
               <ItemTemplate>
                ...
                <%--<telerik:GridBoundColumn HeaderText="TareWt" DataField="ctnrwt" AllowFiltering="false" DataFormatString="{0:#,0.00}">
                <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>     
                <telerik:GridBoundColumn HeaderText="NetWt" DataField="goodswt" AllowFiltering="false" DataFormatString="{0:#,0.00}">
                <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>  
                <telerik:GridBoundColumn HeaderText="GrossWt" DataField="grosswt" AllowFiltering="false" DataFormatString="{0:#,0.00}">
                <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>  
                <telerik:GridBoundColumn HeaderText="Measurement" DataField="ctnrvol" AllowFiltering="false" DataFormatString="{0:#,0.00}">
                <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>--%>     
