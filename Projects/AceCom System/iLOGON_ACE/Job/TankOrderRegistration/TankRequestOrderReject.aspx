<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankRequestOrderReject.aspx.cs" Inherits="iWMS.Web.Job.TankOrderRegistration.TankOrderReject" %>
...
<head id="Head1" runat="server">
    <title>Tank Request Order Reject</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Tank Request Order Reject Reason</asp:Label>
            </td>
        </tr>
    </table>
