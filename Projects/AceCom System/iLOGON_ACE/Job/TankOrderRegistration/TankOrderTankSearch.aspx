<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankOrderTankSearch.aspx.cs" Inherits="iWMS.Web.Job.TankOrderRegistration.TankOrderTankSearch" %>
...
<head id="Head1" runat="server">
    <title>Tank Order Tank Search</title>
...
<body>
    ...
    <telerik:RadGrid id="ResultDG" runat="server" autogeneratecolumns="false" gridlines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="tankno">
            <Columns>
                <telerik:GridButtonColumn ButtonType="LinkButton" CommandName="tankno" HeaderText="TankNo"
                ...
                <telerik:GridBoundColumn HeaderText="TankCapacity" DataField="TankCapacity" AllowFiltering="false">
                </telerik:GridBoundColumn>                               
