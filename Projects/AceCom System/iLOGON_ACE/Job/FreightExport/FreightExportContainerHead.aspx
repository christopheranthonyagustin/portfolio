<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightExportContainerHead.aspx.cs" Inherits="iWMS.Web.Job.FreightExport.FreightExportContainerHead" %>
...
<head runat="server">
    <title>FreightExportContainerHead</title>
                        ...
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" Visible="True" ID="FreightExportEdit" ImageUrl="../../image/pencil.gif"
                                    BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit Freight Export"
                                    OnClick="FreightExportEdit_Click" CausesValidation="False"></asp:ImageButton>
                            </ItemTemplate>
