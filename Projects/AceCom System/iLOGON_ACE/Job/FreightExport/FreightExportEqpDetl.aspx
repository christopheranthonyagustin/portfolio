<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightExportEqpDetl.aspx.cs"
    Inherits="iWMS.Web.Job.FreightExport.FreightExportEqpDetl" %>
                                ...
                                <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="JobTypeReq" runat="server" ControlToValidate="JobTypeList"
                                                ErrorMessage="*"></asp:RequiredFieldValidator>
                                            <br />
                                            <telerik:RadDropDownList ID="JobTypeList" runat="server" Skin="Sunset" BackColor="#ded7c6" AutoPostBack="True"
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="TptTypeReq" runat="server" ControlToValidate="TptTypeList"
                                                ErrorMessage="*"></asp:RequiredFieldValidator>
                                            <br />
                                            <telerik:RadDropDownList ID="TptTypeList" runat="server" Skin="Sunset" BackColor="#ded7c6" AutoPostBack="True"
                                                DataTextField="Descr" DataValueField="item" Enabled="True" Width="155px">
                                            </telerik:RadDropDownList>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <telerik:RadDropDownList ID="OOGList" runat="server" Skin="WebBlue" Enabled="True" DataTextField="" DataValueField="item"
                                                Width="155px">
                                            </telerik:RadDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td nowrap class="style1">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="BillOption2List"
                                                ErrorMessage="*"></asp:RequiredFieldValidator><br>
                                            <telerik:RadDropDownList ID="BillOption2List" runat="server" Enabled="True" DataTextField="Descr" AutoPostBack="true"
                                                DataValueField="item" Skin="Sunset" BackColor="#ded7c6" Width="155px">
                                            </telerik:RadDropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap class="style3">
                                            ...
                                            <telerik:RadTextBox ID="TransporterCodeTxt" runat="server" Skin="WebBlue" AutoPostBack="True" OnTextChanged="TransporterCodeTxt_TextChanged"
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap valign="top">
                                            ...
                                            <br>
                                            <telerik:RadTextBox Style="z-index: 0" ID="descrTxt" runat="server" Skin="WebBlue" Rows="3" TextMode="MultiLine"
                                                Width="155px" Height="80px">
                                            </telerik:RadTextBox>
                                        </td>
                                        <td nowrap valign="top">
                                            ...
                                            <br />
                                            <br />
                                            <telerik:RadTextBox Style="z-index: 0" ID="FrAddrTxt" runat="server" Skin="WebBlue" Rows="3" TextMode="MultiLine"
                                                Width="155px" Height="80px">
                                            </telerik:RadTextBox>
                                        </td>
