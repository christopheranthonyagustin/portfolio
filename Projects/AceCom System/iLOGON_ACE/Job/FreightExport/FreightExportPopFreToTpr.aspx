<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightExportPopFreToTpr.aspx.cs" Inherits="iWMS.Web.Job.FreightExport.PopFreToTpr" %>
...
<html>
<head runat="server">
    <title>Book Transport @ Freight Export Register</title>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <br />
                    <br />
                    &nbsp;<asp:Button ID="PopulateBtn" runat="server" CssClass="white" Text="Book"
