...
<%@ Page Language="c#" Codebehind="FreightExportMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.FreightExport.FreightExportMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="NewModuleTitle" align="right">
                        <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Freight Export Register</asp:Label>
                    </td>
				</tr>
			</table>
		</form>
