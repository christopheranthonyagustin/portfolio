<%@ Page Language="c#" CodeBehind="FreightExportHead.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.FreightExport.FreightExportHead" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table width="100%">
            <tr>
                <td width="400px">
                    ...
                    &nbsp;
                    <asp:Button ID="BookWarehouseBtn" CssClass="LongLabelWhite" runat="server" OnClick="BookWarehouseBtn_Click"
        ...
        <div id="div-datagrid" style="height: 92%">
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" Width="6000px"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" AllowFilteringByColumn="true">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="100px"
                            ...
                            <ItemTemplate>
                                <asp:ImageButton runat="server" Visible="True" ID="FreightExportEdit" ImageUrl="../../image/pencil.gif"
                                    BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit Freight Export Register"
                                    OnClick="FEldEdit_Click" CausesValidation="False"></asp:ImageButton>
                                <iWMS:iSubMenu ID="subMenuCtl" runat="server"></iWMS:iSubMenu>
                                <asp:Label ID="DetailLbl" runat="server"></asp:Label>
                                <asp:Label ID="JobPopCfmLbl" runat="server" />
                                <asp:Label ID="WisPopCfmLbl" runat="server" />
                        ...
                        <telerik:GridBoundColumn HeaderText="Acc" DataField="accode" AllowFiltering="true"
                            ColumnGroupName="accode" SortExpression="accode" UniqueName="accode" Reorderable="true" HeaderStyle-Width="140px" ItemStyle-Width="140px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Job#" DataField="number" AllowFiltering="true"
                            ColumnGroupName="number" SortExpression="number" UniqueName="number" Reorderable="true" HeaderStyle-Width="140px" ItemStyle-Width="140px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Status" DataField="statusdescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="statusdescr" SortExpression="statusdescr" UniqueName="statusdescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Quotation" DataField="qucode" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="qucode" SortExpression="qucode" UniqueName="qucode" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="SType" DataField="shipmenttypedescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="shipmenttypedescr" SortExpression="shipmenttypedescr" UniqueName="shipmenttypedescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="FType" DataField="frttypedescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="frttypedescr" SortExpression="frttypedescr" UniqueName="frttypedescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="FMode" DataField="frtmodedescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="frtmodedescr" SortExpression="frtmodedescr" UniqueName="frtmodedescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Site" DataField="releaseloc" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="releaseloc" SortExpression="releaseloc" UniqueName="releaseloc"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="HouseOBL/AWB" DataField="inmshipdocno" AllowFiltering="true" HeaderStyle-Width="150px" ItemStyle-Width="150px"
                            ColumnGroupName="inmshipdocno" SortExpression="inmshipdocno" UniqueName="inmshipdocno" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="MasterOBL/AWB" DataField="outmshipdocno" AllowFiltering="true" HeaderStyle-Width="170px" ItemStyle-Width="170px"
                            ColumnGroupName="outmshipdocno" SortExpression="outmshipdocno" UniqueName="outmshipdocno" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Permit" DataField="permitno" AllowFiltering="true" HeaderStyle-Width="180px" ItemStyle-Width="180px"
                            ColumnGroupName="permitno" SortExpression="permitno" UniqueName="permitno" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="CustRef" DataField="exref1" AllowFiltering="true" HeaderStyle-Width="180px" ItemStyle-Width="180px"
                            ColumnGroupName="exref1" SortExpression="exref1" UniqueName="exref1" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="PortNetNo" DataField="exref2" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="exref2" SortExpression="exref2" UniqueName="exref2" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Remarks" DataField="remarks" AllowFiltering="true" HeaderStyle-Width="1200px" ItemStyle-Width="1200px"
                            ColumnGroupName="remarks" SortExpression="remarks" UniqueName="remarks" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="BLSurrendedIn" DataField="blsurrendedindescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="BLSurrendedIn" SortExpression="BLSurrendedIn" UniqueName="BLSurrendedIn" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Description" DataField="license" AllowFiltering="true" HeaderStyle-Width="600px" ItemStyle-Width="600px"
                            ColumnGroupName="license" SortExpression="license" UniqueName="license" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Invno" DataField="drinvno" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="drinvno" SortExpression="drinvno" UniqueName="drinvno" Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="TINo" DataField="delvagentrefno" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="delvagentrefno" SortExpression="delvagentrefno" UniqueName="delvagentrefno"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="POL" DataField="inloadingportdescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="inloadingportdescr" SortExpression="inloadingportdescr" UniqueName="inloadingportdescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="ETD" DataField="outetd" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="outetd" SortExpression="outetd" UniqueName="outetd" Reorderable="true"
                            DataFormatString="{0:dd/MMM/yyyy}">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="POD" DataField="outdischargeportdescr" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                            ColumnGroupName="outdischargeportdescr" SortExpression="outdischargeportdescr" UniqueName="outdischargeportdescr"
                            Reorderable="true">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="ETA" DataField="ineta" AllowFiltering="true" HeaderStyle-Width="140px" ItemStyle-Width="140px"
