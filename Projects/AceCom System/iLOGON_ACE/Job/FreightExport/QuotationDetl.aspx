<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDetl.aspx.cs"
    Inherits="iWMS.Web.Job.FreightExport.QuotationDetl" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                &nbsp;<asp:Button ID="AddBtn" runat="server" CssClass="detailButton" Text="Add" OnClick="AddBtn_Click">
                    ...
                    &nbsp;<asp:Button ID="AddBtn" runat="server" CssClass="white" Text="Add" OnClick="AddBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>&nbsp;<asp:Button ID="CloseBtn" runat="server" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"
                        Text="Close" OnClick="CloseBtn_Click"></asp:Button>&nbsp;
                </td>
            </tr>
            <tr>
