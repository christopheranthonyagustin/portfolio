<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceBillingWorkbenchMenu.aspx.cs" Inherits="iWMS.Web.Job.ServiceBillingWorkbench.ServiceBillingWorkbenchMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Service Billing Workbench</title>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right" valign="bottom">
                    <asp:Label ID="MenuLbl" runat="server">Service Billing Workbench</asp:Label>
                </td>
            </tr>
        </table>
    </form>
