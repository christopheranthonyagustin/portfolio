<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceBillingWorkbenchGRNotBilled.aspx.cs" Inherits="iWMS.Web.Job.ServiceBillingWorkbench.ServiceBillingWorkbenchGRNotBilled" %>
...
<html>
<head runat="server">
    <title>Service Billing Workbench GoodsReceive NotBilled</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="form2" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowFilteringByColumn="true"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="Id" Name="GRNotBilledGrid">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ReceiptNo" UniqueName="ReceiptNo" SortExpression="ReceiptNo" HeaderText="ReceiptNo" AllowFiltering="true" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="GoodsIssueNo" UniqueName="GoodsIssueNo" SortExpression="GoodsIssueNo" HeaderText="GoodsIssueNo" AllowFiltering="true" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="TypeDescr" UniqueName="Type" SortExpression="Type" HeaderText="Type" AllowFiltering="true" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
