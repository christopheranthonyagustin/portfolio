<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceBillingWorkbenchGRNonBillable.aspx.cs" Inherits="iWMS.Web.Job.ServiceBillingWorkbench.ServiceBillingWorkbenchGRNonBillable" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GR-NonBillable @ Service Billing Workbench</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="RcDtId" Name="VehicleXOrderGrid" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#05538c" HeaderStyle-Font-Bold="true">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ReceivedUomQty" HeaderText="Received Quantity" Display="true" DataFormatString="{0:#,0.##}">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="RcsDtId" HeaderText="RcsDtId" Display="False">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ReceivedQty" HeaderText="ReceivedQty" Display="False">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Uom" HeaderText="Uom" Display="False">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="RcDtId" HeaderText="RcDtId" Display="False">
                    </telerik:GridBoundColumn>
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
