<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceBillingWorkbenchGRAddCharge.aspx.cs" Inherits="iWMS.Web.Job.ServiceBillingWorkbench.ServiceBillingWorkbenchGRAddCharge" %>
...
<head id="Head1" runat="server">
    <title>AddCharge @ ServiceBillingWorkbench</title>
    ...
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="SearchBtn" runat="server" CssClass="white" Text="Search" OnClientClick="disableBtn(this.id,false)" ToolTip="Search"
                        UseSubmitBehavior="false" OnClick="SearchBtn_Click"></asp:Button>
                    &nbsp;
                    <asp:Button ID="AddBtn" runat="server" CssClass="white" Text="Add" OnClick="AddBtn_Click" OnClientClick="disableBtn(this.id,false)"
                        UseSubmitBehavior="false"></asp:Button>
                    &nbsp;
                    <asp:Button ID="AddNextBtn" runat="server" CssClass="white" Text="Add & Next" OnClick="AddNextBtn_Click" OnClientClick="disableBtn(this.id,false)"
                        UseSubmitBehavior="false"></asp:Button>
                    &nbsp;
                    <asp:Button ID="CloseBtn" runat="server" CssClass="white"
        ...
        <telerik:RadGrid ID="RCChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            Skin="Metro" OnItemDataBound="RCChargeDG_ItemDataBound" onkeydown="if(this.readOnly) event.preventDefault();">
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ChargeCode" HeaderText="Charge" ItemStyle-Font-Bold="true" />
                    <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-HorizontalAlign="Center" UniqueName="chargedescr" AllowFiltering="false">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="MinCharge" HeaderStyle-HorizontalAlign="Center" UniqueName="UMinCharge">
                        <ItemTemplate>
