<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceBillingWorkbenchGIAddCharge.aspx.cs" Inherits="iWMS.Web.Job.ServiceBillingWorkbench.ServiceBillingWorkbenchGIAddCharge" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="AddBtn" runat="server" CssClass="white" Text="Add" OnClick="AddBtn_Click"></asp:Button>
                    &nbsp;
        ...
        <telerik:RadGrid ID="ISChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            Skin="Metro" OnItemDataBound="ISChargeDG_ItemDataBound">
