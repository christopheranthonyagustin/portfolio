<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportOrderV2Menu.aspx.cs" Inherits="iWMS.Web.Job.TransportOrderV2.TransportOrderV2Menu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TransportOrderV2</title>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right" valign="bottom">
                    <asp:Label ID="MenuLbl" runat="server">Transport Order V2</asp:Label>
                </td>
            </tr>
            <tr>
