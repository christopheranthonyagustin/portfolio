<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Job.ClosePeriodSvcChit.Menu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>ClosePeriodSvcChit</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="15" style="border-bottom: #D5D5D5 1px solid;">
    <form id="Form1" method="post" runat="server">
        ...
        <table width="100%">
            <tr>
                <%--Ticket #2867: KSL : Enhancement to Close Period Service Chit Modified by XM 24/06/2016--%>
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="ReportLbl" runat="server">Close Period Service Chit</asp:Label>
                </td>
                <%--<td class="style1">
                &nbsp;
            </td>
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 30%; background-color: #660000;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        &nbsp;<asp:Label ID="ReportLbl" runat="server">Close Period Service Chit</asp:Label></div>
                </div>
            </td>--%>
            </tr>
        </table>
