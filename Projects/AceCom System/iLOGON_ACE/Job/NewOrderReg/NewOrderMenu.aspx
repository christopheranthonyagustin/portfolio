...
<%@ Page Language="c#" CodeBehind="NewOrderMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.NewOrderReg.NewOrderMenu" %>
            ...
            <td class="ModuleTitle" align="right" valign="bottom">
                <div class="rounded-box1" style="background-color: #336600; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        width: 316px;">
                        <asp:Label ID="MenuLbl" runat="server">Order Register</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
