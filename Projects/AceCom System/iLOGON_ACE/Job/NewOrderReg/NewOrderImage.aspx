<%@ Page Language="c#" CodeBehind="NewOrderImage.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.NewOrderReg.NewOrderImage" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>NewOrderImage</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <td colspan=2><div class="DropZone1">
            <p>Drop Files Here</p>
        </div></td>
    </tr>
</body>
