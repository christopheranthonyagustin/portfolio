<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TranshipmentRegisterBillableItems.aspx.cs" Inherits="iWMS.Web.Job.TranshipmentRegister.TranshipmentRegisterBillableItems" %>
...
<head runat="server">
    <title>TranshipmentRegisterBillableItems</title>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        ...
                        <asp:Button ID="DelImgBtn" CssClass="white" runat="server"
                            ...
                            &nbsp; 
                        <asp:Button ID="BillBtn" CssClass="white" runat="server" OnClick="BillBtn_Click" Visible="True" Text="Bill" CausesValidation="false" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                            &nbsp; 
                ...
                <%--Start Set Hidden button for changing from TT-popup to RadConfirm--%>
                <table>
                    <tr>
                        <td>                           
                            <asp:Button ID="ConfirmBillBtn" Text="" Style="display: none;" OnClick="ConfirmBillBtn_Click" runat="server" />
                        </td>
                    </tr>
                </table>
                <%--End--%>
