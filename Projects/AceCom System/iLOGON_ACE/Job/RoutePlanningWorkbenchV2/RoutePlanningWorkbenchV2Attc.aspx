<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbenchV2Attc.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbenchV2.RoutePlanningWorkbenchV2Attc" %>
...
<html>
<head runat="server">
    <title>RoutePlanningWorkbenchV2Attc</title>
...
<body id="main-content">
    <form id="Form1" method="post" enctype="multipart/form-data" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            CausesValidation="false" AutoPostBack="true" SelectedIndex="4" Skin="Office2007">
            <Tabs>
