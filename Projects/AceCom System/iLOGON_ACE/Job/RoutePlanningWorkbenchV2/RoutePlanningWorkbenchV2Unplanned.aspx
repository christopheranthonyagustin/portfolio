<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbenchV2Unplanned.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbenchV2.RoutePlanningWorkbenchV2Unplanned" %>
...
<head id="Head1" runat="server">
    <title>RoutePlanningWorkbenchV2Unplanned</title>
...
<body style="border-spacing: 0px;">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            CausesValidation="false" AutoPostBack="true" SelectedIndex="5" Skin="Office2007">
            <Tabs>
