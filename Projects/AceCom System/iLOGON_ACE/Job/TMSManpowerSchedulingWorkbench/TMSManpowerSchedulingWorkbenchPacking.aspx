<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSManpowerSchedulingWorkbenchPacking.aspx.cs" Inherits="iWMS.Web.Job.TMSManpowerSchedulingWorkbench.TMSManpowerSchedulingWorkbenchPacking" %>
...
<head runat="server">
    <title>Packing @TMS Manpower Scheduling Workbench</title>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div style="display: inline-block; text-align: left">
                                                ...
                                                &nbsp;
                                                 <asp:Button ID="PackingListBtn" CssClass="blue" runat="server" OnClick="PackingListBtn_Click" Text="PackingList" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="500" DataKeyNames="id" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM"
                ...
                <DetailTables>
                    <telerik:GridTableView DataKeyNames="id" Name="ChildGrid" HierarchyDefaultExpanded="true" InsertItemDisplay="Bottom">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderStyle-Width="2%" ItemStyle-Width="2%" Reorderable="false"
