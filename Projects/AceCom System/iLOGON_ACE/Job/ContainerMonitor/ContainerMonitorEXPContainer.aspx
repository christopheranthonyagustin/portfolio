<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerMonitorEXPContainer.aspx.cs" Inherits="iWMS.Web.Job.ContainerMonitor.ContainerMonitorEXPContainer" %>
...
<head id="Head1" runat="server">
    <title>ContainerMonitorEXPContainer</title>
    ...
    <form id="form1" runat="server" method="post">
        ...
        <table>
            <tr>
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="CMSBtn" runat="server" CssClass="white" Text="CMS" CausesValidation="false"
                        OnClick="CMSBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                    &nbsp;
                    <asp:Button ID="ReadyBtn" runat="server" CssClass="white" Text="Ready" CausesValidation="false"
        ...
        <div style="height: 52%" id="div1">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" EnableLinqExpressions="False" AllowPaging="True"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" Name="EXPContainerGrid">
