<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerMonitorEXPSummaryEdit.aspx.cs" Inherits="iWMS.Web.Job.ContainerMonitor.ContainerMonitorEXPSummaryEdit" %>
...
<html>
<head runat="server">
    <title>Containe Monitor EXP Summary Edit</title>
    <base target="_self" />
            ...
            <ContentTemplate>
                ...
                <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="CMS" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderTemplate>
                                    <div>CMS</div>
                                    <input id="cbSelectAllCms" name="cbSelectAllCms" type="checkbox" onclick="selectAll(this, 'chkCMS')">
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="ESN" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderTemplate>
                                    <div>ESN</div>
                                    <input id="cbSelectAllEsn" name="cbSelectAllEsn" type="checkbox" onclick="selectAll(this, 'chkESN')">
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkESN" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Ready For Export" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="SealNo" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" AllowFiltering="false">
                                <ItemTemplate>
                                    <telerik:RadTextBox ID="SealNoTxt" runat="server" Width="150px" Skin="WebBlue" Text='<%# DataBinder.Eval(Container.DataItem, "SealNo") %>'>
                                    </telerik:RadTextBox>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>                            
                            <telerik:GridTemplateColumn HeaderText="RequiredDate" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" AllowFiltering="false">
                                <ItemTemplate>
                                    <telerik:RadDatePicker ID="RequiredDate" runat="server" Width="150px" Skin="WebBlue" DataField="expdate"
                                    AllowFiltering="false"  ColumnGroupName="expdate" SortExpression="expdate" UniqueName="expdate"
                                    Reorderable="true" DisplayDateFormat="{0:dd/MMM/yyyy}" SelectedDate='<%# Bind("expdate") %>' DateInput-DateFormat="dd/MMM/yyyy" DateInput-DisplayDateFormat="dd/MMM/yyyy">
                            ...
                            <telerik:GridBoundColumn DataField="CMS" Display="false" />
                            <telerik:GridBoundColumn DataField="ESN" Display="false" />
                            <telerik:GridBoundColumn DataField="ReadyForExport" Display="false" />
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
                <br />
