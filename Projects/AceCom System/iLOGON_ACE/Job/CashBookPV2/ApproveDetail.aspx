<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveDetail.aspx.cs"
    Inherits="iWMS.Web.Job.CashBookPV2.ApproveDetail" %>
    ...
    <form id="form1" method="post" runat="server">
        ...
        <div>
            <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                ...
                <tr>
                    <td>
                        <asp:Button ID="ApproveBtn" runat="server" Text="Approve" Visible="true" CssClass="white"
                            OnClick="ApproveBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
                    </td>
                </tr>
            </table>
