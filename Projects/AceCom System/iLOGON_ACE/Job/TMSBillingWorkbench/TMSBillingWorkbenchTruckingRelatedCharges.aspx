<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBillingWorkbenchTruckingRelatedCharges.aspx.cs" Inherits="iWMS.Web.Job.TMSBillingWorkbench.TMSBillingWorkbenchTruckingRelatedCharges" %>
...
<html>
<head runat="server">
    <title>TruckingRelatedCharges @ TMSBillingWorkbench</title>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Import Date" DataField="ImportDate" SortExpression="ImportDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Return Date" DataField="ReturnDate" SortExpression="ReturnDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Collection Date" DataField="CollectionDate" SortExpression="CollectionDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Export Date" DataField="ExportDate" SortExpression="ExportDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="PlugInStartDate" DataField="PlugInStartDate" SortExpression="PlugInStartDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="PlugInEndDate" DataField="PlugInEndDate" SortExpression="PlugInEndDate" HeaderStyle-Width="140px" ItemStyle-Width="140px"
                        DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
