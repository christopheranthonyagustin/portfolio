<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBillingWorkbenchCharge.aspx.cs" Inherits="iWMS.Web.Job.TMSBillingWorkbench.TMSBillingWorkbenchCharge" %>
...
<head runat="server">
    <title>TMSBillingWorkbenchCharge</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" CausesValidation="false" MultiPageID="RadMultiPage1"
            AutoPostBack="true" SelectedIndex="0" Skin="Windows7" RenderMode="Lightweight" OnTabClick="RadTabStrip1_TabClick" Style="height: 26px">
            <Tabs>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                ...
                <div id="div3" style="height: 100%">
                    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                        ...
                        AllowPaging="false" Skin="Metro" RenderMode="Lightweight" OnNeedDataSource="ResultDG_NeedDataSource"
