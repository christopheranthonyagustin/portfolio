<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDetl.aspx.cs" Inherits="iWMS.Web.Job.TMSBillingWorkbench.QuotationDetl" %>
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="ContainerNo" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <telerik:RadDropDownList ID="ContainerNoDDL" runat="server" Skin="WebBlue" Width="155" DropDownWidth="155" DataValueField="CtnrNo" DataTextField="CtnrNo" OnLoad="ContainerNoDDL_Load"></telerik:RadDropDownList>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
