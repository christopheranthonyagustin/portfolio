<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBillingWorkbenchTruckingRelatedChargesBill.aspx.cs" Inherits="iWMS.Web.Job.TMSBillingWorkbench.TMSBillingWorkbenchTruckingRelatedChargesBill" %>
...
<head runat="server">
    <title>Bill @ TMSBillingWorkbench</title>
                                ...
                                <telerik:RadGrid ID="AdditionalInfoDG" runat="server" AutoGenerateColumns="false" GridLines="None" Height="350px"
                                    ...
                                    <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="DetourReason" SortExpression="DetourReason" UniqueName="DetourReason" HeaderText="Detour Reason">
                                            </telerik:GridBoundColumn>
