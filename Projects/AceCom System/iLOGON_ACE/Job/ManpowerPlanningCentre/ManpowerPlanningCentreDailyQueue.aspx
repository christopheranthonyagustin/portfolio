<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManpowerPlanningCentreDailyQueue.aspx.cs" Inherits="iWMS.Web.Job.ManpowerPlanningCentre.ManpowerPlanningCentreDailyQueue" %>
...
<head runat="server">
    <title>ManpowerPlanningCentreDailyQueue</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" AllowFilteringByColumn="false"
                    ...
                    AllowPaging="true" AutoGenerateColumns="true" GridLines="None" OnGridExporting="ResultDG_GridExporting"
