<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7RE.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7RE" %>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Silk" RenderMode="Lightweight" Height="98%"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Account/BookingNo" ItemStyle-HorizontalAlign="Center" DataField="AcookingNoEndCustomer"
                                HeaderText="Account <br/> BookingNo <br/> EndCustomer" SortExpression="AcCode" AutoPostBackOnFilter="true" ItemStyle-Width="117px" HeaderStyle-Width="117px" FilterControlWidth="60px">
                                <ItemTemplate>
                                    <%# string.Format("{0:}",  Eval("AcBookingNoEndCustomer")) %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Carrier/BLNO" HeaderText="Carrier <br/> BLNO" DataField="CarrierNameBLNO" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="160px" HeaderStyle-Width="160px"
                                SortExpression="CarrierNameBLNO" AllowFiltering="false">
                                <ItemTemplate>
                                   <%-- <%# string.Format("{0:}",  Eval("CarrierNameBLNO")) %>
                                    <br />
                                    </br>--%>
                                     <asp:Label runat="server" ID="lblCarrierName" Font-Bold="true" Text='<%# DataBinder.Eval(Container.DataItem, "outcarriername")%>'></asp:Label>
                                    <br />
                                    <asp:Label runat="server" ID="lblBLNo" Text='<%# DataBinder.Eval(Container.DataItem, "BLNo")%>'></asp:Label>
                                    <br />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadComboBox ID="CarrierList" runat="server" DataTextField="descr" DataValueField="item"
                                        RenderMode="Lightweight" Skin="WebBlue" Width="140px" OnItemsRequested="CarrierList_ItemsRequested"
                                        HighlightTemplatedItems="true" Filter="Contains" EnableLoadOnDemand="true" OnClientDropDownClosed="VehicleList_DropDownClosed">
                                    </telerik:RadComboBox>
                                    <br />
                                    <br />
                                     <telerik:RadTextBox runat="server" ID="BLNoTxt" TextMode="SingleLine" Width="110px">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV7RE.aspx/CheckUsedTrailerNo',
                ...
                var CarrierNameBLNO = function (BLNo, Carrier, CarrierValue) {
                    // to display the text to user
                ...
                CarrierNameBLNO.prototype.equals = function (carrierNameBLNO) {
                    if (this.Carrier === carrierNameBLNO.Carrier &&
                        this.CarrierValue === carrierNameBLNO.CarrierValue &&
                        this.BLNo === carrierNameBLNO.BLNo) {
                        return true;
                    }
                    return false;
                }
                CarrierNameBLNO.prototype.toString = function () {
                    return JSON.stringify({
                        Carrier: this.Carrier, CarrierValue: this.CarrierValue, BLNo: this.BLNo
                    });
                }
                ...
                function GetCellValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "Carrier/BLNO") {
                        args.set_cancel(true);
                        var Container = args.get_container();
                        var CarrierName = $telerik.findElement(Container, "lblCarrierName").innerHTML;
                        var BlNo = $telerik.findElement(Container, "lblBLNo").innerHTML;
                        args.set_value(new CarrierNameBLNO(BlNo, CarrierName));
                    }
                }
                ...
                function SetCellValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "Carrier/BLNO") {
                        args.set_cancel(true);
                        var Container = args.get_container(), Value = args.get_value();
                        $telerik.findElement(Container, "lblCarrierName").innerHTML = Value.Carrier;
                        $telerik.findElement(Container, "lblBLNo").innerHTML = Value.BLNo;
                    }
                }
                ...
                function GetEditorValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "Carrier/BLNO") {
                        args.set_cancel(true);
                        var container = args.get_container(),
                            BLNo = $telerik.findControl(container, "BLNoTxt").get_value(),
                            Carrier = $telerik.findControl(container, "CarrierList").get_text(),
                            CarrierValue = ($telerik.findControl(container, "CarrierList").get_value().split("|"))[0];

                        args.set_value(new CarrierNameBLNO(BLNo, Carrier, CarrierValue));
                    }
                }
                ...
                function SetEditorValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "Carrier/BLNO") {
                        ...
                        if ($telerik.findControl(container, "CarrierList") && $telerik.findControl(container, "CarrierList").findItemByText(value.Carrier))
                            $telerik.findControl(container, "CarrierList").findItemByText(value.Carrier).select();
                        else
                            $telerik.findControl(container, "CarrierList").set_text(value.Carrier);

                        $telerik.findControl(container, "BLNoTxt").set_value(value.BLNo);
                    }
                }
