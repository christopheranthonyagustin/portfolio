...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7Menu.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7Menu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TripPlanningV7</title>
        ...
        <table width="100%">
            <tr valign="bottom">
                ...
                <td class="NewModuleTitle" align="right" valign="bottom">
                    <asp:Label ID="MenuLbl" runat="server">Trip Planning V7</asp:Label>
                </td>
            </tr>
        </table>
    </form>
