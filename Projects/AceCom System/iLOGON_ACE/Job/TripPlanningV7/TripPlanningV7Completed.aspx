<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7Completed.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7Completed" %>
                    ...
                    <asp:Panel ID="ButtonPanel" runat="server">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="Button1" runat="server" CssClass="white" Text="Open" OnClick="OpenBtn_Click"
        ...
        <asp:UpdatePanel ID="OuterUpdatePanel" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007" RenderMode="Lightweight"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid" Width="2000px"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="TripDateTime" HeaderText="TripDateTime" ItemStyle-HorizontalAlign="Center" AllowFiltering="false"
                             ...
                             <telerik:GridBoundColumn UniqueName="jbno" DataField="JobNo" HeaderText="JobNo" AllowFiltering="true">
                        </telerik:GridBoundColumn>
                            <telerik:GridTemplateColumn UniqueName="JobNo" ItemStyle-HorizontalAlign="Center" DataField="AcBookingNo"
                                HeaderText="Account <br/> BookingNo <br/> EndCustomer" SortExpression="AcCode" AutoPostBackOnFilter="true" ItemStyle-Wrap="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="TripTypeDoubleStatus" ItemStyle-HorizontalAlign="Center" HeaderText="TripType <br/> Double <br/> Status"
                                SortExpression="TripTypeDoubleStatus" AllowFiltering="true" AutoPostBackOnFilter="true" DataField="TripTypeDoubleStatus" AllowSorting="true">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Vehicle" DataField="VehNoDriverTrailer" HeaderText="Vehicle <br/> Driver<br/> Trailer <br/> TrailerPark" ItemStyle-HorizontalAlign="Center"
                                SortExpression="VehNoDriverTrailer" AllowFiltering="true" AllowSorting="true" ItemStyle-Wrap="false" AutoPostBackOnFilter="true">
                                <ItemTemplate>
