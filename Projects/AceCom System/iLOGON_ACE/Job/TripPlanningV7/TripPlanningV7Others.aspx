<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7Others.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7Others" %>
...
<html>
<head runat="server">
    <title>TripPlanningV7Others</title>
            ...
            <tr>
                <td align="left" valign="top">
                    ...
                    <%--<asp:Button ID="DeleteBtn" runat="server" Text="Delete" OnClick="DeleteBtn_Click" 
                                CssClass="white" ToolTip="Bill" OnClientClick="disableBtn(this.id)"  UseSubmitBehavior="false" />--%>
                </td>
            </tr>
        </table>
        <asp:UpdatePanel ID="OuterUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Silk" RenderMode="Lightweight" Height="98%"
                    OnNeedDataSource="ResultDG_NeedDataSource" AllowMultiRowSelection="true" MasterTableView-AllowSorting="true" OnBatchEditCommand="ResultDG_BatchEditCommand"
                    ...
                    AllowFilteringByColumn="true" ClientSettings-AllowColumnsReorder="true" AllowSorting="true" AllowPaging="true">
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="S/N" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="65px" ItemStyle-Width="65px"
                            ...
                            <telerik:GridTemplateColumn UniqueName="ExpDate" HeaderText="RequiredDate" ItemStyle-HorizontalAlign="Center" AllowFiltering="true"
                                SortExpression="ExpDate" AllowSorting="true" HeaderStyle-Width="155px" ItemStyle-Width="155px"
                                AutoPostBackOnFilter="true" DataField="ExpDateFormat">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblExpDate" Text='<%# DataBinder.Eval(Container.DataItem, "ExpDate", "{0:dd/MMM/yyyy <br/> HH:mm}")%>'></asp:Label>
                                    <br />
                                    <asp:Label runat="server" ID="lblDate" Text='<%# DataBinder.Eval(Container.DataItem, "EqpRemarks")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadDateTimePicker runat="server" ID="ExpDateDP" Skin="Office2007" Width="140px"
                            ...
                            <telerik:GridTemplateColumn UniqueName="JobNo/Account/BookingNo" ItemStyle-HorizontalAlign="Center" DataField="JobAcBookingNo" HeaderStyle-Width="135px" ItemStyle-Width="135px"
                            ...
                            <telerik:GridTemplateColumn UniqueName="ContainerNo/SealNo" HeaderText="ContainerNo <br/> SealNo" DataField="ContainerNoSealNo"
                                SortExpression="ContainerNo" AllowFiltering="true" AutoPostBackOnFilter="true" ItemStyle-Width="150px" HeaderStyle-Width="150px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Vehicle/Driver/Trailer" HeaderText="Vehicle <br/> Driver<br/> TrailerPark<br/> TrailerNo" ItemStyle-HorizontalAlign="Center"
                                SortExpression="VehNo" AllowFiltering="true" AutoPostBackOnFilter="true" ItemStyle-Width="155px" HeaderStyle-Width="155px" DataField="VehicleDriverTrailerParkTrailerNo">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <telerik:RadComboBox ID="VehicleList" runat="server" DataTextField="descr" DataValueField="item"
                                        RenderMode="Lightweight" Skin="WebBlue" Width="140px" DropDownWidth="140px" OnItemsRequested="VehicleList_ItemsRequested"
                                    ...
                                    <telerik:RadComboBox ID="DriverList" runat="server" DataTextField="descr" DataValueField="item"
                                        RenderMode="Lightweight" Skin="WebBlue" Width="140px" DropDownWidth="140px" OnItemsRequested="DriverCBB_ItemsRequested"
                                        HighlightTemplatedItems="true" EnableLoadOnDemand="true" Filter="Contains">
                                    </telerik:RadComboBox>
                                    <br />
                                    <br />
                                    ...
                                    <telerik:RadComboBox ID="TrailerNoList" runat="server" DataTextField="descr" DataValueField="item" RenderMode="Lightweight"
                                        OnLoad="TrailerNoList_Load" HighlightTemplatedItems="true" Skin="WebBlue" Width="140px" DropDownWidth="140px"
                            ...
                            <telerik:GridTemplateColumn UniqueName="BillSizeType/TripOption/BillOption" HeaderText="BillSizeType <br/> TripOption <br/> BillOption" ItemStyle-HorizontalAlign="Center"
                                SortExpression="billsizetype" AllowFiltering="true" ItemStyle-Width="155px" HeaderStyle-Width="155px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="TripTypeDoubleStatus" ItemStyle-HorizontalAlign="Center" HeaderText="JobType <br/> TripType <br/> Double <br/> Status" SortExpression="TripTypeDoubleStatus"
                                AllowFiltering="false" ItemStyle-Width="120px" HeaderStyle-Width="120px">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "JobTypeTripTypeDoubleStatus")%>
                                    </br>                                    
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="DropOff" HeaderText="DropOff" SortExpression="ToServicePtDescr" DataField="toaddr" AllowFiltering="true" AutoPostBackOnFilter="true" ItemStyle-Width="155px" HeaderStyle-Width="155px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="SpecialInstruction" HeaderText="TripSpecialInstruction" SortExpression="SpecialInstruction" AllowFiltering="false" ItemStyle-Width="155px" HeaderStyle-Width="155px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="JobSpecialInstruction" HeaderText="JobSpecialInstruction" SortExpression="JobSpecialInstruction" AllowFiltering="false" ItemStyle-Width="155px" HeaderStyle-Width="155px">
                                <ItemTemplate>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV7Others.aspx/CheckUsedTrailerNo',
                ...
                var ExpiryDate = function (Expdate, Date) {
                    this.Expdate = Expdate; // in javascript Date object
                    this.Date = Date;
                }

                ExpiryDate.prototype.equals = function (expirydate) {
                    if (((!this.Expdate && !expirydate.Expdate) || moment(this.Expdate).isSame(moment(expirydate.Expdate)))
                        && this.Date === expirydate.Date) {
                        return true;
                    }
                    return false;
                }

                ExpiryDate.prototype.toString = function () {
                    var required = null;
                    if (this.Expdate)
                        required = moment(this.Expdate).format("DD/MMM/YYYY HH:mm");
                    return JSON.stringify({
                        Expdate: required, Date: this.Date
                    });
                }
                ...
                function GetCellValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "ExpDate") {
                        args.set_cancel(true);
                        var Container = args.get_container();
                        //var Expirydate = $telerik.findElement(Container, "lblExpDate").innerText;
                        var ExpirydateText = $telerik.findElement(Container, "lblExpDate").innerText;
                        var Expirydate = null;
                        if (ExpirydateText)
                            Expirydate = moment(ExpirydateText, "DD/MMM/YYYY HH:mm").toDate();
                        var Date = $telerik.findElement(Container, "lblDate").innerHTML;
                        args.set_value(new ExpiryDate(Expirydate, Date));
                    }
                ...
                function SetCellValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "ExpDate") {
                        ...
                        //$telerik.findElement(Container, "lblExpDate").innerText = Value.Expdate;
                        if (Value.Expdate)
                            $telerik.findElement(Container, "lblExpDate").innerText = moment(Value.Expdate).format("DD/MMM/YYYY HH:mm");
                        else
                            $telerik.findElement(Container, "lblExpDate").innerText = "";
                ...
                function GetEditorValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "ExpDate") {
                        args.set_cancel(true);
                        var Container = args.get_container(),
                            Expirydate = $telerik.findControl(Container, "ExpDateDP").get_selectedDate(),
                ...
                function SetEditorValue(sender, args) {
                    ...
                    if (args.get_columnUniqueName() === "ExpDate") {
                        ...
                        $telerik.findControl(Container, "ExpDateDP").set_selectedDate(Value.Expdate);
