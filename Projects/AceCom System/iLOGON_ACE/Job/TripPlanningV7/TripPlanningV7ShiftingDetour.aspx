<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7ShiftingDetour.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7ShiftingDetour" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TripPlanningV7 Shifting/Detour</title>
        ...
        <asp:UpdatePanel ID="OuterUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="false" Skin="Silk" RenderMode="Lightweight"
                    OnNeedDataSource="ResultDG_NeedDataSource" AllowMultiRowSelection="true" MasterTableView-AllowSorting="true" Height="98%" AllowPaging="true"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ExecutionDate" HeaderText="ExecutionDate" ItemStyle-Width="155px" HeaderStyle-Width="155px" ItemStyle-HorizontalAlign="Center"
                                AllowSorting="true" AutoPostBackOnFilter="true" SortExpression="bookingtime" DataField="BookingTimeFormat">
                                <ItemTemplate>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV7ShiftingDetour.aspx/CheckUsedTrailerNo',
