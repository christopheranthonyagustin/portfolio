<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7Attc.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7Attc" %>
...
<html>
<head runat="server">
    <title>Attc @ TripPlanningV7</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" enctype="multipart/form-data" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td>
                    <span style="padding-left: 10px">PIC</span>
                </td>
                <td>
                    <telerik:RadTextBox ID="Pic" runat="server" Enabled="false"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2"><br /></td>
