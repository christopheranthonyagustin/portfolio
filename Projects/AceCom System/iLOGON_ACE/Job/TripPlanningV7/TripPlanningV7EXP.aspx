<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV7EXP.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV7.TripPlanningV7EXP" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TripPlanningV7EXP</title>
            ...
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Silk" RenderMode="Lightweight" Height="98%"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid"
                        PageSize="50" HeaderStyle-HorizontalAlign="Center" CommandItemDisplay="Top" EditMode="Batch" TableLayout="Auto">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="85px" ItemStyle-Width="85px" HeaderStyle-HorizontalAlign="Left">
                                <HeaderTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Ready" ItemStyle-HorizontalAlign="Center" DataField="ReadyDone" HeaderText="Ready" SortExpression="ReadyDone" AllowFiltering="false" HeaderStyle-Width="55px" ItemStyle-Width="55px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ContainerNo/SealNo" HeaderText="ContainerNo <br/> SealNo" DataField="ContainerNoSealNo"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <br />
                                    <br />
                                    <telerik:RadTextBox runat="server" ID="SealNoTxt" TextMode="SingleLine" Width="98px">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV7EXP.aspx/CheckUsedTrailerNo',
