<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BLRegisterMenu.aspx.cs" Inherits="iWMS.Web.Job.BLRegister.BLRegisterMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                ...
                <asp:Label ID="BLRegisterLbl" labelclass="NewModuleTitle" runat="server"></asp:Label></div>
            </td>
        </tr>
    </table>
    </form>
