<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveJobGenInv.aspx.cs"
  Inherits="iWMS.Web.Job.ApproveJobGenInv.ApproveJobGenInv" %><%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<%@ Register TagPrefix="iWMS" TagName="iForm" Src="../../Control/iFormCtl.ascx" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>ApproveJobGenInv</title>
            ...
            <td class="ModuleTitle" align="right">
               <%--<div class="rounded-box1" style="background-color: #336600; width: 30%">
                ...
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Approve Job Generate Invoice</asp:Label>
                </div>
            </td>
    ...
    <tr>
      <td>
        <table style="z-index: 0" id="Table2" border="0" cellspacing="2" cellpadding="2">
            <tr>
                 <td>&nbsp
                    <%--<telerik:RadButton Style="z-index: 0" ID="generateBtn" runat="server" CssClass="detailbutton" Skin="WebBlue" Text="Generate Invoice" OnClick="generateBtn_Click"></telerik:RadButton>--%>
                 ...
                 <td>&nbsp
                    <%--<telerik:RadButton Style="z-index: 0" ID="Resetbtn" runat="server" CssClass="detailbutton" Skin="WebBlue" Text="Reset" OnClick="resetBtn_Click"></telerik:RadButton>--%>
                     <asp:Button ID="Resetbtn" class="white" runat="server" OnClick="resetBtn_Click" CausesValidation="false"  
                        Text="Reset" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                 </td>                    
                 <td>
                  &nbsp;              
                 <%--<%-- Modified by JL, 29th April 2016--%>
