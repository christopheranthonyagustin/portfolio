...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportMenuCT.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCT.TransportMenuCT" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>CourierTrackerRegister</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="5" style="border-bottom: #d5d5d5 1px solid">
    ...
    <table width="100%">
        <tr valign="bottom">
            ...
            <td class="ModuleTitle" align="right" valign="bottom">
                <div class="rounded-box1" style="background-color: #336600; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        width: 320px;">
                        <asp:Label ID="MenuLbl" runat="server">Courier Tracker Register</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
