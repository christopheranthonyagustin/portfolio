<%@ Page Language="c#" CodeBehind="TransportCtnrDetl.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.TransporterCT.TransportCtnrDetl" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td align="left">
                ...
                <asp:Button ID="switchEqpBtn" runat="server" Text="SwitchEqp" Visible="False" CssClass="detailButton"
                ...
                &nbsp;
                <asp:Button ID="PopFromSpBtn" runat="server" Text="Populate From ShipPlan" Visible="False"
                    CssClass="detailButton" OnClick="PopFromSpBtn_Click"></asp:Button>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="style1" valign="top">
                                ...
                                <br />
                                <asp:TextBox ID="NoOfTripsTxt" runat="server" Style="z-index: 0" Width="155px"></asp:TextBox>
                            </td>
                            <td class="style1" valign="top">
    ...
    <div style="height: 80%; top: 0px; left: 0px;" id="div-datagrid">
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ctnrtypedescr" SortExpression="ctnrtypedescr"
                        HeaderText="BillSizeType" ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="exptime" HeaderText="StartTime" Visible="true"
                    ...
                    <telerik:GridBoundColumn DataField="endtime" HeaderText="EndTime" Visible="true"
                        ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
        ...
        <%--    <asp:DataGrid ID="ResultDG" runat="server" PageSize="8" CellPadding="2" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="eqptypedescr" SortExpression="eqptypedescr" HeaderText="EqpType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="eqptype" SortExpression="eqptype" Visible="false"></asp:BoundColumn>
                <asp:BoundColumn DataField="ctnrtype" SortExpression="ctnrtype" HeaderText="BillSizeType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="jobtypedescr" SortExpression="jobtypedescr" HeaderText="JobType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="tpttypedescr" SortExpression="tpttypedescr" HeaderText="TptType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="expdate" SortExpression="expdate" HeaderText="StartDate"
                    DataFormatString="{0:dd-MMM-yy}">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="exptime" HeaderText="StartTime" Visible="true" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="enddate" HeaderText="EndDate" Visible="false"></asp:BoundColumn>
                <asp:BoundColumn DataField="endtime" HeaderText="EndTime" Visible="true" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="frserviceptdescr" SortExpression="frserviceptdescr" HeaderText="FrSvcPt">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="toserviceptdescr" SortExpression="toserviceptdescr" HeaderText="ToSvcPt">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="nooftrips" SortExpression="nooftrips" HeaderText="NoOfTrips" DataFormatString="{0:#,0.0}">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="noofhours" SortExpression="noofhours" HeaderText="NoOfHours" DataFormatString="{0:#,0.00}">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="noofheadcount" SortExpression="noofheadcount" HeaderText="NoOfPax" DataFormatString="{0:#,0.0}">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="bkref" SortExpression="bkref" HeaderText="BookingRef">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="bkreforiginal" SortExpression="bkreforiginal" HeaderText="OriginalBookingRef">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="descr" SortExpression="descr" HeaderText="Descr">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="tptercode" SortExpression="tptercode" HeaderText="Vendor">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="oog" SortExpression="oog" HeaderText="OOG">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="overht" SortExpression="overht" HeaderText="OverHt">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="overwt" SortExpression="overwt" HeaderText="OverWt">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="overlen" SortExpression="overlen" HeaderText="OverLen">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="quaycrane" SortExpression="quaycrane" HeaderText="QuayCrane">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="cellno" SortExpression="cellno" HeaderText="CellNo">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="sno" Visible="False"></asp:BoundColumn>
                <asp:BoundColumn DataField="policeescort" Visible="False"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="jobtype" Visible="false"></asp:BoundColumn>
                <asp:BoundColumn DataField="tpttype" Visible="false"></asp:BoundColumn>
            </Columns>
