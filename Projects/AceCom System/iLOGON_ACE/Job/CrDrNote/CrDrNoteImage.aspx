<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrDrNoteImage.aspx.cs" Inherits="iWMS.Web.Job.CrDrNote.CrDrNoteImage" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onserverclick="ImageDelete" onclick="return confirm(Delete?)" runat="server">
                        ...
                        <table border="0" cellspacing="2" cellpadding="2" width="100%">
                            ...
                            <tr>
                               ...
                               <%-- <telerik:RadButton ID="ImageSubmit" runat="server" OnClick="ImageSubmit_ServerClick"
                                    ...
                                    <asp:Button ID="ImageSubmit" class="white" runat="server" OnClick="ImageSubmit_ServerClick"
    ...
    <asp:Panel ID="DropZonePanel" runat="server" Style="padding-left: 10px;">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td colspan="2">
