<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbench.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbench.RoutePlanningWorkbench" %>
            ...
            <tr>
                <td valign="top">
                    ...
                    <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight"
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="vehno" Name="ParentGrid" PageSize="50" HierarchyLoadMode="Client" HierarchyDefaultExpanded="true" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                            <Columns>
                            ...
                            <DetailTables>
                                <telerik:GridTableView DataKeyNames="id" Name="ChildGrid" SkinID="Telerik" HierarchyDefaultExpanded="true" InsertItemDisplay="Bottom">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridCalculatedColumn HeaderText="CustRef<br/>Account" UniqueName="Test" DataFields="CustRef,accode"
                                            Expression='{0} + " <br/> " + {1}' SortExpression="accode"
                                            Reorderable="true">
                ...
                <td valign="top">
                    ...
                    <br />
                    <br />
                    <telerik:RadGrid ID="ResultDG2" runat="server" EnableLinqExpressions="False" Skin="Metro"
