<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbenchAttc.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbench.RoutePlanningWorkbenchAttc" %>
...
<html>
<head runat="server">
    <title>RoutePlanningWorkBenchTripAttc</title>
...
<body id="main-content">
    <form id="Form1" method="post" enctype="multipart/form-data" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            CausesValidation="false" AutoPostBack="true" SelectedIndex="4" Skin="Windows7">
            <Tabs>
