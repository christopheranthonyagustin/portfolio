<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbench2.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbench.RoutePlanningWorkbench2" %>
...
<head id="Head1" runat="server">
    <title>RoutePlanningWorkbench2</title>
                            ...
                            <td>
                                ...
                                <asp:Button ID="CompletedBtn" runat="server" CssClass="white" OnClick="CompletedBtn_Click"
                                    Text="Completed" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                            <br />
                                            <br />                                <asp:Button ID="ManifestBtn" runat="server" CssClass="blue" OnClick="ManifestBtn_Click"
