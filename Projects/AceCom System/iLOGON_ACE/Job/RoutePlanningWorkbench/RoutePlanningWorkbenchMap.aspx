<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbenchMap.aspx.cs" 
    Inherits="iWMS.Web.Job.RoutePlanningWorkbench.WebForm1" %>
...
<html>
<head>
    <title>RoutePlanningWorkbenchMap</title>
    <style dir="rtl">
        #main-content {
            height: 500px;
            width: auto;
...
<body id="main-content">
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            CausesValidation="false" AutoPostBack="true" SelectedIndex="2" Skin="Windows7">
            <Tabs>
