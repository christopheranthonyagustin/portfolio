<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoutePlanningWorkbenchTripInfo.aspx.cs" Inherits="iWMS.Web.Job.RoutePlanningWorkbench.RoutePlanningWorkbenchTripInfo" %>
...
<html>
<head runat="server">
    <title>RoutePlanningWorkBenchTripInfo</title>
...
<body id="main-content">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            CausesValidation="false" AutoPostBack="true" SelectedIndex="3" Skin="Windows7">
            <Tabs>
