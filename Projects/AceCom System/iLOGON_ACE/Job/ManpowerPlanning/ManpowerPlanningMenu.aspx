<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManpowerPlanningMenu.aspx.cs"
    Inherits="iWMS.Web.Job.ManpowerPlanning.ManpowerPlanningMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ManpowerPlanningMenu</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="MenuLbl" runat="server">Manpower Planning</asp:Label>
                </td>
            </tr>
        </table>
    </form>
