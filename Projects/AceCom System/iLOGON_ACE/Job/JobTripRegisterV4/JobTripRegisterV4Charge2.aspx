<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTripRegisterV4Charge2.aspx.cs" Inherits="iWMS.Web.Job.JobTripRegisterV4.JobTripRegisterV4Charge2" %>
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="ChargedescTxt" runat="server" Width="160"
                                        Value='<%# DataBinder.Eval(Container.DataItem, "jbchargedescr") %>'></asp:TextBox>                                                             
                                </ItemTemplate>  
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="DiscountAmt" HeaderStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    ...
                                    AutoPostBack="true" Text='<%# DataBinder.Eval(Container.DataItem, "discountamt", "{0:0.0000}") %>'></asp:TextBox>
