...
<%@ Page Language="c#" CodeBehind="InvoiceMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.InvoiceRegisterV2.InvoiceMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>InvoiceMenu</title>
            ...
            <td class="ModuleTitle" align="right">
               <%--<div class="rounded-box1" style="background-color: #336600; width: 80%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                       ...
                       <%-- <asp:Label ID="MenuLbl" runat="server">Invoice Register</asp:Label>--%>
                        <asp:Label ID="MenuLbl" runat="server" style="color:Black; font-size:medium; font-weight: bold">Invoice Register V2&nbsp;&nbsp;</asp:Label><%--</div>--%>
