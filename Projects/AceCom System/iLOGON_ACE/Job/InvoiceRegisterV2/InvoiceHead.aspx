<%@ Page Language="c#" CodeBehind="InvoiceHead.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.InvoiceRegisterV2.InvoiceHead" %>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Customer Name" DataField="billname" AllowFiltering="true"
                        SortExpression="billname" UniqueName="billname" Reorderable="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="BillingType" DataField="BillingType" AllowFiltering="true"
                        SortExpression="BillingType" UniqueName="BillingType" Reorderable="true">
                    </telerik:GridBoundColumn>
