<%@ Page Language="c#" CodeBehind="StorageDetail1.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.InvoiceRegisterV2.StorageDetail1" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>StorageDetail1</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%" id="report" runat="server">
        ...
        <tr class="graytitle">
            ...
            <td colspan="2">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">StorageDetail1</asp:Label>
            </td>
        </tr>
        <tr class="graytitle">
            <td>
