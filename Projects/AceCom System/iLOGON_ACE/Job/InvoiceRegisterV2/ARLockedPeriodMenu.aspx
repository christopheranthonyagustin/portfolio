<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARLockedPeriodMenu.aspx.cs"
    Inherits="iWMS.Web.Job.InvoiceRegisterV2.ARLockedPeriodMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>ARLockedPeriodMenu</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="8" style="border-bottom: #d5d5d5 1px solid">
    ...
    <table width="100%">
        <tr>
            ...
            <%--Ticket #4219: KSL : Enhancement to AR Locked Period module Modified by XM 05/07/2016--%>
            <td align="left">
            <div class="NewModuleTitle">
            <asp:Label ID="MenuLbl" runat="server">AR Locked Period</asp:Label>
            </div>
            </td>
            <%--<td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 20%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="MenuLbl" runat="server">ARLockedPeriod</asp:Label></div>
                </div>
            </td>--%>
        </tr>
    </table>
