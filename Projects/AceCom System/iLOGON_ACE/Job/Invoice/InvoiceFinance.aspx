<%@ Page Language="c#" CodeBehind="InvoiceFinance.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Invoice.InvoiceFinance" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>InvoiceFinance</title>
        ...
        <asp:DataGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" OnCancelCommand="ResultDG_Cancel"
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="Min Charge($)" ItemStyle-HorizontalAlign="Right">
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "minchargeamt", "{0:#,0.00}") %>
                    </ItemTemplate>
                </asp:TemplateColumn>
