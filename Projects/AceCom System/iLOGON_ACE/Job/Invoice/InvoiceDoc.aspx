<%@ Page Language="c#" CodeBehind="InvoiceDoc.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.Invoice.InvoiceDoc" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td align="right">
                ...
                <asp:Button ID="AddBtn" runat="server" Text="+ Rate" CssClass="detailButton" OnClick="AddBtn_Click">
                </asp:Button>&nbsp;
    ...
    <br>
    <div id="div-datagrid">
        <asp:DataGrid ID="ResultDG" runat="server" UseAccessibleHeader="True" DataKeyField="id"
            CellPadding="2" GridLines="Both" OnEditCommand="ResultDG_Edit" OnUpdateCommand="ResultDG_Update"
            OnCancelCommand="ResultDG_Cancel" AutoGenerateColumns="False">
