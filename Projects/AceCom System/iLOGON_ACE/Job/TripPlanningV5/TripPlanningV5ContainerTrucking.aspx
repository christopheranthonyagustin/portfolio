<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV5ContainerTrucking.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV5.TripPlanningV5ContainerTrucking" %>
...
<head id="Head1" runat="server">
    <title>Trip Planning V5 Container Trucking</title>
    <base target="_self" />
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel">
                        <ContentTemplate>
                            ...
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" Width="700px"
                                ...
                                <HeaderStyle Wrap="false"></HeaderStyle>
                                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" CommandItemDisplay="Top" Name="IncentiveAdd" EditMode="InPlace" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
