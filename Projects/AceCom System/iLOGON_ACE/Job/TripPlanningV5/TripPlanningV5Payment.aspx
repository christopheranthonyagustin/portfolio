<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV5Payment.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV5.TripPlanningV5Payment" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>
                            ...
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false"
                                ...
                                <HeaderStyle Wrap="false"></HeaderStyle>
                                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ID" CommandItemDisplay="Top" Name="CBAdd" EditMode="InPlace" HorizontalAlign="Center" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Cjob" HeaderText="Cjob">
                                            <HeaderTemplate>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblContainerNo" runat="server" Text="ContainerNo" Width="150px" Style="text-align: center" CssClass="RGridHeader_CUSTOM"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblJobNo" runat="server" Text="JobNo" Width="150px" Style="text-align: center" CssClass="RGridHeader_CUSTOM"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblVeh" runat="server" Text="Vehicle" Width="150px" Style="text-align: center" CssClass="RGridHeader_CUSTOM"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblPer" runat="server" Text="Driver" Width="150px" Style="text-align: center" CssClass="RGridHeader_CUSTOM"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </HeaderTemplate>
