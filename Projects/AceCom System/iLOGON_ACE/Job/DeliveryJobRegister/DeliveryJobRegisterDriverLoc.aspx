<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryJobRegisterDriverLoc.aspx.cs" Inherits="iWMS.Web.Job.DeliveryJobRegister.DeliveryJobRegisterDriverLoc" %>
        ...
        <script type="text/javascript">
		    ...
		    <%}%>
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var image = "DeliveryJobRegisterMapPointsMakeThumbNail.aspx?file=" + markers[i][3];
