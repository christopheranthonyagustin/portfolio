<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryJobRegisterQueue.aspx.cs" Inherits="iWMS.Web.Job.DeliveryJobRegister.DeliveryJobRegisterQueue" %>
...
<head runat="server">
    <title>DeliveryJobRegisterQueue</title>
...
<%--                    <td>
                        <asp:ComboBox ID="PartnerCBB" runat="server" CssClas=""
                    </td>--%>
                    <td>
                        <br />
                        ...
                        &nbsp;
                        <asp:Button ID="PODCollectedBtn" runat="server" CssClass="white" OnClick="PODCollectedBtn_Click" 
                ...
                <tr>
                    <td>
                        ...
                        <asp:Button ID="CreateNewBtn" runat="server" CssClass="LongLabelWhite" Text="&nbsp;&nbsp;&nbsp;&nbsp;New&nbsp;&nbsp;&nbsp;&nbsp; Booking" OnClick="CreateNewBtn_Click"
                            OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        &nbsp;
                        <asp:Button ID="EditBtn" runat="server" Cssclass="LongLabelWhite" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Booking" OnClick="EditBtn_Click"
                            OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>
                        &nbsp;
                        ...
                        &nbsp;
                         <asp:Button ID="MassUpdateBookingsBtn" CssClass="LongLabelWhite" runat="server" OnClick="MassUpdateBookingsBtn_Click"
                             Text="Mass Update Bookings" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Visible="false" />
                        &nbsp;
                       ...
                       &nbsp;
                        <asp:Button ID="RecurringBtn" runat="server" CssClass="LongLabelWhite" OnClick="RecurringBtn_Click"
                            Text="Recurring Booking" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        &nbsp;
                        ...
                        &nbsp;
                         <!-- <asp:Button ID="MapPointsBtn" runat="server" CssClass="LongLabelWhite" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Map&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Points" OnClick="MapPointsBtn_Click"
                            OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        &nbsp;
                        <asp:Button ID="ManageWaveBtn" CssClass="LongLabelWhite" runat="server" OnClick="ManageWaveBtn_Click"
                            Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Wave" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>
                        &nbsp;
                        <asp:Button ID="ReleasePickPlanBtn" CssClass="LongLabelGreen" runat="server" OnClick="ReleasePickPlanBtn_Click"  Enabled="false"
                            Text="&nbsp;&nbsp;&nbsp;Release&nbsp;&nbsp;&nbsp; Pick Plan" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        ...
                        <asp:Label ID="LesserInfoChkLbl" runat="server" CssClass="LessInfoPosition" Font-Bold="true" Text="LessInfo" ForeColor="Black"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
