<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryJobRegisterMenu.aspx.cs" Inherits="iWMS.Web.Job.DeliveryJobRegister.DeliveryJobRegisterMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Delivery Job Register</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <asp:Label ID="Label1" Style="color: Black; font-size: medium; font-weight: bold" runat="server">Delivery Job Register&nbsp;&nbsp;</asp:Label>
                </td>
