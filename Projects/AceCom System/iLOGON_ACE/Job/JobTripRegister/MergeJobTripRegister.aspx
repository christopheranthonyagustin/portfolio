<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MergeJobTripRegister.aspx.cs" Inherits="iWMS.Web.Job.JobTripRegister.MergeJobTripRegister" %>
...
<head runat="server">
    <title>MergeJobTripRegister</title>
    <base target="_self" />
        ...
        <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">            
            <tr>
                <td>
                    ...
                    <br />
                    &nbsp;&nbsp;                   
                     <asp:Button ID="OkayBtn" runat="server" Text=" Okay " OnClick="OkayBtn_Click"></asp:Button>                   
                </td>
            </tr>
        </table>
