<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkshopOrderCancel.aspx.cs" Inherits="iWMS.Web.Job.WorkshopOrder.WorkshopOrderCancel" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Workshop Order Cancel</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            <tr>
                <td>
                    <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Workshop Order Cancellation</asp:Label>
                </td>
            </tr>
        </table>
