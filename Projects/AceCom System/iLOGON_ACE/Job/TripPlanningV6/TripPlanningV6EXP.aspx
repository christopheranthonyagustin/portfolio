<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6EXP.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6EXP" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TripPlanningV6EXP</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <asp:UpdatePanel ID="OuterUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" Height="80%"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                        HeaderStyle-HorizontalAlign="Center" CommandItemDisplay="Top" EditMode="Batch" TableLayout="Auto">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Left">
                                <HeaderTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Ready" ItemStyle-HorizontalAlign="Center" DataField="ReadyDone" HeaderText="Ready"
                                SortExpression="ReadyDone" AllowFiltering="false" HeaderStyle-Width="55px" ItemStyle-Width="55px">
                                <ItemTemplate>
                                    <asp:Label ID="ReadyDoneLbl" runat="server"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="ESN" ItemStyle-HorizontalAlign="Center" DataField="ESNDone" HeaderText="ESN" SortExpression="ESNDone" AllowFiltering="false" HeaderStyle-Width="45px" ItemStyle-Width="45px">
                                <ItemTemplate>
                                    <asp:Label ID="ESNLbl" runat="server"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="ReadyDate" HeaderText="ReadyDate" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="88px" HeaderStyle-Width="88px"
                                SortExpression="ReadyDate" AllowSorting="true" AllowFiltering="false" AutoPostBackOnFilter="true" DataField="ReadyDate">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ReadyDate", "{0:dd/MMM HH:mm }")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="JobNo/Account/BookingNo" DataField="JobAcBookingNo" HeaderStyle-Width="135px" ItemStyle-Width="135px" ItemStyle-HorizontalAlign="Center"
                                HeaderText="JobNo <br/> Account <br/> BookingNo <br> PortnetNo <br/> EndCustomer" SortExpression="AcCode" AutoPostBackOnFilter="true">
                                <ItemTemplate>
                                    <%# string.Format("{0:}",  Eval("JobAcBookingNo")) %>
                                    <br />
                                    <%# string.Format("{0:}",  Eval("EndCustomer")) %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridTemplateColumn UniqueName="ETA/Vessel/Voyage" HeaderText="ETA <br/> Vessel <br/> Voyage" DataField="ETAVesselVoyage" HeaderStyle-Width="135px" ItemStyle-Width="135px"
                                SortExpression="INETA" AutoPostBackOnFilter="true" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ETA/Countdown" HeaderText="ETA<br/>Count<br/>down" DataField="ETACountdown" ItemStyle-HorizontalAlign="Center"
                                SortExpression="ETACountdown" AllowFiltering="false" HeaderStyle-Width="135px" ItemStyle-Width="135px">
                            ...
                            <telerik:GridTemplateColumn UniqueName="ContainerNo/SealNo" HeaderText="ContainerNo <br/> SealNo" DataField="ContainerNoSealNo"
                                SortExpression="ContainerNo" AutoPostBackOnFilter="true" HeaderStyle-Width="105px" ItemStyle-Width="105px" FilterControlWidth="60px">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <telerik:RadTextBox runat="server" ID="ContainerNoTxt" TextMode="SingleLine" Width="98px" Style="text-transform: uppercase">
                                    </telerik:RadTextBox>
                                    <br />
                                    <br />
                                    <telerik:RadTextBox runat="server" ID="SealNoTxt" TextMode="SingleLine" Width="98px" Style="text-transform: uppercase">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="VGM" HeaderText="VGM" ItemStyle-HorizontalAlign="Center"
                                SortExpression="VerifiedGrossMass" AllowFiltering="false" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                                <ItemTemplate>
                                    <%# String.IsNullOrEmpty(Eval("VerifiedGrossMass").ToString()) ? "" : String.Format("{0:F2}", Convert.ToDouble(Eval("VerifiedGrossMass").ToString())) %>
                                    </br>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadTextBox runat="server" ID="VGMTxt" TextMode="SingleLine" Width="70px">
                                    </telerik:RadTextBox>
                                    <asp:CompareValidator ID="VGMCompVal" runat="server" ControlToValidate="VGMTxt" ForeColor="Red"
                            ...
                            <telerik:GridTemplateColumn UniqueName="Vehicle/Driver/Trailer" HeaderText="Vehicle <br/> Driver<br/> TrailerPark<br/> TrailerNo" ItemStyle-HorizontalAlign="Center"
                                SortExpression="VehNoDriverTrailer" AllowFiltering="true" AutoPostBackOnFilter="true" ItemStyle-Width="155px" HeaderStyle-Width="155px" DataField="VehicleDriverTrailerParkTrailerNo">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="BillSizeType/TripOption/BillOption" HeaderText="BillSizeType <br/> TripOption <br/> BillOption"
                                ...
                                <EditItemTemplate>
                                    <telerik:RadDropDownList ID="BillSizeTypeList" runat="server" Width="140px"
                                        RenderMode="Lightweight" Enabled="false" Skin="WebBlue">
                                    </telerik:RadDropDownList>
                                    <br />
                                    <br />
                                    <telerik:RadDropDownList ID="TripOptionList" runat="server" Width="140px"
                                        RenderMode="Lightweight" OnLoad="TripOptionDDL_Load" Skin="WebBlue">
                                    </telerik:RadDropDownList>
                                    <br />
                                    <br />
                            ...
                            <telerik:GridTemplateColumn UniqueName="PickUp" HeaderText="PickUp" DataField="fraddr" SortExpression="FrServicePtDescr" AllowFiltering="true" AutoPostBackOnFilter="true"
                                HeaderStyle-Width="155px" ItemStyle-Width="155px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <br />
                                    <br />
                                    <telerik:RadTextBox runat="server" ID="FrAddrTxt" Width="140px" TextMode="MultiLine" Enabled="true" Rows="3">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="DropOff" HeaderText="DropOff" DataField="toaddr" SortExpression="ToServicePtDescr" AllowFiltering="true" AutoPostBackOnFilter="true"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <telerik:RadTextBox runat="server" ID="ToAddrTxt" Text='<%# DataBinder.Eval(Container.DataItem, "toaddr") %>'
                                        TextMode="MultiLine" Enabled="true" Rows="3" Width="140px">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="JobSpecialInstruction" HeaderText="JobSpecialInstruction" SortExpression="JobSpecialInstruction"
                                AllowFiltering="false" HeaderStyle-Width="145px" ItemStyle-Width="145px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "JobSpecialInstruction")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="PermitType/PermitNo" HeaderText="PermitType <br/> PermitNo <br/> PermitExpiry Date" HeaderStyle-Width="135px" ItemStyle-Width="135px"
                                SortExpression="PermitTypePermitNoPermitExpiryDate" AllowFiltering="false" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "PermitTypePermitNoPermitExpiryDate")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="InternalDocNo/OutsourceDocNo" HeaderText="InternalDocNo <br/> OutsourceDocNo"
                                SortExpression="InternalDocNo" AllowFiltering="false" HeaderStyle-Width="135px" ItemStyle-Width="135px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="TripSpecialInstruction" HeaderText="TripSpecialInstruction" SortExpression="TripSpecialInstruction"
                                ...
                                <EditItemTemplate>
                                    <telerik:RadTextBox runat="server" ID="TripSpecialInstructionTxt" Width="130px" TextMode="MultiLine" Rows="3"></telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn UniqueName="TripTypeDoubleStatus" HeaderText="TripType <br/> Double <br/> Status" SortExpression="TripTypeDoubleStatus"
                                AllowFiltering="false" HeaderStyle-Width="85px" ItemStyle-Width="85px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                            ...
                            <telerik:GridBoundColumn DataField="JBTripId" UniqueName="JBTripId" Display="False"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="JBCTNRId" UniqueName="JBCTNRId" Display="False"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ESNDone" UniqueName="ESNV" Display="False"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PregateDone" UniqueName="PregateV" Display="False"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ReadyDone" UniqueName="ReadyV" Display="False"></telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="ETACountdownColour" Display="False" />
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV6EXP.aspx/CheckUsedTrailerNo',
