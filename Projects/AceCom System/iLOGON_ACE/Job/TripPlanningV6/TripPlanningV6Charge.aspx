<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6Charge.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6Charge" %>
...
<head id="Head1" runat="server">
    <title>Trip Planning V6 Charge</title>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="chargeid" HeaderText="Charge">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="ChargeCombo" runat="server"
                                                    ...
                                                    DataTextField="ChargeCode" DataValueField="Id" RenderMode="Lightweight" Filter="Contains"
                                                ...
                                                <asp:TextBox ID="ChargeId" runat="server" Visible="false" Value='<%# DataBinder.Eval(Container.DataItem, "chargeid") %>' />
