<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6CE.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6CE" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>TripPlanningV6CE</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab id="TripQueueTab" Text="TripQueue" Value="550" runat="server">
                </telerik:RadTab>
                ...
                <telerik:RadTab id="NonContainerizedTab" Text="Non-Containerized" Value="750" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
                    ...
                    <tr>
                        <td style="padding-top: 8px; padding-bottom: 4px">
                            ...
                            <asp:Button ID="CompletedBtn" runat="server" CssClass="white" OnClick="CompletedBtn_Click"
                                Text="Complete" OnClientClick="disableBtn(this.id);saveChangesToGrid()" UseSubmitBehavior="false" />
                ...
                <asp:UpdatePanel ID="OuterUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="false" Skin="Silk" RenderMode="Lightweight" AllowPaging="true"
                            OnNeedDataSource="ResultDG_NeedDataSource" AllowMultiRowSelection="true" MasterTableView-AllowSorting="true" Height="83%"
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label runat="server" ID="IsContainerNoDuplicatedLbl" />
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="JobNo/Account/BookingNo" DataField="JobAcBookingNoEndCustomerPortnetNo" ItemStyle-HorizontalAlign="Center"
                                        HeaderText="JobNo <br/> Account <br/> BookingNo <br/> EndCustomer <br/> PortnetNo" SortExpression="AcCode" AutoPostBackOnFilter="true" ItemStyle-Width="135px" HeaderStyle-Width="135px">
                                        <ItemTemplate>
                                            <%# string.Format("{0:}",  Eval("JobAcBookingNoEndCustomerPortnetNo")) %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="ETA/Vessel/Voyage" HeaderText="ETA <br/> Vessel <br/> Voyage" DataField="ETAVesselVoyage" ItemStyle-HorizontalAlign="Center"
                                        SortExpression="INETA" AutoPostBackOnFilter="true" ItemStyle-Width="120px" HeaderStyle-Width="120px" FilterControlWidth="75px">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="Shipper" HeaderText="Shipper" DataField="Shipper" ItemStyle-Width="110px" HeaderStyle-Width="110px"
                                        ItemStyle-HorizontalAlign="Center" SortExpression="Shipper" AutoPostBackOnFilter="true" FilterControlWidth="65px">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridBoundColumn DataField="IsContainerNoDuplicated" Display="False" />
                                    <telerik:GridBoundColumn DataField="ContainerNoInJobNo" Display="False" />
            ...
            <telerik:RadPageView runat="server" Height="94%" ID="EXPRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="IMPRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="RERadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="RRERadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="OthersRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="SDRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="JobSchedulingRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="TripQueueRadPageView" ContentUrl="TripPlanningV6TripQueue.aspx" />
            <telerik:RadPageView runat="server" Height="94%" ID="CompletedRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="ContainerSearchRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="AllTripRadPageView" />
            <telerik:RadPageView runat="server" Height="94%" ID="NonContainerizedRadPageView" />
