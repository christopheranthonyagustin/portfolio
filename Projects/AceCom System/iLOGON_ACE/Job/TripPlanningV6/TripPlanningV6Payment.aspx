<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6Payment.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6Payment" %>
...
<head id="Head1" runat="server">
    <title>Trip Planning V6 Payment</title>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>
                            ...
                            <telerik:RadWindow ID="AttcIconRadWindow" runat="server" VisibleOnPageLoad="true" Title="Attc @ TripPlanningV6" Width="800px" Height="600px"
                                NavigateUrl='<%# "TripPlanningV6Attc.aspx?JBId="+ HiddenField.Value %>' Left="100px" Top="20px"
