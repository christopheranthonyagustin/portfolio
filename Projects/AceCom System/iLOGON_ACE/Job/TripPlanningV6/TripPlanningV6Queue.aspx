<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6Queue.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6Queue" %>
                ...
                <asp:UpdatePanel ID="GridUpdatePanel" runat="server">
                    <ContentTemplate>
                        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro"
                            OnItemDataBound="ResultDG_ItemDataBound" OnNeedDataSource="ResultDG_NeedDataSource" OnColumnCreated="ResultDG_ColumnCreated" Height="70%"
                            ...
                            ItemStyle-Wrap="true" OnGridExporting="ResultDG_GridExporting" GridLines="Both"  Width="117%">
                            ...
                            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true" ColumnsReorderMethod="Reorder">
                                ...
                                <Scrolling AllowScroll="true" UseStaticHeaders="true" ScrollHeight="450" FrozenColumnsCount="1"/>
                            </ClientSettings>
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="100" TableLayout="Fixed">
                                <Columns>
                                    <telerik:GridTemplateColumn UniqueName="S/N" HeaderText="S/N" SortExpression="S/N"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="40px" ItemStyle-Width="40px"
