<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6TripQueueOrder.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6TripQueueOrder" %>
                ...
                <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2"
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="CancelBtn" CssClass="white" runat="server" Text="Cancel" CausesValidation="false"
