<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6RRE.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6RRE" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <asp:UpdatePanel ID="OuterUpdatePanel" runat="server">
            <ContentTemplate>
                <%-- Width="185%"--%>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Silk" RenderMode="Lightweight" Height="92.5%"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ReadyDate" HeaderText="ReadyDate <br/> ReadyDateRemarks" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="130px" HeaderStyle-Width="130px"
                                SortExpression="ReadyDateOnly" AllowSorting="true" AllowFiltering="true" AutoPostBackOnFilter="true" DataField="ReadyDateOnly" FilterControlWidth="60px">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ReadyDateFormat", "{0:dd/MMM HH:mm }")%>
                                    <br />
                                    <%# DataBinder.Eval(Container.DataItem, "ReadyDateRemarks")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Vehicle/Driver/Trailer" HeaderText="Vehicle <br/> Driver<br/> TrailerPark<br/> TrailerNo" ItemStyle-HorizontalAlign="Center"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <telerik:RadComboBox ID="TrailerNoList" runat="server" DataTextField="descr" DataValueField="item" RenderMode="Lightweight"
                                        OnLoad="TrailerNoList_Load" HighlightTemplatedItems="true" Skin="WebBlue" Width="140px" EnableLoadOnDemand="true"
                            ...
                            <telerik:GridTemplateColumn UniqueName="ContainerNo/SealNo" HeaderText="ContainerNo <br/> SealNo" ItemStyle-Width="120px" HeaderStyle-Width="120px"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <br />
                                    <br />
                                    <telerik:RadTextBox runat="server" ID="SealNoTxt" TextMode="SingleLine" Width="110px" Style="text-transform: uppercase">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ETA/Vessel/Voyage" HeaderText="ETA <br/> Vessel <br/> Voyage" DataField="ETAVesselVoyage" ItemStyle-HorizontalAlign="Center" SortExpression="INETA" AutoPostBackOnFilter="true" ItemStyle-Width="135px" HeaderStyle-Width="135px">
                                <ItemTemplate>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV6RRE.aspx/CheckUsedTrailerNo',
