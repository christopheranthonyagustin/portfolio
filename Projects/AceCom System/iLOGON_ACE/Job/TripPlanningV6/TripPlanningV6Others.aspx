<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6Others.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6Others" %>
...
<html>
<head runat="server">
    <title>TripPlanningV6Others</title>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="ExpDate" HeaderText="RequiredDate" ItemStyle-HorizontalAlign="Center" AllowFiltering="true"
                                SortExpression="ExpDateOnly" AllowSorting="true" HeaderStyle-Width="155px" ItemStyle-Width="155px"
                                AutoPostBackOnFilter="true" DataField="ExpDateOnly">
                                <ItemTemplate>
            ...
            <script type="text/javascript">
                ...
                function TrailerNoList_ClientDropDownClosed(sender, args) {
                    ...
                    if (TrailerNo != null && TrailerNo != "") {
                        $.ajax({
                            url: 'TripPlanningV6Others.aspx/CheckUsedTrailerNo',
