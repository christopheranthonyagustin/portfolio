<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripPlanningV6ContainerTrucking.aspx.cs" Inherits="iWMS.Web.Job.TripPlanningV6.TripPlanningV6ContainerTrucking" %>
...
<head id="Head1" runat="server">
    <title>Trip Planning V6 Container Trucking</title>
    <base target="_self" />
                ...
                <td>
                    <asp:Panel ID="ChkPanel" runat="server">
                        ...
                        <table style="margin-left: 190px;">
                            <tr>
                                <td>
                                    <asp:CheckBox ID="FreeStorageExpToAllChkBox" runat="server" />
                                    <asp:Label ID="FreeStorageExpToAllLbl" runat="server" Font-Bold="true" Width="400px" Font-Size="Small" ForeColor="Black"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel">
                        <ContentTemplate>
                            ...
                            <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                AllowPaging="false" Skin="Metro" OnNeedDataSource="ResultDG1_NeedDataSource" Width="50%">
