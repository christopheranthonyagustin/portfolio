<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderContainerDetail.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderContainerDetail" %>
...
<html>
<head runat="server">
    <title>TMS Booking Order Container Detail</title>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" OnNeedDataSource="ResultDG_NeedDataSource"
                    OnItemDataBound="ResultDG_ItemDataBound" AllowSorting="true" Skin="Office2007">
