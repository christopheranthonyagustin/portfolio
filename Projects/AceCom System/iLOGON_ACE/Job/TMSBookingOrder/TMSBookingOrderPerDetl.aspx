<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderPerDetl.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderPerDetl" %>
...
<html>
<head runat="server">
    <title>TMSBookingOrderPerDetl</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
            <tr>
                <td>&nbsp;<asp:Label ID="AtvtLbl" runat="server" CssClass="pagetitle"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="height: 20px">
                    <asp:Button ID="SaveBtn" runat="server" Text="Add" CssClass="white" OnClick="SaveBtn_Click"
