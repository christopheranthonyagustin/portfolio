<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderPayableAdd.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderPayableAdd" %>
...
<head id="Head1" runat="server">
    <title>TMS Booking Order Payable Add</title>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                AllowSorting="true" AllowFilteringByColumn="false" EnableLinqExpressions="false" OnItemDataBound="ResultDG_ItemDataBound"
                                AllowPaging="false" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" Width="80%">
