<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDetl.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.QuotationDetl" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="CloseBtn" runat="server" Text="Close" OnClick="CloseBtn_Click" CssClass="white" ToolTip="Close" />
                </td>
            ...
            <telerik:RadGrid ID="JBChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Charge Description" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True" UniqueName="ChargeDescription" AllowFiltering="false">
                            <ItemTemplate>
                                <asp:TextBox ID="ChargeDescrTxt" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "chargedescr") %>' TextMode="MultiLine" Width="400px" Height="80px"></asp:TextBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Remarks" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="RemarksTxt" runat="server" Width="300" TextMode="MultiLine" Height="80px"></asp:TextBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
