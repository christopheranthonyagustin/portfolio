<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderCopy.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderCopy" %>
...
<body onload="javascript:window.focus();">
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            ...
            <tr>
                <td>
                    <asp:RadioButton ID="JobHeader" runat="server" Text="Copy Job Header" GroupName="Job" Checked="true" />
                    <br />
                    <asp:RadioButton ID="JobDetail" runat="server" Text="Copy Job Header With Trip Detail" GroupName="Job" />
                    <br />
                </td>
            </tr>
            <tr>
