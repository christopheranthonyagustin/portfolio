<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderOrder.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderOrder" %>
...
<head id="Head1" runat="server">
    <title>Non-Containerized Trip @ TMS Booking Order</title>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            ...
                                            &nbsp;
                                            <asp:Button ID="CloseWindowBtn" CssClass="LongLabelWhite" runat="server" OnClick="CancelBtn_Click" Text="Close Window" CausesValidation="false"
                                                OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                            &nbsp;
                                            <asp:Button ID="NextItemBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="NextItemBtn_Click" Text="Next" CausesValidation="false"
                                                OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                        </td>
                                    </tr>
                                </table>
