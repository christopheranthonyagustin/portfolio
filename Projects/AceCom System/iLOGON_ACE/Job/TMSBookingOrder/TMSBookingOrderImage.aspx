<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderImage.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderImage" %>
...
<html>
<head runat="server">
    <title>TMSBookinggOrderImage</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" enctype="multipart/form-data" runat="server">
        ...
        <table>
            <tr>
                <td>&nbsp;<asp:Label ID="MassUploadLbl" runat="server" CssClass="pagetitle"></asp:Label>
                </td>
            </tr>
        </table>
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td><br />&nbsp;
                    ...
                    <asp:Button ID="PrevItemBtn" runat="server" Text="Prev" CssClass="white" BackColor="Pink" OnClick="PrevItemBtn_Click" Visible="True"
                        OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" CausesValidation="false" />&nbsp;
                    <asp:Button ID="NextItemBtn" runat="server" Text="Next" CssClass="white" BackColor="Pink" OnClick="NextItemBtn_Click" Visible="True"
                        OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" CausesValidation="false" />&nbsp;
                    ...
                    <asp:DataList ID="ImageDataList" runat="server" RepeatColumns="0" DataKeyField="id"
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadDropDownList ID="ImageTypeDDL" runat="server" Skin="WebBlue"
                                            DataValueField="item" DataTextField="descr" DataSource='<%# ImageTypeDS%>' Width="155">
                                        </telerik:RadDropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <asp:Label ID="ImageIdLbl" runat="server" Text='<%# Eval("id") %>' Visible="false" />
                                </tr>
                            </table>
                        </ItemTemplate>
