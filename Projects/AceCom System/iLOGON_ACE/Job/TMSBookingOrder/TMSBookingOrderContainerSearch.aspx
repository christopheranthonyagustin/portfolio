<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMSBookingOrderContainerSearch.aspx.cs" Inherits="iWMS.Web.Job.TMSBookingOrder.TMSBookingOrderContainerSearch" %>
...
<html>
<head runat="server">
    <title>TMSBookingOrderContainerSearch</title>
                                    ...
                                    <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" AllowFilteringByColumn="true"
                                        ...
                                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBCTNRId" Name="ParentGrid" PageSize="50" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="JobNo" UniqueName="JobNo" SortExpression="JobNo" HeaderText="JobNo" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn DataField="BillSizeType" UniqueName="BillSizeType" SortExpression="BillSizeType" HeaderText="BillSizeType" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Vessel" UniqueName="Vessel" SortExpression="Vessel" HeaderText="Vessel" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Voyage" UniqueName="Voyage" SortExpression="Voyage" HeaderText="Voyage" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="ETA" UniqueName="ETA" SortExpression="ETA" HeaderText="ETA" ReadOnly="true" DataFormatString="{0:dd/MMM/yyyy}" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridTemplateColumn UniqueName="WarehouseAddress" HeaderText="WarehouseAddress" SortExpression="WarehouseAddress" AllowFiltering="false" ItemStyle-Width="160px"
                                                ...
                                                <telerik:GridBoundColumn DataField="Released" UniqueName="Released" SortExpression="Released" HeaderText="Released" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Discharged" UniqueName="Discharged" SortExpression="Discharged" HeaderText="Discharged" ReadOnly="true" AllowFiltering="false">
                                                </telerik:GridBoundColumn>
