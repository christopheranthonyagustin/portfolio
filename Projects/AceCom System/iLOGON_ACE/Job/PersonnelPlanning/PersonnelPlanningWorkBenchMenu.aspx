...
<%@ Page Language="c#" CodeBehind="PersonnelPlanningWorkBenchMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.PersonnelPlanning.PersonnelPlanningWorkBenchMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="MenuLbl" runat="server">Personnel Workbench</asp:Label>
                </td>
            </tr>
        </table>
    </form>
