<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingOrderUndoBill.aspx.cs" Inherits="iWMS.Web.Job.BookingOrder.BookingOrderUndoBill" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            OnItemDataBound="ResultDG_ItemDataBound" MasterTableView-AllowFilteringByColumn="false">
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="DRId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
