<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingOrderTripUpdate.aspx.cs" Inherits="iWMS.Web.Job.BookingOrder.BookingOrderTripUpdate" %>
...
<head id="Head1" runat="server">
    <title>Booking Order Trip Update</title>
    <base target="_self" />
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel">
                        <ContentTemplate>
                            ...
                            <telerik:RadGrid ID="IncentiveResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                AllowPaging="false" Skin="Metro" OnNeedDataSource="IncentiveResultDG_NeedDataSource" Width="50%">
