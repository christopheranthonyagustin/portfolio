<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingOrderAdd.aspx.cs" Inherits="iWMS.Web.Job.BookingOrder.BookingOrderAdd" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ConfirmCotainerNoCheckingCallbackFn(arg) {
                if (arg) // User clicked OK Button in RadConfirm
                {
                    __doPostBack("<%=ConfirmCheckContainerBtn.UniqueID %>", "");
                }
            }
            function ConfirmBookingRefCheckingCallbackFn(arg) {
                if (arg) // User clicked OK Button in RadConfirm
                {
                    __doPostBack("<%=ConfirmCheckBookingRefBtn.UniqueID %>", "");
                }
            }
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="RadPageView1">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Button ID="ConfirmCheckBookingRefBtn" Text="" Style="display: none;" OnClick="ConfirmCheckBookingRefBtn_Click" runat="server" /><%--Set Hidden button for changing from TT-popup to RadConfirm--%>
                        </td>
                        <td>
                            <asp:Button ID="ConfirmCheckContainerBtn" Text="" Style="display: none;" OnClick="ConfirmCheckContainerBtn_Click" runat="server" /><%--Set Hidden button for changing from TT-popup to RadConfirm--%>
                        </td>
                    </tr>
                </table>
            </telerik:RadPageView>
