<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrossDockContainer.aspx.cs" Inherits="iWMS.Web.Job.BookingOrder.CrossDockContainer" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" OnNeedDataSource="ResultDG_NeedDataSource"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="jbctnrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
