<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARPostingMenu.aspx.cs"
    Inherits="iWMS.Web.Job.ARPosting.ARPostingMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <%--<div class="rounded-box1" style="background-color: #cc0000; width: 90%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        font-size: 10pt; font-weight: bold; padding-top: 3px; left: 3px; top: 0px; width: 300px; margin-left: auto; margin-right: auto; text-align: left;">--%>
                        <asp:Label ID="BI_Lbl" runat="server"></asp:Label><%--</div>--%>
