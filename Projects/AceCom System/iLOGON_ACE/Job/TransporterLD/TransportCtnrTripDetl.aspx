...
<%@ Page Language="c#" CodeBehind="TransportCtnrTripDetl.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.TransporterLD.TransportCtnrTripDetl" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <asp:Button ID="MassDetourBtn" runat="server" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"
                    ...
                    &nbsp;
                <asp:Button ID="OfferBtn" runat="server" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"
                    OnClick="OfferBtn_Click" Text="Offer" />
                    &nbsp;                          
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                        <telerik:RadPageView runat="server" Height="700px" ID="TripGridRadPageView">
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" AllowFilteringByColumn="true">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn HeaderText="OfferStatus" DataField="offerstatusdescr" AllowFiltering="true"
                                            ColumnGroupName="offerstatusdescr" SortExpression="offerstatusdescr" UniqueName="offerstatusdescr"
                                            Reorderable="true">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn HeaderText="OfferRemarks" DataField="OfferRemarks" AllowFiltering="false"
                                            ColumnGroupName="OfferRemarks" SortExpression="OfferRemarks" UniqueName="OfferRemarks"
                                            Reorderable="true">
                                        </telerik:GridBoundColumn>
