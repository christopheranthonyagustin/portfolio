<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackInstruction.aspx.cs" Inherits="iWMS.Web.Job.TransporterLD.PackInstruction" %>
...
<%--        <telerik:RadButton Style="z-index: 0" ID="UpdateFormBtn" runat="server" CssClass="detailButton" Text="Update" 
        ...
        <asp:Button ID="UpdateFormBtn" runat="server" CssClass="white" Text="Update" OnClick="UpdateBtn_Click" OnClientClick="if (!Page_ClientValidate()){ return false; } this.disabled = true; this.value = 'Processing...';" UseSubmitBehavior="false" />
