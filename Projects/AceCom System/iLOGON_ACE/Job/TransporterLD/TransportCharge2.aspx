<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportCharge2.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterLD.TransportCharge2" %>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        <td align="left">
                            ...
                            &nbsp;
                            <asp:Button ID="GenerateBtn" CssClass="white" runat="server" CausesValidation="false"
                                OnClick="GenerateBtn_Click" Text="Generate" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                            &nbsp;
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="SeqNo" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="SeqNoTxt" runat="server" Width="50" Text='<%# DataBinder.Eval(Container.DataItem, "sno") %>'></asp:TextBox>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="chargeaccode" runat="server" ReadOnly="true" Width="200" Text='<%# DataBinder.Eval(Container.DataItem, "ChargeAcCode") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <telerik:RadDatePicker ID="FrExpTxt" Width="110px" runat="server" DateInput-DateFormat="dd/MMM/yyyy" DateInput-EmptyMessage="Date"
                                                    DateInput-DisplayDateFormat="dd/MMM/yyyy" Skin="Office2007" Visible="false">
                                                    <Calendar>
                                                        <SpecialDays>
                                                ...
                                                <telerik:RadTextBox ID="FrTimeTxt" Width="65px" runat="server" Visible="false" EmptyMessage="Start" Text='<%# DataBinder.Eval(Container.DataItem, "frtime") %>'></telerik:RadTextBox>
                                                <telerik:RadTextBox ID="ToTimeTxt" Width="65px" runat="server" Visible="false" EmptyMessage="End" Text='<%# DataBinder.Eval(Container.DataItem, "totime") %>'></telerik:RadTextBox>
                                                <telerik:RadTextBox ID="VehnoTxt" Width="70px" runat="server" Visible="false" EmptyMessage="VehNo" Text='<%# DataBinder.Eval(Container.DataItem, "jbchargevehno") %>'></telerik:RadTextBox>
                                                <telerik:RadTextBox ID="donoTxt" Width="70px" runat="server" Visible="false" EmptyMessage="DONo" Text='<%# DataBinder.Eval(Container.DataItem, "dono") %>'></telerik:RadTextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ExchRate" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="ExchRateTxt" runat="server" Width="60" Text='<%# DataBinder.Eval(Container.DataItem, "exchrate", "{0:#,0.00}") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="VehNo" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <telerik:RadComboBox ID="VehNoDDL" runat="server" DataSource='<%# VehNoDS%>' DataTextField="Descr"
                                                    ...
                                                    SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(VehNoDS,DataBinder.Eval(Container.DataItem, "crossvehno").ToString())%>' />
                                                <br />
                                                <br />
