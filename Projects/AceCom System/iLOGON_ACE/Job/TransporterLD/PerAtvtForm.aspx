<%@ Page Language="c#" CodeBehind="PerAtvtForm.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.TransporterLD.PerAtvtForm" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="10">
             ...
             <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="frexpdate" SortExpression="frexpdate" HeaderText="frexpdate"
                        ItemStyle-Wrap="False" Display="false" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="toexpdate" SortExpression="toexpdate" HeaderText="toexpdate"
                        ItemStyle-Wrap="False" Display="false" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="frexptime" SortExpression="frexptime" HeaderText="frexptime"
                        ItemStyle-Wrap="False" Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="toexptime" SortExpression="toexptime" HeaderText="toexptime"
                        ItemStyle-Wrap="False" Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="fractdate" SortExpression="fractdate" HeaderText="fractdate"
                        ItemStyle-Wrap="False" Display="false" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="toactdate" SortExpression="toactdate" HeaderText="toactdate"
                        ItemStyle-Wrap="False" Display="false" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>                    
                    <telerik:GridBoundColumn DataField="tothours" SortExpression="tothours" HeaderText="tothours"
                        ItemStyle-Wrap="False" Display="false">
                    </telerik:GridBoundColumn>
