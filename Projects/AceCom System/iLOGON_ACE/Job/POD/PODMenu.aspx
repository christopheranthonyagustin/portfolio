...
<%@ Page Language="c#" CodeBehind="PODMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.POD.PODMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 60%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        font-size: 10pt; font-weight: bold; padding-top: 3px; left: 1px; top: 0px; width: 200px;">
                        <asp:Label ID="MenuLbl" runat="server">POD</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
