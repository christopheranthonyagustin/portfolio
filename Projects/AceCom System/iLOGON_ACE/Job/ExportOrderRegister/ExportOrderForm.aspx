<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportOrderForm.aspx.cs" Inherits="iWMS.Web.Job.ExportOrderRegister.ExportOrderForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                <br />
                &nbsp;
                <asp:Button ID="UpdateBtn" runat="server" CssClass="white" Text="Update" OnClick="UpdateBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                &nbsp;
                <asp:Button ID="SMSBtn" runat="server" CssClass="white" Text="SMS" OnClick="SMSBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />

                <iWMS:iForm ID="formCtl" runat="server"></iWMS:iForm>
                <br />    
                <asp:Button ID="AssignBtn" runat="server" CssClass="white" Text="Assign" OnClick="AssignBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" Visible="false" />
                &nbsp;&nbsp;
                <asp:Button ID="CompleteBtn" runat="server" CssClass="white" Text="Complete" OnClick="CompleteBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" Visible="false" />
                &nbsp;&nbsp;
                <asp:Button ID="DeliveryBtn" runat="server" CssClass="white" Text="Delivery" OnClick="DeliveryBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                &nbsp;&nbsp;
                <asp:Button ID="CollectionBtn" runat="server" CssClass="white" Text="Collection" OnClick="CollectionBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                &nbsp;&nbsp;
                <asp:Button ID="AddBoxBtn" runat="server" CssClass="white" Text="AddBox " OnClick="AddBoxBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                &nbsp;&nbsp;
                <asp:Button ID="TransferBoxBtn" runat="server" CssClass="white" Text="TransferBox" OnClick="TransferBoxBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                  &nbsp;&nbsp;
                <asp:Button ID="CancelBtn" runat="server" CssClass="white" Text="Cancel" OnClick="CancelBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
				&nbsp;&nbsp;
                <asp:Button ID="SelfCollectionBtn" runat="server" CssClass="white" Text="SelfCollect" OnClick="SelfCollectionBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
				&nbsp;&nbsp;
                <asp:Button ID="AssignBoxBtn" runat="server" CssClass="white" Text="AssignBox" OnClick="AssignBoxBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                &nbsp;&nbsp;
                <asp:Button ID="CollectBoxBtn" runat="server" CssClass="white" Text="AirParcel" OnClick="CollectBoxBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                <br />
                <br />
                ...
                <asp:Panel ID="SKUTileListPanel" runat="server">
                    ...
                    <div style="display: none">
                        <asp:Button ID="AddJBCtnrItemBtn" runat="server" CssClass="white" Text="AddJBCtnrItem" OnClick="AddJBCtnrItemBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn SortExpression="skudescr" UniqueName="skudescr" HeaderText="BoxSize">
                                ...
                                <EditItemTemplate>
                                    <telerik:RadDropDownList ID="BoxSizeTxt" runat="server" Skin="WebBlue" DataSource='<%# SKUDS %>' DataTextField="descr" DataValueField="id" ExpandDirection="Up"
