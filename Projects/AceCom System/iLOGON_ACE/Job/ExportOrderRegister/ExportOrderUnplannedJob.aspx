<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportOrderUnplannedJob.aspx.cs" Inherits="iWMS.Web.Job.ExportOrderRegister.ExportOrderUnplannedJob" %>
...
<html>
<head runat="server">
    <title>ExportOrderUnplannedJob</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Button ID="SearchBtn" runat="server" CssClass="white" OnClick="SearchBtn_Click" Text="Search" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
        <br />
        <br />
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                <telerik:RadGrid ID="ResultDg" runat="server" AutoGenerateColumns="false" GridLines="None"
                    AllowSorting="true" AllowFilteringByColumn="true" EnableLinqExpressions="false" OnNeedDataSource="ResultDg_NeedDataSource"
                    AllowPaging="true" Skin="Office2007" Height="1000px" OnItemDataBound="ResultDg_ItemDataBound">
