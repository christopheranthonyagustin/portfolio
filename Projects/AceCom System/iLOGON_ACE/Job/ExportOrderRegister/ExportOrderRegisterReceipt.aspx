<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportOrderRegisterReceipt.aspx.cs" Inherits="iWMS.Web.Job.ExportOrderRegister.ExportOrderRegisterReceipt" %>
...
<html>
<head runat="server">
    <title>ExportOrderRegisterReceipt</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="NewPanel" runat="server">
            ...
            <asp:Button ID="NewBtn" runat="server" CssClass="white" Text="New"
                OnClick="NewBtn_Click" UseSubmitBehavior="false" CausesValidation="false" OnClientClick="disableBtn(this.id)"/>
            &nbsp;
            <asp:Button ID="CancelBtn" runat="server" CssClass="white" Text="Cancel" OnClientClick="disableBtn(this.id)"
                OnClick="Cancel_Click" UseSubmitBehavior="false" CausesValidation="false" />
            &nbsp;
            <asp:Button ID="ReceiptBtn" runat="server" Text="Receipt" OnClick="ReceiptBtn_Click" Width="100px"
                OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" CssClass="blue" />
            &nbsp;
        </asp:Panel>
        <asp:Panel ID="AddPanel" runat="server">
             &nbsp;
            <asp:Button ID="AddBtn" runat="server" CssClass="white" Text="Add" OnClientClick="disableBtn(this.id,true)"
                OnClick="AddBtn_Click" UseSubmitBehavior="false" />
            &nbsp;
             <asp:Button ID="UpdateBtn" runat="server" CssClass="white" Text="Update" OnClientClick="disableBtn(this.id)"
                OnClick="UpdateBtn_Click" UseSubmitBehavior="false" CausesValidation="false" />
            &nbsp;
            <asp:Button ID="CloseBtn" runat="server" CssClass="white" Text="Close" OnClientClick="disableBtn(this.id)"
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                     ...
                     <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="ReceiptEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit" CausesValidation="false"
                                        OnClick="ReceiptEdit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
