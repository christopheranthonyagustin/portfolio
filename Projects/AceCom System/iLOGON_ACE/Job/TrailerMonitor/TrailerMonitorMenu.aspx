<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrailerMonitorMenu.aspx.cs" Inherits="iWMS.Web.Job.TrailerMonitor.TrailerMonitorMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Trailer Monitor</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <asp:Label ID="Label1" Style="color: Black; font-size: medium; font-weight: bold" runat="server">Trailer Monitor&nbsp;&nbsp;</asp:Label>
                </td>
