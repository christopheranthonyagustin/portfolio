<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliverySchedulingWorkbenchMapPlanning.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliverySchedulingWorkbench.DailyDeliverySchedulingWorkbenchMapPlanning" %>
...
<head runat="server">
    <title>MapPlanning @ DailyDeliverySchedulingWorkbench</title>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="FromDateLbl" runat="server" Text="FromDate" />
                    <br />
                ...
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="MPUnAssignBtn" runat="server" CssClass="blue" OnClick="MPUnAssignBtn_Click" Text="UnAssign" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
                <td>
                    &nbsp;
                    <span>Veh no</span>
