<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliverySchedulingWorkbenchOrder.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliverySchedulingWorkbench.DailyDeliverySchedulingWorkbenchOrder" %>
...
<head id="Head1" runat="server">
    <title>Booking @ Daily Delivery Scheduling Workbench</title>
    <base target="_self" />
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel">
                                <ContentTemplate>
                                    ...
                                    <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
                                        ...
                                        AllowPaging="true" Skin="Metro" OnNeedDataSource="ResultDG1_NeedDataSource">
                                        ...
                                        <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                                            ...
                                            <Columns>
                                                <telerik:GridBoundColumn DataField="SKU" UniqueName="SKU" SortExpression="SKU" HeaderText="SKU" HeaderStyle-Width="180px" ItemStyle-Width="180px" />
                                                <telerik:GridBoundColumn DataField="SKUDescription" UniqueName="SKUDescription" SortExpression="SKUDescription" HeaderText="SKUDescription" HeaderStyle-Width="250px" ItemStyle-Width="250px" />
                                                <telerik:GridBoundColumn DataField="ReturnQty" UniqueName="ReturnQty" SortExpression="ReturnQty" HeaderText="ReturnQty" AllowFiltering="false" HeaderStyle-Width="120px" ItemStyle-Width="120px" />
                                                <telerik:GridBoundColumn DataField="InUOM" UniqueName="InUOM" SortExpression="InUOM" HeaderText="InUOM" AllowFiltering="false" HeaderStyle-Width="100px" ItemStyle-Width="100px" />
                                                <telerik:GridBoundColumn DataField="ReturnRemarks" UniqueName="ReturnRemarks" SortExpression="ReturnRemarks" HeaderText="ReturnRemarks" HeaderStyle-Width="250px" ItemStyle-Width="250px" />
                                            </Columns>
                                        </MasterTableView>
                                    </telerik:RadGrid>
