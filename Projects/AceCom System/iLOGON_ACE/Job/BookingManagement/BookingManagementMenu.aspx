<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingManagementMenu.aspx.cs" Inherits="iWMS.Web.Job.BookingManagement.BookingManagementMenu" %>
...
<html>
<head runat="server">
    <title>BookingManagementMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server"> Booking Management</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
