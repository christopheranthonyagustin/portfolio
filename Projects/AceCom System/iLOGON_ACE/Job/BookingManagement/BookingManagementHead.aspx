<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingManagementHead.aspx.cs" Inherits="iWMS.Web.Job.BookingManagement.BookingManagementHead" %>
...
<html>
<head runat="server">
    <title>BookingManagementHead</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        &nbsp;
            <asp:Button ID="PopulateBtn" runat="server" CssClass="white" Text="Populate"
                OnClick="PopulateBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
            <br />        
