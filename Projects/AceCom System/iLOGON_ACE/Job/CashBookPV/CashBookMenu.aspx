...
<%@ Page Language="c#" CodeBehind="CashBookMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.CashBookPV.CashBookMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                ...
                <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Payment Register</asp:Label></div>
            </td>
        </tr>
    </table>
    </form>
