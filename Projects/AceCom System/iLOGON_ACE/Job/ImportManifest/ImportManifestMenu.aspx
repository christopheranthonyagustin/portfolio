<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportManifestMenu.aspx.cs" Inherits="iWMS.Web.Job.ImportManifest.ImportManifestMenu" %>
...
<html>
<head runat="server">
    <title>ImportManifestMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Import Manifest</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
