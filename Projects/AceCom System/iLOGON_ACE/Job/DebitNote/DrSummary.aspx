<%@ Page Language="c#" CodeBehind="DrSummary.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.DebitNote.DrSummary" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    ...
                    <asp:Button ID="QuBtn" runat="server" CssClass="white" Width="150px" OnClick="QuBtnBtn_Click"
