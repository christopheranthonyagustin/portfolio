<%@ Page Language="c#" CodeBehind="InvoiceHead.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.DebitNote.InvoiceHead" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="DrCfmImgBtn" runat="server" Text="Post " OnClick="DrCfmImgBtn_Click"
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CssClass="green" ToolTip="PostInvoice" />
                </td>
                <td>
                ...
                <td>
                    <asp:Button ID="CopyAdhocInvoiceBtn" runat="server" Text="Copy Adhoc Invoice" OnClick="CopyAdhocInvoiceBtn_Click"
                        CssClass="LongLabelWhite" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
                <td>
                ...
                <td>
                    <asp:Button ID="EInvoiceBtn" runat="server" Text="E-Invoice" OnClick="EInvoiceBtn_Click"
                        CssClass="green" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
                <td>
        ...
        <table>
            <tr>
                <td>
                    <telerik:RadMenu ID="RadMenu_MoreFunction" runat="server" ShowToggleHandle="false" ClickToOpen="true" EnableEmbeddedSkins="false" Skin="Default"
                        OnItemClick="RadMenu_MoreFunction_ItemClick" OnClientItemClicked="RadMenuClientOnClick" RenderMode="Lightweight" CssClass="RadMenu_CUSTOM_Blue">
                        <Items>
                            <telerik:RadMenuItem runat="server" Text="More<br/>Function" PostBack="false" Value="MoreFunction">
                                <Items>
                                    <telerik:RadMenuItem ID="InternalBillingId" runat="server" Value="INTERNALBILLING" Text="Internal Billing" />
                                    <telerik:RadMenuItem ID="PaidId" runat="server" Value="PAID" Text="Paid" />
                                    <telerik:RadMenuItem runat="server" Value="PeppolEInvoice" Text="Peppol E-Invoice" />
                                    <telerik:RadMenuItem ID="ReadyForApprovalId" runat="server" Value="READYFORAPPROVAL" Text="Ready for Approval" />
                                    <telerik:RadMenuItem ID="RerouteForApprovalId" runat="server" Value="REROUTEFORAPPROVAL" Text="Reroute for Approval" />
                                </Items>
                            </telerik:RadMenuItem>
                        </Items>
                    </telerik:RadMenu>
                    ...
                    <telerik:RadMenu ID="RadMenu_MorePrintouts" runat="server" ShowToggleHandle="false" ClickToOpen="true" EnableEmbeddedSkins="false" Skin="Default"
                        ...
                        <Items>
                            <telerik:RadMenuItem runat="server" Text="More<br/>Printouts" PostBack="false" Value="MorePrintouts">
                                <Items>
                                    <telerik:RadMenuItem runat="server" Value="ExportInvoice" Text="Export Invoice" />
                                    <telerik:RadMenuItem runat="server" Value="ExportInvoiceCSL" Text="Export Invoice CSL" />
                                    <telerik:RadMenuItem runat="server" Value="InvExportToExcel" Text="Inv Export To Excel" />
                                    <telerik:RadMenuItem runat="server" Value="CSLExportToExcel" Text="CSL Export To Excel" />
                                    <telerik:RadMenuItem runat="server" Value="ExportToExcel" Text="Export To Excel" />
                                    <telerik:RadMenuItem runat="server" Value="InvoiceWorkOrder" Text="Work Order" />
                                </Items>
                            </telerik:RadMenuItem>
                        </Items>
                    </telerik:RadMenu>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ImageButton runat="server" Visible="False" ID="DrCfmLbl" ImageUrl="../../image/interfacedrcfm.png"
                                ...
                                CausesValidation="False"></asp:ImageButton>
                            <asp:ImageButton runat="server" Visible="False" ID="InterLbl" ImageUrl="../../image/internalicon.png"
                                BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="InterDone"
                                CausesValidation="False"></asp:ImageButton>
                    ...
                    <telerik:GridBoundColumn HeaderText="SourceActDate" DataField="SourceActDate" AllowFiltering="true"
                        SortExpression="SourceActDate" UniqueName="SourceActDate" Reorderable="true" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn HeaderText="Status" DataField="statusdescr" AllowFiltering="true"
                     ...
                     <telerik:GridBoundColumn HeaderText="Payment Status" DataField="InvStatusDescr" AllowFiltering="true"
                    ...
                    <telerik:GridBoundColumn DataField="ApprovedDate" SortExpression="ApprovedDate" HeaderText="ApprovedDate"
