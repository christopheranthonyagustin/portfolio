<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobsNotInvoiceGen.aspx.cs"
    Inherits="iWMS.Web.Job.DebitNote.JobsNotInvoiceGen" %>
            ...
            <tr>
                <td>
                    <table style="z-index: 0" id="Table2" border="0" cellspacing="2" cellpadding="2"
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Refresh" runat="server" OnClick="refreshBtn_Click" Text="Refresh" class="white"
                                    OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />&nbsp;
              <asp:Button ID="generateBtn" runat="server" OnClick="generateBtn_Click" UseSubmitBehavior="False"
                  Text="Generate" Visible="false" OnClientClick="disableBtn(this.id,true)" class="white" />&nbsp;
              <asp:Button ID="Resetbtn" runat="server" Text="Reset" Visible="false" OnClick="resetBtn_Click"
                  UseSubmitBehavior="False" OnClientClick="disableBtn(this.id,true)" class="white" />
