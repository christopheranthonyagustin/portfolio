<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderManagementImage.aspx.cs" Inherits="iWMS.Web.Job.OrderManagement.OrderManagementImage" %>
...
<html>
<head runat="server">
    <title>OrderManagementImage</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
            ...
            <tr>
                <td colspan="2">
                    <asp:Panel ID="FileUploadPanel" runat="server">
                        <table border="0" cellspacing="2" cellpadding="2" width="100%" style="margin-left: 9px">
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="RadButton1" runat="server" CssClass="white" OnClick="ImageSubmit_ServerClick"
                                        Text="Upload" UseSubmitBehavior="false" Style="margin-left: 13px" SingleClick="true" SingleClickText="Uploading..."></asp:Button>
                       <%--         <telerik:RadButton ID="ImageSubmit" runat="server" OnClick="ImageSubmit_ServerClick"
                                    Text="Upload" CssClass="white" SingleClick="true" SingleClickText="Uploading..."></telerik:RadButton>--%>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td colspan="2">
                <div class="DropZone1" style="margin-left: 15px;">
                    <p>
                        Drop Files Here
                    </p>
                </div>
