<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VISVehicle.aspx.cs" Inherits="iWMS.Web.Job.VehicleInspectionSchedule.VISVehicle" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="550px" ID="VehicleRadPageView">
                <table>
                    <tr>
                        <td>
