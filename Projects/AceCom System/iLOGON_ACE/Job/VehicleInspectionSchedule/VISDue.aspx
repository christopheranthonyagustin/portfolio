<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VISDue.aspx.cs"
    Inherits="iWMS.Web.Job.VehicleInspectionSchedule.VISDue" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="50%" ID="DueRadPageView">
                <table>
                    <tr>
                        <td>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="ScheduleInspectionBtn" runat="server" CssClass="LongLabelWhite"
                                 OnClick="ScheduleInspectionBtn_Click"
                                Text="Schedule Inspection" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn Display="false" DataField="VehicleNo">
