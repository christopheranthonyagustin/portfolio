<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistanceMatrixMenu.aspx.cs" Inherits="iWMS.Web.Job.DistanceMatrix.DistanceMatrixMenu" %>
...
<head id="Head1" runat="server">
    <title>Distance Matrix Menu</title>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="EmailQueuelbl" runat="server">Distance Matrix</asp:Label>
            </td>
        </tr>
    </table>
    </form>
