<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveriesPlanningMapPoints.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanning.DailyDeliveriesPlanningMapPoints" %>
        ...
        <script type="text/javascript">            
		    ...
		    <%}%>
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var image = "DailyDeliveriesPlanningMapPointsMakeThumbNail.aspx?file=" + markers[i][2];
