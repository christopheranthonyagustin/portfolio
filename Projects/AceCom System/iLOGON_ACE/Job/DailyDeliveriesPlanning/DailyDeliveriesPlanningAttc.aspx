<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveriesPlanningAttc.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanning.DailyDeliveriesPlanningAttc" %>
...
<html>
<head runat="server">
    <title>DailyDeliveriesPlanning Attc</title>
                    ...
                    <asp:Panel ID="FileUploadPanel" runat="server" Style="padding-left: 10px;">
                        <table border="0" cellspacing="2" cellpadding="2" width="100%">
                            <tr>
                                <td>
                                    <br />
                                    <telerik:RadAsyncUpload runat="server" ID="RadAsyncUpload1" RenderMode="Lightweight" st
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    &nbsp;                               
                                    <asp:Button ID="ImageBtn" runat="server" OnClick="ImageSubmit_ServerClick" Text="Upload"
