<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveriesPlanningQuotationDetl.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanning.DailyDeliveriesPlanningQuotationDetl" %>
...
<body>
    <form id="form1" runat="server" defaultbutton="SearchBtn">
        ...
        <br />
        <div id="div-datagrid">
            <telerik:RadGrid ID="JBChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None" Skin="Metro" >
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace" Height="100px" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                    <Columns>
