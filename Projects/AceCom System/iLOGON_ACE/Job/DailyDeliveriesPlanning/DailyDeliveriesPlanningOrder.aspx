<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveriesPlanningOrder.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanning.DailyDeliveriesPlanningOrder" %>
...
<head id="Head1" runat="server">
    <title>Booking @ Daily Deliveries Planning</title>
    <base target="_self" />
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="GeneralTab" Text="General" Value="0" runat="server">
                 ...
                 <telerik:RadTab Id="DeliveryItemsTab" Text="Delivery Items" Value="100" runat="server">
                </telerik:RadTab>
