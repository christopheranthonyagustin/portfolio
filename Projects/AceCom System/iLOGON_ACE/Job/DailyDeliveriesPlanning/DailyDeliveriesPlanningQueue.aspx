<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveriesPlanningQueue.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveriesPlanning.DailyDeliveriesPlanningQueue" %>
...
<head runat="server">
    <title>DailyDeliveriesPlanningQueue</title>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        &nbsp;
                        <asp:Button ID="excelBtn" runat="server" CssClass="green" Text="Export Excel" OnClick="ExportExcel"
