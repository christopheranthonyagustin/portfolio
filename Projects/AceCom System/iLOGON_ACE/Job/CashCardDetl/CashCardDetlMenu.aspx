...
<%@ Page Language="c#" CodeBehind="CashCardDetlMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.CashCardDetl.CashCardDetlMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 80%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="MenuLbl" runat="server">Cash Card Detl</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
