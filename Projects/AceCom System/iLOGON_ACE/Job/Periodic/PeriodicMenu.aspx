...
<%@ Page Language="c#" CodeBehind="PeriodicMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Job.Periodic.PeriodicMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PeriodicMenu</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 60%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="MenuLbl" runat="server">Periodic</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
