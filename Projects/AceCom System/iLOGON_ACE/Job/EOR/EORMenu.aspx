<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EORMenu.aspx.cs" Inherits="iWMS.Web.Job.EOR.EORMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                ...
                <asp:Label ID="EROLbl" labelclass="NewModuleTitle" runat="server"></asp:Label></div>
            </td>
        </tr>
    </table>
    </form>
