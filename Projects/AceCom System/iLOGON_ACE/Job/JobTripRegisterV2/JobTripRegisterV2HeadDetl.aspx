<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTripRegisterV2HeadDetl.aspx.cs" Inherits="iWMS.Web.Job.JobTripRegisterV2.JobTripRegisterV2HeadDetl" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" id="table1" runat="server" width="100%">
            <tr id="TR" runat="server" class="tab">
                <td runat="server" valign="bottom" id="TD" class="style1">
                </td>
                <td class="NewModuleTitle" align="right" valign="bottom" id="TDM">
                    <asp:Label ID="Label1" runat="server">Job Trip Register V2</asp:Label>
                </td>
            </tr>
        </table>
    <br />        
        <table border="0">
            <tr>
                ...
                <td>
                    <asp:Button ID="OpenBtn" class="white" runat="server" OnClick="OpenBtn_Click"
                ...
                <td>
                    <asp:Button ID="CompletedBtn" class="white" runat="server" OnClick="CompletedBtn_Click"
                        Text="Completed" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                    &nbsp;
                </td>
                <td>
                    <asp:Button ID="VoidBtn" class="white" runat="server" OnClick="VoidBtn_Click"
                        Text="Void" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                    &nbsp;
                </td>
                <td>
                    <asp:Button ID="CancelledBtn" class="white" runat="server" OnClick="CancelledBtn_Click"
                ...
                <td>
                    <asp:Button ID="ChangeResourceBtn" class="white" runat="server" OnClick="ChangeResourceBtn_Click"
                        Text="Resource" ToolTip="ChangeResource" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                    &nbsp;
                </td>
                <td>
                    <asp:Button ID="ChangeScheduleBtn" class="white" runat="server" OnClick="ChangeScheduleBtn_Click"
                ...
                <td>
                    <asp:Button ID="RoutePlanBtn" CssClass="white" runat="server" OnClick="RoutePlanBtn_Click"
                        Text="RoutePlan" CausesValidation="False" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                    &nbsp;            
                </td>
            </tr>
        </table>
        ...
        <table border="0">
            <tr>
                <td>
                    <br />
                    <%--<asp:Button ID="PrevBtn" class="white" runat="server" OnClick="PrevBtn_Click"
                        Text="Prev Day" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />--%>
                ...
                <td>
                    <br />
                   <%-- <asp:Button ID="NextBtn" class="white" runat="server" OnClick="NextBtn_Click"
                        Text="Next Day" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />--%>
        ...
        CausesValidation="false" SelectedIndex="0" Skin="Office2007" OnTabClick="RadTabStrip1_TabClick">
             <Tabs>
            <telerik:RadTab Text="Trip" Value="0" readonly="readonly" runat="server">
            </telerik:RadTab>
            <telerik:RadTab Text="Resource" Value="100" runat="server">
            </telerik:RadTab>            
        </Tabs>
        </telerik:RadTabStrip> 
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" OnPreRender="ResultDG_PreRender"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="ActWt" DataField="ActWt" AllowFiltering="true" ItemStyle-CssClass="break-word"
                        ...
                        HeaderStyle-Width="20px" ItemStyle-Width="20px" Display="false">
                        <ItemTemplate>
            ...
            <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
                AllowPaging="false" Skin="Office2007" Visible="false" OnItemDataBound="ResultDG1_ItemDataBound">
            ...
            <telerik:RadGrid ID="ResultDG2" runat="server" AutoGenerateColumns="false" GridLines="None"
                AllowPaging="false" Skin="Office2007" Visible="false" OnItemDataBound="ResultDG2_ItemDataBound">
                <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                    <Selecting AllowRowSelect="true" />
                </ClientSettings>
                <SortingSettings EnableSkinSortStyles="false" />
