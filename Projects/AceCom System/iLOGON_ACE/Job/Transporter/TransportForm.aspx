...
<%@ Page Language="c#" CodeBehind="TransportForm.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Job.Transporter.TransportForm" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0"
    ...
    <table id="table1" border="0" cellspacing="3" cellpadding="3" width="100%" runat="server">
        <tr>
            <td>
                <input id="tab1" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(1, "table1");' value="Header" runat="server">&nbsp;
                <input id="tab2" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(2, "table1");' value="Party" runat="server">
                <input id="tab3" style="width: 80px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(3, "table1");' value="Container" runat="server">
                <input id="tab4" style="width: 80px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(4, "table1");' value="Trip" runat="server">
                <input id="tab5" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(5, "table1");' value="Attc" runat="server">
                <input id="tab6" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(6, "table1");' value="Task" runat="server">
                <input id="tab7" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(7, "table1");' value="Charge" runat="server">
                <input id="tab8" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(8, "table1");' value="Charge2" runat="server">
                <input id="tab9" style="width: 70px; cursor: pointer" class="TabTitle" readonly="true"
                    onclick='clickRow(9, "table1");' value="Cost" runat="server">
            </td>
