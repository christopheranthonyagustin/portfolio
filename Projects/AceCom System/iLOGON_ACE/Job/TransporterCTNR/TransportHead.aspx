<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportHead.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportHead" %>
    ...
    <div id="div-datagrid" style="height: 92%">
        ...
        <asp:DataGrid ID="ResultDG" runat="server" DataKeyField="id" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="type" SortExpression="type" HeaderText="JobType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="permittype" SortExpression="permittype" HeaderText="TptType">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
