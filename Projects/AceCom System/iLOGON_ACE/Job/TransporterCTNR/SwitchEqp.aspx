<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SwitchEqp.aspx.cs" Inherits="iWMS.Web.Job.TransporterCTNR.SwitchEqp" %>
                    ...
                    <tr>
                        <td valign="top" style="width: 35%">
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                OnItemDataBound="ResultDG_ItemDataBound" AllowSorting="true" EnableLinqExpressions="false"
                                Skin="Office2007">
