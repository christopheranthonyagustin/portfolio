<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportCtnrTrip.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportCtnrTrip" %>

<%@ Register TagPrefix="iWMS" TagName="iForm" Src="../../Control/iFormCtl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>TransportCtnrTrip</title>
