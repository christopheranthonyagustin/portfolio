<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportCost.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportCost" %>
...
<body>
    ...
    <br />
    <div id="div-datagrid">
        <asp:DataGrid ID="JBCostDG" runat="server" AutoGenerateColumns="False" GridLines="Both"
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="Currency" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:DropDownList ID="CurrencyList" Enabled="True" DataTextField="code" DataValueField="code"
                            runat="server" DataSource='<%# CurrencyListDS%>' />
                    </ItemTemplate>
                </asp:TemplateColumn>
