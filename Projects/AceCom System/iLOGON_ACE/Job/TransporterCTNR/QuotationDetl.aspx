<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDetl.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.QuotationDetl" %>
        ...
        <tr>
            <td>
                <telerik:RadButton Style="z-index: 0" ID="SearchBtn" runat="server" Text="Search"
                    Skin="WebBlue" OnClick="serachBtn_Click">
                </telerik:RadButton>
                &nbsp;
                <telerik:RadButton Style="z-index: 0" ID="AddBtn" runat="server" Text="Add" Skin="WebBlue"
                    OnClick="AddBtn_Click">
                </telerik:RadButton>
                &nbsp;
                <telerik:RadButton Style="z-index: 0" ID="CloseBtn" runat="server" Text="Close" Skin="WebBlue"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="SeqNo" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="QuDtIdLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "id") %>'
                          ...
                          <telerik:GridTemplateColumn HeaderText="ExistInCharge" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                             <asp:Label ID="ExistInChargeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "InCharge") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-Font-Bold="True" UniqueName="ChargeDescription" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="chargecodeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "chargecode") %>'></asp:Label>
                            </br>
                            <asp:Label ID="chargeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "chargedescr") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
