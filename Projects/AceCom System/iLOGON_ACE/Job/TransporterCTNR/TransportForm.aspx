<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportForm.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportForm" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0"
    ...
    <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
        ...
        <Tabs>
            ...
            <telerik:RadTab Text="ChargeRef" Value="620" runat="server">
            </telerik:RadTab>
    ...
    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage"
        ...
        <telerik:RadPageView runat="server" Height="100%" ID="EximRadPageView">           
        ...
        <telerik:RadPageView runat="server" Height="100%" ID="PartyRadPageView">            
        ...
        <telerik:RadPageView runat="server" Height="71%" ID="ChargeRadPageView" />
        <telerik:RadPageView runat="server" Height="71%" ID="ChargeRefRadPageView" />
    ...
    <ajaxToolkit:ModalPopupExtender ID="mpeMessagePopup" runat="server" PopupControlID="pnlMessageBox"
        ...
        <asp:Button ID="RadUpdate" runat="server" CssClass="white" Visible="false" Text="Update" OnClick="UpdateBtn_Click" AutoPostBack="true" OnClientClick="if (!Page_ClientValidate()){ return false; } this.disabled = true; this.value = 'Processing...';" UseSubmitBehavior="false" />
