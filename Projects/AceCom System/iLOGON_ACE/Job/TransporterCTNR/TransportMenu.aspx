<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportMenu.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>TransportMenu</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #336600; width: 60%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        width: 316px;">
                        <asp:Label ID="MenuLbl" runat="server">Transporter</asp:Label>
                    </div>
                </div>
            </td>
        </tr>
