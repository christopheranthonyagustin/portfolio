<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportCtnrDetl.aspx.cs"
    Inherits="iWMS.Web.Job.TransporterCTNR.TransportCtnrDetl" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <asp:Button ID="TransferEqpBtn" runat="server" CssClass="white" Text="Transfer" OnClick="TransferEqpBtn_Click" OnClientClick="disableBtn(this.id)"
                    ...
                    &nbsp; 
                <asp:Button ID="PrintDOBtn" runat="server" CssClass="blue" Text="PrintDO" OnClick="PrintDOBtn_Click"
                    UseSubmitBehavior="false" OnClientClick="disableBtn(this.id)" />
                    &nbsp; 
                <asp:Button ID="PopFromSpBtn" runat="server" CssClass="green" Text="ShipPlan" OnClick="PopFromSpBtn_Click"
                    UseSubmitBehavior="false" OnClientClick="disableBtn(this.id)" Visible="true" />
                    &nbsp; 
                 <asp:Button ID="switchEqpBtn" runat="server" CssClass="white" Text="SwitchEqp" OnClick="switchBtn_Click"
                     UseSubmitBehavior="false" OnClientClick="disableBtn(this.id)" Visible="false" />
                </td>
                <td>
                    ...
                    <telerik:GridTableView DataKeyNames="id" Name="ChildGrid" Width="100%" SkinID="Telerik"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="FromDate" DataField="frexpdate" AllowFiltering="true"
                                ...
                                HeaderStyle-Width="100px" Reorderable="true" DataFormatString="{0:dd/MMM/yyyy HH:mm}"
                            ...
                            <telerik:GridBoundColumn Display="False" DataField="status" SortExpression="status"
                                HeaderStyle-Width="450px" HeaderText="Status" />
                            <telerik:GridBoundColumn HeaderText="Type" DataField="type" AllowFiltering="true"
                                HeaderStyle-Width="450px" ColumnGroupName="type" SortExpression="type" UniqueName="type"
                            ...
                            <telerik:GridBoundColumn HeaderText="SealNo" DataField="sealno" AllowFiltering="true"
                                HeaderStyle-Width="100px" ColumnGroupName="sealno" SortExpression="sealno" UniqueName="sealno"
                                Reorderable="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn HeaderText="TripOption" DataField="sectordescr" AllowFiltering="true"
                                ColumnGroupName="sectordescr" SortExpression="sectordescr" UniqueName="sector"
                                Reorderable="true" HeaderStyle-HorizontalAlign="Center">
                            </telerik:GridBoundColumn>
