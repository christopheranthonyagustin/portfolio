<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveryServiceMapPlanning.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveryService.DailyDeliveryServiceMapPlanning" %>
...
<head runat="server">
    <title>MapPlanning @ DailyDeliveryService</title>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <br />
                    <asp:Label ID="VehLbl" runat="server">Filter Veh no</asp:Label>
                    <br>
                    <input type="text" runat="server" clientidmode="Static" id="MPFilterVehNoCB_value" style="display: none" />
                    <telerik:RadComboBox ID="MPFilterVehNoCB" runat="server" DataValueField="item" DataTextField="descr"
                        ...
                        HighlightTemplatedItems="true" OnItemsRequested="Filterveh_ItemsRequested" Width="155" Height="200px" OnLoad="FilterVehNoCB_Load" OnClientSelectedIndexChanged="MPFilterVehNoCB_IndexChanged" OnSelectedIndexChanged="MPFilterVehNoCB_SelectedIndexChanged">
                    </telerik:RadComboBox>                                      
                </td>
                <td>
                    <br />
                ...
                <td>      
                    <br />           
                     <asp:Label ID="VehicleLbl" runat="server">Veh no</asp:Label>
                    <br>
                    <input type="text" runat="server" clientidmode="Static" id="hdnMPVehNo" style="display: none" />
                    <telerik:RadComboBox ID="MPVehNoCB" runat="server" DataValueField="item" DataTextField="descr"
                        Skin="WebBlue" AutoPostBack="true" CausesValidation="false" EnableLoadOnDemand="true" AllowCustomText="false" RenderMode="Lightweight"  OnItemDataBound="MPVehNoCB_ItemDataBound"
                        Filter="Contains" DropDownAutoWidth="Enabled" DropDownCssClass="radComboboxWithMultiCol" ItemsPerRequest="200" ShowMoreResultsBox="true"
                        HighlightTemplatedItems="true" OnItemsRequested="Vehicle_ItemsRequested" Width="155" Height="200px" OnLoad="MPVehNoCB_Load" OnClientSelectedIndexChanged="MPVehNoCB_IndexChanged">
                    </telerik:RadComboBox> 
                </td>
                <td>
                    <br />
        ...
        <script type="text/javascript">
            ...
            function MPVehNoCB_IndexChanged(sender, eventArgs){
                ...
                var newValue = sender.get_selectedItem().get_attributes().getAttribute('Driver Name');console.log(newValue);console.log('a',sender.get_selectedItem().get_attributes())                              
                var control = $find('MPDriverCB');              
                if (control.findItemByText(newValue))
                    control.findItemByText(newValue).select();
                else {
                    if (!newValue) {
            ...
            function initMap() {
                ...
                trafficLayer.setMap(mapPlanningGmap);*/
                        ...
                        google.maps.event.addListener(marker, 'mouseover', (function (marker, i) {
                            return function () {
                                var content = '<div class="info_content">' +
                                    ...
                                    '<p>' +
                                    'Order No: ' + infoContents[i].OrderNo + '</p>' +
                                    '<p>' +
                ...
                if(markers.length > 0){
                    for(var i=0; i < DistinctVehNo.length; i++){
                        ...
                        Ref: https://stackoverflow.com/questions/17673580/google-maps-drag-rectangle-to-select-markers --%>
