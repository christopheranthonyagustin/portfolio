<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveryServiceOrder.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveryService.DailyDeliveryServiceOrder" %>
...
<head id="Head1" runat="server">
    <title>Booking @ Daily Delivery Service</title>
    <base target="_self" />
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="DeliveryItemsTab" Text="DeliveryItems" Value="100" runat="server">
                </telerik:RadTab>
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <iWMS:iForm ID="formCtl_JBCtnrTripAddr" runat="server"></iWMS:iForm>
                                                <iWMS:iForm ID="formCtl_JBCtnrTripRoute" runat="server"></iWMS:iForm>
                                    ...
                                    <telerik:RadGrid ID="ResultDG2" runat="server" AutoGenerateColumns="false" GridLines="None"
                                        AllowSorting="true" AllowFilteringByColumn="false" EnableLinqExpressions="false"
                                        AllowPaging="false" Skin="Metro" OnNeedDataSource="ResultDG2_NeedDataSource"
                                        OnItemDataBound="ResultDG2_ItemDataBound" Width="90%">
                                        <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                                            <Selecting AllowRowSelect="true" />
                                        </ClientSettings>
                                        <SortingSettings EnableSkinSortStyles="false" />
                                        ...
                                        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                            <PagerStyle Mode="NextPrevNumericAndAdvanced" />
                                            <Columns>
                                                <telerik:GridTemplateColumn UniqueName="sno" HeaderText="Executed On" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px" HeaderStyle-Width="100px">
                                                    <ItemTemplate>
                                                        <%# string.Format("{0:dd/MMM/yyyy hh:mm:ss}", Eval("ExecutedOn")) %>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn HeaderText="Type" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Vehicle" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="VehicleLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Vehicle") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn HeaderText="Driver" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="DriverLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Driver") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                 <telerik:GridTemplateColumn HeaderText="Reason" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="ReasonCodeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RejectReasonDescr") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>

                                                <telerik:GridTemplateColumn HeaderText="Longitude" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="LongitudeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Longitude") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn HeaderText="Latitude" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="LatitudeLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Latitude") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                            </Columns>
                                        </MasterTableView>
