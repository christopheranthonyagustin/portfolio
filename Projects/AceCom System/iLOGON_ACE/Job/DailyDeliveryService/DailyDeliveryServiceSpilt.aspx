<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveryServiceSpilt.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveryService.DailyDeliveryServiceSpilt" %>
...
<head id="Head1" runat="server">
    <title>Daily Delivery Service Split</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2"
            ...
            <tr>
                <td>
                    <asp:Button ID="SplitBtn" class="white" runat="server" OnClick="SplitBtn_Click"
