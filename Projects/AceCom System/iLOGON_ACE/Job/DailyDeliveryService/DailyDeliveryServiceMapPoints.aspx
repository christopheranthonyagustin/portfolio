<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveryServiceMapPoints.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveryService.DailyDeliveryServiceMapPoints" %>
        ...
        <script type="text/javascript">            
		    ...
		    <%}%>
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var image = "DailyDeliveryServiceMapPointsMakeThumbNail.aspx?file=" + markers[i][2];
