<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyDeliveryServiceRecurring.aspx.cs" Inherits="iWMS.Web.Job.DailyDeliveryService.DailyDeliveryServiceRecurring" %>
...
<html>
<head runat="server">
    <title>Daily Delivery Service Recurring</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2"
            ...
            <tr>
                <td>
                    <asp:Label ID="RecurringLbl" runat="server" Font-Bold="true" Font-Size="Large" ForeColor="red"></asp:Label><br />
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="ForNextFewDaysLbl" runat="server" Text="ForNextFewDays"></asp:Label><br />
                    <br />
