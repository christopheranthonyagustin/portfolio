<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountWorkbenchCancellationnotsent.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountWorkbench.CycleCountWorkbenchCancellationnotsent" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2" runat="server">
                    <tr>
                        <td>
                         ...
                         <td>
                            <asp:Button ID="SendCancellationBtn" CssClass="LongLabelGreen" runat="server" OnClick="SendCancellationBtn_Click"
                                Text="&nbsp;&nbsp;&nbsp;&nbsp;Send  &nbsp;&nbsp;&nbsp;&nbsp; Cancellation" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
