<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountWorkbenchByLocationInventorySchedule.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountWorkbench.CycleCountWorkbenchByLocationInventorySchedule1" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="580px" ID="AccessPointMasterDashboardRadPageView">
                <table>
                    <tr>
                        <td>
                            <iWMS:iForm ID="formCtl_ByLocationInventorySchedule" runat="server" />
                        </td>
                </table>
                <br />
                <asp:Button ID="RefreshBtn" class="white" runat="server" OnClick="RefreshBtn_Click"
                    Text="Refresh" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                <asp:Button ID="ScheduleNextCountDateBtn" CssClass="LongLabelWhite" runat="server" OnClick="ScheduleNextCountDateBtn_Click"
                    Text="&nbsp;Schedule Next Count Date" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM"
