<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountWorkbenchCountinprogress.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountWorkbench.CycleCountWorkbenchCountinprogress" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <iWMS:iForm ID="formCtl_Countinprogress" runat="server" />
                </td>
                <td>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" DataKeyNames="StockId"
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ReadOnly="true" Display="true" HeaderStyle-Wrap="true" ItemStyle-Wrap="true" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                     ...
                     <telerik:GridBoundColumn DataField="ICID" Display="false">
