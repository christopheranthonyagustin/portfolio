<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountWorkbenchSplitSKU.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountWorkbench.CycleCountWorkbenchSplitSKU" %>
...
<html>
<head runat="server">
    <title>CycleCountWorkbenchSplitSKU</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Text="By Scheduled Count" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ReadOnly="true" Display="true"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton runat="server" Visible="True" ImageUrl="../../image/detail.gif" Width="15" ToolTip="LotId & StockId Array"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="BySKURadPageView" />
            <telerik:RadPageView runat="server" Height="700px" ID="ByLocationRadPageView" />
