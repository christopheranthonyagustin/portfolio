<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountWorkbenchCountCompleted.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountWorkbench.CycleCountWorkbenchCountCompleted" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="CountSheetItemsTab" Text="Count Sheet Item" Value="100" runat="server">
                </telerik:RadTab>
                    ...
                    <table border="0" cellpadding="2" cellspacing="2" runat="server">
                        <tr>
                            <td>
                             ...
                             <td>
                            <asp:Button ID="CountSheetBtn" CssClass="LongLabelBlue" runat="server" OnClick="CountSheetBtn_Click"
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" DataKeyNames="ICID"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ReadOnly="true" Display="true" HeaderStyle-Wrap="true"
                                    ItemStyle-Wrap="true" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                                    <HeaderTemplate>
