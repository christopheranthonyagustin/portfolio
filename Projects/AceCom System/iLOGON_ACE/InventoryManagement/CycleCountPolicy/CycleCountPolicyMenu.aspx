<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountPolicyMenu.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountPolicy.CycleCountPolicyMenu" %>
...
<head id="Head1" runat="server">
    <title>CycleCountPolicyMenu</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="CycleCountPolicyLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
