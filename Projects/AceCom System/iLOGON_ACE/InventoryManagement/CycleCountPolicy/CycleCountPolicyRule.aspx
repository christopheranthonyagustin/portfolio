<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountPolicyRule.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountPolicy.CycleCountPolicyRule" %>
...
<html>
<head runat="server">
    <title>CycleCountPolicyRule</title>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                ...
                                <ItemTemplate>
                                    ...
                                    &nbsp;&nbsp;
                                    <asp:ImageButton runat="server" Visible="True" ID="CCPolicyedit" ImageUrl="../../image/pencil.gif"
                                        BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit Cycle Count Policy Templater Manager"
                                        OnClick="CCPolicyedit_Click" CausesValidation="False"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ID="CCPolicydelete"
                                        ImageUrl="../../image/bin.gif" Width="15" Height="15" AlternateText="Delete" CausesValidation="false"
                                        OnClick="CCPolicydelete_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridBoundColumn DataField="RuleName" SortExpression="RuleName" HeaderText="RuleName"
