<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountPolicyRuleMaster.aspx.cs" Inherits="iWMS.Web.InventoryManagement.CycleCountPolicy.CycleCountPolicyRuleMaster" %>
...
<head id="Head1" runat="server">
    <title>Rule @ Cycle Count Policy</title>
    <base target="_self" />
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PropertyId" CommandItemDisplay="TopAndBottom" EditMode="Batch" Name="ParentGrid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn UniqueName="QualifyingValue" HeaderText="Qualifying Value" DataField="QualifyingValue" AllowFiltering="false" ItemStyle-Width="120px"
                                                        HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
