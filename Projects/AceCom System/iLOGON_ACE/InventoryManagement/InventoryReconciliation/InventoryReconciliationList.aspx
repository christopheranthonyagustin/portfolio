<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryReconciliationList.aspx.cs" Inherits="iWMS.Web.InventoryManagement.InventoryReconciliation.InventoryReconciliationList" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>InventoryReconciliationList</title>
...
<body leftmargin="0" topmargin="0">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="500px" ID="ListRadPageView">
                <br />
                <table  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="VarianceAdjustmentBtn" CssClass="LongLabelWhite" runat="server" OnClick="VarianceAdjustmentBtn_Click"
                                Text="Variance Adjustment" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />&nbsp;
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true" EnableLinqExpressions="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="RegisterId">
