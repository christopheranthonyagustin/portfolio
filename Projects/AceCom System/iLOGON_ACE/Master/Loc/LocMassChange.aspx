<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocMassChange.aspx.cs"
    Inherits="iWMS.Web.Master.Loc.LocMassChange" %>
...
<head runat="server">
    <title>Mass Update @ Location</title>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function ConfirmUpdateBtnCallbackFn(arg) {
