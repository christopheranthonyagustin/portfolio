<%@ Page Language="c#" CodeBehind="LocListHead.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Loc.LocListHead" %>
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="MassChangeBtn">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="StocksLocationTab" Text="Stocks in location" Value="100" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="PendingPutawayTab" Text="Pending putaway" Value="200" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="PendingissuanceTab" Text="Pending issuance" Value="300" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="SearchResultsRadPageView">
                <p>
                ...
                <table>
                    <tr>
                        <td style="width: 800px;">
                            <asp:Button ID="MassChangeBtn" CssClass="LongLabelWhite" runat="server" OnClick="MassChangeBtn_Click" Text="Mass Update" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />&nbsp;
                    ...
                    <asp:Label ID="lblProcessID" runat="server" Visible="False" />
                     ...
                     <asp:Button ID="LocLabelBtn" class="LongLabelBlue" runat="server" OnClick="LocLabelBtn_Click" Text="Location Label"
                         OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                            ...
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="code">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="OccupiedVolume" SortExpression="OccupiedVolume" HeaderText="Occupied volume" Reorderable="true" ColumnGroupName="OccupiedVolume" UniqueName="OccupiedVolume"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="typedescr" SortExpression="typedescr" HeaderText="Module Type" Reorderable="true" ColumnGroupName="typedescr" UniqueName="typedescr"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="abc" SortExpression="abc" HeaderText="ABC Classification" Reorderable="true" ColumnGroupName="abc" UniqueName="abc" ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="enableput" HeaderText="Allow Putaway" SortExpression="enableput" Reorderable="true" ColumnGroupName="enableput" UniqueName="enableput"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="enableallc" HeaderText="Allow Allocation" SortExpression="enableallc" Reorderable="true" ColumnGroupName="enableallc" UniqueName="enableallc"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="enablemove" HeaderText="Allow Move" SortExpression="enablemove" Reorderable="true" ColumnGroupName="enablemove" UniqueName="enablemove"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="StorageCategoryDescr" SortExpression="StorageCategoryDescr" HeaderText="Storage Category" Reorderable="true" ColumnGroupName="StorageCategoryDescr" UniqueName="StorageCategoryDescr"
                                            ItemStyle-Wrap="false">
                                            <ItemStyle Wrap="False"></ItemStyle>
                                        </telerik:GridBoundColumn>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="StocksLocationRadPageView" />
            <telerik:RadPageView runat="server" Height="700px" ID="PendingPutawayRadPageView" />
            <telerik:RadPageView runat="server" Height="700px" ID="PendingissuanceRadPageView" />
