<%@ Page Language="c#" CodeBehind="MassChangeLocHead.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.Loc.MassChangeLocHead" %>
            ...
            <td>
                <asp:DataGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" DataKeyField="code"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="enableput" HeaderText="EnablePUTA" SortExpression="enableput">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="enableallc" HeaderText="EnableALLC" SortExpression="enableallc">
                        </asp:BoundColumn>
