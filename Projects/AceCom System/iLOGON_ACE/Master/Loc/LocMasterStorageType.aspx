<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocMasterStorageType.aspx.cs" Inherits="iWMS.Web.Master.Loc.LocMasterStorageType" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Length">
                        ...
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="LengthTxtBox" runat="server" Skin="WebBlue" Text='<%# DataBinder.Eval(Container.DataItem, "Length") %>'></telerik:RadTextBox>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Width">
                        ...
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="WidthTxtBox" runat="server" Skin="WebBlue" Text='<%# DataBinder.Eval(Container.DataItem, "Width") %>'></telerik:RadTextBox>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                     ...
                     <telerik:GridTemplateColumn HeaderText="Height">
                        ...
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="HeightTxtBox" runat="server" Skin="WebBlue" Text='<%# DataBinder.Eval(Container.DataItem, "Height") %>'></telerik:RadTextBox>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>

                    <telerik:GridTemplateColumn HeaderText="Volume">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "Volume")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="VolumeTxtBox" runat="server" Skin="WebBlue" Text='<%# DataBinder.Eval(Container.DataItem, "Volume") %>'></telerik:RadTextBox>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
