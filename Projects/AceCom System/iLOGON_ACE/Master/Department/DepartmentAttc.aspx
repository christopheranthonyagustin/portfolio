<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentAttc.aspx.cs" Inherits="iWMS.Web.Master.Department.DepartmentAttc" %>
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onserverclick="DepartmentImageDelete" runat="server">
