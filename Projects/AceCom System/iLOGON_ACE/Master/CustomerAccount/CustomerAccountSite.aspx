<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAccountSite.aspx.cs" Inherits="iWMS.Web.Master.CustomerAccount.CustomerAccountSite" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>CustomerAccountSite</title>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="rcloccode" SortExpression="rcloccode" HeaderText="DefaultReceiveLoc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="xdloccode" SortExpression="xdloccode" HeaderText="DefaultXDockLoc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="dmgloccode" SortExpression="dmgloccode" HeaderText="DefaultQCDamageLoc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="shortageloccode" SortExpression="shortageloccode"
                            HeaderText="Default Shortage Loc" ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="surplusloccode" SortExpression="surplusloccode"
                            HeaderText="Default Surplus Loc" ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ktdploccode" SortExpression="ktdploccode" HeaderText="Kit Deposit Location"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ktwdloccode" SortExpression="ktwdloccode" HeaderText="Kit Withdrawal Location"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="loanloccode" SortExpression="loanloccode" HeaderText="Default Loan Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="maintenanceloccode" SortExpression="maintenanceloccode" HeaderText="Default Mtn. Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="loanrejectloccode" SortExpression="loanrejectloccode" HeaderText="Default Loan Reject Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="maintenancerejectloccode" SortExpression="maintenancerejectloccode" HeaderText="Default Mtn. Reject Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
