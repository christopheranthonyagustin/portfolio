<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAccountControlSearch.aspx.cs" Inherits="iWMS.Web.Master.CustomerAccount.CustomerAccountControlSearch" %>
...
<html>
<head runat="server">
    <title>CustomerAccountControlSearch</title>
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="Searchbtn">
        <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
           <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
            ...
            <Tabs>
                <telerik:RadTab Text="ControlSearch" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
