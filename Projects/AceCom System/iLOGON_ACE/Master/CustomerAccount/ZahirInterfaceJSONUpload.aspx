<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZahirInterfaceJSONUpload.aspx.cs" Inherits="iWMS.Web.Master.CustomerAccount.ZahirInterfaceJSONUpload" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%"
            ...
            Skin="Metro" Height="430px" ClientSettings-AllowColumnsReorder="true">
            <ClientSettings>
