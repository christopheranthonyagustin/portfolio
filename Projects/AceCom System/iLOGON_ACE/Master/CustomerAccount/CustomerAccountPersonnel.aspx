<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAccountPersonnel.aspx.cs" Inherits="iWMS.Web.Master.CustomerAccount.CustomerAccountPersonnel" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>CustomerAccountPersonnel</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="pagetitle">&nbsp;
                    <asp:ImageButton ID="DelImgBtn" runat="server" ImageUrl="../../Image/dustbin.png" Width="35" Height="35"
