<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="iWMS.Web.Master.CustomerAccount.Contact" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="pagetitle"><br />
                    <asp:Button ID="AddDetailBtn" class="white" runat="server" Text="New Line" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Visible="False" />
