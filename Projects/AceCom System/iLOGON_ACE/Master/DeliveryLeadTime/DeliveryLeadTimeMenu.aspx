<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryLeadTimeMenu.aspx.cs" Inherits="iWMS.Web.Master.DeliveryLeadTime.DeliveryLeadTimeMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>DeliveryLeadTime</title>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="SMSQueuelbl" runat="server">Delivery Lead Time</asp:Label>
            </td>
        </tr>
    </table>
    </form>
