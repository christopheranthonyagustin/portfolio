<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncentiveMatrixHead.aspx.cs" Inherits="iWMS.Web.Master.IncentiveMatrix.IncentiveMatrixHead" %>
...
<head id="Head1" runat="server">
    <title>IncentiveMatrixHead</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" ClientDataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
