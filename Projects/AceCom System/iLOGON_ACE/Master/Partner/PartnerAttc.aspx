<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerAttc.aspx.cs" Inherits="iWMS.Web.Master.Partner.PartnerAttc" %>
...
<html>
<head runat="server">
    <title>DailyDeliveryService Attc</title>
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onserverclick="PartnerImageDelete" runat="server">
