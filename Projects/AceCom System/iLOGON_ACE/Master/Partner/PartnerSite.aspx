<%@ Page Language="c#" CodeBehind="PartnerSite.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Partner.PartnerSite" %>
                        ...
                        <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                            <tr>
                               ...
                               <asp:Button ID="ClosePanelBtn" class="white" runat="server" OnClick="ClosePanelBtn_Click" Text="Hide"
                                   OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CausesValidation="false" style="margin-bottom:15px" />
                                </td>
                                <td>&nbsp;
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <asp:Label ID="RcvLbl" runat="server">Default RCV. Loc</asp:Label>
                                ...
                                <td nowrap>
                                    <asp:Label ID="XdLbl" runat="server">Default XD. Loc</asp:Label>
                                ...
                                <td nowrap>
                                    <asp:Label ID="DmgLbl" runat="server">Default Dmg. Loc</asp:Label><br>
                                ...
                                <td nowrap>
                                    ...
                                    <br>
                                    <telerik:RadDropDownList ID="StatusDDL" runat="server" Skin="Sunset"
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                            <ItemTemplate>
                                ...
                                <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onclick="return confirm('Confirm delete Site Setup?')"
                                    onserverclick="PnSite_Delete" runat="server">
                        ...
                        <telerik:GridBoundColumn DataField="rcloccode" SortExpression="rcloccode" HeaderText="Default RCV. Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="xdloccode" SortExpression="xdloccode" HeaderText="Default XD. Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="dmgloccode" SortExpression="dmgloccode" HeaderText="Default Dmg. Loc"
                            ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
