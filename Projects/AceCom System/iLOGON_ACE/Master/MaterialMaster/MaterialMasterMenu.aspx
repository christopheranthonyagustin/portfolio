<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialMasterMenu.aspx.cs" Inherits="iWMS.Web.Master.MaterialMaster.MaterialMasterMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Material Master (SKU)</title>
