<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialMasterHead.aspx.cs" Inherits="iWMS.Web.Master.MaterialMaster.MaterialMasterHead" %>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Account" DataField="accode" AllowFiltering="true"
                                ColumnGroupName="accode" SortExpression="accode" UniqueName="Account" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn Display="False" DataField="acid" SortExpression="acid" HeaderText="acid" />
                            <telerik:GridBoundColumn HeaderText="SKU code" DataField="code" AllowFiltering="true"
                                ColumnGroupName="code" SortExpression="Code" UniqueName="Code" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Description" DataField="descr" AllowFiltering="true"
                                ColumnGroupName="descr" SortExpression="descr" UniqueName="Description" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>                        
                            <telerik:GridBoundColumn HeaderText="Code2" DataField="code2" AllowFiltering="true"
                                ColumnGroupName="code2" SortExpression="code2" UniqueName="code2" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Type" DataField="typedescr" AllowFiltering="true"
                                ColumnGroupName="typedescr" SortExpression="typedescr" UniqueName="Type" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="BOM" DataField="BOM" AllowFiltering="true"
                                ColumnGroupName="BOM" SortExpression="BOM" UniqueName="BOM" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Group" DataField="grpdescr" AllowFiltering="true"
                                ColumnGroupName="grpdescr" SortExpression="grpdescr" UniqueName="Group" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Status" DataField="statusdescr" AllowFiltering="true"
                                ...
                                Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText=" Putaway Policy" DataField="putcodedescr" AllowFiltering="true"
                                ColumnGroupName="putcodedescr" SortExpression="putcodedescr" UniqueName="Putaway"
                                Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Allocation Policy" DataField="allcodedescr" AllowFiltering="true"
                            ...
                            <telerik:GridBoundColumn HeaderText="ABC Classification" DataField="abcdescr" AllowFiltering="true"
                                ColumnGroupName="abcdescr" SortExpression="abcdescr" UniqueName="ABC" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>                            
                            <telerik:GridBoundColumn HeaderText="Add Date" DataField="adddate" AllowFiltering="true"
                                ColumnGroupName="adddate" SortExpression="adddate" UniqueName="Adddate" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Add User" DataField="adduser" AllowFiltering="true"
                                ColumnGroupName="adduser" SortExpression="adduser" UniqueName="Adduser" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Edit Date" DataField="editdate" AllowFiltering="true"
                                ColumnGroupName="editdate" SortExpression="editdate" UniqueName="Editdate" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Edit User" DataField="edituser" AllowFiltering="true"
                                ColumnGroupName="edituser" SortExpression="edituser" UniqueName="Edituser" Reorderable="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
