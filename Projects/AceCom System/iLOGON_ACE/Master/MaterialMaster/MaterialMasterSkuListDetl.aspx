...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialMasterSkuListDetl.aspx.cs" Inherits="iWMS.Web.Master.MaterialMaster.MaterialMasterSkuListDetl" %>
...
<body onload='displayRow("table1");'>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Text="Main" Value="0" readonly="readonly" runat="server">
                 ...
                 <telerik:RadTab Text="UOM" Value="100" readonly="readonly" runat="server">
                </telerik:RadTab>
               ...
               <%-- <telerik:RadTab Text="Attributes" Value="100" runat="server">
                ...
                <telerik:RadTab Text="SKUPack" Value="250" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="UOMRadPageView">
            </telerik:RadPageView>
