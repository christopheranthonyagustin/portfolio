...
<%@ Page Language="c#" CodeBehind="VesselBerthingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.VesselBerthingSchedule.VesselBerthingMenu"%>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>VesselBerthingMenu</title>
            ...
            <td class="NewModuleTitle" align="right">
                <%--<div class="rounded-box1" style="background-color: #cc0000; width: 40%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="VesselLbl" labelclass="NewModuleTitle" runat="server"></asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
