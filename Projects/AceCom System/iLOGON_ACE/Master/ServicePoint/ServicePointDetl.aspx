<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServicePointDetl.aspx.cs" Inherits="iWMS.Web.Master.ServicePoint.ServicePointDetl" %>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" AllowFilteringByColumn="false">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="traveltime" SortExpression="traveltime" HeaderText="Travel Time">
                        </telerik:GridBoundColumn>
