<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsigneePartnerDetl.aspx.cs" Inherits="iWMS.Web.Master.ConsigneePartner.ConsigneePartnerDetl" %>
...
<html>
<head runat="server">
    <title>ConsigneePartnerDetl</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="AP-Supplierr" Value="200" readonly="readonly" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="70%" ID="SKURateRadPageView" />
