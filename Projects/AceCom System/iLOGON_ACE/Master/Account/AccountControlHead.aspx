<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountControlHead.aspx.cs" Inherits="iWMS.Web.Master.Account.AccountControlHead" %>
...
<html>
<head runat="server">
    <title>AccountControlHead</title>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Text="ControlSearchResults" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
