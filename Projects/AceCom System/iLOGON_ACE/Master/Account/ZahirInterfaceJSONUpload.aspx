<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZahirInterfaceJSONUpload.aspx.cs" Inherits="iWMS.Web.Master.Account.ZahirInterfaceJSONUpload" %>
...
<head id="Head1" runat="server">
    <title>ZahirInterfaceUpload</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    <asp:Label runat="server" ID="TitleLbl" CssClass="BoldText" style="font-size:17px; color:black; font-weight: bold;font-family: Helvetica" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="ZHRBtn" runat="server" Text=" Zahir " OnClick="ZHRBtn_Click"
                        ToolTip="Click to Upload Selected Files"
                        UseSubmitBehavior="false" CssClass="white" />
                    &nbsp;
