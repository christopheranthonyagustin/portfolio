<%@ Page Language="c#" CodeBehind="AccountDetl.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Account.AccountDetl" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Notification Control" Value="700" runat="server">
                </telerik:RadTab>
                ...
                <telerik:RadTab Text="General Business Posting Group" Value="650" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <iWMS:iForm ID="formCtl2" runat="server"></iWMS:iForm>
                <br />
                &nbsp;&nbsp;
            <%--<telerik:RadButton ID="SOUpdateBtn" runat="server" Skin = "WebBlue" Text="Update" CssClass="detailButton"
                Style="z-index: 0" OnClick="UpdateBtn_Click"></telerik:RadButton>--%>
            </telerik:RadPageView>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="NotificationControlRadPageView" />
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="GeneralBusinessPostingGroupRadPageView">
                <br />
                &nbsp;&nbsp;
