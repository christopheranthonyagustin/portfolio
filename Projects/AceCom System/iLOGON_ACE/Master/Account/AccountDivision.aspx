<%@ Page Language="c#" CodeBehind="AccountDivision.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.Account.AccountDivision" %>
                ...
                <td colspan="2">
                    <asp:Panel ID="AddPanel" runat="server" Visible="False">
                        ...
                        <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                            ...
                            <tr>
                                <td nowrap style="padding-left: 10px; padding-top: 10px">
