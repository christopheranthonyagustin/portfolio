<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehUpKeepBudgetMenu.aspx.cs"
    Inherits="iWMS.Web.Master.VehUpKeepBudget.VehUpKeepBudgetMenu" %>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                &nbsp;<td class="NewModuleTitle" align="right">
                    <telerik:RadLabel Text="Vehicle Upkeep Budget" Value="0" readonly="readonly" runat="server">
                    </telerik:RadLabel>
                    </div> </div>
                </td>
        </tr>
