<%@ Page Language="c#" CodeBehind="PerIncidentImage.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.PerIncident.PerIncidentImage" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PerIncidentImage</title>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td align="right">                                
                                    <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="False" CommandName='<%#DataBinder.Eval(Container,"DataItem.id")%>'
                                        OnClick="PerIncidentImageDelete">
        ...
        <tr>
            <td>
                ...
                <asp:Panel ID="FileUploadPanel" runat="server" style="margin-left: 12px; margin-top: 10px;">
                    <table border="0" cellspacing="2" cellpadding="2" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                            <telerik:RadButton ID="ImageSubmit" runat="server"  OnClick="ImageSubmit_ServerClick" Text="Upload"
                             Skin="WebBlue">
                            </telerik:RadButton>
