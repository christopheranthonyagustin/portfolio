<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerUpload.aspx.cs"
    Inherits="iWMS.Web.Master.Container.ContainerUpload" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        ...
        <tr>
            <td class="style1">
                <asp:Label ID="billgrpLbl" runat="server">Default Billing Group: </asp:Label>
                <br />
                <br />
                <br />
            ...
            <td>
                <telerik:RadDropDownList ID="billgrpDDL" Skin="WebBlue" runat="server" Width="150px" />
                <br />
                <br />
                <br />
                <%--<asp:FileUpload ID="excelFile" runat="server" />--%>
                <telerik:RadAsyncUpload runat="server" ID="excelFile" MultipleFileSelection="Disabled"
                    MaxFileInputsCount="1" AllowedFileExtensions=".xls,.xlsx" Skin="WebBlue" />
            </td>
        </tr>
        <tr>
            <td class="style1">
            ...
            <td>
                ...
                <br />
                <telerik:RadButton ID="excelSend" Text=" VALIDATE " runat="server" Skin="WebBlue"
                    OnClick="excelSend_Click" OnClientClick="return busyBox.Show();" />
                <br />
        ...
        <tr>
            ...
            <td>
                <telerik:RadDropDownList ID="excelssDDL" runat="server" Skin="WebBlue" AutoPostBack="True"
                    OnSelectedIndexChanged="excelssDDL_SelectedIndexChanged" Visible="false" />
                <br />
                <telerik:RadButton ID="excelssBtn" Text="Get WorkSheet" Skin="WebBlue" runat="server"
                    CssClass="formbtn" Visible="false" />
