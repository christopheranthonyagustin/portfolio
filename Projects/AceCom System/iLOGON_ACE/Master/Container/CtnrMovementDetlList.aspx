<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CtnrMovementDetlList.aspx.cs" Inherits="iWMS.Web.Master.Container.CtnrMovementDetlList" %>
...
<head id="Head1" runat="server">
     ...
     <title>StoringOrderDetlList</title>
            ...
            <HeaderStyle Wrap="false" CssClass="RGridHeader_CUSTOM" ForeColor="White"></HeaderStyle>
              <MasterTableView AllowMultiColumnSorting="true" >
                <Columns>                    
                    ...
                    <telerik:GridBoundColumn HeaderText="TransDate" DataField="TransDate" SortExpression="TransDate" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn HeaderText="XAccount" DataField="XACCode" SortExpression="XACCode" AllowFiltering="false">
                    </telerik:GridBoundColumn>
