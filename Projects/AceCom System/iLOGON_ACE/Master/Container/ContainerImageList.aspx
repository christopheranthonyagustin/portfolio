<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerImageList.aspx.cs" Inherits="iWMS.Web.Master.Container.ContainerImageList" %>
...
<head id="Head1" runat="server">
    <title>ContainerImageList</title>
...
<body  bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td><br />
                <%--<telerik:RadButton ID="AddBtn" runat="server" Text="NewDoc" Skin="WebBlue" CssClass="detailButton" OnClick="AddBtn_Click">
                </telerik:RadButton>--%>
                <asp:Button ID="AddBtn" CssClass="white" runat="server" OnClick="AddBtn_Click" 
                                    Text="NewDoc" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                 &nbsp;<asp:Label
    ...
    <br />
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                <%--<Scrolling SaveScrollPosition="true" UseStaticHeaders="true" ScrollHeight="90%" />--%>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Wrap="false">                    
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Wrap="false">
                        <ItemTemplate>
                            ...
                            <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onclick="return confirm('Confirm delete?')"
                                onserverclick="SKUImageDelete" runat="server">
                                <img id="delImg" src="../../image/bin.gif" width="15" height="15" border="0" alt="Delete Costing Sheet Image"
                                    runat="server"></a>
                        </ItemTemplate>
                    ...
                    <telerik:GridBoundColumn DataField="rem1" SortExpression="rem2" HeaderText="Rem1"
                        ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>  
