<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncentiveMatrixTMSMenu.aspx.cs" Inherits="iWMS.Web.Master.IncentiveMatrixTMS.IncentiveMatrixTMSMenu" %>
...
<head id="Head1" runat="server">
    <title>IncentiveMatrixTMSMenu</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="IncentiveMatrixTMSLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
