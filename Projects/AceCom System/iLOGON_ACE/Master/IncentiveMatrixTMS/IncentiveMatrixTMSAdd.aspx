<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncentiveMatrixTMSAdd.aspx.cs" Inherits="iWMS.Web.Master.IncentiveMatrixTMS.IncentiveMatrixTMSAdd" %>
...
<html>
<head runat="server">
    <title>IncentiveMatrixTMSAdd</title>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="AllowanceRate" UniqueName="AllowanceRate">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "AllowanceRate", "{0:#,0.##}")  %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadTextBox runat="server" ID="AllowanceRateTxt" Skin="Office2007" Width="150px"></telerik:RadTextBox>
                                    <asp:CompareValidator ID="AllowanceRateTxtCompVal" runat="server" ControlToValidate="AllowanceRateTxt"
                                        EnableClientScript="true" ErrorMessage="#" Operator="DataTypeCheck" Type="Double" />
                                    <asp:CompareValidator ID="AllowanceRateTxtZeroVal" runat="server" ControlToValidate="AllowanceRateTxt"
                                        EnableClientScript="true" ErrorMessage="#" Operator="GreaterThanEqual" ValueToCompare="0" />
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn UniqueName="billsizetype" HeaderText="BillSizeType">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "BillSizeTypeDescr")%>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadComboBox ID="BillSizeTypeCombo" runat="server" CausesValidation="false" EnableVirtualScrolling="true" ShowMoreResultsBox="true" RenderMode="Lightweight" AllowCustomText="false" Filter="Contains"
                                        CheckBoxes="true" EnableCheckAllItemsCheckBox="true" DropDownAutoWidth="Enabled" Width="155" Height="300"
                                        Skin="WebBlue" DataSource='<%# BillSizeTypeListDS%>' SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(BillSizeTypeListDS,DataBinder.Eval(Container.DataItem, "BillSizeTypeDescr").ToString())%>'
                                        DataTextField="descr" DataValueField="item">
                                    </telerik:RadComboBox>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
