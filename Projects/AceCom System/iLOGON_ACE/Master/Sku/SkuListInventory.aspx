<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkuListInventory.aspx.cs" Inherits="iWMS.Web.Master.Sku.SKUListInventory" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <br /><br /><br />
        <asp:Label ID="OnHandLbl" runat="server" Font-Size="Medium"></asp:Label>
        <br /> <br />
        <asp:Label ID="AllocatedLbl" runat="server" Font-Size="Medium"></asp:Label>
        <br /> <br />
        <asp:Label ID="PickedLbl" runat="server" Font-Size="Medium"></asp:Label>
         <br /> <br />
        <asp:Label ID="AvailableLbl" runat="server" Font-Size="Medium"></asp:Label>
    </form>
</body>
</html>
