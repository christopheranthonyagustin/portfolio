<%@ Page Language="c#" CodeBehind="SkuPack.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Sku.SkuPack" %>
...
<body>
    <form id="Form1" method="post" runat="server" defaultbutton="AddPackBtn">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip" CausesValidation="false" MultiPageID="RadMultiPage"
            AutoPostBack="true" SelectedIndex="0" Skin="Windows7" OnTabClick="RadTabStrip_TabClick">
            <Tabs>
                <telerik:RadTab Id="UOMTab" Text="UOM" Value="0" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="600px" ID="UOMTabRadPageView">
                ...
                <telerik:RadGrid ID="PackDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="25" DataKeyNames="id" EditMode="InPlace">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn DataField="TierCount" SortExpression="TierCount" UniqueName="TierCount"
                                HeaderText="TierCount">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "TierCount") %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TierCountTxt" runat="server" Width="80"></asp:TextBox>
                                    <asp:CompareValidator ID="TierCountVal" runat="server" ControlToValidate="TierCountTxt"
                                        EnableClientScript="True" ErrorMessage="*" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridTemplateColumn HeaderText="TierUOM">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "TierUOM") %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList ID="TierUOMDDL" DataTextField="descr" DataValueField="item"
                            ...
                            <telerik:GridTemplateColumn DataField="HighCount" SortExpression="HighCount" UniqueName="HighCount"
                                HeaderText="HighCount">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "HighCount") %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="HighCountTxt" runat="server" Width="80"></asp:TextBox>
                                    <asp:CompareValidator ID="HighCountVal" runat="server" ControlToValidate="HighCountTxt"
                                        EnableClientScript="True" ErrorMessage="*" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridTemplateColumn HeaderText="HighUOM">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "HighUOM") %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList ID="HighUOMDDL" DataTextField="descr" DataValueField="item"
                                        SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(UOMDS,DataBinder.Eval(Container.DataItem, "uom").ToString())%>'
                                        DataSource='<%# UOMDS%>' runat="server" />
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
