<%@ Page Language="c#" CodeBehind="SkuCopy.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Sku.SkuCopy" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table class="TABLE" id="FormTable" width="100%" runat="server">
        ...
        <tr>
            ...
            <td align="center">
                <asp:Button ID="SelectBtn" runat="server" Text=" Select  " OnClick="SelectBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" >
                </asp:Button><br>
                <br>
                <asp:Button ID="RemoveBtn" runat="server" Text="Remove" OnClick="RemoveBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" >
                </asp:Button><br>
                <br>
                <asp:Button ID="RemoveAllBtn" runat="server" Text="Remove All" OnClick="RemoveAllBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" >
                </asp:Button>
            </td>
            <td colspan="2">
    ...
    <table>
        <tr>
            <td>
                <asp:Button ID="Copy_Btn" runat="server" CssClass="white" Text="Copy" OnClick="Copy_Btn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" >
                </asp:Button>
            </td>
            <td>
                <asp:Button ID="Clear" runat="server" CssClass="white" Text="Clear All" OnClick="Clear_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" >
                </asp:Button>
            </td>
        </tr>
    </table>
