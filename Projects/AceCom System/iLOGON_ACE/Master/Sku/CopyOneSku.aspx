<%@ Page Language="c#" CodeBehind="CopyOneSku.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Sku.CopyOneSku" %>
        ...
        <table id="FormTable" class="TABLE" runat="server" width="90%">
            ...
            <tr>
                ...
                <td style="width: 140px">
                    ...
                    <%--<telerik:RadDropDownList ID="toCooDDL" TabIndex="12" runat="server" Skin="WebBlue" OnSelectedIndexChanged="toCooDDL_SelectedIndexChanged">
