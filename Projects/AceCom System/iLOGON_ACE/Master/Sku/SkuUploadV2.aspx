<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkuUploadV2.aspx.cs" Inherits="iWMS.Web.Master.Sku.SkuUploadV2" %>
                ...
                <asp:Panel ID="stdUploadPanel" runat="server" Visible="false">
                    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                        ...
                        <tr>
                            <td style="width: 50%">
                                <br />
                                <asp:Label ID="Label1" Text="Note : Only Microsoft Excel files can be Uploaded." Style="margin-left: 15px;" runat="server"></asp:Label>
                                <br />
                                <br />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="excelSend" runat="server" Text="Upload" CssClass="white" OnClick="excelSend_Click"
                                    OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" Style="margin-left: 14px;"></asp:Button>
                                <br />
