<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkuLotUploadMenu.aspx.cs"
    Inherits="iWMS.Web.Master.Sku.SkuLotUploadMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>SkuLotUpload</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="TextLbl" runat="server">SKU Lot Upload</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
