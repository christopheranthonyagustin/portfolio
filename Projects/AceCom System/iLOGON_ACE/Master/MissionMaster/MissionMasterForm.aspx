<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MissionMasterForm.aspx.cs" Inherits="iWMS.Web.Master.MissionMaster.MissionMasterForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Payload" Value="50" readonly="readonly" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="90%" ID="PayloadRadPageView" />
