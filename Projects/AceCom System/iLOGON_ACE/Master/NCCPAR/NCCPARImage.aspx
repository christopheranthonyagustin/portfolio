<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCCPARImage.aspx.cs" Inherits="iWMS.Web.Master.NCCPAR.NCCPARImage" %>
                        ...
                        <table border="0" cellspacing="1" cellpadding="1" width="100%">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvSiteCode" runat="server" ControlToValidate="ImageName"
                            ...
                            <tr>
                                ...
                                <br />
                                &nbsp;
                                    <asp:Button ID="ImageSubmit" CssClass="white" runat="server" OnClick="ImageSubmit_ServerClick" Text="Upload"
