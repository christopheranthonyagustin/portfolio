<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehicleDocketDetl.aspx.cs" Inherits="iWMS.Web.Master.Vehicle.VehicleDocketDetl" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
    <form id="Form1" method="post" runat="server" style="z-index: 0">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Text="PassSearch Results" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
                    ...
                    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false"
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" EditMode="InPlace">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="vehdescr" SortExpression="vehdescr" HeaderText="Description">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="typedescr" SortExpression="typedescr" HeaderText="Type">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="refno" SortExpression="refno" HeaderText="ReferenceNo">
                                </telerik:GridBoundColumn>
