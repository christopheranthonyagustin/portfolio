<%@ Page Language="c#" CodeBehind="BatchVehImageMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.Vehicle.BatchVehImageMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #660000; width: 30%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="ReportNameLbl" runat="server">Batch Vehicle Image</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
