<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServicePt.aspx.cs" Inherits="iWMS.Web.Master.Vehicle.ServicePt" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="pagetitle"><br />
                <asp:Button ID="DeleteBtn" CssClass="white" runat="server" OnClick="DeleteAllBtn_Click" Text="Delete" Visible="false" 
                            UseSubmitBehavior="false" OnClientClick="disableBtn(this.id)"></asp:Button>
            </td>
            <td align="right">
        ...
        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="ServicePt" HeaderText="ServicePt">
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "ServicePtDescr")%>
                    </ItemTemplate>
                      <EditItemTemplate>
                ...
                <telerik:GridTemplateColumn UniqueName="ExpiryDate" HeaderText="ExpiryDate">
                    ...
                    <EditItemTemplate>
                        ...
                        <telerik:RadDatePicker ID="ExpiryDate" Width="100%" runat="server" DateInput-DateFormat="dd/MMM/yyyy "
                            TimeView-TimeFormat="HH:mm" DateInput-DisplayDateFormat="dd/MMM/yyyy " PopupDirection="TopRight"
                            DbSelectedDate='<%# DataBinder.Eval(Container.DataItem, "ExpiryDate") %>'  Skin="Sunset"
                            AutoPostBackControl="Both" BackColor="#ded7c6" DateInput-BackColor="#ded7c6">
                            <Calendar>
                                <SpecialDays>
                ...
                <telerik:GridTemplateColumn UniqueName="status" HeaderText="Status">
                    ...
                    <EditItemTemplate>
                        <telerik:RadDropDownList runat="server" ID="txtStatus" DataSource='<%# VehServicePtStatus%>'
                            Skin="WebBlue" DataTextField="descr" DataValueField="item" Width="90%" 
                            SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(VehServicePtStatus,DataBinder.Eval(Container.DataItem, "status").ToString())%>'>
                        </telerik:RadDropDownList>
                    </EditItemTemplate>
                </telerik:GridTemplateColumn>
