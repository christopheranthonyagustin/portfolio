<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2MvmtSchedule.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2MvmtSchedule" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SKUV2 Movement Schedule</title>
...
<body>
    <form id="form1" method="post" runat="server">
            ...
            <tr>
                <td>
                    <div class="NewModuleTitle">
                        <asp:Label ID="Label1" runat="server">SKUV2 Movement Schedule</asp:Label>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
            AllowSorting="false" EnableLinqExpressions="false" Skin="Metro" AllowPaging="false"
            ...
            <MasterTableView AllowMultiColumnSorting="false" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
            </MasterTableView>
        </telerik:RadGrid>
        <br />
        <telerik:RadGrid ID="LegendDG" runat="server" GridLines="None" Skin="Metro" AutoGenerateColumns="true" Visible="false" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
            <ClientSettings>
                <Resizing AllowColumnResize="true" ResizeGridOnColumnResize="true" AllowResizeToFit="true" />
            </ClientSettings>
            <ItemStyle Wrap="false"></ItemStyle>
