<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2Menu.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2Menu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>SkuV2Menu</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">SKUV2</asp:Label>
                </td>
            </tr>
        </table>
    </form>
