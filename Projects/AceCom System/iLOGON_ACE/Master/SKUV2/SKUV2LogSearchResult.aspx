<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2LogSearchResult.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2LogSearchResult" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false"
                AllowSorting="True" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource">
                ...
                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" EditMode="InPlace" PageSize="300" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
