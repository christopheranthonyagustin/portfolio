<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2LotUploadMenu.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2LotUploadMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>SkuV2LotUploadmenu</title>
            ...
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                        ...
                        <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; font-size: 10pt; font-weight: bold; padding-top: 3px; left: 3px; top: 0px; width: 170px;">
                            <asp:Label ID="TextLbl" runat="server">SKUV2 Lot Upload</asp:Label>
                        </div>
                    </div>
                </td>
            </tr>
