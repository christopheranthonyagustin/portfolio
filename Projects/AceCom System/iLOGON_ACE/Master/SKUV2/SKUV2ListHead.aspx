<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2ListHead.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2ListHead" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Id="ResultTab" Text="Search Results" Value="0" runat="server" >
                </telerik:RadTab>
                ...
                <table>
                    <tr>
                        <td align="left" class="style1">
                            ...
                            &nbsp;
                            <asp:Button ID="InvBtn" runat="server" Text="Inventory" OnClick="InvBtn_Click"
