<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2Copy.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2Copy" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>SKUV2Copy</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table class="TABLE" id="FormTable" width="100%" runat="server">
            ...
            <tr>
                <td colspan="2">
                    <asp:ListBox ID="fromListbox" runat="server" SelectionMode="Multiple" Rows="10" Width="100%"></asp:ListBox>
                </td>
                <td align="center">
                    <asp:Button ID="SelectBtn" runat="server" Text=" Select  " OnClick="SelectBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button><br>
                    <br>
                    <asp:Button ID="RemoveBtn" runat="server" Text="Remove" OnClick="RemoveBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button><br>
                    <br>
                    <asp:Button ID="RemoveAllBtn" runat="server" Text="Remove All" OnClick="RemoveAllBtn_Click" CssClass="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
                </td>
                <td colspan="2">
                    <asp:ListBox ID="toListbox" runat="server" SelectionMode="Multiple" Rows="10" Width="100%"></asp:ListBox>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                <td>
                    <asp:Button ID="Copy_Btn" runat="server" CssClass="white" Text="Copy" OnClick="Copy_Btn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
                </td>
                <td>
                    <asp:Button ID="Clear" runat="server" CssClass="white" Text="Clear All" OnClick="Clear_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
                </td>
            </tr>
        </table>
    </form>
