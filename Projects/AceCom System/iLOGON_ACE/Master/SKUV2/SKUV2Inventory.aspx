<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKUV2Inventory.aspx.cs" Inherits="iWMS.Web.Master.SKUV2.SKUV2Inventory" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>SKUV2 Inventory</title>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <telerik:RadGrid ID="SkuUomQtyResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowSorting="true"
            AllowPaging="true" Skin="Metro" OnNeedDataSource="SkuUomQtyResultDG_NeedDataSource">
        ...
        <telerik:RadGrid ID="LocResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowSorting="true"
            AllowPaging="true" Skin="Metro" OnNeedDataSource="LocResultDG_NeedDataSource">
            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                <Selecting AllowRowSelect="true" />
            </ClientSettings>
            <SortingSettings EnableSkinSortStyles="false" />
        ...
        <telerik:RadGrid ID="SlocResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowSorting="true"
            AllowPaging="true" Skin="Metro" OnNeedDataSource="SlocResultDG_NeedDataSource">
            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                <Selecting AllowRowSelect="true" />
            </ClientSettings>
            <SortingSettings EnableSkinSortStyles="false" />
        ...
        <telerik:RadGrid ID="Lot456ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowSorting="true"
            AllowPaging="true" Skin="Metro" OnNeedDataSource="Lot456ResultDG_NeedDataSource">
            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                <Selecting AllowRowSelect="true" />
            </ClientSettings>
            <SortingSettings EnableSkinSortStyles="false" />
