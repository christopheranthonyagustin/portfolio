<%@ Page Language="c#" CodeBehind="SkuImage.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Sku_DAPL.SkuImage" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td colspan="2">
                <asp:Label ID="SkuLbl" runat="server" CssClass="pagetitle"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
