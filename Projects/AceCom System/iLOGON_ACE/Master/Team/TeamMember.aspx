<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamMember.aspx.cs" Inherits="iWMS.Web.Master.Team.TeamMember" %>
              ...
              <tr>
                  <td>
                      <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false"
                                ...
                                OnUpdateCommand="ResultDG_Update" OnEditCommand="ResultDG_Edit" OnItemCommand="ResultDG_ItemCommand" GroupPanelPosition="Top" Width="500px">
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" CommandItemDisplay="Top" Name="CBAdd"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Member" HeaderText="Member">
                                            <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="PersonnelList" runat="server" DefaultMessage="Select a Charge"
                                                    DropDownHeight="150px" Skin="WebBlue" DataSource='<%# PersonnelDS%>' SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(PersonnelDS,DataBinder.Eval(Container.DataItem, "id").ToString())%>'
