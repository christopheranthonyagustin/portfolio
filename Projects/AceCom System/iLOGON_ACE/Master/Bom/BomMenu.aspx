...
<%@ Page Language="c#" CodeBehind="BomMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Bom.BomMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">                
                        <asp:Label ID="VehicleLbl" runat="server">B.O.M</asp:Label>
            </td>
        </tr>
    </table>
    </form>
