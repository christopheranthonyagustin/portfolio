<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerAbsentUpload.aspx.cs" Inherits="iWMS.Web.Master.PerAbsent.PerAbsentUpload" %>
...
<html>
<head runat="server">
    <title>Personnel Absent Upload</title>
        ...
        <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server" style="float:left">
            ...
            <tr>
                <td class="style1">
                    ...
                    <asp:Label ID="lblnote" Text="Note:" runat="server"></asp:Label>
                    <br />&nbsp;
                    <asp:Label ID="Label1" Text="1.Only Excel files can be uploaded." runat="server"></asp:Label>
                    <br />&nbsp;
                    <asp:Label ID="Label2" Text="2.Only personnel registered in Personnel Master will be successfully updated in Personnel Absent module." runat="server"></asp:Label>
                </td>
            </tr>
             <tr>
                <td class="style1">&nbsp;
