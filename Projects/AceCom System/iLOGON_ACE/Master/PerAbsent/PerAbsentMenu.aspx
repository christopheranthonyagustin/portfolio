<%@ Page Language="c#" CodeBehind="PerAbsentMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.PerAbsent.PerAbsentMenu" %>
        ...
        <tr>
            ...
            <%--    <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <div>
                        <asp:Label ID="perAbsentLbl" runat="server"></asp:Label></div>
                <%--</div>--%>
            </td>
        </tr>
    </table>
