<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchAttc.aspx.cs" Inherits="iWMS.Web.Master.Branch.BranchImage" %>
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onserverclick="BranchImageDelete" runat="server">
