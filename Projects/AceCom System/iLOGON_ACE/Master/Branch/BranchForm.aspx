<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchForm.aspx.cs" Inherits="iWMS.Web.Master.Branch.BranchForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Control" Value="50" readonly="readonly" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Attc" Value="100" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
