<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchControl.aspx.cs" Inherits="iWMS.Web.Master.Branch.BranchControl" %>
                            ...
                            <tr>
                                <td colspan="5">
                                    ...
                                    <asp:Button ID="SaveBtn" runat="server" CssClass="white" Text="Save" OnClick="SaveBtn_Click"
                                        UseSubmitBehavior="false" OnClientClick="disableBtn(this.id, true)" />
                                    <asp:Button ID="ClosePanelBtn" runat="server" CssClass="white" Text="Hide" OnClick="ClosePanelBtn_Click" Style="margin-bottom: 10px"
