<%@ Page Language="c#" CodeBehind="DockSearch.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Dock.DockSearch" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <asp:Label Style="z-index: 0" ID="MessageLbl" runat="server" CssClass="errorLabel" Visible="False"></asp:Label>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="DockDashboardRadPageView" />
