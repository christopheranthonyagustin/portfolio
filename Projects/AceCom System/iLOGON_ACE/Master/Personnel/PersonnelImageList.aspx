<%@ Page Language="c#" CodeBehind="PersonnelImageList.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.Personnel.PersonnelImageList" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>PersonnelImageList</title>
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
        ...
        <tr>
            <td>
                ...
                <%-- &nbsp;<asp:Label ID="personnelCodeLbl" Font-Italic="False" runat="server" Style="font-family: Arial, Helvetica, sans-serif;
                    font-size: 16px; font-weight: 700"></asp:Label>--%>
    ...
    <div id="div1">
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            OnItemDataBound="ResultDG_ItemDataBound" OnEditCommand="ResultDG_EditCommand" OnNeedDataSource="ResultDG_NeedDataSource">
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="typedescr" SortExpression="typedescr" HeaderText="Document Type"
                        ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
