<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonnelAccountContact.aspx.cs" Inherits="iWMS.Web.Master.Personnel.PersonnelAccountContact" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>PersonnelAccountContact</title>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" OnNeedDataSource="ResultDG_NeedDataSource"
        ...
        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn UniqueName="accontactname" HeaderText="AcContactName">
                    <HeaderStyle Wrap="false" HorizontalAlign="Center" Width="50px" />
                    <ItemStyle Wrap="False" HorizontalAlign="Left" Width="50px" />
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "accontactname")%>
                    </ItemTemplate>
                <EditItemTemplate>
                                    <telerik:RadComboBox ID="accontactname" runat="server" DefaultMessage="Select a ContactName"
                                     Skin="Sunset" DropDownHeight="150px" DataSource='<%# AccountContactDS%>' SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(AccountContactDS,DataBinder.Eval(Container.DataItem, "accontactname").ToString())%>'
                                   ...
                                   <asp:TextBox ID="ChargeCodeTxt" runat="server" Visible="false" Value='<%# DataBinder.Eval(Container.DataItem, "accontactname") %>' BackColor="#ded7c6"/>
                                 <asp:RequiredFieldValidator ID="TaskListReqVal" runat="server" ControlToValidate="accontactname"
                            ErrorMessage="*" />
                   </EditItemTemplate>
                </telerik:GridTemplateColumn>
                ...
                <telerik:GridTemplateColumn UniqueName="status" HeaderText="Status">
                    ...
                    <EditItemTemplate>
                        <telerik:RadDropDownList runat="server" ID="ddlStatus" DataSource='<%# PerAcContactStatus%>'
                            Skin="WebBlue" DataTextField="descr" DataValueField="item" Width="90%" 
                            SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(PerAcContactStatus,DataBinder.Eval(Container.DataItem, "status").ToString())%>'>
                        </telerik:RadDropDownList>
                    </EditItemTemplate>
                </telerik:GridTemplateColumn>
