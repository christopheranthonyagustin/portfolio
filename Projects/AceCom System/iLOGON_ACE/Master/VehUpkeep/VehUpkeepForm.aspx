...
<%@ Page Language="c#" CodeBehind="VehUpkeepForm.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.VehUpkeep.VehUpkeepForm" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="700px" ID="MainRadPageView">
                <table>
                    <tr>
                        <td><br />&nbsp;
                                 <asp:Button ID="UpdateBtn" class="white" runat="server" OnClick="UpdateBtn_Click" ToolTip="Save" Visible="False"
                                    ...
                                    <tr>
                                        <td width="150px">
                                            <asp:CheckBox ID="ReAttachedChkBox" runat="server" Checked="False" Style="z-index: 0"
                                                Visible="false" Text="Re-Attach" AutoPostBack="true" OnCheckedChanged="ReAttachedChkBox_CheckedChanged" />
                                        </td>
                                        <td>
