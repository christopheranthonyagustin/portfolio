<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehUpkeepUpload.aspx.cs" Inherits="iWMS.Web.Master.VehUpkeep.VehUpkeepUpload" %>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                ...
                <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                    ...
                    <tr>
                        <td>Format</td>
                        <td>
                            <asp:DropDownList ID="formatDDL" runat="server" Width="156px" BackColor="Yellow" />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
