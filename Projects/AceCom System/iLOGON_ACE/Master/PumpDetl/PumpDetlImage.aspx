<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PumpDetlImage.aspx.cs" Inherits="iWMS.Web.Master.PumpDetl.PumpDetlImage" %>
                        ...
                        <table border="0" cellspacing="2" cellpadding="2" width="100%" style="margin-left: 9px">                          
                            ...
                            <tr>
                                ...
                                <telerik:RadButton ID="ImageSubmit" runat="server" OnClick="ImageSubmit_ServerClick"
                                    Text="  UPLOAD  " style="margin-left: 5px;"
