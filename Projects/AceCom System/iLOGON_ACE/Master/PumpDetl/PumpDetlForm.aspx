...
<%@ Page Language="c#" CodeBehind="PumpDetlForm.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.PumpDetl.PumpDetlForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Attc" Value="25" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <table>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
             ...
             <telerik:RadPageView runat="server" Height="700px" ID="AttcPageView">
            </telerik:RadPageView>
