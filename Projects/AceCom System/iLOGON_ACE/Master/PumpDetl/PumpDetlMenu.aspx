<%@ Page Language="c#" CodeBehind="PumpDetlMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.PumpDetl.PumpDetlMenu" %>
            ...
            <%--<td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="PumpDetlLbl" runat="server">Pump Transaction</asp:Label></div>
                </div>
            </td>--%>
            <td class="NewModuleTitle" align="right">
            <asp:Label ID="PumpDetlLbl" runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    </form>
