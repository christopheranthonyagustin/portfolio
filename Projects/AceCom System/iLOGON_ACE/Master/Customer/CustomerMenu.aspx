...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMenu.aspx.cs" Inherits="iWMS.Web.Master.Customer.CustomerMenu" %>
        ...
        <tr>
            ...
            <td align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Customer</asp:Label>
                </div>
            </td>
        </tr>
    </table>
