<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PalletMasterSearch.aspx.cs" Inherits="iWMS.Web.Master.PalletMaster.PalletMasterSearch" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server" defaultbutton="Searchbtn">
        ...
        <asp:Label Style="z-index: 0" ID="MessageLbl" runat="server" CssClass="errorLabel" Visible="False"></asp:Label>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="PalletDashboardRadPageView" />
