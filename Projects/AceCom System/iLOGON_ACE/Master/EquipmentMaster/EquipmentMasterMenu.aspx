...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentMasterMenu.aspx.cs" Inherits="iWMS.Web.Master.EquipmentMaster.EquipmentMasterMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>EquipmentMasterMenu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Equipment Master</asp:Label>
                </div>
            </td>
        </tr>
    </table>
