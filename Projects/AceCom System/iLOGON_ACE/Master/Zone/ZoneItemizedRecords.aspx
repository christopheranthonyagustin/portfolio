<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZoneItemizedRecords.aspx.cs" Inherits="iWMS.Web.Master.Zone.ZoneItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../Zone/ZoneListHead.aspx";
        }
