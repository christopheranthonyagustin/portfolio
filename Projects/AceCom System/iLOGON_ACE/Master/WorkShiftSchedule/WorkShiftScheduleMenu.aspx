<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkShiftScheduleMenu.aspx.cs" 
    Inherits="iWMS.Web.Master.WorkShiftSchedule.WorkShiftScheduleMenu" %>
            ...
            <tr>
               <td class="style1">
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="WorkShiftScheduleLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
