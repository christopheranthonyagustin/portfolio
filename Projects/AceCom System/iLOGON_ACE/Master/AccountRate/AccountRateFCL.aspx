<%@ Page Language="c#" CodeBehind="AccountRateFCL.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.AccountRate.AccountRateFCL" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>AccountRateFCL</title>
        ...
        <asp:DataGrid ID="RateDG" runat="server" AutoGenerateColumns="False" OnCancelCommand="RateDG_Cancel"
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="20FT($)" ItemStyle-HorizontalAlign="Right">
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "fcl20rate", "{0:#,0.##}") %>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="40FT($)" ItemStyle-HorizontalAlign="Right">
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "fcl40rate", "{0:#,0.##}") %>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="40TFT($)" ItemStyle-HorizontalAlign="Right">
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "fcl40trate", "{0:#,0.##}") %>
                    </ItemTemplate>
                </asp:TemplateColumn>
