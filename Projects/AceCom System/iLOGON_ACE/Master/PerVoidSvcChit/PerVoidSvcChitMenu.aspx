<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerVoidSvcChitMenu.aspx.cs"
    Inherits="iWMS.Web.Master.PerVoidSvcChit.PerVoidSvcChitMenu" %>
            ...
            <td class="NewModuleTitle" align="right">
                <%--<div class="rounded-box1" style="background-color: #cc0000; width: 70%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="PerVoidSvcChitLbl" runat="server">Personnel Void Service Chit</asp:Label>
                <%--</div>--%>
            </td>
        </tr>
    </table>
