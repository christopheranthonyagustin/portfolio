...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessPointMasterMenu.aspx.cs" Inherits="iWMS.Web.Master.AccessPointMaster.AccessPointMasterMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>AccessPointMasterMenu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Access Point Master</asp:Label>
                </div>
            </td>
        </tr>
    </table>
