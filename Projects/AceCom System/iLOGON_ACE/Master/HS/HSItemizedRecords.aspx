<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSItemizedRecords.aspx.cs" Inherits="iWMS.Web.Master.HS.HSItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../HS/HSListHead.aspx";
        }
