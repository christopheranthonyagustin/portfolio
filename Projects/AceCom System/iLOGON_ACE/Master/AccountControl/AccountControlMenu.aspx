<%@ Page Language="c#" CodeBehind="AccountControlMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Master.AccountControl.AccountControlMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>AccountControlMenu</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="background-color: #cc0000; width: 40%">
                    ...
                    <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="MenuLbl" runat="server">Account Control</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
