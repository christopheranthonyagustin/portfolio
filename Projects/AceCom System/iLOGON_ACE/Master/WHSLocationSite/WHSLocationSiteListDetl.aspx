...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHSLocationSiteListDetl.aspx.cs" Inherits="iWMS.Web.Master.WHSLocationSite.WHSLocationSiteListDetl" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<html>
<head runat="server">
    <title>>WarehouseLocationSiteListDetl</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Series" Value="50" readonly="readonly" runat="server" Enabled="false">
                </telerik:RadTab>
