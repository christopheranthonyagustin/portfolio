<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHSLocationSiteMenu.aspx.cs" Inherits="iWMS.Web.Master.WHSLocationSite.WHSLocationSiteMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>>WarehouseLocationMenu</title>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">   
                 <asp:Label ID="WHSLocationLbl" runat="server">Warehouse Location Site</asp:Label></div>       
            </td>
        </tr>
    </table>
    </form>
