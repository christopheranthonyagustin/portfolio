...
<%@ Page Language="c#" CodeBehind="RouteMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Master.Route.RouteMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">                
                        <asp:Label ID="RouteLbl" runat="server">Route</asp:Label>
            </td>  
        </tr>
    </table>
    </form>
