...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorageTypeSKUGroupSearch.aspx.cs" 
    Inherits="iWMS.Web.Master.StorageTypeSKUGroup.StorageTypeSKUGroupSearch" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>StorageTypeSkuGroupSearch</title>
