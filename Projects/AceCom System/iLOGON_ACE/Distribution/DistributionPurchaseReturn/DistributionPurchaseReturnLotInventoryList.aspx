<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseReturnLotInventoryList.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseReturn.DistributionPurchaseReturnLotInventoryList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td>
                    <div class="pagetitle">
                        <asp:Label ID="StepLbl" runat="server">Select Purchase Order Item (Step 2 of 3)</asp:Label><br />
                    </div>
                </td>
                <td align="right">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="LotInventoryId" PageSize="50">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ItemUOMQty" SortExpression="ItemQty" HeaderText="ItemQty" AllowFiltering="false">
                    </telerik:GridBoundColumn>
