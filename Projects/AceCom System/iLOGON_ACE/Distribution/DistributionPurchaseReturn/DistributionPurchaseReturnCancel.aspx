<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseReturnCancel.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseReturn.DistributionPurchaseReturnCancel" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Cancel @ Distribution Purchase Return</title>
    <base target="_self" />
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            <tr>
                <td>
                    <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Purchase Return Cancellation</asp:Label>
                </td>
            </tr>
        </table>
