<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseReturnHead.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseReturn.DistributionPurchaseReturnHead" %>
...
<html>
<head runat="server">
    <title>Distribution Purchase Return Head</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="HeaderRadPageView">
                <table style="width: 100%; height=0" cellpadding="7px">
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="PrintPurchaseReturnBtn" runat="server" CssClass="LongLabelBlue" Text="Purchase Return"
                                OnClick="PrintPurchaseReturnBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />&nbsp;
                            <asp:Button ID="CancelConfirmBtn" Text="" Style="display: none;" OnClick="CancelConfirmBtn_Click" runat="server" /><%--Set Hidden button for changing from TT-popup to RadConfirm--%>
                        </td>
                        <td>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="PurchaseReturnId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="PurchaseReturnNo" UniqueName="PurchaseReturnNo" SortExpression="PurchaseReturnNo" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="PurchaseReturnNo">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PurchaseReturnDate" UniqueName="PurchaseReturnDate" SortExpression="PurchaseReturnDate"
                                HeaderText="PurchaseReturnDate" DataFormatString="{0:dd/MMM/yyyy}">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PurchaseInvoiceNo" UniqueName="PurchaseInvoiceNo" HeaderText="InvoiceNo" ShowFilterIcon="true" AllowFiltering="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PurchaseReturnStatusDescr" UniqueName="PurchaseReturnStatusDescr" SortExpression="PurchaseReturnStatusDescr" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="Status">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PurchaseReturnStatus" Display="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ApproveStatus" Display="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PurchaseReturnNo" Display="false">
                            </telerik:GridBoundColumn>
