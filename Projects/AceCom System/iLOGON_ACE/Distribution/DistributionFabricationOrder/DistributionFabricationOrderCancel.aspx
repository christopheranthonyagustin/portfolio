<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionFabricationOrderCancel.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationOrder.DistributionFabricationOrderCancel" %>


<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Distribution Fabrication Order Cancel </title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Distribution Fabrication Order Cancel</asp:Label>
            </td>
        </tr>
    </table>
