<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionFabricationOrderStage.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationOrder.DistributionFabricationOrderStage" %>
...
<html>
<head runat="server">
    <title>Distribution Fabrication Order Stage</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="25" DataKeyNames="FabricationOrderStageId" EditMode="InPlace">
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                        ...
                        <ItemTemplate>
                            ...
                            <a id="InkDelette" href='<%#DataBinder.Eval(Container,"DataItem.FabricationOrderStageId")%>' onclick="return confirm('Confirm delete?')"
                    ...
                    <telerik:GridTemplateColumn HeaderText="FabricationOrderStageStatus">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "FabricationOrderStageStatusDescr") %>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:DropDownList ID="SalesorderFabricationStageStatusDDL" DataMember="" DataTextField="descr" DataValueField="item"
                                SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(FabricationOrderStageStatusDS,DataBinder.Eval(Container.DataItem, "FabricationOrderStageStatus").ToString())%>'
                                DataSource='<%# FabricationOrderStageStatusDS%>' runat="server" />
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridBoundColumn DataField="SaleFabricationOrderId" Display="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="FabricationOrderStageStatusDescr" Display="false">
                    </telerik:GridBoundColumn>
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
