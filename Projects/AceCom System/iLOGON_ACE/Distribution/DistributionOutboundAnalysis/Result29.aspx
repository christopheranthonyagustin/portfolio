<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result29.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionOutboundAnalysis.Result29" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="FabricationOrderDateLabel" runat="server" class="graytitle" Text="FabricationOrderDate :" />
                </td>
                <td>
                    <asp:Label ID="FabricationOrderDateLbl" runat="server" class="graytitle"></asp:Label>
                </td>
            </tr>
