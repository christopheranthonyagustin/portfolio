...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesReturnItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesReturn.DistributionSalesReturnItem" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Distribution Sales Return Item</title>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
                <td colspan="2" valign="top">
                    <asp:Label ID="doNoLbl" runat="server">DONo</asp:Label>
                    &nbsp;
                <telerik:RadTextBox ID="DONo" runat="server" Width="120px"></telerik:RadTextBox>
                    &nbsp;
        ...
        <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="DeliveryOrderItemId" PageSize="50">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="DeliveryOrderNo" SortExpression="DeliveryOrderNo" HeaderText="DeliveryOrderNo" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="DeliveryOrderDate" SortExpression="DeliveryOrderDate" HeaderText="DeliveryOrderDate" DataFormatString="{0:dd/MMM/yyyy}" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="DeliveryOrderStatusDescr" SortExpression="DeliveryOrderStatus" HeaderText="DeliveryOrderStatus" AllowFiltering="false">
                    </telerik:GridBoundColumn> 
