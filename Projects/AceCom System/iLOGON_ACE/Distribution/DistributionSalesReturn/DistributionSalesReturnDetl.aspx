<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesReturnDetl.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesReturn.DistributionSalesReturnDetl" %>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="SalesReturnNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
