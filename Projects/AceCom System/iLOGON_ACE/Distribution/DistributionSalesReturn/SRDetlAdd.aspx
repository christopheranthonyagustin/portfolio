<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRDetlAdd.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesReturn.SRDetlAdd" %>
            ...
            <script type="text/javascript">
                function ClientValidate(sender, args) {
                    ...
                    if (NewItemQty != null && NewItemQty != "" && UOM != null && UOM != "") {
                        ...
                        $.ajax({
                            async: false,
                            url: 'SRDetlAdd.aspx/ValidateItemQtyAndUOM',
