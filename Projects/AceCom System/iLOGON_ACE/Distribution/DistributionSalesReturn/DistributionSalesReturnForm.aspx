<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesReturnForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesReturn.DistributionSalesReturnForm" %>
...
<html>
<head runat="server">
    <title>DistributionSalesReturnForm</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="AttcTab" Text="Attc" Value="15" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="SalesReturnItemRadPageView">
                        <br />
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="SalesReturnItemId">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SRDetailEdit"
                                                ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit" CausesValidation="false"
                                                OnClick="SRDetailEdit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                            &nbsp;
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SRDeleteImg"
                                        ImageUrl="../../image/bin.gif" Width="15" Height="15" AlternateText="Delete" CausesValidation="false"
                                        OnClick="SRDeleteImg_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="DeliveryOrderNo" DataField="DeliveryOrderNo" SortExpression="DeliveryOrderNo" UniqueName="DeliveryOrderNo"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="DeliveryOrderItemLineNo" DataField="DeliveryOrderItemLineNo" SortExpression="DeliveryOrderItemLineNo" UniqueName="DeliveryOrderItemLineNo"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="LocationBinCode" DataField="LocationBinCode" SortExpression="LocationBinCode" UniqueName="LocationBinCode"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn HeaderText="StorageLocationCode" DataField="StorageLocationCode" SortExpression="StorageLocationCode" UniqueName="StorageLocationCode"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="SalesReturnItemStatus" DataField="SalesReturnItemStatusDescr" SortExpression="SalesReturnItemStatus" UniqueName="SalesReturnItemStatus"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <%--<telerik:GridTemplateColumn HeaderText="ModifiedOn" ItemStyle-Wrap="false">
                                     ...
                                     <telerik:GridBoundColumn HeaderText="DeliveryOrderItemId" DataField="POItemId" UniqueName="PurchaseOrderItemId" Display="false">
                                    </telerik:GridBoundColumn>
