<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesReturnMenu.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesReturn.DistributionSalesReturnMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Distribution Sales Return Menu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="ModuleLbl" labelclass="NewModuleTitle" runat="server"></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
