<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseRequestForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseRequest.DistributionPurchaseRequestForm" %>
...
<html>
<head runat="server">
    <title>Distribution Purchase Request Form</title>
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip2" MultiPageID="RadMultiPage2" AutoPostBack="true"
                    ...
                    <Tabs>
                        <telerik:RadTab Id="ItemTab" Text="Item" Value="10" runat="server">
                         ...
                         <telerik:RadTab Id="POTab" Text="PO" Value="20" runat="server">
                        </telerik:RadTab>                       
                    </Tabs>                    
                </telerik:RadTabStrip>
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="GLDistributionRadPageView">
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PurchaseRequestItemId">
                                <Columns>
                                    ...
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="delImg"
                                        ...
                                        OnClick="PODelete_Click"  OnClientClick="return confirm('Confirm delete?')" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="PurchaseRequestItemStatus" DataField="PurchaseRequestItemStatusDescr" SortExpression="PurchaseRequestItemStatus" UniqueName="PurchaseRequestItemStatus"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="PurchaseRequestItemId" Display="false">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
                    ...
                    <telerik:RadPageView runat="server" Height="90%" ID="PORadPageView">
                        <br />
                        <telerik:RadGrid ID="ResultPODG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            AllowFilteringByColumn="false" Skin="Office2007" OnNeedDataSource="ResultPODG_NeedDataSource">
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PurchaseOrderItemId">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="PurchaseOrderItemStatus" DataField="PurchaseOrderItemStatus" SortExpression="PurchaseOrderItemStatus" UniqueName="PurchaseOrderItemStatus"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
