<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseRequestItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseRequest.DistributionPurchaseRequestItem" %>
...
<head id="Head1" runat="server">
    <title>Distribution Purchase Request Item</title>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="PurchaseRequestNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
