<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionStockAdjustmentList.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionStockAdjustment.DistributionStockAdjustmentList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                ...
                <td align="right">
                    <asp:Button ID="NextBtn" runat="server" Text=" Next " CssClass="detailButton" OnClick="NextBtn_Click"></asp:Button>&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="3">
