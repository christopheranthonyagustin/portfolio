<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionStockAdjustmentHead.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionStockAdjustment.DistributionStockAdjustmentHead" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                &nbsp;   
                <asp:Button ID="PrintStockAdjustmentBtn" runat="server" CssClass="LongLabelBlue" Text="Print Stock Adjustment"
                    OnClick="PrintStockAdjustmentBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                <br />
                <br />
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="StockAdjustmentId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="StockAdjustmentNo" UniqueName="StockAdjustmentNo" SortExpression="StockAdjustmentNo" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="StockAdjustmentNo">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="StockAdjustmentDate" UniqueName="StockAdjustmentDate" SortExpression="StockAdjustmentDate"
                                HeaderText="StockAdjustmentDate" DataFormatString="{0:dd/MMM/yyyy}">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="StockAdjustmentTypeDescr" UniqueName="StockAdjustmentTypeDescr" SortExpression="StockAdjustmentTypeDescr" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="Type">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="StockAdjustmentReasonDescr" UniqueName="StockAdjustmentReasonDescr" SortExpression="StockAdjustmentReasonDescr" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="Reason">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="StockAdjustmentStatusDescr" UniqueName="StockAdjustmentStatusDescr" SortExpression="StockAdjustmentStatusDescr" ShowFilterIcon="false" AllowFiltering="false"
                                HeaderText="Status">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="StockAdjustmentStatus" Display="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="StockAdjustmentId" Display="false">
                            </telerik:GridBoundColumn>
