<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricationOrderQuotationSubItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationOrderQuotation.FabricationOrderQuotationSubItem" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="80%" ID="HeaderRadPageView">
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                &nbsp;
                            <asp:Button ID="AddDetailBtn" runat="server" class="white" Text="NewSubItem" OnClick="AddDetailBtn_Click"
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="FabricationOrderQuotationSubItemId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridCalculatedColumn HeaderText="UnitPrice <br/> Multiplier" DataFields="UnitPrice,Multiplier"
                                Expression='{0} + " <br/>" + {1}' SortExpression="UnitPrice" Reorderable="true">
                            </telerik:GridCalculatedColumn>
                            <telerik:GridCalculatedColumn HeaderText="Amount <br/> Currency" DataFields="Amount,CurrencyCode"
                                Expression='{0} + " <br/>" + {1}' SortExpression="Currency" Reorderable="true">
                            </telerik:GridCalculatedColumn>
