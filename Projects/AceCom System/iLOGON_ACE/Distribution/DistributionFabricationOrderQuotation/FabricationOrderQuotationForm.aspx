<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricationOrderQuotationForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationOrderQuotation.FabricationOrderQuotationForm" %>
...
<html>
<head runat="server">
    <title>Fabrication Order Quotation Form</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="MainTab" Text="Main" Value="0" runat="server" PostBack="true">
                </telerik:RadTab>
