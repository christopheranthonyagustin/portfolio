<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseOrderItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseOrder.DistributionPurchaseOrderItem" %>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="PurchaseOrderNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
