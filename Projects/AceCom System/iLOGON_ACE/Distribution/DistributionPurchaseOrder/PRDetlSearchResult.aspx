...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRDetlSearchResult.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseOrder.PRDetlSearchResult" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PRSearchResult</title>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
                <td colspan="2" valign="top">
                    <asp:Label ID="prNoLbl" runat="server">PRNo</asp:Label>
                    &nbsp;
                <telerik:RadTextBox ID="PRNo" runat="server" Width="120px"></telerik:RadTextBox>
                    &nbsp;
        ...
        <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PurchaseRequestItemId" PageSize="50">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="PurchaseRequestNo" SortExpression="PurchaseRequestNo" HeaderText="PurchaseRequestNo" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="PurchaseRequestDate" SortExpression="PurchaseRequestDate" HeaderText="PurchaseRequestDate" DataFormatString="{0:dd/MMM/yyyy}" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="PurchaseRequestStatusDescr" SortExpression="PurchaseRequestStatus" HeaderText="PurchaseRequestStatus" AllowFiltering="false">
                    </telerik:GridBoundColumn> 
