<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderReject.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseOrder.PurchaseOrderReject" %>
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Purchase Order Reject</asp:Label>
            </td>
        </tr>
    </table>
