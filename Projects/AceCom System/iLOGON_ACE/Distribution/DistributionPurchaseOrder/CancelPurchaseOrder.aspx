<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelPurchaseOrder.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseOrder.CancelPurchaseOrder" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Cancel @ Purchase Order</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            <tr>
                <td>
                    <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Purchase Order Cancellation</asp:Label>
                </td>
            </tr>
        </table>
