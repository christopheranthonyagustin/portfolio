<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DSOQCancel.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrderQuotation.DSOQCancel" %>
...
<head runat="server">
    <title>Cancel @Sales Order Quotation</title>
...
<body>
    <form id="form1" runat="server" method="post">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Sales Order Quotation Cancellation</asp:Label>
                </td>
            </tr>
        </table>
