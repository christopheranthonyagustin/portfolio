<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseInvoiceCancel.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseInvoice.DistributionPurchaseInvoiceCancel" %>
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Purchase Invoice Cancellation</asp:Label>
            </td>
        </tr>
    </table>
