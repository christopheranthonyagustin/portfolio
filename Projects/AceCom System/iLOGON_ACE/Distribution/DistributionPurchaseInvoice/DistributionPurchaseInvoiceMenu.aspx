<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseInvoiceMenu.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseInvoice.DistributionPurchaseInvoiceMenu" %>
            ...
            <tr>
               <td class="style1">
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="PurchaseInvoiceLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
