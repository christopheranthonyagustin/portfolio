<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionPurchaseInvoiceDetail.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionPurchaseInvoice.DistributionPurchaseInvoiceDetail" %>
...
<head id="Head1" runat="server">
    <title>Distribution Goods Receive Item</title>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="GoodsReceiveNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
