<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SODetlDOSD.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionDeliveryOrder.SODetlDOSD" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>SODetlDOSD</title>
        ...
        <telerik:RadGrid ID="ResultDG1" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="Id" PageSize="50">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" AllowFiltering="false">
                        <ItemTemplate>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <asp:Label ID="FromLb" runat="server">SO :</asp:Label>
                                </tr>
                                <tr>
                                    <asp:Label ID="ToLb" runat="server">DO:</asp:Label>
                                </tr>
                            </table>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>  
                    ...
                    <telerik:GridTemplateColumn ItemStyle-Wrap="False" HeaderText="ItemQty" SortExpression="qty" AllowFiltering="false" UniqueName="ItemQty">
                        <ItemTemplate>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ItemOutstandingDeliveredQty","{0:#}") %>'
                                            ID="AvailQtyLabel" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <telerik:RadTextBox runat="server" Width="60px" ID="QtyTxt" BackColor="Yellow" Text='<%# DataBinder.Eval(Container.DataItem, "ItemOutstandingDeliveredQty","{0:#}") %>' OnTextChanged="QtyTxt_TextChanged" AutoPostBack="true"></telerik:RadTextBox>
                                        ...
                                        <asp:CompareValidator ID="QtyCompVal" runat="server" ErrorMessage="Exceed" ControlToValidate="QtyTxt" ValueToCompare='<%# DataBinder.Eval(Container.DataItem, "ItemOutstandingDeliveredQty","{0:#}") %>' Enable="false"
                                            Operator="LessThanEqual" Type="Integer" Visible="True" ForeColor="Red"></asp:CompareValidator>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
                      ...
                      <telerik:GridTemplateColumn HeaderText="ItemUOM">
                        <ItemTemplate>
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadDropDownList ID="UOMList" DataTextField="descr" DataValueField="item" SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(ItemUOMDS,DataBinder.Eval(Container.DataItem, "ItemUOM").ToString())%>' CausesValidation="false"
                                            DataSource='<%# ItemUOMDS%>' runat="server" Width="100" AutoPostBack="true" OnSelectedIndexChanged="UOMList_SelectedIndexChanged1"/>
                                        <asp:RequiredFieldValidator ID="UOMReq" runat="server" ErrorMessage="*" ControlToValidate="UOMList" ForeColor="Red"></asp:RequiredFieldValidator>
                    ...
                    <telerik:GridBoundColumn DataField="LocationBinCode" SortExpression="LocationBinCode" HeaderText="LocationBinCode" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="StorageLocationCode" SortExpression="StorageLocationCode" HeaderText="StorageLocationCode" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                   <telerik:GridTemplateColumn ItemStyle-Wrap="False" HeaderText="ItemId" SortExpression="ItemId" AllowFiltering="false" Display="false">
                    ...
                    <telerik:GridTemplateColumn ItemStyle-Wrap="False" HeaderText="ItemLHUQty" SortExpression="ItemLHUQty" AllowFiltering="false" Display="false">
                        <ItemTemplate>
                            <telerik:RadTextBox runat="server" ID="ItemLHUQtyTxt" Text='<%# DataBinder.Eval(Container.DataItem, "ItemOutstandingDeliveredQty","{0:#}") %>'></telerik:RadTextBox>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>

                     <telerik:GridBoundColumn DataField="ItemId" SortExpression="ItemId" HeaderText="ItemId" AllowFiltering="false" Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ItemUOMQty" SortExpression="ItemUOMQty" HeaderText="ItemUOMQty" AllowFiltering="false" Display="false">
                    </telerik:GridBoundColumn>
           ...
           <%-- <script type="text/javascript">
                function ClientValidate(sender, args) {
                    ...
                    if (NewItemQty != null && NewItemQty != "" && UOM != null && UOM != "") {
                        ...
                        $.ajax({
                            async: false,
                            url: 'SODetlDOSD.aspx/ValidateItemQtyAndUOM',
