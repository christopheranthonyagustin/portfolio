<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelSalesOrder.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrder.CancelSalesOrder" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Cancel @Sales Order</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            <tr>
                <td>
                    <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Sales Order Cancellation</asp:Label>
                </td>
            </tr>
        </table>
