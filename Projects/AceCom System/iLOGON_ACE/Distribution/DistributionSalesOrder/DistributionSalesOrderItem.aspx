<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesOrderItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrder.DistributionSalesOrderItem" %>
...
<head id="Head1" runat="server">
    <title>Distribution Sales Order Item</title>
        ...
        <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2" width="100%">
            <tr>
                <td>
                    ...
                    <%--<asp:Button ID="CalculateDimensionBtn" CssClass="LongLabelWhite" runat="server" OnClick="CalculateDimensionBtn_Click"
                        Text="Calculate Dimension" CausesValidation="false" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />--%>
                    <%--<asp:Button ID="CalculateUnitRateBtn" CssClass="LongLabelWhite" runat="server" OnClick="CalculateUnitRateBtn_Click"
                        Text="Calculate Unitrate" CausesValidation="false" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />--%>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="SalesOrderNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
