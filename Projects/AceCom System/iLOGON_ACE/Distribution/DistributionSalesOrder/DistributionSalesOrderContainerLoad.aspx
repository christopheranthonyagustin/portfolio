<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesOrderContainerLoad.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrder.DistributionSalesOrderContainerLoad" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="550px" ID="ContainerRadPageView">
                <br />
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="TallySheetBtn" runat="server" CssClass="LongLabelBlue" Text="Tally Sheet"
                                OnClick="TallySheetBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" Width="100%">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="S/N" ItemStyle-HorizontalAlign="Center" AutoPostBackOnFilter="true" AllowFiltering="false"
                             ...
                             <telerik:GridBoundColumn HeaderText="SalesOrderNo" DataField="SalesOrderNo" SortExpression="SalesOrderNo" UniqueName="SalesOrderNo"
                                Reorderable="true">
