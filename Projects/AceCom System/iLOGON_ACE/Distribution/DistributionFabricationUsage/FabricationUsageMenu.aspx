<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricationUsageMenu.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationUsage.FabricationUsageMenu" %>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Distribution Fabrication Usage</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
