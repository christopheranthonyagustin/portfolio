<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelFabricationUsage.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionFabricationUsage.CancelFabricationUsage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cancel @Fabrication Usage</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Distribution Fabrication Usage Cancel</asp:Label>
            </td>
        </tr>
    </table>
