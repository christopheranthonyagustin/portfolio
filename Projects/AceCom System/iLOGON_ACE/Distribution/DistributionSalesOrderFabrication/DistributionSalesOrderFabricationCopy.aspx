<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesOrderFabricationCopy.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrderFabrication.DistributionSalesOrderFabricationCopy" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Copy @ DistributionSalesOrderFabrication</title>
...
<body onload="javascript:window.focus();">
    <form id="Form1" method="post" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="SOCopyLbl" runat="server">Copy From Distribution Sales Order Fabrication</asp:Label>
                    <br />
