<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelSalesOrderFabrication.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrderFabrication.CancelSalesOrderFabrication" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Cancel @Sales Order Fabrication</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Sales Order Fabrication Cancellation</asp:Label>
            </td>
        </tr>
    </table>
