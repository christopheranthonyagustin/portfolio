<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionSalesOrderFabricationForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionSalesOrderFabrication.DistributionSalesOrderFabricationForm" %>
...
<html>
<head runat="server">
    <title>Distribution Sales Order Fabrication Form</title>
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="GLDistributionRadPageView">
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="SalesOrderFabricationItemId">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="SalesOrderFabricationStatus" DataField="SalesOrderFabricationStatusDescr" SortExpression="SalesOrderFabricationStatusDescr" UniqueName="SalesOrderFabricationStatusDescr"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
