<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobOrderSurveyItemAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.JobOrderSurveyItemAdd" %>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1ForAttc" AutoPostBack="true"
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="JobOrderSurveyItemAttcRadPageView">
            </telerik:RadPageView>
