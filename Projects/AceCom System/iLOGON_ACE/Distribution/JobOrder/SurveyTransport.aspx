<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyTransport.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyTransport" %>
...
<head runat="server">
    <title>Survey Transport @ Job Order</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="TransportRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveyTransportId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Height="50px" ItemStyle-Width="50px">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyTransportEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyTransportDelete"
                                    ...
                                    <asp:Label ID="SurveyTransportAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="DeliveryAddress" UniqueName="DeliveryAddress" SortExpression="DeliveryAddress" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="DeliveryAddress">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Transport" UniqueName="Transport" SortExpression="Transport" ShowFilterIcon="true" AllowFiltering="true"
                            ...
                            <telerik:GridBoundColumn DataField="SurveyTransportId" Display="false">
                            </telerik:GridBoundColumn>
