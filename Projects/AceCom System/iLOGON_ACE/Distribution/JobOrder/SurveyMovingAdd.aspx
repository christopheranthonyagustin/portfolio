<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyMovingAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyMovingAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey Moving @ JobOrder</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" onload='displayRow("table1");'>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server"  Height="700px" ID="SurveyMovingAttcRadPageView">
            </telerik:RadPageView>
