<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyLiftingAndHoistingAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyLiftingAndHoistingAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey LiftingAndHoisting @ JobOrder</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="SurveyLiftingAndHoistingAttcRadPageView">
            </telerik:RadPageView>
