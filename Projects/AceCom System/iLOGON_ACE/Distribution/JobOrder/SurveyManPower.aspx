<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyManPower.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyManPower" %>
...
<head runat="server">
    <title>Survey ManPower @ Job Order</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="ManPowerRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveyManPowerId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Height="50px" ItemStyle-Width="50px">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyManpowerEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyManpowerDelete"
                                    ...
                                    <asp:Label ID="SurveyManPowerAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="TotalManPower" UniqueName="TotalManPower" SortExpression="TotalManPower" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Total Manpower Needed">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="ManPower" UniqueName="ManPower" SortExpression="ManPower" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Man Power">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SurveyManPowerId" Display="false">
                            </telerik:GridBoundColumn>
