<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveySafetyDocuments.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveySafetyDocuments" %>
...
<head runat="server">
    <title>Survey Scope Safety Documents @ Distribution Job Order</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="SafetyDocumentsRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveySafetyDocumentsId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Height="50px" ItemStyle-Width="50px">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveySafetyDocumentsEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveySafetyDocumentsDelete"
                                    ...
                                    <asp:Label ID="SurveySafetyDocumentsAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SafetyDocuments" UniqueName="SafetyDocuments" SortExpression="SafetyDocuments" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Safety Documents">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SurveySafetyDocumentsId" Display="false">
                            </telerik:GridBoundColumn>
