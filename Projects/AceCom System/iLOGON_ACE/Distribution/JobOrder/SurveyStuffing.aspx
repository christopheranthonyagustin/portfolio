<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyStuffing.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyStuffing" %>
...
<head runat="server">
    <title>Survey Stuffing @ Job Order</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="StuffingRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveyStuffingId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Height="50px" ItemStyle-Width="50px">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyStuffingEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyStuffingDelete"
                                                ImageUrl="../../image/bin.gif" Width="15" Height="15" AlternateText="Delete" CausesValidation="false"
                                                OnClick="Delete_Click" BackColor="Transparent" OnClientClick="return confirm('Confirm Delete?')" BorderWidth="0"></asp:ImageButton>
                                     <asp:Label ID="SurveyStuffingAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SurveyStuffingId" Display="false">
                            </telerik:GridBoundColumn>
