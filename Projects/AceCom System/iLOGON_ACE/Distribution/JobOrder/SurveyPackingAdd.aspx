<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyPackingAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyPackingAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey Packing @ JobOrder</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab ID="AttchTab" Text="Attachment" Value="100" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="SurveyPackingAddRadPageView">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Label ID="JobOrderSurveyNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="SurveyPackingAttchRadPageView">
            </telerik:RadPageView>
