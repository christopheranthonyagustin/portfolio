<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyForkliftAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyForkliftAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey Forklift @ JobOrder</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="SurveyForkliftAttcRadPageView">
            </telerik:RadPageView>
