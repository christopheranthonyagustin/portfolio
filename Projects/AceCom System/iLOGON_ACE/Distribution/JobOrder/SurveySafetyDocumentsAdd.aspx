<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveySafetyDocumentsAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveySafetyDocumentsAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey SafetyDocuments @ Job Order</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="500px" ID="SurveySafetyDocumentsAttcRadPageView">
            </telerik:RadPageView>
