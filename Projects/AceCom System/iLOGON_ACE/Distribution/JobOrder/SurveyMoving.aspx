<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyMoving.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyMoving" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="MovingRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveyMovingId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyMovingEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyMovingDelete"
                                    ...
                                    <asp:Label ID="SurveyMovingAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="MovingPlace" UniqueName="MovingPlace" SortExpression="MovingPlace" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Moving Place">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="FloorProtection" UniqueName="FloorProtection" SortExpression="FloorProtection" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Floor Protection">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="DistanceOfMoving" UniqueName="DistanceOfMoving" SortExpression="DistanceOfMoving" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Distance Of Moving">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="PalletJack" UniqueName="PalletJack" SortExpression="PalletJack" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Pallet Jack">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SurveyMovingId" Display="false">
                            </telerik:GridBoundColumn>
