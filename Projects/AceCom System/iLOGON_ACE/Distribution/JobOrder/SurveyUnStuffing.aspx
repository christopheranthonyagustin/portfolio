<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyUnStuffing.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyUnStuffing" %>
...
<head runat="server">
    <title>Survey Unstuffing @ Job Order</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="90%" ID="UnStuffingRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="SurveyUnStuffingId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Height="50px" ItemStyle-Width="50px">
                                <ItemStyle Wrap="False"></ItemStyle>
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyUnstuffingEdit"
                                        ImageUrl="../../image/pencil.gif" Width="15" Height="15" AlternateText="Edit"
                                        OnClick="Edit_Click" BackColor="Transparent" BorderWidth="0"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="SurveyUnstuffingDelete"
                                    ...
                                    <asp:Label ID="SurveyUnStuffingAttcImage" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Container" UniqueName="Container" SortExpression="Container" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Container">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="UnCratingType" UniqueName="UnCratingType" SortExpression="UnCratingType" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="UnCratingType">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SurveyUnStuffingId" Display="false">
                            </telerik:GridBoundColumn>
