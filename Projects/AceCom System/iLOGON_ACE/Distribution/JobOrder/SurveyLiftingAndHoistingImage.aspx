<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyLiftingAndHoistingImage.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyLiftingAndHoistingImage" %>
...
<html>
<head runat="server">
     <title> Survey Lifting And Hoisting Image</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" enctype="multipart/form-data" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td colspan="2">
                    <asp:DataList ID="ImageDataList" runat="server" RepeatColumns="0" DataKeyField="JobOrderSurveyImageId"
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.JobOrderSurveyImageId")%>' onserverclick="ImageDelete" runat="server" >
