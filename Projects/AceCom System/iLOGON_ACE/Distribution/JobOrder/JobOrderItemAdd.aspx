<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobOrderItemAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.JobOrderItemAdd" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="SourceTab" Text="Source" Value="150" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Label ID="JobOrderNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="JobOrderItemAttcRadPageView">
            </telerik:RadPageView>
            <telerik:RadPageView runat="server" Height="700px" ID="SourceRadPageView">
            </telerik:RadPageView>
