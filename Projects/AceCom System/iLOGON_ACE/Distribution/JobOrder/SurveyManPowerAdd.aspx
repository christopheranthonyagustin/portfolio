<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyManPowerAdd.aspx.cs" Inherits="iWMS.Web.Distribution.JobOrder.SurveyManPowerAdd" %>
...
<head id="Head1" runat="server">
    <title>Survey ManPower @ JobOrder</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="SurveyManPowerAttcRadPageView">
            </telerik:RadPageView>
