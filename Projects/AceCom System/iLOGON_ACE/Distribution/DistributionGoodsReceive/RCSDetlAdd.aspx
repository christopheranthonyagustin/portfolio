<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RCSDetlAdd.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionGoodsReceive.RCSDetlAdd" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PurchaseOrderItemId" PageSize="50">
                ...
                <Columns>
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadDropDownList ID="UOMList" DataTextField="descr" DataValueField="item"
                                            runat="server" Width="100" AutoPostBack="true" Skin="Sunset" BackColor="#ded7c6" />
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderText="LocationBinCode">
                        ...
                        <ItemTemplate>
                            <telerik:RadComboBox ID="LocationBinCodeList" runat="server"
                                ...
                                DataTextField="descr" DataValueField="item" OnDataBound="LocationBinCodeComboBox_DataBound" RenderMode="Lightweight" Filter="Contains" BackColor="#ded7c6"
                                AutoPostBack="true" CausesValidation="false" Width="150">
                            </telerik:RadComboBox>
                            <asp:RequiredFieldValidator ID="LocationBinCodeListReqVal" runat="server" ControlToValidate="LocationBinCodeList" ErrorMessage="*" ForeColor="Red" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderText="StorageLocationCode">
                        ...
                        <ItemTemplate>
                            <telerik:RadComboBox ID="StorageLocationCodeList" runat="server"
                                ...
                                DataTextField="descr" DataValueField="item" OnDataBound="StorageLocationCodeComboBox_DataBound" RenderMode="Lightweight" Filter="Contains" BackColor="#ded7c6"
                                AutoPostBack="true" CausesValidation="false" Width="150">
                            </telerik:RadComboBox>
                            <asp:RequiredFieldValidator ID="StorageLocationCodeListReqVal" runat="server" ControlToValidate="StorageLocationCodeList" ErrorMessage="*" ForeColor="Red" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn ItemStyle-Wrap="False" HeaderText="ItemUnitLandedCost" SortExpression="LandedCostTxt" AllowFiltering="false" Display="true">
                        <ItemTemplate>
                            <telerik:RadTextBox runat="server" ID="LandedCostTxt" BackColor="#ded7c6"  AutoPostBack="true" Text='<%# DataBinder.Eval(Container.DataItem, "ExpectedReceivedQty","{0:#}") %>'></telerik:RadTextBox>                     
                            <asp:RequiredFieldValidator ID="LandedCostReq" runat="server" ErrorMessage="*" ControlToValidate="LandedCostTxt" ForeColor="Red"></asp:RequiredFieldValidator>                            
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
            ...
            <script type="text/javascript">
                function ClientValidate(sender, args) {
                    ...
                    if (NewItemQty != null && NewItemQty != "" && UOM != null && UOM != "") {
                        ...
                        $.ajax({
                            async: false,
                            url: 'RCSDetlAdd.aspx/ValidateItemQtyAndUOM',
