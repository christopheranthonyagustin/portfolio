<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionGoodsReceiveForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionGoodsReceive.DistributionGoodsReceiveForm" %>
...
<html>
<head runat="server">
    <title>Distribution Goods Receive Form</title>
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="GLDistributionRadPageView">
                        ...
                        <asp:Panel ID="NewBtnPanel" runat="server">
                            ...
                            <asp:Button ID="PopualtePIBtn" runat="server" CssClass="white" Text="PopulatePI"
                                OnClick="PopualtePIBtn_Click" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="GoodsReceiveItemId">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="PurchaseOrderNo" DataField="PurchaseOrderNo" SortExpression="PurchaseOrderNo" UniqueName="PurchaseOrderNo"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="PurchaseOrderItemLineNo" DataField="PurchaseOrderItemLineNo" SortExpression="PurchaseOrderItemLineNo" UniqueName="PurchaseOrderItemLineNo"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="ItemAvgCost" DataField="ItemAvgCost" SortExpression="ItemAvgCost" UniqueName="ItemAvgCost"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="GoodsReceiveItemStatus" DataField="GoodsReceiveItemStatusDescr" SortExpression="GoodsReceiveItemStatus" UniqueName="GoodsReceiveItemStatus"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="PurchaseOrderItemId" DataField="POItemId" UniqueName="PurchaseOrderItemId" Display="false">
                                    </telerik:GridBoundColumn>
