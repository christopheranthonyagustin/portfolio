<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PODetlRCSD.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionGoodsReceive.PODetlRCSD" %>
            ...
            <script type="text/javascript">
                function ClientValidate(sender, args) {
                    ...
                    if (NewItemQty != null && NewItemQty != "" && UOM != null && UOM != "") {
                        ...
                        $.ajax({
                            async: false,
                            url: 'PODetlRCSD.aspx/ValidateItemQtyAndUOM',
