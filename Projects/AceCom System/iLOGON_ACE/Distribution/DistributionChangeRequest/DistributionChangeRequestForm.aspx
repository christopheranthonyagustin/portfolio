<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionChangeRequestForm.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionChangeRequest.DistributionChangeRequestForm" %>
...
<html>
<head runat="server">
    <title>Distribution Change Request Form</title>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip2" MultiPageID="RadMultiPage2" AutoPostBack="true"
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab Id="ItemAttcTab" Text="Attch" Value="50" runat="server">
                        </telerik:RadTab>                
                    </Tabs>                    
                </telerik:RadTabStrip>
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="GLDistributionRadPageView">
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ChangeRequestItemId">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Line" DataField="Line" SortExpression="Line" UniqueName="Line"
                                    ...
                                    <telerik:GridBoundColumn HeaderText="ChangeRequestItemStatus" DataField="ChangeRequestItemStatusDescr" SortExpression="ChangeRequestItemStatus" UniqueName="ChangeRequestItemStatus"
                                        AllowFiltering="true" Reorderable="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="ChangeRequestItemId" Display="false">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
