<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionChangeRequestItem.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionChangeRequest.DistributionChangeRequestItem" %>
...
<head id="Head1" runat="server">
    <title>Distribution Change Request Item</title>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="ChangeRequestNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
