<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionWarehouseMasterHead.aspx.cs" Inherits="iWMS.Web.Distribution.DistributionWarehouseMaster.DistributionWarehouseMasterHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Result @ Warehouse Master</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="WarehouseId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="WarehouseDescription" UniqueName="WarehouseDescription" SortExpression="WarehouseDescription" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Description">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="WarehouseStatusDescr" UniqueName="WarehouseStatusDescr" SortExpression="WarehouseStatusDescr" ShowFilterIcon="true" AllowFiltering="true"
                                HeaderText="Status">
                            </telerik:GridBoundColumn>
