<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookPaymentAPOutstanding.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookPayment.CashBookPaymentAPOutstanding" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="APHId" PageSize="150">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="CCY" DataField="CurrCode" SortExpression="Currency" UniqueName="Currency"
                        AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0,0.00}" ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle Width="150px" />
                        <ItemStyle Width="150px" />
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn HeaderText="Supplier Code" DataField="SupplierCode" UniqueName="SupplierCode" ItemStyle-Wrap="false">
                        <HeaderStyle Width="120px" />
                        <ItemStyle Width="120px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Supplier Name" DataField="SupplierName" UniqueName="SupplierName" ItemStyle-Wrap="true" />
