<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookPaymentAPApplied.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookPayment.CashBookPaymentAPApplied" %>
...
<html>
<head runat="server">
    <title>CashBookPaymentAPApplied</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        &nbsp;
         <asp:Button ID="SumPayBtn" runat="server" CssClass="White" Text="Sum & Pay"
             OnClick="SumPayBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
        &nbsp;
