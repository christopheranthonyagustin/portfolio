<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookPaymentItemizedRecords.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookPayment.CashBookPaymentItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../CashBookPayment/CashBookPaymentHead.aspx";
        }
