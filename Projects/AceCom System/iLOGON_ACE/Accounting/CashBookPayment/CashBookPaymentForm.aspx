<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookPaymentForm.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookPayment.CashBookPaymentForm" %>
...
<html>
<head runat="server">
    <title>CashBookPaymentForm</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="APAppliedTab" Text="APApplied" Value="200" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="APOutstandingTab" Text="APOutstanding" Value="300" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="ARAppliedTab" Text="ARApplied" Value="400" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="AROutstandingTab" Text="AROutstanding" Value="500" runat="server"></telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip2" MultiPageID="RadMultiPage2" AutoPostBack="true"
                    ...
                    <Tabs>
                        <telerik:RadTab Text="GLDistribution" Value="50" runat="server">
                         ...
                         <telerik:RadTab Id="UploadGLDistribution" Text="Upload" Value="100" runat="server">
                         </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                <telerik:RadMultiPage runat="server" ID="RadMultiPage2" CssClass="outerMultiPage" SelectedIndex="0" RenderSelectedPageOnly="true">
                    <telerik:RadPageView runat="server" Height="90%" ID="GLDistributionRadPageView">
                        ...
                        &nbsp;
                        <asp:Button ID="AbsorbDifferenceBtn" runat="server" CssClass="LongLabelWhite" Text="Absorb Difference" CausesValidation="false"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="TaxType" DataField="TaxTypeDescr" SortExpression="TaxTypeDescr" UniqueName="TaxTypeDescr"
                                        AllowFiltering="true" ReadOnly="True" Reorderable="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="gvCell">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridCalculatedColumn HeaderText="PaymentNo <br/> PaymentRefNo" DataFields="PaymentNo, PaymentRefNo" Expression='{0} + " <br/>" + {1}' SortExpression="PaymentNo"
                    ...
                    <telerik:RadPageView runat="server" Height="50px" ID="UploadGLDistributionRadPageView">
                        <table>
                            <tr>
                                <td class="style1">&nbsp;
                                     <br />
                                    ...
                                    <br /><br />
                                    <asp:Button ID="UploadGLDistributionBtn" runat="server" CssClass="LongLabelWhite" Text="Upload"
                                        OnClick="UploadGLDistributionBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                                    <br /><br />
                                    <asp:Button ID="DownloadTemplateBtn" CssClass="LongLabelWhite" runat="server" OnClick="DownloadTemplateBtn_Click"
                                        Text="Download Template" UseSubmitBehavior="false" />
                                </td>
                            </tr>
                        </table>
                    </telerik:RadPageView>
            ...
            <telerik:RadPageView runat="server" Height="70%" ID="QRCodeRadPageView" />
            <telerik:RadPageView runat="server" Height="70%" ID="APAppliedRadPageView" />
            <telerik:RadPageView runat="server" Height="70%" ID="APOutstandingRadPageView" />
            <telerik:RadPageView runat="server" Height="70%" ID="ARAppliedRadPageView" />
            <telerik:RadPageView runat="server" Height="70%" ID="AROutstandingRadPageView" />
