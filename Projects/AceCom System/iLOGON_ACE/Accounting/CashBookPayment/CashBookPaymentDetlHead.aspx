<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookPaymentDetlHead.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookPayment.CashBookPaymentDetlHead" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="number" UniqueName="number" SortExpression="number"
                        HeaderText="Cash Book Payment No" ShowFilterIcon="false" AllowFiltering="false">
                    </telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="PaymentNo" UniqueName="PaymentNo" SortExpression="PaymentNo"
                        HeaderText="Payment No" ShowFilterIcon="false" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="PaymentRefNo" UniqueName="PaymentRefNo" SortExpression="PaymentRefNo"
