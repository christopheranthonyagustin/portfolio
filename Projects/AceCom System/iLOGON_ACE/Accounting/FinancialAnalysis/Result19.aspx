<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result19.aspx.cs" Inherits="iWMS.Web.Accounting.FinancialAnalysis.Result19" %>
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td>
                    ...
                    <asp:Label ID="forPeriodLbl" runat="server" class="graytitle" Text="For Period&nbsp;&nbsp;:" />
