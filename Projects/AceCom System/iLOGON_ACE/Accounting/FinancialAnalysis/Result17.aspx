<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result17.aspx.cs" Inherits="iWMS.Web.Accounting.FinancialAnalysis.Result17" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td colspan="2">
                    <asp:Label ID="Title" runat="server" class="graytitle"></asp:Label>
            ...
            <tr class="GrayTitle">
                ...
                <td>
                    ...
                    <asp:Label ID="forPeriodLbl" runat="server" class="graytitle" Text="as at Period&nbsp;&nbsp;:" />
                    <asp:Label ID="forPeriod" runat="server" class="graytitle"></asp:Label>
                    <asp:Label ID="FrDateLbl" runat="server" class="graytitle" Text="ending &nbsp;&nbsp;:" />
            ...
            <tr class="graytitle">
                <td colspan="2">
                    ...
                    <asp:Label ID="Branchlbl" runat="server" class="graytitle"></asp:Label>
                </td>
            </tr>

            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="IncludeUnpostedRecordsLbl" runat="server" class="graytitle" />
                    <asp:Label ID="IncludeUnpostedRecords" runat="server" class="graytitle"></asp:Label>
                </td>
                <tr class="graytitle">
                    <td colspan="2">
                        <asp:Label ID="Label2" runat="server" class="graytitle" Text="Printed By :" />
                        <asp:Label ID="UserText" runat="server" class="graytitle"></asp:Label>
                    </td>
                </tr>
                <tr class="graytitle">
                    <td colspan="2">
                        <asp:Label ID="DisplayAmountLbl" runat="server" class="graytitle" Text="Display Amount As :" />
                        <asp:Label ID="DisplayLbl" runat="server" class="graytitle"></asp:Label>
                    </td>
                </tr>
        </table>
