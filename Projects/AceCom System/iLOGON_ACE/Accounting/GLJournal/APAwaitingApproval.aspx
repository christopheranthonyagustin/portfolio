<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APAwaitingApproval.aspx.cs" Inherits="iWMS.Web.Accounting.GLJournal.APAwaitingApproval" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>APAwaitingApproval</title>
                ...
                <telerik:RadGrid ID="ResultDg" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="APGLAccId" UniqueName="APGLAccId" Display="false"/>
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
            </telerik:RadPageView>
