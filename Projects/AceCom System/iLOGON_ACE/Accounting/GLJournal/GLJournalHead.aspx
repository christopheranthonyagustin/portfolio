<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLJournalHead.aspx.cs" Inherits="iWMS.Web.Accounting.GLJournal.GLJournalHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GLJournalHead</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                &nbsp;
                <asp:Button ID="ConfigureRecurringBtn" CssClass="LongLabelWhite" runat="server" OnClick="ConfigureRecurringBtn_Click"
                    Text="Set as Recurring" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                &nbsp;
                <asp:Button ID="ReversePostingBtn" CssClass="LongLabelWhite" runat="server" OnClick="ReversePostingBtn_Click"
                    Text="Reverse Posting" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                &nbsp;
                   <asp:Button ID="JournalVoucherBtn" runat="server" CssClass="LongLabelBlue" Text="Journal Voucher"
                       OnClick="JournalVoucherBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                &nbsp;
                ...
                <telerik:RadGrid ID="ResultDg" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="GLDate" UniqueName="GLDate" SortExpression="GLDate"
                                HeaderText="GLDate" DataFormatString="{0:dd/MMM/yyyy}">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="ExchRate" UniqueName="ExchRate" SortExpression="ExchRate"
                                HeaderText="ExchangeRate">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="GLHDRAmt" UniqueName="GLHDRAmt" SortExpression="GLHDRAmt"
                                HeaderText="Debit" HeaderStyle-HorizontalAlign="Center">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="GLHCRAmt" UniqueName="GLHCRAmt" SortExpression="GLHCRAmt"
