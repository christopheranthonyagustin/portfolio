<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLJournalItemizedRecords.aspx.cs" Inherits="iWMS.Web.Accounting.GLJournal.GLJournalItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../GLJournal/GLJournalHead.aspx";
        }
        ...
        <asp:UpdatePanel ID="ItemizedRecordsUpdatePanel" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" AllowFilteringByColumn="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="GLHId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
