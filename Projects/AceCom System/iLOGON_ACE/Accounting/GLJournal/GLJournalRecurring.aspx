<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLJournalRecurring.aspx.cs" Inherits="iWMS.Web.Accounting.GLJournal.GLJournalRecurring" %>
...
<head runat="server">
    <title>Recurring Journal Master @ GL Journal</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>&nbsp;
                <asp:Button ID="AddBtn" CssClass="white" runat="server" OnClick="AddBtn_Click" Visible="True" Text="Set" CausesValidation="false" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                </td>
            </tr>
        </table>
