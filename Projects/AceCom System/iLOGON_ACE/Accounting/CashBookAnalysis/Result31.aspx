<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result31.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookAnalysis.Result31" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            <tr class="GrayTitle">
                <td>
                    <asp:Label ID="LblCompanyName" runat="server" class="graytitle" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr class="GrayTitle">
                <td colspan="2">
