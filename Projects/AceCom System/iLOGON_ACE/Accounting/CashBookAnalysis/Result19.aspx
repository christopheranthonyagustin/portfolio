<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result19.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookAnalysis.Result19" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <div id="div-datagrid" style="height: 92%">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" EnableLinqExpressions="False" AllowPaging="True" OnColumnCreated="ResultDG_ColumnCreated"
