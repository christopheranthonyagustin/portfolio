<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APSubledgerHead.aspx.cs" Inherits="iWMS.Web.Accounting.APSubledger.APSubledgerHead" %>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Number" UniqueName="Number" SortExpression="Number"
                                HeaderText="APNumber" ShowFilterIcon="false" AllowFiltering="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="InvoiceNo" UniqueName="InvoiceNo" SortExpression="InvoiceNo"
                                HeaderText="InvoiceNo">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="APDate" UniqueName="APDate" SortExpression="APDate"
                                HeaderText="APDate" DataFormatString="{0:dd/MMM/yyyy}">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn FilterControlWidth="0px" DataField="SuppCode" UniqueName="SuppCode" HeaderText="SupplierCode" ShowFilterIcon="false" AllowFiltering="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="SuppName" UniqueName="SuppName" HeaderText="SupplierName">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SuppName" Display="false">
                            </telerik:GridBoundColumn>
