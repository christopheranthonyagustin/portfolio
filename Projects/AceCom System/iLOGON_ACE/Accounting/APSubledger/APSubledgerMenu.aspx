<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APSubledgerMenu.aspx.cs" Inherits="iWMS.Web.Accounting.APSubledger.APSubledgerMenu" %>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">AP Subsidiary Ledger</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
