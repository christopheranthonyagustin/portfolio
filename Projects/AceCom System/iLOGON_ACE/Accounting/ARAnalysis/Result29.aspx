<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result29.aspx.cs" Inherits="iWMS.Web.Accounting.ARAnalysis.Result29" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td colspan="2">
                    <asp:Label ID="Title" runat="server" Text="AR Analysis" class="graytitle"></asp:Label>
            </tr>
            <tr class="GrayTitle">
                <td colspan="2">
                    ...
                    <asp:Label ID="FrPeriodLbl" runat="server" class="graytitle" Text="from Period&nbsp;&nbsp;:" />
                    <asp:Label ID="frPeriod" runat="server" class="graytitle"></asp:Label>
                    <asp:Label ID="ToPeriodLbl" runat="server" class="graytitle" Text="to Period&nbsp;&nbsp;:" />
        ...
        <div id="div-datagrid" style="height: 92%">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="True" EnableLinqExpressions="False" OnItemDataBound="ResultDG_ItemDataBound" OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting" OnColumnCreated="ResultDG_ColumnCreated"
