<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARClearanceAROutstanding.aspx.cs" Inherits="iWMS.Web.Accounting.ARClearance.ARClearanceAROutstanding" %>
...
<html>
<head runat="server">
    <title>ARClearanceAROutstanding</title>
    ...
    <script type="text/javascript">
        ...
        // We will refresh parent location.
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ARHId" PageSize="150" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="CCY" DataField="CurrCode" SortExpression="Currency" UniqueName="Currency"
                        AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle Width="150px" />
                        <ItemStyle Width="150px" />
                    </telerik:GridBoundColumn>
