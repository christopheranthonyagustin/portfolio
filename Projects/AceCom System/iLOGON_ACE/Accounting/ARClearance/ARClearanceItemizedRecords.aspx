<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARClearanceItemizedRecords.aspx.cs" Inherits="iWMS.Web.Accounting.ARClearance.ARClearanceItemizedRecords" %>
        ...
        <asp:UpdatePanel ID="ItemizedRecordsUpdatePanel" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" AllowFilteringByColumn="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="CHHId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
