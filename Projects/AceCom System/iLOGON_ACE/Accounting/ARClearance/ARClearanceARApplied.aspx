<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARClearanceARApplied.aspx.cs" Inherits="iWMS.Web.Accounting.ARClearance.ARClearanceARApplied" %>
...
<html>
<head runat="server">
    <title>ARClearanceARApplied</title>
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="OriginalAmount" DataField="InvoiceAmount" SortExpression="InvoiceAmount" UniqueName="InvoiceAmount"
                        AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                    </telerik:GridBoundColumn>
