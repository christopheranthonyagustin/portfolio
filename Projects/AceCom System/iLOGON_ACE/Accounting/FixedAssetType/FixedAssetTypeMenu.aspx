<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FixedAssetTypeMenu.aspx.cs" Inherits="iWMS.Web.Accounting.FixedAssetType.FixedAssetTypeMenu" %>
...
<html>
<head runat="server">
    <title>FixedAssetTypeMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Fixed Asset Type</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
