<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result29.aspx.cs" Inherits="iWMS.Web.Accounting.APAnalysis.Result29" %>
...
<body>
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="UnblancedLbl" runat="server" class="graytitle" Visible="false" Text="There are UNBALANCED transactions in this report" ForeColor="Red"/>
                </td>
            </tr>
        </table>
