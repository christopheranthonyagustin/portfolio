<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookReceiptAROutstanding.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookReceipt.CashBookReceiptAROutstanding" %>
...
<html>
<head runat="server">
    <title>CashBookReceiptAROutstanding</title>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="SearchBtn" runat="server" CssClass="white" Text="Search"
                        OnClick="SearchBtn_Click" UseSubmitBehavior="false"/>
                </td> 
            </tr>
        </table>
        <table>
        ...
        <asp:UpdatePanel ID="Panel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    AllowPaging="true" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource"  OnItemDataBound="ResultDG_ItemDataBound" Resizing-AllowColumnResize="true">
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ARHId" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Date" DataField="ARDate" SortExpression="ARDate" UniqueName="ARDate"
                            ...
                            <telerik:GridBoundColumn HeaderText="CCY" DataField="CurrCode" SortExpression="Currency" UniqueName="Currency"
                                AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0,0.00}">
                                <HeaderStyle Width="150px" />
                                <ItemStyle Width="150px" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn HeaderText="Customer Code" DataField="CustomerCode" UniqueName="CustomerCode" ItemStyle-Wrap ="false">
                                <HeaderStyle Width="120px" />
                                <ItemStyle Width="120px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Customer Name" DataField="CustomerName" UniqueName="CustomerName" ItemStyle-Wrap ="true"/>
                            <telerik:GridBoundColumn HeaderText="Status" DataField="status" UniqueName="status" Display="false" />
                            <telerik:GridBoundColumn HeaderText="ARDate" DataField="ARDate" Display="false" />
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
            </ContentTemplate>
