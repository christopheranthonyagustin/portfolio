<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookReceiptItemizedRecords.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookReceipt.CashBookReceiptItemizedRecords" %>
...
<head runat="server">
   <title id="ItemizedTitle" runat="server"></title>
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../CashBookReceipt/CashBookReceiptHead.aspx";
        }
