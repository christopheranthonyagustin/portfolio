<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookReceiptARAP.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookReceipt.CashBookReceiptARAP" %>
...
<html>
<head runat="server">
    <title>CashBookReceiptARAP</title>
        ...
        <table>
            <tr>
              <td>
                ...
                <td>
                    <asp:Button ID="UploadInvoiceBtn" runat="server" CssClass="LongLabelWhite" Text="Upload Invoice"
                        OnClick="UploadInvoiceBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                </td>
                <td>
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="OriginalAmount" DataField="InvoiceAmount" SortExpression="InvoiceAmount" UniqueName="InvoiceAmount"
                        AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0,0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn HeaderText="Customer Code" DataField="CustSuppCode" UniqueName="CustSuppCode" ItemStyle-Wrap ="false"/>
                    <telerik:GridBoundColumn HeaderText="Customer Name" DataField="CustSuppName" UniqueName="CustSuppName" ItemStyle-Wrap ="true"/>
