<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookReceiptForm.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookReceipt.CashBookReceiptForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="QRCodeTab" Text="QR Code" Value="100" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="ARAppliedTab" Text="AR Applied" Value="200" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="AROutstandingTab" Text="AR Outstanding" Value="300" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="APAppliedTab" Text="AP Applied" Value="400" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="APOutstandingTab" Text="AP Outstanding" Value="500" runat="server"></telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" ID="ARAPRadPageView" />
            <telerik:RadPageView runat="server" ID="AROutstandingRadPageView" />
            <telerik:RadPageView runat="server" ID="APAppliedRadPageView" />
