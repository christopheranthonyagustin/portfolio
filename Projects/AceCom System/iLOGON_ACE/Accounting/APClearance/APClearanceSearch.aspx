<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APClearanceSearch.aspx.cs" Inherits="iWMS.Web.Accounting.APClearance.APClearanceSearch" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server" defaultbutton="SearchBtn">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="APClearanceListDashboardRadPageView" />
