<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APClearanceAROutstanding.aspx.cs" Inherits="iWMS.Web.Accounting.APClearance.APClearanceAROutstanding" %>
...
<html>
<head runat="server">
    <title>APClearanceAROutstanding</title>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="APHId" PageSize="150">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Date" DataField="APDate" SortExpression="APDate" UniqueName="APDate"
                    ...
                    <telerik:GridBoundColumn HeaderText="APDate" DataField="APDate" Display="false" />
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
    </form>
