<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APClearanceForm.aspx.cs" Inherits="iWMS.Web.Accounting.APClearance.APClearanceForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                ...
                <telerik:RadTab Id="AttcTab" Text="Attc" Value="400" runat="server"></telerik:RadTab>
                <telerik:RadTab Id="LogTab" Text="Log" Value="500" runat="server"></telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <table>
            <tr>
