<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APClearanceMenu.aspx.cs" Inherits="iWMS.Web.Accounting.APClearance.APClearanceMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>APClearanceMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">AP Clearance</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
