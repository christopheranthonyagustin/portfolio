<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradingPartnerSupplierHead.aspx.cs" Inherits="iWMS.Web.Accounting.TradingPartner.TradingPartnerSupplierHead" %>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="TPNId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="suppliercode" ItemStyle-Wrap="false" SortExpression="suppliercode"
                                HeaderText="SupplierCode">
                            </telerik:GridBoundColumn>
