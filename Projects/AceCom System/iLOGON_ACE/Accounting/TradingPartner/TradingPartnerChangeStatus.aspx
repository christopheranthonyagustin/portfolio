<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradingPartnerChangeStatus.aspx.cs" Inherits="iWMS.Web.Accounting.TradingPartner.TradingPartnerChangeStatus" %>
...
<head runat="server">
    <title>Change Status @ Tradepartner</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <telerik:RadLabel Text="Number of Tradepartner" Font-Size="Small" runat="server"></telerik:RadLabel>
                    <br />
                    <telerik:RadTextBox ID="NumberofTradepartnerTxt" TextMode="SingleLine" runat="server" Resize="Both" Skin="WebBlue"
