<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradingPartnerCustomer.aspx.cs" Inherits="iWMS.Web.Accounting.TradingPartner.TradingPartnerCustomer" %>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="AddDate" HeaderText="Customer Code <br/> Address">
                                <ItemTemplate>
                                    <%# string.Format("{0} <br/> {1}", Eval("CustomerCode"), Eval("TPNAddrCode")) %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                             <telerik:GridTemplateColumn UniqueName="AddDate" HeaderText="ARControlAccount <br/> Currency">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="AddDate" HeaderText="Payment Term <br/> Status">
                             ...
                             <telerik:GridTemplateColumn UniqueName="AddDate" HeaderText="ReviewNotes <br/> PeppolParticipantId ">
                                <ItemTemplate>
                                    <%# string.Format("{0} <br/> {1}", Eval("ReviewNotes"), Eval("PeppolParticipantId")) %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                             <telerik:GridBoundColumn HeaderText="ModifiedOn" DataField="ModifiedOn" UniqueName="ModifiedOn" 
                                AllowFiltering="true" ReadOnly="True" Reorderable="true">
                            </telerik:GridBoundColumn>
                         </Columns>
                    </MasterTableView>
