<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradingPartnerAdd.aspx.cs" Inherits="iWMS.Web.Accounting.TradingPartner.TradingPartnerAdd" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <asp:Button ID="AddBtn" runat="server" CssClass="white" Text="Add"
                 ...
                 &nbsp;
                <asp:Button ID="GenCodeBtn" CssClass="white" runat="server" OnClick="GenerateBtn_Click" Text="Generate"
