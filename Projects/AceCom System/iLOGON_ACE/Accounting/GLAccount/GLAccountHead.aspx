<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLAccountHead.aspx.cs" Inherits="iWMS.Web.Accounting.GLAccount.GLAccountHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GLAccountHead</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                <br />
                <asp:Button ID="EditBtn" CssClass="white" runat="server" OnClick="ldEdit_Click"
