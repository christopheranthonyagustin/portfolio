<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLAccountRevenue.aspx.cs" Inherits="iWMS.Web.Accounting.GLAccount.GLAccountRevenue" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GLAccountRevenue</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="RevenueRecordsTab" Text="RevenueRecords" Value="0" runat="server">
                </telerik:RadTab>
