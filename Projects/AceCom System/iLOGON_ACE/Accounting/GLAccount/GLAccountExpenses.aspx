<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLAccountExpenses.aspx.cs" Inherits="iWMS.Web.Accounting.GLAccount.GLAccountExpenses" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GLAccountExpenses</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="ExpensesRecordsTab" Text="ExpensesRecords" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="ManageBudgetTab" Text="ManageBudget" Value="50" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="ManageBudgetRadPageView">
            </telerik:RadPageView>
