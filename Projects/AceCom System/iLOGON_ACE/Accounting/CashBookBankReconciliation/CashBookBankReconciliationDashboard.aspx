<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookBankReconciliationDashboard.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookBankReconciliation.CashBookBankReconciliationDashboard" %>
...
<head runat="server">
    <title>Cash Book Bank Reconciliation Dashboard</title>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function OnClientClose(sender, args) {
                document.getElementById('<%= WarningDashboardPanel.ClientID %>').style.visibility = 'visible';
            }
        </script>
