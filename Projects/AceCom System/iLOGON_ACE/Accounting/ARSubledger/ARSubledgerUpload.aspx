<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARSubledgerUpload.aspx.cs" Inherits="iWMS.Web.Accounting.ARSubledger.ARSubledgerUpload" %>
...
<body>
    <form id="Form1" method="post" runat="server" style="z-index: 0">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
            ...
            <Tabs>
                <telerik:RadTab Id="MainTab" Text="Upload" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
