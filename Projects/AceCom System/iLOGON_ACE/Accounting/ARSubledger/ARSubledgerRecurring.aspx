<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARSubledgerRecurring.aspx.cs" Inherits="iWMS.Web.Accounting.ARSubledger.ARSubledgerRecurring" %>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>&nbsp;
                <asp:Button ID="AddBtn" CssClass="white" runat="server" OnClick="AddBtn_Click" Visible="True" Text="Add" CausesValidation="false" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                </td>
            </tr>
        </table>
