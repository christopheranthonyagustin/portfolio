<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARSubledgerItemizedRecords.aspx.cs" Inherits="iWMS.Web.Accounting.ARSubledger.ARSubledgerItemizedRecords" %>
        ...
        <asp:UpdatePanel ID="ItemizedRecordsUpdatePanel" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight" AllowFilteringByColumn="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="ARHID">
