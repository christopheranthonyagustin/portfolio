<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result41.aspx.cs" Inherits="iWMS.Web.Accounting.GLAnalysis.Result41" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <asp:Button ID="ExcelBtn" runat="server" CssClass="LongLabelGreen" Text="Export Excel" OnClick="ExportExcel"
