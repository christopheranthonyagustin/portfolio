<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormattedReportWriterForm.aspx.cs" Inherits="iWMS.Web.Accounting.FormattedReportWriter.FormattedReportWriterForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Line" Value="10" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="800px" ID="LineRadPageView">
            </telerik:RadPageView>
