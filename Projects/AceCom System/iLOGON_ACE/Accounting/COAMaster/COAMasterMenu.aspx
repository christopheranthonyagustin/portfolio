<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="COAMasterMenu.aspx.cs" Inherits="iWMS.Web.Accounting.COAMaster.COAMasterMenu" %>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">r</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
