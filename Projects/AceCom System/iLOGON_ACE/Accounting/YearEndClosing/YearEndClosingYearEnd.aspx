<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearEndClosingYearEnd.aspx.cs" Inherits="iWMS.Web.Accounting.YearEndClosing.YearEndClosingYearEnd" %>
                ...
                <table>
                    <tr>
                        ...
                        <asp:Button ID="CloseBtn" runat="server" CssClass="white" Text="Close"
                            ...
                            &nbsp;
                              <asp:Button ID="CloseConfirmBtn" Text="" Style="display: none;" OnClick="CloseConfirmBtn_Click" runat="server" />
