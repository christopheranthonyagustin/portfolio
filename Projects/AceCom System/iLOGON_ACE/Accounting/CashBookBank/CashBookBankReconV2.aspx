<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookBankReconV2.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookBank.CashBookBankReconV2" %>
...
<head runat="server">
    <title>CashBookBankReconV2</title>
            ...
            <telerik:RadPageView runat="server" ID="MainInfoRadPageView" Height="0px">
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        ...
                        <br />
                         <telerik:RadGrid ID="ResultDG2" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight"
                            OnNeedDataSource="ResultDG2_NeedDataSource" AllowMultiRowSelection="true" OnItemDataBound="ResultDG2_ItemDataBound"
                            ExportSettings-UseItemStyles="true" AutoGenerateColumns="false">
                            <AlternatingItemStyle Wrap="false" HorizontalAlign="Center"></AlternatingItemStyle>
                            <ItemStyle Wrap="false" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Wrap="false" />
