<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookBankMenu.aspx.cs" Inherits="iWMS.Web.Accounting.CashBookBank.CashBookBankMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>CashBookBankMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Cash Book Bank</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
