<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARAPContraMenu.aspx.cs" Inherits="iWMS.Web.Accounting.ARAPContra.ARAPContraMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ARAPContraMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">AR AP Contra</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
