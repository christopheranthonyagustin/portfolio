<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARAPContraAROutstanding.aspx.cs" Inherits="iWMS.Web.Accounting.ARAPContra.ARAPContraAROutstanding" %>
...
<html>
<head runat="server">
    <title>ARAPContraAROutstanding</title>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ARHId" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="CCY" DataField="CurrCode" SortExpression="Currency" UniqueName="Currency"
                                AllowFiltering="true" ReadOnly="True" Reorderable="true" DataFormatString="{0:0.00}">
                                <HeaderStyle Width="150px" />
                                <ItemStyle Width="150px" />
                            </telerik:GridBoundColumn>
