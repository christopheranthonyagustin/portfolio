<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARAPContraHead.aspx.cs" Inherits="iWMS.Web.Accounting.ARAPContra.ARAPContraHead" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                &nbsp;
                <asp:Button ID="PrintContraBtn" runat="server" CssClass="LONGLABELBLUE" Text="Print Contra"
                    OnClick="PrintContraBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                <br />
                <br />
