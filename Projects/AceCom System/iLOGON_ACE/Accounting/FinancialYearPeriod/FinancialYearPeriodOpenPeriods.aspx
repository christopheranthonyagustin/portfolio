<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancialYearPeriodOpenPeriods.aspx.cs" Inherits="iWMS.Web.Accounting.FinancialYearPeriod.FinancialYearPeriodOpenPeriods" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>FinancialYearPeriodOpenPeriods</title>
    ...
    <form id="Form1" method="post" runat="server">
        <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
         <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Text="OpenPeriods" Value="0" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />&nbsp;
        <asp:Button ID="CloseBtn" CssClass="LongLabelWhite" runat="server" OnClick="CloseBtn_Click" Text="Close &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Period&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
         ...
         &nbsp;
         <asp:Button ID="ReopenBtn" runat="server" CssClass="LongLabelWhite" Text="Reopen &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Period&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                    OnClick="ReopenBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
        <br />
        <br />
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="PeriodId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="status" ItemStyle-Wrap="false" SortExpression="status"
                        HeaderText="status" Display="false">
                    </telerik:GridBoundColumn>
