<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EASGLMenu.aspx.cs" Inherits="iWMS.Web.BillingManagement.Interface.EASGLMenu" %>
      ...
      <td class="ModuleTitle" align="right">
        <div class="rounded-box1" style="background-color: #cc0000; width: 70%">
          ...
          <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
            ...
            <asp:Label ID="BI_Lbl" runat="server">EAS-GL</asp:Label></div>
        </div>
      </td>
    </tr>
  </table>
