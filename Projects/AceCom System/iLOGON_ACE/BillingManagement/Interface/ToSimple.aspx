<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToSimple.aspx.cs" Inherits="iWMS.Web.BillingManagement.Interface.ToSimple" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
  ...
  <table id="FormTable" border="0" cellspacing="2" cellpadding="2" width="100%" runat="server">
    ...
    <tr>
      <td colspan="2" align="right">
        ...
        <asp:Button ID="DownloadBtn" CssClass="formbtn" Text="Download" runat="server" OnClick="DownloadBtn_Click" OnClientClick="return confirm('Confirm to Download?')"/>
        <br />
  ...
  <div id="div-datagrid" style="height: 90%">
    <asp:DataGrid id="ResultDG" Runat="server" AutoGenerateColumns="false" CellPadding="2" BorderStyle="None" UseAccessibleHeader="True" ItemStyle-CssClass="preSpacing">
      <AlternatingItemStyle CssClass="DGItem"></AlternatingItemStyle>
      <ItemStyle CssClass="DGAlternateItem"></ItemStyle>
      <Columns>
        <asp:TemplateColumn ItemStyle-Wrap="false" HeaderText="SimpleInfo">
          <ItemTemplate>
            <asp:Label id = "lbName" runat="server" Text='<%#Convertor(Eval("Simpledescr")) %>' />
          </ItemTemplate>
        </asp:TemplateColumn>
        <asp:BoundColumn DataField="bisvcdtid" Visible="false" />
      </Columns>
    </asp:DataGrid>    
  </div>
  </form>
