<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BIUploadMenu.aspx.cs" Inherits="iWMS.Web.BillingManagement.BillingInstruction.BIUploadMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>BIUploadMenu</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="BACKGROUND-COLOR:#cc0000;WIDTH:70%">
							...
							<div class="box-contents1" 
                                style="PADDING-BOTTOM:5px;PADDING-LEFT:3px;PADDING-RIGHT:5px;FONT-SIZE:10pt;FONT-WEIGHT:bold;PADDING-TOP:3px;LEFT:3px; top: 0px; width: 129px;"><asp:Label id="BI_Lbl" runat="server">Upload BI</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
