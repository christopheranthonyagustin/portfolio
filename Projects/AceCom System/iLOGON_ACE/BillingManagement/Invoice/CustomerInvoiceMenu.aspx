<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerInvoiceMenu.aspx.cs" Inherits="iWMS.Web.BillingManagement.Invoice.CustomerInvoiceMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>CustomerInvoiceMenu</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="BACKGROUND-COLOR:#336600;WIDTH:60%">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px; width: 316px;">
								<asp:Label id="MenuLbl" runat="server">Generate Customer Invoice</asp:Label>
							    </div>
						</div>
					</td>
				</tr>
