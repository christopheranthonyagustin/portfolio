<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorInvoiceHead.aspx.cs" Inherits="iWMS.Web.BillingManagement.VendorInvoice.VendorInvoiceHead" %>
        ...
        <asp:Label Style="z-index: 0" ID="MessageLbl" runat="server" CssClass="errorLabel"
          ...
          <asp:datagrid id="ResultDG" runat="server" DataKeyField="id" AutoGenerateColumns="False" BorderStyle="None"
					  ...
					  <Columns>
						  ...
						  <asp:BoundColumn DataField="accode" SortExpression="accode" HeaderText="Vendor">
							  <HeaderStyle Wrap="False"></HeaderStyle>
							  <ItemStyle Wrap="False"></ItemStyle>
						  </asp:BoundColumn>
					    ...
					    <asp:BoundColumn DataField="edituser" SortExpression="edituser" ReadOnly="True" HeaderText="Edit User">
						  ...
						  <asp:BoundColumn DataField="type" SortExpression="type" HeaderText="type" visible="false" />
