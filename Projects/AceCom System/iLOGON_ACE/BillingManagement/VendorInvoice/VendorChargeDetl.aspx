<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorChargeDetl.aspx.cs" Inherits="iWMS.Web.BillingManagement.VendorInvoice.VendorChargeDetl" %>
          ...
          <td>
            <table border="0" cellpadding="2" cellspacing="2">
              <tr>
                ...
                <td Width="160px" > <asp:Label ID="AccLbl" runat="server" Text="Vendor" />  <br />
                  <asp:DropDownList ID="AccountList" runat="server" Enabled="false" DataTextField="code" DataValueField="id" Width="160px" />
                </td>
                <td Width="160px" > <asp:Label ID="CcLbl" runat="server" Text="CostCentre" />  <br />
                  <asp:DropDownList ID="CostCentreList" runat="server" DataTextField="descr" DataValueField="item" Width="160px" BackColor="Yellow" />
                </td>
              </tr>
            </table>           
          </td>
