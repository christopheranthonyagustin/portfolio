<%@ Page language="c#" Codebehind="InvInUseMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Enquiry.InvInUse.InvInUseMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvInUseMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						&nbsp;<asp:Label id="InvCountStatusLbl" runat="server">Inventory In-Use</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
