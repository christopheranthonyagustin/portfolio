<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightBillableWBChargeDetl.aspx.cs" Inherits="iWMS.Web.FreightManagement.FreightBillableWorkbench.FreightBillableWBChargeDetl" %>
        ...
        <asp:Panel ID="Panel1" runat="server" Width="300px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr align="left" valign="top">
                    <td>&nbsp;
                        <asp:Label ID="JobNoLbl" Font-Bold="true" Font-Size="Medium" runat="server"></asp:Label>
                        <br /><br />
                    </td>
                </tr>
                <tr>
                    <td nowrap class="style2" valign="top">&nbsp; Invoice:       
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td nowrap class="style2" valign="top">&nbsp; InvoiceDate:       
                        &nbsp;&nbsp;&nbsp;
                        <telerik:RadDatePicker ID="InvoiceDate" runat="server" Width="180px"
                            DateInput-DateFormat="dd/MMM/yyyy" DateInput-DisplayDateFormat="dd/MMM/yyyy" PopupDirection="BottomRight" Skin="Sunset">
                        ...
                        <asp:RequiredFieldValidator ID="InvoiceDateReqVal" runat="server"
                            ControlToValidate="InvoiceDate" ErrorMessage="*" ForeColor="Red" />
                        <br />
                        <br />
                    </td>
                </tr>
                ...
                <tr>
                    <td nowrap class="style2" valign="top">&nbsp; PaymentInfo: &nbsp;&nbsp;
