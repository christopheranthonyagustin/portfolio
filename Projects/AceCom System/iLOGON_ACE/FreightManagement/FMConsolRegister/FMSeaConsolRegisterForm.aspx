<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMSeaConsolRegisterForm.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMConsolRegister.FMSeaConsolRegisterForm" %>
...
<html>
<head runat="server">
    <title>FMSeaConsolRegisterForm</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Route" Value="50" runat="server">
                </telerik:RadTab>
                ...
                <telerik:RadTab Text="Attachment" Value="800" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="100%" ID="ScheduleRadPageView" />
