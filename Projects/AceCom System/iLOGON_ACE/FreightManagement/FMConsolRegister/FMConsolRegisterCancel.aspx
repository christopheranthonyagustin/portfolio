<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMConsolRegisterCancel.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMConsolRegister.FMConsolRegisterCancel" %>
...
<head id="Head1" runat="server">
    <title>FMConsol Register Cancel</title>
    <base target="_self" />
        ...
        <table>
            ...
            <tr>
               <td>
                ...
                <td valign="top">
                    <asp:RequiredFieldValidator ID="ReasonTxtLReqVal" runat="server" ControlToValidate="ReasonTxt" ErrorMessage="*" ForeColor="Red" />
                </td>          
            </tr>
            <tr>
                <td>
