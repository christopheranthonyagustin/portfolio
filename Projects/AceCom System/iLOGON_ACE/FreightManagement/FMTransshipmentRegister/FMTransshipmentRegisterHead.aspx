<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMTransshipmentRegisterHead.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMTransshipmentRegister.FMTransshipmentRegisterHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>FMTransshipmentRegisterHead</title>
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="POLDescr" UniqueName="POLDescr" SortExpression="POLDescr" HeaderText="POL">
                             ...
                             <telerik:GridBoundColumn DataField="PODDescr" UniqueName="PODDescr" SortExpression="PODDescr" HeaderText="LastDischarge">
                            </telerik:GridBoundColumn>
