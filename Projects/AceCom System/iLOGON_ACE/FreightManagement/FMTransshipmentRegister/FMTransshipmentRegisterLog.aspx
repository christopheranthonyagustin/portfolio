<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMTransshipmentRegisterLog.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMTransshipmentRegister.FMTransshipmentRegisterLog" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>FMTransshipmentRegisterLog</title>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                    ...
                    <Columns>
                        ...
                        <telerik:GridCalculatedColumn HeaderText="LineId" DataFields="FMTransshipmentId"
