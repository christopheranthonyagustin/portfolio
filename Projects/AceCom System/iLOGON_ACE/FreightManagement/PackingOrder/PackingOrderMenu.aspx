<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingOrderMenu.aspx.cs" Inherits="iWMS.Web.FreightManagement.PackingOrder.PackingOrderMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    ...
                    <asp:Label ID="VehicleLbl" labelclass="NewModuleTitle" runat="server"></asp:Label></div> 
                </td>
            </tr>
        </table>
    </form>
