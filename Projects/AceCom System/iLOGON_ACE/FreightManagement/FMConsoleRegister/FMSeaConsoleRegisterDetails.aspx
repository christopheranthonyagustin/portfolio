<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMSeaConsoleRegisterDetails.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMConsoleRegister.FMSeaConsoleRegisterDetails" %>
...
<html>
<head runat="server">
    <title>FMSeaConsoleRegisterDetails</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Numbers" Value="900" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
