<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMSeaJobRegisterRoute.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMJobRegister.FMSeaJobRegisterRoute" %>
                    ...
                    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                        <telerik:RadPageView runat="server" ID="HeaderRadPageView" Height="5px">
                            <asp:Panel ID="Panel1" runat="server">
                                <asp:Button ID="Button2" runat="server" CssClass="white" Text="NewRoute" ValidationGroup="reqvalgrp"
                                    OnClick="NewRoute_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                <br />
                            </asp:Panel>
                                        ...
                                        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" TableLayout="Auto">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="10px" ItemStyle-Width="10px">
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:ImageButton runat="server" Visible="True" ID="TradePartnerEdit"
