<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMAirJobRegisterForm.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMJobRegister.FMAirJobRegisterForm" %>
...
<html>
<head runat="server">
    <title>FMAirJobRegisterForm</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                                ...
                                <Items>
                                    <telerik:RadMenuItem runat="server" Text="Depature" PostBack="false" Value="Depature">
                                        <Items>
                                            ...
                                            <telerik:RadMenuItem runat="server" Value="ShippingOrder" Text="Shipping Order" />
                                        </Items>
                                    </telerik:RadMenuItem>
                                </Items>
                            </telerik:RadMenu>
                    ...
                    <telerik:RadMenu ID="ArrivalRadMenu" runat="server" ShowToggleHandle="false" ClickToOpen="true" EnableEmbeddedSkins="false"
                                ...
                                <Items>
                                    <telerik:RadMenuItem runat="server" Text="Arrival" PostBack="false" Value="Arrival">
                                        <Items>
                                            <telerik:RadMenuItem runat="server" Value="ArrivalNotice" Text="Arrival Notice" />
                                            <telerik:RadMenuItem runat="server" Value="AuthorisationRelease" Text="Authorisation Release" />
                                            <telerik:RadMenuItem runat="server" Value="AuthorisationReleaseExcel" Text="Authorisation Release(Excel)" />
                                            <telerik:RadMenuItem runat="server" Value="DeliveryOrder" Text="Delivery Order" />
                                            <telerik:RadMenuItem runat="server" Value="DepotStoringOrder" Text="Depot Storing Order" />
                                            <telerik:RadMenuItem runat="server" Value="ArrivalTruckingAdvice" Text="Trucking Advice" />
                                            <telerik:RadMenuItem runat="server" Value="LetterofIndemnity" Text=" Letter of Indemnity" />
                                            <telerik:RadMenuItem runat="server" Value="LetterofIndemnityExcel" Text=" Letter of Indemnity(Excel)" />
                                        </Items>
                                    </telerik:RadMenuItem>
                                </Items>
                            </telerik:RadMenu>
                ...
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:Label Text="MAWB" runat="server" Font-Bold="true" Font-Size="Small"></asp:Label>
                            </td>
                            <td style="font-size: smaller; font-weight: bold">:</td>
                            <td>
                                <asp:Label ID="MAWBLbl" runat="server" Font-Bold="true" Font-Size="Small"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td style="font-size: smaller; font-weight: bold">:</td>
                            <td>
                                <asp:Label ID="AirHouseBill" runat="server" Font-Bold="true" Font-Size="Small"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="100%" ID="ChargePageView" />
