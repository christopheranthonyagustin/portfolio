<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMJobRegisterItemizedRecords.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMJobRegister.FMJobRegisterItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../FMJobRegister/FMJobRegisterHead.aspx";
        }
