<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMJobRegisterPaymentHistory.aspx.cs" Inherits="iWMS.Web.FreightManagement.FMJobRegister.FMJobRegisterPaymentHistory" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>FMJobRegisterPaymentHistory</title>
                ...
                <td>
                    <div style="height: 92%" id="div1">
                        <telerik:RadGrid ID="ResultDG2" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true"
                            AllowFilteringByColumn="false" Skin="Office2007" OnNeedDataSource="ResultDG2_NeedDataSource">
