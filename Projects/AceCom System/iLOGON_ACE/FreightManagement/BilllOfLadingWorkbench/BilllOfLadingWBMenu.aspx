<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BilllOfLadingWBMenu.aspx.cs" Inherits="iWMS.Web.FreightManagement.BilllOfLadingWorkbench.BilllOfLadingWBMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>BilllOfLadingWorkbench</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Billl Of Lading Workbench</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
