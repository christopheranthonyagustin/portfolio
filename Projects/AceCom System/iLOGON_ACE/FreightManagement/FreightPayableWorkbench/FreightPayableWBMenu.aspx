<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightPayableWBMenu.aspx.cs" Inherits="iWMS.Web.FreightManagement.FreightPayableWorkbench.FreightPayableWBMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>FreightPayableWorkbench</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Freight Payable Workbench</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
