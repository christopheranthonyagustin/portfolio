<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreighPayableWBForm.aspx.cs"
    Inherits="iWMS.Web.FreightManagement.FreightPayableWorkbench.FreighPayableWBForm" %>
...
<html>
<head runat="server">
    <title>FreighPayableWBForm</title>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                <telerik:RadTab Id="PayableTab" Text="Payable" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="VendorTab" Text="Vendor Invoice" Value="100" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
                                        ...
                                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid" PageSize="50" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <Columns>
                                                <telerik:GridTemplateColumn UniqueName="Job" ItemStyle-HorizontalAlign="Center" HeaderText="Job">
                                                    <ItemTemplate>
                                                        <br />
                                                        <%# string.Format("<b>{0:}</b>" + "<br/><br/>" + "{1:}",Eval("JobNo"), Eval("JobStatusDescr")) %>
                                                        <br />
                                                    </ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="Branch" ItemStyle-HorizontalAlign="Center" HeaderText="Branch <br/> Department">
                                                    <ItemTemplate>
                                                        <br />
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="Consol" ItemStyle-HorizontalAlign="Center" HeaderText="Consol <br/> Carrier">
                                                    <ItemTemplate>
                                                        <br />
                                            ...
                                            <DetailTables>
                                                <telerik:GridTableView DataKeyNames="id" Name="ChildGrid" SkinID="Telerik" BorderColor="WhiteSmoke" BorderWidth="20px" BorderStyle="Double"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn UniqueName="LocalCostAmt" HeaderText="LocalAmt <br/> Tax">
                                                            <ItemTemplate>
                                                                <%# Eval("CostLocalAmt", "{0:n}") %>
                                                            </br>
                                                            </br>
                                                            <%# DataBinder.Eval(Container.DataItem, "CostTaxAmt")%>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="ResultDG4" runat="server" EnableLinqExpressions="False" Skin="Office2007" RenderMode="Lightweight"
                        ...
                        <iWMS:MsgPopup ID="MsgPopup4" runat="server"></iWMS:MsgPopup>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </telerik:RadPageView>
