<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MHAInterfaceMenu.aspx.cs" Inherits="iWMS.Web.Interface.MHAIncoming.MHAInterfaceMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>MHAInterface</title>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="MHAInterfaceLbl" runat="server">Interface</asp:Label>
            </td>
        </tr>
    </table>
    </form>
