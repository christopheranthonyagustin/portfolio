<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EMAILQUEUEMenu.aspx.cs" Inherits="iWMS.Web.Interface.EMAILQUEUE.EMAILQUEUEMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="EmailQueuelbl" runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    </form>
