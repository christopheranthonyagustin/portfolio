<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataTransformationServiceIgnored.aspx.cs" Inherits="iWMS.Web.Interface.DataTransformationService.DataTransformationServiceIgnored" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <telerik:RadGrid ID="ResultRadGrid" runat="server" GridLines="None" AutoGenerateColumns="false"
                    ...
                    AllowSorting="false" BorderStyle="Solid" OnNeedDataSource="ResultRadGrid_NeedDataSource"
                    Skin="Office2007">
