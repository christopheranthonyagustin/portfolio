<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataTransformationServiceItem.aspx.cs" Inherits="iWMS.Web.Interface.DataTransformationService.DataTransformationServiceItem" %>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="ItemRadPageView">
                <table border="0" cellpadding="2" cellspacing="2" runat="server">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="LoadSampleBtn" CssClass="white" runat="server" OnClick="LoadSampleBtn_Click" Text="Load Sample" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td>
                        <td>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="ItemId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
