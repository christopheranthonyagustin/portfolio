<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataTransformationServiceMapAddAndEdit.aspx.cs" Inherits="iWMS.Web.Interface.DataTransformationService.DataTransformationServiceMapAddAndEdit" %>
...
<head id="Head1" runat="server">
    <title>DataTransformationMap</title>
                        ...
                        <ContentTemplate>
                            <table>
                                <tr>
                                  ...
                                  <asp:Label ID="DataTransformationServiceNoLbl" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
