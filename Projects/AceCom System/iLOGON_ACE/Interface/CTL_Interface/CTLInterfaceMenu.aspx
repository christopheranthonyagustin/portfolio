<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTLInterfaceMenu.aspx.cs" Inherits="iWMS.Web.Interface.CTL_Interface.CTLInterfaceMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="Interfacelbl" runat="server">Interface</asp:Label>
            </td>
        </tr>
    </table>
    </form>
