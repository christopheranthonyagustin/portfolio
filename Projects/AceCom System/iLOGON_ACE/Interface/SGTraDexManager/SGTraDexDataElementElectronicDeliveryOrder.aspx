<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SGTraDexDataElementElectronicDeliveryOrder.aspx.cs" Inherits="iWMS.Web.Interface.SGTraDexManager.SGTraDexDataElementElectronicDeliveryOrder" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="700px" ID="DataElementElectronicDeliveryOrderRadPageView">
