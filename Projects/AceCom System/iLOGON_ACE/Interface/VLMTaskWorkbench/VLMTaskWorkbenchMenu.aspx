<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VLMTaskWorkbenchMenu.aspx.cs" Inherits="iWMS.Web.Interface.VLMTaskWorkbench.VLMTaskWorkbenchMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>WavePickingWorkbenchMenu</title>
