<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APILOGDashboard.aspx.cs" Inherits="iWMS.Web.Interface.APILOG.APILOGDashboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="OverView" style="width: 100%;overflow: hidden;">
            <table style="margin-left: 5px;">
                <tr>
                    <td>
                        <asp:Button ID="RefreshOverviewBtn" CssClass="LongLabelWhite" runat="server" OnClick="RefreshOverviewBtn_Click"
        ...
        <div id="Warning" style="width: 100%; margin-top: 4%">
            <table style="margin-left: 5px;">
                <tr>
                    <td>
                        <asp:Button ID="RefreshWarningBtn" CssClass="LongLabelWhite" runat="server" OnClick="RefreshWarningBtn_Click"
