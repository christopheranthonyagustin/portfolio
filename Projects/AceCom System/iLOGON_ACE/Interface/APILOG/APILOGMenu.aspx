<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APILOGMenu.aspx.cs" Inherits="iWMS.Web.Interface.APILOG.APILOGMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="APILOGlbl" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    </form>
