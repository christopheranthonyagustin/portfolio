<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveRegisterCharge.aspx.cs" Inherits="iWMS.Web.MoveManagement.MoveRegister.TransportCharge2" %>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        <td align="left">
                            ...
                            &nbsp; 
                            <asp:Button ID="BillBtn" CssClass="white" runat="server" OnClick="BillBtn_Click" Visible="True" Text="Bill"
                            ...
                            &nbsp;
                            <asp:Button ID="ApproveBtn" runat="server" CssClass="blue" ToolTip="Approve" UseSubmitBehavior="false" CausesValidation="false"
                                OnClick="ApproveBtn_Click" Text="Approve" OnClientClick="disableBtn(this.id)" />
                            &nbsp;&nbsp;
                        </td>
                        <td align="right">
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:CheckBox ID="chkObjApproveInv" runat="server" />
                                                <asp:Label ID="invnoLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "invno") %>'></asp:Label>
                                                <asp:Label ID="invStatusLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "InvStatusDescr") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center"
                                            UniqueName="chargecode" AllowFiltering="false">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ChargeDescription" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="chargedescrtxt" runat="server" Width="300px" Height="100px" TextMode="MultiLine"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Currency" HeaderStyle-HorizontalAlign="Center"
                                            AllowFiltering="false">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="Currency_ddl" runat="server" DataSource='<%# CurrencyDS%>' DataTextField="Descr"
                                                    DataValueField="Item" SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(CurrencyDS,DataBinder.Eval(Container.DataItem, "currcode").ToString())%>' />
                                                <asp:RequiredFieldValidator ID="CurrencyReqVal" runat="server" ControlToValidate="Currency_ddl"
                                                    ErrorMessage="*" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="InvStatus" Display="false">
                                        </telerik:GridBoundColumn>
