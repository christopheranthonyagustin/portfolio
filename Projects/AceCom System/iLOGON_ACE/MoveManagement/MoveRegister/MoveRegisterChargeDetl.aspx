<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveRegisterChargeDetl.aspx.cs" Inherits="iWMS.Web.MoveManagement.MoveRegister.MoveRegisterChargeDetl" %>
...
<head runat="server">
    <title>MoveRegisterChargeDetl</title>
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Charge Description" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="chargedescrText" runat="server" Width="200" Text='<%# DataBinder.Eval(Container.DataItem, "chargedescr") %>'></asp:TextBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" UniqueName="DefaultQty">
                            <ItemTemplate>
                                <asp:TextBox ID="QtyTxt" runat="server" Width="60" Text='<%# DataBinder.Eval(Container.DataItem, "DefaultQty") %>'></asp:TextBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Currency" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="CurrencyLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "currcode") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
