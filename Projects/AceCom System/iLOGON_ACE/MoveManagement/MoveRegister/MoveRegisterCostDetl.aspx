<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveRegisterCostDetl.aspx.cs" Inherits="iWMS.Web.MoveManagement.MoveRegister.MoveRegisterCostDetl" %>
...
<head runat="server">
    <title>MoveRegisterCostDetl</title>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Label ID="chargeidLbl" runat="server"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "chargeid") %>' Visible="false"></asp:Label>
                                </br>
