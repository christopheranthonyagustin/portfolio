<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyJobPlanningActivity.aspx.cs" Inherits="iWMS.Web.MoveManagement.DailyJobPlanning.DailyJobPlanningActivity" %>
...
<head runat="server">
    <title>DailyRidesPlanningActivity</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip" MultiPageID="RadMultiPage" AutoPostBack="true" OnTabClick="RadTabStrip_TabClick"
            ...
            <Tabs>
                <telerik:RadTab Id="ScheduleTab" Text="Schedule" Value="0" runat="server" Enabled="true" Selected="true">
                </telerik:RadTab>
                <telerik:RadTab Id="HandlerTab" Text="Handler" Value="100" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
    <telerik:RadMultiPage runat="server" ID="RadMultiPage" SelectedIndex="0" CssClass="outerMultiPage">
        ...
        <telerik:RadPageView runat="server" ID="HandlerPageView" Height="700px">
        </telerik:RadPageView>
