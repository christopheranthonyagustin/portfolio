<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteSurveyQuotation.aspx.cs" Inherits="iWMS.Web.MoveManagement.SiteSurvey.SiteSurveyQuotation" %>
...
<head runat="server">
    <title>Site Survey Quotation</title>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>                            
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                             ...
                             <%--   <ItemTemplate>
                                    <asp:ImageButton runat="server" Visible="True" ImageAlign="AbsMiddle" ID="QuotationEdit"
                                ...
                                <ItemStyle Wrap="False"></ItemStyle>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="qudetlid" HeaderStyle-HorizontalAlign="Center"
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Charge" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                                            UniqueName="chargedescr" AllowFiltering="false">
                                             ...
                                             <ItemTemplate>
                                                 <telerik:RadDropDownList ID="Chargedescrtxt" runat="server" DataSource='<%# ChargedescrDS%>' DataTextField="descr"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                                            UniqueName="chargedescr" AllowFiltering="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="descrtxt" runat="server" Width="100%" TextMode="MultiLine"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="TaxType" HeaderStyle-HorizontalAlign="Center"
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                 ...
                                                 <asp:RequiredFieldValidator ID="TypeVal" Runat="server" ControlToValidate="Typeddl" ErrorMessage="*"  Visible="false"/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
