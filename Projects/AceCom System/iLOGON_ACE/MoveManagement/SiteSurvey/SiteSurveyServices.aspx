<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteSurveyServices.aspx.cs" Inherits="iWMS.Web.MoveManagement.SiteSurvey.SiteSurveyServices" %>
...
<head runat="server">
    <title>SiteSurveyServices</title>
                            ...
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="quserviceid" HeaderStyle-HorizontalAlign="Center"
                                            Display="false">
                                            <ItemTemplate>
                                                <asp:Label ID="QuserviceIdLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "id") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="code" Display="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Codetxt" runat="server" Width="100%" AutoPostBack="true"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "code", "{0}") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                         <telerik:GridTemplateColumn HeaderText="Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="code">
                                            <ItemTemplate>
                                                <asp:TextBox ID="codetext" runat="server" Width="100%" AutoPostBack="true" ReadOnly="true"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "code", "{0}") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                          <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="Descriptiontxt" runat="server" Width="300px" TextMode="MultiLine"
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" UniqueName="type">
                                            <ItemTemplate>                                                
                                                <asp:TextBox ID="typetext" runat="server" Width="100%" AutoPostBack="true" ReadOnly="true"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "type", "{0}") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                          <telerik:GridTemplateColumn HeaderText="Remarks" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="True"
                                            UniqueName="Remarks" AllowFiltering="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Remarkstxt" runat="server" Width="300px" TextMode="MultiLine"
