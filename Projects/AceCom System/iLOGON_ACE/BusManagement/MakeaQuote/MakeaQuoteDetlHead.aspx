<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakeaQuoteDetlHead.aspx.cs" Inherits="iWMS.Web.BusManagement.MakeaQuote.MakeaQuoteDetlHead" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>MakeaQuoteDetlHead</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div id="div-radgrid">
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            AllowFilteringByColumn="true" Skin="Office2007" OnItemDataBound="ResultDG_ItemDataBound" OnItemCommand="ResultDG_ItemCommand">
