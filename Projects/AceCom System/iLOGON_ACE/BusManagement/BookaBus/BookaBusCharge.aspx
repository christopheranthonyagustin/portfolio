<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookaBusCharge.aspx.cs" Inherits="iWMS.Web.BusManagement.BookaBus.BookaBusCharge" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="250" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="DiscountAmt" HeaderStyle-HorizontalAlign="Center"
                         AllowFiltering="false">
                        <ItemTemplate>
                            <asp:TextBox ID="DiscountAmtTxt" runat="server" Width="60"
