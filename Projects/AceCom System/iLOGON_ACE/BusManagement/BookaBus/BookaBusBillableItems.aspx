<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookaBusBillableItems.aspx.cs" Inherits="iWMS.Web.BusManagement.BookaBus.BookaBusBillableItems" %>
...
<head runat="server">
    <title>BookaBusBillableItems</title>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" height="40">
                    <tr>
                        ...
                        <asp:Button ID="DelImgBtn" CssClass="white" runat="server"
                         ...
                         <asp:Button ID="PendingBtn" CssClass="white" runat="server" 
                             OnClick="PendingBtn_Click"  Text="Pending" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                                    &nbsp;
                        <asp:Button ID="BillBtn" CssClass="white" runat="server" OnClick="BillBtn_Click" Visible="True" Text="Bill" CausesValidation="false" 
                        ...
                        <asp:Button ID="UndoBillBtn" CssClass="white" runat="server" OnClick="UndoBillBtn_Click" Visible="True" Text="UndoBill" CausesValidation="false" 
                            ...
                            &nbsp;<br /><br />
                        <asp:Button ID="PrevItemBtn" CssClass="white" runat="server" OnClick="PrevItemBtn_Click" Visible="True" Text="Prev" Width="78px"
                            CausesValidation="false" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                    &nbsp;
                        <asp:Button ID="NextItemBtn" CssClass="white" runat="server" OnClick="NextItemBtn_Click" Visible="True" Text="Next"  Width="78px"
                            CausesValidation="false" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
...
<%--                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>--%>
                            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" PageSize="250" DataKeyNames="id">
