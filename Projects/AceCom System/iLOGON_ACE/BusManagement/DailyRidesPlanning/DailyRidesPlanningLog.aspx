<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyRidesPlanningLog.aspx.cs" Inherits="iWMS.Web.BusManagement.DailyRidesPlanning.DailyRidesPlanningLog" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>DailyRidesPlanningLog</title>
    ...
    <form id="form1" runat="server" method="post">
        ...
        <div style="height: 92%" id="div1">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="JBId">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Cat" SortExpression="Cat" HeaderText="Category"
                         ...
                         <telerik:GridBoundColumn DataField="JBCTTrId" SortExpression="JBCTTrId" HeaderText="TripId"
                            ItemStyle-Wrap="False">
                        </telerik:GridBoundColumn>
