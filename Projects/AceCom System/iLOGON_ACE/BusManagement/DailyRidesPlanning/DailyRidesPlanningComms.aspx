<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyRidesPlanningComms.aspx.cs" Inherits="iWMS.Web.BusManagement.DailyRidesPlanning.DailyRidesPlanningComms" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>DailyRidesPlanningComms</title>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="CommsType" UniqueName="CommsType" SortExpression="CommsType" HeaderText="CommsType">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Recipient" UniqueName="Recipient" SortExpression="Recipient" HeaderText="Recipient">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="RecipientName" UniqueName="RecipientName" SortExpression="RecipientName" HeaderText="RecipientName">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Sender" UniqueName="Sender" SortExpression="Sender" HeaderText="Sender">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Message" UniqueName="Message" SortExpression="Message" HeaderText="Message">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="NoOfTries" UniqueName="NoOfTries" SortExpression="NoOfTries" HeaderText="NoOfTries">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="TableName" UniqueName="TableName" SortExpression="TableName" HeaderText="TableName">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="RecordId" UniqueName="RecordId" SortExpression="RecordId" HeaderText="RecordId">
                            </telerik:GridBoundColumn>
