<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyRidesPlanningMenu.aspx.cs" Inherits="iWMS.Web.BusManagement.DailyRidesPlanning.DailyRidesPlanningMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <asp:Label ID="Label1" Style="color: Black; font-size: medium; font-weight: bold" runat="server"></asp:Label>
                </td>
