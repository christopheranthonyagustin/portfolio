<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyRidesPlanningPlan.aspx.cs" Inherits="iWMS.Web.BusManagement.DailyRidesPlanning.DailyRidesPlanningPlan" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="PlanTab" Text="Plan" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="QueueTab" Text="Queue" Value="100" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="GanttTab" Text="Gantt" Value="150" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="SMStab" Text="SMS" Value="200" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="CommsTab" Text="Comms" Value="250" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="PaymentTab" Text="Payment" Value="300" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="NotCompletedTab" Text="NotCompleted" Value="350" runat="server">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="AlternativeBtn" runat="server" CssClass="white" Text="Alternative"
                                ...
                                &nbsp;  
                            <asp:Button ID="EditRidesBtn" runat="server" CssClass="white" Text="Edit Rides"
                                OnClick="EditRidesBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                                &nbsp;                                                                
                            <asp:Button ID="SpeedUpBtn" runat="server" CssClass="white" Text="Mass Update"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="JBTripId" Name="ParentGrid" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="TourGuideName" HeaderText="TourGuideName <br> ContactNo">
                                        ...
                                        <EditItemTemplate>
                                            <br />
                                            <telerik:RadComboBox ID="TourGuideNameList" runat="server" DataTextField="descr" DataValueField="item" AllowCustomText="true"
            ...
            <telerik:RadPageView runat="server" ID="NotCompletedPageView" Height="700px">
                ...
                Skin="Office2007" OnNeedDataSource="ResultDG1_NeedDataSource" OnItemDataBound="ResultDG1_ItemDataBound" OnColumnCreated="ResultDG1_ColumnCreated"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-Width="100px" ItemStyle-Width="100px">               
                    <Columns>
                    </Columns>
                 </MasterTableView>
               </telerik:RadGrid>
