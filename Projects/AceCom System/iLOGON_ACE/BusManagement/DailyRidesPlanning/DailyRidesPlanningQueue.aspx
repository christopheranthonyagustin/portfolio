<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyRidesPlanningQueue.aspx.cs" Inherits="iWMS.Web.BusManagement.DailyRidesPlanning.DailyRidesPlanningQueue" %>
    ...
    <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="2" cellspacing="2" runat="server">
            ...
            <tr>
                ...
                <asp:Button ID="AllRidesBtn" runat="server" CssClass="LongLabelWhite" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; All Rides" OnClick="AllRidesBtn_Click"
                ...
                <asp:Button ID="ColoursBtn" runat="server" CssClass="white" OnClick="ColoursBtn_Click"
                    Text="Colours" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"/>
                </td>
            </tr>
        </table>
        <br />
