...
<%@ Page Language="c#" CodeBehind="TipMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.App.Tip.TipMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="ModuleTitle" align="right">
                    <asp:Label ID="Label1" Style="color: Black; font-size: medium; font-weight: bold" runat="server">Tip Tool</asp:Label>
                </td>
            </tr>
        </table>
    </form>
