...
<%@ Page Language="c#" CodeBehind="ListAdd.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.App.List.ListAdd" %>
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="AddBtn">
     ...
     <asp:Button ID="UpdateBtn" CssClass="white" runat="server" OnClick="UpdateBtn_Click" Visible="False"
         Text="Update" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" ToolTip="Update" />
                &nbsp;   
    <asp:Button ID="AddDetailBtn" CssClass="white" runat="server" OnClick="AddDetailBtn_Click" Visible="False"
        Text="Add Detail" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
            </telerik:RadPageView>
