...
<%@ Page language="c#" Codebehind="KittingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.VAS.Kitting.KittingMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>KittingMenu</title>
			...
			<table width="100%">
				<tr>
					<td><input type="hidden" id="tb1" value="1"><a onclick="document.getElementById('tb1').value=1;"><iwms:tabs id="MenuTabs" runat="server"></iwms:tabs></a></td>
						...
						<asp:Label id="KitDocLbl" runat="server">Kitting Document</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
