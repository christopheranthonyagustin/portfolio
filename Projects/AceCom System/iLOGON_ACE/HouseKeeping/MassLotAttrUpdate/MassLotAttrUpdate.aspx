<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MassLotAttrUpdate.aspx.cs"
    Inherits="iWMS.Web.HouseKeeping.MassLotAttrUpdate.MassLotAttrUpdate" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td colspan="2">
                <asp:Label ID="headerLbl1" runat="server" CssClass="pagetitle">Mass Lot Attribute Update :</asp:Label><br />
                <br />
            </td>
            <td width="40%">
            </td>
