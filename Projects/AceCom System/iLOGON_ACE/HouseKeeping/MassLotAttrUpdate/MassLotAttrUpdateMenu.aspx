<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MassLotAttrUpdateMenu.aspx.cs" Inherits="iWMS.Web.HouseKeeping.MassLotAttrUpdate.MassLotAttrUpdateMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>MassLotAttributeUpdate</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="BACKGROUND-COLOR:#cc0000;WIDTH:70%">
							...
							<div class="box-contents1" 
                                style="PADDING-BOTTOM:5px;PADDING-LEFT:3px;PADDING-RIGHT:5px;FONT-SIZE:10pt;FONT-WEIGHT:bold;PADDING-TOP:3px;LEFT:3px; top: 0px; width: 200px;"><asp:Label id="TextLbl" runat="server">Mass Lot Attribute Update</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
