...
<%@ Page language="c#" Codebehind="PFTRMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.HouseKeeping.PostFillingTransferReceipt.PFTRMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>PostFillingTransferReceiptMenu</title>
			...
			<table width="100%">
				<tr>
					<td><iwms:tabs id="MenuTabs" runat="server"></iwms:tabs></td>
						...
						<asp:Label id="InvTransferLbl" runat="server">Post Filling Transfer Receipt</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
