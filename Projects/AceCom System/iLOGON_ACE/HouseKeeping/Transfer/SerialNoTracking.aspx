<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialNoTracking.aspx.cs" Inherits="iWMS.Web.HouseKeeping.Transfer.SerialNoTracking" %>
...
<%--                      <asp:Button ID="MassDeleteBtn" CssClass="white" runat="server" OnClick="MassDeleteBtn_Click" Text="MassDelete" 
                     ...
                     <asp:Button ID="DeleteALLBtn" CssClass="white" runat="server" OnClick="DeleteALLBtn_Click" Text="DeleteALL" 
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                     &nbsp;
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace" >
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="skuid" HeaderText="skuid" SortExpression="skuid" ReadOnly="true" Visible ="false"></telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="TUNO2" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "tuno1")%>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="TUNO2Txt" Skin="Office2007" runat="server" Width="100px" Text='<%# DataBinder.Eval(Container.DataItem, "tuno2") %>'></telerik:RadTextBox>
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
