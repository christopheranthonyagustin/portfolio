<%@ Page Language="c#" CodeBehind="TransferAdd.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.HouseKeeping.Transfer.TransferAdd" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <br />
    &nbsp;
    <asp:Button ID="AddBtn" class="white" runat="server" OnClick="AddBtn_Click" Text="Add" Visible="true" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
    <br />
    <br>
