<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplenishmentWorkbenchMenu.aspx.cs" Inherits="iWMS.Web.HouseKeeping.ReplenishmentWorkbench.ReplenishmentWorkbenchMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ReplenishmentWorkbenchMenu</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="ReplenishmentLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
