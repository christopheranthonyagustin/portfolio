<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceMenu.aspx.cs" Inherits="iWMS.Web.HouseKeeping.Maintenance.MaintenanceMenu" %>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Maintenance</asp:Label>
                </div>
            </td>
        </tr>
    </table>
