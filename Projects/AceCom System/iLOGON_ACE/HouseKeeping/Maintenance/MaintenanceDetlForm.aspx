<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceDetlForm.aspx.cs"
    Inherits="iWMS.Web.HouseKeeping.Maintenance.MaintenanceDetlForm" %>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="pagetitle">
                ...
                <asp:Label ID="DetailLbl" Text="SKU " runat="server"></asp:Label>&nbsp;<br />
            </td>
        </tr>
        <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                        <td align="center">
                            ...
                            <input id="HIDDEN_Type" type="hidden" runat="server" />
                            <input id="HIDDEN_TfdtId" type="hidden" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <table cellspacing="2" cellpadding="2">
                                <tr>
                                    <td>
                                        ...
                                        <br>
                                            <asp:TextBox ID="TEXT_SkuCode" runat="server" AutoPostBack="True" BackColor="Yellow"
                                                OnTextChanged="TEXT_SkuCode_TextChanged" Width="155"></asp:TextBox>
                                            <br></br>
                                        </br>
                                    </td>
                                    <td>
                                    ...
                                    <asp:Panel ID="BomPanel" runat="server">
                                        <td>
                                            ...
                                            <asp:CompareValidator ID="BomQtyVal" runat="server" ErrorMessage="#" ControlToValidate="INTEGER_Qty"
                                                Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                                            <br>
                                                <asp:TextBox ID="DOUBLE_BomQty" runat="server" Width="155"></asp:TextBox>
                                            </br>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="2" cellpadding="2">
                                    <tr>
                                        <td>
                                            <asp:Label ID="RcDataLbl" runat="server">ReceivedDate</asp:Label>
                                            <br />
                                    ...
                                    <tr>
                                    <td>
                                    <asp:TextBox ID="lotidtxt" runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="lengthtxt" runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="widthtxt" runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="heightxt" runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="voltxt" runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="wttxt"  runat="server" Width="155" Visible=false></asp:TextBox>
                                    <asp:TextBox ID="netwttxt" runat="server" Width="155" Visible=false></asp:TextBox>                                    
                                    </td> 
                                    </tr>
                                </table>
                            </td>
                            ...
                            <table cellspacing="2" cellpadding="2">
                                ...
                                <tr runat="server" id="ChildSKU_Pnl" visible="false">
                                    <td colspan="7" class="style1">
                                        ...
                                        <asp:DropDownList ID="TEXT_ChildSkuLot" runat="server" Width="200" />
                                    </td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <asp:TextBox ID="TEXT_fromlot4" runat="server" Visible="false" Width="155"></asp:TextBox>
                                    </td>
                                    <td class="style1">
                                        <asp:Label ID="ToLot4Lbl" Visible="false" runat="server">ToLot4</asp:Label>
                                        <br />
                                        <asp:TextBox ID="TEXT_tolot4" runat="server" Visible="false" Width="155"></asp:TextBox>
                                    </td>
                                    <td class="style1">
                                        &nbsp;
                                    </td>
        ...
        <tr>
            <td valign="top" align="center">
                <asp:Button ID="ChooseTU1Btn" runat="server" Text="Choose TU1" OnClick="ChooseTU1Btn_Click"
                    CausesValidation="false" CssClass="detailbutton" Visible="False" Enabled="false">
                </asp:Button>&nbsp;
                <asp:Button ID="ChooseLotBtn" runat="server" Text="Choose Lot" OnClick="ChooseLotBtn_Click"
                    CausesValidation="false" CssClass="detailbutton" Visible="False" Enabled="false">
                </asp:Button>&nbsp;
            ...
            <td>
                ...
                <asp:Panel ID="ModalPanel2" runat="server" Width="100%" CssClass="ModalPopup">
                    <table width="100%" border="0" cellpadding="2" cellspacing="2">
                        <tr>
                            <td>
                                <table width="99%" border="0" align="center" cellpadding="4" cellspacing="2" style="font-family: Arial;
                                    font-size: 8pt; border-style: solid; border-color: Yellow; background-color: White;">
                                    <tr>
