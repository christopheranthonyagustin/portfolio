<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BOMLotAttrUpdate.aspx.cs"
    Inherits="iWMS.Web.HouseKeeping.BOMLotAttrUpdate.BOMLotAttrUpdate" %>

<%@ Register Src="../../Control/iFormCtl.ascx" TagName="iform" TagPrefix="iwms" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>BOMLotAttrUpdate</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td colspan="2">
                <asp:Label ID="headerLbl1" runat="server" CssClass="pagetitle">BOM Lot Attribute Update :</asp:Label><br />
                <br />
            </td>
            <td width="40%">
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <asp:Button ID="excelSend" Text=" INITIATE UPLOAD " runat="server" OnClick="excelSend_Click"
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="excelssDDL" runat="server" AutoPostBack="True" Visible="false" />
                <br />
    ...
    <div id="div-datagrid" style="height: 92%">
        <asp:DataGrid ID="ResultDG" runat="server" CellPadding="2" BorderStyle="None" UseAccessibleHeader="True"
            ...
            <Columns>
                <asp:BoundColumn DataField="error" SortExpression="error" HeaderText="Error">
                    <HeaderStyle Wrap="False"></HeaderStyle>
