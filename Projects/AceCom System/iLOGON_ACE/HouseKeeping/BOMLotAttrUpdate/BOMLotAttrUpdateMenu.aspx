<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BOMLotAttrUpdateMenu.aspx.cs" Inherits="iWMS.Web.HouseKeeping.BOMLotAttrUpdate.BOMLotAttrUpdateMenu" %>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="BACKGROUND-COLOR:#cc0000;WIDTH:70%">
							...
							<div class="box-contents1" 
                                style="PADDING-BOTTOM:5px;PADDING-LEFT:3px;PADDING-RIGHT:5px;FONT-SIZE:10pt;FONT-WEIGHT:bold;PADDING-TOP:3px;LEFT:3px; top: 0px; width: 200px;"><asp:Label id="TextLbl" runat="server">BOM Lot Attribute Update</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
