<%@ Page Language="c#" CodeBehind="InvHoldList.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.HouseKeeping.InvHold.InvHoldList" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>InvHoldList</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div id="div1">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                    <td align="Left">
                        <asp:Button ID="NextBtn" runat="server" Text="Next" Visible="True" UseSubmitBehavior="false" CssClass="white" OnClick="NextBtn_Click"></asp:Button>&nbsp;
