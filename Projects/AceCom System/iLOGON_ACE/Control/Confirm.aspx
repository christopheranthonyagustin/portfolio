<%@ Page Language="c#" CodeBehind="Confirm.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Control.Confirm" %>
        ...
        <tr>
            <td>
                <div style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px; margin: 0px;
                    overflow: auto; border-left: gray 0px solid; width: 320px; padding-top: 0px;
                    border-bottom: gray 0px solid; height: 130px">
                    <table>
                        <tr>
                            <td>
