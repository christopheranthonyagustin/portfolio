<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachmentParentChildUpload.aspx.cs" Inherits="iWMS.Web.Control.AttachmentParentChildUpload" %>
        ...
        <div class="upload-container">
            ...
            <div class="upload-popup" style="display: none;">
                ...
                <div class="upload-popup-footer">
                    ...
                    <input type="hidden" id="HiddenChildId" runat="server" />
                </div>
            </div>
            ...
            $(document).ready(function () {
                ...
                function GetPlaceholderIcon(file) {
                    ...
                    const IconMapping = {
                        ...
                        'ppt': { class: 'fa fa-file-powerpoint-o', color: 'red' },
                        'pptx': { class: 'fa fa-file-powerpoint-o', color: 'red' },
                ...
                document.getElementById('UploadBtn').addEventListener('click', () => {
                    ...
                    formData.append("ChildId", document.getElementById("HiddenChildId").value);
        ...
        <script type="text/javascript">
            function DeleteButtonClick(e, Button) {
                if (confirm("Are you sure you want to delete this image?")) {
                    ...
                    $.ajax({
                        url: 'AttachmentParentChildUpload.aspx/DeleteImage',
                        data: JSON.stringify({
                            ImageId: ImageId,
                            ImageName: ImageName
                        }),
            ...
            function SaveButtonClick(e, Button) {
                ...
                $.ajax({
                    url: 'AttachmentParentChildUpload.aspx/SaveInfo',
                    data: JSON.stringify({
                        ImageId: ImageId,
                        ImageName: ImageName,
