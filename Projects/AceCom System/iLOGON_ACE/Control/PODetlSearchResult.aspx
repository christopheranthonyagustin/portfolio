<%@ Page Language="c#" CodeBehind="PODetlSearchResult.aspx.cs" AutoEventWireup="True"
    MaintainScrollPositionOnPostback="true" Inherits="iWMS.Web.Control.PODetlSearchResult" %>
...
<body topmargin="5">
    <form id="Form1" action="PODetlSearchResult.aspx" method="post" runat="server">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <td>
                ...
                <td align="right">
                    <asp:TextBox ID="ReturnReceiveDateTxt" runat="server" ReadOnly="True" CssClass="detailButton"
                        BackColor="Transparent" BorderWidth="0"></asp:TextBox>&nbsp;
        ...
        <tr>
            <td colspan="2" valign="top">
                ...
                &nbsp;
                <asp:TextBox ID="poNoTxt" runat="server"></asp:TextBox>
                &nbsp;
    ...
    <div id="div-datagrid">
        <asp:DataGrid ID="ResultDG" runat="server" OnItemCommand="ResultDG_ItemCommand" PageSize="5"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="suname" SortExpression="suname" HeaderText="Supplier">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="poline" SortExpression="poline" HeaderText="POLineNo">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="skudescr" SortExpression="skudescr" HeaderText="Descr">
                    <HeaderStyle Wrap="False"></HeaderStyle>
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundColumn>
                <asp:TemplateColumn HeaderText="OrderedQty" ItemStyle-HorizontalAlign="Right">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "orderedqty", "{0:#,0.##}")%>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="OustandingQty" ItemStyle-HorizontalAlign="Right">
                    <ItemTemplate>
