<%@ Control Language="c#" AutoEventWireup="True" Codebehind="iHSSearchCtl.ascx.cs" Inherits="iWMS.Web.Control.iHSSearchCtl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
