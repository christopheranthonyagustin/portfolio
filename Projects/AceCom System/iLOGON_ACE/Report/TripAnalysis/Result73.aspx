<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result73.aspx.cs" Inherits="iWMS.Web.Report.TripAnalysis.Result73" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="perLbl" runat="server">Shipment Type</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="NonBill" runat="server">Non-Billable Option</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="NonBillLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="QuantumOption" runat="server">Quantum Option</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="QuantumOptionLbl" runat="server"></asp:Label>
                </td>
            </tr>  
