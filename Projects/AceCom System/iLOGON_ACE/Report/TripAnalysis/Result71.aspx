<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result71.aspx.cs" Inherits="iWMS.Web.Report.TripAnalysis.Result71" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="TitleLabel" runat="server">Trip Analysis</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="DateRangeLabel" runat="server">Date Range</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="PartnereLabel" runat="server">Partner</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="DateRangeTypeLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td class="style4">
