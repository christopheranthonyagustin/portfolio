<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result97.aspx.cs" Inherits="iWMS.Web.Report.TripAnalysis.Result97" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="TripLbl" runat="server">Personnel</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="startDateLbl" runat="server">Start Date</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
