<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result11.aspx.cs" Inherits="iWMS.Web.Report.TripAnalysis.Result11" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="TripLbl" runat="server">Format</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
