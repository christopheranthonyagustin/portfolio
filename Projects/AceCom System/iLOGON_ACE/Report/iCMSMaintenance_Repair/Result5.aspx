<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result5.aspx.cs" Inherits="iWMS.Web.Report.iCMSMaintenance_Repair.Result5" %>
...
<html>
<head runat="server">
    <title>POL Tank Requirement</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td class="style2" colspan="2">
                    <asp:Label ID="DateRangeLBL" runat="server">DateRange</asp:Label>
                </td>
                <td>:
                </td>
                &nbsp;&nbsp;<td class="style1">
                    <asp:Label ID="DateRangeDesrLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007"
            ...
            <MasterTableView AllowMultiColumnSorting="true">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="EORNo" SortExpression="EORNo" HeaderText="EORNo" />
                    <telerik:GridBoundColumn DataField="ctnrno" SortExpression="ctnrno" HeaderText="TankNo" />
                    <telerik:GridBoundColumn DataField="lastcommodity" SortExpression="lastcommodity" HeaderText="LastCommodity" />
                    <telerik:GridBoundColumn DataField="commodity" SortExpression="commodity" HeaderText="Commodity" />
                    <telerik:GridBoundColumn DataField="eqpspecialinstruction" SortExpression="eqpspecialinstruction" HeaderText="POLTankRequirement" />
                    <telerik:GridBoundColumn DataField="expgateoutdate" SortExpression="expgateoutdate" HeaderText="ReleaseDate"
                        DataFormatString="{0:dd/MMM/yyyy}" />
                    <telerik:GridBoundColumn DataField="POLCEDate" SortExpression="POLCEDate" HeaderText="POLCEDate"
                        DataFormatString="{0:dd/MMM/yyyy}" />
                    ...
                    <telerik:GridBoundColumn DataField="POLCEDepotServicePtdescr" SortExpression="POLCEDepotServicePtdescr" HeaderText="POLDepot" />
                    <telerik:GridBoundColumn DataField="PODREDepotServicePtdescr" SortExpression="PODREDepotServicePtdescr" HeaderText="PODDepot" />
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
    </form>
