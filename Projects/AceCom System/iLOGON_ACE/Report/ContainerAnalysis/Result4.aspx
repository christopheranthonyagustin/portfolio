<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result4.aspx.cs" Inherits="iWMS.Web.Report.ContainerAnalysis.Result4" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" EnableLinqExpressions="False" AllowPaging="True"
            ...
            ExportSettings-UseItemStyles="true" GridLines="Both"
            OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting">
