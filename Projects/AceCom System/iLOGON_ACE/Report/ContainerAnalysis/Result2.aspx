<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Report.ContainerAnalysis.Result2" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">

<html>
<head>
    <title>LeaseExpirySchedule</title>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="4">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">iCMS Container Analysis </asp:Label><asp:Label
        ...
        <tr>
            <td class="style2">
                <asp:Label ID="DateTimeLbl" runat="server">Generated Date & Time </asp:Label>
            </td>
            <td>
                :
            </td>
