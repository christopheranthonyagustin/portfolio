<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.VehiclePerformanceAnalysis.Search" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
             <td>
                Format
             <br />  
                 <telerik:RadDropDownList ID="output_ddl" runat="server" Skin="WebBlue" OnSelectedIndexChanged="outputddl_SelectedIndexChanged" AutoPostBack="true"/>
             </td>
             </table>
            </tr>
            ...
            <tr>
             ...
             VehicleOpsUnit
             <br />
                 <telerik:RadDropDownList ID="opsunitcode_ddl" runat="server" Skin="WebBlue" AutoPostBack="true" />
             </td>
            </tr>
            <tr>
             <td>
