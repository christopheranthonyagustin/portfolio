...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.DrListingByAccount.Search" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>RevenueByAccount</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <tr>
        <td></td>
        <td>
            <asp:Button ID="CompileBtn" CausesValidation="false" runat="server" Text="Compile" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"
