<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.StockBalanceBySKU2.Menu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>StockBalanceBySKU</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="BACKGROUND-COLOR:#660000;WIDTH:30%">
							...
							<div class="box-contents1" style="PADDING-BOTTOM:5px;PADDING-LEFT:3px;PADDING-RIGHT:5px;FONT-SIZE:10pt;FONT-WEIGHT:bold;PADDING-TOP:3px;LEFT:2px">
								<asp:Label id="ReportNameLbl" runat="server">Stock Balance Detail By SKU</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
