<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCCPARBreakDown.aspx.cs" Inherits="iWMS.Web.Report.NCCPARBreakDown.NCCPARBreakDown" %>
   ...
   <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="500px">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>   
                        ...
                        <td style="width: 400px" valign="top">
                            <telerik:RadListBox ID="NCCPARStatus" runat="server" AllowDelete="false" 
                                ...
                                ontransferred="NCCPARStatus_Transferred" SelectionMode="Multiple" Skin="Sunset" 
                                TransferMode="Move" TransferToID="SelectedNCCPARStatus" Width="200px">
                            </telerik:RadListBox>
                        </td>
                        <td style="width: 400px" valign="top">
                            <telerik:RadListBox ID="SelectedNCCPARStatus" runat="server" 
     ...
     <table>
        <tr>
            <td>
                <asp:Label ID="MessageLbl" runat="server" CssClass="errorLabel" 
                    Style="z-index: 0" Visible="False"></asp:Label>
            </td>
        </tr>
        </table>
    </asp:Panel>
