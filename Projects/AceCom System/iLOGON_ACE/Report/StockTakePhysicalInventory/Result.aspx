<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.StockTakePhysicalInventory.Result" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>StockTake Physical Inventory</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%" id="report" runat="server">
            ...
            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Date :</asp:Label> 
        ...
        <tr>
                <td colspan="2">
                    <asp:Label ID="TiTleLbl2" runat="server" CssClass="Graytitle">Type :</asp:Label>                   
                    <asp:Label ID="ICTypelbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td>
                    <asp:Label ID="DateLbl" runat="server">GeneratedDate =</asp:Label>
