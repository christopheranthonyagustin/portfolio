<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryStatusTrackerVehicleMapPoint.aspx.cs" Inherits="iWMS.Web.Report.DeliveryStatusTracker.DeliveryStatusTrackerVehicleMapPoint" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            string[] coordsCont = (string[])ViewState["MapPointsTimeStamp"];
            string[] vehno = (string[])ViewState["MapPointsVehno"];
            string[] perid = (string[])ViewState["MapPointsPerName"];
            string[] partner = (string[])ViewState["MapPointsPartner"];
