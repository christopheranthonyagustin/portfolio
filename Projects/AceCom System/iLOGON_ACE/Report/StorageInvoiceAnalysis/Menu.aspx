<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.StorageInvoiceAnalysis.Menu" %>
    ...
    <tr>
        <td align="left">
            <div class="NewModuleTitle">
                <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Storage Invoice Analysis</asp:Label></div>
        </td>
        </tr>
    </table>
    </form>
