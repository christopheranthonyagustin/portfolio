<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListOfLocationMenu.aspx.cs" Inherits="iWMS.Web.Report.ListOfLocation.ListOfLocation" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>ListOfLocationMenu</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								<asp:Label id="ReportLbl" runat="server">List Of Location</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
