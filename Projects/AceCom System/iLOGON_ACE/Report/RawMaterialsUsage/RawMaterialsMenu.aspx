<%@ Page language="c#" Codebehind="RawMaterialsMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.RawMaterialsUsage.RawMaterialsMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>RawMaterialsMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
							<div class="rounded-box1" style="width:40%;background-color:#660000;">
						...
						<asp:Label id="RawMaterialsLbl" runat="server">Raw Materials Usage</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
