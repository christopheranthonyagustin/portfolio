<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Report.ThroughputAnalysis.Result2" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Throughput Analysis [ForecastWRCWISWeeklybyNetwt]</title>
...
<body>
   <form id="form1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="style2" colspan="4">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Throughput Analysis</asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style2" colspan="2">
                <asp:Label ID="DateLbl" runat="server">From Date</asp:Label>
            </td>
            <td>
                :
            </td>
        ...
        <tr>
            <td class="style2" colspan="2">
                <asp:Label ID="PeriodLbl" runat="server">No Of Week</asp:Label>
            </td>
            <td>
                :
            </td>
            <td colspan="2">
                <asp:Label ID="NoPeriodLbl" runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
