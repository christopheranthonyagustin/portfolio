<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.ThroughputAnalysis.Result" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%" id="report" runat="server">
        ...
        <tr class="graytitle">
            ...
            <td colspan="2">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Throughput Analysis 
                Report</asp:Label>
        ...
        <tr class="graytitle">
            <td class="style1">
                <asp:Label ID="StatusHeaderLbl" runat="server">SkuGroup</asp:Label>
            </td>
            <td>
                :
            </td>
