<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.LocalDistriByDest.Menu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="ReportLbl" runat="server">Local Distribution By Destination</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
