<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.PSAFEDIRebateAnalysis.Result" %>
...
<body>
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Skin="Silk">
        ...
        <ChartTitle Text="PSA Rebates Analysis">
        </ChartTitle>
        <Legend>
