<%@ Page language="c#" Codebehind="AgeingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.Ageing.AgeingMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>AgeingMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="ReportLbl" runat="server">Inventory Ageing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
