<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.TripSumByTptType.Menu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="ReportLbl" runat="server">Trip Summary By Transport Type</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
