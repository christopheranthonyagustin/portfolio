<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.UserAccessAuditTrail.Menu" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="15" style="border-bottom: #D5D5D5 1px solid;">
    ...
    <table width="100%">
        <tr>
            <%--Ticket #4884: AW : Enhancement to User Access Audit Trail Modified by XM 18/07/2016--%>
            <td align="left">
                <div class="NewModuleTitle">
                    <asp:Label ID="ReportLbl" runat="server">User Access Audit Trail</asp:Label>
                </div>
            </td>
            <%--<td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 30%; background-color: #660000;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        &nbsp;<asp:Label ID="ReportLbl" runat="server">User Access Audit Trail</asp:Label></div>
                </div>
            </td>--%>
        </tr>
    </table>
