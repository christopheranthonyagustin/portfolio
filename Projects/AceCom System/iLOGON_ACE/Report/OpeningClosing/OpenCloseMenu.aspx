<%@ Page language="c#" Codebehind="OpenCloseMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.OpeningClosing.OpenCloseMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>OpenCloseMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="OpenCloseLbl" runat="server">Opening Closing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
