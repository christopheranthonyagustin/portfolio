...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.JbChargeDetailSummary.Search" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>JobChargeDetailandSummary</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <tr>
        <td>
            <telerik:RadButton ID="CompileBtn" runat="server" OnClick="CompileBtn_Click" Skin="WebBlue" Text=" Complie " Style="top: 5px; left: 10px" Height="22px">
            </telerik:RadButton>
            <br />
