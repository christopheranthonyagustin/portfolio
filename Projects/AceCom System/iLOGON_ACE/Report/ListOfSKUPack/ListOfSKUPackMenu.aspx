<%@ Page language="c#" Codebehind="ListOfSKUPackMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.ListOfSKUPack.ListOfSKUPackMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>ListOfSKUPack</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								&nbsp;<asp:Label id="ReportLbl" runat="server">List Of SKU Pack</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
