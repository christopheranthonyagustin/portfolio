<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result3.aspx.cs" Inherits="iWMS.Web.Report.OpenCloseBalanceV2.Result3" %>
                ...
                <td>
                    <div id="div-datagrid" style="height: 92%">
                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="True" EnableLinqExpressions="False"
                            ...
                            EnableHeadersVisualStyles="false" EnableEmbeddedSkins="false" Width="100%" Height="490px">
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                                ...
                                <Columns>
                                    ...
                                    <%--     <telerik:GridBoundColumn DataField="FrPeriod" SortExpression="FrPeriod" HeaderText="FrPeriod"
                                        DataFormatString="{0:dd/MMM/yyyy}">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ToPeriod" SortExpression="ToPeriod" HeaderText="ToPeriod"
                                        DataFormatString="{0:dd/MMM/yyyy}">
                                    </telerik:GridBoundColumn>
