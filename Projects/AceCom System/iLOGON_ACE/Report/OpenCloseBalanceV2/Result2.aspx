<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Report.OpenCloseBalanceV2.Result2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="qunoTitleLbl" runat="server">Quotation</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="qunoLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
