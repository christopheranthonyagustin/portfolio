<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.iCMSInventoryAsAt.Result" %>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007"
        ...
        <MasterTableView AllowMultiColumnSorting="true">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="SKUStatus" SortExpression="SKUStatus" HeaderText="ContainerStatus" />
                <telerik:GridBoundColumn DataField="Condition" SortExpression="Condition" HeaderText="Condition" />
                <telerik:GridBoundColumn DataField="SKUMfgDate" SortExpression="SKUMfgDate" HeaderText="MfgDate"
                    DataFormatString="{0:dd/MMM/yyyy}" />
                <telerik:GridBoundColumn DataField="SKUGrossWt" SortExpression="SKUGrossWt" HeaderText="GrossWt" DataFormatString="{0:#,0.##}" />
                <telerik:GridBoundColumn DataField="DepotCode" SortExpression="DepotCode" HeaderText="DepotCode" />
                <telerik:GridBoundColumn DataField="OwnershipType" SortExpression="OwnershipType"
                    HeaderText="OwnershipType (Lease or Own)" />
                <telerik:GridBoundColumn DataField="srcno" SortExpression="srcno" HeaderText="StoringOrderNo" />    
                <telerik:GridBoundColumn DataField="TransDate" SortExpression="TransDate" HeaderText="StoringDate"
                    DataFormatString="{0:dd/MMM/yyyy}" />
                <telerik:GridBoundColumn DataField="HeadRemarks" SortExpression="HeadRemarks" HeaderText="Remarks" /> 
                <telerik:GridBoundColumn DataField="AgeingDays" HeaderText="AgeingDays" />
            </Columns>
        </MasterTableView>
    </telerik:RadGrid>
    </form>
