<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result5.aspx.cs" Inherits="iWMS.Web.Report.iCMSInventoryAsAt.Result5" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">iCMS Inventory from </asp:Label><asp:Label
        ...
        <tr>
            <td align="right" class="style1">
                <a id="A1" runat="server" onserverclick="ExportExcel1">
                    <img id="Img1" border="0" alt="Export to Excel" align="left" src="../../Image/excel.png"
                        runat="server">
                </a>
            </td>
            <td>
