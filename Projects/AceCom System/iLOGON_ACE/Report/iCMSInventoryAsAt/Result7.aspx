<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result7.aspx.cs" Inherits="iWMS.Web.Report.iCMSInventoryAsAt.Result7" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">

<html>
<head runat="server">
    <title>iCMS Inventory Analysis [LeaseSizeTypeSummary] Result</title>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td class="style2" colspan="4">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Lease SizeType Summary</asp:Label>
            </td>
        </tr>
        <tr>
