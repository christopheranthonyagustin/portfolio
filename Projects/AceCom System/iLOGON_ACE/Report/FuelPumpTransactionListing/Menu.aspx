<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.FuelPumpTransactionListing.Menu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>FuelPumpTransactionListing</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="15" style="BORDER-BOTTOM: #D5D5D5 1px solid;">
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				<tr>
				<%--Ticket #3019: BCC : New Fuel Pump Transaction Listing <FuelPumpTransaction_17.rpt> Modified by XM 16/06/2016--%>
					<%--<td class="style1">&nbsp;</td>
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								&nbsp;<asp:Label id="ReportLbl" runat="server">Fuel Pump Transaction Listing</asp:Label></div>
						</div>
					</td>--%>
					<td class="NewModuleTitle" align="left">
					<asp:Label id="ReportLbl" runat="server">Fuel Pump Transaction Listing</asp:Label>
					</td>
				</tr>
			</table>
		</form>
