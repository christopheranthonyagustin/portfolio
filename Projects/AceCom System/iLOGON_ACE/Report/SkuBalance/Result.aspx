<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.SkuBalance.Result" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>SkuBalance</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            ...
            <td colspan="2">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">SKU Balance in Quantity & TUNo1</asp:Label>
            </td>
        </tr>
        <tr class="graytitle">
            <td class="style1">
        ...
        <tr class="graytitle">
            <td class="style1">
                <asp:Label ID="Info2Lbl" runat="server">InclLotValue</asp:Label>
            </td>
            <td class="style2">
                :
            </td>
            <td colspan="2">
                <asp:Label ID="InfoDescr2Lbl" runat="server"></asp:Label>
            </td>
        </tr>
        <tr class="graytitle">
            <td class="style1">
