<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.SkuBalance.Menu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="ReportLbl" runat="server">SKU Balance in Quantity & TUNo1</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
