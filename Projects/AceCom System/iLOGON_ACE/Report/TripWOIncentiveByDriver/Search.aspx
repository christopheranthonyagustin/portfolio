<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.TripWOIncentiveByDriver.Search" %>
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="50%">
                                ...
                                <tr>
                                    ...
                                    <td width="25%">
                                        <asp:ListBox ID="EqpTypeList" runat="server" Rows="6" SelectionMode="Multiple" Width="100%" />
                                    </td>
                                    <td width="13%" align="center">
                                        <br />
                                        <br />
                                    ...
                                    <td width="25%">
                                        <asp:ListBox ID="SelectedEqpTypeList" runat="server" Rows="6" SelectionMode="Multiple"
