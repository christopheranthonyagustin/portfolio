<%@ Page language="c#" Codebehind="InvMvmtClassLotMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.InvMvmtClassLot.InvMvmtClassLotMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvMvmtClassLotMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="InvCountStatusLbl" runat="server">Inv Mvmt by Class & Lot</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
