<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReOrderMenu.aspx.cs" Inherits="iWMS.Web.Report.ReOrder.ReOrderMenu" %>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								&nbsp;<asp:Label id="ReportLbl" runat="server">SKU Replenishment List</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>--%>
			    ...
			    <tr>
			        <td>
                        <div class="NewModuleTitle">
                            <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">&nbsp;&nbsp;SKU Replenishment List</asp:Label></div>
                    </td>
                </tr>
			</table>
		</form>
