<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.JbSummaryListing.Menu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>JobOrderInvoiceSummary</title>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								&nbsp;<asp:Label id="ReportLbl" runat="server">Job Order Invoice Summary</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
