<%@ Page Language="c#" CodeBehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.ReceiptListingByFinalizedDate.Menu" %>
           ...
           <%-- <td class="style1">
            ...
            <%--<div class="rounded-box1" style="background-color: #660000; width: 30%">--%>
                   ...
                   <%-- <div class="box-contents1" style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px;
                        ...
                        <asp:Label ID="Label1" labelclass="NewModuleTitle"  runat="server">Receipt Summary Listing</asp:Label></div>
