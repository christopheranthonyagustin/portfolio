...
<%@ Page Language="c#" CodeBehind="SuppHistSearch.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Report.SupplierHistory.SuppHistSearch" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>SuppHistSearch</title>
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
    ...
    <table cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            <td nowrap>
                &nbsp;
                <asp:Label ID="SuppCodeLbl" runat="server">Supplier Code</asp:Label>
            </td>
            <td>
                :
                <asp:TextBox ID="SuppCodeTxtBox" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="SuppCodeReqVal" ControlToValidate="SuppCodeTxtBox"
