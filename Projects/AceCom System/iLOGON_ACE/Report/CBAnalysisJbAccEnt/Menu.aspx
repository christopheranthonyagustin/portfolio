<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.CBAnalysisJbAccEnt.Menu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="ReportLbl" runat="server">CashBook Analysis by Job Account Entity</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
