<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListOfPaymentTransSummaryResult.aspx.cs" Inherits="iWMS.Web.Report.ListOfPaymentTransaction.ListOfPaymentTransSummaryResult" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div style="height: 92%" id="div-datagrid">
        ...
        <table>
            ...
            <tr class="graytitle">                
                <td colspan="2">
                    List Of Payment Transaction (Summary)
                </td>
            </tr>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid"
                AllowPaging="true" HierarchyLoadMode="Client">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="PVDate" DataField="pvdate" DataFormatString="{0:dd/MMM/yyyy}"
                        UniqueName="pvdate" SortExpression="pvdate"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="vdid" SortExpression="VendorDocNo" HeaderText="VendorDocNo"></telerik:GridBoundColumn>
                    
                   <telerik:GridBoundColumn HeaderText="VendorDocDate" DataField="exdate1" DataFormatString="{0:dd/MMM/yyyy}"
                   UniqueName="exdate1" SortExpression="exdate1"></telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="chargecode" SortExpression="ChargeCode" HeaderText="ChargeCode" Display="false">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="chargedescr" SortExpression="ChargeDescr"  HeaderText="ChargeDescr" Display="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="recoverable" SortExpression="recoverable" HeaderText="Recoverable"
                        ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
                       <telerik:GridBoundColumn DataField="RecoverableType" SortExpression="RecoverableType" HeaderText="RecoverableType"
                        ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="RecoverableRemarks" SortExpression="RecoverableRemarks" HeaderText="RecoverableRemarks"
                        ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="jbcttrid" SortExpression="JobNo" HeaderText="JobNo" ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="vehno" SortExpression="EqpNo" HeaderText="EqpNo" ItemStyle-Wrap="False">
                    </telerik:GridBoundColumn>
