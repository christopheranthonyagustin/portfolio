<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.TPRScheduleByVehno.Menu" %>
		...
		<form id="Form1" method="post" runat="server">
            ...
            <td class="NewModuleTitle" align="right">
              <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                        ...
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Transport Schedule By Vehno</asp:Label>
                      </div>
            </td>
            </tr>
			</table>
