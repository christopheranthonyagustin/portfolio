<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.JobChargesAccrual.Result" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%" id="report" runat="server">
        ...
        <tr class="graytitle">
            ...
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">List of Job Charges Accrual</asp:Label>
            </td>
        </tr>
        <tr class="graytitle">
            <td class="style1">
       ...
       <%-- <tr class="graytitle">
        ...
        <table width="80%" id="Table1" runat="server">
        <tr>
            <td colspan="3">
