<%@ Page language="c#" Codebehind="Menu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.InvMovement.Menu" %>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								...
								<asp:Label id="InvCountStatusLbl" runat="server">Inventory Movement</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
