<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.VehUpkeepAnalysis.Result" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>VehicleUpkeepAnalysis</title>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="DateLbl" runat="server" class="graytitle" Text="Vehicle Upkeep Analysis " />
                <asp:Label ID="DateRangeLbl" runat="server" class="graytitle" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label ID="opsLbl" runat="server" class="graytitle" Text="VehicleOpsUnit :" />
                <asp:Label ID="opsunitLbl" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Skin="Silk">
        <charttitle text="Vehicle Upkeep Analysis">
        </charttitle>
        <legend>
