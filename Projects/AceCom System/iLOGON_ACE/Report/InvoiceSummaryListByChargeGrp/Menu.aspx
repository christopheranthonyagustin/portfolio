<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.InvoiceSummaryListByChargeGrp.Menu" %>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								<asp:Label id="ReportLbl" runat="server">Invoice Summary List By Charge</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
