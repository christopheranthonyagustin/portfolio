<%@ Page language="c#" Codebehind="Result3.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.InventoryByLot.Result3" %>
		...
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				...
				<td><asp:label ID="ReportLbl" Runat="server">Report</asp:label></td>
					<td>:</td>
					<td colspan="2"><asp:label id="TitleLbl" runat="server" CssClass="Graytitle">Inventory By Lot</asp:label></td>
				</tr>
				<tr class="graytitle">
			...
			<div id="div-datagrid" style="HEIGHT:85%"><asp:datagrid id="ResultDG" runat="server" AutoGenerateColumns="True" BorderStyle="None" GridLines="Both"
