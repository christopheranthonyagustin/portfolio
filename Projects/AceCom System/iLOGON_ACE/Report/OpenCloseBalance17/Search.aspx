...
<%@ Page Language="c#" CodeBehind="Search.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.OpenCloseBalance17.Search" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2"
        ...
        <tr>
            <td>
                <asp:Button ID="ExcelCompileBtn" runat="server" Text="Export" Visible="false" CssClass="white"
                ...
                <asp:Button ID="CompileBtn" runat="server" Text="Compile" CssClass="white"
                    OnClick="CompileBtn_Click" OnClientClick="busyBox.Show();"></asp:Button>&nbsp;<input
                        class="white" value="Reset" type="reset"><br>
