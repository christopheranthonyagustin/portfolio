...
<%@ Page Language="c#" CodeBehind="PayHistSearch.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Report.PaymentHistory.PayHistSearch" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PayHistSearch</title>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="FromDateReqVal" ControlToValidate="FromDateCal:ReturnTxt"
                    ErrorMessage="*" runat="server" Enabled="False"></asp:RequiredFieldValidator><asp:CustomValidator
