<%@ Page language="c#" Codebehind="PayHistMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.PaymentHistory.PayHistMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>PayHistMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="PayHistLbl" runat="server">Payment History</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
