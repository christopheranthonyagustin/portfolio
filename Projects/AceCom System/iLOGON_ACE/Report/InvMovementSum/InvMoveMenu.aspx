<%@ Page language="c#" Codebehind="InvMoveMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.InvMovementSum.InvMoveMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvMoveMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="InvMovementLbl" runat="server">Inventory Movement Summary</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
