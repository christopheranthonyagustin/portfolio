<%@ Page language="c#" Codebehind="ListOfPersonnelMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.ListOfPersonnel.ListOfPersonnelMenu" %>
			...
			<table width="100%">
                ...
                <td class="NewModuleTitle" align="right">
                  <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                            ...
                            <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">List Of Personnel</asp:Label>
                          </div>
                </td>
            </tr>					
			</table>
