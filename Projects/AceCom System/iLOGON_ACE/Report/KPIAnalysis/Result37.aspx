<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result37.aspx.cs" Inherits="iWMS.Web.Report.KPIAnalysis.Result37" %>
...
<head runat="server">
    <title>Order Line Picking Accuracy</title>
                ...
                <table>
                    <tr>
                        <td style="text-align: center; padding-top: 20px;">
                            <asp:Label runat="server" Text="Order Line Picking Accuracy" Font-Size="Large" Font-Bold="true"></asp:Label>
                            <asp:Label runat="server" Text="Target KPI : > 99.5%" Font-Size="Small" ForeColor="LightGreen" Font-Bold="true" CssClass="TargetKPILblCSS"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
