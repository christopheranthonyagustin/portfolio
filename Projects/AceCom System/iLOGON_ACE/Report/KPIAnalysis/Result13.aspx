<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result13.aspx.cs" Inherits="iWMS.Web.Report.KPIAnalysis.Result13" %>
...
<head runat="server">
    <title>Inbound Performance</title>
                ...
                <table>
                    <tr>
                        <td style="text-align: center; padding-top: 20px;">
                            <asp:Label runat="server" Text="Inbound Performance" Font-Size="Large" Font-Bold="true"></asp:Label>
