<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.TripAnalysisByShipmentType.Result" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>TripAnalysisByShipmentType</title>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="DateLbl" runat="server" class="graytitle" Text="Trip Analysis By ShipmentType " />
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Skin="Silk">
        <charttitle text="Trip Analysis By Shipment Type">
        </charttitle>
        <legend>
