<%@ Page language="c#" Codebehind="InvMoveMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.InvMovementDetl.InvMoveMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="InvMovementLbl" runat="server">Inventory Movement Detail</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
