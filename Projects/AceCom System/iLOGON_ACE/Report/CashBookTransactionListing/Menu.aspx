<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.CashBookTransactionListing.Menu" %>
        ...
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
              <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                        ...
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Cash Book Transaction Listing</asp:Label>
                      </div>
            </td>
        </tr>
        </table>
