<%@ Page Language="c#" CodeBehind="Result2.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.IssueListingByFinalizedDate.Result2" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="3">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Issue Summary Listing From</asp:Label><asp:Label
