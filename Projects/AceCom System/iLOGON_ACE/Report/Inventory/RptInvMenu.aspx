<%@ Page language="c#" Codebehind="RptInvMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.Inventory.RptInvMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>RptInvMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="InvCountStatusLbl" runat="server">Inventory</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
