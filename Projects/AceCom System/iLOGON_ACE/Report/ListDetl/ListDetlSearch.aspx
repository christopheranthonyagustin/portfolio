...
<%@ Page Language="c#" CodeBehind="ListDetlSearch.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Report.ListDetlSearch.ListDetlSearch" %>
    ...
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                <telerik:RadButton ID="ResetBtn" runat="server" Text="Reset" class="detailbutton" value="Reset" type="reset"
                OnClick="ResetBtn_Click"></telerik:RadButton>
                <br>
