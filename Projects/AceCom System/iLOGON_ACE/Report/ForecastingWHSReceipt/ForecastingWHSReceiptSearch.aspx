<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForecastingWHSReceiptSearch.aspx.cs"
    Inherits="iWMS.Web.Report.ForecastingWHSReceipt.ForecastingWHSReceiptSearch" %>
...
<html>
<head runat="server">
    <title>Forecasting Warehouse Receipt</title>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" AllowPaging="true"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" CommandItemDisplay="Top"
            ...
            <Columns>
                ...
                <%--<telerik:GridTemplateColumn UniqueName="Date2" HeaderText="Dates" DataField="Date2" Display="false">
                    <HeaderTemplate>
                        <asp:Label ID="lblUsrDef02date" runat="server" Text="Dates" Width="100px" Style="text-align: center"></asp:Label>
                    </HeaderTemplate>
                    <HeaderStyle Wrap="false" HorizontalAlign="Center" Width="100px" />
                    <ItemStyle Wrap="False" HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "Date2" , "{0:dd/MMM/yyyy}")%>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <telerik:RadDatePicker runat="server" ID="UsrDef02date" Skin="Office2007" Rows="1"
                            Width="170px" DateInput-DateFormat="dd/MMM/yyyy" DateInput-DisplayDateFormat="dd/MMM/yyyy">
                            <Calendar>
                                <SpecialDays>
                        ...
                        <asp:RequiredFieldValidator ID="UsrDef02dateReqVal" runat="server" ControlToValidate="UsrDef02date"
                            ErrorMessage="*" />
                    </EditItemTemplate>
                </telerik:GridTemplateColumn>--%>
            </Columns>
