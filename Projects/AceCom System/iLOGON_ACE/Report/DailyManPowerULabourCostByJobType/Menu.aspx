<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.DailyManPowerULabourCostByJobType.Menu" %>
    ...
    <tr>
        <td align="left">
            <div class="NewModuleTitle">
                <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Daily ManPowerUtilization & LabourCosts</asp:Label></div>
        </td>
        </tr>
    </table>
    </form>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 30%; background-color: #660000;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        &nbsp;<asp:Label ID="ReportLbl" runat="server">Daily Manpower Utilization & Labour Costs</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
