<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.DailyManPowerULabourCostByJobType.Search" %>
    ...
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
        ...
        <tr>
                                    <td class="style5"  >
                                        JobType</td>
                                    <td class="style12">
                                        <asp:ListBox ID="JobTypeList" runat="server" Rows="6" SelectionMode="Multiple" 
                                            Width="97%" />
                                    </td>
                                    ...
                                    <td class="style11" >
                                        <asp:ListBox ID="SelectedJobTypeList" runat="server" Rows="6" SelectionMode="Multiple"
                                            Width="95%" Style="background-color: Yellow;" />
                                    </td>
                                    <td >
                                    </td>
                                </tr>
