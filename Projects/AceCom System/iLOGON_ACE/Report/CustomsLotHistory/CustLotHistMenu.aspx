<%@ Page language="c#" Codebehind="CustLotHistMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.CustomsLotHistory.CustLotHistMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						&nbsp;<asp:Label id="CustLotHistLbl" runat="server">Customs LotNo History</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
