<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Report.ReceiptTaskSummary.Result" %>
         ...
         <telerik:RadGrid ID="ResultRadGrid" runat="server" GridLines="Both" AutoGenerateColumns="false"
            ...
            <MasterTableView AllowMultiColumnSorting="true" >
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Forwarder" DataField="tptername" AllowFiltering="true">
                    </telerik:GridBoundColumn>
