<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="iWMS.Web.Report.ReceiptTaskSummary.Menu" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
		<title>ReceiptTaskSummary</title>
					...
					<td class="NewModuleTitle" align="left">
						<%--<div class="rounded-box1" style="width:30%;background-color:#660000;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">--%>
								<asp:Label id="ReportLbl" runat="server">Receipt Task Summary</asp:Label>
							<%--	</div>
						</div>--%>
					</td>
				</tr>
