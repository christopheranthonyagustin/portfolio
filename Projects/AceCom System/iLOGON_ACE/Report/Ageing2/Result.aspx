<%@ Page language="c#" Codebehind="Result.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.Ageing2.Result" %>
		...
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				...
				<td><asp:label ID="ReportLbl" Runat="server">Report</asp:label></td>
					<td>:</td>
					<td colspan="2"><asp:label id="TitleLbl" runat="server" CssClass="Graytitle">Inventory Ageing</asp:label></td>
				</tr>
				<tr class="graytitle">
				...
				<tr class="graytitle">
					<td><asp:label ID="selectLbl" Runat="server">Selection Criteria</asp:label></td>
					<td>:</td>
					<td colSpan="2">
						<asp:Label id="selectionLbl" runat="server"></asp:Label></td>
				</tr>
				<tr class="graytitle">
			...
			<div id="div-datagrid" style="HEIGHT:90%; top: 0px; left: 0px;"><asp:datagrid id="ResultDG" 
