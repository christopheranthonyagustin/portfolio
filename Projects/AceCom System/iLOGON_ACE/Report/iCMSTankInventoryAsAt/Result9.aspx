<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result9.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result9" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html>
<head id="Head1" runat="server">
    <title>iCMS Tank Inventory As At [PODDoorDetails] Result</title>
