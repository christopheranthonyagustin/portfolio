<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result10.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result10" %>
...
<html>
<head runat="server">
    <title>iCMS Tank Inventory As At [DepotBalanceDetails] Result</title>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                &nbsp;&nbsp;<td class="style1">
                    <asp:Label ID="DepotDesrLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
