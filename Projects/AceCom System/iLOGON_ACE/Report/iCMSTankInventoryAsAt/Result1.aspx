<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result1.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result1" %>
...
<html>
<head runat="server">
    <title>iCMS Tank Inventory As At [TankMovementDetails] Result</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
           ...
           <tr>
                <td class="style2" colspan="4">
                    <asp:Label ID="TitleLblpickup" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="4">
                    <asp:Label ID="TitleLblpod" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                &nbsp;&nbsp;<td class="style1">
                    <asp:Label ID="CommodityLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
                    <asp:Label ID="Label2" runat="server">MovementStatus</asp:Label>
                </td>
                <td>:
                </td>
                &nbsp;&nbsp;<td class="style1">
                    <asp:Label ID="MovementStatusLbl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
