<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result8.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result8" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html>
<head id="Head1" runat="server">
    <title>iCMS Tank Inventory As At [TankInvoiceDetail] Result</title>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr>
                <td class="style2" colspan="2">
                    <asp:Label ID="AccLabl" runat="server">Account</asp:Label>
                </td>
                <td>:
                </td>
                &nbsp;&nbsp;<td class="style1">
                    <asp:Label ID="AccNameLabl" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" Skin="Office2007" OnGridExporting="ResultDG_GridExporting"
            ...
            <MasterTableView AutoGenerateColumns="true" ShowHeader="false">
                <ItemTemplate>
                    <b><u>Invoice Summary Listing</u></b>
                    <br />
                    <br />
