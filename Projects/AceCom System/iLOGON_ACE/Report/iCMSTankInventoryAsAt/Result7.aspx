<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result7.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result7" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html>
<head id="Head1" runat="server">
    <title>iCMS Tank Inventory As At [TankBookingSummary] Result</title>
