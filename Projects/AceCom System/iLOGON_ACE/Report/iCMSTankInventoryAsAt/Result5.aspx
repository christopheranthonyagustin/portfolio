<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result5.aspx.cs" Inherits="iWMS.Web.Report.iCMSTankInventoryAsAt.Result5" %>
...
<html>
<head runat="server">
    <title>iCMS Tank Inventory As At [BLHeadSummary] Result</title>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" Skin="Office2007" OnGridExporting="ResultDG_GridExporting"
            ...
            <MasterTableView AutoGenerateColumns="true" ShowHeader="false">
                <ItemTemplate>
                    ...
                    <br />
                    <telerik:RadGrid ID="SubResultDG2" runat="server" AutoGenerateColumns="True" Skin="Office2007" Width="30%"
