...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListOfAccountSearch.aspx.cs"
    Inherits="iWMS.Web.Report.ListOfAccount.ListOfAccountSearch" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>ListOfAccountSearch</title>
