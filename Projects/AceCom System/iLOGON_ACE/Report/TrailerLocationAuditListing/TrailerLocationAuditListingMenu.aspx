<%@ Page language="c#" Codebehind="TrailerLocationAuditListingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.TrailerLocationAuditListing.TrailerLocationAuditListingMenu" %>
                ...
                <tr>
                    ...
                    <td class="NewModuleTitle" align="right">
                      <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                                ...
                                <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">Trailer Location Audit Listing</asp:Label>
                              </div>
                    </td>
                </tr>
            </table>			
