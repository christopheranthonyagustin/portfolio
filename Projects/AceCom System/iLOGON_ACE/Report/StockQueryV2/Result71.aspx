<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result71.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result71" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="Label4" runat="server">Site : </asp:Label>
