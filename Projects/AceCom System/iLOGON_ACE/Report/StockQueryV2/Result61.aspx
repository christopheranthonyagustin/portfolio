<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result61.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result61" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="Label1" runat="server">AsAtDate :</asp:Label>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="Label4" runat="server">MainLot : </asp:Label>
                    <asp:Label ID="MainLotLbl" runat="server"></asp:Label> -
                    <asp:Label ID="MainLotDesc" runat="server"></asp:Label>
                </td>               
            </tr>
            <tr>
                <td>                  
