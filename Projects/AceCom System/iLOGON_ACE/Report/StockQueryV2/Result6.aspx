<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result6.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result6" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
           ...
           <tr>
            ...
            <tr>
           <td>
                <asp:Label ID="StyleLabel" runat="server" class="graytitle" Text="Style:" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:Label ID="StyleLbl" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
             <tr>
                <td colspan="2">
