<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result53.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result53" %>
...
<form id="form1" runat="server">    
        ...
        <table width="100%">
            ...
            <tr>
                <td> 
                    <asp:Button ID="Excel" CssClass="green" runat="server" OnClick="ExportExcel_Click" 
                        Text="Excel" />                                          
                </td>               
            </tr>
        </table>
