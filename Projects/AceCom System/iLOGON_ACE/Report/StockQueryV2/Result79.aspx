<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result79.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result79" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="Label3" runat="server">SiteCode</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
