<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result73.aspx.cs" Inherits="iWMS.Web.Report.StockQueryV2.Result73" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td align="left" style="width:100%">
                    <%--<asp:ImageButton ID="ExportExcelLnk" runat="server" ImageUrl="../../Image/Excel.png"
        ...
        <div id="div2" style="width: 100%; height: 100%; overflow: hidden"  >
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" Width="100%" Height="490px"
                ...
                OnGridExporting="RadGrid1_GridExporting" ExportSettings-UseItemStyles="true" OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting">
                
                <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowExpandCollapse="true">
                    <%--Ticket #6986: DNKH : Enhancement to Stock Query V2 - {sp_StockQuery_73} format (Stock Balance Now) PT --%>
