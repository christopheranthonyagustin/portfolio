<%@ Page language="c#" Codebehind="Result.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Report.CtnrSummary.Result" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>WhseCtnrSumm</title>
    ...
    <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
			...
			<table width="100%" id="report" runat="server">					
				...
				<td width = "10%"><asp:label ID="ReportLbl" Runat="server">Report</asp:label></td>
					<td>:</td>
					<td colspan="2"><asp:label id="TitleLbl" runat="server" CssClass="Graytitle">Warehouse Container Summary</asp:label>
				...
				<tr class="graytitle">
					<td><asp:label id="FmtLbl" runat="server">Format</asp:label></td>
					<td>:</td>
					<td colSpan="2">
            ...
            EnableLinqExpressions="False" AllowPaging="True"
            Skin="Office2007" OnNeedDataSource="ResultDG2_NeedDataSource" OnItemDataBound="ResultDG2_ItemDataBound" Width="25%"
            >
