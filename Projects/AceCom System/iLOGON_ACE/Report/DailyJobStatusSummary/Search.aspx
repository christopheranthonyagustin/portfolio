<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="iWMS.Web.Report.DailyJobStatusSummary.Search" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 30%; background-color: #660000;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        &nbsp;<asp:Label ID="ReportLbl" runat="server">Daily Job Status Summary</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="60%">
                    <tr>
                        ...
                        <td width="25%">
                            <asp:ListBox ID="AvailList" runat="server" Rows="10" SelectionMode="Multiple" Width="90%" />
                        </td>
