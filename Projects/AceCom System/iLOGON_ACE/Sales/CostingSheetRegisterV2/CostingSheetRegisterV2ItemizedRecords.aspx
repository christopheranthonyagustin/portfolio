<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingSheetRegisterV2ItemizedRecords.aspx.cs" Inherits="iWMS.Web.Sales.CostingSheetRegisterV2.CostingSheetRegisterV2ItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../CostingSheetRegisterV2/CostingSheetRegisterV2Head.aspx";
        }
