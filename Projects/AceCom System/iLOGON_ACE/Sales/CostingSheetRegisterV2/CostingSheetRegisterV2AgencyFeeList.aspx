<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingSheetRegisterV2AgencyFeeList.aspx.cs" Inherits="iWMS.Web.Sales.CostingSheetRegisterV2.CostingSheetRegisterV2AgencyFeeList" %>
...
<head id="Head1" runat="server">
    <title>Costing Sheet AgencyFee List</title>
    ...
    <table width="100%">
        <tr>
            <td align="right">
                ...
                <asp:Button ID="PopulateToCSButton" runat="server" Text="PopulateToCS" OnClick="PopulateToCSBtn_Click" Visible="true"
                    CssClass="LongLabelWhite" OnClientClick="disableBtn(this.id)"></asp:Button>
    ...
    <telerik:RadGrid id="ResultDG" runat="server" autogeneratecolumns="false" gridlines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderText="AgentCountry" DataField="qucountrycodedescr" AllowFiltering="false">
                </telerik:GridBoundColumn>      
                ...
                <telerik:GridBoundColumn HeaderText="EstUnitCostUOM" DataField="estunitcostuom" AllowFiltering="false">
                </telerik:GridBoundColumn>                          
            </Columns>
        </MasterTableView>
    </telerik:RadGrid>
