<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHSServiceRatesDetl.aspx.cs" Inherits="iWMS.Web.Sales.WarehouseServiceRates.WHSServiceRatesDetl" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table id="table1" border="0" cellspacing="12" cellpadding="0" runat="server">
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="BillCalcMethodInfoBtn" runat="server" Text="BCMInfo" OnClick="BillCalcMethodInfoBtn_Click" CausesValidation="False"
                        OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" CssClass="white" ToolTip="Bill Calculate Method Information" />
                </td>
            </tr>
        </table>
        <br />
