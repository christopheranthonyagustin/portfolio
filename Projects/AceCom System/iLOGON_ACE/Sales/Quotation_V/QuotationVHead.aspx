<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationVHead.aspx.cs"
    Inherits="iWMS.Web.Sales.Quotation_V.QuotationVHead" %>
...
<head id="Head1" runat="server">
    <title>Vendor Quotation Head</title>
            ...
            OnClick="DeleteAllBtn_Click" OnClientClick="return confirm('Delete all quotation lines that have not been generated into invoice?')" ToolTip="Delete all quotation lines"></asp:Button>&nbsp;
                    <asp:Button ID="ConfirmBtn" runat="server" Text="Confirm" CssClass="white"
                     ...
                     <asp:Button ID="QuotationBtn" runat="server" Text="Quotation" CssClass="blue"
                         OnClick="QuotationBtn_Click" OnClientClick="return confirm('Print Excel Quotation?')" ToolTip="Excel Quotation"></asp:Button>&nbsp;
              <asp:Button ID="QuotationExcelBtn" runat="server" Text="Quotation" CssClass="green"
                  OnClick="QuotationExcelBtn_Click" OnClientClick="return confirm('Print Quotation?')" ToolTip="Quotation"></asp:Button>&nbsp;
              <asp:Button ID="RateSheetBtn" runat="server" Text="Rate Sheet" CssClass="blue"
                  OnClick="RateSheetBtn_Click" OnClientClick="return confirm('Print Rate Sheet?')" ToolTip="Rate Sheet"></asp:Button>&nbsp;
                <asp:Button ID="RateSheetExcelBtn" runat="server" Text="Rate Sheet" CssClass="green"
                    OnClick="RateSheetExcelBtn_Click" OnClientClick="return confirm('Print Excel Rate Sheet?')" ToolTip="Rate Sheet"></asp:Button>&nbsp;
        <br />
        <br />
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" OnNeedDataSource="ResultDG_NeedDataSource"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                ...
                <DetailTables>
                    ...
                    <telerik:GridTableView DataKeyNames="id" Name="OFChildGrid" Width="100%" SkinID="Telerik" HeaderStyle-BackColor="#05538C" HeaderStyle-ForeColor="White"
                        AllowPaging="false" AllowFilteringByColumn="false" TableLayout="Fixed">
