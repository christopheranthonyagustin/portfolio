<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorQuotationV3ImageList.aspx.cs" Inherits="iWMS.Web.Sales.VendorQuotationV3.VendorQuotationV3ImageList" %>
...
<head id="Head1" runat="server">
    <title>VendorQuotationImageList</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                <td><br />
                    <asp:Button ID="AddBtn" runat="server" Text="Add" CssClass="white"
                        OnClick="AddBtn_Click" OnClientClick="disableBtn(this.id,false)" ToolTip="Add" UseSubmitBehavior="false"></asp:Button>
                    &nbsp;
                    <asp:Label
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" HeaderStyle-BackColor="#05538C" HeaderStyle-ForeColor="White">
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Wrap="false">
                        <ItemTemplate>
                            ...
                            <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onclick="return confirm('Confirm delete?')"
                                onserverclick="VQuotationImageDelete" runat="server">
                                <img id="delImg" src="../../image/bin.gif" width="15" height="15" border="0" alt="Delete VQuotation"
                                    runat="server"></a>
                        </ItemTemplate>
