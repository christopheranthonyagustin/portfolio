<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingSheetDetlHead.aspx.cs"
    Inherits="iWMS.Web.Sales.CostingSheet.CostingSheetDetlHead" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    <asp:Button ID="MassChangeBtn" runat="server" Text="Update" OnClick="MassChangeBtn_Click" Visible="True"
