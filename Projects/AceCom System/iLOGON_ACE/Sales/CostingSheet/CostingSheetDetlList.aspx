<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingSheetDetlList.aspx.cs"
    Inherits="iWMS.Web.Sales.CostingSheet.CostingSheetDetlList" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <asp:Button ID="DelImgBtn" runat="server" Text="Delete" OnClick="DeleteAllBtn_Click" Visible="true"
                    ...
                    &nbsp;
                <telerik:RadButton ID="NewOceanFreightBtn" runat="server" Text="NewOceanFreight" Visible="true"
                    CssClass="detailButton" OnClick="NewOceanFreightBtn_Click" Skin="WebBlue">
                </telerik:RadButton>
                    &nbsp;
                <telerik:RadButton ID="NewCleaningCostBtn" runat="server" Text="NewCleaningCost" Visible="true"
                    CssClass="detailButton" OnClick="NewCleaningCostBtn_Click" Skin="WebBlue">
                </telerik:RadButton>
                    &nbsp;
                <telerik:RadButton ID="NewAgencyFeeBtn" runat="server" Text="NewAgencyFee" Visible="true"
                    CssClass="detailButton" OnClick="NewAgencyFeeBtn_Click" Skin="WebBlue">
                </telerik:RadButton>
                    &nbsp;
                <telerik:RadButton ID="NewEmptyRepoCostBtn" runat="server" Text="NewEmptyRepoCost" Visible="true"
                    CssClass="detailButton" OnClick="NewEmptyRepoCostBtn_Click" Skin="WebBlue">
                </telerik:RadButton>
                    &nbsp;                
                </td>
            </tr>
