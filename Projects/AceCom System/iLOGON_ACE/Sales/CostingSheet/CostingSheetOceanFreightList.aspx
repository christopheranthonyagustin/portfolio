<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingSheetOceanFreightList.aspx.cs" Inherits="iWMS.Web.Sales.CostingSheet.CostingSheetOceanFreightList" %>
...
<head id="Head1" runat="server">
    <title>Costing Sheet OceanFreight List</title>
...
<body>
    ...
    <br /><br />
     <telerik:RadGrid ID="ResultDG"  runat="server" AutoGenerateColumns="true" 
            ...
            Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" OnItemDataBound="ResultDG_ItemDataBound" ExportSettings-UseItemStyles="true">
