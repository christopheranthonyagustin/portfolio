...
<%@ Page Language="c#" CodeBehind="QuotationHead.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Sales.Quotation_17.QuotationHead" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                        <ItemStyle Wrap="False"></ItemStyle>
                        <ItemTemplate>
                            <asp:ImageButton ID="Copybtn" runat="server" Visible="false" ImageUrl="../../image/copy.png" ToolTip="Copy"
                                Width="15" Height="15" AlternateText="Copy" BackColor="Transparent" OnClick="CopyBtn_Click"
                                BorderWidth="0"></asp:ImageButton>&nbsp;&nbsp;
                                <asp:ImageButton ID="Deletebtn" runat="server" Visible="false" ImageUrl="../../image/bin.gif" ToolTip="Delete"
                                    Width="15" Height="15" AlternateText="Delete" BackColor="Transparent" OnClick="Deletebtn_Click1"
                              ...
                              <asp:ImageButton ID="ConfirmBtn" runat="server" Visible="false" ImageUrl="../../image/finalize.gif" ToolTip="Confirm"
                                  ...
                                  OnClientClick="return confirm('Proceed to Confirm Quotation?');"
                                  BorderWidth="0"></asp:ImageButton>&nbsp;&nbsp;                                                                      
                        </ItemTemplate>
                        <ItemStyle Wrap="false" />
                    </telerik:GridTemplateColumn>
