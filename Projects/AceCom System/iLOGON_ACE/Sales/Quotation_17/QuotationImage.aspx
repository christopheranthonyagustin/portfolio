<%@ Page Language="c#" CodeBehind="QuotationImage.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Sales.Quotation_17.QuotationImage" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="ImageSubmit" runat="server" Text="Upload" OnClick="ImageSubmit_ServerClick"
                                        OnClientClick="disableBtn(this.id,false)" CssClass="white" ToolTip="Upload" UseSubmitBehavior="false" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
