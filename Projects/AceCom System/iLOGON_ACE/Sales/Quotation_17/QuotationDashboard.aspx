<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDashboard.aspx.cs" Inherits="iWMS.Web.Sales.Quotation_17.QuotationDashboard" %>
...
<head runat="server">
    <title>QuotationRegister Dashboard</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadWindow ID="RadWindow" runat="server" VisibleOnPageLoad="true" Width="1000px" Height="600px" OnClientClose="OnClientClose"
