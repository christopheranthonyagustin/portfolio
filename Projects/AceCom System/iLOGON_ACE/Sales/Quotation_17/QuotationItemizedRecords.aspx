<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationItemizedRecords.aspx.cs" Inherits="iWMS.Web.Sales.Quotation_17.QuotationItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../Quotation_17/QuotationHead.aspx";
        }
