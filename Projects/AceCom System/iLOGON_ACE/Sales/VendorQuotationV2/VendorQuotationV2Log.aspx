<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorQuotationV2Log.aspx.cs" Inherits="iWMS.Web.Sales.VendorQuotationV2.VendorQuotationV2Log" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>VendorQuotationV2Log</title>
