<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorQuotationV2Form.aspx.cs" Inherits="iWMS.Web.Sales.VendorQuotationV2.VendorQuotationV2Form" %>
...
<head id="Head1" runat="server">
    <title>VendorQuotationV2Form</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            AutoPostBack="true" CausesValidation="false" Skin="Office2007">
            <Tabs>
