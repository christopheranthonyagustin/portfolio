<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorQuotationV2Head.aspx.cs" Inherits="iWMS.Web.Sales.VendorQuotationV2.VendorQuotationV2Head" %>
...
<html>
<head runat="server">
    <title>VendorQuotationV2Head</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" CausesValidation="false" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Text="MainGrid" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="False" OnNeedDataSource="ResultDG_NeedDataSource"
            AllowPaging="True" AllowFilteringByColumn="True" Skin="Office2007" OnItemDataBound="ResultDG_ItemDataBound"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Name" DataField="pname" AllowFiltering="true"
                        ColumnGroupName="pname" SortExpression="pname" UniqueName="pname" Reorderable="true">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn HeaderText="PIC" DataField="smancodedescr" AllowFiltering="true"
