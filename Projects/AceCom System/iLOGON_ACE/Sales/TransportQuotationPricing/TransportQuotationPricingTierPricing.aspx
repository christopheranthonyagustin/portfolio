<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportQuotationPricingTierPricing.aspx.cs" Inherits="iWMS.Web.Sales.TransportQuotationPricing.TransportQuotationPricingTierPricing" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div>
            <telerik:RadGrid ID="QUSDetDG" runat="server" AutoGenerateColumns="false" GridLines="Both" OnCancelCommand="QUSDetDG_Cancel"
                ...
                OnItemDataBound="QUSDetDG_ItemDataBound" CellPadding="2" UseAccessibleHeader="True" Skin="Office2007">
                <ClientSettings>
