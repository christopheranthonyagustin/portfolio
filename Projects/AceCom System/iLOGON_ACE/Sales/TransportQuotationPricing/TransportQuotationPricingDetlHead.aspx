<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportQuotationPricingDetlHead.aspx.cs" Inherits="iWMS.Web.Sales.TransportQuotationPricing.TransportQuotationPricingDetlHead" %>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn Display="False" DataField="pricebreakoption" UniqueName="pricebreakoption" />
                    </Columns>
                </MasterTableView>
            </telerik:RadGrid>
        </div>
