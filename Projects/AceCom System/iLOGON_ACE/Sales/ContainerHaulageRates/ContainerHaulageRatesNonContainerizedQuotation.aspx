<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerHaulageRatesNonContainerizedQuotation.aspx.cs" Inherits="iWMS.Web.Sales.ContainerHaulageRates.ContainerHaulageRatesNonContainerizedQuotation" %>
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="TripRate <br/> Currency" UniqueName="PerTripRate" ItemStyle-Width="160px" HeaderStyle-Width="160px">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblPerTripRate" Text='<%# string.Format("{0:}",Eval("PerTripRate")) %>'></asp:Label>
                                            <br />
                                            <br />
                                            <asp:Label runat="server" ID="lblCurrency" Text='<%# string.Format("{0:}",Eval("CurrCode")) %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <telerik:RadTextBox runat="server" ID="PerTripRateTxt" Text='<%# DataBinder.Eval(Container.DataItem, "PerTripRate") %>'
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="SubsequentHourRate " UniqueName="SubsequentHourRate" ItemStyle-Width="160px" HeaderStyle-Width="160px">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblSubsequentHourRate" Text='<%# string.Format("{0:}",Eval("SubsequentHourRate")) %>'></asp:Label>
                                            <br />
                                            <br />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <telerik:RadTextBox runat="server" ID="SubsequentHourRatetxt" Text='<%# DataBinder.Eval(Container.DataItem, "SubsequentHourRate") %>'
                                                TextMode="SingleLine" Enabled="true" Width="150px">
                                            </telerik:RadTextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="DailyRate" UniqueName="FullDayRate" ItemStyle-Width="160px" HeaderStyle-Width="160px">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblDailyRate" Text='<%# string.Format("{0:}",Eval("FullDayRate")) %>'></asp:Label>
                                            <br />
                                            <br />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <telerik:RadTextBox runat="server" ID="DailyRatetxt" Text='<%# DataBinder.Eval(Container.DataItem, "FullDayRate") %>'
                                                TextMode="SingleLine" Enabled="true" Width="150px">
                                            </telerik:RadTextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
