<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerHaulageRatesTierPricing.aspx.cs" Inherits="iWMS.Web.Sales.ContainerHaulageRates.ContainerHaulageRatesTierPricing" %>
...
<body onload="javascript:window.focus();">
    <form id="Form1" method="post" runat="server">
        ...
        <br>
        <div>
            <telerik:RadGrid ID="QUSDetDG" runat="server" AutoGenerateColumns="false" GridLines="None" OnCancelCommand="QUSDetDG_Cancel"
