<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerHaulageRatesServiceRates.aspx.cs" Inherits="iWMS.Web.Sales.ContainerHaulageRates.ContainerHaulageRatesServiceRates" %>
                ...
                <table style="z-index: 0" id="Table1" border="0" cellspacing="2" cellpadding="2"
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="CancelBtn" class="LongLabelWhite" runat="server" OnClick="CancelBtn_Click" Text="Close Window" CausesValidation="false"
