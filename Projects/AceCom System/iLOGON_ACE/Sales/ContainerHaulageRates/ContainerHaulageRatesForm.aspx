<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerHaulageRatesForm.aspx.cs" Inherits="iWMS.Web.Sales.ContainerHaulageRates.ContainerHaulageRatesForm" %>
...
<body onload='displayRow("table1");' bottommargin="0" leftmargin="0" rightmargin="0"
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="UpdatesBtn">
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Line" Value="100" runat="server">
                 ...
                 <telerik:RadTab Text="Non-Containerized Quotation" Value="110" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="QRCode" Value="120" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="TierPricing" Value="300" runat="server" Visible="false">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="UpdatesBtn" runat="server" Text="Update" OnClick="UpdateBtn_Click"
                             ...
                             <asp:Label ID="Updatelbl" runat="server" ForeColor="red" Text="Quotation is Approved.No more changes allowed." 
                                 Visible="false" CssClass="pagetitle"></asp:Label>
            ...
            <telerik:RadPageView runat="server" Height="85%" ID="QuoteLineRadPageView" />
            <telerik:RadPageView runat="server" Height="85%" ID="NonContainerizedQuotationRadPageView" />
            <telerik:RadPageView runat="server" Height="85%" ID="QRCodeRadPageView" />
