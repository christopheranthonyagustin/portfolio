<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV3UpdateMenu.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV3.InvCountV3UpdateMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>InvCountV3UpdateMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="InvCountLbl" runat="server">Update</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
