<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV3Serialized.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV3.InvCountV3Serialized" %>
...
<head id="Head1" runat="server">
    <title>InvCountV3Serialized</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" 
        ...
        <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="loccode" AllowFilteringByColumn="false">
            ...
            <Columns>
                <%--<telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" Display="false"
                ...
                <telerik:GridTemplateColumn HeaderText="CountQty" AllowFiltering="false" UniqueName="counteduomqty">
                    <ItemTemplate>
