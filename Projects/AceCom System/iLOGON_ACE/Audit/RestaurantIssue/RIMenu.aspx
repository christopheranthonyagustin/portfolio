<%@ Page language="c#" Codebehind="RIMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Audit.RestaurantIssue.RIMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="IssueLbl" runat="server">Issue</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
