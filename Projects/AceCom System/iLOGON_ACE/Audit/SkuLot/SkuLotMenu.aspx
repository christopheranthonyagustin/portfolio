<%@ Page language="c#" Codebehind="SkuLotMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Audit.SkuLot.SkuLotMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>SkuLotMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<td class="NewModuleTitle" align="right">
					    <asp:Label id="VehicleLbl" runat="server">SKU Lot</asp:Label><%--</div></div></td>--%>
					</td>
				</tr>
			</table>
		</form>
