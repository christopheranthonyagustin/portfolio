<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ICDetlCount.aspx.cs" Inherits="iWMS.Web.Audit.InvCount.ICDetlCount" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>InvCount Detail Count</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table>
        <tr>
            <td align="left">
                <asp:Button ID="reconlot4Btn" runat="server" CssClass="white" Text="ReconLot4"
                    OnClick="reconlot4Btn_Clicked" />
                <asp:Button ID="reconlot5Btn" runat="server" CssClass="white" Text="ReconLot5"
                    OnClick="reconlot5Btn_Clicked" />
                <asp:Button ID="reconLocTUBtn" runat="server" CssClass="white" Text="RconLocTU1"
                    OnClick="reconLocTUBtn_Clicked" />
                   <asp:Button ID="reconSKULOCBtn" runat="server" CssClass="white" Text="ReconSKU"
                    OnClick="reconLocTUBtn_Clicked" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"  />
                  <asp:Button ID="DeleteLineBtn" runat="server" CssClass="white" Text="Delete"
                    OnClick="DeleteLineBtn_Click" OnClientClick="return confirm('Confirm to Delete the selected InvCount Detail Count?')"  />
            </td>
        </tr>
    </table>
    <br />
