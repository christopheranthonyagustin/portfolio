<%@ Page language="c#" Codebehind="InvCountDetl4.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Audit.InvCount.InvCountDetl4" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" border="0" width="100%">
				...
				<tr>
					<td>Remark : Please manually adjust for those error line(s).</td>
				</tr>
			</table>
			<br>
