...
<%@ Page language="c#" Codebehind="InvCountMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Audit.InvCount.InvCountMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvCountMenu</title>
			...
			<table width="100%">
				<tr>
					...
					<%--<div class="rounded-box1" style="width:70%;background-color:#996633;">
						...
						<asp:Label id="InvCountLbl" runat="server"> Count V1 </asp:Label><%--</div></div>--%></td>
				</tr>
			</table>
		</form>
	</body>
