<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ICDetlUploadCounted.aspx.cs" Inherits="iWMS.Web.Audit.InvCount.ICDetlUploadCounted" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Inventory Count Detail Counted</title>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="excelSend" Text="VALIDATE&UPLOAD" runat="server" OnClick="excelSend_Click"
                        OnClientClick="return busyBox.Show();" CssClass="white"/>
                    <br />
