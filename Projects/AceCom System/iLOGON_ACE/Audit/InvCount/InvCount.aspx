<%@ Page Language="c#" CodeBehind="InvCount.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Audit.InvCount.InvCount" %>
...
<body leftmargin="0" topmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td>
                <div class="pagetitle">
                    Inventory&nbsp;Count&nbsp;(Step&nbsp;2 of&nbsp;2)</div>
            </td>
            <td align="right">
                <asp:Label ID="MessageLbl" runat="server" ForeColor="Red" Font-Bold="True"></asp:Label>&nbsp;
                <asp:Button ID="YesBtn" runat="server" Text=" Yes " Visible="False" CssClass="white"
                    OnClick="YesBtn_Click"></asp:Button>
                <asp:Button  ID="BackBtn" runat="server" CssClass="white"
                ...
                <asp:Button  ID="CancelBtn" runat="server" CssClass="white"
