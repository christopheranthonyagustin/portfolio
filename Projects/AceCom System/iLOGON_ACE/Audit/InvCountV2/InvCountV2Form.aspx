<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2Form.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2Form" %>
     ...
     <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
        <telerik:RadPageView runat="server" Height="90%" ID="HeaderRadPageView">
            ...
            <%--<asp:ImageButton ID="UpdateBtn" runat="server" ImageUrl="../../Image/Update.png"
                Visible="False" OnClick="UpdateBtn_Click" BackColor="Transparent" BorderWidth="0"
                Style="z-index: 0" ImageAlign="AbsMiddle" />--%>
            <br /><br />
            <iWMS:iForm ID="formCtl" runat="server"></iWMS:iForm>
        </telerik:RadPageView>
        <telerik:RadPageView runat="server" Height="85%" ID="CandidatesRadPageView" />
        <telerik:RadPageView runat="server" Height="85%" ID="SerializedRadPageView" />
