<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2Menu.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2Menu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >

<html>
	<head id="Head1" runat="server">
		<title>InvCountV2Menu</title>
		...
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				<tr>
					...
					<%--edit by HW @ 21/Sep/2016 Ticket #4396:--%>
					<%--<div class="rounded-box1" style="width:70%;background-color:#996633;">
						...
						<asp:Label id="InvCountLbl" runat="server">Count V2</asp:Label><%--</div></div>--%></td>
				</tr>
			</table>
		</form>
	</body>
