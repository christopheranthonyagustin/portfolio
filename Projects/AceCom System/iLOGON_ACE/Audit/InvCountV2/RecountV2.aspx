<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecountV2.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV2.RecountV2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>RecountV2</title>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" border="0" width="100%">
				<tr>
					...
					<td align="right"><asp:Button id="PrintBtn" runat="server" Text="Print Recount List" CssClass="detailButton" onclick="PrintBtn_Click"></asp:Button>&nbsp;&nbsp;</td>
				</tr>
			</table><br>
			<div id="div-datagrid">
