<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>InvCountV2</title>
...
<body leftmargin="0" topmargin="0">
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" OnPreRender = "ResultDG_PreRender"            
