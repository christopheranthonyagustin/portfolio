<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2BySkulocLot4CandSearch.aspx.cs" Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2BySkulocLot4CandSearch" %>
<%@ Register TagPrefix="iWMS" TagName="iForm" Src="../../Control/iFormCtl.ascx" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>InvCountV2BySkulocLot4CandSearch</title>
				...
				<tr>
					...
					<td align="right">
						<asp:Label style="Z-INDEX: 0" id="MessageLbl" runat="server" ForeColor="Red" Font-Bold="True"></asp:Label>&nbsp;
                         <asp:Button ID="SearchBtn" class="white" runat="server" OnClick="SearchBtn_Click" Visible="false" Text="Search" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
						<%--<asp:button id="SearchBtn" runat="server" Text="Search Inventory" CssClass="detailButton" onclick="SearchBtn_Click" Visible="false"></asp:button>--%>&nbsp;
					</td>
				</tr>
				<tr>
                ...
                &nbsp;&nbsp;
                 <asp:Button ID="CancelBtn" class="white" runat="server" OnClick="CancelBtn_Click" Text="Cancel" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" /> 
					<%--<telerik:RadButton id="SaveCandidates" runat="server" Text="Save Candidates" 
                            CssClass="detailButton" onclick="SaveCandidates_Click"></telerik:RadButton>--%>&nbsp;
