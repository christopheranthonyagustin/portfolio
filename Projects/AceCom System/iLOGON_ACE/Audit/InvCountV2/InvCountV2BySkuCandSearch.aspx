<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2BySkuCandSearch.aspx.cs"
    Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2BySkuCandSearch" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="60%">
            <tr>
                ...
                <td align="right">
                   ...
                   <%-- <asp:Button ID="SearchBtn" runat="server" Text="Search Inventory" CssClass="detailButton"
                        OnClick="SearchBtn_Click" Visible="false"></asp:Button>--%>
    ...
    <asp:Panel ID="ResultPanel" runat="server">
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            AllowPaging="false" AllowSorting="true" Skin="Metro" >
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="slltid" Name="ParentGrid">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="S/N">
                        <ItemTemplate>
