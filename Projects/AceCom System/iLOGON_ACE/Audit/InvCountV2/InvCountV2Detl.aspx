<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvCountV2Detl.aspx.cs"
    Inherits="iWMS.Web.Audit.InvCountV2.InvCountV2Detl" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            ...
            <td>
                <asp:Button ID="AddDetailBtn" class="white" runat="server" OnClick="AddDetailBtn_Click" Visible="False"  Text="Select" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                <%--<asp:ImageButton ID="AddDetailBtn" runat="server" ImageUrl="../../Image/Select.png" 
                    BackColor="Transparent" BorderWidth="0" Style="z-index: 0" ImageAlign="AbsMiddle" OnClick="AddDetailBtn_Click" Visible="False" />--%>
                &nbsp;
                 <asp:Button ID="ButtonExcel" class="green" runat="server" OnClick="ButtonExcel_Click" Text="Excel" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                 <%--<asp:ImageButton ID="ButtonExcel" runat="server" ImageUrl="../../Image/Excel.png"
                    ...
                    ImageAlign="AbsMiddle" ToolTip="Export To Excel" OnClick="ButtonExcel_Click" />  --%> 
                &nbsp;   
                <asp:Button ID="UpdateBtn" class="white" runat="server" OnClick="UpdateBtn_Click" Text="Update" Visible="False"  OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                 &nbsp;
                 ...
                 &nbsp;
                <asp:Button ID="CountSheetBtn" class="blue" runat="server" OnClick="CountSheetBtn_Click" Text="CountSheet" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                 &nbsp;
             </td>
             <td>
                LineId<br />
            ...
            <br />
                ...
                <%--<asp:ImageButton ID="SearchBtn" runat="server" ImageUrl="../../image/Search.png" BackColor="Transparent" 
                BorderWidth="0" ImageAlign="AbsMiddle" ToolTip="Search" OnClick="SearchBtn_Click"/>--%>
            </td>
        </tr>
    </table>              
    <br />
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" Height="100%" 
        ...
        <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id" AllowFilteringByColumn="false">
