<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocalCourierServicesWIP.aspx.cs" Inherits="iWMS.Web.WebV2_ILOGON.LocalCourierServices.LocalCourierServicesWIP" %>
...
<head runat="server">
    <title>To Be Delivered@ LocalCourierServices</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="SubMenuDiv" class="submenu">
            ...
            <a class="active" href="LocalCourierServicesWIP.aspx" id="WIP" runat="server">To Be Delivered</a>
        ...
        <telerik:RadGrid ID="WIPRadGrid" runat="server" OnNeedDataSource="WIPRadGrid_NeedDataSource" AutoGenerateColumns="false" Skin="Office2010Blue" RenderMode="Lightweight"
