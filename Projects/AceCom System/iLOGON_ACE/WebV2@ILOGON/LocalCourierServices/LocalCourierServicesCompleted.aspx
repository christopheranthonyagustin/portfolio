<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocalCourierServicesCompleted.aspx.cs" Inherits="iWMS.Web.WebV2_ILOGON.LocalCourierServices.LocalCourierServicesCompleted" %>
...
<head runat="server">
    <title>Delivered @ LocalCourierServices</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="SubMenuDiv" class="submenu">
            ...
            <a class="active" href="LocalCourierServicesCompleted.aspx" id="Completed" runat="server">Delivered</a>
            <a href="LocalCourierServicesDashboard.aspx" id="Dashboard" runat="server">Dashboard</a>
        </div>

        <telerik:RadGrid ID="CompletedRadGrid" runat="server" OnNeedDataSource="CompletedRadGrid_NeedDataSource" AutoGenerateColumns="false" Skin="Office2010Blue" RenderMode="Lightweight"
