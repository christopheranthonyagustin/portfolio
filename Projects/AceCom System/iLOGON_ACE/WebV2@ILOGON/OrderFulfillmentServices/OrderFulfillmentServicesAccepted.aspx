<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderFulfillmentServicesAccepted.aspx.cs" Inherits="iWMS.Web.WebV2_ILOGON.OrderFulfillmentServices.OrderFulfillmentServicesAccepted" %>
...
<head runat="server">
    <title>Accepted @ Order Fulfilment Services</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="SubMenuDiv" class="submenu">
            ...
            <a class="active" href="OrderFulfillmentServicesAccepted.aspx" id="Accepted" runat="server">Accepted</a>
