<%@ Page language="c#" Codebehind="PutawayMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Inbound.Putaway.PutawayMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>PutawayMenu</title>
				...
				<tr>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:40%;background-color:#336600;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;"><asp:Label id="PutawayDocLbl" runat="server">Putaway Document</asp:Label></div>
						</div>
					</td>
				</tr>
			</table>
