<%@ Page language="c#" Codebehind="POCandidateDetl.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Inbound.Receipt.POCandidateDetl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>POCandidateDetl</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<div id="div-datagrid"><asp:datagrid id="ResultDG" runat="server" PageSize="8" BorderStyle="None" GridLines="Both" CellPadding="2"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="receivedqty" SortExpression="receivedqty" HeaderText="Qty">
							<HeaderStyle Wrap="False"></HeaderStyle>
