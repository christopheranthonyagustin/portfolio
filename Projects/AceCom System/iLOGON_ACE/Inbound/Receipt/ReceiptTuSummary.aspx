<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptTuSummary.aspx.cs"
    Inherits="iWMS.Web.Inbound.Receipt.ReceiptTuSummary" %>
            ...
            <div id="div-datagrid">
                <asp:DataGrid ID="ResultDG" runat="server" PageSize="8" GridLines="Both" CellPadding="2"
                    ...
                    <Columns>
                     ...
                     <%--   <asp:BoundColumn DataField="MinLot4" SortExpression="MinLot4" HeaderText="MinLot4">
                            <HeaderStyle Wrap="False"></HeaderStyle>
                            <ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="MaxLot4" SortExpression="MaxLot4" HeaderText="MaxLot4">
                            <HeaderStyle Wrap="False"></HeaderStyle>
                            <ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>--%>
                      ...
                      <%--  <asp:BoundColumn DataField="MinLot5" SortExpression="MinLot5" HeaderText="MinLot5">
                            <HeaderStyle Wrap="False"></HeaderStyle>
                            <ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="MaxLot5" SortExpression="MaxLot5" HeaderText="MaxLot5">
                            <HeaderStyle Wrap="False"></HeaderStyle>
                            <ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>--%>
                    </Columns>
