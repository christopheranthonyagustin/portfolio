<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GKERcUpload.aspx.cs" Inherits="iWMS.Web.Inbound.Receipt.GKERcUpload" %>
...
<body>
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td colspan="2">
                <asp:Label ID="headerLbl1" runat="server" CssClass="pagetitle"></asp:Label><br />
                <br />
            </td>
            <td width="40%">
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:CheckBox ID="showpassed" Text="Show Passed SKU Line" runat="server" OnCheckedChanged="ShowPassed_CheckChanged"
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <asp:DropDownList ID="billgrpDDL" runat="server" Visible="false" Width="150px" />
            </td>
        </tr>
        <tr>
            <td class="style1">
