<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NPMSInterface.aspx.cs" Inherits="iWMS.Web.Inbound.Receipt.NPMSInterface" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Button ID="ExportExcelBtn" runat="server" class="green" Text="Excel" OnClick="ExportExcelBtn_Click" />&nbsp;
