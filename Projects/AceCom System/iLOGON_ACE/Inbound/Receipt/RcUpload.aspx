<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RcUpload.aspx.cs" Inherits="iWMS.Web.Inbound.Receipt.RcUpload" %>
    ...
    <body>
        <form id="Form1" method="post" runat="server" style="Z-INDEX: 0">
            <table  id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
               <tr>
                    <td colspan="2"><asp:label id="headerLbl1" Runat="server" CssClass="pagetitle"></asp:label><br /><br /></td>
			        <td width="40%"></td>
               </tr>
		       <tr>
		            <td colspan="2">
		       ...
		       <tr>
		            ...
		            <td>
                        ...
                        <asp:Button id="excelSend" Text=" SEND AND RETRIEVE " runat="server" OnClick="excelSend_Click"/>
						</td>
		       </tr>
		       <tr>
