<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPalletLabelMenu.aspx.cs" Inherits="iWMS.Web.Inbound.Receipt.PrintPalletLabelMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head id="Head1" runat="server">
		<title>PrintPalletLabelMenu</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="5" style="BORDER-BOTTOM: #D5D5D5 1px solid;">
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				<tr>
					<td class="style1"><input type="hidden" id="tb1" value="1"></td>
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:80%;background-color:#336600;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								<asp:Label id="PrintPalletLabelLbl" runat="server">Print Pallet Label</asp:Label>
							</div>
						</div>
					</td>
				</tr>
