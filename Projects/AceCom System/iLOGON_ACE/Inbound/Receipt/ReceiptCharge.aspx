<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="ReceiptCharge.aspx.cs"
    Inherits="iWMS.Web.Inbound.Receipt.ReceiptCharge" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                        ...
                        <td>
                            <div class="pagetitle">
                                ...
                                <asp:Button ID="DelImgBtn" runat="server" Text="Delete" OnClick="DeleteBtn_Click" Visible="true"
                                    OnClientClick="disableBtn(this.id,false)" ToolTip="Delete" CssClass="white" UseSubmitBehavior="false" />&nbsp;<br /><br />
                ...
                <br />
                <asp:UpdatePanel ID="RCChargeUpdatePanel" runat="server">
                    <ContentTemplate>
                        <telerik:RadGrid ID="RCChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                            EnableLinqExpressions="false" AllowPaging="false" AllowSorting="false" AllowFilteringByColumn="false" OnPreRender="RCChargeDG_PreRender"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="rcchargeid" Width="600px">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn Display="false" HeaderText="rcchargeid" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-HorizontalAlign="Center" UniqueName="Qty">
                                        <ItemTemplate>
                                            <asp:TextBox ID="QtyTxt" Width="50px" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "qty") %>'
                                                OnTextChanged="QtyRateDiscount_TextChanged" AutoPostBack="false"></asp:TextBox>
