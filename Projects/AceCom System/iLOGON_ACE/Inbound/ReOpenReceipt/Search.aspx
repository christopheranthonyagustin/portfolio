...
<%@ Page Language="c#" CodeBehind="Search.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Inbound.ReOpenReceipt.Search" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table style="z-index: 0; margin-right: 0px;" id="Table1" border="0" cellspacing="2"
            ...
            <tr>
                <td class="style1">
                    &nbsp;
                    <asp:Button ID="RetrieveBtn" runat="server" Text="Retrieve" ToolTip="Retrieve" OnClick="RetrieveBtn_Click"
