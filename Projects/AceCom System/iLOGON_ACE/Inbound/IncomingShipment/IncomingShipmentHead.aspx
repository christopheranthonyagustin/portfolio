<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomingShipmentHead.aspx.cs" Inherits="iWMS.Web.Inbound.IncomingShipment.IncomingShipmentHead" %>
...
<html>
<head runat="server">
    <title>IncomingShipmentHead</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" OnNeedDataSource="ResultDG_NeedDataSource" OnItemDataBound="ResultDG_ItemDataBound"
            AllowSorting="true" AllowFilteringByColumn="true" EnableLinqExpressions="false" ClientSettings-AllowColumnsReorder="true" AllowPaging="true" Skin="Office2007">
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="gateindate" SortExpression="gateindate" HeaderText="TruckInDate" DataFormatString="{0:dd/MMM/yyyy}">
                    </telerik:GridBoundColumn>
