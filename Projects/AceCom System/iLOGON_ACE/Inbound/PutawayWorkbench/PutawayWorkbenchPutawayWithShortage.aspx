<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PutawayWorkbenchPutawayWithShortage.aspx.cs" Inherits="iWMS.Web.Inbound.PutawayWorkbench.PutawayWorkbenchPutawayWithShortage" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="PutawayWithShortageTab" Text="Putaway With Shortage" Value="0" runat="server">
                </telerik:RadTab>
                ...
                <table border="0" cellpadding="2" cellspacing="2" runat="server">
                    <tr>
                        <td>
                         ...
                         <td>
                            <asp:Button ID="AdjustShortageBtn" CssClass="white" Width="110" runat="server" OnClick="AdjustShortageBtn_Click" Text="Adjust Shortage" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                        </td> 
                        <td align="right">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" DataKeyNames="StockId">
                        ...
                        <Columns>
                           ...
                           <telerik:GridBoundColumn Display="False" DataField="PalletNo" />
