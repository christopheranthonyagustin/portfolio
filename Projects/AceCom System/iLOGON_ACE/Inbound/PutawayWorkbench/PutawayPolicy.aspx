<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PutawayPolicy.aspx.cs" Inherits="iWMS.Web.Inbound.PutawayWorkbench.PutawayPolicy" %>
...
<head id="Head1" runat="server">
    <title>Policy Manager @ Putaway Workbench</title>
    <base target="_self" />
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" EnableViewState="false"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="PropertyId" CommandItemDisplay="TopAndBottom" EditMode="Batch" Name="ParentGrid"
                                                    ...
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="deleteicon" AllowFiltering="false" ItemStyle-Width="15px" HeaderStyle-Width="15px" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="Delete" 
                                                                ...
                                                                OnClick="PutawayPlanPropertyDelete_Click" BackColor="Transparent" BorderWidth="0" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
