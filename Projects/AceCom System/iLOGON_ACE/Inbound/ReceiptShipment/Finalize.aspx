<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Finalize.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.Finalize" %>
...
<body >
    ...
    <table >
        <tr>
            <td>
                &nbsp;&nbsp;<asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">Finalize</asp:Label>
            </td>       
            <tr>
                <td colspan="2">
