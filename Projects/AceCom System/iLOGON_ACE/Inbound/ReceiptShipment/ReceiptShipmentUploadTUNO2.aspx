<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentUploadTUNO2.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentUploadTUNO2" %>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <br />
                    &nbsp;<asp:Label ID="Label3" Text="1. Eash TUNO2 can only be uploaded once." Font-Size="15px" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
            </tr>
