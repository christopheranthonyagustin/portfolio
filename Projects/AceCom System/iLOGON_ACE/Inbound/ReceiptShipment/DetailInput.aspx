<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailInput.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.DetailInput" %>
<%@ Register TagPrefix="iWMS" TagName="iInput" Src="../../Control/iInputCtl.ascx" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Receipt Shipment Detail Input</title>
            ...
            <td valign="top" align="center">
                <asp:Button ID="SaveNextBtn" runat="server" Text="Save &amp; Next" CssClass="detailbutton"
                    OnClick="SaveNextBtn_Click"></asp:Button>&nbsp;<asp:Button ID="SaveBtn" runat="server"
                        Text="Save &amp; Close" CssClass="detailbutton" OnClick="SaveBtn_Click">
                </asp:Button>&nbsp;
