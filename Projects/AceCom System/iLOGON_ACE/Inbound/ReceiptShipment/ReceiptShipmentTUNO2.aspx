<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentTUNO2.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentTUNO2" %>
                        ...
                        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="Id"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="TUNO2" HeaderText="TUNO2">
                                        <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2")%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="TUNO2" Text='<%# Eval("TUNO2") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="Length" HeaderText="Length (M)">
                                        <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2Length")%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="Length" Text='<%# Eval("TUNO2Length") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="TUNO2LengthReqVal" runat="server" ControlToValidate="Length"
                                                ErrorMessage="*" />
                                            <asp:CompareValidator ID="TUNO2LengthCompVal" runat="server" ControlToValidate="Length"
                                                EnableClientScript="true" ErrorMessage="#" Operator="DataTypeCheck" Type="Double" />
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="Width" HeaderText="Width (M)">
                                        <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2Width")%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="Width" Text='<%# Eval("TUNO2Width") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="TUNO2WidthReqVal" runat="server" ControlToValidate="Width"
                                                ErrorMessage="*" />
                                            <asp:CompareValidator ID="TUNO2WidthCompVal" runat="server" ControlToValidate="Width"
                                                EnableClientScript="true" ErrorMessage="#" Operator="DataTypeCheck" Type="Double" />
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="Height" HeaderText="Height (M)">
                                        <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2Height")%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="Height" Text='<%# Eval("TUNO2Height") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="TUNO2HeightReqVal" runat="server" ControlToValidate="Height"
                                                ErrorMessage="*" />
                                            <asp:CompareValidator ID="TUNO2HeightCompVal" runat="server" ControlToValidate="Height"
                                                EnableClientScript="true" ErrorMessage="#" Operator="DataTypeCheck" Type="Double" />
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="Vol" HeaderText="Vol (M3)">
                                        ...
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2Vol") %>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="Vol" Text='<%# Eval("TUNO2Vol") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="WT" HeaderText="WT">
                                        ...
                                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2WT")%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="WT" Text='<%# Eval("TUNO2WT") %>' Skin="Office2007" Width="100px">
                                            </asp:TextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Remarks" UniqueName="REM">
                                        ...
                                        <HeaderStyle Wrap="false" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "TUNO2Remarks")  %>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="Rem" Text='<%# DataBinder.Eval(Container.DataItem, "TUNO2Remarks") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>
