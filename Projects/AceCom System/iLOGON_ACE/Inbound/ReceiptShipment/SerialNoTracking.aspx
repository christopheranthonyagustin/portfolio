<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialNoTracking.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.SerialNoTracking" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>ReceiptSNoTracking</title>
         ...
         <table border="0" cellspacing="0" cellpadding="0" width="100%">
             <tr>
                 <td>
                     ...
                     <asp:Button ID="PrevItemBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="PrevItemBtn_Click" Visible="True" Text="Prev" CausesValidation="false" 
                      ...
                      <asp:Button ID="DeleteSerialBtn" CssClass="LongLabelWhite" runat="server" OnClick="DeleteSerialBtn_Click" Text="&nbsp;&nbsp;&nbsp;&nbsp; Delete &nbsp;&nbsp;&nbsp;&nbsp; Serial No" 
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />  &nbsp;

                      <asp:Button ID="UploadBtn" CssClass="white" runat="server" OnClick="UploadBtn_Click" Text="Upload" 
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />&nbsp;

                     <asp:Button ID="NextItemBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="NextItemBtn_Click" Visible="True" Text="Next" CausesValidation="false"
                         OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />&nbsp;
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" EditMode="InPlace" >
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="SKUCode" HeaderText="SKU Code" SortExpression="SKUCode" ReadOnly="true"></telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="TUNO2" HeaderText="TUNO2" SortExpression="TUNO2" ReadOnly="true"></telerik:GridBoundColumn>
