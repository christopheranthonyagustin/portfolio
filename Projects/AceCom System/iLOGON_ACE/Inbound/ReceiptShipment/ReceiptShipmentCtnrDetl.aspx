<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentCtnrDetl.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentCtnrDetl" %>
...
<html>
<head runat="server">
    <title>ReceiptShipmentCtnrDetl</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" onload="if (document.getElementById('CtnrNoTxt')!= null) document.getElementById('CtnrNoTxt').focus();">
    <form id="Form1" method="post" runat="server">
        ...
        <br />
        <asp:Label ID="lblCtrnNo" Font-Bold="true" Font-Size="15px" CssClass="ctrnNo" runat="server" Visible="false"></asp:Label>
