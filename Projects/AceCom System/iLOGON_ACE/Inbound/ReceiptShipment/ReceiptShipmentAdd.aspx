<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentAdd.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentAdd" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" RenderMode="Lightweight"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Details" Value="200" runat="server">
                </telerik:RadTab>
        ...
        <table>
            <tr>
                <td>
                    <telerik:RadButton Style="z-index: 0" ID="UpdateBtn" runat="server" CssClass="detailButton" Skin="WebBlue"
                        Text="Update" Visible="False" OnClick="UpdateBtn_Click">
                    </telerik:RadButton>
                    &nbsp;&nbsp;
                    
                    <asp:Button
                        ID="AddDetailBtn" runat="server" Text="More >" Visible="False" CssClass="detailButton"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
                    ...
                    <telerik:RadPageView runat="server" Height="700px" ID="ShipmentInfoRadPageView">
