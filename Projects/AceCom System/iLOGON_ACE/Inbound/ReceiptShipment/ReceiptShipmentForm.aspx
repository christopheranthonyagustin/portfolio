<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentForm.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentForm" %>
...
<html>
<head runat="server">
    <title>ReceiptShipmentForm</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Charge" Value="10" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Container" Value="20" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Attachment" Value="30" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Log" Value="40" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <asp:Button ID="UpdateBtn" CssClass="white" runat="server" OnClick="UpdateBtn_Click" Visible="False"
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip2" CausesValidation="false" MultiPageID="RadMultiPage2"
                    ...
                    <Tabs>
                        <telerik:RadTab ID="LineTab" Text="Line" Value="100" readonly="readonly" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Inventory" Value="200" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="LotMovement" Value="300" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="UploadLot" Value="400" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="TUNO1" Value="500" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="TUNO2" Value="600" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="SerialNo" Value="700" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Upload TUNO1" Value="800" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Upload TUNO2" Value="900" runat="server">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Excess" Value="1000" runat="server">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
