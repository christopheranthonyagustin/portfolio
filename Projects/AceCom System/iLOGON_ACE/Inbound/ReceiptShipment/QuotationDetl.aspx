<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDetl.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.QuotationDetl" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
               ...
               UseSubmitBehavior="false"     OnClick="serachBtn_Click"></asp:Button>
                  <%--    <asp:Button ID="serarchBtn" runat="server" Text="Search" OnClick="serarchBtn_Click"
                    ...
                    UseSubmitBehavior="false"     ></asp:Button>&nbsp;<asp:Button ID="CloseBtn" runat="server" CssClass="white"
        ...
        <br />
        <telerik:RadGrid ID="RCChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None" OnPreRender="RCChargeDG_PreRender"
            EnableLinqExpressions="false" AllowPaging="false" AllowSorting="false" AllowFilteringByColumn="false"
            Skin="Office2007" OnItemDataBound="RCChargeDG_ItemDataBound" onkeydown="if(this.readOnly) event.preventDefault();">
