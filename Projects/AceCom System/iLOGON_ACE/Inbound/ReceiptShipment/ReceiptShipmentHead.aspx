<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptShipmentHead.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.ReceiptShipmentHead" %>
...
<html>
<head runat="server">
    <title>Search Result @ Receipt Shipment</title>
                                ...
                                <telerik:GridTemplateColumn Reorderable="false" AllowFiltering="false" HeaderStyle-Width="250px">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" Visible="True" ID="ReceiveEdit" ImageUrl="../../image/pencil.gif"
                                            BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit Receipt Shipment"
