<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubDetailInput.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptShipment.SubDetailInput" %>
<%@ Register TagPrefix="iWMS" TagName="iInput" Src="../../Control/iInputCtl.ascx" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Receipt SubDetail Input</title>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="pagetitle">
                ...
                <asp:Label ID="Label1" runat="server">Detail</asp:Label>&nbsp;
