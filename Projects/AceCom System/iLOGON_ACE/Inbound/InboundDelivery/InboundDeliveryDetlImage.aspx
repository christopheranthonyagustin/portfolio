<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliveryDetlImage.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliveryDetlImage" %>
...
<html>
<head runat="server">
    <title>InboundDeliveryDetlImage</title>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="False" CommandName='<%#DataBinder.Eval(Container,"DataItem.id")%>'
                                        OnClick="InboundDeliveryImageDelete">
