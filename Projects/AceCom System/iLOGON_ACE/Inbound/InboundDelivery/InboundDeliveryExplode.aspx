<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliveryExplode.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliveryExplode" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Explode @ Inbound Delivery</title>
    ...
    <div>
        <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
            ...
            <tr>
                <td style="width:50%;">
                    &nbsp;
                    <b><asp:Label ID="QtyLbl" runat="server">Explode each line into</asp:Label></b>
            ...
            <tr>
                <td colspan="2">
                    &nbsp;
                    <asp:Button ID="Populate_Btn" runat="server" OnClick="Populate_Btn_Click" Text="Explode" CssClass="white" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                    &nbsp;
                     <asp:Button ID="CloseWindowBtn" runat="server" OnClick="CloseWindowBtn_Click" Text="Close Window" CssClass="LongLabelWhite" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
            </tr>
        </table>
    </div>
