<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliveryIQCCompleteNotProcessed.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliveryIQCCompleteNotProcessed" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" cellpadding="2" cellspacing="2" runat="server">
            <tr>
                <td>
                    ...
                    <asp:Button ID="ProcessIQCCompleteBtn" CssClass="longlabelwhite" runat="server" OnClick="ProcessIQCCompleteBtn_Click" Text="Process IQC_Complete" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
            </tr>
        </table>
        <br />
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="ProcessId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
