<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliverySKULineAdd.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliverySKULineAdd" %>
...
<head id="Head1" runat="server">
    <title>SKU Line @ Inbound Delivery</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" ID="MainRadPageView">
                ...
                <asp:Button ID="NextItemBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="NextItemBtn_Click" Visible="True" Text="Next"
                    CausesValidation="false" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                    &nbsp;
                    <asp:Button ID="CloseBtn" CssClass="LONGLABELWHITE" runat="server" OnClick="CloseBtn_Click" Visible="True" Text="Close Window"
                    CausesValidation="false" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />
                </asp:Panel>
                <br />
