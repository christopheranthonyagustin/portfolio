<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliveryErrorResponse.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliveryErrorResponse" %>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="RCSDTID" DataField="RCSDTID" Display="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="ReceiptNo" DataField="ReceiptNo" Display="false"></telerik:GridBoundColumn>
