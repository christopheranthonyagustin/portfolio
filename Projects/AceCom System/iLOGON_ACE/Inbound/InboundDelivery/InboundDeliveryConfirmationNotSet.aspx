<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundDeliveryConfirmationNotSet.aspx.cs" Inherits="iWMS.Web.Inbound.InboundDelivery.InboundDeliveryConfirmationNotSet" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        &nbsp;
        <asp:Button ID="SendConfirmationBtn" runat="server" Text="Send Confirmation" OnClick="SendConfirmationBtn_Click1" OnClientClick="disableBtn(this.id,false)" ToolTip="Sent" UseSubmitBehavior="false" CssClass="LongLabelWhite" />
         &nbsp;
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="ReceiptId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
