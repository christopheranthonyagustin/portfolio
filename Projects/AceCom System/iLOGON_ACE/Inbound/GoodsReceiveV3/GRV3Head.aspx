<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3Head.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3Head" %>
        ...
        <div style="height: 92%" id="div-datagrid">
            <table cellspacing="2" cellspacing="2">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="CloseGRbtn" CssClass="White" runat="server" OnClick="CloseGR_Click"
                            Text="Close GR" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                    </td>
                    <td>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn Display="false" DataField="acid" UniqueName="acid">
