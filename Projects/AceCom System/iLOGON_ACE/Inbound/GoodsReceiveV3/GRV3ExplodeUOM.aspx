<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3ExplodeUOM.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3ExplodeUOM" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Explode @ GoodReceive V2</title>
        ...
        <div>
            <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                <tr>
                    <td style="width: 50%;">&nbsp;
                    <b>
                        <asp:Label ID="UomLbl" runat="server">Packing UOM</asp:Label><input id="HIDDEN_Uom" type="hidden"
                            runat="server" /></b>
                    </td>
                ...
                <tr>
                    <td style="width: 50%;">&nbsp;
                    <b>
                        <asp:Label ID="QtyLbl" runat="server">Explode each line into</asp:Label></b>
