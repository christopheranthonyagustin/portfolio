<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3DetailInput.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3DetailInput" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="SKUInventoryLocation" Value="1">
                </telerik:RadTab>
                <telerik:RadTab Text="Extra Lots" Value="2">
                </telerik:RadTab>
                <telerik:RadTab Text="Remarks" Value="3">
                </telerik:RadTab>
                <telerik:RadTab Text="Invoice" Value="4">
                </telerik:RadTab>
                <telerik:RadTab Text="Attc" Value="5">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" ID="SKUInventoryLocationRadPageView">               
            </telerik:RadPageView>
