<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3Charge.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3Charge" %>
...
<head runat="server">
    <title>Charge @ GoodsReceiveV3</title>
                ...
                <td>
                    <div class="pagetitle">
                        <asp:Button ID="SaveBtn" runat="server" Text="Save" OnClick="SaveBtn_Click" Visible="false"
                         ...
                         <asp:Button ID="CopyBtn" runat="server" Text="Copy" OnClick="CopyBtn_Click" Visible="true"
                             OnClientClick="disableBtn(this.id,false)" ToolTip="Copy" CssClass="white" UseSubmitBehavior="false" />&nbsp;
                        <asp:Button ID="NotifyTransportBtn" runat="server" Text="NotifyTransport" OnClick="NotifyTransportBtn_Click"
                            OnClientClick="disableBtn(this.id,false)" CssClass="longlabelwhite" UseSubmitBehavior="false" />&nbsp;
        ...
        <telerik:RadGrid ID="RCChargeDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="rcchargeid" Width="600px">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="TMSJobNo" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="TMSJobNoLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TMSJobNo") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
