<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3InvoiceListing.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3InvoiceListing" %>
...
<head runat="server">
    <title>Invoice Listing @ GoodsReceiveV3</title>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="Id" Width="600px" Name="ParentGrid">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="GRNumber" HeaderStyle-HorizontalAlign="Center"
                        UniqueName="GRNumber" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="GRNumberLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "GRNumber") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="ReceiptDate" HeaderStyle-HorizontalAlign="Center"
                        UniqueName="ReceiptDate" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="ReceiptDateLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ReceiptDate","{0:dd/MMM/yyyy hh:mm}") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
