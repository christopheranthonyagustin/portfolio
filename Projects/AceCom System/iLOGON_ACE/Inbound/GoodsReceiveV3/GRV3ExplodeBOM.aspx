<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3ExplodeBOM.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3ExplodeBOM" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>BOMExplode @ Good Receive V2</title>
                ...
                <td align="center">
                    <div id="div-datagrid">
                        <telerik:RadGrid ID="ResultDG" runat="server" UseAccessibleHeader="True" BorderStyle="Solid"
                            PageSize="8" CellPadding="2" GridLines="Both" AutoGenerateColumns="False" Skin="Metro" OnItemDataBound="ResultDG_ItemDataBound">
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="skuid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                <Columns>
