<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3Return.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3Return" %>
...
<html>
<head runat="server">
    <title>Return @ GoodsReceiveV3</title>
            ...
            <telerik:RadGrid ID="ResultDGAdd" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="true" PageSize="50"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="200" DataKeyNames="Id">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="AvailableQuantity" DataField="receiveduomqty" AllowFiltering="false"
                            SortExpression="receiveduomqty" UniqueName="qty" Reorderable="true"
                            DataFormatString="{0:#}">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="ReturnQuantity" AllowFiltering="false" UniqueName="expectedqty"
                            Reorderable="true" SortExpression="receiveduomqty">
                            <ItemTemplate>
                                <telerik:RadTextBox ID="ReturnQtyTxt" runat="server" Width="100" Skin="WebBlue"
                                    Text='<%# string.Format("{0:#}", DataBinder.Eval(Container.DataItem, "receiveduomqty")) %>' DataFormatString="{0:#}">
                                </telerik:RadTextBox>
                                <asp:CompareValidator ID="ReturnQtyCompVal1" runat="server" ControlToValidate="ReturnQtyTxt"
                                    ...
                                    Operator="LessThanEqual" ValueToCompare='<%# DataBinder.Eval(Container.DataItem, "receiveduomqty") %>' Type="Double" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridBoundColumn HeaderText="RcDtId" DataField="RcDtId" Display="false" />
                    </Columns>
                </MasterTableView>
            </telerik:RadGrid>
        </asp:Panel>
