<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3AddCharge.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3AddCharge" %>
    ...
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="serarchBtn" runat="server" CssClass="white" Text="Search" OnClientClick="disableBtn(this.id,false)" ToolTip="Search"
                        UseSubmitBehavior="false" OnClick="serachBtn_Click"></asp:Button>
