<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3TUNO1.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3TUNO1" %>
...
<html>
<head runat="server">
    <title>TUNO1 @ GoodsReceiveV3</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" CausesValidation="false" MultiPageID="RadMultiPage1"
            SelectedIndex="0" Skin="Metro" AutoPostBack="true">
        </telerik:RadTabStrip>
