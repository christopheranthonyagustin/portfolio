<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV3InvoiceSummary.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV3.GRV3InvoiceSummary" %>
...
<head runat="server">
    <title>GRV3InvoiceSummary</title>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            <telerik:RadPageView runat="server" Height="700px" ID="NotBilledRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="True" EnableLinqExpressions="False"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" AllowPaging="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="BilledRadPageView">
                ...
                <telerik:RadGrid ID="BilledResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <HeaderStyle Wrap="false" CssClass="RGridHeader_CUSTOM" ForeColor="White"></HeaderStyle>
                    <PagerStyle Mode="NextPrevNumericAndAdvanced" />
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" AllowPaging="true" DataKeyNames="id" Name="ParentGrid">
                        <PagerStyle Mode="NextPrevNumericAndAdvanced" />
                        <Columns>
