<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoringOrderHead.aspx.cs"
    Inherits="iWMS.Web.Inbound.StoringOrder.StoringOrderHead" %>
        ...
        <tr>
            <td>
                <asp:ImageButton ID="cancelImgBtn" runat="server" OnClick="cancelImgBtn_Clicked"
                    Visible="true" ToolTip="Cancel" BackColor="Transparent" BorderWidth="0" ImageAlign="AbsMiddle"
                ...
                <%--<asp:ImageButton ID="populateBtn" runat="server" Visible="false" OnClick="populateBtn_Clicked"
                    AlternateText="Populate" ToolTip="Populate Selected Storing Order" ImageUrl="../../Image/Populate.png"
                    BackColor="Transparent" BorderWidth="0" ImageAlign="AbsMiddle" Height="25px" Width="25px" />--%>
            </td>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="number" SortExpression="number" HeaderText="StoreOrderNo">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="typedescr" SortExpression="typedescr" HeaderText="Type">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="statusdescr" SortExpression="statusdescr" HeaderText="Status">
                </telerik:GridBoundColumn>
                <%--Ticket #5795: TAA : Enhancement to Storing Order (RCHEAD) add by XM 03/08/2016--%>
