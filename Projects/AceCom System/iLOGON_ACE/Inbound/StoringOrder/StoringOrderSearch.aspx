<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoringOrderSearch.aspx.cs"
    Inherits="iWMS.Web.Inbound.StoringOrder.StoringOrderSearch" %>
    ...
    <form id="form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                ...
                &nbsp;
                <asp:Button ID="excelBtn" class="green" runat="server" OnClick="ExportExcel" Text="Excel" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                <br />
