<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoringOrderDetlList.aspx.cs" Inherits="iWMS.Web.Inbound.StoringOrder.StoringOrderDetlList" %>
              ...
              <MasterTableView AllowMultiColumnSorting="true" >
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Source" DataField="src" AllowFiltering="true"
                     ...
                     <telerik:GridBoundColumn HeaderText="TransDate" DataField="TransDate" SortExpression="TransDate" DataFormatString="{0:dd/MMM/yyyy HH:mm:ss}">
                    </telerik:GridBoundColumn>
