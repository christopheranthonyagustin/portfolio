<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POUPLInterfaceUpload_17.aspx.cs" Inherits="iWMS.Web.Inbound.PurchaseOrder.POUPLInterfaceUpload_17" %>
...
<head runat="server">
    <title>POUPLInterfaceUpload</title>
        ...
        <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">        
            ...
            <tr>
                <td class="style1">              
                    ...
                    <br />
                               &nbsp;
                    <asp:Label ID="lblnote" Text="Note : Only txt files can be uploaded." runat="server"></asp:Label>
                    <br />
                    <br />
                    <br />
                    <br />
