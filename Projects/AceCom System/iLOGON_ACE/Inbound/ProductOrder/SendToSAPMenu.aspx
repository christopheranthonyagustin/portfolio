...
<%@ Page language="c#" Codebehind="SendToSAPMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Inbound.ProductOrder.SendToSAPMenu" %>
					...
					<td class="ModuleTitle" align="right">
						<div class="rounded-box1" style="width:80%;background-color:#336600;">
							...
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
								<asp:Label id="ReceiptDocLbl" runat="server">Send To SAP</asp:Label>
							</div>
						</div>
					</td>
				</tr>
