<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelReceiptRegisterV2.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptRegisterV2.CancelReceiptRegisterV2" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>CancelReceiptRegisterV2</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">ReceiptRegisterV2 Cancellation</asp:Label>
            </td>
        </tr>
    </table>
