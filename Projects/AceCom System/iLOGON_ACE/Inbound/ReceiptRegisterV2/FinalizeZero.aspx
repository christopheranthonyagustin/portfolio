<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalizeZero.aspx.cs" Inherits="iWMS.Web.Inbound.ReceiptRegisterV2.FinalizeZero" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Finalize via Receipt</title>
        ...
        <table cellspacing="2" cellpadding="2" width="100%">
            ...
            <tr>
                ...
                <td width="60%" align="left">
                    <asp:Button ID="ConfirmBtn" runat="server" CssClass="detailbutton" Text="Confirm"
