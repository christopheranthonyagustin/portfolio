<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankStoringOrderTankDetl.aspx.cs"
    Inherits="iWMS.Web.Inbound.TankStoringOrder.TankStoringOrderTankDetl" %>
                ...
                <asp:Panel ID="AddPanel" runat="server" Visible="False">
                    <table border="0" cellspacing="1" cellpadding="1" width="100%">
                        <tr>
                            <td>
                                &nbsp;                               
                                <asp:Button ID="SaveBtn" CssClass="white" runat="server" OnClick="SaveBtn_Click" Visible="true"  
                                    Text="Save" OnClientClick="disableBtn(this.id, true)" UseSubmitBehavior="false" />
                                &nbsp;                               
                                <asp:Button ID="SaveNextBtn" CssClass="white" runat="server" OnClick="SaveNextBtn_Click" Visible="true"  
                                    Text="Save &amp; Next" OnClientClick="disableBtn(this.id, true)" UseSubmitBehavior="false" />
                                &nbsp;                               
                                <asp:Button ID="ClosePanelBtn" CssClass="white" runat="server" OnClick="ClosePanelBtn_Click" Visible="true"  
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderText="TankCondition" DataField="iCMSTankCondition"
                    AllowFiltering="true" SortExpression="iCMSTankCondition" UniqueName="iCMSTankCondition"
                    Reorderable="true">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn HeaderText="PODDemurrageLastDay" DataField="lot17" AllowFiltering="true"
                ...
                <telerik:GridBoundColumn HeaderText="TotalPODDemurrageDays" DataField="lot13" AllowFiltering="true"
