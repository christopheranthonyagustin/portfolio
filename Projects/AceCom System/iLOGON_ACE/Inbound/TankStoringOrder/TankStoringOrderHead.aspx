<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TankStoringOrderHead.aspx.cs" Inherits="iWMS.Web.Inbound.TankStoringOrder.TankStoringOrderHead" %>
...
<head id="Head1" runat="server">
    <title>TankStoringOrderHead</title>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="noofpkg" SortExpression="noofpkg" HeaderText="Total "
                    AllowFiltering="false" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:G2}">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="StoredQty" SortExpression="StoredQty" HeaderText="Stored "
