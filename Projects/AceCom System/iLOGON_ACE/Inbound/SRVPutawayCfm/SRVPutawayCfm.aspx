<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRVPutawayCfm.aspx.cs" Inherits="iWMS.Web.Inbound.SRVPutawayCfm.SRVPutawayCfm" %>
...
<head id="Head1" runat="server">
    <title>SRV Putaway Confirmation</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">SRV Putaway Confirmation</asp:Label>
                </div>
            </td>
            </td>
        </tr>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="20" DataKeyNames="id" EditMode="InPlace">
                ...
                <Columns>                    
                    ...
                    <telerik:GridBoundColumn DataField="id"  UniqueName="SRVno"
                        HeaderText="SRV No"  Display="true">
                    </telerik:GridBoundColumn>
