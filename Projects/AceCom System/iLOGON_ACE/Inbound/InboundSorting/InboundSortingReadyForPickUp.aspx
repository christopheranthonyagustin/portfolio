<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundSortingReadyForPickUp.aspx.cs" Inherits="iWMS.Web.Inbound.InboundSorting.InboundSortingReadyForPickUp" %>
...
<head runat="server">
    <title>Ready for Pickup @ Inbound Sorting</title>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        &nbsp;
                        <asp:Button ID="RequestforRobotBtn" CssClass="LongLabelWhite" runat="server" OnClick="RequestforRobotBtn_Click"
                            Text="Request for Robot" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
