<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundSortingLoadRobotForPutaway.aspx.cs" Inherits="iWMS.Web.Inbound.InboundSorting.InboundSortingLoadRobotForPutaway" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            CausesValidation="false" SelectedIndex="0" Skin="Windows7" OnTabClick="RadTabStrip1_TabClick" Style="padding-left: 15px">
            <Tabs>
