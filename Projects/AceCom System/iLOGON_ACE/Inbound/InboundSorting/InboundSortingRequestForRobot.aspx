<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundSortingRequestForRobot.aspx.cs" Inherits="iWMS.Web.Inbound.InboundSorting.InboundSortingRequestForRobot" %>
...
<head runat="server">
    <title>Request for Robot @ Inbound Sorting</title>
