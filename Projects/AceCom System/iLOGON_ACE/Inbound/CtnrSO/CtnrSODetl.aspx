<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CtnrSODetl.aspx.cs"
    Inherits="iWMS.Web.Inbound.CtnrSO.CtnrSODetl" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td>
                <asp:Panel ID="CtrlPanel" runat="server">                    
                    ...
                    &nbsp;
                    <asp:Button ID="EIRBtn" CssClass="blue" runat="server" OnClick="EIRBtn_Click" Text="EIR" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" /> 
                    &nbsp;                    
                    <asp:Button ID="MassDeleteBtn" class="white" runat="server" OnClick="MassDeleteBtn_Click" Text="Delete"  Visible="false"
                         OnClientClick="return confirm('Confirm to delete the selected Container(s)?')" UseSubmitBehavior="true" ToolTip="Delete Container(s)" /> 
                    &nbsp;                    
                     <asp:Button ID="MassConfirmBtn" class="white" runat="server" OnClick="MassConfirmBtn_Click" Text="Confirm"  Visible="false"
                        OnClientClick="return confirm('Confirm to store the selected Container(s)?')" UseSubmitBehavior="true" ToolTip="Release Container(s)" /> 
                    &nbsp;                   
                    <asp:Button ID="MassReOpenBtn" class="white" runat="server" OnClick="MassReopenBtn_Click" Text="Reopen"  Visible="false"
                        OnClientClick="return confirm('Confirm to re-open the selected Container(s)?')" UseSubmitBehavior="true" ToolTip="Re-Open Container(s)"  /> 
                     &nbsp;
                    <asp:Button ID="BulkAddBtn" class="white" runat="server" OnClick="BulkAddBtn_Click" Text="BulkAdd"  
                         OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" /> 
                    &nbsp;       
                    <asp:Button ID="ExcelBtn" class="green" runat="server" OnClick="ExcelBtn_Click"
        ...
        <tr>
            <td>
                <asp:Panel ID="AddPanel" runat="server" Visible="False">
                    <table border="0" cellspacing="1" cellpadding="1" width="100%">
                        <tr>
                            <td>                              
                                 &nbsp;                              
                                 <asp:Button ID="SaveBtn" CssClass="white" runat="server" OnClick="SaveBtn_Click" Text="Save" Visible="true" /> 
                                &nbsp;
                                <asp:Button ID="SaveNextBtn" CssClass="white" runat="server" OnClick="SaveNextBtn_Click" Text="Save &amp; Next" Visible="true"/> 
                                &nbsp;  
                ...
                <asp:Panel ID="BulkAddPanel" runat="server" Visible="false">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td>
                                <asp:Button ID="Redobtn" runat="server" CssClass="white" Text=" Redo " OnClick="Redobtn_Click" Visible="false"
                                ...
                                <asp:Button ID="SaveCtnrBtn" runat="server" CssClass="white" Text=" Save " OnClick="SaveCtnrBtn_Click" Visible="false" 
                                    UseSubmitBehavior="false" OnClientClick="disableBtn(this.id, true)" />&nbsp;
                                <asp:Button ID="CloseBulkAddPnlBtn" runat="server" CssClass="white" Text="Hide" OnClick="CloseBulkAddPnlBtn_Click"
                                    UseSubmitBehavior="false" OnClientClick="disableBtn(this.id, false)" CausesValidation="false" />&nbsp;
                            </td>
                        </tr>
                        <tr>
