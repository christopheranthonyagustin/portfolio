<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CtnrSOPopulatePopUp.aspx.cs"
    Inherits="iWMS.Web.Inbound.CtnrSO.CtnrSOPopulatePopUp" %>
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">CtnrSO Populate</asp:Label>
            </td>
        </tr>
    </table>
