<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2Copy.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2Copy" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>Copy @ GoodsReceiveV2</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                    <br />
                    <asp:CheckBox ID="ChargeChkBox" runat="server" Text="Include Charge Lines" Enabled="False"></asp:CheckBox>
                    <br />
                    <asp:Label Style="z-index: 0" ID="errorLb2" runat="server" CssClass="errorLabel"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
