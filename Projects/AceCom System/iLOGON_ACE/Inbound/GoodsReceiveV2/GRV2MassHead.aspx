<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2MassHead.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2MassHead" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        <asp:Button Style="z-index: 0" ID="PrintGINBtn" runat="server" CssClass="detailbutton"
            Text="Print GIN" OnClick="PrintGINBtn_Click" OnClientClick="return busyBox.Show();"></asp:Button>
