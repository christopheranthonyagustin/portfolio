<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2ContainerHead.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2ContainerHead" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="form1" runat="server" method="post">
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="ExcelBtn" CssClass="green" runat="server" OnClick="ExcelBtn_Click"
                        Text="Excel" UseSubmitBehavior="false" CausesValidation="false" />
                </td>
            </tr>
        </table>
        <br />
        <div id="div-datagrid">
            <telerik:RadGrid ID="ResultDG" runat="server" GridLines="None" AutoGenerateColumns="false"
                ...
                AllowPaging="true" Skin="Metro" ExportSettings-UseItemStyles="true"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id" GridLines="Both">
