<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2PopulateToTPR.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2PopulateToTPR" %>
...
<html>
<head runat="server">
    <title>Populate Receipt To Job @ GoodReceiveV2</title>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table style="z-index: 0" id="Table1" border="0" cellspacing="3" cellpadding="3"
            ...
            <tr>
                <td>&nbsp;<asp:Button ID="PopulateBtn" runat="server" CssClass="detailbutton" Text="Populate"
