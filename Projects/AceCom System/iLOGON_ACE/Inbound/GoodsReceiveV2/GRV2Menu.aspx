<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2Menu.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2Menu" %>
...
<html>
<head runat="server">
    <title>Menu @ GoodsReceiveV2</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Goods Receive V2</asp:Label>
                    </div>
                </td>
            </tr>
        </table>
