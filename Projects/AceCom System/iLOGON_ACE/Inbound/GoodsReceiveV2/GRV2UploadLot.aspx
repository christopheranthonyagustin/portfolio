<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRV2UploadLot.aspx.cs" Inherits="iWMS.Web.Inbound.GoodsReceiveV2.GRV2UploadLot" %>
...
<head runat="server">
    <title>UploadLot @ GoodReceive V2</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
            OnNeedDataSource="ResultDG_NeedDataSource" BorderStyle="Solid" Skin="Office2007" Visible="false">
