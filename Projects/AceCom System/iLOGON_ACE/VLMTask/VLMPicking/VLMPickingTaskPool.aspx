<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VLMPickingTaskPool.aspx.cs" Inherits="iWMS.Web.VLMTask.VLMPicking.VLMPickingTaskPool" %>
        ...
        <div>
            <table style="padding-left: 25px">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="StartPickingBtn" runat="server" Text="Start Picking" CssClass="LongLabelWhite"
                                    OnClick="StartPickingBtn_Click" CausesValidation="false" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                    </td>
                </tr>
            </table>
            <br />
