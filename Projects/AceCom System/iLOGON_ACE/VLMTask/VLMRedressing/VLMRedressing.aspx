<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VLMRedressing.aspx.cs" Inherits="iWMS.Web.VLMTask.VLMRedressing.VLMRedressing" %>
                ...
                <div>
                    <table style="padding-left: 25px">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="StartRedressingBtn" runat="server" Text="Start Redressing" CssClass="LongLabelWhite"
                                    OnClick="StartRedressingBtn_Click" CausesValidation="false" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                            </td>
                        </tr>
                    </table>
                    <br />
