<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafeEntryRegisterMenu.aspx.cs" Inherits="iWMS.Web.SafeEntry.SafeEntryRegister.SafeEntryRegisterMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Menu @ SafeEntryRegister</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="ModuleLabel" CssClass="NewModuleTitle" runat="server"></asp:Label>
                    </div>
                </td>
            </tr>
        </table>
