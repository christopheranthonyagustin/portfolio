<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafeEntryRegisterDetail.aspx.cs" Inherits="iWMS.Web.SafeEntry.SafeEntryRegister.SafeEntryRegisterDetail" %>
...
<html>
<head runat="server">
    <title>SafeEntryRegisterDetail</title>
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="padding-left: 15px;">
                                <br />
                                <asp:Button ID="SubmitBtn" runat="server" Text="Save" CssClass="white" UseSubmitBehavior="false" CausesValidation="false"
                                    OnClientClick="disableBtn(this.id, false)" OnClick="SubmitBtn_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
