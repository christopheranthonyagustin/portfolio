<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickingKioskMenu.aspx.cs" Inherits="iWMS.Web.Outbound.PickingKiosk.PickingKioskMenu" %>
...
<html>
<head runat="server">
    <title>Picking Kiosk Menu</title>
        ...
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                    left: 2px">
                    <asp:Label ID="MenuLbl" runat="server">Picking Kiosk</asp:Label></div>
            </td>
        </tr>
    </table>
    </form>
