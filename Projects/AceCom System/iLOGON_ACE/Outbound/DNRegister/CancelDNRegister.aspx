<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelDNRegister.aspx.cs" Inherits="iWMS.Web.Outbound.DNRegister.CancelDNRegister" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>CancelDNRegister</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">DNRegister Cancellation</asp:Label>
            </td>
        </tr>
    </table>
