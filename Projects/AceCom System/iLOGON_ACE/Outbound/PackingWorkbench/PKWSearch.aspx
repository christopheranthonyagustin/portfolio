<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PKWSearch.aspx.cs" Inherits="iWMS.Web.Outbound.PackingWorkbench.PKWSearch" %>
...
<html>
<head runat="server">
    <title>Search @ Packing Workbench</title>
    ...
    <form id="Form1" method="post" runat="server" defaultbutton="SearchBtn">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Ready to pack" ID="ReadyToPackTab" Value="200" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="DashboardRadPageView"></telerik:RadPageView>
             <telerik:RadPageView runat="server" Height="700px" ID="ReadytopackRadPageView"></telerik:RadPageView>
