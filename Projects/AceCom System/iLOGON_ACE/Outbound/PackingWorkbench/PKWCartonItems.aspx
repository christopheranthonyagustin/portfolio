<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PKWCartonItems.aspx.cs" Inherits="iWMS.Web.Outbound.PackingWorkbench.PKWCartonItems" %>
...
<head runat="server">
    <title>Carton Item@ Packing Workbench</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="580px" ID="CartonItemRadPageView">
                <table>
                    <tr>
                        <td>
