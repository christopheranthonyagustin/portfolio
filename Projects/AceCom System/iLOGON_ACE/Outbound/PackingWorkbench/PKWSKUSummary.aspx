<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PKWSKUSummary.aspx.cs" Inherits="iWMS.Web.Outbound.PackingWorkbench.PKWSKUSummary" %>
...
<head runat="server">
    <title>Pallet @ Packing Workbench</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="580px" ID="PalletRadPageView">
                <table>
                    <tr>
                        <td>
