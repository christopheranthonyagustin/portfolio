<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PKWPalletCarton.aspx.cs" Inherits="iWMS.Web.Outbound.PackingWorkbench.PKWPalletCarton" %>
...
<head runat="server">
    <title>Pallet carton @ Packing Workbench</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="580px" ID="PalletCartonRadPageView">
                <table>
                    <tr>
                         <td>
