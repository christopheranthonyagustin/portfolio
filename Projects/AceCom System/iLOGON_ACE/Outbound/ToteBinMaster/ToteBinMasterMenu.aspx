...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToteBinMasterMenu.aspx.cs" Inherits="iWMS.Web.Outbound.ToteBinMaster.ToteBinMasterMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>ToteBinMasterMenu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Tote Bin Master</asp:Label>
                </div>
            </td>
        </tr>
    </table>
