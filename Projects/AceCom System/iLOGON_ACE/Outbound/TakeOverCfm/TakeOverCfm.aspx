<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TakeOverCfm.aspx.cs" Inherits="iWMS.Web.Outbound.TakeOverCfm.TakeOverCfm" %>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">TakeOver Confirmation</asp:Label>
                </div>
            </td>        
        </tr>
    </table>
