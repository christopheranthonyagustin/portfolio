<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanMenu.aspx.cs" Inherits="iWMS.Web.Outbound.Loan.LoanMenu" %>
<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>LoanMenu</title>
        ...
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
              <%--  <div style="padding-bottom: 5px; padding-left: 3px; padding-right: 5px; padding-top: 3px;
                        ...
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server">LOAN</asp:Label>
                      </div>
            </td>
        </tr>
    </table>
