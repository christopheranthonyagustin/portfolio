...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickingCartMasterMenu.aspx.cs" Inherits="iWMS.Web.Outbound.PickingCartMaster.PickingCartMasterMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PickingCartMasterMenu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Picking Cart Master</asp:Label>
                </div>
            </td>
        </tr>
    </table>
