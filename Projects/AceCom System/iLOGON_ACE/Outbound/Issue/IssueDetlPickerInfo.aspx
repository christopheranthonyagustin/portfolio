<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueDetlPickerInfo.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.IssueDetlPickerInfo" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>Goods Issue PickerInfo</title>
