<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueReleaseRequestHead.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.IssueReleaseRequestHead" %>
...
<html>
<head runat="server">
    <title>IsReleaseRequestHead</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" CausesValidation="false"
            ...
            <Tabs>
                <telerik:RadTab Text="RORequest" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <br />
        <table>
            <tr>
                <td>
                    <asp:Button ID="ConfirmBtn" CssClass="white" runat="server" OnClick="ConfirmBtn_Click" Text="Accept RO"
