<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ALPSItemRequestInterface.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.ALPSItemRequestInterface" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Received On" DataField="ReceivedOn" 
                        SortExpression="GeneratedOn" UniqueName="GeneratedOn" Reorderable="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="id" DataField="ItemRequestId" AllowSorting="false"
