<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MOTULDESADVInterface.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.MOTULDESADVInterface" %>
...
<head runat="server">
    <title>MOTULDESADVInterface</title>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="SAP Delivery No" DataField="SAPDeliveryNo"
                        SortExpression="SAPDeliveryNo" UniqueName="SAPDeliveryNo" Reorderable="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Market" DataField="Market"
                        SortExpression="Market" UniqueName="Market" Reorderable="true">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn HeaderText="LFART" DataField="LFART"
                        SortExpression="LFART" UniqueName="LFART" Reorderable="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Line Count" DataField="POLineCount"
