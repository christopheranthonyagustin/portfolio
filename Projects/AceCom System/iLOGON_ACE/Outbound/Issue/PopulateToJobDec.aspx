<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopulateToJobDec.aspx.cs"
    Inherits="iWMS.Web.Outbound.Issue.PopulateToJobDec" %>
            ...
            <tr>
                <td>
                    <asp:Button ID="PopulateBtn" runat="server" CssClass="white" Text="Populate"
                        OnClick="PopulateBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"></asp:Button>
                </td>
            </tr>
             <tr>
                <td>
