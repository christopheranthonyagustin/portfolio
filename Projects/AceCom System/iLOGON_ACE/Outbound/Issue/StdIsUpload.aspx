<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StdIsUpload.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.StdIsUpload" %>
...
<body>
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td colspan="2">
                <asp:Label ID="headerLbl1" Visible="false" runat="server" CssClass="pagetitle"></asp:Label><br />
                <br />
            </td>
            <td width="40%">
            </td>
