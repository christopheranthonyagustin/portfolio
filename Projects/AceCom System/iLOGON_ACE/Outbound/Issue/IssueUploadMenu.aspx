<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueUploadMenu.aspx.cs"
    Inherits="iWMS.Web.Outbound.Issue.IssueUploadMenu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>DrListingByAccount</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 30%; background-color: #660000;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        &nbsp;<asp:Label ID="ReportLbl" runat="server">Issue Upload</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
