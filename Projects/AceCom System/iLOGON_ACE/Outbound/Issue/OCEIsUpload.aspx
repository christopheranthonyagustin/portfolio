<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OCEIsUpload.aspx.cs" Inherits="iWMS.Web.Outbound.Issue.OCEIsUpload" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
        <tr>
            <td colspan="2">
                <asp:Label ID="headerLbl1" runat="server" CssClass="pagetitle" />&nbsp;<br />
                <br />
            </td>
            <td width="40%">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <a id="ExportExcelLnk" runat="server" onserverclick="ExportExcel" visible="false">
                    <img id="excelImg" border="0" alt="Export to Excel" align="absMiddle" src="../../Image/excel.gif"
                        height="20" runat="server"></img></a>
            </td>
        </tr>
    </table>
    <br />
