<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentSkuHeadExpected.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentSkuHeadExpected" %>
    ...
    <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
       ...
       <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn Display="False" DataField="acid" UniqueName="acid"></telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn Display="False" DataField="sitecode" UniqueName="sitecode"></telerik:GridBoundColumn>
