<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentLogDetl.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentLogDetl" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table style="width: 100%; height: 30px">
            ...
            <tr>
                <td>
                    <asp:Button ID="EDIBtn" runat="server" Text="EDI" OnClick="EDIBtn_Click"
                        OnClientClick="disableBtn(this.id,false)" CssClass="green" />
                    &nbsp;
