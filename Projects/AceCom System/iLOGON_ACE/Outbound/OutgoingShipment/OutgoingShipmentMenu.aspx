...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentMenu.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                        <asp:Label ID="IssueMenuLbl" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    </form>
