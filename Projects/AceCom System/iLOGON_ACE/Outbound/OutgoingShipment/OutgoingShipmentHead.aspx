<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentHead.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentHead" %>
...
<html>
<head runat="server">
    <title>OutgoingShipmentHead</title>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="AllocatedImgBtn" runat="server" Text="Allocate" OnClick="AllocatedImgBtn_Click"
                                ...
                                UseSubmitBehavior="false" CssClass="white" ToolTip="Allocate Selected OutgoingShipment(s)" />
                        </td>
                        ...
                        <td>
                            <asp:Button ID="UnAllocatedBtn" runat="server" Text="Unallocate" OnClick="UnAllocatedBtn_Click"
                                OnClientClick="disableBtn(this.id,false)"
                                UseSubmitBehavior="false" CssClass="white" ToolTip="Unallocate Selected OutgoingShipment(s)" />
                        </td>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton runat="server" ID="OutgoingShipmentEdit" ImageUrl="../../image/pencil.gif"
                                        BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Edit OutgoingShipment"
                                        OnClick="ldEdit_Click" CausesValidation="False"></asp:ImageButton>
                                    <asp:ImageButton runat="server" Visible="False" ID="OutgoingShipmentCancel" ImageUrl="../../image/bin.gif"
                                        BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Cancel OutgoingShipment"
                                    ...
                                    <asp:ImageButton runat="server" Visible="True" ID="OutgoingShipmentCopy" ImageUrl="../../image/copy.png"
                                        BorderWidth="0" BackColor="Transparent" Width="15" Height="15" AlternateText="Copy OutgoingShipment"
                                        OnClick="OutgoingShipmentCopy_Click" CausesValidation="False"></asp:ImageButton>
                            ...
                            <telerik:GridBoundColumn DataField="GradeDescription" SortExpression="GradeDescription" HeaderText="Grade" AutoPostBackOnFilter="true">
                            </telerik:GridBoundColumn>
