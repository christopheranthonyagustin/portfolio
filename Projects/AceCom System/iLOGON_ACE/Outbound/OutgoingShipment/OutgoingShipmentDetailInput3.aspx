<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentDetailInput3.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentDetailInput3" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Stock On Hand" Value="6" ID="StockOnHandTab" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="TUNO1 Stock on Hand" Value="7" ID="TUNO1StockonHandTab" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="LotDischarge" Value="8">
                </telerik:RadTab>
                <telerik:RadTab Text="Attc" Value="9" ID="AttcTab" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="SAPInfo" Value="10">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView ID="StockOnHandRadPageView" Height="500px" runat="server"></telerik:RadPageView>
            <telerik:RadPageView ID="TUNO1StockonHandRadPageView" Height="500px" runat="server"></telerik:RadPageView>
                            ...
                            <asp:Panel ID="FileUploadPanel" runat="server">
                                <table border="0" cellspacing="2" cellpadding="2" width="100%">
                                    <tr>
                                        ...
                                        <asp:Label ID="MessageLbl1" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
