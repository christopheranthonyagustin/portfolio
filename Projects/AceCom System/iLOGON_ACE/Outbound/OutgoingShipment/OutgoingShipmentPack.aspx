<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentPack.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentPack" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" CausesValidation="false" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Id="ItemTab" Text="Item" Value="0" readonly="readonly" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="SerialNoTab" Text="SerialNo" Value="50" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="700px" ID="MainInfoRadPageView">
                ...
                <table border="0" width="100%">
                    <tr>
                        <td>
                            <asp:Button ID="NewPackingBtn" CssClass="white" runat="server" Text="NewPacking" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CausesValidation="false" OnClick="NewPackingBtn_Click" />
                        </td>
                    </tr>
                </table>
                <table border="0" width="100%">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="CartonLabelBtn" runat="server" CssClass="blue" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CausesValidation="false" Text="Carton Label" OnClick="CartonLabelBtn_Click" />
                                    </td>
                                    <td>
                                        <asp:Button ID="ExcelBtn" runat="server" Text="PackUnit" OnClick="ExcelBtn_Click" UseSubmitBehavior="false" CssClass="green" ToolTip="Manifest Excel" />
                                    </td>
                                    <td>
                                        <asp:Button ID="PackDetailButton" runat="server" Text="PackDetail" OnClick="PackDetailButton_Click" UseSubmitBehavior="false" CssClass="green" ToolTip="Manifest Excel" />
                                    </td>
                                </tr>
                            </table>
                        </td>
