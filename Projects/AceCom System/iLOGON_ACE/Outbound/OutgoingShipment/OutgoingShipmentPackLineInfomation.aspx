<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentPackLineInfomation.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentPackLineInfomation" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Pack @ LineInformation</title>
    ...
    <script type="text/javascript">
        ...
        function LineInfoCBSelectAll(invoker) {
            var inputElements = document.getElementsByTagName('input');
            for (var i = 0; i < inputElements.length; i++) {
                var myElement = inputElements[i];
                if (myElement.type === "checkbox") {
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="PrevBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="PrevBtn_Click" Visible="true"
                Text="Prev" CausesValidation="false" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
            &nbsp;
                                <asp:Button ID="NextBtn" CssClass="white" runat="server" BackColor="Pink" OnClick="NextBtn_Click" Visible="true"
        ...
        <div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <telerik:radgrid id="LineInfoDg" runat="server" enablelinqexpressions="False" skin="Metro" rendermode="Lightweight"
                        allowmultirowselection="true" onneeddatasource="LineInfoDg_NeedDataSource" allowfilteringbycolumn="false"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="Id" TableLayout="Fixed" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                <Columns>
                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="30px" ItemStyle-Width="30px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <input id="LineInfoCBSelectAll" name="LineInfoCBSelectAll" type="checkbox" onclick="LineInfoCBSelectAll(this)">
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="LineInfoCHKObjective" runat="server" />
                                        </ItemTemplate>
