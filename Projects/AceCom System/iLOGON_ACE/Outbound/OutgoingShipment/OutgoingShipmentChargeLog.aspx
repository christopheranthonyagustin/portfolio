<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentChargeLog.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentChargeLog" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>IssueChargeLog</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div style="height: 120%" id="div-datagrid">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" Width="100%" Height="100%">
