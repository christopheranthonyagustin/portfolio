<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentExplode.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentExplode" %>
    ...
    <div>
        <table id="table1" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
            ...
            <tr>
                <td colspan="2">
                    &nbsp;
                    <asp:Button ID="Populate_Btn" runat="server" OnClick="Populate_Btn_Click" Text=" POPULATE "
                        CssClass="detailButton" />
                </td>
            </tr>
        </table>
    </div>
