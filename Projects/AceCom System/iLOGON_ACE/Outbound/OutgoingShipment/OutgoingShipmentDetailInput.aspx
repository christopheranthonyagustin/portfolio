<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentDetailInput.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentDetailInput" %>
...
<body onload="javascript:window.focus();" leftmargin="0" topmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td>
                <iWMS:iInput ID="iInput1" runat="server"></iWMS:iInput>
                <br>
            </td>
        </tr>
        <tr>
