<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutgoingShipmentCtnrPreLoadCheck.aspx.cs" Inherits="iWMS.Web.Outbound.OutgoingShipment.OutgoingShipmentCtnrPreLoadCheck" %>
...
<body>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG3" runat="server" AutoGenerateColumns="false" GridLines="None"
            OnNeedDataSource="ResultDG3_NeedDataSource" AllowSorting="true"
            Skin="Metro">
            <ClientSettings AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                <Selecting AllowRowSelect="true" />
            </ClientSettings>
