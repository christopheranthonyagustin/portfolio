<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundSortingLoadRobotForIssuance.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundSorting.OutboundSortingLoadRobotForIssuance" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <table style="padding-left: 15px" id="t1" runat="server">
            <tr>
                <td>
                    ...
                    <telerik:RadTextBox ID="RobotTxt" runat="server" Skin="Sunset" Width="200" Height="50" CausesValidation="false" BackColor="#ded7c6" Font-Size="Large"
                        UseSubmitBehavior="false" OnTextChanged="RobotTxt_TextChanged" AutoPostBack="true"></telerik:RadTextBox>
                </td>
            </tr>
        </table>
        <br />
        ...
        <br />
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick" Style="padding-left: 15px"
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="100%" ID="HeaderRadPageView">
                <div>
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" style="padding-left: 15px"
