<%@ Page Language="c#" CodeBehind="PickingStartMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Outbound.PickTicket.PickingStartMenu" %>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 40%; background-color: #FF6600;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        <asp:Label ID="PTLbl" runat="server">Starting Picking</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
