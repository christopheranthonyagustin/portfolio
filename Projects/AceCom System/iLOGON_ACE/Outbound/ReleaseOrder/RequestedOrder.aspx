...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestedOrder.aspx.cs"
    Inherits="iWMS.Web.Outbound.ReleaseOrder.RequestedOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>RequestedOrder</title>
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="rostatusdescr" SortExpression="rostatusdescr" HeaderText="Status"
                    AllowFiltering="true">
                </telerik:GridBoundColumn>
