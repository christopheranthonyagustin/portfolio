<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseOrderDraftForm.aspx.cs"
    Inherits="iWMS.Web.Outbound.ReleaseOrder.ReleaseOrderDraftForm" %>
...
<head runat="server">
    <title>ReleaseOrderDraftForm</title>
...
<body onload='displayRow("table1");'>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" Height="580px" ID="OrderdetlsRadPageView">
            </telerik:RadPageView>
