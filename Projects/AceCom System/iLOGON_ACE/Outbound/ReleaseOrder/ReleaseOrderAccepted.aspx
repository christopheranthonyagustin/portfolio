<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseOrderAccepted.aspx.cs" Inherits="iWMS.Web.Outbound.ReleaseOrder.ReleaseOrderAccepted" %>
...
<body>
    ...
    <div id="div-datagrid" style="height: 98%">
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
            ...
            Skin="Windows7" OnNeedDataSource="ResultDG_NeedDataSource" OnItemDataBound="ResultDG_ItemDataBound">
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="GINO" SortExpression="GINO" HeaderText="GINO" AllowFiltering="false">
                    </telerik:GridBoundColumn>
