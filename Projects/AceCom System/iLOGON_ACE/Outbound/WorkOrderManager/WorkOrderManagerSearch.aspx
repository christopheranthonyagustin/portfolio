<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkOrderManagerSearch.aspx.cs" Inherits="iWMS.Web.Outbound.WorkOrderManager.WorkOrderManagerSearch" %>
...
<html>
<head runat="server">
    <title>Search @ WorkOrderManager</title>
...
<body>
    <form id="Form1" method="post" runat="server" defaultbutton="SearchBtn">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Dashboard" ID="DashboardTab" Value="100" runat="server">
                 ...
                 <telerik:RadTab Text="WO Request" ID="WORequestTab"  Value="150" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Upload" ID="UploadTab" Value="200" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="WorkOrderManagerDashboardRadPageView" />
            <telerik:RadPageView runat="server" Height="700px" ID="WORequestRadPageView" />
