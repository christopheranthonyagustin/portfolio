<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingKioskCloseAndSeal.aspx.cs" Inherits="iWMS.Web.Outbound.PackingKiosk.PackingKioskCloseAndSeal" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock runat="server">
        <script type="text/javascript">
            ...
            function Close() {
                GetRadWindow().close();
                window.parent.location.href = "../PackingKiosk/PackingKioskScanPickingCart.aspx";
            }
        </script>
