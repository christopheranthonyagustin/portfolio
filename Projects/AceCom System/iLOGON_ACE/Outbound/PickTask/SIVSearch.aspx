<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SIVSearch.aspx.cs" Inherits="iWMS.Web.Outbound.PickTask.SIVSearch" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:ImageButton ID="ConfirmPABtn" runat="server" ImageUrl="../../Image/Confirm.png"
                        ...
                        &nbsp;
                    <asp:Button ID="BatchBtn" class="white" runat="server" OnClick="BatchBtn_Click" Text="BatchSIV" 
