<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackIntoCageCartonReadyForCage.aspx.cs" Inherits="iWMS.Web.Outbound.PackIntoCage.PackIntoCageCartonReadyForCage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="CartonLabelBtn" CssClass="blue" runat="server" OnClick="CartonLabelBtn_Click" Text="Carton Label"
        ...
        <div>
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true" EnableLinqExpressions="false"
                AllowPaging="true" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" OnColumnCreated="ResultDG_ColumnCreated" OnPreRender="ResultDG_PreRender">
