<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterfaceUpload_DUNI.aspx.cs" Inherits="iWMS.Web.Outbound.WithdrawalRequest.InterfaceUpload_DUNI" %>
                    ...
                    <table>
                      <tr>
                        <td class="style1">
                            ...
                            <br /><br />
                            &nbsp;<asp:Label ID="Label4" Text="1. Any similar CustomerReference that was previously uploaded into Goods Issue that exists in this file will be ignore." Font-Size="15px" runat="server"></asp:Label>
                            <br />
                        </td>
                      </tr>
                    </table>
