<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WithdrawalRequestHead.aspx.cs" Inherits="iWMS.Web.Outbound.WithdrawalRequest.WithdrawalRequestHead" %>
...
<html>
<head runat="server">
    <title>WithdrawalRequestHead</title>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="HeaderRadPageView">
                ...
                <div id="div-datagrid">
                    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                        ...
                        OnItemDataBound="ResultDG_ItemDataBound" OnPageIndexChanged="ResultDG_PageIndexChanged" OnPreRender="ResultDG_PreRender">
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="exref2" SortExpression="exref2" HeaderText="Request No" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                                </telerik:GridBoundColumn>
