<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GFInterfaceUpload.aspx.cs" Inherits="iWMS.Web.Outbound.WithdrawalRequest.GFInterfaceUpload" %>
        ...
        <MasterTableView AllowMultiColumnSorting="false" TableLayout="Fixed" Name="Master"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn FilterControlWidth="50px" HeaderStyle-Width="80px" ItemStyle-Width="80px"
                    AllowFiltering="true" DataField="status" ColumnGroupName="status" ShowFilterIcon="false"
                    SortExpression="status" UniqueName="Status" HeaderText="Status" AutoPostBackOnFilter="true"
                ...
                <telerik:GridBoundColumn HeaderText="IssueNo" DataField="issueno" AllowFiltering="true"
                    FilterControlWidth="70px" HeaderStyle-Width="80px" ColumnGroupName="issueno"
                    SortExpression="issueno" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                ...
                <telerik:GridBoundColumn HeaderText="ISStatus" DataField="isstatus" AllowFiltering="false"
                    HeaderStyle-Width="70px" ColumnGroupName="isstatus" SortExpression="isstatus"
                    UniqueName="ISStatus">
                </telerik:GridBoundColumn>
