<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CtnrROHead.aspx.cs"
    Inherits="iWMS.Web.Outbound.CtnrRO.CtnrROHead" %>
<%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>CtnrROHead</title>
...
<body>
    ...
    <table width="100%">
        <tr>
            <td>                 
                 <asp:Button ID="cancelBtn" class="white" runat="server" OnClick="cancelImgBtn_Clicked" Visible="true"
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
        ...
        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" Name="ParentGrid">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="number" SortExpression="number" HeaderText="RO No">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="ReleasedQty" SortExpression="ReleasedQty" HeaderText="Released" AllowFiltering="false" 
