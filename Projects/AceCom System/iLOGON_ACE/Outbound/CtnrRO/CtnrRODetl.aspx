<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CtnrRODetl.aspx.cs"
    Inherits="iWMS.Web.Outbound.CtnrRO.CtnrRODetl" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="CtrlPanel" runat="server">                    
                    ...
                    &nbsp;                  
                    <asp:Button ID="EIRBtn" class="blue" runat="server" OnClick="EIRBtn_Click" Text="EIR" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" /> 
                    &nbsp;                   
                    ...
                    &nbsp;                  
                     <asp:Button ID="MassConfirmBtn" class="white" runat="server" OnClick="MassConfirmBtn_Click" Text="Confirm"  Visible="false"
                        OnClientClick="return confirm('Confirm to release the selected Container(s)?')" UseSubmitBehavior="true" ToolTip="Release Container(s)" /> 
                    &nbsp;                  
