<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelIssueRegisterV2.aspx.cs" Inherits="iWMS.Web.Outbound.IssueRegisterV2.CancelIssueRegisterV2" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>CancelIssueRegisterV2</title>
    <base target="_self" />
...
<body onload="javascript:window.focus();">
    ...
    <table cellspacing="2" cellpadding="2" width="100%">
        <tr>
            <td>
                <asp:Label ID="TitleLbl" runat="server" CssClass="pagetitle">IssueRegisterV2 Cancellation</asp:Label>
            </td>
        </tr>
    </table>
