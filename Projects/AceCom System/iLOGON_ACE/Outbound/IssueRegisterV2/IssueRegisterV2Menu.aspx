...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueRegisterV2Menu.aspx.cs" Inherits="iWMS.Web.Outbound.IssueRegisterV2.IssueRegisterV2Menu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>OutboundMenu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">IssueRegister V2</asp:Label>
                </div>
            </td>
        </tr>
    </table>
