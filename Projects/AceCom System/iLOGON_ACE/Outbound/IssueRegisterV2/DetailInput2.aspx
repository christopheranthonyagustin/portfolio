<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailInput2.aspx.cs" Inherits="iWMS.Web.Outbound.IssueRegisterV2.DetailInput2" %>
                        ...
                        <td>
                            <table cellspacing="2" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="QtyLbl" runat="server">ExpQty</asp:Label>:
                                    ...
                                    <td>
                                        <asp:Label ID="QtyHLbl" runat="server">AllocatedQTY</asp:Label>:
                                        <br>
                                        <telerik:RadTextBox ID="INTEGER_QtyAlloc" runat="server" Width="155" Enabled="True">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="2" cellspacing="2">
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ID" EditMode="InPlace">
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="TransQty" AllowFiltering="false"
                                                        ...
                                                        <ItemTemplate>
                                                            <telerik:RadTextBox ID="AllocQtyTxt" runat="server" Skin="WebBlue" Text="0" Width="80px"
                    ...
                    <tr>
                        <td align="Center">
                            <telerik:RadButton ID="AllocateBtn" runat="server" Skin="WebBlue" Text="Allocate" CssClass="detailbutton"
                                OnClick="AllocateBtn_Click" Visible="false"></telerik:RadButton>&nbsp;
                            <telerik:RadButton ID="CloseBtn" runat="server"  Skin="WebBlue" Text="Close" CssClass="detailbutton" OnClick="CloseBtn_Click">
                            </telerik:RadButton>
                            <br />
