<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPackingMenu.aspx.cs" Inherits="iWMS.Web.Outbound.OrderPacking.OrderPackingMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>OrderPackingMenu</title>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="NewModuleTitle">
                        <asp:Label ID="MenuLbl" labelclass="NewModuleTitle" runat="server" />
                    </div>
                </td>
            </tr>
            <tr>
