<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPackingPackDetl.aspx.cs" Inherits="iWMS.Web.Outbound.OrderPacking.OrderPackingPackDetl" %>
...
<head runat="server">
    <title>Pack @ Order Packing</title>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function selectAll(id) {
                var masterTable = $find("<%= PKDetlResultDG.ClientID %>").get_masterTableView();
        ...
        <asp:UpdatePanel ID="PKDetlUpdatePanel" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="PKDetlResultDG" runat="server" EnableLinqExpressions="False" Skin="Metro" RenderMode="Lightweight"
                    AllowMultiRowSelection="true" OnNeedDataSource="PKDetlResultDG_NeedDataSource" AllowFilteringByColumn="false" OnItemDataBound="PKDetlResultDG_ItemDataBound"
                    AllowPaging="true" AutoGenerateColumns="false" GridLines="None" OnBatchEditCommand="PKDetlResultDG_BatchEditCommand">
