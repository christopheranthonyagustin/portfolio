<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3CustomsDeclaration.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3CustomsDeclaration" %>
...
<html>
<head runat="server">
    <title>Customs Declaration @ Goods Issue</title>
...
<body leftmargin="0" topmargin="0">
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="PopulateBtn" runat="server" CssClass="white" Text="Populate"
                        OnClick="PopulateBtn_Click" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"></asp:Button>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="AccLbl" runat="server" Visible="false">Account</asp:Label>
                    <br />
                    <telerik:RadDropDownList ID="AccDDL" ZIndex="15000" runat="server" Width="155px" Skin="Sunset" Visible="false">
