<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3ContainerItemInput.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3ContainerItemInput" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="CtnrNoLabel" Font-Bold="true" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
