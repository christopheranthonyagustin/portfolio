<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3Container.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3Container" %>
            ...
            function SelectAll(Invoker) {
                ...
                for (var i = 0; i < InputElements.length; i++) {
                    ...
                    if (Element.type === "checkbox") {
                        Element.checked = Invoker.checked;
                    }
                    else {
                        Element.checked = Invoker.UnChecked
                    }
                }
            }
        </script>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="pagetitle">
                    ...
                    &nbsp;
                    <asp:Button ID="DOBtn" runat="server" Text="DO" CssClass="blue" OnClick="DOBtn_Click"
