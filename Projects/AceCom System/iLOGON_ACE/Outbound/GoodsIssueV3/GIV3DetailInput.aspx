<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3DetailInput.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3DetailInput" %>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" ID="MainRadPageView">
                ...
                <asp:Panel ID="AddPanel" runat="server">
                    ...
                    <asp:Button ID="SearchInventoryBtn" runat="server" CssClass="white" Text="Search" OnClick="SearchInventoryBtn_Click"
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CausesValidation="false" />
                    <asp:Button ID="SearchGRBtn" runat="server" CssClass="white" Text="SearchGR" OnClick="SearchGRBtn_Click"
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CausesValidation="false" />
                </asp:Panel>
