<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3Charge.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3Charge" %>
                ...
                <td>
                    ...
                    <asp:Button ID="QuBtn" runat="server" CssClass="white" OnClick="QuBtnBtn_Click"
                     ...
                     <asp:Button ID="DelImgBtn" runat="server" CssClass="white" OnClick="DeleteBtn_Click"
                         ToolTip="Delete Selected Charges(s)" Text="Delete" />
