<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3AddCharge.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3AddCharge" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:Button ID="AddBtn" runat="server" CssClass="detailButton" Text="Add" OnClick="AddBtn_Click"></asp:Button>&nbsp;<asp:Button ID="CloseBtn" runat="server" CssClass="detailButton"
