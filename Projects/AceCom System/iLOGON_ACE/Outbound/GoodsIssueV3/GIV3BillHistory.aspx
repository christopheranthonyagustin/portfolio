<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV3BillHistory.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV3.GIV3BillHistory" %>
        ...
        <div style="height: 80%" id="div-datagrid">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
