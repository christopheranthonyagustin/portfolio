<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryCountRecords.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryCountRecords" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Button ID="SendCandidatesBtn" CssClass="LongLabelWhite" runat="server" OnClick="SendCandidatesBtn_Click"
                        Text="Send Candidates" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
                  <td>
                    <asp:Button ID="SendResultsBtn" CssClass="LongLabelWhite" runat="server" OnClick="SendResultsBtn_Click"
                        Text="&nbsp;&nbsp;&nbsp;&nbsp;Send  &nbsp;&nbsp;&nbsp;&nbsp; Results" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
                </td>
                  <td>
                    <asp:Button ID="SendAdjustmentBtn" CssClass="LongLabelWhite" runat="server" OnClick="SendAdjustmentBtn_Click"
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="false"
            EnableLinqExpressions="false" AllowPaging="true" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" Width="300%" OnItemDataBound="ResultDG_ItemDataBound"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" DataKeyNames="ICID"
                ...
                <Columns>
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ReadOnly="true" Display="true" HeaderStyle-Wrap="true" ItemStyle-Wrap="true" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                        <HeaderTemplate>
