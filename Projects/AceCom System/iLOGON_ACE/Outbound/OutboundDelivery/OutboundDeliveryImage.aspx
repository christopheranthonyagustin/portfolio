...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryImage.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryImage" %>
        ...
        <tr>
            ...
            <td>
                <div style="display:inline-block; height: 90vh; float: right; position:relative; margin-left:28px;">
                    <asp:Button ID="DownloadAllBtn" CssClass="white" runat="server" OnClick="DownloadAllBtn_ServerClick" Text="Download All Files" UseSubmitBehavior="false" style="margin-top:5px; margin-bottom:8px" />
