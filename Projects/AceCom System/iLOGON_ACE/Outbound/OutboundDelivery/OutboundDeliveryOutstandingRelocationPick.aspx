<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryOutstandingRelocationPick.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryOutstandingRelocationPick" %>
...
<head runat="server">
    <title>OutstandingRelocationPick</title>
            ...
            <telerik:RadPageView runat="server" Height="580px" ID="PlannedRadPageView">
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="StartRelocationBtn" runat="server" CssClass="LongLabelWhite" Text="Start Relocation"
                                OnClick="StartRelocationBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
                <br />
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Width="50px" HeaderStyle-Width="50px">
                                <HeaderTemplate>
                            ...
                            <telerik:GridBoundColumn Display="false" DataField="Location">
