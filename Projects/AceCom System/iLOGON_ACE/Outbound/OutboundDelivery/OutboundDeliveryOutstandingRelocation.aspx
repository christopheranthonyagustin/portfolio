<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryOutstandingRelocation.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryOutstandingRelocation" %>
...
<head runat="server">
    <title>OutstandingRelocation</title>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="RequestRelocationBtn" runat="server" CssClass="LongLabelWhite" Text="Request Relocation"
                                OnClick="RequestRelocationBtn_Click" OnClientClick="disableBtn(this.id, false)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
                <br />
