<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryPickDetl.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryPickDetl" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td align="left">
                    ...
                    &nbsp;<asp:Button ID="BackBtn" runat="server" Text="Back" Class="white" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false"
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" RenderMode="Lightweight" ShowStatusBar="true"
            ...
            OnNeedDataSource="ResultDG_NeedDataSource" OnBatchEditCommand="ResultDG_BatchEditCommand">
