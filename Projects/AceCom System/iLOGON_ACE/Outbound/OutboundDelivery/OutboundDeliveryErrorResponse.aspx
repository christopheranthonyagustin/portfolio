<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryErrorResponse.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryErrorResponse" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Id="ErrorresponseRecordsTab" Text="Error response Records" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="ErrorresponseLogTab" Text="Error response Log" Value="50" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="IssueId" DataField="IssueId" Display="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="IssueNo" DataField="IssueNo" Display="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="OrderNo" DataField="OrderNo" Display="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="SKUCode" DataField="SKUCode" Display="false"></telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="ErrorresponseLogRadPageView" />
