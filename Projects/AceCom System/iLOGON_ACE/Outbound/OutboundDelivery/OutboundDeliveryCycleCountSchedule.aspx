<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliveryCycleCountSchedule.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliveryCycleCountSchedule" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
         <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                <telerik:RadTab Text="Outstanding count" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Count in progress" Value="50" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Text="Count records" Value="100" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" Height="580px" ID="PlannedRadPageView">
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="false"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White" DataKeyNames="SKUID"
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="CountInProgessRadPageView" />
