<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDeliverySKULineAdd.aspx.cs" Inherits="iWMS.Web.Outbound.OutboundDelivery.OutboundDeliverySKULineAdd" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Attc" Value="1" ID="AttcTab" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
