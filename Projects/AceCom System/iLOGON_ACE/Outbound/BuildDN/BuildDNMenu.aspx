<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuildDNMenu.aspx.cs" Inherits="iWMS.Web.Outbound.BuildDN.BuildDNMenu" %>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Build DN</asp:Label>
                </div>
            </td>
        </tr>
    </table>
