<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipPlanItemizedRecords.aspx.cs" Inherits="iWMS.Web.Outbound.ShipPlan.ShipPlanItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../ShipPlan/ShipPlanHead.aspx";
        }
