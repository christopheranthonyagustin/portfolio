<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipPlanHUNotClosed.aspx.cs" Inherits="iWMS.Web.Outbound.ShipPlan.ShipPlanHUNotClosed" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>HU Not Closed</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="CloseHUBtn" runat="server" Text="Close Cage" OnClick="CloseHUBtn_Click"
            ...
            <asp:Button ID="RefreshBtn" runat="server" Text="Refresh" OnClick="RefreshBtn_Click"
             ...
             &nbsp;
            <asp:Button ID="DeleteCageBtn" runat="server" Text="Delete Cage" OnClick="DeleteCageBtn_Click"
                OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" CssClass="white" />
             &nbsp;
        ...
        <div>
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" OnColumnCreated="ResultDG_ColumnCreated" AllowSorting="true" AllowFilteringByColumn="true" EnableLinqExpressions="false"
                AllowPaging="true" Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" ReorderColumnsOnClient="true"  OnPreRender="ResultDG_PreRender"
