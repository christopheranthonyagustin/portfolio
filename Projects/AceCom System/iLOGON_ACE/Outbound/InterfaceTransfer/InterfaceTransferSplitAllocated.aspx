<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterfaceTransferSplitAllocated.aspx.cs" Inherits="iWMS.Web.Outbound.InterfaceTransfer.InterfaceTransferSplitAllocated" %>
...
<head id="Head1" runat="server">
    <title>InterfaceTransferSplitAllocated</title>
                            ...
                            <table cellspacing="2" cellpadding="2">
                                <tr>
                                    ...
                                    <asp:Panel ID="BomPanel" runat="server">
                                        ...
                                        <td>
                                            <asp:Label ID="BomUomLbl" runat="server">BOM UOM</asp:Label>:
                                            <br />
                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Tu1Lbl" runat="server">TU#</asp:Label>1
                                            <br />
                                            <telerik:RadTextBox ID="TEXT_Tu1" runat="server">
                                            </telerik:RadTextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="Tu2Lbl" runat="server">TU#</asp:Label>2
                                            <br />
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="2" cellspacing="2">
                                        ...
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ID" EditMode="InPlace">
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="availableUOMQty" SortExpression="availableUOMQty" HeaderText="UOMQty" DataFormatString="{0:#,0.####}">
                                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                                        <ItemStyle Wrap="False"></ItemStyle>
                                                    </telerik:GridBoundColumn>
                    ...
                    <tr>
                        <td align="Center">
                            <telerik:RadButton ID="SplitBtn" runat="server" Skin="WebBlue" Text="ReAllocate"
