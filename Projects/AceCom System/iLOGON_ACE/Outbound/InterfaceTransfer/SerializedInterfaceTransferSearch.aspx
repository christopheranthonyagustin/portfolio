<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerializedInterfaceTransferSearch.aspx.cs" Inherits="iWMS.Web.Outbound.InterfaceTransfer.SerializedInterfaceTransferSearch" %>
...
<head id="Head1" runat="server">
    <title>SerializedInterfaceTransferSearch</title>
        ...
        <tr>
            ...
            <td class="NewModuleTitle" align="left">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Serialized InterfaceTransfer</asp:Label>
                </div>
            </td>
        </tr>
    </table>
