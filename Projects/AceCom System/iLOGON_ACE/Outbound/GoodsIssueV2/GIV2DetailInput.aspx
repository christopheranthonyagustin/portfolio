<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2DetailInput.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2DetailInput" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="External" Value="4">
                </telerik:RadTab>
                <telerik:RadTab Text="Invoice" Value="5">
                </telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
            <telerik:RadPageView runat="server" ID="MainRadPageView">
                    ...
                    <table>
                        <tr>
                            ...
                            <td align="left" style="width: 195px">
                                ...
                                <asp:Label ID="ChkClearLbl" runat="server" Font-Bold="true" Font-Size="Small" Text="Clear Fields for Next Entry" ForeColor="Black"></asp:Label>
                            </td>
                            <td align="left">
                                <asp:CheckBox ID="ChkAutoAllocate" ToolTip="AutoAllocate" runat="server" />
                                <asp:Label ID="ChkAutoAllocateLbl" runat="server" Font-Bold="true" Font-Size="Small" Text="AutoAllocate" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                <asp:Panel ID="EditcheckBoxPanel" runat="server">
                    <table>
                        <tr>
                            <td class="pagetitle" style="width: 280px">
                                <asp:Label ID="IdLbl2" runat="server"></asp:Label>
                            </td>
                            <td align="left">
                ...
                <asp:Panel ID="MultiAddPanel" runat="server">
                    &nbsp;
                    <asp:Button ID="MultiChooseLotBtn" runat="server" CssClass="white" Text="Choose Lot" OnClick="ChooseLotBtn_Click"
                        OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" Enabled="false" CausesValidation="false" />&nbsp;
                    <asp:Button ID="MultiAddBtn" runat="server" CssClass="white" Text="Add" OnClick="MultiAddBtn_Click"
                        OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false" />&nbsp;
                    <asp:Button ID="PrevSelectedBtn" runat="server" Text="Prev" OnClick="PrevSelectedBtn_Click" CausesValidation="false"
                        CssClass="white" OnClientClick="disableBtn(this.id,true)" UseSubmitBehavior="false"></asp:Button>&nbsp;
                    <asp:Button ID="NextSelectedBtn" runat="server" CssClass="white" Text="Next" OnClick="NextSelectedBtn_Click"
                        UseSubmitBehavior="false" OnClientClick="disableBtn(this.id,true)" CausesValidation="false" />&nbsp;
                    <span style="margin-left: 300px"></span>
                    <asp:Label ID="MultiRecordNo" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="Large" CssClass="Pagetitle"></asp:Label>
                </asp:Panel>
                <br />
                                        ...
                                        <table cellspacing="2" cellpadding="2">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ...
                                                    <asp:Panel ID="InsufficientQtyPanel" Visible="False" runat="server">
                                                        <table cellspacing="1" cellpadding="1">
                                                            <tr align="center">
                                                                <td colspan="2">
                                                                    <asp:Label Style="z-index: 0" ID="Label1" runat="server" CssClass="linkLabelBig">Soft Allocation Info</asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr align="right">
                                                                <td>
                                                                    <asp:Label runat="server">Available Qty :</asp:Label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr align="center">
                                                                <td colspan="2">
                                                                    <asp:Label runat="server" CssClass="errorLabel">*INSUFFICIENT QTY*</asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                            ...
                                            <td valign="top">
                                                ...
                                                <asp:DataGrid ID="ResultDG" runat="server" OnItemCommand="ResultDG_ItemCommand" PageSize="5"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="LotRemarks" SortExpression="LotRemarks" HeaderText="LotRemarks">
                                                            <HeaderStyle Wrap="False"></HeaderStyle>
                                                            <ItemStyle Wrap="False"></ItemStyle>
                                                        </asp:BoundColumn>
