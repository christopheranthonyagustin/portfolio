...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2Menu.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2Menu" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>GoodsIssueV2Menu</title>
        ...
        <tr>
            ...
            <td class="ModuleTitle" align="right">
                <div class="NewModuleTitle">
                    <asp:Label ID="Label1" labelclass="NewModuleTitle" runat="server">Goods Issue V2</asp:Label>
                </div>
            </td>
        </tr>
    </table>
