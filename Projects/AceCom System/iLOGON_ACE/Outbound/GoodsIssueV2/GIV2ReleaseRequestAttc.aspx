<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2ReleaseRequestAttc.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2ReleaseRequestAttc" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head id="Head1" runat="server">
    <title>GIV2ReleaseRequestAttc</title>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td colspan="2">
                <div class="DropZone1" style="margin-left:20px">
                    <p>
                        Drop Files Here
                    </p>
                </div>
