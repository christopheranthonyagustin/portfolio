<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2ReleaseRequest.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2ReleaseRequest" %>
...
<head id="Head1" runat="server">
    <title>GIV2ReleaseRequest</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultRadGrid" runat="server" Skin="Metro" AllowPaging="True"
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="lotid" CommandItemDisplay="Top" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                PageSize="50">
                <Columns>
