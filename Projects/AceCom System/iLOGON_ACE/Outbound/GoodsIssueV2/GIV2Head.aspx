<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2Head.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2Head" %>
            ...
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="accode" HeaderText="Acc">
                        ...
                        <telerik:GridBoundColumn DataField="DONo" HeaderText="DO No" AllowFiltering="true">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="prioritydescr" SortExpression="prioritydescr"
                         ...
                         <telerik:GridBoundColumn DataField="ISCharges" SortExpression="ISCharges"
                            HeaderText="Charges">
                        </telerik:GridBoundColumn>
