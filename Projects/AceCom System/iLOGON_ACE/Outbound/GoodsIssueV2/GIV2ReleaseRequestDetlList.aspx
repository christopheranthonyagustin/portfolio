<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2ReleaseRequestDetlList.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2ReleaseRequestDetlList" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <br />
        <asp:Label ID="Label1" runat="server">Account</asp:Label><br />
