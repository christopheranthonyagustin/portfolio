<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2PickTask.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2PickTask" %>
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="id" PageSize="50" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onclick="return confirm('Confirm delete?')"
                                            onserverclick="Delete" runat="server">
                                ...
                                <telerik:GridTemplateColumn DataField="loccheckdigit" UniqueName="loccheckdigit" SortExpression="loccheckdigit"
                                    HeaderText="Checkdigits" ItemStyle-Width="160px" HeaderStyle-Width="160px" ReadOnly="true">
                                    <ItemTemplate>
