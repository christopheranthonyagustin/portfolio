<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2Copy.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2Copy" %>
    ...
    <table cellspacing="2" cellpadding="2">
        ...
        <tr>
            <td valign="top" align="right" colspan="2">
                    <asp:Label ID="errorLbl" runat="server" CssClass="errorLabel"></asp:Label>&nbsp;</p>
            </td>
        </tr>
    </table>
    </form>
