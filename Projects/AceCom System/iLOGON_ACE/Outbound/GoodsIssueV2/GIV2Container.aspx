<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2Container.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2Container" %>
    ...
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                <td colspan="2">
                    <asp:Panel ID="AddPanel" runat="server" Visible="False">
                        <table id="table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                            <tr>
                                <td colspan="4" class="style1">
                                    ...
                                    &nbsp; 
                                           <asp:Button ID="PrintChecklistBtn" runat="server" Text="Checklist" ToolTip="Print Checklist" OnClick="PrintChecklistBtn_Click"
                                               OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" class="blue" CausesValidation="False" />
                                    &nbsp; 
                                           <asp:Button ID="PrintTallyBtn" runat="server" Text="Tally Sheet" ToolTip="Print Tally Sheet" OnClick="PrintTallyBtn_Click"
                                               OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" class="blue" CausesValidation="False" />
                                    &nbsp; 
                        ...
                        <asp:Panel ID="FormPanel" runat="server" Visible="True">
                            <table id="table2" border="0" cellspacing="1" cellpadding="1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td nowrap class="style2" valign="top">
                                                <asp:Label ID="ChokingWoodLabel" runat="server" Text="ChokingWood" /><br />
                                                <telerik:RadTextBox ID="ChokingWoodTxt" runat="server" Skin="WebBlue" ></telerik:RadTextBox>
                                            </td>
                                            <td nowrap class="style2" valign="top">
                                                <asp:Label ID="TareWeightLabel" runat="server" Text="TareWeight" /><br />
                                                <telerik:RadTextBox ID="TareWeightTxt" runat="server" Skin="WebBlue" ></telerik:RadTextBox>
                                            </td>
                                            <td nowrap class="style2" valign="top">
                                                <asp:Label ID="VerifiedGrossMassLabel" runat="server" Text="VerifiedGrossMass" /><br />
                                        ...
                                        <tr>
                                             <td></td>
                                              <td nowrap class="style2" valign="top">
                                                 <asp:Label ID="NoOfPackageLabel" runat="server" Text="NoOfPackges" /><br />
                                                 <telerik:RadTextBox ID="NoOfPackageTxt" runat="server" Skin="WebBlue"></telerik:RadTextBox>                                                                                      
                                                  <asp:CompareValidator ID="NoOfPackageTxtCompVal" ControlToValidate="NoOfPackageTxt" ErrorMessage="#"
                                        runat="server" EnableClientScript="True" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>       
                                             </td>
                                             <td nowrap class="style2" valign="top">
                                                 <asp:Label ID="NoOfPalletLabel" runat="server" Text="NoOfPallets" /><br />
                                                 <telerik:RadTextBox ID="NoOfPalletTxt" runat="server" Skin="WebBlue"></telerik:RadTextBox>
                                                 <asp:CompareValidator ID="NoOfPalletTxtCompVal" ControlToValidate="NoOfPalletTxt" ErrorMessage="#"
                                        runat="server" EnableClientScript="True" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                             </td>
                                        </tr>
                        ...
                        <asp:Panel ID="ItemsPanel" runat="server" Visible="False" CssClass="itemsTabPanel">
                            <table border="0" cellspacing="10px" width="100%">
                                <tr>
                                    <td>
                                        <asp:Button ID="AddItemBtn" runat="server" CssClass="white" Text="New" OnClick="AddItemBtn_Click"
                                            UseSubmitBehavior="false" OnClientClick="disableBtn(this.id)" />

                                        <asp:Label ID="ItemTabContainerLabel" runat="server" Font-Bold="True" ForeColor="Black" style="padding-left: 20px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <telerik:RadGrid ID="ResultItemDG" runat="server" EnableLinqExpressions="False" Skin="Windows7" RenderMode="Lightweight" ShowStatusBar="true"
        ...
        <div style="height: 80%; top: 0px; left: 0px;" id="div-datagrid">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                EnableLinqExpressions="false" AllowPaging="true" Skin="Windows7" AllowSorting="true"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="ChokingWood" SortExpression="ChokingWood" HeaderText="ChokingWood"
                             ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TareWeight" SortExpression="TareWeight" HeaderText="TareWeight"
                             ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>                        
                        <telerik:GridBoundColumn DataField="VerifiedGrossMass" SortExpression="VerifiedGrossMass" HeaderText="VerifiedGrossMass"
                             ItemStyle-Wrap="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NoOfPackages" SortExpression="edituser" ItemStyle-Wrap="false"
                            HeaderText="NoOfPackages">
                        </telerik:GridBoundColumn>
                         <telerik:GridBoundColumn DataField="NoOfPallets" SortExpression="edituser" ItemStyle-Wrap="false"
                            HeaderText="NoOfPallets">
                        </telerik:GridBoundColumn>
