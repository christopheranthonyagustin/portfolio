<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2BreakBulk.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2BreakBulk" %>
    ...
    <form id="formBreakBulk" runat="server">
        ...
        <br />
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="30" Width="100%" CommandItemDisplay="Top" DataKeyNames="rcdtid">
