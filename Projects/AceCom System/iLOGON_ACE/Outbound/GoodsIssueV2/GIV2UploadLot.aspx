<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIV2UploadLot.aspx.cs" Inherits="iWMS.Web.Outbound.GoodsIssueV2.GIV2UploadLot" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None"
             BorderStyle="Solid" Skin="Windows7" Visible="false" OnNeedDataSource="ResultDG_NeedDataSource">
