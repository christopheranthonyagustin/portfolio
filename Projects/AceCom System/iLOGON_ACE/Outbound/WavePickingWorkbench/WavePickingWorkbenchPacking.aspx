<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WavePickingWorkbenchPacking.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.WavePickingWorkbenchPacking" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <br />
        <asp:Button ID="PackedBtn" CssClass="white" runat="server" OnClick="PackedBtn_Click" Text="Packed" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
        <br />
        <br />
