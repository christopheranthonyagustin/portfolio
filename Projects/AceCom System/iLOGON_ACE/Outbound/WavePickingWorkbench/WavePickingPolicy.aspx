<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WavePickingPolicy.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.WavePickingPolicy" %>
...
<head id="Head1" runat="server">
    <title>Policy Manager @ Wave Pick Workbench</title>
    <base target="_self" />
                                                    ...
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="deleteicon" AllowFiltering="false" ItemStyle-Width="15px" HeaderStyle-Width="15px" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="Delete"
                                                                ...
                                                                OnClick="WavePickingPropertyDelete_Click" BackColor="Transparent" BorderWidth="0" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
