<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WavePickingWorkbenchReadytoRelease.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.WavePickingWorkbenchReadytoRelease" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="ReleaseShipBtn" runat="server" CssClass="white" Text="Release Ship"
                        OnClick="ReleaseShipBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                    &nbsp;
                            <asp:Button ID="CargoManifestBtn" runat="server" Text="Cargo Manifest" OnClick="CargoManifestBtn_Click"
                                OnClientClick="disableBtn(this.id,false)"
                                UseSubmitBehavior="false" CssClass="longlabelblue" ToolTip="Cargo Manifest Print?" />
                </td>
            </tr>
        </table>
        <br />
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="true"
            ...
            <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="ShipPlanId" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
