<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardIndicatorMaster.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.DashboardIndicatorMaster" %>
                                        ...
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" EnableViewState="false"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="DashboardPropertyId" CommandItemDisplay="TopAndBottom" EditMode="Batch" Name="ParentGrid" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="QualifyingItem" HeaderText="QualifyingItem" ReadOnly="true" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="80px" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <telerik:GridTemplateColumn UniqueName="QualifyingValue" HeaderText="QualifyingValue" DataField="QualifyingValue" AllowFiltering="false" ItemStyle-Width="120px"
