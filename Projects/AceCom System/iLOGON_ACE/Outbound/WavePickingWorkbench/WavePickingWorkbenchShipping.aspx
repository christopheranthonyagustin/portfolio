<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WavePickingWorkbenchShipping.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.WavePickingWorkbenchShipping" %>
...
<head runat="server">
    <title>Wave Picking Workbench Packing</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table border="0" cellpadding="2" cellspacing="2" runat="server">
         ...
         <br />
        <asp:Button ID="ShippedBtn" CssClass="white" runat="server" OnClick="ShippedBtn_Click" Text="Shipped" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false" />
        <br />
        <br />
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true" AllowFilteringByColumn="false"
            ...
            Skin="Metro" OnNeedDataSource="ResultDG_NeedDataSource" OnColumnCreated="ResultDG_ColumnCreated">
