<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WavePickingWorkbenchPackingPool.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.WavePickingWorkbenchPackingPool" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" AutoPostBack="true"
            ...
            <Tabs>
                <telerik:RadTab Id="ReadyToPackTab" Text="Ready To Pack" Value="0" runat="server">
                </telerik:RadTab>
                <telerik:RadTab Id="PackInProgressTab" Text="Pack In Progress" Value="100" runat="server">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
                ...
                <table>
                    ...
                    <asp:Button ID="ExcelBtn" runat="server" CssClass="Green" Text="Excel" OnClick="ExcelBtn_Click"
                         UseSubmitBehavior="false" />
                            &nbsp;
                    <asp:Button ID="CompletePackingBtn" runat="server" CssClass="LongLabelWhite" Text="Complete Packing"
                        OnClick="CompletePackingBtn_Click" OnClientClick="disableBtn(this.id,false)" UseSubmitBehavior="false" />
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="PackInProgressRadPageView">
            </telerik:RadPageView>
