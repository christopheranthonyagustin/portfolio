<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardIndicator.aspx.cs" Inherits="iWMS.Web.Outbound.WavePickingWorkbench.DashboardIndicator" %>
        ...
        <asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
         <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    <br />
                    <asp:Label ID="DashboardIndicatorLbl" runat="server" CssClass="pagetitle"></asp:Label>
                </td>
            </tr>
        </table>
