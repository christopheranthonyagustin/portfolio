<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlockRegisterSplit.aspx.cs" Inherits="iWMS.Web.Outbound.BlockRegister.BlockRegisterSplit" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CompareValidator ID="QtyVal" runat="server" ControlToValidate="INTEGER_Qty"
                                            ErrorMessage="#" Type="Double" Operator="DataTypeCheck"></asp:CompareValidator><asp:CompareValidator
                                                ID="QtyValueVal" runat="server" ControlToValidate="INTEGER_Qty" ErrorMessage="#"
                                                Type="Double" Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator><br>
                                        ...
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ID" EditMode="InPlace">
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="spavailableqty"  UniqueName="spavailableqty" SortExpression="spavailableqty" 
                                                    HeaderText="Qty" DataFormatString="{0:#,0.####}" ItemStyle-HorizontalAlign="Right">
                                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                                        <ItemStyle Wrap="False"></ItemStyle>
                                                    </telerik:GridBoundColumn>                
