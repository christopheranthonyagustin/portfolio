<%@ Page Language="c#" CodeBehind="PollSalesMenu.aspx.cs" AutoEventWireup="True"
    Inherits="iWMS.Web.Outbound.PollSales.PollSalesMenu" %>

<%@ Register TagPrefix="iWMS" TagName="Tabs" Src="../../Control/Tabs.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server">
    <title>PollSalesMenu</title>
            ...
            <td class="ModuleTitle" align="right">
                <div class="rounded-box1" style="width: 40%; background-color: #FF6600;">
                    ...
                    <div class="box-contents1" style="font-size: 10pt; font-weight: bold; left: 2px;
                        ...
                        <asp:Label ID="PollSalesLbl" runat="server">Poll For Sales</asp:Label></div>
                </div>
            </td>
        </tr>
    </table>
