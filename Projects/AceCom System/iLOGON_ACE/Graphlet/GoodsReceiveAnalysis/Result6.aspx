<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result6.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsReceiveAnalysis.Result6" %>
    ...
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td>Good Receive Analysis&nbsp;-&nbsp;
                    ...
                    <asp:Label ID="lblfinalfrdate" runat="server"></asp:Label>
                    <asp:Label ID="lblfinaltodate" runat="server"></asp:Label>             
            ...
            <tr class="graytitle">
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAcCode" runat="server" class="graytitle" />
                    <asp:Label ID="lblAcName" runat="server" class="graytitle" />
                </td>
            </tr>
        </table>
        ...
        <div id="div-datagrid" style="height: 92%">
            <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="True" EnableLinqExpressions="False"
                Skin="Office2007" OnNeedDataSource="ResultDG_NeedDataSource" GridLines="Both" OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting"
