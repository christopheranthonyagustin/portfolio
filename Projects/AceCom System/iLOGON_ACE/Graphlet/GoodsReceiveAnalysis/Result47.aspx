<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result47.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsReceiveAnalysis.Result47" %>
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                   ...
                   <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="ReceivedDateLbl" runat="server"></asp:Label>
                </td>
            </tr>
                  <tr class="graytitle">
                <td class="style4">
