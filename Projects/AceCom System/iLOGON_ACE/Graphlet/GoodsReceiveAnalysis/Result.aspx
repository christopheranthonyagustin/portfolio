<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsReceiveAnalysis.Result" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="DateLbl" runat="server" class="graytitle" Text="Goods Receive Analysis " />
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Skin="Silk">
        <ChartTitle Text=" GR - Number of Goods Receive Processed">
        </ChartTitle>
        <Legend>
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart2" Skin="Silk">
        <ChartTitle Text=" GR - Number of SKU Lines Processed">
        </ChartTitle>
        <Legend>
            <Appearance Position="Bottom">
                <TextStyle Margin="20 0 0 0" />
 ...
 All Series
    ...
    <telerik:RadHtmlChart runat="server" ID="RadHtmlChart3" Skin="Silk">
        <ChartTitle Text="GR - Number of LHU Quantity Received">
        </ChartTitle>
        <Legend>
            <Appearance Position="Bottom">
                <TextStyle Margin="20 0 0 0" />
