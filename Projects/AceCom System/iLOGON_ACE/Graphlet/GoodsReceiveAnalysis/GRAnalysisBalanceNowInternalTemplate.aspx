<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRAnalysisBalanceNowInternalTemplate.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsReceiveAnalysis.GRAnalysisBalanceNowInternalTemplate" %>
            ...
            <table>
                <tr>
                    <td valign="top" align="left">
                        <telerik:RadGrid ID="ResultDGAvailable" runat="server" AutoGenerateColumns="false" GridLines="None" Width="230px" Height="455px"
                    ...
                    <td valign="top" align="left">
                        <telerik:RadGrid ID="ResultDGAssigned" runat="server" AutoGenerateColumns="false" GridLines="None" Width="320px" Height="455"
                            EnableLinqExpressions="false" AllowPaging="true" Skin="Office2007" AllowSorting="true" OnRowDrop="ResultDGAssigned_RowDrop"
                            OnItemDataBound="ResultDGAssigned_ItemDataBound" UseAccessibleHeader="true" AllowFilteringByColumn="false"
                            OnNeedDataSource="ResultDGAssigned_NeedDataSource" AllowMultiRowSelection="true">
                            <ClientSettings AllowRowsDragDrop="true" AllowAutoScrollOnDragDrop="false" Selecting-AllowRowSelect="true">
                                <Scrolling UseStaticHeaders="True" AllowScroll="true" />
                            </ClientSettings>
                            <SortingSettings EnableSkinSortStyles="false" />
