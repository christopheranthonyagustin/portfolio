<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Graphlet.iCMSReleaseOrderAnalysis.Result2" %>
     ...
     <table width="100%">
       <tr>
        ...
        <tr>
            ...
            &nbsp;&nbsp;<td class="style1">
                <asp:Label ID="FormatDescLbl" runat="server" CssClass="Graytitle">Outstanding Release Order As At </asp:Label><asp:Label
            ...
            <Columns>
                <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                    ...
                    <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="adddate" SortExpression="adddate" HeaderText="IssueDate" DataFormatString="{0:dd/MMM/yyyy}">
                        </telerik:GridBoundColumn>
