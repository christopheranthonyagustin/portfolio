<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result67.aspx.cs" Inherits="iWMS.Web.Graphlet.FreightAnalysis.Result67" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007" OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting"
            ...
            <MasterTableView AllowMultiColumnSorting="true" TableLayout="Auto" PageSize="50">
