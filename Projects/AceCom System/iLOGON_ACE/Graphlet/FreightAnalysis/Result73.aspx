<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result73.aspx.cs" Inherits="iWMS.Web.Graphlet.FreightAnalysis.Result73" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="FrDateLbl" runat="server" CssClass="Graytitle" Text="From Date"></asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="FrDateTxt" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="ToDateLbl" runat="server" CssClass="Graytitle" Text="To Date"></asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="ToDateTxt" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td class="style4">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="ReopenUserLbl" runat="server" CssClass="Graytitle" Text="ReopenUser"></asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="ReopenUserTxt" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007"
            ...
            <MasterTableView AllowMultiColumnSorting="true" ItemStyle-Width="140px" HeaderStyle-Width="140px" Width="100%" TableLayout="Auto">
                <Columns>
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
