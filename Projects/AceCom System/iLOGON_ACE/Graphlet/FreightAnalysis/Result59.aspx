<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result59.aspx.cs" Inherits="iWMS.Web.Graphlet.FreightAnalysis.Result59" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="FormatLable" runat="server" class="graytitle" Text="Freight Analysis :" />
                </td>
                <td>
                    <asp:Label ID="FormatText" class="graytitle" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="ARDATELabel" runat="server" CssClass="Graytitle" Text="AR Date :"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="ARDATEText" runat="server" CssClass="Graytitle"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="InvoiceNumberLabel" runat="server" class="graytitle" Text="Invoice Number :" />
                </td>
                <td>
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007" OnExcelExportCellFormatting="ResultDG_ExcelExportCellFormatting"
            ...
            <MasterTableView AllowMultiColumnSorting="true" Width="150%" TableLayout="Auto" PageSize="50">
