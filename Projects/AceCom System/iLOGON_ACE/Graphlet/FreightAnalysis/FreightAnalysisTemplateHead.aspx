<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreightAnalysisTemplateHead.aspx.cs" Inherits="iWMS.Web.Graphlet.FreightAnalysis.FreightAnalysisTemplateHead" %>
...
<html>
<head runat="server">
    <title>FreightAnalysisTemplateHead</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" OnNeedDataSource="ResultDG_NeedDataSource"
            EnableLinqExpressions="false" AllowPaging="true" Skin="Office2007" AllowSorting="true" UseAccessibleHeader="true" AllowFilteringByColumn="true">
