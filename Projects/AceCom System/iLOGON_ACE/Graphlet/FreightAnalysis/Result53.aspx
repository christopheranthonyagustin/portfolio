<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result53.aspx.cs" Inherits="iWMS.Web.Graphlet.FreightAnalysis.Result53" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="FormatLabel" runat="server" class="graytitle" Text="Freight Analysis :" />
                </td>
                <td>
