<%@ Page language="c#" Codebehind="InfoBoardMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.InfoBoard.InfoBoardMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InfoBoardMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="DockAtvtLbl" runat="server">Info Board</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
