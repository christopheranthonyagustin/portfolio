<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result19.aspx.cs" Inherits="iWMS.Web.Graphlet.BMSAnalysis.Result19" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>BMS Analysis 19</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="TitleLbl" runat="server" class="graytitle" Text="BMS Analysis" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label1" runat="server" class="graytitle" Text="AsAtDate&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :" />
                    <asp:Label ID="AsAtDate" runat="server" class="graytitle"></asp:Label>
                </td>
            </tr>
        </table>
