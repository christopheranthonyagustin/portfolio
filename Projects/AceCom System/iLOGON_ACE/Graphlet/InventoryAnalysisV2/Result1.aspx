<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result1.aspx.cs" Inherits="iWMS.Web.Graphlet.InventoryAnalysisV2.Result1" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html>
<head id="Head1" runat="server">
    <title>InventoryAnalysisV2 Result</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td width="70%" align="right">
                    <asp:Button ID="excelImg" runat="server" class="green" Text="Excel" ToolTip="Export to Excel" OnClick="ExportExcel"
