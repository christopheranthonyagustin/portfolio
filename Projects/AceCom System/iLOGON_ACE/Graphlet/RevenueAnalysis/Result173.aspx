<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result173.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result173" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="true" GridLines="None" AllowSorting="true"
            Skin="Office2007" OnNeedDataSource="ResultDG_NeedDataSource" OnGridExporting="ResultDG_GridExporting">
