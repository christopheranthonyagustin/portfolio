<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result7.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result7" %>
...
<head runat="server">
    <title>RevenueAnalysis BY DateRange</title>
...
<body>
   <form id="form1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="style2" colspan="4">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">RevenueAnalysis BY DateRange</asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:Label ID="Date1Lbl" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" colspan="2">
            ...
            <td colspan="2">
                <asp:Label ID="Date2Lbl" runat="server"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
