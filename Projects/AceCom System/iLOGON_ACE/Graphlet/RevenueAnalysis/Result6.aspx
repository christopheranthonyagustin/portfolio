<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result6.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result6" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Label ID="EntityLbl" class="graytitle" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
           <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Label ID="invoicedate" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
    </table>
