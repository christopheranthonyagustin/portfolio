<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result107.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result107" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="JTLbl" runat="server">JobType</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="JobTypeLbl" runat="server"></asp:Label>
                </td>
            </tr>
              <tr class="graytitle">
                <td class="style4">
