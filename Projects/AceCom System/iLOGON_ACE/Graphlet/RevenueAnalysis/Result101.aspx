<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result101.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result101" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Revenue Analysis-Job Invoice</title>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="TitleLbl" runat="server" class="graytitle" Text="Job Invoice" />             
            </td>
        </tr>       
        <tr>
            <td colspan="2">
         ...
         <tr>
            <td colspan="2">
                <asp:Label ID="TypeLbl" runat="server" class="graytitle" Text="Job Type :" />
                <asp:Label ID="jobtypeLbl" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label ID="TransportLbl" runat="server" class="graytitle" Text="Transport Type :" />
                <asp:Label ID="transporttypelbl" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
