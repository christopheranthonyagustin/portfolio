<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result67.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result67" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table width="100%" id="report" runat="server">
        ...
        <tr class="graytitle">
         ...
         <tr class="graytitle">
            <td class="style1">
                <asp:Label ID="EntityLbl" runat="server">Entity</asp:Label>
            </td>
            <td class="style1">
                :
            </td>
            <td class="style1">
                <asp:Label ID="EntityNameLbl" runat="server"></asp:Label>
            </td>
        </tr>
        <tr class="graytitle">
            <td class="style1">
