<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result5.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result5" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="OpsUnitLbl" runat="server" class="graytitle" Text="VehicleOpsUnit :" />
    ...
    <asp:ImageButton ID="ButtonExcel" runat="server" ImageUrl="../../Image/excel.gif"
     ...
     <telerik:RadGrid ID="ResultDG"  runat="server" AutoGenerateColumns="true" 
            ...
            Skin="Office2007" OnNeedDataSource="ResultDG_NeedDataSource" OnItemDataBound="ResultDG_ItemDataBound"
             OnGridExporting="ResultDG_GridExporting" ExportSettings-UseItemStyles="true" Width="80%" AllowFilteringByColumn="true" >
