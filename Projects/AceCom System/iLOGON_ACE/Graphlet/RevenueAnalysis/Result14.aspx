<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result14.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result14" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
             ...
             <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="EntLbl" runat="server">Entity</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="EntText" runat="server"></asp:Label>
                </td>
            </tr>
            <tr class="graytitle">
                <td class="style4">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="CurrencyLabel" runat="server">Currency</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="CurrencyLbl" runat="server"></asp:Label>
                </td>
            </tr>

              <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="SMLbl" runat="server">Salesman</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="SMText" runat="server"></asp:Label>
                </td>
            </tr>

            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="DateLbl" runat="server">Date Range</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
