<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result16.aspx.cs" Inherits="iWMS.Web.Graphlet.RevenueAnalysis.Result16" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="DateRangeTypeLabel" runat="server">Date Range Type</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
