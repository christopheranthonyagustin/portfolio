<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchFormat.aspx.cs" Inherits="iWMS.Web.Graphlet.InventoryAnalysis.SearchFormat" %>
        ...
        <script type="text/javascript">
            ...
            <%for (int i = 0; i < format.Length; i++)
            {
                ...
                document.getElementById(eachId).addEventListener('click', function (event) {
                    ...
                    window.location = 'Search.aspx?id=' + id + '&des=' + des;
                });
            <%}
            }%>
