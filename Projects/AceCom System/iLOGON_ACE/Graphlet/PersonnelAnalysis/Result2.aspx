<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Graphlet.PersonnelAnalysis.Result2" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007"
                AutoGenerateColumns="true" OnGridExporting="ResultDG_GridExporting"
