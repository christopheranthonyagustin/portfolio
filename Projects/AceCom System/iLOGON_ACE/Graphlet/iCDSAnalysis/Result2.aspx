<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Graphlet.iCDSAnalysis.Result2" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">iCDS Analysis</asp:Label><asp:Label
    ...
    <telerik:RadGrid ID="ResultDG" runat="server" EnableLinqExpressions="False" Skin="Office2007"
        ...
        AllowPaging="false" AllowSorting="true" AllowFilteringByColumn="true" CellPadding="2"
        ...
        <MasterTableView AllowMultiColumnSorting="true">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="skucode" SortExpression="skucode" HeaderText="ContainerNo" />
                <telerik:GridBoundColumn DataField="SizeTypeDescr" SortExpression="SizeTypeDescr"
                    HeaderText="SizeType" />
                <telerik:GridBoundColumn DataField="SKUStatus" SortExpression="SKUStatus" HeaderText="Condition" />
                <telerik:GridBoundColumn DataField="DepotCode" SortExpression="DepotCode" HeaderText="Depot" />
                <telerik:GridBoundColumn DataField="CustomerRef" SortExpression="CustomerRef" HeaderText="CustomerRef" />
                <telerik:GridBoundColumn DataField="transdate" SortExpression="transdate" HeaderText="StoringDate"
                    DataFormatString="{0:dd/MMM/yyyy}" />
                <telerik:GridBoundColumn DataField="Laden" SortExpression="Laden" HeaderText="Empty/Laden" />
                <telerik:GridBoundColumn DataField="GradeType" SortExpression="GradeType" HeaderText="GradeType" />
                <telerik:GridBoundColumn DataField="AgeingDays" SortExpression="AgeingDays" HeaderText="AgeingDays" />
                 <telerik:GridBoundColumn DataField="Row" SortExpression="Row" HeaderText="Location" />
            </Columns>
        </MasterTableView>
    </telerik:RadGrid>
    </form>
