<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result3.aspx.cs" Inherits="iWMS.Web.Graphlet.iCDSAnalysis.Result3" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">iCDS Analysis from </asp:Label><asp:Label
