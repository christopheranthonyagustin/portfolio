<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result17.aspx.cs" Inherits="iWMS.Web.Graphlet.PackingOrderAnalysis.Result17" %>
...
<head runat="server">
    <title>PackingOrderAnalysis</title>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td colspan="2">
                    <asp:Label ID="Title" runat="server" Text="PackingOrder Analysis" class="graytitle"></asp:Label>                  
                </td>
            </tr>
            <tr class ="GrayTitle">
                <td colspan="2">
            ...
            <tr class="GrayTitle">
                <td colspan="2">
                    ...
                    <asp:Label ID="AcNamelbl" runat="server" class="graytitle" />
                </td>
            </tr>
        </table>
