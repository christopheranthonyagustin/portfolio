<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result2.aspx.cs" Inherits="iWMS.Web.Graphlet.ThroughputAnalysis.Result2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="TitleLabel" runat="server">Throughput Analysis</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
           ...
           <tr class="graytitle">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="NoOfWeekLbl" runat="server">Number of Week</asp:Label>
                </td>
                <td class="style3">:
                </td>
               <td>
                    <asp:Label ID="WeekLbl" runat="server"></asp:Label>
                </td>
            </tr>            
            <tr>
                <td>
