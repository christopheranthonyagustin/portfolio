<%@ Page language="c#" Codebehind="LocUtilizationMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.LocUtilizationV2.LocUtilizationMenu" %>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="DockAtvtLbl" runat="server">Location Utilization</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
