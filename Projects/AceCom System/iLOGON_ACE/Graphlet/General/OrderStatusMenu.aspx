<%@ Page language="c#" Codebehind="OrderStatusMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.OrderStatusMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>OrderrStatusMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="OrderStatusLbl" runat="server">Issue Status</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
