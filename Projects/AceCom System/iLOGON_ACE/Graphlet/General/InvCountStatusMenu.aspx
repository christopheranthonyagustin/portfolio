<%@ Page language="c#" Codebehind="InvCountStatusMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.InvCountStatusMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvCountStatusMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="InvCountStatusLbl" runat="server">Inv.Count Status</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
