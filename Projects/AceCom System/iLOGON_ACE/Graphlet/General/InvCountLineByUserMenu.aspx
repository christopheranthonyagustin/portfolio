<%@ Page language="c#" Codebehind="InvCountLineByUserMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.InvCountLineByUserMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>InvCountByUserMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="GraphletLbl" runat="server">Graphlet</asp:Label>&nbsp;:
						<asp:Label id="InvCountByUserLbl" runat="server">Inv.Count Task</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
