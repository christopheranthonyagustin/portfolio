<%@ Page language="c#" Codebehind="OrderStatus.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.OrderStatus" %>
						...
						<td>
							<table cellSpacing="1" cellPadding="1" width="100%" border="0">
								<tr bgColor="#ffffff">
									...
									<td>:<asp:dropdownlist id="AccountList" runat="server"></asp:dropdownlist></td>
								</tr>
								<tr bgColor="#ffffff">
									<td>&nbsp;
								...
								<tr bgColor="#ffffff">
									<td vAlign="top" colSpan="2"><asp:datagrid id="StatusDG" runat="server" cssclass="Content" borderwidth="1px" showfooter="True"
											...
											<Columns>
												<asp:BoundColumn DataField="XValue" HeaderText="Order Status">
