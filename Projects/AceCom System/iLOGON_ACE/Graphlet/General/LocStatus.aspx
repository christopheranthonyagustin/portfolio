<%@ Page language="c#" Codebehind="LocStatus.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.LocStatus" %>
					...
					<td>
						<table cellSpacing="1" cellPadding="1" width="100%" border="0">
							<tr bgColor="#ffffff">
								...
								<td>:<asp:dropdownlist id="SiteList" runat="server"></asp:dropdownlist></td>
							</tr>
							<tr bgColor="#ffffff">
								<td width="20%">&nbsp;
									<asp:Label id="ZoneLbl" runat="server">Zone</asp:Label></td>
								<td>:<asp:dropdownlist id="ZoneList" runat="server"></asp:dropdownlist></td>
							</tr>
							<tr bgColor="#ffffff">
								<td>&nbsp;
									<asp:Label id="ViewLbl" runat="server">Select View</asp:Label></td>
								<td>:<asp:dropdownlist id="drpChartType" runat="server">
							...
							<tr bgColor="#ffffff">
								<td vAlign="top" colSpan="2"><asp:datagrid id="StatusDG" runat="server" cssclass="Content" borderwidth="1px" showfooter="True"
										...
										<Columns>
											<asp:BoundColumn DataField="XValue" HeaderText="Location Status">
