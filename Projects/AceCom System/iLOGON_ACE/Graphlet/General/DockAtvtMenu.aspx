<%@ Page language="c#" Codebehind="DockAtvtMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.DockAtvtMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>DockAtvtMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="DockAtvtLbl" runat="server">Dock Activity</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
