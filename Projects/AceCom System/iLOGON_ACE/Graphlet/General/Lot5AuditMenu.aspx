<%@ Page language="c#" Codebehind="Lot5AuditMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.Lot5AuditMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>Lot5AuditMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="Lot5AuditLbl" runat="server">Customs Lot Audit Control</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
