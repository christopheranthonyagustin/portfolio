<%@ Page language="c#" Codebehind="LocStatusMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.LocStatusMenu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head runat="server">
		<title>LocStatusMenu</title>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="LocStatusLbl" runat="server">Location Status</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
