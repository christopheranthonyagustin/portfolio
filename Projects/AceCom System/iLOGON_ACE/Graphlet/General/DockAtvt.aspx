<%@ Page language="c#" Codebehind="DockAtvt.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Graphlet.General.DockAtvt" %>
							...
							<table cellSpacing="1" cellPadding="1" width="100%" border="0">
								...
								<tr bgColor="#ffffff">
									<td vAlign="top" colSpan="2"><asp:datagrid id="StatusDG" runat="server" cssclass="Content" borderwidth="1px" showfooter="True"
											...
											<Columns>
												<asp:BoundColumn DataField="XValue" HeaderText="Dock Activity">
