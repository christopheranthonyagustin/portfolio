<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserTransactionStatisticsMenu.aspx.cs" Inherits="iWMS.Web.Graphlet.General.UserTransactionStatisticsMenu" %>
		...
		<form id="Form1" method="post" runat="server">
			<table width="100%">
				...
				<%--	<td class="ModuleTitle" align="right">
						...
						<asp:Label id="UserTranStatusLbl" runat="server">Transaction Statistics Analysis</asp:Label></div>--%>
						 <asp:Label ID="UserTranStatusLbl" labelclass="NewModuleTitle" runat="server">Transaction Statistics Analysis</asp:Label>
						<%--</div>--%>
