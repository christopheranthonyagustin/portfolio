<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result3.aspx.cs" Inherits="iWMS.Web.Graphlet.TripIncentivebyDriver.Result3" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <telerik:RadHtmlChart runat="server" ID="RadHtmlChart1" Skin="Silk" Width="1500" Height="700">
        ...
        <br />
        <br />
        <telerik:RadHtmlChart runat="server" ID="RadHtmlChart2" Skin="Silk" Width="1500" Height="700">
