<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result67.aspx.cs" Inherits="iWMS.Web.Graphlet.WareHouseAnalysis.Result67" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    <asp:Button ID="ExportExcel" CssClass="green" runat="server" OnClick="ExportExcel_Click"
                        Text="Excel" />
                </td>
            </tr>
        </table>
