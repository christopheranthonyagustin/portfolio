<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Graphlet.UserAnalysis.Result" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="TitleLabel" runat="server" CssClass="Graytitle" Text="User Analysis -"></asp:Label>
