<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="iWMS.Web.Graphlet.TimesheetAnalysis.Result" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="Label3" runat="server" Visible="false" class="graytitle" Text="Type :" />
                <asp:Label ID="TypeLbl" runat="server" Visible="false" class="graytitle" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
       ...
       <tr>
            <td colspan="2">
                <asp:Label ID="AsAtLbl" runat="server" class="graytitle" Text="AsAtDate :" />
                <asp:Label ID="asatdateLbl" runat="server" class="graytitle"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
