<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result31.aspx.cs" Inherits="iWMS.Web.Graphlet.PaymentAnalysis.Result31" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr class="graytitle">
            <td colspan="2">
                <asp:Label ID="TitleLbl" runat="server" class="graytitle" Text="Payment Analysis" />             
            </td>
        </tr>       
        <tr>
            <td colspan="2">
