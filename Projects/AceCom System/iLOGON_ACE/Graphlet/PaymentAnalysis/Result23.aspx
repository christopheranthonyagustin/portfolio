<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result23.aspx.cs" Inherits="iWMS.Web.Graphlet.PaymentAnalysis.Result23" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="3">
                    <asp:Label ID="TitleLbl" runat="server" CssClass="Graytitle">Payment Analysis</asp:Label><asp:Label
