<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsIssueFormat.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.GoodsIssueFormat" %>
        ...
        <script type="text/javascript">
            ...
            <%for (int i = 0; i < format.Length; i++)
            {
                ...
                document.getElementById(eachId).addEventListener('click', function (event) {
                    ...
                    window.location = 'GoodsIssue.aspx?id=' + id + '&des=' + des;
                });
            <%}
            }%>
