<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result137.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.Result137" %>
...
<body>
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="GrayTitle">
                <td colspan="2">
                    <asp:Label ID="Title" runat="server" Text="GIAnalysis" class="graytitle"></asp:Label>
                </td>
            </tr>
            <tr class="GrayTitle">
                <td colspan="2">
