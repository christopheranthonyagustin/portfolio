<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result13.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.Result13" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="ShippedDateLbl" runat="server">Shipped Date</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
                    <asp:Label ID="ShippedDateValue" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
