<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result109.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.Result109" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td class="style4">
                    <asp:Label ID="shipDateLbl" runat="server">Shipped Date</asp:Label>
                </td>
                <td class="style3">:
                </td>
                <td>
