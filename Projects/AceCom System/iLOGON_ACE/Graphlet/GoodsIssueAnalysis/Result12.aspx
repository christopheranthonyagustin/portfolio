<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result12.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.Result12" %>
    ...
    <form id="Form2" method="post" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
             ...
             <tr class="graytitle">
                <td>Date generated&nbsp;:&nbsp;
                    <asp:Label ID="lblcurrentdate" runat="server" class="graytitle"/>                    
                </td>
           </tr>            
        </table>
