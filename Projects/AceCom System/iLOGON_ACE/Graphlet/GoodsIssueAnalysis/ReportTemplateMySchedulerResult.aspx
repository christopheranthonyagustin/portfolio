<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportTemplateMySchedulerResult.aspx.cs" Inherits="iWMS.Web.Graphlet.GoodsIssueAnalysis.ReportTemplateMySchedulerResult" %>
                    ...
                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" Exportable="false">
                        <ItemTemplate>
                            <asp:ImageButton runat="server" Visible="True" ID="TaskSchQEdit" ImageUrl="..\..\image\pencil.gif" Width="15" Height="15" AlternateText="Edit Task Scheduler Queue"
                                BorderWidth="0" BackColor="Transparent" OnClick="TaskSchQEdit_Click" CausesValidation="False"></asp:ImageButton>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
