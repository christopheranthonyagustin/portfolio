<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardAnalysisWMSInventory.aspx.cs" Inherits="iWMS.Web.Graphlet.DashboardAnalysis.DashboardAnalysisWMSInventory" %>
...
<body>
    ...
    <form id="form1" method="post" runat="server">
                                ...
                                <div style="margin-left: 8px; margin-right: 8px; margin-bottom: 8px">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="2" id="table1" runat="server" visible="true" height="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="refreshLbl" runat="server" Text="RefreshEvery" S/><br />
            ...
            <tr>
                <td colspan="3" class="style2">
                    ...
                    <br />
                     ...
                     <asp:Label ID="lblytd" runat="server" Visible="false" Font-Bold="true" Font-Size="13px"></asp:Label>  
                    ...
                    <br />
                    <telerik:RadGrid ID="ResultDG2" runat="server" AutoGenerateColumns="true" AllowSorting="True" OnColumnCreated="ResultDG2_ColumnCreated"
                        BorderStyle="Solid" Skin="Office2007" onsorting="GridView1_Sorting" AllowPaging="true" OnItemDataBound="ResultDG2_ItemDataBound"
                        OnPageIndexChanged="ResultDG2_PageIndexChanged" OnNeedDataSource="ResultDG2_NeedDataSource"
                        GridLines="Both" ExportSettings-UseItemStyles="true" OnGridExporting="ResultDG2_GridExporting">
                        <ClientSettings AllowColumnsReorder="false" ReorderColumnsOnClient="true" Selecting-AllowRowSelect="true" Resizing-AllowColumnResize="true">
                        </ClientSettings>
                        <SortingSettings EnableSkinSortStyles="false" />
                        <AlternatingItemStyle Wrap="true" Font-Size="16px"></AlternatingItemStyle>
                    ...
                    <br />
                      ...
                      <asp:Label ID="lblmtd" runat="server" Visible="false" Font-Bold="true" Font-Size="13px"></asp:Label>  

                    <br />
                    <telerik:RadGrid ID="ResultDG3" runat="server" AutoGenerateColumns="true" AllowSorting="True" OnColumnCreated="ResultDG3_ColumnCreated"
                        BorderStyle="Solid" Skin="Office2007" onsorting="GridView1_Sorting" AllowPaging="true" OnItemDataBound="ResultDG3_ItemDataBound"
                        OnPageIndexChanged="ResultDG3_PageIndexChanged" OnNeedDataSource="ResultDG3_NeedDataSource"
                        GridLines="Both" ExportSettings-UseItemStyles="true" OnGridExporting="ResultDG3_GridExporting">
                        <ClientSettings AllowColumnsReorder="false" ReorderColumnsOnClient="true" Selecting-AllowRowSelect="true" Resizing-AllowColumnResize="true">
                        </ClientSettings>
                        <SortingSettings EnableSkinSortStyles="false" />
                        <AlternatingItemStyle Wrap="true" Font-Size="16px"></AlternatingItemStyle>
                    ...
                    <br />
                    <telerik:RadGrid ID="ResultDG4" runat="server" AutoGenerateColumns="true" AllowSorting="True" OnColumnCreated="ResultDG4_ColumnCreated"
                        BorderStyle="Solid" Skin="Office2007" onsorting="GridView1_Sorting" AllowPaging="true" OnItemDataBound="ResultDG4_ItemDataBound"
                        OnPageIndexChanged="ResultDG4_PageIndexChanged" OnNeedDataSource="ResultDG4_NeedDataSource"
                        GridLines="Both" ExportSettings-UseItemStyles="true" OnGridExporting="ResultDG4_GridExporting">
                        <ClientSettings AllowColumnsReorder="false" ReorderColumnsOnClient="true" Selecting-AllowRowSelect="true" Resizing-AllowColumnResize="true">
                        </ClientSettings>
                        <SortingSettings EnableSkinSortStyles="false" />
                        <AlternatingItemStyle Wrap="true" Font-Size="16px"></AlternatingItemStyle>
        ...
        <asp:Label ID="MsgLabel" runat="server" Visible="false" Font-Bold="true" Font-Size="16px"></asp:Label>
    </form>
</body>
</html>
