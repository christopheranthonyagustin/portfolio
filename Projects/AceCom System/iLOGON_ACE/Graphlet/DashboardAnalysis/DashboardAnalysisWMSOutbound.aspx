<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardAnalysisWMSOutbound.aspx.cs" Inherits="iWMS.Web.Graphlet.DashboardAnalysis.DashboardAnalysisWMSOutbound" %>
                        ...
                        <telerik:RadPanelItem runat="server" Value="Panel">
                            <ItemTemplate>
                                <div style="margin-left: 8px; margin-right: 8px; margin-bottom: 8px">
                                    ...
                                    <asp:Panel runat="server" ID="WMSOutbound13Panel" Visible="false">
                                        <table>
                                            <tr>
                                                <td>
        ...
        <table id="resultTable" runat="server" cellspacing="0" cellpadding="0" width="100%" height="100%"
                ...
                <tr>
                    <td colspan="3" class="style2">
                        ...
                        <asp:Label ID="Lbl" runat="server" Text="Goods Issue" Font-Bold="true" Font-Size="21px" Visible="false"></asp:Label> &nbsp;
