<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Declaration.aspx.cs" Inherits="iWMS.Web.Graphlet.DeclarationAnalysis.Declaration" %>
...
<body>
    <form id="form1" method="post" runat="server">
       ...
       <asp:Panel ID="Panel13" runat="server" Width="500px">
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                            <ContentTemplate>
                                &nbsp;
                                <asp:Label ID="MessageLbl13" runat="server" CssClass="errorLabel" Style="z-index: 0"
