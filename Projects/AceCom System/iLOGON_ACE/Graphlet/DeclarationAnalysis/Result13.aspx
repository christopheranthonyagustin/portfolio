<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result13.aspx.cs" Inherits="iWMS.Web.Graphlet.DeclarationAnalysis.Result13" %>
...
<head id="Head1" runat="server">
    <title>TransactionAnalysis</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="TitleLbl" runat="server" class="graytitle" Text="Transaction Analysis" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="datelbl" runat="server" class="graytitle" Text="AddedDate Range :" Visible="false" />
                    <asp:Label ID="DateLabel" runat="server" class="graytitle" Visible="false"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Label ID="TransdateLabel" runat="server" class="graytitle" Text="TransactionDate Range :" Visible="false" />
                    <asp:Label ID="TransactionLabel" runat="server" class="graytitle" visible="false"></asp:Label>
                </td>
            </tr>
        </table>
