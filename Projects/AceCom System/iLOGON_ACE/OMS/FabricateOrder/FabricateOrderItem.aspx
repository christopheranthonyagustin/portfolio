<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricateOrderItem.aspx.cs" Inherits="iWMS.Web.OMS.FabricateOrder.FabricateOrderItem" %>
...
<head id="Head1" runat="server">
    <title>Fabricate Order Item</title>
...
<body onload="javascript:window.focus();">
    <form id="form1" runat="server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage" RenderSelectedPageOnly="true">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="FabricateOrderJobOrderItemRadPageView">
            </telerik:RadPageView>
            <telerik:RadPageView runat="server" Height="700px" ID="FabricateOrderJobOrderItemAttcRadPageView">
            </telerik:RadPageView>
            <telerik:RadPageView runat="server" Height="700px" ID="FabricateOrderAttcRadPageView">
            </telerik:RadPageView>
            <telerik:RadPageView runat="server" Height="700px" ID="FabricateOrderDORadPageView">
            </telerik:RadPageView>
