<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricateOrderHead.aspx.cs" Inherits="iWMS.Web.OMS.FabricateOrder.FabricateOrderHead" %>
                ...
                <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="FabricateOrderId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="RcId" UniqueName="RcId" SortExpression="RcId" HeaderText="RcId" Display="false">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="custreferenceno" UniqueName="custreferenceno" SortExpression="custreferenceno"
                            ...
                            <telerik:GridBoundColumn DataField="FabricateStatusDescr" UniqueName="FabricateStatusDescr" SortExpression="FabricateStatusDescr"
                                HeaderText="Status">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="JobOrderNo" UniqueName="JobOrderNo" SortExpression="JobOrderNo" HeaderText="JobOrderNo">
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="GoodsReceiveNo" UniqueName="GoodsReceiveNo" SortExpression="GoodsReceiveNo" HeaderText="GoodsReceiveNo">
                            </telerik:GridBoundColumn>
