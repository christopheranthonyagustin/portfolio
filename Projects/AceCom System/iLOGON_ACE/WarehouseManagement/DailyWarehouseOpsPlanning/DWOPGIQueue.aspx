<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DWOPGIQueue.aspx.cs" Inherits="iWMS.Web.WarehouseManagement.DailyWarehouseOpsPlanning.DWOPGIQueue" %>
...
<head runat="server">
    <title>Daily Warehouse Operations Planning GIQueue</title>
                ...
                <tr>
                   ...
                   <td>
                    ...
                    <td>
                        ...
                        &nbsp; 
                        <asp:Button ID="TodayBtn" class="white" runat="server" CssClass="white" OnClick="TodayBtn_Click"
                        ...
                        <asp:Button ID="UnassignBtn" runat="server" CssClass="white" Text="Unassign" OnClick="UnassignBtn_Click"
                            OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"  />
                        &nbsp;
                         <asp:Button ID="TrackContainerBtn" class="LongLabelWhite" runat="server" 
                            Text="Track Milestones" OnClientClick="disableBtn(this.id)" UseSubmitBehavior="false"   />
                        &nbsp;
