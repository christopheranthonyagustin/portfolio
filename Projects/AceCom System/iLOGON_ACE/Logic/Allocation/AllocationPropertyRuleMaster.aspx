<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllocationPropertyRuleMaster.aspx.cs" Inherits="iWMS.Web.Logic.Allocation.AllocationPropertyRuleMaster" %>
...
<head id="Head1" runat="server">
    <title>Rule @ Allocation Policy</title>
    <base target="_self" />
                                    ...
                                    <td>
                                        ...
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" EnableViewState="false"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PropertyId" CommandItemDisplay="TopAndBottom" EditMode="Batch" Name="ParentGrid"
                                                ...
                                                <Columns>
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false" ItemStyle-Width="20px" HeaderStyle-Width="20px" HeaderStyle-HorizontalAlign="Center">
                                                    ...
                                                    <telerik:GridBoundColumn DataField="QualifyingItemDescr" HeaderText="Qualifying Item" ReadOnly="true" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="50px" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                                    </telerik:GridBoundColumn>

                                                    <telerik:GridTemplateColumn UniqueName="Qualifier" HeaderText="Qualifier"
                                                        SortExpression="Qualifier" AllowFiltering="false" ItemStyle-Width="50px" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <telerik:GridTemplateColumn UniqueName="QualifyingValue" HeaderText="Qualifying Value" DataField="QualifyingValue" AllowFiltering="false" ItemStyle-Width="120px"
                                                        ...
                                                        <EditItemTemplate>
                                                            <%--<telerik:RadTextBox runat="server" ID="QualifyingValueTxt" TextMode="SingleLine" Width="140px">
                                                            </telerik:RadTextBox>--%>
