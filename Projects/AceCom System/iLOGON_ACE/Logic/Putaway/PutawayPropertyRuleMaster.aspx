<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PutawayPropertyRuleMaster.aspx.cs" Inherits="iWMS.Web.Logic.Putaway.PutawayPropertyRuleMaster" %>
...
<head id="Head1" runat="server">
    <title>Rule @ Putaway Policy</title>
    <base target="_self" />
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <telerik:RadTabStrip runat="server" ID="RadTabStrip1" CausesValidation="false" MultiPageID="RadMultiPage1"
                                            ...
                                            <Tabs>
                                                <telerik:RadTab Id="PropertyTab" Text="Property" Value="0" readonly="readonly" runat="server" Visible="false">
                                                </telerik:RadTab>
                                            </Tabs>
                                        </telerik:RadTabStrip>
                                        <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" EnableViewState="false"
                                            ...
                                            AllowPaging="false" Skin="Metro" RenderMode="Lightweight" OnNeedDataSource="ResultDG_NeedDataSource" OnItemDataBound="ResultDG_ItemDataBound"
                                            ...
                                            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="PropertyId" CommandItemDisplay="TopAndBottom" EditMode="Batch" Name="ParentGrid"
                                                HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="RGridHeader_CUSTOM" HeaderStyle-ForeColor="White">
                                                <BatchEditingSettings EditType="Row" OpenEditingEvent="Click" SaveAllHierarchyLevels="true" HighlightDeletedRows="true" />
                                                <CommandItemSettings ShowAddNewRecordButton="false" />
                                                <Columns>
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false"  HeaderStyle-HorizontalAlign="Center">
                                                    ...
                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="deleteicon" AllowFiltering="false"  ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="Delete"
                                                                ...
                                                                OnClick="Delete_Click" BackColor="Transparent" BorderWidth="0" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridBoundColumn DataField="QualifyingItemDescr" HeaderText="Qualifying Item" ReadOnly="true" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    </telerik:GridBoundColumn>

                                                    <telerik:GridTemplateColumn UniqueName="Qualifier" HeaderText="Qualifier"
                                                        SortExpression="Qualifier" AllowFiltering="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                        ...
                                                        <EditItemTemplate>
                                                            <telerik:RadComboBox ID="QualifierDDL" OnLoad="QualifierDDL_Load" runat="server" Skin="WebBlue" Enabled="true"
                                                                RenderMode="Lightweight"  OnClientDropDownOpening="QualifierDDL_Filter" HighlightTemplatedItems="true">
                                                            </telerik:RadComboBox>
                                                        </EditItemTemplate>
                                                    </telerik:GridTemplateColumn>

                                                    <telerik:GridTemplateColumn Reorderable="false" UniqueName="docicon" AllowFiltering="false"  ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <telerik:GridTemplateColumn UniqueName="QualifyingValue" HeaderText="Qualifying Value" DataField="QualifyingValue" AllowFiltering="false" 
                                                         ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="LblQualifyingValue" Text='<%# Eval("QualifyingValue") %>' CssClass="wordwrap"></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <telerik:RadComboBox ID="QualifyingValueDDL" OnLoad="QualifyingValueDDL_Load" runat="server" Skin="WebBlue" Enabled="true"
                                                                RenderMode="Lightweight" OnClientDropDownOpening="QualifyingValueDDL_Filter" Filter="Contains" AllowCustomText="true" HighlightTemplatedItems="true">
                                                            </telerik:RadComboBox>
                                                        </EditItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridTemplateColumn UniqueName="QualifierList" HeaderText="QualifierList" DataField="QualifierList" AllowFiltering="false"
                                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" Display="false">
                                                        <ItemTemplate>
                                                            <telerik:RadTextBox runat="server" ID="QualifierListTxt" Text='<%# Eval("QualifierList") %>'>
                                                            </telerik:RadTextBox>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridTemplateColumn UniqueName="QualifyingValueList" HeaderText="QualifyingValueList" DataField="QualifyingValue" AllowFiltering="false"
                                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" Display="false">
                                                        <ItemTemplate>
                                                            <telerik:RadTextBox runat="server" ID="QualifyingValueListTxt" Text='<%# Eval("QualifyingValueList") %>'>
                                                            </telerik:RadTextBox>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
