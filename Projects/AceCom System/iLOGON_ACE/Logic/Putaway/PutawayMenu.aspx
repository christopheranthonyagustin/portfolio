<%@ Page Language="c#" CodeBehind="PutawayMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Logic.Putaway.PutawayMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="MenuLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
