<%@ Page language="c#" Codebehind="OutboundHandlingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.OutboundHandling.OutboundHandlingMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="ReportLbl" runat="server">Outbound Handling Billing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
