<%@ Page language="c#" Codebehind="OutboundHandlingSearch.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.OutboundHandling.OutboundHandlingSearch" %>
	...
	<body bottomMargin="0" leftMargin="0" rightMargin="0" topMargin="0">
		...
		<asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
			<table border="0" cellSpacing="2" cellPadding="2">
				...
				<tr>
					<td noWrap>&nbsp;
						<asp:label id="MinimumLbl" runat="server"> Minimum per Issue</asp:label></td>
					<td>:
