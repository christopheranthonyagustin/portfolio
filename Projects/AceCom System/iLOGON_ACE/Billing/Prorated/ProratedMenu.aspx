<%@ Page language="c#" Codebehind="ProratedMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Prorated.ProratedMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="ReportLbl" runat="server">1st Month Pro-Rated Storage Billing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
