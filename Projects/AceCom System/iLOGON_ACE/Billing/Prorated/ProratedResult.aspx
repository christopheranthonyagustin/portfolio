<%@ Page language="c#" Codebehind="ProratedResult.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Prorated.ProratedResult" %>
			...
			<table border="0" cellSpacing="1" cellPadding="1" width="100%">
				<tr>
					<td class="boldtext"><asp:label id="AccountLbl" runat="server" CssClass="Graytitle">Account : </asp:label><BR>
						<asp:label id="MonthLbl" runat="server" CssClass="Graytitle">Entry Month : </asp:label><BR>
						<asp:label id="DaysLbl" runat="server" CssClass="Graytitle">Calendar Days in Month : </asp:label><BR>
