<%@ Page language="c#" Codebehind="ProratedSearch.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Prorated.ProratedSearch" %>
	...
	<body bottomMargin="0" leftMargin="0" rightMargin="0" topMargin="0">
		...
		<asp:ScriptManager ID="ToolkitScriptManager1" runat="server" />
			<table border="0" cellSpacing="2" cellPadding="2">
				...
				<tr>
					<td noWrap>&nbsp;
						<asp:label id="DateLbl" runat="server">Entry Month</asp:label></td>
					<td>:<iwms:icalondate id="DateCal" runat="server"></iwms:icalondate></td>
				</tr>
				<tr>
					<td noWrap>&nbsp;
				...
				<tr>
					<td noWrap></td>
					<td>&nbsp;
						<asp:button id="CompileBtn" runat="server" Text="Compile" CssClass="formbtn" onclick="CompileBtn_Click"></asp:button>&nbsp;<INPUT class="formbtn" value="Reset" type="reset">&nbsp;
