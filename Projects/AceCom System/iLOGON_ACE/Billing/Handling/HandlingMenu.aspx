<%@ Page language="c#" Codebehind="HandlingMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Handling.HandlingMenu" %>
			...
			<table width="100%">
				<tr>
					<td>&nbsp;</td>
						...
						<asp:Label id="ReportLbl" runat="server">Inbound Handling Billing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
