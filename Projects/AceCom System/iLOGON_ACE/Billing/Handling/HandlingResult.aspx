<%@ Page language="c#" Codebehind="HandlingResult.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Handling.HandlingResult" %>
			...
			<table border="0" cellSpacing="1" cellPadding="1" width="100%">
				<tr>
					<td class="boldtext"><asp:label id="AccountLbl" runat="server" CssClass="Graytitle">Account : </asp:label><BR>
						...
						<asp:label id="MinimumLbl" runat="server" CssClass="Graytitle">Minimum Per UOM : $</asp:label><BR>
					</td>
				</tr>
				<tr>
