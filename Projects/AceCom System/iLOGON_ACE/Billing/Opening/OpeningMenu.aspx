<%@ Page language="c#" Codebehind="OpeningMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Billing.Opening.OpeningMenu" %>
			...
			<table width="100%">
				<tr>
					...
					<td class="ModuleTitle" align="right">
						...
						<asp:Label id="ReportLbl" runat="server">Opening Month Storage Billing</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
