<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanDetlAdd.aspx.cs" Inherits="iWMS.Web.Management.Loan.LoanDetlAdd" %>
                    ...
                    <tr>
                        <td align="center">
                            &nbsp;<asp:ImageButton ID="AlertImgBtn" runat="server" ImageUrl="../../Image/alert.gif"
                                Visible="False" CausesValidation="false" BackColor="Transparent" BorderWidth="0" ImageAlign="AbsMiddle">
                            </asp:ImageButton>
