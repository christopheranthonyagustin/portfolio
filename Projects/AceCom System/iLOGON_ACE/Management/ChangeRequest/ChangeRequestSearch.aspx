<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeRequestSearch.aspx.cs" Inherits="iWMS.Web.Management.ChangeRequest.ChangeRequestSearch" %>
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <td style="position: relative;">
                                        ...
                                        <iWMS:iForm ID="formCtl_Descr" runat="server"></iWMS:iForm>
                                        <iWMS:iForm ID="formCtl_DateInfo" runat="server"></iWMS:iForm>
                                    </td>
                                    <td style="position: absolute; margin-left: -1px !important; margin-top: -1px !important">
