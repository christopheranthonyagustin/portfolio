<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContainerYardPlanningMenu.aspx.cs"
    Inherits="iWMS.Web.Management.ContainerYardPlanning.ContainerYardPlanningMenu" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="NewModuleTitle" align="right">
                <asp:Label ID="CtnrYPlbl" runat="server">Container Yard Planning</asp:Label>
            </td>
        </tr>
    </table>
    </form>
