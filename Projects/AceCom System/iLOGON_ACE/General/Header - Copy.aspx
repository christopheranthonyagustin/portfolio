                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <i id="NotiBell" class="bi bi-bell NotiBellCSS" onclick="ShowUserMessage()" style="font-size: 20px; color: white;" />
                                    </td>
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.d) {
                        ...
                        document.getElementById("NumberCircle").style.display = "none";
