<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LicenseManagerMenu.aspx.cs" Inherits="iWMS.Web.Adm.LicenseManager.LicenseManagerMenu" %>
...
<html>
<head runat="server">
    <title>LicenseManagerMenu</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td align="right" class="NewModuleTitle">
