<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LicenseManagerAnalysis17.aspx.cs" Inherits="iWMS.Web.Adm.LicenseManager.LicenseManagerAnalysis17" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>License Manager Analysis 17</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            ...
            <tr class="graytitle">
                <td colspan="2">
                    <asp:Label ID="TitleLbl" runat="server" class="graytitle" Text="License Manager Analysis" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
