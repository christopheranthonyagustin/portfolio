<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionInformationMenu.aspx.cs" Inherits="iWMS.Web.Adm.SessionInformation.SessionInformationMenu" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="NewModuleTitle" align="right">
                    <asp:Label ID="SessionInformationLbl" runat="server"></asp:Label></td>
            </tr>
        </table>
    </form>
</body>
