...
<%@ Page language="c#" Codebehind="TranslateMenu.aspx.cs" AutoEventWireup="True" Inherits="iWMS.Web.Adm.Translate.TranslateMenu" %>
					...
					<td><iwms:tabs id="MenuTabs" runat="server"></iwms:tabs></td>
						...
						<div class="rounded-box1" style="width:40%;background-color:#FF6600;">
							<div class="top-right-corner1">
								<div class="top-right-inside1" style="BACKGROUND-COLOR: #ffffff;color:#FF6600">•</div>
							</div>
							<div class="top-left-corner1">
								<div class="top-left-inside1" style="BACKGROUND-COLOR: #ffffff;color:#FF6600">•</div>
							</div>
							<div class="box-contents1" style="font-size:10pt;font-weight:bold;left:2px;padding:3px 5px 5px 3px;">
						<asp:Label id="ShipPlanLbl" runat="server">Translate</asp:Label></div></div></td>
				</tr>
			</table>
		</form>
	</body>
