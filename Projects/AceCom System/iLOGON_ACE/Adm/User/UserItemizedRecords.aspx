<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserItemizedRecords.aspx.cs" Inherits="iWMS.Web.Adm.User.UserItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../User/UserHead.aspx";
        }
