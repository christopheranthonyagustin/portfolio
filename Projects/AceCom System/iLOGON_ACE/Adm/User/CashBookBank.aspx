<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookBank.aspx.cs" Inherits="iWMS.Web.Adm.User.CashBookBank" %>
            ...
            <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                ...
                <tr>
                    <td style="padding-bottom: 5px; width: 700px">
                        <asp:Label ID="Label1" runat="server" Text="Banks Assigned" Font-Bold="true" Font-Size="Medium" />
                    </td>
                    <td style="padding-bottom: 5px; padding-left: 15px;">
                        <asp:Label ID="Label2" runat="server" Text="Banks Not Assigned" Font-Bold="true" Font-Size="Medium" />
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <telerik:RadGrid ID="ResultDGAssigned" runat="server" AutoGenerateColumns="false" GridLines="None"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="Entname" SortExpression="Entity" HeaderText="Entity"
                                        ItemStyle-Wrap="false">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="BankCode" SortExpression="BankCode" HeaderText="BankCode"
                                        ItemStyle-Wrap="false">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="BankDescr" SortExpression="BankDescr" HeaderText="BankDescription"
                                        ItemStyle-Wrap="false">
                                    </telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
                        ...
                        <telerik:RadGrid ID="ResultDGUnAssigned" runat="server" AutoGenerateColumns="false" GridLines="None"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="100">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="entcode" HeaderText="entcode" UniqueName="entcode" Display="false" />
                                </Columns>
                            </MasterTableView>
                        </telerik:RadGrid>
                    </td>
