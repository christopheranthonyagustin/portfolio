<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAnalysisFormat.aspx.cs" Inherits="iWMS.Web.Adm.User.UserAnalysisFormat" %>
            ...
            <table id="FormTable" border="0" cellspacing="0" cellpadding="0" width="100%" runat="server">
                ...
                <tr>
                    <td style="padding-bottom: 5px; width: 700px">
                        <asp:Label ID="Label1" runat="server" Text="Assigned" Font-Bold="true" Font-Size="Medium"/>
                    </td>
                    <td style="padding-bottom: 5px; padding-left: 15px;">

                        <asp:Label ID="Label2" runat="server" Text="Available Analysis Format" Font-Bold="true" Font-Size="Medium"/>
                    </td>
                </tr>
                <tr>
                        ...
                        <telerik:RadGrid ID="ResultDGAssigned" runat="server" AutoGenerateColumns="false" GridLines="None"
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="100" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Format" SortExpression="Format" HeaderText="Format"
                                        ItemStyle-Wrap="false">
                                    </telerik:GridBoundColumn>
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" PageSize="100" >
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Status" SortExpression="Status" HeaderText="Status"
                                     ...
                                     <telerik:GridBoundColumn DataField="FormatCode" SortExpression="FormatCode" HeaderText="FormatCode" Display="false"
                                        ItemStyle-Wrap="false">
                                    </telerik:GridBoundColumn>
