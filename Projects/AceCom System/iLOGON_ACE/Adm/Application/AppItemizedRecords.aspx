<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppItemizedRecords.aspx.cs" Inherits="iWMS.Web.Adm.Application.AppItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../Application/AppHead.aspx";
        }
