<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KnowledgeBaseManagerAttach.aspx.cs" Inherits="iWMS.Web.Adm.KnowledgeBaseManager.KnowledgeBaseManagerAttach" %>
...
<head runat="server">
    <title>FixedAssetMasterAttch</title>
     <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    <meta content="Microsoft Visual Studio .NET 7.1" name="GENERATOR">
    <meta content="C#" name="CODE_LANGUAGE">
    <meta content="JavaScript" name="vs_adefaultClientScript">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td colspan="2" style="padding-top: 10px;">
                    <asp:DataList ID="ImageDataList" runat="server" RepeatColumns="0" DataKeyField="KBImageId"
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.KBImageId")%>' onserverclick="ImageDelete" runat="server">
