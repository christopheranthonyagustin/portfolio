<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntityCurrency.aspx.cs" Inherits="iWMS.Web.Adm.Entity.EntityCurrency" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EntityCurrency</title>
                    ...
                    <telerik:RadGrid ID="ResultDG" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" AllowSorting="true" OnItemCommand="ResultDG_ItemCommand"
                        ...
                        <MasterTableView AllowMultiColumnSorting="true" PageSize="50" CommandItemDisplay="Top" DataKeyNames="id" EditMode="InPlace">
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Entity" ItemStyle-Wrap="false">
                                    ...
                                    <EditItemTemplate>
                                        <telerik:RadComboBox ID="EntityComBo" runat="server" DataTextField="descr" DataValueField="item"
                                            ...
                                            SelectedIndex='<%#iWMS.BusinessFacade.ListingSystem.GetSelectedIndex(EntityDS, DataBinder.Eval(Container.DataItem, "EntId").ToString())%>'
                                            AutoPostBack="true" Enabled="false">
                                        </telerik:RadComboBox>
                                    </EditItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="Currency" ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "CurrCode")%>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <telerik:RadComboBox ID="CurrencyComBo" runat="server" DataTextField="descr" DataValueField="item"
                                            DataSource='<%# CurrencyDS%>' Skin="WebBlue" Width="150px" DropDownWidth="150px"
                                            RenderMode="Lightweight" CausesValidation="false" Filter="Contains"
                                ...
                                <telerik:GridTemplateColumn HeaderText="AR Control Account" ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "ARControlGLAccCodeDescr")%>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <telerik:RadMultiColumnComboBox ID="RevenueAccountComBo" runat="server"                                            
                                            ...
                                            Text='<%# DataBinder.Eval(Container.DataItem, "ARControlGLAccId") %>'>
                                        </telerik:RadMultiColumnComboBox>
                                    </EditItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="AP Control Account" ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "APControlGLAccCodeDescr")%>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <telerik:RadMultiColumnComboBox ID="ExpenseAccountComBo" runat="server" 
                                            Skin="WebBlue" RenderMode="Lightweight" CausesValidation="false" Filter="Contains"
                                            DataTextField="descr" DataValueField="item" Width="150px" DropDownWidth="150px" 
                                            Text='<%# DataBinder.Eval(Container.DataItem, "APControlGLAccId") %>'>
                                        </telerik:RadMultiColumnComboBox>
                                    </EditItemTemplate>
                                </telerik:GridTemplateColumn>
