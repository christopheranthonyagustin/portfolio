<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntityItemizedRecords.aspx.cs" Inherits="iWMS.Web.Adm.Entity.EntityItemizedRecords" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function close() {
            GetRadWindow().close();
            window.parent.parent.location.href = "../Entity/EntityHead.aspx";
        }
