<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntityControl.aspx.cs"
    Inherits="iWMS.Web.Adm.Entity.EntityControl" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>EntityControlDetl</title>
                        ...
                        <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <telerik:RadComboBox ID="TypeList" runat="server" DataValueField="item" Width="240px"
                                        Skin="WebBlue" AutoPostBack="true" AllowCustomText="false" RenderMode="Lightweight"
                                        Filter="Contains">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                ...
                <MasterTableView AllowMultiColumnSorting="true" PageSize="50" DataKeyNames="id">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn Reorderable="false" UniqueName="icon" AllowFiltering="false">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton runat="server" Visible="True" ID="EntControlEdit" ImageUrl="../../image/pencil.gif"
                                ...
                                <a id="lnkDelete" href='<%#DataBinder.Eval(Container,"DataItem.id")%>' onclick="return confirm('Confirm delete Control?')"
                                    onserverclick="EntControl_Delete" runat="server">
